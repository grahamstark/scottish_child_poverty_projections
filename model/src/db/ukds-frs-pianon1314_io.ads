--
-- Created by ada_generator.py on 2017-11-13 10:51:14.808063
-- 
with Ukds;
with DB_Commons;
with Base_Types;
...
package Ukds.Frs.Pianon1314_IO is
   ...
   --
   function Is_Null( a_pianon1314 : Pianon1314 ) return Boolean;
   ...
   --
   function Retrieve( c : d.Criteria; connection : Database_Connection := null ) return Ukds.Frs.Pianon1314_List;
   
   --
   -- Retrieves a list of Ukds.Frs.Pianon1314 retrived by the sql string, or throws an exception
   --
   function Retrieve( sqlstr : String; connection : Database_Connection := null ) return Ukds.Frs.Pianon1314_List;
   
   --
   -- Save the given record, overwriting if it exists and overwrite is true, 
   -- otherwise throws DB_Exception exception. 
   --
   procedure Save( a_pianon1314 : Ukds.Frs.Pianon1314; overwrite : Boolean := True; connection : Database_Connection := null );
   
   --
   -- Delete the given record. Throws DB_Exception exception. Sets value to Ukds.Frs.Null_Pianon1314
   --
   procedure Delete( a_pianon1314 : in out Ukds.Frs.Pianon1314; connection : Database_Connection := null );
   --
   ...
   function Map_From_Cursor( cursor : GNATCOLL.SQL.Exec.Forward_Cursor ) return Ukds.Frs.Pianon1314;
