...
update target_data.population_forecasts set all_ages = 
                coalesce( age_0, 0.0 ) +
                coalesce( age_1, 0.0 ) + 
                coalesce( age_2, 0.0 ) +
                coalesce( age_3, 0.0 ) +
...
select 
        year,sum(all_ages) as all_age_sum,
        sum(
                coalesce( age_0, 0.0 ) +
                coalesce( age_1, 0.0 ) + 
                coalesce( age_2, 0.0 ) +
                ...
                coalesce( age_108, 0.0 ) +
                coalesce( age_109, 0.0 ) +
                coalesce( age_110, 0.0 )) as total_sum,
        sum(
                coalesce( age_16, 0.0 ) +
                coalesce( age_17, 0.0 ) +
                coalesce( age_18, 0.0 ) +
                ...
                coalesce( age_108, 0.0 ) +
                coalesce( age_109, 0.0 ) +
                coalesce( age_110, 0.0 )) as age_16_plus,
        sum(
                coalesce( age_16, 0.0 ) +
                coalesce( age_17, 0.0 ) +
                coalesce( age_18, 0.0 ) +
                ...
                coalesce( age_62, 0.0 ) +
                coalesce( age_63, 0.0 ) +
                coalesce( age_64, 0.0 )) as age_16_64
from 
        target_data.population_forecasts 
where 
