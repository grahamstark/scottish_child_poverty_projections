--
-- Created by ada_generator.py on 2017-09-21 21:49:52.732229
-- 
with Ukds;
with DB_Commons;
with Base_Types;
...
package Ukds.Frs.Pianom0809_IO is
   ...
   --
   -- returns true if the primary key parts of a_pianom0809 match the defaults in Ukds.Frs.Null_Pianom0809
   --
   function Is_Null( a_pianom0809 : Pianom0809 ) return Boolean;
   
   --
   -- returns the single a_pianom0809 matching the primary key fields, or the Ukds.Frs.Null_Pianom0809 record
   -- if no such record exists
   --
   function Retrieve_By_PK( user_id : Integer; edition : Integer; year : Integer; benunit : Integer; sernum : Sernum_Value; connection : Database_Connection := null ) return Ukds.Frs.Pianom0809;
   --
   ...
   --
   -- Retrieves a list of Ukds.Frs.Pianom0809 matching the criteria, or throws an exception
   --
   function Retrieve( c : d.Criteria; connection : Database_Connection := null ) return Ukds.Frs.Pianom0809_List;
   
   --
   -- Retrieves a list of Ukds.Frs.Pianom0809 retrived by the sql string, or throws an exception
   --
   function Retrieve( sqlstr : String; connection : Database_Connection := null ) return Ukds.Frs.Pianom0809_List;
   
   --
   -- Save the given record, overwriting if it exists and overwrite is true, 
   -- otherwise throws DB_Exception exception. 
   --
   procedure Save( a_pianom0809 : Ukds.Frs.Pianom0809; overwrite : Boolean := True; connection : Database_Connection := null );
   
   --
   -- Delete the given record. Throws DB_Exception exception. Sets value to Ukds.Frs.Null_Pianom0809
   --
   procedure Delete( a_pianom0809 : in out Ukds.Frs.Pianom0809; connection : Database_Connection := null );
   --
   ...
   function Map_From_Cursor( cursor : GNATCOLL.SQL.Exec.Forward_Cursor ) return Ukds.Frs.Pianom0809;
   ...
   --    8 : london                   : Parameter_Integer  : Integer              :        0 
   --    9 : adultb                   : Parameter_Integer  : Integer              :        0 
   --   10 : ethgrphh                 : Parameter_Integer  : Integer              :        0 
   --   11 : benunit                  : Parameter_Integer  : Integer              :        0 
   ...
   --   24 : pippenbu                 : Parameter_Integer  : Integer              :        0 
   --   25 : piginvbu                 : Parameter_Integer  : Integer              :        0 
   --   26 : pigernbu                 : Parameter_Integer  : Integer              :        0 
   --   27 : pibenibu                 : Parameter_Integer  : Integer              :        0 
   --   28 : piothibu                 : Parameter_Integer  : Integer              :        0 
   --   29 : pinahcbu                 : Parameter_Integer  : Integer              :        0 
   --   30 : piirbbu                  : Parameter_Integer  : Integer              :        0 
   --   31 : pidisben                 : Parameter_Integer  : Integer              :        0 
   --   32 : piretben                 : Parameter_Integer  : Integer              :        0 
   --   33 : pripenbu                 : Parameter_Integer  : Integer              :        0 
   --   34 : nonben2bu                : Parameter_Integer  : Integer              :        0 
   --   35 : perbenbu                 : Parameter_Integer  : Integer              :        0 
   --   36 : perbenbu2                : Parameter_Integer  : Integer              :        0 
