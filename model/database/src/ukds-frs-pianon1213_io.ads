--
-- Created by ada_generator.py on 2017-09-18 17:36:25.791625
-- 
with Ukds;
with DB_Commons;
with Base_Types;
...
package Ukds.Frs.Pianon1213_IO is
   ...
   --
   -- returns true if the primary key parts of a_pianon1213 match the defaults in Ukds.Frs.Null_Pianon1213
   --
   function Is_Null( a_pianon1213 : Pianon1213 ) return Boolean;
   
   --
   -- returns the single a_pianon1213 matching the primary key fields, or the Ukds.Frs.Null_Pianon1213 record
   -- if no such record exists
   --
   function Retrieve_By_PK( user_id : Integer; edition : Integer; year : Integer; benunit : Integer; sernum : Sernum_Value; connection : Database_Connection := null ) return Ukds.Frs.Pianon1213;
   --
   ...
   --
   -- Retrieves a list of Ukds.Frs.Pianon1213 matching the criteria, or throws an exception
   --
   function Retrieve( c : d.Criteria; connection : Database_Connection := null ) return Ukds.Frs.Pianon1213_List;
   
   --
   -- Retrieves a list of Ukds.Frs.Pianon1213 retrived by the sql string, or throws an exception
   --
   function Retrieve( sqlstr : String; connection : Database_Connection := null ) return Ukds.Frs.Pianon1213_List;
   
   --
   -- Save the given record, overwriting if it exists and overwrite is true, 
   -- otherwise throws DB_Exception exception. 
   --
   procedure Save( a_pianon1213 : Ukds.Frs.Pianon1213; overwrite : Boolean := True; connection : Database_Connection := null );
   
   --
   -- Delete the given record. Throws DB_Exception exception. Sets value to Ukds.Frs.Null_Pianon1213
   --
   procedure Delete( a_pianon1213 : in out Ukds.Frs.Pianon1213; connection : Database_Connection := null );
   --
   ...
   function Map_From_Cursor( cursor : GNATCOLL.SQL.Exec.Forward_Cursor ) return Ukds.Frs.Pianon1213;
