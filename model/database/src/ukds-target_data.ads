...
package Ukds.target_data is
   ...
   type Target_Dataset is record
      ...
      sco_hhld_one_adult_male : Amount := 0.0;
      sco_hhld_one_adult_female : Amount := 0.0;
      sco_hhld_two_adults : Amount := 0.0;
      sco_hhld_one_adult_one_child : Amount := 0.0;
      sco_hhld_one_adult_two_plus_children : Amount := 0.0;
      sco_hhld_two_plus_adult_one_plus_children : Amount := 0.0;
      sco_hhld_three_plus_person_all_adult : Amount := 0.0;
      ...
      eng_hhld_other_households : Amount := 0.0;
      nir_hhld_one_adult_households : Amount := 0.0;
      nir_hhld_two_adults_without_children : Amount := 0.0;
      nir_hhld_other_households_without_children : Amount := 0.0;
      nir_hhld_one_adult_households_with_children : Amount := 0.0;
      nir_hhld_other_households_with_children : Amount := 0.0;
      wal_hhld_1_person : Amount := 0.0;
      wal_hhld_2_person_no_children : Amount := 0.0;
      wal_hhld_2_person_1_adult_1_child : Amount := 0.0;
      wal_hhld_3_person_no_children : Amount := 0.0;
      wal_hhld_3_person_2_adults_1_child : Amount := 0.0;
      wal_hhld_3_person_1_adult_2_children : Amount := 0.0;
      wal_hhld_4_person_no_children : Amount := 0.0;
      wal_hhld_4_person_2_plus_adults_1_plus_children : Amount := 0.0;
      wal_hhld_4_person_1_adult_3_children : Amount := 0.0;
      wal_hhld_5_plus_person_no_children : Amount := 0.0;
      wal_hhld_5_plus_person_2_plus_adults_1_plus_children : Amount := 0.0;
      wal_hhld_5_plus_person_1_adult_4_plus_children : Amount := 0.0;
      male : Amount := 0.0;
      female : Amount := 0.0;
      employed : Amount := 0.0;
      employee : Amount := 0.0;
   ...
   Null_Target_Dataset : constant Target_Dataset := (
         ...
         sco_hhld_one_adult_male => 0.0,
         sco_hhld_one_adult_female => 0.0,
         sco_hhld_two_adults => 0.0,
         sco_hhld_one_adult_one_child => 0.0,
         sco_hhld_one_adult_two_plus_children => 0.0,
         sco_hhld_two_plus_adult_one_plus_children => 0.0,
         sco_hhld_three_plus_person_all_adult => 0.0,
         ...
         eng_hhld_other_households => 0.0,
         nir_hhld_one_adult_households => 0.0,
         nir_hhld_two_adults_without_children => 0.0,
         nir_hhld_other_households_without_children => 0.0,
         nir_hhld_one_adult_households_with_children => 0.0,
         nir_hhld_other_households_with_children => 0.0,
         wal_hhld_1_person => 0.0,
         wal_hhld_2_person_no_children => 0.0,
         wal_hhld_2_person_1_adult_1_child => 0.0,
         wal_hhld_3_person_no_children => 0.0,
         wal_hhld_3_person_2_adults_1_child => 0.0,
         wal_hhld_3_person_1_adult_2_children => 0.0,
         wal_hhld_4_person_no_children => 0.0,
         wal_hhld_4_person_2_plus_adults_1_plus_children => 0.0,
         wal_hhld_4_person_1_adult_3_children => 0.0,
         wal_hhld_5_plus_person_no_children => 0.0,
         wal_hhld_5_plus_person_2_plus_adults_1_plus_children => 0.0,
         wal_hhld_5_plus_person_1_adult_4_plus_children => 0.0,
         male => 0.0,
         female => 0.0,
         employed => 0.0,
         employee => 0.0,
