--
-- Created by ada_generator.py on 2017-09-20 22:07:21.536020
-- 
with Ukds;
with DB_Commons;
with Base_Types;
...
package Ukds.Target_Data.Population_Forecasts_IO is
   ...
   --
   function Retrieve_By_PK( year : Integer; rec_type : Unbounded_String; variant : Unbounded_String; country : Unbounded_String; edition : Year_Number; target_group : Unbounded_String; connection : Database_Connection := null ) return Ukds.Target_Data.Population_Forecasts;
   --
   -- Returns true if record with the given primary key exists
   --
   function Exists( year : Integer; rec_type : Unbounded_String; variant : Unbounded_String; country : Unbounded_String; edition : Year_Number; target_group : Unbounded_String; connection : Database_Connection := null ) return Boolean ;
