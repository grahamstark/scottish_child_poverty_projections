--
-- Created by ada_generator.py on 2017-09-20 15:38:49.070212
-- 
with Ukds;
with DB_Commons;
with Base_Types;
...
package Ukds.Frs.Pianon1516_IO is
   ...
   --
   -- returns true if the primary key parts of a_pianon1516 match the defaults in Ukds.Frs.Null_Pianon1516
   --
   function Is_Null( a_pianon1516 : Pianon1516 ) return Boolean;
   
   --
   -- returns the single a_pianon1516 matching the primary key fields, or the Ukds.Frs.Null_Pianon1516 record
   -- if no such record exists
   --
   function Retrieve_By_PK( user_id : Integer; edition : Integer; year : Integer; benunit : Integer; sernum : Sernum_Value; connection : Database_Connection := null ) return Ukds.Frs.Pianon1516;
   --
   ...
   --
   -- Retrieves a list of Ukds.Frs.Pianon1516 matching the criteria, or throws an exception
   --
   function Retrieve( c : d.Criteria; connection : Database_Connection := null ) return Ukds.Frs.Pianon1516_List;
   
   --
   -- Retrieves a list of Ukds.Frs.Pianon1516 retrived by the sql string, or throws an exception
   --
   function Retrieve( sqlstr : String; connection : Database_Connection := null ) return Ukds.Frs.Pianon1516_List;
   
   --
   -- Save the given record, overwriting if it exists and overwrite is true, 
   -- otherwise throws DB_Exception exception. 
   --
   procedure Save( a_pianon1516 : Ukds.Frs.Pianon1516; overwrite : Boolean := True; connection : Database_Connection := null );
   
   --
   -- Delete the given record. Throws DB_Exception exception. Sets value to Ukds.Frs.Null_Pianon1516
   --
   procedure Delete( a_pianon1516 : in out Ukds.Frs.Pianon1516; connection : Database_Connection := null );
   --
   ...
   procedure Add_chbenbu( c : in out d.Criteria; chbenbu : Integer; op : d.operation_type:= d.eq; join : d.join_type := d.join_and );
   procedure Add_winpaybu( c : in out d.Criteria; winpaybu : Amount; op : d.operation_type:= d.eq; join : d.join_type := d.join_and );
   ...
   procedure Add_tvpaybu( c : in out d.Criteria; tvpaybu : Amount; op : d.operation_type:= d.eq; join : d.join_type := d.join_and );
   ...
   procedure Add_chbenbu_To_Orderings( c : in out d.Criteria; direction : d.Asc_Or_Desc );
   procedure Add_winpaybu_To_Orderings( c : in out d.Criteria; direction : d.Asc_Or_Desc );
   ...
   procedure Add_tvpaybu_To_Orderings( c : in out d.Criteria; direction : d.Asc_Or_Desc );
   ...
   function Map_From_Cursor( cursor : GNATCOLL.SQL.Exec.Forward_Cursor ) return Ukds.Frs.Pianon1516;

   -- 
   -- returns an array of GNATColl SQL Parameters indexed 1 .. 67, as follows
   ...
   --    9 : benunit                  : Parameter_Integer  : Integer              :        0 
   --   10 : ethgrphh                 : Parameter_Integer  : Integer              :        0 
   --   11 : chbenbu                  : Parameter_Integer  : Integer              :        0 
   --   12 : winpaybu                 : Parameter_Float    : Amount               :      0.0 
   --   13 : gs_newbu                 : Parameter_Integer  : Integer              :        0 
   --   14 : gs_newpp                 : Parameter_Integer  : Integer              :        0 
   --   15 : mbhcdec                  : Parameter_Integer  : Integer              :        0 
   --   16 : obhcdec                  : Parameter_Integer  : Integer              :        0 
   --   17 : mahcdec                  : Parameter_Integer  : Integer              :        0 
   --   18 : oahcdec                  : Parameter_Integer  : Integer              :        0 
   --   19 : sexsp                    : Parameter_Integer  : Integer              :        0 
   --   20 : newfamb2                 : Parameter_Integer  : Integer              :        0 
   --   21 : pidefbhc                 : Parameter_Float    : Amount               :      0.0 
   --   22 : pidefahc                 : Parameter_Float    : Amount               :      0.0 
   --   23 : pigrosbu                 : Parameter_Integer  : Integer              :        0 
   --   24 : pinincbu                 : Parameter_Integer  : Integer              :        0 
   --   25 : pigoccbu                 : Parameter_Integer  : Integer              :        0 
   --   26 : pippenbu                 : Parameter_Integer  : Integer              :        0 
   --   27 : piginvbu                 : Parameter_Integer  : Integer              :        0 
   --   28 : pigernbu                 : Parameter_Integer  : Integer              :        0 
   --   29 : pibenibu                 : Parameter_Integer  : Integer              :        0 
   --   30 : piothibu                 : Parameter_Integer  : Integer              :        0 
   --   31 : pinahcbu                 : Parameter_Integer  : Integer              :        0 
   --   32 : piirbbu                  : Parameter_Integer  : Integer              :        0 
   --   33 : pidisben                 : Parameter_Integer  : Integer              :        0 
   --   34 : piretben                 : Parameter_Integer  : Integer              :        0 
   --   35 : pripenbu                 : Parameter_Integer  : Integer              :        0 
   --   36 : tvpaybu                  : Parameter_Float    : Amount               :      0.0 
   --   37 : nonben2bu                : Parameter_Integer  : Integer              :        0 
   --   38 : perbenbu                 : Parameter_Integer  : Integer              :        0 
   --   39 : perbenbu2                : Parameter_Integer  : Integer              :        0 
   --   40 : rrpen                    : Parameter_Integer  : Integer              :        0 
   --   41 : newfambu2                : Parameter_Integer  : Integer              :        0 
   --   42 : dummy                    : Parameter_Integer  : Integer              :        0 
   --   43 : coup_q1                  : Parameter_Float    : Amount               :      0.0 
   --   44 : coup_q2                  : Parameter_Float    : Amount               :      0.0 
   --   45 : coup_q3                  : Parameter_Float    : Amount               :      0.0 
   --   46 : coup_q4                  : Parameter_Float    : Amount               :      0.0 
   --   47 : coup_q5                  : Parameter_Float    : Amount               :      0.0 
   --   48 : acou_q1                  : Parameter_Float    : Amount               :      0.0 
   --   49 : acou_q2                  : Parameter_Float    : Amount               :      0.0 
   --   50 : acou_q3                  : Parameter_Float    : Amount               :      0.0 
   --   51 : acou_q4                  : Parameter_Float    : Amount               :      0.0 
   --   52 : acou_q5                  : Parameter_Float    : Amount               :      0.0 
   --   53 : sing_q1                  : Parameter_Integer  : Integer              :        0 
   --   54 : sing_q2                  : Parameter_Integer  : Integer              :        0 
   --   55 : sing_q3                  : Parameter_Integer  : Integer              :        0 
   --   56 : sing_q4                  : Parameter_Integer  : Integer              :        0 
   --   57 : sing_q5                  : Parameter_Integer  : Integer              :        0 
   --   58 : asin_q1                  : Parameter_Integer  : Integer              :        0 
   --   59 : asin_q2                  : Parameter_Integer  : Integer              :        0 
   --   60 : asin_q3                  : Parameter_Integer  : Integer              :        0 
   --   61 : asin_q4                  : Parameter_Integer  : Integer              :        0 
   --   62 : asin_q5                  : Parameter_Integer  : Integer              :        0 
   --   63 : clust                    : Parameter_Integer  : Integer              :        0 
   --   64 : strat                    : Parameter_Integer  : Integer              :        0 
   --   65 : agehd80                  : Parameter_Integer  : Integer              :        0 
   --   66 : agesp80                  : Parameter_Integer  : Integer              :        0 
   --   67 : sernum                   : Parameter_Bigint   : Sernum_Value         :        0 
