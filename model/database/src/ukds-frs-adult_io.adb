--
-- Created by ada_generator.py on 2017-09-06 17:20:41.712179
-- 
with Ukds;
...
package body Ukds.Frs.Adult_IO is
   ...
   SELECT_PART : constant String := "select " &
         "user_id, edition, year, sernum, benunit, person, abs1no, abspar, abspay, abswhy," &
         "abswk, x_access, accjb, accmsat, accountq, accssamt, accsspd, adeduc, adema, ademaamt," &
         "ademapd, age, agehqual, aliamt, alimny, alipd, alius, allow1, allow2, allow3," &
         "allow4, allpay1, allpay2, allpay3, allpay4, allpd1, allpd2, allpd3, allpd4, aluamt," &
         "alupd, anyacc, anyed, anymon, anypen1, anypen2, anypen3, anypen4, anypen5, anypen6," &
         "anypen7, apamt, apdamt, apdir, apdpd, appd, bfd, bfdamt, bfdpd, bfdval," &
         "btec, btecnow, c2orign, calm, camemt, cameyr, cameyr2, cbaamt2, cbchk, change," &
         "chkctc, chkdpco1, chkdpco2, chkdpco3, chkdpn, chkdsco1, chkdsco2, chkdsco3, chknop, citizen," &
         "citizen2, claifut1, claifut2, claifut3, claifut4, claifut5, claifut6, claifut7, claifut8, claimant," &
         "cohabit, combid, commusat, condit, contuk, convbl, coptrust, corign, corigoth, ctclum1," &
         "ctclum2, cupchk, curqual, cvht, cvpay, cvpd, ddaprog1, ddatre1, ddatrep1, defrpen," &
         "degree, degrenow, denrec, depend, depress, disben1, disben2, disben3, disben4, disben5," &
         "disben6, discuss, disd01, disd02, disd03, disd04, disd05, disd06, disd07, disd08," &
         "disd09, disd10, disdifp1, dla1, dla2, dls, dlsamt, dlspd, dlsval, dob," &
         "down, dv09pens, dvil03a, dvil04a, dvjb12ml, dvmardf, ed1amt, ed1pd, ed1sum, ed2amt," &
         "ed2pd, ed2sum, edatt, edhr, edtyp, eligadlt, eligchld, eligschm, emparr, empcontr," &
         "emppen, empschm, empstat, envirsat, es2000, ethgrps, etngrp, eualiamt, eualimny, eualipd," &
         "euetype, everwrk, exthbct1, followsc, followup, fted, ftwk, gpispc, gpjsaesa, x_grant," &
         "grtamt1, grtamt2, grtdir1, grtdir2, grtnum, grtsce1, grtsce2, grtval1, grtval2, gta," &
         "happy, health1, heathad, help, hholder, hi1qual1, hi1qual2, hi1qual3, hi1qual4, hi1qual5," &
         "hi1qual6, hi3qual, higho, highonow, hrpid, hsvper, iclaim1, iclaim2, iclaim3, iclaim4," &
         "iclaim5, iclaim6, iclaim7, iclaim8, iclaim9, incdur, injlong, injwk, invests, iout," &
         "isa1type, isa2type, issue, jobaway, jobbyr, jobsat, kidben1, kidben2, kidben3, lareg," &
         "legltrus, lifesat, likewk, limitl, lktime, lktrain, lkwork, lnkdwp, lnkref01, lnkref02," &
         "lnkref03, lnkref04, lnkref05, lnkref06, lnkref07, lnkref08, lnkref09, lnkref10, lnkref11, loan," &
         "loannum, lstwrk1, lstwrk2, lstyr, meaning, medrec, memschm, mntamt1, mntamt2, mntarr1," &
         "mntarr2, mntarr3, mntarr4, mntgov1, mntgov2, mntnrp, mntpay, mntpd1, mntpd2, mntrec," &
         "mntus1, mntus2, mntusam1, mntusam2, mntuspd1, mntuspd2, moneysat, ms, nanid1, nanid2," &
         "nanid3, nanid4, nanid5, nanid6, nervous, ni2train, niamt, nietngrp, niexthbb, ninanid1," &
         "ninanid2, ninanid3, ninanid4, ninanid5, ninanid6, ninanid7, nipd, nireg, nirelig, nolk1," &
         "nolk2, nolk3, nowant, nssec, numjob, numjob2, nvqlenow, nvqlev, oddjob, oldstud," &
         "otabspar, otamt, otapamt, otappd, othben1, othben2, othben3, othben4, othben5, othben6," &
         "othpass, othqual1, othqual2, othqual3, othtax, othtrust, otinva, pareamt, parepd, penben1," &
         "penben2, penben3, penben4, penben5, penflag, penlump, perspen1, perspen2, pip1, pip2," &
         "pollopin, polttrus, ppchk1, ppchk2, ppchk3, ppnumc, ppper, practice, privpen, proptax," &
         "ptwk, r01, r02, r03, r04, r05, r06, r07, r08, r09," &
         "r10, r11, r12, r13, r14, reasden, reasmed, reasnhs, reason, recsat," &
         "redamt, redany, rednet, redtax, relasat, religenw, religsc, rentprof, retire, retire1," &
         "retreas, royal1, royal2, royal3, royal4, royyr1, royyr2, royyr3, royyr4, rsa," &
         "rsanow, rstrct, safe, samesit, schchk, scotvec, sctvnow, sdemp01, sdemp02, sdemp03," &
         "sdemp04, sdemp05, sdemp06, sdemp07, sdemp08, sdemp09, sdemp10, sdemp11, sdemp12, selfdemp," &
         "sex, sflntyp1, sflntyp2, sftype1, sftype2, sic, sidqn, slrepamt, slrepay, slreppd," &
         "soc2010, socfund1, socfund2, socfund3, socfund4, spcreg1, spcreg2, spcreg3, spnumc, spout," &
         "spyrot, srentamt, srentpd, srispc, srjsaesa, stakep, start, tcever1, tcever2, tcrepay1," &
         "tcrepay2, tcrepay3, tcrepay4, tcrepay5, tcrepay6, tcthsyr1, tcthsyr2, tdaywrk, tea, tea9697," &
         "tempjob, timesat, topupl, totint, train2, trainee, trnallow, ttbprx, tuborr, typeed," &
         "unpaid1, unpaid2, w1, w2, wageben1, wageben2, wageben3, wageben4, wageben5, wageben6," &
         "wageben7, wageben8, wait, whoresp, whosectb, wintfuel, working, wpa, wpba, wtclum1," &
         "wtclum2, ystrtwk, month, able, actacci, age80, agehq80, basacti, careab, careah," &
         "carecb, carech, carecl, carefl, carefr, careot, carere, chbflg, corignan, curacti," &
         "currjobm, disacta1, discora1, dobmonth, dobyear, empoccp, empstatb, empstatc, empstati, ethgr3," &
         "gebacti, giltcti, gross4, hdage, hdben, hdindinc, heartval, hourab, hourah, hourcare," &
         "hourcb, hourch, hourcl, hourfr, hourot, hourre, hourtot, hperson, iagegr2, iagegr3," &
         "iagegr4, iagegrp, incseo2, indinc, indisben, inearns, ininv, inirben, innirben, inothben," &
         "inpeninc, inrinc, inrpinc, intvlic, intxcred, isacti, marital, mjobsect, ninanida, nincseo2," &
         "nindinc, ninearns, nininv, ninnirbn, ninothbn, ninpenin, ninrinc, ninsein2, nirel2, occupnum," &
         "pepscti, poaccti, pocardi, prevjobm, relhrp, sapadj, seincam2, smpadj, sppadj, sspadj," &
         "stshcti, taxpayer, tesscti, totgrant, tothours, totoccp, typeed2, untrcti, uperson, w45," &
         "widoccp, xbonflag, anxious, candgnow, curothf, curothp, curothwv, dvhiqual, gnvqnow, gpuc," &
         "happywb, hi1qual7, hi1qual8, mntarr5, mntnoch1, mntnoch2, mntnoch3, mntnoch4, mntnoch5, mntpro1," &
         "mntpro2, mntpro3, mnttim1, mnttim2, mnttim3, mntwrk1, mntwrk2, mntwrk3, mntwrk4, mntwrk5," &
         "ndeplnow, oqualc1, oqualc2, oqualc3, sruc, webacnow, indeth, euactive, euactno, euartact," &
         "euaskhlp, eucinema, eucultur, euinvol, eulivpe, eumtfam, eumtfrnd, eusocnet, eusport, eutkfam," &
         "eutkfrnd, eutkmat, euvol, natscot, ntsctnow, penwel1, penwel2, penwel3, penwel4, penwel5," &
         "penwel6, skiwknow, skiwrk, slos, yjblev, abs2no, accftpt, b2qfut1, b2qfut2, b2qfut3," &
         "b3qfut1, b3qfut2, b3qfut3, b3qfut4, b3qfut5, b3qfut6, ben1q1, ben1q2, ben1q3, ben1q4," &
         "ben1q5, ben1q6, ben1q7, ben2q1, ben2q2, ben2q3, ben3q1, ben3q2, ben3q3, ben3q4," &
         "ben3q5, ben3q6, ben4q1, ben4q2, ben4q3, ben5q1, ben5q2, ben5q3, ben5q4, ben5q5," &
         "ben5q6, ben7q1, ben7q2, ben7q3, ben7q4, ben7q5, ben7q6, ben7q7, ben7q8, ben7q9," &
         "btwacc, dentist, disdif1, disdif2, disdif3, disdif4, disdif5, disdif6, disdif7, disdif8," &
         "dptcboth, dptclum, ed1borr, ed1int, ed1monyr, ed2borr, ed2int, ed2monyr, edattn1, edattn2," &
         "edattn3, edtime, emppay1, emppay2, emppay3, endyr, epcur, ethgrp, exthbct2, exthbct3," &
         "eyetest, follow, future, govpis, govpjsa, hbothamt, hbothbu, hbothpd, hbothwk, hbotwait," &
         "health, hosp, hprob, isa3type, ln1rpint, ln2rpint, look, lookwk, mntct, mntfor1," &
         "mntfor2, mnttota1, mnttota2, natid1, natid2, natid3, natid4, natid5, natid6, ndeal," &
         "newdtype, nhs1, nhs2, nhs3, niethgrp, ninatid1, ninatid2, ninatid3, ninatid4, ninatid5," &
         "ninatid6, ninatid7, ninatid8, nirel, nitrain, nlper, nolook, ntcapp, ntcdat, ntcinc," &
         "ntcorig1, ntcorig2, ntcorig3, ntcorig4, ntcorig5, prit, prscrpt, soc2000, specs, startyr," &
         "taxcred1, taxcred2, taxcred3, taxcred4, taxcred5, taxfut, train, trav, voucher, war1," &
         "war2, wftcboth, wftclum, whyfrde1, whyfrde2, whyfrde3, whyfrde4, whyfrde5, whyfrde6, whyfrey1," &
         "whyfrey2, whyfrey3, whyfrey4, whyfrey5, whyfrey6, whyfrpr1, whyfrpr2, whyfrpr3, whyfrpr4, whyfrpr5," &
         "whyfrpr6, whytrav1, whytrav2, whytrav3, whytrav4, whytrav5, whytrav6, wmkit, wtclum3, addda," &
         "bntxcred, fsbndcti, fwmlkval, gross2, gross3, hbsupran, netocpen, nsbocti, otbscti, prbocti," &
         "sayecti, sclbcti, sscti, superan, ttwcosts, ben5q7, ben5q8, ben5q9, ddatre, disdif9," &
         "fare, nittwmod, oneway, pssamt, pssdate, ttwcode1, ttwcode2, ttwcode3, ttwcost, ttwfar," &
         "ttwfrq, ttwmod, ttwpay, ttwpss, ttwrec, crunaci, enomorti, ttwmode, ddatrep, disdifp," &
         "sfrpis, sfrpjsa, ethgr2, consent, dvpens, lnkref1, lnkref2, lnkref21, lnkref22, lnkref23," &
         "lnkref24, lnkref25, lnkref3, lnkref4, lnkref5, pconsent, lnkons, lnkref6, lnkref7, lnkref8," &
         "lnkref9, b3qfut7, ben3q7, ddaprog, hbolng, hi2qual, hlpgvn01, hlpgvn02, hlpgvn03, hlpgvn04," &
         "hlpgvn05, hlpgvn06, hlpgvn07, hlpgvn08, hlpgvn09, hlpgvn10, hlpgvn11, hlprec01, hlprec02, hlprec03," &
         "hlprec04, hlprec05, hlprec06, hlprec07, hlprec08, hlprec09, hlprec10, hlprec11, loangvn1, loangvn2," &
         "loangvn3, loanrec1, loanrec2, loanrec3, alg, algamt, algpd, ben4q4, disdifad, gross3_x," &
         "cbaamt, mednum, medprpd, medprpy, medpay, medrep, medrpnm " &
         " from frs.adult " ;
   ...
   use GNATCOLL.SQL_Impl;
      params : constant SQL_Parameters( 1 .. 927 ) := ( if update_order then (
            ...
            2 => ( Parameter_Integer, 0 ),   --  : abspar (Integer)
            3 => ( Parameter_Integer, 0 ),   --  : abspay (Integer)
            4 => ( Parameter_Integer, 0 ),   --  : abswhy (Integer)
            5 => ( Parameter_Integer, 0 ),   --  : abswk (Integer)
            6 => ( Parameter_Integer, 0 ),   --  : x_access (Integer)
            7 => ( Parameter_Integer, 0 ),   --  : accjb (Integer)
            8 => ( Parameter_Integer, 0 ),   --  : accmsat (Integer)
            9 => ( Parameter_Integer, 0 ),   --  : accountq (Integer)
           ...
           17 => ( Parameter_Integer, 0 ),   --  : agehqual (Integer)
           18 => ( Parameter_Float, 0.0 ),   --  : aliamt (Amount)
           19 => ( Parameter_Integer, 0 ),   --  : alimny (Integer)
           20 => ( Parameter_Integer, 0 ),   --  : alipd (Integer)
           21 => ( Parameter_Integer, 0 ),   --  : alius (Integer)
           22 => ( Parameter_Integer, 0 ),   --  : allow1 (Integer)
           23 => ( Parameter_Integer, 0 ),   --  : allow2 (Integer)
           24 => ( Parameter_Integer, 0 ),   --  : allow3 (Integer)
           25 => ( Parameter_Integer, 0 ),   --  : allow4 (Integer)
           26 => ( Parameter_Float, 0.0 ),   --  : allpay1 (Amount)
           27 => ( Parameter_Float, 0.0 ),   --  : allpay2 (Amount)
           28 => ( Parameter_Float, 0.0 ),   --  : allpay3 (Amount)
           29 => ( Parameter_Float, 0.0 ),   --  : allpay4 (Amount)
           30 => ( Parameter_Integer, 0 ),   --  : allpd1 (Integer)
           31 => ( Parameter_Integer, 0 ),   --  : allpd2 (Integer)
           32 => ( Parameter_Integer, 0 ),   --  : allpd3 (Integer)
           33 => ( Parameter_Integer, 0 ),   --  : allpd4 (Integer)
           34 => ( Parameter_Float, 0.0 ),   --  : aluamt (Amount)
           35 => ( Parameter_Integer, 0 ),   --  : alupd (Integer)
           36 => ( Parameter_Integer, 0 ),   --  : anyacc (Integer)
           37 => ( Parameter_Integer, 0 ),   --  : anyed (Integer)
           38 => ( Parameter_Integer, 0 ),   --  : anymon (Integer)
           39 => ( Parameter_Integer, 0 ),   --  : anypen1 (Integer)
           40 => ( Parameter_Integer, 0 ),   --  : anypen2 (Integer)
           41 => ( Parameter_Integer, 0 ),   --  : anypen3 (Integer)
           42 => ( Parameter_Integer, 0 ),   --  : anypen4 (Integer)
           43 => ( Parameter_Integer, 0 ),   --  : anypen5 (Integer)
           44 => ( Parameter_Integer, 0 ),   --  : anypen6 (Integer)
           45 => ( Parameter_Integer, 0 ),   --  : anypen7 (Integer)
           46 => ( Parameter_Float, 0.0 ),   --  : apamt (Amount)
           47 => ( Parameter_Float, 0.0 ),   --  : apdamt (Amount)
           48 => ( Parameter_Integer, 0 ),   --  : apdir (Integer)
           49 => ( Parameter_Integer, 0 ),   --  : apdpd (Integer)
           50 => ( Parameter_Integer, 0 ),   --  : appd (Integer)
           51 => ( Parameter_Integer, 0 ),   --  : bfd (Integer)
           52 => ( Parameter_Float, 0.0 ),   --  : bfdamt (Amount)
           53 => ( Parameter_Integer, 0 ),   --  : bfdpd (Integer)
           54 => ( Parameter_Integer, 0 ),   --  : bfdval (Integer)
           55 => ( Parameter_Integer, 0 ),   --  : btec (Integer)
           56 => ( Parameter_Integer, 0 ),   --  : btecnow (Integer)
           57 => ( Parameter_Integer, 0 ),   --  : c2orign (Integer)
           58 => ( Parameter_Integer, 0 ),   --  : calm (Integer)
           59 => ( Parameter_Integer, 0 ),   --  : camemt (Integer)
           60 => ( Parameter_Integer, 0 ),   --  : cameyr (Integer)
           61 => ( Parameter_Integer, 0 ),   --  : cameyr2 (Integer)
           62 => ( Parameter_Integer, 0 ),   --  : cbaamt2 (Integer)
           63 => ( Parameter_Integer, 0 ),   --  : cbchk (Integer)
           64 => ( Parameter_Integer, 0 ),   --  : change (Integer)
           65 => ( Parameter_Integer, 0 ),   --  : chkctc (Integer)
           66 => ( Parameter_Integer, 0 ),   --  : chkdpco1 (Integer)
           67 => ( Parameter_Integer, 0 ),   --  : chkdpco2 (Integer)
           68 => ( Parameter_Integer, 0 ),   --  : chkdpco3 (Integer)
           69 => ( Parameter_Integer, 0 ),   --  : chkdpn (Integer)
           70 => ( Parameter_Integer, 0 ),   --  : chkdsco1 (Integer)
           71 => ( Parameter_Integer, 0 ),   --  : chkdsco2 (Integer)
           72 => ( Parameter_Integer, 0 ),   --  : chkdsco3 (Integer)
           73 => ( Parameter_Integer, 0 ),   --  : chknop (Integer)
           74 => ( Parameter_Integer, 0 ),   --  : citizen (Integer)
           75 => ( Parameter_Integer, 0 ),   --  : citizen2 (Integer)
           76 => ( Parameter_Integer, 0 ),   --  : claifut1 (Integer)
           77 => ( Parameter_Integer, 0 ),   --  : claifut2 (Integer)
           78 => ( Parameter_Integer, 0 ),   --  : claifut3 (Integer)
           79 => ( Parameter_Integer, 0 ),   --  : claifut4 (Integer)
           80 => ( Parameter_Integer, 0 ),   --  : claifut5 (Integer)
           81 => ( Parameter_Integer, 0 ),   --  : claifut6 (Integer)
           82 => ( Parameter_Integer, 0 ),   --  : claifut7 (Integer)
           83 => ( Parameter_Integer, 0 ),   --  : claifut8 (Integer)
           84 => ( Parameter_Integer, 0 ),   --  : claimant (Integer)
           85 => ( Parameter_Integer, 0 ),   --  : cohabit (Integer)
           86 => ( Parameter_Integer, 0 ),   --  : combid (Integer)
           87 => ( Parameter_Integer, 0 ),   --  : commusat (Integer)
           88 => ( Parameter_Integer, 0 ),   --  : condit (Integer)
           89 => ( Parameter_Integer, 0 ),   --  : contuk (Integer)
           90 => ( Parameter_Integer, 0 ),   --  : convbl (Integer)
           91 => ( Parameter_Integer, 0 ),   --  : coptrust (Integer)
           92 => ( Parameter_Integer, 0 ),   --  : corign (Integer)
           93 => ( Parameter_Integer, 0 ),   --  : corigoth (Integer)
           94 => ( Parameter_Integer, 0 ),   --  : ctclum1 (Integer)
           95 => ( Parameter_Integer, 0 ),   --  : ctclum2 (Integer)
           96 => ( Parameter_Integer, 0 ),   --  : cupchk (Integer)
           97 => ( Parameter_Integer, 0 ),   --  : curqual (Integer)
           98 => ( Parameter_Integer, 0 ),   --  : cvht (Integer)
           99 => ( Parameter_Float, 0.0 ),   --  : cvpay (Amount)
           100 => ( Parameter_Integer, 0 ),   --  : cvpd (Integer)
           101 => ( Parameter_Integer, 0 ),   --  : ddaprog1 (Integer)
           102 => ( Parameter_Integer, 0 ),   --  : ddatre1 (Integer)
           103 => ( Parameter_Integer, 0 ),   --  : ddatrep1 (Integer)
           104 => ( Parameter_Integer, 0 ),   --  : defrpen (Integer)
           105 => ( Parameter_Integer, 0 ),   --  : degree (Integer)
           106 => ( Parameter_Integer, 0 ),   --  : degrenow (Integer)
           107 => ( Parameter_Integer, 0 ),   --  : denrec (Integer)
           108 => ( Parameter_Integer, 0 ),   --  : depend (Integer)
           109 => ( Parameter_Integer, 0 ),   --  : depress (Integer)
           110 => ( Parameter_Integer, 0 ),   --  : disben1 (Integer)
           111 => ( Parameter_Integer, 0 ),   --  : disben2 (Integer)
           112 => ( Parameter_Integer, 0 ),   --  : disben3 (Integer)
           113 => ( Parameter_Integer, 0 ),   --  : disben4 (Integer)
           114 => ( Parameter_Integer, 0 ),   --  : disben5 (Integer)
           115 => ( Parameter_Integer, 0 ),   --  : disben6 (Integer)
           116 => ( Parameter_Integer, 0 ),   --  : discuss (Integer)
           117 => ( Parameter_Integer, 0 ),   --  : disd01 (Integer)
           118 => ( Parameter_Integer, 0 ),   --  : disd02 (Integer)
           119 => ( Parameter_Integer, 0 ),   --  : disd03 (Integer)
           120 => ( Parameter_Integer, 0 ),   --  : disd04 (Integer)
           121 => ( Parameter_Integer, 0 ),   --  : disd05 (Integer)
           122 => ( Parameter_Integer, 0 ),   --  : disd06 (Integer)
           123 => ( Parameter_Integer, 0 ),   --  : disd07 (Integer)
           124 => ( Parameter_Integer, 0 ),   --  : disd08 (Integer)
           125 => ( Parameter_Integer, 0 ),   --  : disd09 (Integer)
           126 => ( Parameter_Integer, 0 ),   --  : disd10 (Integer)
           127 => ( Parameter_Integer, 0 ),   --  : disdifp1 (Integer)
           128 => ( Parameter_Integer, 0 ),   --  : dla1 (Integer)
           129 => ( Parameter_Integer, 0 ),   --  : dla2 (Integer)
           130 => ( Parameter_Integer, 0 ),   --  : dls (Integer)
           131 => ( Parameter_Float, 0.0 ),   --  : dlsamt (Amount)
           132 => ( Parameter_Integer, 0 ),   --  : dlspd (Integer)
           133 => ( Parameter_Integer, 0 ),   --  : dlsval (Integer)
           134 => ( Parameter_Date, Clock ),   --  : dob (Ada.Calendar.Time)
           135 => ( Parameter_Integer, 0 ),   --  : down (Integer)
           136 => ( Parameter_Integer, 0 ),   --  : dv09pens (Integer)
           137 => ( Parameter_Integer, 0 ),   --  : dvil03a (Integer)
           138 => ( Parameter_Integer, 0 ),   --  : dvil04a (Integer)
           139 => ( Parameter_Integer, 0 ),   --  : dvjb12ml (Integer)
           140 => ( Parameter_Integer, 0 ),   --  : dvmardf (Integer)
           141 => ( Parameter_Float, 0.0 ),   --  : ed1amt (Amount)
           142 => ( Parameter_Integer, 0 ),   --  : ed1pd (Integer)
           143 => ( Parameter_Integer, 0 ),   --  : ed1sum (Integer)
           144 => ( Parameter_Float, 0.0 ),   --  : ed2amt (Amount)
           145 => ( Parameter_Integer, 0 ),   --  : ed2pd (Integer)
           146 => ( Parameter_Integer, 0 ),   --  : ed2sum (Integer)
           147 => ( Parameter_Integer, 0 ),   --  : edatt (Integer)
           148 => ( Parameter_Integer, 0 ),   --  : edhr (Integer)
           149 => ( Parameter_Integer, 0 ),   --  : edtyp (Integer)
           150 => ( Parameter_Integer, 0 ),   --  : eligadlt (Integer)
           151 => ( Parameter_Integer, 0 ),   --  : eligchld (Integer)
           152 => ( Parameter_Integer, 0 ),   --  : eligschm (Integer)
           153 => ( Parameter_Integer, 0 ),   --  : emparr (Integer)
           154 => ( Parameter_Integer, 0 ),   --  : empcontr (Integer)
           155 => ( Parameter_Integer, 0 ),   --  : emppen (Integer)
           156 => ( Parameter_Integer, 0 ),   --  : empschm (Integer)
           157 => ( Parameter_Integer, 0 ),   --  : empstat (Integer)
           158 => ( Parameter_Integer, 0 ),   --  : envirsat (Integer)
           159 => ( Parameter_Integer, 0 ),   --  : es2000 (Integer)
           160 => ( Parameter_Integer, 0 ),   --  : ethgrps (Integer)
           161 => ( Parameter_Integer, 0 ),   --  : etngrp (Integer)
           162 => ( Parameter_Float, 0.0 ),   --  : eualiamt (Amount)
           163 => ( Parameter_Integer, 0 ),   --  : eualimny (Integer)
           164 => ( Parameter_Integer, 0 ),   --  : eualipd (Integer)
           165 => ( Parameter_Integer, 0 ),   --  : euetype (Integer)
           166 => ( Parameter_Integer, 0 ),   --  : everwrk (Integer)
           167 => ( Parameter_Integer, 0 ),   --  : exthbct1 (Integer)
           168 => ( Parameter_Integer, 0 ),   --  : followsc (Integer)
           169 => ( Parameter_Integer, 0 ),   --  : followup (Integer)
           170 => ( Parameter_Integer, 0 ),   --  : fted (Integer)
           171 => ( Parameter_Integer, 0 ),   --  : ftwk (Integer)
           172 => ( Parameter_Integer, 0 ),   --  : gpispc (Integer)
           173 => ( Parameter_Integer, 0 ),   --  : gpjsaesa (Integer)
           174 => ( Parameter_Integer, 0 ),   --  : x_grant (Integer)
           175 => ( Parameter_Float, 0.0 ),   --  : grtamt1 (Amount)
           176 => ( Parameter_Float, 0.0 ),   --  : grtamt2 (Amount)
           177 => ( Parameter_Float, 0.0 ),   --  : grtdir1 (Amount)
           178 => ( Parameter_Float, 0.0 ),   --  : grtdir2 (Amount)
           179 => ( Parameter_Integer, 0 ),   --  : grtnum (Integer)
           180 => ( Parameter_Integer, 0 ),   --  : grtsce1 (Integer)
           181 => ( Parameter_Integer, 0 ),   --  : grtsce2 (Integer)
           182 => ( Parameter_Float, 0.0 ),   --  : grtval1 (Amount)
           183 => ( Parameter_Float, 0.0 ),   --  : grtval2 (Amount)
           184 => ( Parameter_Integer, 0 ),   --  : gta (Integer)
           185 => ( Parameter_Integer, 0 ),   --  : happy (Integer)
           186 => ( Parameter_Integer, 0 ),   --  : health1 (Integer)
           187 => ( Parameter_Integer, 0 ),   --  : heathad (Integer)
           188 => ( Parameter_Integer, 0 ),   --  : help (Integer)
           189 => ( Parameter_Integer, 0 ),   --  : hholder (Integer)
           190 => ( Parameter_Integer, 0 ),   --  : hi1qual1 (Integer)
           191 => ( Parameter_Integer, 0 ),   --  : hi1qual2 (Integer)
           192 => ( Parameter_Integer, 0 ),   --  : hi1qual3 (Integer)
           193 => ( Parameter_Integer, 0 ),   --  : hi1qual4 (Integer)
           194 => ( Parameter_Integer, 0 ),   --  : hi1qual5 (Integer)
           195 => ( Parameter_Integer, 0 ),   --  : hi1qual6 (Integer)
           196 => ( Parameter_Integer, 0 ),   --  : hi3qual (Integer)
           197 => ( Parameter_Integer, 0 ),   --  : higho (Integer)
           198 => ( Parameter_Integer, 0 ),   --  : highonow (Integer)
           199 => ( Parameter_Integer, 0 ),   --  : hrpid (Integer)
           200 => ( Parameter_Integer, 0 ),   --  : hsvper (Integer)
           201 => ( Parameter_Integer, 0 ),   --  : iclaim1 (Integer)
           202 => ( Parameter_Integer, 0 ),   --  : iclaim2 (Integer)
           203 => ( Parameter_Integer, 0 ),   --  : iclaim3 (Integer)
           204 => ( Parameter_Integer, 0 ),   --  : iclaim4 (Integer)
           205 => ( Parameter_Integer, 0 ),   --  : iclaim5 (Integer)
           206 => ( Parameter_Integer, 0 ),   --  : iclaim6 (Integer)
           207 => ( Parameter_Integer, 0 ),   --  : iclaim7 (Integer)
           208 => ( Parameter_Integer, 0 ),   --  : iclaim8 (Integer)
           209 => ( Parameter_Integer, 0 ),   --  : iclaim9 (Integer)
           210 => ( Parameter_Integer, 0 ),   --  : incdur (Integer)
           211 => ( Parameter_Integer, 0 ),   --  : injlong (Integer)
           212 => ( Parameter_Integer, 0 ),   --  : injwk (Integer)
           213 => ( Parameter_Integer, 0 ),   --  : invests (Integer)
           214 => ( Parameter_Integer, 0 ),   --  : iout (Integer)
           215 => ( Parameter_Integer, 0 ),   --  : isa1type (Integer)
           216 => ( Parameter_Integer, 0 ),   --  : isa2type (Integer)
           217 => ( Parameter_Integer, 0 ),   --  : issue (Integer)
           218 => ( Parameter_Integer, 0 ),   --  : jobaway (Integer)
           219 => ( Parameter_Integer, 0 ),   --  : jobbyr (Integer)
           220 => ( Parameter_Integer, 0 ),   --  : jobsat (Integer)
           221 => ( Parameter_Integer, 0 ),   --  : kidben1 (Integer)
           222 => ( Parameter_Integer, 0 ),   --  : kidben2 (Integer)
           223 => ( Parameter_Integer, 0 ),   --  : kidben3 (Integer)
           224 => ( Parameter_Integer, 0 ),   --  : lareg (Integer)
           225 => ( Parameter_Integer, 0 ),   --  : legltrus (Integer)
           226 => ( Parameter_Integer, 0 ),   --  : lifesat (Integer)
           227 => ( Parameter_Integer, 0 ),   --  : likewk (Integer)
           228 => ( Parameter_Integer, 0 ),   --  : limitl (Integer)
           229 => ( Parameter_Integer, 0 ),   --  : lktime (Integer)
           230 => ( Parameter_Integer, 0 ),   --  : lktrain (Integer)
           231 => ( Parameter_Integer, 0 ),   --  : lkwork (Integer)
           232 => ( Parameter_Integer, 0 ),   --  : lnkdwp (Integer)
           233 => ( Parameter_Integer, 0 ),   --  : lnkref01 (Integer)
           234 => ( Parameter_Integer, 0 ),   --  : lnkref02 (Integer)
           235 => ( Parameter_Integer, 0 ),   --  : lnkref03 (Integer)
           236 => ( Parameter_Integer, 0 ),   --  : lnkref04 (Integer)
           237 => ( Parameter_Integer, 0 ),   --  : lnkref05 (Integer)
           238 => ( Parameter_Integer, 0 ),   --  : lnkref06 (Integer)
           239 => ( Parameter_Integer, 0 ),   --  : lnkref07 (Integer)
           240 => ( Parameter_Integer, 0 ),   --  : lnkref08 (Integer)
           241 => ( Parameter_Integer, 0 ),   --  : lnkref09 (Integer)
           242 => ( Parameter_Integer, 0 ),   --  : lnkref10 (Integer)
           243 => ( Parameter_Integer, 0 ),   --  : lnkref11 (Integer)
           244 => ( Parameter_Integer, 0 ),   --  : loan (Integer)
           245 => ( Parameter_Integer, 0 ),   --  : loannum (Integer)
           246 => ( Parameter_Integer, 0 ),   --  : lstwrk1 (Integer)
           247 => ( Parameter_Integer, 0 ),   --  : lstwrk2 (Integer)
           248 => ( Parameter_Integer, 0 ),   --  : lstyr (Integer)
           249 => ( Parameter_Integer, 0 ),   --  : meaning (Integer)
           250 => ( Parameter_Integer, 0 ),   --  : medrec (Integer)
           251 => ( Parameter_Integer, 0 ),   --  : memschm (Integer)
           252 => ( Parameter_Float, 0.0 ),   --  : mntamt1 (Amount)
           253 => ( Parameter_Float, 0.0 ),   --  : mntamt2 (Amount)
           254 => ( Parameter_Integer, 0 ),   --  : mntarr1 (Integer)
           255 => ( Parameter_Integer, 0 ),   --  : mntarr2 (Integer)
           256 => ( Parameter_Integer, 0 ),   --  : mntarr3 (Integer)
           257 => ( Parameter_Integer, 0 ),   --  : mntarr4 (Integer)
           258 => ( Parameter_Integer, 0 ),   --  : mntgov1 (Integer)
           259 => ( Parameter_Integer, 0 ),   --  : mntgov2 (Integer)
           260 => ( Parameter_Integer, 0 ),   --  : mntnrp (Integer)
           261 => ( Parameter_Integer, 0 ),   --  : mntpay (Integer)
           262 => ( Parameter_Integer, 0 ),   --  : mntpd1 (Integer)
           263 => ( Parameter_Integer, 0 ),   --  : mntpd2 (Integer)
           264 => ( Parameter_Integer, 0 ),   --  : mntrec (Integer)
           265 => ( Parameter_Integer, 0 ),   --  : mntus1 (Integer)
           266 => ( Parameter_Integer, 0 ),   --  : mntus2 (Integer)
           267 => ( Parameter_Float, 0.0 ),   --  : mntusam1 (Amount)
           268 => ( Parameter_Float, 0.0 ),   --  : mntusam2 (Amount)
           269 => ( Parameter_Integer, 0 ),   --  : mntuspd1 (Integer)
           270 => ( Parameter_Integer, 0 ),   --  : mntuspd2 (Integer)
           271 => ( Parameter_Integer, 0 ),   --  : moneysat (Integer)
           272 => ( Parameter_Integer, 0 ),   --  : ms (Integer)
           273 => ( Parameter_Integer, 0 ),   --  : nanid1 (Integer)
           274 => ( Parameter_Integer, 0 ),   --  : nanid2 (Integer)
           275 => ( Parameter_Integer, 0 ),   --  : nanid3 (Integer)
           276 => ( Parameter_Integer, 0 ),   --  : nanid4 (Integer)
           277 => ( Parameter_Integer, 0 ),   --  : nanid5 (Integer)
           278 => ( Parameter_Integer, 0 ),   --  : nanid6 (Integer)
           279 => ( Parameter_Integer, 0 ),   --  : nervous (Integer)
           280 => ( Parameter_Integer, 0 ),   --  : ni2train (Integer)
           281 => ( Parameter_Float, 0.0 ),   --  : niamt (Amount)
           282 => ( Parameter_Integer, 0 ),   --  : nietngrp (Integer)
           283 => ( Parameter_Integer, 0 ),   --  : niexthbb (Integer)
           284 => ( Parameter_Integer, 0 ),   --  : ninanid1 (Integer)
           285 => ( Parameter_Integer, 0 ),   --  : ninanid2 (Integer)
           286 => ( Parameter_Integer, 0 ),   --  : ninanid3 (Integer)
           287 => ( Parameter_Integer, 0 ),   --  : ninanid4 (Integer)
           288 => ( Parameter_Integer, 0 ),   --  : ninanid5 (Integer)
           289 => ( Parameter_Integer, 0 ),   --  : ninanid6 (Integer)
           290 => ( Parameter_Integer, 0 ),   --  : ninanid7 (Integer)
           291 => ( Parameter_Integer, 0 ),   --  : nipd (Integer)
           292 => ( Parameter_Integer, 0 ),   --  : nireg (Integer)
           293 => ( Parameter_Integer, 0 ),   --  : nirelig (Integer)
           294 => ( Parameter_Integer, 0 ),   --  : nolk1 (Integer)
           295 => ( Parameter_Integer, 0 ),   --  : nolk2 (Integer)
           296 => ( Parameter_Integer, 0 ),   --  : nolk3 (Integer)
           297 => ( Parameter_Integer, 0 ),   --  : nowant (Integer)
           298 => ( Parameter_Float, 0.0 ),   --  : nssec (Amount)
           299 => ( Parameter_Integer, 0 ),   --  : numjob (Integer)
           300 => ( Parameter_Integer, 0 ),   --  : numjob2 (Integer)
           301 => ( Parameter_Integer, 0 ),   --  : nvqlenow (Integer)
           302 => ( Parameter_Integer, 0 ),   --  : nvqlev (Integer)
           303 => ( Parameter_Integer, 0 ),   --  : oddjob (Integer)
           304 => ( Parameter_Integer, 0 ),   --  : oldstud (Integer)
           305 => ( Parameter_Integer, 0 ),   --  : otabspar (Integer)
           306 => ( Parameter_Float, 0.0 ),   --  : otamt (Amount)
           307 => ( Parameter_Float, 0.0 ),   --  : otapamt (Amount)
           308 => ( Parameter_Integer, 0 ),   --  : otappd (Integer)
           309 => ( Parameter_Integer, 0 ),   --  : othben1 (Integer)
           310 => ( Parameter_Integer, 0 ),   --  : othben2 (Integer)
           311 => ( Parameter_Integer, 0 ),   --  : othben3 (Integer)
           312 => ( Parameter_Integer, 0 ),   --  : othben4 (Integer)
           313 => ( Parameter_Integer, 0 ),   --  : othben5 (Integer)
           314 => ( Parameter_Integer, 0 ),   --  : othben6 (Integer)
           315 => ( Parameter_Integer, 0 ),   --  : othpass (Integer)
           316 => ( Parameter_Integer, 0 ),   --  : othqual1 (Integer)
           317 => ( Parameter_Integer, 0 ),   --  : othqual2 (Integer)
           318 => ( Parameter_Integer, 0 ),   --  : othqual3 (Integer)
           319 => ( Parameter_Integer, 0 ),   --  : othtax (Integer)
           320 => ( Parameter_Integer, 0 ),   --  : othtrust (Integer)
           321 => ( Parameter_Integer, 0 ),   --  : otinva (Integer)
           322 => ( Parameter_Float, 0.0 ),   --  : pareamt (Amount)
           323 => ( Parameter_Integer, 0 ),   --  : parepd (Integer)
           324 => ( Parameter_Integer, 0 ),   --  : penben1 (Integer)
           325 => ( Parameter_Integer, 0 ),   --  : penben2 (Integer)
           326 => ( Parameter_Integer, 0 ),   --  : penben3 (Integer)
           327 => ( Parameter_Integer, 0 ),   --  : penben4 (Integer)
           328 => ( Parameter_Integer, 0 ),   --  : penben5 (Integer)
           329 => ( Parameter_Integer, 0 ),   --  : penflag (Integer)
           330 => ( Parameter_Integer, 0 ),   --  : penlump (Integer)
           331 => ( Parameter_Integer, 0 ),   --  : perspen1 (Integer)
           332 => ( Parameter_Integer, 0 ),   --  : perspen2 (Integer)
           333 => ( Parameter_Integer, 0 ),   --  : pip1 (Integer)
           334 => ( Parameter_Integer, 0 ),   --  : pip2 (Integer)
           335 => ( Parameter_Integer, 0 ),   --  : pollopin (Integer)
           336 => ( Parameter_Integer, 0 ),   --  : polttrus (Integer)
           337 => ( Parameter_Integer, 0 ),   --  : ppchk1 (Integer)
           338 => ( Parameter_Integer, 0 ),   --  : ppchk2 (Integer)
           339 => ( Parameter_Integer, 0 ),   --  : ppchk3 (Integer)
           340 => ( Parameter_Integer, 0 ),   --  : ppnumc (Integer)
           341 => ( Parameter_Integer, 0 ),   --  : ppper (Integer)
           342 => ( Parameter_Integer, 0 ),   --  : practice (Integer)
           343 => ( Parameter_Integer, 0 ),   --  : privpen (Integer)
           344 => ( Parameter_Float, 0.0 ),   --  : proptax (Amount)
           345 => ( Parameter_Integer, 0 ),   --  : ptwk (Integer)
           346 => ( Parameter_Integer, 0 ),   --  : r01 (Integer)
           347 => ( Parameter_Integer, 0 ),   --  : r02 (Integer)
           348 => ( Parameter_Integer, 0 ),   --  : r03 (Integer)
           349 => ( Parameter_Integer, 0 ),   --  : r04 (Integer)
           350 => ( Parameter_Integer, 0 ),   --  : r05 (Integer)
           351 => ( Parameter_Integer, 0 ),   --  : r06 (Integer)
           352 => ( Parameter_Integer, 0 ),   --  : r07 (Integer)
           353 => ( Parameter_Integer, 0 ),   --  : r08 (Integer)
           354 => ( Parameter_Integer, 0 ),   --  : r09 (Integer)
           355 => ( Parameter_Integer, 0 ),   --  : r10 (Integer)
           356 => ( Parameter_Integer, 0 ),   --  : r11 (Integer)
           357 => ( Parameter_Integer, 0 ),   --  : r12 (Integer)
           358 => ( Parameter_Integer, 0 ),   --  : r13 (Integer)
           359 => ( Parameter_Integer, 0 ),   --  : r14 (Integer)
           360 => ( Parameter_Integer, 0 ),   --  : reasden (Integer)
           361 => ( Parameter_Integer, 0 ),   --  : reasmed (Integer)
           362 => ( Parameter_Integer, 0 ),   --  : reasnhs (Integer)
           363 => ( Parameter_Integer, 0 ),   --  : reason (Integer)
           364 => ( Parameter_Integer, 0 ),   --  : recsat (Integer)
           365 => ( Parameter_Float, 0.0 ),   --  : redamt (Amount)
           366 => ( Parameter_Integer, 0 ),   --  : redany (Integer)
           367 => ( Parameter_Integer, 0 ),   --  : rednet (Integer)
           368 => ( Parameter_Float, 0.0 ),   --  : redtax (Amount)
           369 => ( Parameter_Integer, 0 ),   --  : relasat (Integer)
           370 => ( Parameter_Integer, 0 ),   --  : religenw (Integer)
           371 => ( Parameter_Integer, 0 ),   --  : religsc (Integer)
           372 => ( Parameter_Integer, 0 ),   --  : rentprof (Integer)
           373 => ( Parameter_Integer, 0 ),   --  : retire (Integer)
           374 => ( Parameter_Integer, 0 ),   --  : retire1 (Integer)
           375 => ( Parameter_Integer, 0 ),   --  : retreas (Integer)
           376 => ( Parameter_Integer, 0 ),   --  : royal1 (Integer)
           377 => ( Parameter_Integer, 0 ),   --  : royal2 (Integer)
           378 => ( Parameter_Integer, 0 ),   --  : royal3 (Integer)
           379 => ( Parameter_Integer, 0 ),   --  : royal4 (Integer)
           380 => ( Parameter_Float, 0.0 ),   --  : royyr1 (Amount)
           381 => ( Parameter_Float, 0.0 ),   --  : royyr2 (Amount)
           382 => ( Parameter_Float, 0.0 ),   --  : royyr3 (Amount)
           383 => ( Parameter_Float, 0.0 ),   --  : royyr4 (Amount)
           384 => ( Parameter_Integer, 0 ),   --  : rsa (Integer)
           385 => ( Parameter_Integer, 0 ),   --  : rsanow (Integer)
           386 => ( Parameter_Integer, 0 ),   --  : rstrct (Integer)
           387 => ( Parameter_Integer, 0 ),   --  : safe (Integer)
           388 => ( Parameter_Integer, 0 ),   --  : samesit (Integer)
           389 => ( Parameter_Integer, 0 ),   --  : schchk (Integer)
           390 => ( Parameter_Integer, 0 ),   --  : scotvec (Integer)
           391 => ( Parameter_Integer, 0 ),   --  : sctvnow (Integer)
           392 => ( Parameter_Integer, 0 ),   --  : sdemp01 (Integer)
           393 => ( Parameter_Integer, 0 ),   --  : sdemp02 (Integer)
           394 => ( Parameter_Integer, 0 ),   --  : sdemp03 (Integer)
           395 => ( Parameter_Integer, 0 ),   --  : sdemp04 (Integer)
           396 => ( Parameter_Integer, 0 ),   --  : sdemp05 (Integer)
           397 => ( Parameter_Integer, 0 ),   --  : sdemp06 (Integer)
           398 => ( Parameter_Integer, 0 ),   --  : sdemp07 (Integer)
           399 => ( Parameter_Integer, 0 ),   --  : sdemp08 (Integer)
           400 => ( Parameter_Integer, 0 ),   --  : sdemp09 (Integer)
           401 => ( Parameter_Integer, 0 ),   --  : sdemp10 (Integer)
           402 => ( Parameter_Integer, 0 ),   --  : sdemp11 (Integer)
           403 => ( Parameter_Integer, 0 ),   --  : sdemp12 (Integer)
           404 => ( Parameter_Integer, 0 ),   --  : selfdemp (Integer)
           405 => ( Parameter_Integer, 0 ),   --  : sex (Integer)
           406 => ( Parameter_Integer, 0 ),   --  : sflntyp1 (Integer)
           407 => ( Parameter_Integer, 0 ),   --  : sflntyp2 (Integer)
           408 => ( Parameter_Integer, 0 ),   --  : sftype1 (Integer)
           409 => ( Parameter_Integer, 0 ),   --  : sftype2 (Integer)
           410 => ( Parameter_Integer, 0 ),   --  : sic (Integer)
           411 => ( Parameter_Integer, 0 ),   --  : sidqn (Integer)
           412 => ( Parameter_Float, 0.0 ),   --  : slrepamt (Amount)
           413 => ( Parameter_Integer, 0 ),   --  : slrepay (Integer)
           414 => ( Parameter_Integer, 0 ),   --  : slreppd (Integer)
           415 => ( Parameter_Integer, 0 ),   --  : soc2010 (Integer)
           416 => ( Parameter_Integer, 0 ),   --  : socfund1 (Integer)
           417 => ( Parameter_Integer, 0 ),   --  : socfund2 (Integer)
           418 => ( Parameter_Integer, 0 ),   --  : socfund3 (Integer)
           419 => ( Parameter_Integer, 0 ),   --  : socfund4 (Integer)
           420 => ( Parameter_Integer, 0 ),   --  : spcreg1 (Integer)
           421 => ( Parameter_Integer, 0 ),   --  : spcreg2 (Integer)
           422 => ( Parameter_Integer, 0 ),   --  : spcreg3 (Integer)
           423 => ( Parameter_Integer, 0 ),   --  : spnumc (Integer)
           424 => ( Parameter_Integer, 0 ),   --  : spout (Integer)
           425 => ( Parameter_Integer, 0 ),   --  : spyrot (Integer)
           426 => ( Parameter_Float, 0.0 ),   --  : srentamt (Amount)
           427 => ( Parameter_Integer, 0 ),   --  : srentpd (Integer)
           428 => ( Parameter_Integer, 0 ),   --  : srispc (Integer)
           429 => ( Parameter_Integer, 0 ),   --  : srjsaesa (Integer)
           430 => ( Parameter_Integer, 0 ),   --  : stakep (Integer)
           431 => ( Parameter_Integer, 0 ),   --  : start (Integer)
           432 => ( Parameter_Integer, 0 ),   --  : tcever1 (Integer)
           433 => ( Parameter_Integer, 0 ),   --  : tcever2 (Integer)
           434 => ( Parameter_Integer, 0 ),   --  : tcrepay1 (Integer)
           435 => ( Parameter_Integer, 0 ),   --  : tcrepay2 (Integer)
           436 => ( Parameter_Integer, 0 ),   --  : tcrepay3 (Integer)
           437 => ( Parameter_Integer, 0 ),   --  : tcrepay4 (Integer)
           438 => ( Parameter_Integer, 0 ),   --  : tcrepay5 (Integer)
           439 => ( Parameter_Integer, 0 ),   --  : tcrepay6 (Integer)
           440 => ( Parameter_Integer, 0 ),   --  : tcthsyr1 (Integer)
           441 => ( Parameter_Integer, 0 ),   --  : tcthsyr2 (Integer)
           442 => ( Parameter_Integer, 0 ),   --  : tdaywrk (Integer)
           443 => ( Parameter_Integer, 0 ),   --  : tea (Integer)
           444 => ( Parameter_Integer, 0 ),   --  : tea9697 (Integer)
           445 => ( Parameter_Integer, 0 ),   --  : tempjob (Integer)
           446 => ( Parameter_Integer, 0 ),   --  : timesat (Integer)
           447 => ( Parameter_Integer, 0 ),   --  : topupl (Integer)
           448 => ( Parameter_Float, 0.0 ),   --  : totint (Amount)
           449 => ( Parameter_Integer, 0 ),   --  : train2 (Integer)
           450 => ( Parameter_Integer, 0 ),   --  : trainee (Integer)
           451 => ( Parameter_Integer, 0 ),   --  : trnallow (Integer)
           452 => ( Parameter_Float, 0.0 ),   --  : ttbprx (Amount)
           453 => ( Parameter_Integer, 0 ),   --  : tuborr (Integer)
           454 => ( Parameter_Integer, 0 ),   --  : typeed (Integer)
           455 => ( Parameter_Integer, 0 ),   --  : unpaid1 (Integer)
           456 => ( Parameter_Integer, 0 ),   --  : unpaid2 (Integer)
           457 => ( Parameter_Integer, 0 ),   --  : w1 (Integer)
           458 => ( Parameter_Integer, 0 ),   --  : w2 (Integer)
           459 => ( Parameter_Integer, 0 ),   --  : wageben1 (Integer)
           460 => ( Parameter_Integer, 0 ),   --  : wageben2 (Integer)
           461 => ( Parameter_Integer, 0 ),   --  : wageben3 (Integer)
           462 => ( Parameter_Integer, 0 ),   --  : wageben4 (Integer)
           463 => ( Parameter_Integer, 0 ),   --  : wageben5 (Integer)
           464 => ( Parameter_Integer, 0 ),   --  : wageben6 (Integer)
           465 => ( Parameter_Integer, 0 ),   --  : wageben7 (Integer)
           466 => ( Parameter_Integer, 0 ),   --  : wageben8 (Integer)
           467 => ( Parameter_Integer, 0 ),   --  : wait (Integer)
           468 => ( Parameter_Integer, 0 ),   --  : whoresp (Integer)
           469 => ( Parameter_Integer, 0 ),   --  : whosectb (Integer)
           470 => ( Parameter_Integer, 0 ),   --  : wintfuel (Integer)
           471 => ( Parameter_Integer, 0 ),   --  : working (Integer)
           472 => ( Parameter_Integer, 0 ),   --  : wpa (Integer)
           473 => ( Parameter_Integer, 0 ),   --  : wpba (Integer)
           474 => ( Parameter_Integer, 0 ),   --  : wtclum1 (Integer)
           475 => ( Parameter_Integer, 0 ),   --  : wtclum2 (Integer)
           476 => ( Parameter_Integer, 0 ),   --  : ystrtwk (Integer)
           477 => ( Parameter_Integer, 0 ),   --  : month (Integer)
           478 => ( Parameter_Integer, 0 ),   --  : able (Integer)
           479 => ( Parameter_Integer, 0 ),   --  : actacci (Integer)
           480 => ( Parameter_Integer, 0 ),   --  : age80 (Integer)
           481 => ( Parameter_Integer, 0 ),   --  : agehq80 (Integer)
           482 => ( Parameter_Integer, 0 ),   --  : basacti (Integer)
           483 => ( Parameter_Integer, 0 ),   --  : careab (Integer)
           484 => ( Parameter_Integer, 0 ),   --  : careah (Integer)
           485 => ( Parameter_Integer, 0 ),   --  : carecb (Integer)
           486 => ( Parameter_Integer, 0 ),   --  : carech (Integer)
           487 => ( Parameter_Integer, 0 ),   --  : carecl (Integer)
           488 => ( Parameter_Integer, 0 ),   --  : carefl (Integer)
           489 => ( Parameter_Integer, 0 ),   --  : carefr (Integer)
           490 => ( Parameter_Integer, 0 ),   --  : careot (Integer)
           491 => ( Parameter_Integer, 0 ),   --  : carere (Integer)
           492 => ( Parameter_Integer, 0 ),   --  : chbflg (Integer)
           493 => ( Parameter_Integer, 0 ),   --  : corignan (Integer)
           494 => ( Parameter_Integer, 0 ),   --  : curacti (Integer)
           495 => ( Parameter_Integer, 0 ),   --  : currjobm (Integer)
           496 => ( Parameter_Integer, 0 ),   --  : disacta1 (Integer)
           497 => ( Parameter_Integer, 0 ),   --  : discora1 (Integer)
           498 => ( Parameter_Integer, 0 ),   --  : dobmonth (Integer)
           499 => ( Parameter_Integer, 0 ),   --  : dobyear (Integer)
           500 => ( Parameter_Float, 0.0 ),   --  : empoccp (Amount)
           501 => ( Parameter_Integer, 0 ),   --  : empstatb (Integer)
           502 => ( Parameter_Integer, 0 ),   --  : empstatc (Integer)
           503 => ( Parameter_Integer, 0 ),   --  : empstati (Integer)
           504 => ( Parameter_Integer, 0 ),   --  : ethgr3 (Integer)
           505 => ( Parameter_Integer, 0 ),   --  : gebacti (Integer)
           506 => ( Parameter_Integer, 0 ),   --  : giltcti (Integer)
           507 => ( Parameter_Integer, 0 ),   --  : gross4 (Integer)
           508 => ( Parameter_Integer, 0 ),   --  : hdage (Integer)
           509 => ( Parameter_Integer, 0 ),   --  : hdben (Integer)
           510 => ( Parameter_Integer, 0 ),   --  : hdindinc (Integer)
           511 => ( Parameter_Float, 0.0 ),   --  : heartval (Amount)
           512 => ( Parameter_Integer, 0 ),   --  : hourab (Integer)
           513 => ( Parameter_Integer, 0 ),   --  : hourah (Integer)
           514 => ( Parameter_Float, 0.0 ),   --  : hourcare (Amount)
           515 => ( Parameter_Integer, 0 ),   --  : hourcb (Integer)
           516 => ( Parameter_Integer, 0 ),   --  : hourch (Integer)
           517 => ( Parameter_Integer, 0 ),   --  : hourcl (Integer)
           518 => ( Parameter_Integer, 0 ),   --  : hourfr (Integer)
           519 => ( Parameter_Integer, 0 ),   --  : hourot (Integer)
           520 => ( Parameter_Integer, 0 ),   --  : hourre (Integer)
           521 => ( Parameter_Integer, 0 ),   --  : hourtot (Integer)
           522 => ( Parameter_Integer, 0 ),   --  : hperson (Integer)
           523 => ( Parameter_Integer, 0 ),   --  : iagegr2 (Integer)
           524 => ( Parameter_Integer, 0 ),   --  : iagegr3 (Integer)
           525 => ( Parameter_Integer, 0 ),   --  : iagegr4 (Integer)
           526 => ( Parameter_Integer, 0 ),   --  : iagegrp (Integer)
           527 => ( Parameter_Float, 0.0 ),   --  : incseo2 (Amount)
           528 => ( Parameter_Integer, 0 ),   --  : indinc (Integer)
           529 => ( Parameter_Integer, 0 ),   --  : indisben (Integer)
           530 => ( Parameter_Float, 0.0 ),   --  : inearns (Amount)
           531 => ( Parameter_Float, 0.0 ),   --  : ininv (Amount)
           532 => ( Parameter_Integer, 0 ),   --  : inirben (Integer)
           533 => ( Parameter_Integer, 0 ),   --  : innirben (Integer)
           534 => ( Parameter_Integer, 0 ),   --  : inothben (Integer)
           535 => ( Parameter_Float, 0.0 ),   --  : inpeninc (Amount)
           536 => ( Parameter_Float, 0.0 ),   --  : inrinc (Amount)
           537 => ( Parameter_Float, 0.0 ),   --  : inrpinc (Amount)
           538 => ( Parameter_Float, 0.0 ),   --  : intvlic (Amount)
           539 => ( Parameter_Float, 0.0 ),   --  : intxcred (Amount)
           540 => ( Parameter_Integer, 0 ),   --  : isacti (Integer)
           541 => ( Parameter_Integer, 0 ),   --  : marital (Integer)
           542 => ( Parameter_Integer, 0 ),   --  : mjobsect (Integer)
           543 => ( Parameter_Integer, 0 ),   --  : ninanida (Integer)
           544 => ( Parameter_Float, 0.0 ),   --  : nincseo2 (Amount)
           545 => ( Parameter_Integer, 0 ),   --  : nindinc (Integer)
           546 => ( Parameter_Integer, 0 ),   --  : ninearns (Integer)
           547 => ( Parameter_Integer, 0 ),   --  : nininv (Integer)
           548 => ( Parameter_Integer, 0 ),   --  : ninnirbn (Integer)
           549 => ( Parameter_Integer, 0 ),   --  : ninothbn (Integer)
           550 => ( Parameter_Integer, 0 ),   --  : ninpenin (Integer)
           551 => ( Parameter_Integer, 0 ),   --  : ninrinc (Integer)
           552 => ( Parameter_Float, 0.0 ),   --  : ninsein2 (Amount)
           553 => ( Parameter_Integer, 0 ),   --  : nirel2 (Integer)
           554 => ( Parameter_Integer, 0 ),   --  : occupnum (Integer)
           555 => ( Parameter_Integer, 0 ),   --  : pepscti (Integer)
           556 => ( Parameter_Integer, 0 ),   --  : poaccti (Integer)
           557 => ( Parameter_Integer, 0 ),   --  : pocardi (Integer)
           558 => ( Parameter_Integer, 0 ),   --  : prevjobm (Integer)
           559 => ( Parameter_Integer, 0 ),   --  : relhrp (Integer)
           560 => ( Parameter_Float, 0.0 ),   --  : sapadj (Amount)
           561 => ( Parameter_Float, 0.0 ),   --  : seincam2 (Amount)
           562 => ( Parameter_Float, 0.0 ),   --  : smpadj (Amount)
           563 => ( Parameter_Float, 0.0 ),   --  : sppadj (Amount)
           564 => ( Parameter_Float, 0.0 ),   --  : sspadj (Amount)
           565 => ( Parameter_Integer, 0 ),   --  : stshcti (Integer)
           566 => ( Parameter_Integer, 0 ),   --  : taxpayer (Integer)
           567 => ( Parameter_Integer, 0 ),   --  : tesscti (Integer)
           568 => ( Parameter_Float, 0.0 ),   --  : totgrant (Amount)
           569 => ( Parameter_Float, 0.0 ),   --  : tothours (Amount)
           570 => ( Parameter_Float, 0.0 ),   --  : totoccp (Amount)
           571 => ( Parameter_Integer, 0 ),   --  : typeed2 (Integer)
           572 => ( Parameter_Integer, 0 ),   --  : untrcti (Integer)
           573 => ( Parameter_Integer, 0 ),   --  : uperson (Integer)
           574 => ( Parameter_Integer, 0 ),   --  : w45 (Integer)
           575 => ( Parameter_Float, 0.0 ),   --  : widoccp (Amount)
           576 => ( Parameter_Integer, 0 ),   --  : xbonflag (Integer)
           577 => ( Parameter_Integer, 0 ),   --  : anxious (Integer)
           578 => ( Parameter_Integer, 0 ),   --  : candgnow (Integer)
           579 => ( Parameter_Integer, 0 ),   --  : curothf (Integer)
           580 => ( Parameter_Integer, 0 ),   --  : curothp (Integer)
           581 => ( Parameter_Integer, 0 ),   --  : curothwv (Integer)
           582 => ( Parameter_Integer, 0 ),   --  : dvhiqual (Integer)
           583 => ( Parameter_Integer, 0 ),   --  : gnvqnow (Integer)
           584 => ( Parameter_Integer, 0 ),   --  : gpuc (Integer)
           585 => ( Parameter_Integer, 0 ),   --  : happywb (Integer)
           586 => ( Parameter_Integer, 0 ),   --  : hi1qual7 (Integer)
           587 => ( Parameter_Integer, 0 ),   --  : hi1qual8 (Integer)
           588 => ( Parameter_Integer, 0 ),   --  : mntarr5 (Integer)
           589 => ( Parameter_Integer, 0 ),   --  : mntnoch1 (Integer)
           590 => ( Parameter_Integer, 0 ),   --  : mntnoch2 (Integer)
           591 => ( Parameter_Integer, 0 ),   --  : mntnoch3 (Integer)
           592 => ( Parameter_Integer, 0 ),   --  : mntnoch4 (Integer)
           593 => ( Parameter_Integer, 0 ),   --  : mntnoch5 (Integer)
           594 => ( Parameter_Integer, 0 ),   --  : mntpro1 (Integer)
           595 => ( Parameter_Integer, 0 ),   --  : mntpro2 (Integer)
           596 => ( Parameter_Integer, 0 ),   --  : mntpro3 (Integer)
           597 => ( Parameter_Integer, 0 ),   --  : mnttim1 (Integer)
           598 => ( Parameter_Integer, 0 ),   --  : mnttim2 (Integer)
           599 => ( Parameter_Integer, 0 ),   --  : mnttim3 (Integer)
           600 => ( Parameter_Integer, 0 ),   --  : mntwrk1 (Integer)
           601 => ( Parameter_Integer, 0 ),   --  : mntwrk2 (Integer)
           602 => ( Parameter_Integer, 0 ),   --  : mntwrk3 (Integer)
           603 => ( Parameter_Integer, 0 ),   --  : mntwrk4 (Integer)
           604 => ( Parameter_Integer, 0 ),   --  : mntwrk5 (Integer)
           605 => ( Parameter_Integer, 0 ),   --  : ndeplnow (Integer)
           606 => ( Parameter_Integer, 0 ),   --  : oqualc1 (Integer)
           607 => ( Parameter_Integer, 0 ),   --  : oqualc2 (Integer)
           608 => ( Parameter_Integer, 0 ),   --  : oqualc3 (Integer)
           609 => ( Parameter_Integer, 0 ),   --  : sruc (Integer)
           610 => ( Parameter_Integer, 0 ),   --  : webacnow (Integer)
           611 => ( Parameter_Integer, 0 ),   --  : indeth (Integer)
           612 => ( Parameter_Integer, 0 ),   --  : euactive (Integer)
           613 => ( Parameter_Integer, 0 ),   --  : euactno (Integer)
           614 => ( Parameter_Integer, 0 ),   --  : euartact (Integer)
           615 => ( Parameter_Integer, 0 ),   --  : euaskhlp (Integer)
           616 => ( Parameter_Integer, 0 ),   --  : eucinema (Integer)
           617 => ( Parameter_Integer, 0 ),   --  : eucultur (Integer)
           618 => ( Parameter_Integer, 0 ),   --  : euinvol (Integer)
           619 => ( Parameter_Integer, 0 ),   --  : eulivpe (Integer)
           620 => ( Parameter_Integer, 0 ),   --  : eumtfam (Integer)
           621 => ( Parameter_Integer, 0 ),   --  : eumtfrnd (Integer)
           622 => ( Parameter_Integer, 0 ),   --  : eusocnet (Integer)
           623 => ( Parameter_Integer, 0 ),   --  : eusport (Integer)
           624 => ( Parameter_Integer, 0 ),   --  : eutkfam (Integer)
           625 => ( Parameter_Integer, 0 ),   --  : eutkfrnd (Integer)
           626 => ( Parameter_Integer, 0 ),   --  : eutkmat (Integer)
           627 => ( Parameter_Integer, 0 ),   --  : euvol (Integer)
           628 => ( Parameter_Integer, 0 ),   --  : natscot (Integer)
           629 => ( Parameter_Integer, 0 ),   --  : ntsctnow (Integer)
           630 => ( Parameter_Integer, 0 ),   --  : penwel1 (Integer)
           631 => ( Parameter_Integer, 0 ),   --  : penwel2 (Integer)
           632 => ( Parameter_Integer, 0 ),   --  : penwel3 (Integer)
           633 => ( Parameter_Integer, 0 ),   --  : penwel4 (Integer)
           634 => ( Parameter_Integer, 0 ),   --  : penwel5 (Integer)
           635 => ( Parameter_Integer, 0 ),   --  : penwel6 (Integer)
           636 => ( Parameter_Integer, 0 ),   --  : skiwknow (Integer)
           637 => ( Parameter_Integer, 0 ),   --  : skiwrk (Integer)
           638 => ( Parameter_Integer, 0 ),   --  : slos (Integer)
           639 => ( Parameter_Integer, 0 ),   --  : yjblev (Integer)
           640 => ( Parameter_Integer, 0 ),   --  : abs2no (Integer)
           641 => ( Parameter_Integer, 0 ),   --  : accftpt (Integer)
           642 => ( Parameter_Integer, 0 ),   --  : b2qfut1 (Integer)
           643 => ( Parameter_Integer, 0 ),   --  : b2qfut2 (Integer)
           644 => ( Parameter_Integer, 0 ),   --  : b2qfut3 (Integer)
           645 => ( Parameter_Integer, 0 ),   --  : b3qfut1 (Integer)
           646 => ( Parameter_Integer, 0 ),   --  : b3qfut2 (Integer)
           647 => ( Parameter_Integer, 0 ),   --  : b3qfut3 (Integer)
           648 => ( Parameter_Integer, 0 ),   --  : b3qfut4 (Integer)
           649 => ( Parameter_Integer, 0 ),   --  : b3qfut5 (Integer)
           650 => ( Parameter_Integer, 0 ),   --  : b3qfut6 (Integer)
           651 => ( Parameter_Integer, 0 ),   --  : ben1q1 (Integer)
           652 => ( Parameter_Integer, 0 ),   --  : ben1q2 (Integer)
           653 => ( Parameter_Integer, 0 ),   --  : ben1q3 (Integer)
           654 => ( Parameter_Integer, 0 ),   --  : ben1q4 (Integer)
           655 => ( Parameter_Integer, 0 ),   --  : ben1q5 (Integer)
           656 => ( Parameter_Integer, 0 ),   --  : ben1q6 (Integer)
           657 => ( Parameter_Integer, 0 ),   --  : ben1q7 (Integer)
           658 => ( Parameter_Integer, 0 ),   --  : ben2q1 (Integer)
           659 => ( Parameter_Integer, 0 ),   --  : ben2q2 (Integer)
           660 => ( Parameter_Integer, 0 ),   --  : ben2q3 (Integer)
           661 => ( Parameter_Integer, 0 ),   --  : ben3q1 (Integer)
           662 => ( Parameter_Integer, 0 ),   --  : ben3q2 (Integer)
           663 => ( Parameter_Integer, 0 ),   --  : ben3q3 (Integer)
           664 => ( Parameter_Integer, 0 ),   --  : ben3q4 (Integer)
           665 => ( Parameter_Integer, 0 ),   --  : ben3q5 (Integer)
           666 => ( Parameter_Integer, 0 ),   --  : ben3q6 (Integer)
           667 => ( Parameter_Integer, 0 ),   --  : ben4q1 (Integer)
           668 => ( Parameter_Integer, 0 ),   --  : ben4q2 (Integer)
           669 => ( Parameter_Integer, 0 ),   --  : ben4q3 (Integer)
           670 => ( Parameter_Integer, 0 ),   --  : ben5q1 (Integer)
           671 => ( Parameter_Integer, 0 ),   --  : ben5q2 (Integer)
           672 => ( Parameter_Integer, 0 ),   --  : ben5q3 (Integer)
           673 => ( Parameter_Integer, 0 ),   --  : ben5q4 (Integer)
           674 => ( Parameter_Integer, 0 ),   --  : ben5q5 (Integer)
           675 => ( Parameter_Integer, 0 ),   --  : ben5q6 (Integer)
           676 => ( Parameter_Integer, 0 ),   --  : ben7q1 (Integer)
           677 => ( Parameter_Integer, 0 ),   --  : ben7q2 (Integer)
           678 => ( Parameter_Integer, 0 ),   --  : ben7q3 (Integer)
           679 => ( Parameter_Integer, 0 ),   --  : ben7q4 (Integer)
           680 => ( Parameter_Integer, 0 ),   --  : ben7q5 (Integer)
           681 => ( Parameter_Integer, 0 ),   --  : ben7q6 (Integer)
           682 => ( Parameter_Integer, 0 ),   --  : ben7q7 (Integer)
           683 => ( Parameter_Integer, 0 ),   --  : ben7q8 (Integer)
           684 => ( Parameter_Integer, 0 ),   --  : ben7q9 (Integer)
           685 => ( Parameter_Integer, 0 ),   --  : btwacc (Integer)
           686 => ( Parameter_Integer, 0 ),   --  : dentist (Integer)
           687 => ( Parameter_Integer, 0 ),   --  : disdif1 (Integer)
           688 => ( Parameter_Integer, 0 ),   --  : disdif2 (Integer)
           689 => ( Parameter_Integer, 0 ),   --  : disdif3 (Integer)
           690 => ( Parameter_Integer, 0 ),   --  : disdif4 (Integer)
           691 => ( Parameter_Integer, 0 ),   --  : disdif5 (Integer)
           692 => ( Parameter_Integer, 0 ),   --  : disdif6 (Integer)
           693 => ( Parameter_Integer, 0 ),   --  : disdif7 (Integer)
           694 => ( Parameter_Integer, 0 ),   --  : disdif8 (Integer)
           695 => ( Parameter_Integer, 0 ),   --  : dptcboth (Integer)
           696 => ( Parameter_Integer, 0 ),   --  : dptclum (Integer)
           697 => ( Parameter_Integer, 0 ),   --  : ed1borr (Integer)
           698 => ( Parameter_Integer, 0 ),   --  : ed1int (Integer)
           699 => ( Parameter_Date, Clock ),   --  : ed1monyr (Ada.Calendar.Time)
           700 => ( Parameter_Integer, 0 ),   --  : ed2borr (Integer)
           701 => ( Parameter_Integer, 0 ),   --  : ed2int (Integer)
           702 => ( Parameter_Date, Clock ),   --  : ed2monyr (Ada.Calendar.Time)
           703 => ( Parameter_Integer, 0 ),   --  : edattn1 (Integer)
           704 => ( Parameter_Integer, 0 ),   --  : edattn2 (Integer)
           705 => ( Parameter_Integer, 0 ),   --  : edattn3 (Integer)
           706 => ( Parameter_Integer, 0 ),   --  : edtime (Integer)
           707 => ( Parameter_Integer, 0 ),   --  : emppay1 (Integer)
           708 => ( Parameter_Integer, 0 ),   --  : emppay2 (Integer)
           709 => ( Parameter_Integer, 0 ),   --  : emppay3 (Integer)
           710 => ( Parameter_Integer, 0 ),   --  : endyr (Integer)
           711 => ( Parameter_Integer, 0 ),   --  : epcur (Integer)
           712 => ( Parameter_Integer, 0 ),   --  : ethgrp (Integer)
           713 => ( Parameter_Integer, 0 ),   --  : exthbct2 (Integer)
           714 => ( Parameter_Integer, 0 ),   --  : exthbct3 (Integer)
           715 => ( Parameter_Integer, 0 ),   --  : eyetest (Integer)
           716 => ( Parameter_Integer, 0 ),   --  : follow (Integer)
           717 => ( Parameter_Integer, 0 ),   --  : future (Integer)
           718 => ( Parameter_Integer, 0 ),   --  : govpis (Integer)
           719 => ( Parameter_Integer, 0 ),   --  : govpjsa (Integer)
           720 => ( Parameter_Float, 0.0 ),   --  : hbothamt (Amount)
           721 => ( Parameter_Integer, 0 ),   --  : hbothbu (Integer)
           722 => ( Parameter_Integer, 0 ),   --  : hbothpd (Integer)
           723 => ( Parameter_Integer, 0 ),   --  : hbothwk (Integer)
           724 => ( Parameter_Integer, 0 ),   --  : hbotwait (Integer)
           725 => ( Parameter_Integer, 0 ),   --  : health (Integer)
           726 => ( Parameter_Integer, 0 ),   --  : hosp (Integer)
           727 => ( Parameter_Integer, 0 ),   --  : hprob (Integer)
           728 => ( Parameter_Integer, 0 ),   --  : isa3type (Integer)
           729 => ( Parameter_Integer, 0 ),   --  : ln1rpint (Integer)
           730 => ( Parameter_Integer, 0 ),   --  : ln2rpint (Integer)
           731 => ( Parameter_Integer, 0 ),   --  : look (Integer)
           732 => ( Parameter_Integer, 0 ),   --  : lookwk (Integer)
           733 => ( Parameter_Integer, 0 ),   --  : mntct (Integer)
           734 => ( Parameter_Integer, 0 ),   --  : mntfor1 (Integer)
           735 => ( Parameter_Integer, 0 ),   --  : mntfor2 (Integer)
           736 => ( Parameter_Integer, 0 ),   --  : mnttota1 (Integer)
           737 => ( Parameter_Integer, 0 ),   --  : mnttota2 (Integer)
           738 => ( Parameter_Integer, 0 ),   --  : natid1 (Integer)
           739 => ( Parameter_Integer, 0 ),   --  : natid2 (Integer)
           740 => ( Parameter_Integer, 0 ),   --  : natid3 (Integer)
           741 => ( Parameter_Integer, 0 ),   --  : natid4 (Integer)
           742 => ( Parameter_Integer, 0 ),   --  : natid5 (Integer)
           743 => ( Parameter_Integer, 0 ),   --  : natid6 (Integer)
           744 => ( Parameter_Integer, 0 ),   --  : ndeal (Integer)
           745 => ( Parameter_Integer, 0 ),   --  : newdtype (Integer)
           746 => ( Parameter_Integer, 0 ),   --  : nhs1 (Integer)
           747 => ( Parameter_Integer, 0 ),   --  : nhs2 (Integer)
           748 => ( Parameter_Integer, 0 ),   --  : nhs3 (Integer)
           749 => ( Parameter_Integer, 0 ),   --  : niethgrp (Integer)
           750 => ( Parameter_Integer, 0 ),   --  : ninatid1 (Integer)
           751 => ( Parameter_Integer, 0 ),   --  : ninatid2 (Integer)
           752 => ( Parameter_Integer, 0 ),   --  : ninatid3 (Integer)
           753 => ( Parameter_Integer, 0 ),   --  : ninatid4 (Integer)
           754 => ( Parameter_Integer, 0 ),   --  : ninatid5 (Integer)
           755 => ( Parameter_Integer, 0 ),   --  : ninatid6 (Integer)
           756 => ( Parameter_Integer, 0 ),   --  : ninatid7 (Integer)
           757 => ( Parameter_Integer, 0 ),   --  : ninatid8 (Integer)
           758 => ( Parameter_Integer, 0 ),   --  : nirel (Integer)
           759 => ( Parameter_Integer, 0 ),   --  : nitrain (Integer)
           760 => ( Parameter_Integer, 0 ),   --  : nlper (Integer)
           761 => ( Parameter_Integer, 0 ),   --  : nolook (Integer)
           762 => ( Parameter_Integer, 0 ),   --  : ntcapp (Integer)
           763 => ( Parameter_Integer, 0 ),   --  : ntcdat (Integer)
           764 => ( Parameter_Float, 0.0 ),   --  : ntcinc (Amount)
           765 => ( Parameter_Integer, 0 ),   --  : ntcorig1 (Integer)
           766 => ( Parameter_Integer, 0 ),   --  : ntcorig2 (Integer)
           767 => ( Parameter_Integer, 0 ),   --  : ntcorig3 (Integer)
           768 => ( Parameter_Integer, 0 ),   --  : ntcorig4 (Integer)
           769 => ( Parameter_Integer, 0 ),   --  : ntcorig5 (Integer)
           770 => ( Parameter_Integer, 0 ),   --  : prit (Integer)
           771 => ( Parameter_Integer, 0 ),   --  : prscrpt (Integer)
           772 => ( Parameter_Integer, 0 ),   --  : soc2000 (Integer)
           773 => ( Parameter_Integer, 0 ),   --  : specs (Integer)
           774 => ( Parameter_Integer, 0 ),   --  : startyr (Integer)
           775 => ( Parameter_Integer, 0 ),   --  : taxcred1 (Integer)
           776 => ( Parameter_Integer, 0 ),   --  : taxcred2 (Integer)
           777 => ( Parameter_Integer, 0 ),   --  : taxcred3 (Integer)
           778 => ( Parameter_Integer, 0 ),   --  : taxcred4 (Integer)
           779 => ( Parameter_Integer, 0 ),   --  : taxcred5 (Integer)
           780 => ( Parameter_Integer, 0 ),   --  : taxfut (Integer)
           781 => ( Parameter_Integer, 0 ),   --  : train (Integer)
           782 => ( Parameter_Integer, 0 ),   --  : trav (Integer)
           783 => ( Parameter_Integer, 0 ),   --  : voucher (Integer)
           784 => ( Parameter_Integer, 0 ),   --  : war1 (Integer)
           785 => ( Parameter_Integer, 0 ),   --  : war2 (Integer)
           786 => ( Parameter_Integer, 0 ),   --  : wftcboth (Integer)
           787 => ( Parameter_Integer, 0 ),   --  : wftclum (Integer)
           788 => ( Parameter_Integer, 0 ),   --  : whyfrde1 (Integer)
           789 => ( Parameter_Integer, 0 ),   --  : whyfrde2 (Integer)
           790 => ( Parameter_Integer, 0 ),   --  : whyfrde3 (Integer)
           791 => ( Parameter_Integer, 0 ),   --  : whyfrde4 (Integer)
           792 => ( Parameter_Integer, 0 ),   --  : whyfrde5 (Integer)
           793 => ( Parameter_Integer, 0 ),   --  : whyfrde6 (Integer)
           794 => ( Parameter_Integer, 0 ),   --  : whyfrey1 (Integer)
           795 => ( Parameter_Integer, 0 ),   --  : whyfrey2 (Integer)
           796 => ( Parameter_Integer, 0 ),   --  : whyfrey3 (Integer)
           797 => ( Parameter_Integer, 0 ),   --  : whyfrey4 (Integer)
           798 => ( Parameter_Integer, 0 ),   --  : whyfrey5 (Integer)
           799 => ( Parameter_Integer, 0 ),   --  : whyfrey6 (Integer)
           800 => ( Parameter_Integer, 0 ),   --  : whyfrpr1 (Integer)
           801 => ( Parameter_Integer, 0 ),   --  : whyfrpr2 (Integer)
           802 => ( Parameter_Integer, 0 ),   --  : whyfrpr3 (Integer)
           803 => ( Parameter_Integer, 0 ),   --  : whyfrpr4 (Integer)
           804 => ( Parameter_Integer, 0 ),   --  : whyfrpr5 (Integer)
           805 => ( Parameter_Integer, 0 ),   --  : whyfrpr6 (Integer)
           806 => ( Parameter_Integer, 0 ),   --  : whytrav1 (Integer)
           807 => ( Parameter_Integer, 0 ),   --  : whytrav2 (Integer)
           808 => ( Parameter_Integer, 0 ),   --  : whytrav3 (Integer)
           809 => ( Parameter_Integer, 0 ),   --  : whytrav4 (Integer)
           810 => ( Parameter_Integer, 0 ),   --  : whytrav5 (Integer)
           811 => ( Parameter_Integer, 0 ),   --  : whytrav6 (Integer)
           812 => ( Parameter_Integer, 0 ),   --  : wmkit (Integer)
           813 => ( Parameter_Integer, 0 ),   --  : wtclum3 (Integer)
           814 => ( Parameter_Integer, 0 ),   --  : addda (Integer)
           815 => ( Parameter_Float, 0.0 ),   --  : bntxcred (Amount)
           816 => ( Parameter_Integer, 0 ),   --  : fsbndcti (Integer)
           817 => ( Parameter_Float, 0.0 ),   --  : fwmlkval (Amount)
           818 => ( Parameter_Integer, 0 ),   --  : gross2 (Integer)
           819 => ( Parameter_Integer, 0 ),   --  : gross3 (Integer)
           820 => ( Parameter_Float, 0.0 ),   --  : hbsupran (Amount)
           821 => ( Parameter_Float, 0.0 ),   --  : netocpen (Amount)
           822 => ( Parameter_Integer, 0 ),   --  : nsbocti (Integer)
           823 => ( Parameter_Integer, 0 ),   --  : otbscti (Integer)
           824 => ( Parameter_Integer, 0 ),   --  : prbocti (Integer)
           825 => ( Parameter_Integer, 0 ),   --  : sayecti (Integer)
           826 => ( Parameter_Integer, 0 ),   --  : sclbcti (Integer)
           827 => ( Parameter_Integer, 0 ),   --  : sscti (Integer)
           828 => ( Parameter_Float, 0.0 ),   --  : superan (Amount)
           829 => ( Parameter_Float, 0.0 ),   --  : ttwcosts (Amount)
           830 => ( Parameter_Integer, 0 ),   --  : ben5q7 (Integer)
           831 => ( Parameter_Integer, 0 ),   --  : ben5q8 (Integer)
           832 => ( Parameter_Integer, 0 ),   --  : ben5q9 (Integer)
           833 => ( Parameter_Integer, 0 ),   --  : ddatre (Integer)
           834 => ( Parameter_Integer, 0 ),   --  : disdif9 (Integer)
           835 => ( Parameter_Float, 0.0 ),   --  : fare (Amount)
           836 => ( Parameter_Integer, 0 ),   --  : nittwmod (Integer)
           837 => ( Parameter_Integer, 0 ),   --  : oneway (Integer)
           838 => ( Parameter_Float, 0.0 ),   --  : pssamt (Amount)
           839 => ( Parameter_Integer, 0 ),   --  : pssdate (Integer)
           840 => ( Parameter_Integer, 0 ),   --  : ttwcode1 (Integer)
           841 => ( Parameter_Integer, 0 ),   --  : ttwcode2 (Integer)
           842 => ( Parameter_Integer, 0 ),   --  : ttwcode3 (Integer)
           843 => ( Parameter_Float, 0.0 ),   --  : ttwcost (Amount)
           844 => ( Parameter_Integer, 0 ),   --  : ttwfar (Integer)
           845 => ( Parameter_Float, 0.0 ),   --  : ttwfrq (Amount)
           846 => ( Parameter_Integer, 0 ),   --  : ttwmod (Integer)
           847 => ( Parameter_Integer, 0 ),   --  : ttwpay (Integer)
           848 => ( Parameter_Integer, 0 ),   --  : ttwpss (Integer)
           849 => ( Parameter_Float, 0.0 ),   --  : ttwrec (Amount)
           850 => ( Parameter_Integer, 0 ),   --  : crunaci (Integer)
           851 => ( Parameter_Integer, 0 ),   --  : enomorti (Integer)
           852 => ( Parameter_Integer, 0 ),   --  : ttwmode (Integer)
           853 => ( Parameter_Integer, 0 ),   --  : ddatrep (Integer)
           854 => ( Parameter_Integer, 0 ),   --  : disdifp (Integer)
           855 => ( Parameter_Integer, 0 ),   --  : sfrpis (Integer)
           856 => ( Parameter_Integer, 0 ),   --  : sfrpjsa (Integer)
           857 => ( Parameter_Integer, 0 ),   --  : ethgr2 (Integer)
           858 => ( Parameter_Integer, 0 ),   --  : consent (Integer)
           859 => ( Parameter_Integer, 0 ),   --  : dvpens (Integer)
           860 => ( Parameter_Integer, 0 ),   --  : lnkref1 (Integer)
           861 => ( Parameter_Integer, 0 ),   --  : lnkref2 (Integer)
           862 => ( Parameter_Integer, 0 ),   --  : lnkref21 (Integer)
           863 => ( Parameter_Integer, 0 ),   --  : lnkref22 (Integer)
           864 => ( Parameter_Integer, 0 ),   --  : lnkref23 (Integer)
           865 => ( Parameter_Integer, 0 ),   --  : lnkref24 (Integer)
           866 => ( Parameter_Integer, 0 ),   --  : lnkref25 (Integer)
           867 => ( Parameter_Integer, 0 ),   --  : lnkref3 (Integer)
           868 => ( Parameter_Integer, 0 ),   --  : lnkref4 (Integer)
           869 => ( Parameter_Integer, 0 ),   --  : lnkref5 (Integer)
           870 => ( Parameter_Integer, 0 ),   --  : pconsent (Integer)
           871 => ( Parameter_Integer, 0 ),   --  : lnkons (Integer)
           872 => ( Parameter_Integer, 0 ),   --  : lnkref6 (Integer)
           873 => ( Parameter_Integer, 0 ),   --  : lnkref7 (Integer)
           874 => ( Parameter_Integer, 0 ),   --  : lnkref8 (Integer)
           875 => ( Parameter_Integer, 0 ),   --  : lnkref9 (Integer)
           876 => ( Parameter_Integer, 0 ),   --  : b3qfut7 (Integer)
           877 => ( Parameter_Integer, 0 ),   --  : ben3q7 (Integer)
           878 => ( Parameter_Integer, 0 ),   --  : ddaprog (Integer)
           879 => ( Parameter_Integer, 0 ),   --  : hbolng (Integer)
           880 => ( Parameter_Integer, 0 ),   --  : hi2qual (Integer)
           881 => ( Parameter_Integer, 0 ),   --  : hlpgvn01 (Integer)
           882 => ( Parameter_Integer, 0 ),   --  : hlpgvn02 (Integer)
           883 => ( Parameter_Integer, 0 ),   --  : hlpgvn03 (Integer)
           884 => ( Parameter_Integer, 0 ),   --  : hlpgvn04 (Integer)
           885 => ( Parameter_Integer, 0 ),   --  : hlpgvn05 (Integer)
           886 => ( Parameter_Integer, 0 ),   --  : hlpgvn06 (Integer)
           887 => ( Parameter_Integer, 0 ),   --  : hlpgvn07 (Integer)
           888 => ( Parameter_Integer, 0 ),   --  : hlpgvn08 (Integer)
           889 => ( Parameter_Integer, 0 ),   --  : hlpgvn09 (Integer)
           890 => ( Parameter_Integer, 0 ),   --  : hlpgvn10 (Integer)
           891 => ( Parameter_Integer, 0 ),   --  : hlpgvn11 (Integer)
           892 => ( Parameter_Integer, 0 ),   --  : hlprec01 (Integer)
           893 => ( Parameter_Integer, 0 ),   --  : hlprec02 (Integer)
           894 => ( Parameter_Integer, 0 ),   --  : hlprec03 (Integer)
           895 => ( Parameter_Integer, 0 ),   --  : hlprec04 (Integer)
           896 => ( Parameter_Integer, 0 ),   --  : hlprec05 (Integer)
           897 => ( Parameter_Integer, 0 ),   --  : hlprec06 (Integer)
           898 => ( Parameter_Integer, 0 ),   --  : hlprec07 (Integer)
           899 => ( Parameter_Integer, 0 ),   --  : hlprec08 (Integer)
           900 => ( Parameter_Integer, 0 ),   --  : hlprec09 (Integer)
           901 => ( Parameter_Integer, 0 ),   --  : hlprec10 (Integer)
           902 => ( Parameter_Integer, 0 ),   --  : hlprec11 (Integer)
           903 => ( Parameter_Integer, 0 ),   --  : loangvn1 (Integer)
           904 => ( Parameter_Integer, 0 ),   --  : loangvn2 (Integer)
           905 => ( Parameter_Integer, 0 ),   --  : loangvn3 (Integer)
           906 => ( Parameter_Integer, 0 ),   --  : loanrec1 (Integer)
           907 => ( Parameter_Integer, 0 ),   --  : loanrec2 (Integer)
           908 => ( Parameter_Integer, 0 ),   --  : loanrec3 (Integer)
           909 => ( Parameter_Integer, 0 ),   --  : alg (Integer)
           910 => ( Parameter_Float, 0.0 ),   --  : algamt (Amount)
           911 => ( Parameter_Integer, 0 ),   --  : algpd (Integer)
           912 => ( Parameter_Integer, 0 ),   --  : ben4q4 (Integer)
           913 => ( Parameter_Integer, 0 ),   --  : disdifad (Integer)
           914 => ( Parameter_Integer, 0 ),   --  : gross3_x (Integer)
           915 => ( Parameter_Integer, 0 ),   --  : cbaamt (Integer)
           916 => ( Parameter_Integer, 0 ),   --  : mednum (Integer)
           917 => ( Parameter_Integer, 0 ),   --  : medprpd (Integer)
           918 => ( Parameter_Integer, 0 ),   --  : medprpy (Integer)
           919 => ( Parameter_Integer, 0 ),   --  : medpay (Integer)
           920 => ( Parameter_Integer, 0 ),   --  : medrep (Integer)
           921 => ( Parameter_Integer, 0 ),   --  : medrpnm (Integer)
           ...
           927 => ( Parameter_Integer, 0 )   --  : person (Integer)
            ...
            8 => ( Parameter_Integer, 0 ),   --  : abspar (Integer)
            9 => ( Parameter_Integer, 0 ),   --  : abspay (Integer)
           10 => ( Parameter_Integer, 0 ),   --  : abswhy (Integer)
           11 => ( Parameter_Integer, 0 ),   --  : abswk (Integer)
           12 => ( Parameter_Integer, 0 ),   --  : x_access (Integer)
           13 => ( Parameter_Integer, 0 ),   --  : accjb (Integer)
           14 => ( Parameter_Integer, 0 ),   --  : accmsat (Integer)
           15 => ( Parameter_Integer, 0 ),   --  : accountq (Integer)
           ...
           23 => ( Parameter_Integer, 0 ),   --  : agehqual (Integer)
           24 => ( Parameter_Float, 0.0 ),   --  : aliamt (Amount)
           25 => ( Parameter_Integer, 0 ),   --  : alimny (Integer)
           26 => ( Parameter_Integer, 0 ),   --  : alipd (Integer)
           27 => ( Parameter_Integer, 0 ),   --  : alius (Integer)
           28 => ( Parameter_Integer, 0 ),   --  : allow1 (Integer)
           29 => ( Parameter_Integer, 0 ),   --  : allow2 (Integer)
           30 => ( Parameter_Integer, 0 ),   --  : allow3 (Integer)
           31 => ( Parameter_Integer, 0 ),   --  : allow4 (Integer)
           32 => ( Parameter_Float, 0.0 ),   --  : allpay1 (Amount)
           33 => ( Parameter_Float, 0.0 ),   --  : allpay2 (Amount)
           34 => ( Parameter_Float, 0.0 ),   --  : allpay3 (Amount)
           35 => ( Parameter_Float, 0.0 ),   --  : allpay4 (Amount)
           36 => ( Parameter_Integer, 0 ),   --  : allpd1 (Integer)
           37 => ( Parameter_Integer, 0 ),   --  : allpd2 (Integer)
           38 => ( Parameter_Integer, 0 ),   --  : allpd3 (Integer)
           39 => ( Parameter_Integer, 0 ),   --  : allpd4 (Integer)
           40 => ( Parameter_Float, 0.0 ),   --  : aluamt (Amount)
           41 => ( Parameter_Integer, 0 ),   --  : alupd (Integer)
           42 => ( Parameter_Integer, 0 ),   --  : anyacc (Integer)
           43 => ( Parameter_Integer, 0 ),   --  : anyed (Integer)
           44 => ( Parameter_Integer, 0 ),   --  : anymon (Integer)
           45 => ( Parameter_Integer, 0 ),   --  : anypen1 (Integer)
           46 => ( Parameter_Integer, 0 ),   --  : anypen2 (Integer)
           47 => ( Parameter_Integer, 0 ),   --  : anypen3 (Integer)
           48 => ( Parameter_Integer, 0 ),   --  : anypen4 (Integer)
           49 => ( Parameter_Integer, 0 ),   --  : anypen5 (Integer)
           50 => ( Parameter_Integer, 0 ),   --  : anypen6 (Integer)
           51 => ( Parameter_Integer, 0 ),   --  : anypen7 (Integer)
           52 => ( Parameter_Float, 0.0 ),   --  : apamt (Amount)
           53 => ( Parameter_Float, 0.0 ),   --  : apdamt (Amount)
           54 => ( Parameter_Integer, 0 ),   --  : apdir (Integer)
           55 => ( Parameter_Integer, 0 ),   --  : apdpd (Integer)
           56 => ( Parameter_Integer, 0 ),   --  : appd (Integer)
           57 => ( Parameter_Integer, 0 ),   --  : bfd (Integer)
           58 => ( Parameter_Float, 0.0 ),   --  : bfdamt (Amount)
           59 => ( Parameter_Integer, 0 ),   --  : bfdpd (Integer)
           60 => ( Parameter_Integer, 0 ),   --  : bfdval (Integer)
           61 => ( Parameter_Integer, 0 ),   --  : btec (Integer)
           62 => ( Parameter_Integer, 0 ),   --  : btecnow (Integer)
           63 => ( Parameter_Integer, 0 ),   --  : c2orign (Integer)
           64 => ( Parameter_Integer, 0 ),   --  : calm (Integer)
           65 => ( Parameter_Integer, 0 ),   --  : camemt (Integer)
           66 => ( Parameter_Integer, 0 ),   --  : cameyr (Integer)
           67 => ( Parameter_Integer, 0 ),   --  : cameyr2 (Integer)
           68 => ( Parameter_Integer, 0 ),   --  : cbaamt2 (Integer)
           69 => ( Parameter_Integer, 0 ),   --  : cbchk (Integer)
           70 => ( Parameter_Integer, 0 ),   --  : change (Integer)
           71 => ( Parameter_Integer, 0 ),   --  : chkctc (Integer)
           72 => ( Parameter_Integer, 0 ),   --  : chkdpco1 (Integer)
           73 => ( Parameter_Integer, 0 ),   --  : chkdpco2 (Integer)
           74 => ( Parameter_Integer, 0 ),   --  : chkdpco3 (Integer)
           75 => ( Parameter_Integer, 0 ),   --  : chkdpn (Integer)
           76 => ( Parameter_Integer, 0 ),   --  : chkdsco1 (Integer)
           77 => ( Parameter_Integer, 0 ),   --  : chkdsco2 (Integer)
           78 => ( Parameter_Integer, 0 ),   --  : chkdsco3 (Integer)
           79 => ( Parameter_Integer, 0 ),   --  : chknop (Integer)
           80 => ( Parameter_Integer, 0 ),   --  : citizen (Integer)
           81 => ( Parameter_Integer, 0 ),   --  : citizen2 (Integer)
           82 => ( Parameter_Integer, 0 ),   --  : claifut1 (Integer)
           83 => ( Parameter_Integer, 0 ),   --  : claifut2 (Integer)
           84 => ( Parameter_Integer, 0 ),   --  : claifut3 (Integer)
           85 => ( Parameter_Integer, 0 ),   --  : claifut4 (Integer)
           86 => ( Parameter_Integer, 0 ),   --  : claifut5 (Integer)
           87 => ( Parameter_Integer, 0 ),   --  : claifut6 (Integer)
           88 => ( Parameter_Integer, 0 ),   --  : claifut7 (Integer)
           89 => ( Parameter_Integer, 0 ),   --  : claifut8 (Integer)
           90 => ( Parameter_Integer, 0 ),   --  : claimant (Integer)
           91 => ( Parameter_Integer, 0 ),   --  : cohabit (Integer)
           92 => ( Parameter_Integer, 0 ),   --  : combid (Integer)
           93 => ( Parameter_Integer, 0 ),   --  : commusat (Integer)
           94 => ( Parameter_Integer, 0 ),   --  : condit (Integer)
           95 => ( Parameter_Integer, 0 ),   --  : contuk (Integer)
           96 => ( Parameter_Integer, 0 ),   --  : convbl (Integer)
           97 => ( Parameter_Integer, 0 ),   --  : coptrust (Integer)
           98 => ( Parameter_Integer, 0 ),   --  : corign (Integer)
           99 => ( Parameter_Integer, 0 ),   --  : corigoth (Integer)
           100 => ( Parameter_Integer, 0 ),   --  : ctclum1 (Integer)
           101 => ( Parameter_Integer, 0 ),   --  : ctclum2 (Integer)
           102 => ( Parameter_Integer, 0 ),   --  : cupchk (Integer)
           103 => ( Parameter_Integer, 0 ),   --  : curqual (Integer)
           104 => ( Parameter_Integer, 0 ),   --  : cvht (Integer)
           105 => ( Parameter_Float, 0.0 ),   --  : cvpay (Amount)
           106 => ( Parameter_Integer, 0 ),   --  : cvpd (Integer)
           107 => ( Parameter_Integer, 0 ),   --  : ddaprog1 (Integer)
           108 => ( Parameter_Integer, 0 ),   --  : ddatre1 (Integer)
           109 => ( Parameter_Integer, 0 ),   --  : ddatrep1 (Integer)
           110 => ( Parameter_Integer, 0 ),   --  : defrpen (Integer)
           111 => ( Parameter_Integer, 0 ),   --  : degree (Integer)
           112 => ( Parameter_Integer, 0 ),   --  : degrenow (Integer)
           113 => ( Parameter_Integer, 0 ),   --  : denrec (Integer)
           114 => ( Parameter_Integer, 0 ),   --  : depend (Integer)
           115 => ( Parameter_Integer, 0 ),   --  : depress (Integer)
           116 => ( Parameter_Integer, 0 ),   --  : disben1 (Integer)
           117 => ( Parameter_Integer, 0 ),   --  : disben2 (Integer)
           118 => ( Parameter_Integer, 0 ),   --  : disben3 (Integer)
           119 => ( Parameter_Integer, 0 ),   --  : disben4 (Integer)
           120 => ( Parameter_Integer, 0 ),   --  : disben5 (Integer)
           121 => ( Parameter_Integer, 0 ),   --  : disben6 (Integer)
           122 => ( Parameter_Integer, 0 ),   --  : discuss (Integer)
           123 => ( Parameter_Integer, 0 ),   --  : disd01 (Integer)
           124 => ( Parameter_Integer, 0 ),   --  : disd02 (Integer)
           125 => ( Parameter_Integer, 0 ),   --  : disd03 (Integer)
           126 => ( Parameter_Integer, 0 ),   --  : disd04 (Integer)
           127 => ( Parameter_Integer, 0 ),   --  : disd05 (Integer)
           128 => ( Parameter_Integer, 0 ),   --  : disd06 (Integer)
           129 => ( Parameter_Integer, 0 ),   --  : disd07 (Integer)
           130 => ( Parameter_Integer, 0 ),   --  : disd08 (Integer)
           131 => ( Parameter_Integer, 0 ),   --  : disd09 (Integer)
           132 => ( Parameter_Integer, 0 ),   --  : disd10 (Integer)
           133 => ( Parameter_Integer, 0 ),   --  : disdifp1 (Integer)
           134 => ( Parameter_Integer, 0 ),   --  : dla1 (Integer)
           135 => ( Parameter_Integer, 0 ),   --  : dla2 (Integer)
           136 => ( Parameter_Integer, 0 ),   --  : dls (Integer)
           137 => ( Parameter_Float, 0.0 ),   --  : dlsamt (Amount)
           138 => ( Parameter_Integer, 0 ),   --  : dlspd (Integer)
           139 => ( Parameter_Integer, 0 ),   --  : dlsval (Integer)
           140 => ( Parameter_Date, Clock ),   --  : dob (Ada.Calendar.Time)
           141 => ( Parameter_Integer, 0 ),   --  : down (Integer)
           142 => ( Parameter_Integer, 0 ),   --  : dv09pens (Integer)
           143 => ( Parameter_Integer, 0 ),   --  : dvil03a (Integer)
           144 => ( Parameter_Integer, 0 ),   --  : dvil04a (Integer)
           145 => ( Parameter_Integer, 0 ),   --  : dvjb12ml (Integer)
           146 => ( Parameter_Integer, 0 ),   --  : dvmardf (Integer)
           147 => ( Parameter_Float, 0.0 ),   --  : ed1amt (Amount)
           148 => ( Parameter_Integer, 0 ),   --  : ed1pd (Integer)
           149 => ( Parameter_Integer, 0 ),   --  : ed1sum (Integer)
           150 => ( Parameter_Float, 0.0 ),   --  : ed2amt (Amount)
           151 => ( Parameter_Integer, 0 ),   --  : ed2pd (Integer)
           152 => ( Parameter_Integer, 0 ),   --  : ed2sum (Integer)
           153 => ( Parameter_Integer, 0 ),   --  : edatt (Integer)
           154 => ( Parameter_Integer, 0 ),   --  : edhr (Integer)
           155 => ( Parameter_Integer, 0 ),   --  : edtyp (Integer)
           156 => ( Parameter_Integer, 0 ),   --  : eligadlt (Integer)
           157 => ( Parameter_Integer, 0 ),   --  : eligchld (Integer)
           158 => ( Parameter_Integer, 0 ),   --  : eligschm (Integer)
           159 => ( Parameter_Integer, 0 ),   --  : emparr (Integer)
           160 => ( Parameter_Integer, 0 ),   --  : empcontr (Integer)
           161 => ( Parameter_Integer, 0 ),   --  : emppen (Integer)
           162 => ( Parameter_Integer, 0 ),   --  : empschm (Integer)
           163 => ( Parameter_Integer, 0 ),   --  : empstat (Integer)
           164 => ( Parameter_Integer, 0 ),   --  : envirsat (Integer)
           165 => ( Parameter_Integer, 0 ),   --  : es2000 (Integer)
           166 => ( Parameter_Integer, 0 ),   --  : ethgrps (Integer)
           167 => ( Parameter_Integer, 0 ),   --  : etngrp (Integer)
           168 => ( Parameter_Float, 0.0 ),   --  : eualiamt (Amount)
           169 => ( Parameter_Integer, 0 ),   --  : eualimny (Integer)
           170 => ( Parameter_Integer, 0 ),   --  : eualipd (Integer)
           171 => ( Parameter_Integer, 0 ),   --  : euetype (Integer)
           172 => ( Parameter_Integer, 0 ),   --  : everwrk (Integer)
           173 => ( Parameter_Integer, 0 ),   --  : exthbct1 (Integer)
           174 => ( Parameter_Integer, 0 ),   --  : followsc (Integer)
           175 => ( Parameter_Integer, 0 ),   --  : followup (Integer)
           176 => ( Parameter_Integer, 0 ),   --  : fted (Integer)
           177 => ( Parameter_Integer, 0 ),   --  : ftwk (Integer)
           178 => ( Parameter_Integer, 0 ),   --  : gpispc (Integer)
           179 => ( Parameter_Integer, 0 ),   --  : gpjsaesa (Integer)
           180 => ( Parameter_Integer, 0 ),   --  : x_grant (Integer)
           181 => ( Parameter_Float, 0.0 ),   --  : grtamt1 (Amount)
           182 => ( Parameter_Float, 0.0 ),   --  : grtamt2 (Amount)
           183 => ( Parameter_Float, 0.0 ),   --  : grtdir1 (Amount)
           184 => ( Parameter_Float, 0.0 ),   --  : grtdir2 (Amount)
           185 => ( Parameter_Integer, 0 ),   --  : grtnum (Integer)
           186 => ( Parameter_Integer, 0 ),   --  : grtsce1 (Integer)
           187 => ( Parameter_Integer, 0 ),   --  : grtsce2 (Integer)
           188 => ( Parameter_Float, 0.0 ),   --  : grtval1 (Amount)
           189 => ( Parameter_Float, 0.0 ),   --  : grtval2 (Amount)
           190 => ( Parameter_Integer, 0 ),   --  : gta (Integer)
           191 => ( Parameter_Integer, 0 ),   --  : happy (Integer)
           192 => ( Parameter_Integer, 0 ),   --  : health1 (Integer)
           193 => ( Parameter_Integer, 0 ),   --  : heathad (Integer)
           194 => ( Parameter_Integer, 0 ),   --  : help (Integer)
           195 => ( Parameter_Integer, 0 ),   --  : hholder (Integer)
           196 => ( Parameter_Integer, 0 ),   --  : hi1qual1 (Integer)
           197 => ( Parameter_Integer, 0 ),   --  : hi1qual2 (Integer)
           198 => ( Parameter_Integer, 0 ),   --  : hi1qual3 (Integer)
           199 => ( Parameter_Integer, 0 ),   --  : hi1qual4 (Integer)
           200 => ( Parameter_Integer, 0 ),   --  : hi1qual5 (Integer)
           201 => ( Parameter_Integer, 0 ),   --  : hi1qual6 (Integer)
           202 => ( Parameter_Integer, 0 ),   --  : hi3qual (Integer)
           203 => ( Parameter_Integer, 0 ),   --  : higho (Integer)
           204 => ( Parameter_Integer, 0 ),   --  : highonow (Integer)
           205 => ( Parameter_Integer, 0 ),   --  : hrpid (Integer)
           206 => ( Parameter_Integer, 0 ),   --  : hsvper (Integer)
           207 => ( Parameter_Integer, 0 ),   --  : iclaim1 (Integer)
           208 => ( Parameter_Integer, 0 ),   --  : iclaim2 (Integer)
           209 => ( Parameter_Integer, 0 ),   --  : iclaim3 (Integer)
           210 => ( Parameter_Integer, 0 ),   --  : iclaim4 (Integer)
           211 => ( Parameter_Integer, 0 ),   --  : iclaim5 (Integer)
           212 => ( Parameter_Integer, 0 ),   --  : iclaim6 (Integer)
           213 => ( Parameter_Integer, 0 ),   --  : iclaim7 (Integer)
           214 => ( Parameter_Integer, 0 ),   --  : iclaim8 (Integer)
           215 => ( Parameter_Integer, 0 ),   --  : iclaim9 (Integer)
           216 => ( Parameter_Integer, 0 ),   --  : incdur (Integer)
           217 => ( Parameter_Integer, 0 ),   --  : injlong (Integer)
           218 => ( Parameter_Integer, 0 ),   --  : injwk (Integer)
           219 => ( Parameter_Integer, 0 ),   --  : invests (Integer)
           220 => ( Parameter_Integer, 0 ),   --  : iout (Integer)
           221 => ( Parameter_Integer, 0 ),   --  : isa1type (Integer)
           222 => ( Parameter_Integer, 0 ),   --  : isa2type (Integer)
           223 => ( Parameter_Integer, 0 ),   --  : issue (Integer)
           224 => ( Parameter_Integer, 0 ),   --  : jobaway (Integer)
           225 => ( Parameter_Integer, 0 ),   --  : jobbyr (Integer)
           226 => ( Parameter_Integer, 0 ),   --  : jobsat (Integer)
           227 => ( Parameter_Integer, 0 ),   --  : kidben1 (Integer)
           228 => ( Parameter_Integer, 0 ),   --  : kidben2 (Integer)
           229 => ( Parameter_Integer, 0 ),   --  : kidben3 (Integer)
           230 => ( Parameter_Integer, 0 ),   --  : lareg (Integer)
           231 => ( Parameter_Integer, 0 ),   --  : legltrus (Integer)
           232 => ( Parameter_Integer, 0 ),   --  : lifesat (Integer)
           233 => ( Parameter_Integer, 0 ),   --  : likewk (Integer)
           234 => ( Parameter_Integer, 0 ),   --  : limitl (Integer)
           235 => ( Parameter_Integer, 0 ),   --  : lktime (Integer)
           236 => ( Parameter_Integer, 0 ),   --  : lktrain (Integer)
           237 => ( Parameter_Integer, 0 ),   --  : lkwork (Integer)
           238 => ( Parameter_Integer, 0 ),   --  : lnkdwp (Integer)
           239 => ( Parameter_Integer, 0 ),   --  : lnkref01 (Integer)
           240 => ( Parameter_Integer, 0 ),   --  : lnkref02 (Integer)
           241 => ( Parameter_Integer, 0 ),   --  : lnkref03 (Integer)
           242 => ( Parameter_Integer, 0 ),   --  : lnkref04 (Integer)
           243 => ( Parameter_Integer, 0 ),   --  : lnkref05 (Integer)
           244 => ( Parameter_Integer, 0 ),   --  : lnkref06 (Integer)
           245 => ( Parameter_Integer, 0 ),   --  : lnkref07 (Integer)
           246 => ( Parameter_Integer, 0 ),   --  : lnkref08 (Integer)
           247 => ( Parameter_Integer, 0 ),   --  : lnkref09 (Integer)
           248 => ( Parameter_Integer, 0 ),   --  : lnkref10 (Integer)
           249 => ( Parameter_Integer, 0 ),   --  : lnkref11 (Integer)
           250 => ( Parameter_Integer, 0 ),   --  : loan (Integer)
           251 => ( Parameter_Integer, 0 ),   --  : loannum (Integer)
           252 => ( Parameter_Integer, 0 ),   --  : lstwrk1 (Integer)
           253 => ( Parameter_Integer, 0 ),   --  : lstwrk2 (Integer)
           254 => ( Parameter_Integer, 0 ),   --  : lstyr (Integer)
           255 => ( Parameter_Integer, 0 ),   --  : meaning (Integer)
           256 => ( Parameter_Integer, 0 ),   --  : medrec (Integer)
           257 => ( Parameter_Integer, 0 ),   --  : memschm (Integer)
           258 => ( Parameter_Float, 0.0 ),   --  : mntamt1 (Amount)
           259 => ( Parameter_Float, 0.0 ),   --  : mntamt2 (Amount)
           260 => ( Parameter_Integer, 0 ),   --  : mntarr1 (Integer)
           261 => ( Parameter_Integer, 0 ),   --  : mntarr2 (Integer)
           262 => ( Parameter_Integer, 0 ),   --  : mntarr3 (Integer)
           263 => ( Parameter_Integer, 0 ),   --  : mntarr4 (Integer)
           264 => ( Parameter_Integer, 0 ),   --  : mntgov1 (Integer)
           265 => ( Parameter_Integer, 0 ),   --  : mntgov2 (Integer)
           266 => ( Parameter_Integer, 0 ),   --  : mntnrp (Integer)
           267 => ( Parameter_Integer, 0 ),   --  : mntpay (Integer)
           268 => ( Parameter_Integer, 0 ),   --  : mntpd1 (Integer)
           269 => ( Parameter_Integer, 0 ),   --  : mntpd2 (Integer)
           270 => ( Parameter_Integer, 0 ),   --  : mntrec (Integer)
           271 => ( Parameter_Integer, 0 ),   --  : mntus1 (Integer)
           272 => ( Parameter_Integer, 0 ),   --  : mntus2 (Integer)
           273 => ( Parameter_Float, 0.0 ),   --  : mntusam1 (Amount)
           274 => ( Parameter_Float, 0.0 ),   --  : mntusam2 (Amount)
           275 => ( Parameter_Integer, 0 ),   --  : mntuspd1 (Integer)
           276 => ( Parameter_Integer, 0 ),   --  : mntuspd2 (Integer)
           277 => ( Parameter_Integer, 0 ),   --  : moneysat (Integer)
           278 => ( Parameter_Integer, 0 ),   --  : ms (Integer)
           279 => ( Parameter_Integer, 0 ),   --  : nanid1 (Integer)
           280 => ( Parameter_Integer, 0 ),   --  : nanid2 (Integer)
           281 => ( Parameter_Integer, 0 ),   --  : nanid3 (Integer)
           282 => ( Parameter_Integer, 0 ),   --  : nanid4 (Integer)
           283 => ( Parameter_Integer, 0 ),   --  : nanid5 (Integer)
           284 => ( Parameter_Integer, 0 ),   --  : nanid6 (Integer)
           285 => ( Parameter_Integer, 0 ),   --  : nervous (Integer)
           286 => ( Parameter_Integer, 0 ),   --  : ni2train (Integer)
           287 => ( Parameter_Float, 0.0 ),   --  : niamt (Amount)
           288 => ( Parameter_Integer, 0 ),   --  : nietngrp (Integer)
           289 => ( Parameter_Integer, 0 ),   --  : niexthbb (Integer)
           290 => ( Parameter_Integer, 0 ),   --  : ninanid1 (Integer)
           291 => ( Parameter_Integer, 0 ),   --  : ninanid2 (Integer)
           292 => ( Parameter_Integer, 0 ),   --  : ninanid3 (Integer)
           293 => ( Parameter_Integer, 0 ),   --  : ninanid4 (Integer)
           294 => ( Parameter_Integer, 0 ),   --  : ninanid5 (Integer)
           295 => ( Parameter_Integer, 0 ),   --  : ninanid6 (Integer)
           296 => ( Parameter_Integer, 0 ),   --  : ninanid7 (Integer)
           297 => ( Parameter_Integer, 0 ),   --  : nipd (Integer)
           298 => ( Parameter_Integer, 0 ),   --  : nireg (Integer)
           299 => ( Parameter_Integer, 0 ),   --  : nirelig (Integer)
           300 => ( Parameter_Integer, 0 ),   --  : nolk1 (Integer)
           301 => ( Parameter_Integer, 0 ),   --  : nolk2 (Integer)
           302 => ( Parameter_Integer, 0 ),   --  : nolk3 (Integer)
           303 => ( Parameter_Integer, 0 ),   --  : nowant (Integer)
           304 => ( Parameter_Float, 0.0 ),   --  : nssec (Amount)
           305 => ( Parameter_Integer, 0 ),   --  : numjob (Integer)
           306 => ( Parameter_Integer, 0 ),   --  : numjob2 (Integer)
           307 => ( Parameter_Integer, 0 ),   --  : nvqlenow (Integer)
           308 => ( Parameter_Integer, 0 ),   --  : nvqlev (Integer)
           309 => ( Parameter_Integer, 0 ),   --  : oddjob (Integer)
           310 => ( Parameter_Integer, 0 ),   --  : oldstud (Integer)
           311 => ( Parameter_Integer, 0 ),   --  : otabspar (Integer)
           312 => ( Parameter_Float, 0.0 ),   --  : otamt (Amount)
           313 => ( Parameter_Float, 0.0 ),   --  : otapamt (Amount)
           314 => ( Parameter_Integer, 0 ),   --  : otappd (Integer)
           315 => ( Parameter_Integer, 0 ),   --  : othben1 (Integer)
           316 => ( Parameter_Integer, 0 ),   --  : othben2 (Integer)
           317 => ( Parameter_Integer, 0 ),   --  : othben3 (Integer)
           318 => ( Parameter_Integer, 0 ),   --  : othben4 (Integer)
           319 => ( Parameter_Integer, 0 ),   --  : othben5 (Integer)
           320 => ( Parameter_Integer, 0 ),   --  : othben6 (Integer)
           321 => ( Parameter_Integer, 0 ),   --  : othpass (Integer)
           322 => ( Parameter_Integer, 0 ),   --  : othqual1 (Integer)
           323 => ( Parameter_Integer, 0 ),   --  : othqual2 (Integer)
           324 => ( Parameter_Integer, 0 ),   --  : othqual3 (Integer)
           325 => ( Parameter_Integer, 0 ),   --  : othtax (Integer)
           326 => ( Parameter_Integer, 0 ),   --  : othtrust (Integer)
           327 => ( Parameter_Integer, 0 ),   --  : otinva (Integer)
           328 => ( Parameter_Float, 0.0 ),   --  : pareamt (Amount)
           329 => ( Parameter_Integer, 0 ),   --  : parepd (Integer)
           330 => ( Parameter_Integer, 0 ),   --  : penben1 (Integer)
           331 => ( Parameter_Integer, 0 ),   --  : penben2 (Integer)
           332 => ( Parameter_Integer, 0 ),   --  : penben3 (Integer)
           333 => ( Parameter_Integer, 0 ),   --  : penben4 (Integer)
           334 => ( Parameter_Integer, 0 ),   --  : penben5 (Integer)
           335 => ( Parameter_Integer, 0 ),   --  : penflag (Integer)
           336 => ( Parameter_Integer, 0 ),   --  : penlump (Integer)
           337 => ( Parameter_Integer, 0 ),   --  : perspen1 (Integer)
           338 => ( Parameter_Integer, 0 ),   --  : perspen2 (Integer)
           339 => ( Parameter_Integer, 0 ),   --  : pip1 (Integer)
           340 => ( Parameter_Integer, 0 ),   --  : pip2 (Integer)
           341 => ( Parameter_Integer, 0 ),   --  : pollopin (Integer)
           342 => ( Parameter_Integer, 0 ),   --  : polttrus (Integer)
           343 => ( Parameter_Integer, 0 ),   --  : ppchk1 (Integer)
           344 => ( Parameter_Integer, 0 ),   --  : ppchk2 (Integer)
           345 => ( Parameter_Integer, 0 ),   --  : ppchk3 (Integer)
           346 => ( Parameter_Integer, 0 ),   --  : ppnumc (Integer)
           347 => ( Parameter_Integer, 0 ),   --  : ppper (Integer)
           348 => ( Parameter_Integer, 0 ),   --  : practice (Integer)
           349 => ( Parameter_Integer, 0 ),   --  : privpen (Integer)
           350 => ( Parameter_Float, 0.0 ),   --  : proptax (Amount)
           351 => ( Parameter_Integer, 0 ),   --  : ptwk (Integer)
           352 => ( Parameter_Integer, 0 ),   --  : r01 (Integer)
           353 => ( Parameter_Integer, 0 ),   --  : r02 (Integer)
           354 => ( Parameter_Integer, 0 ),   --  : r03 (Integer)
           355 => ( Parameter_Integer, 0 ),   --  : r04 (Integer)
           356 => ( Parameter_Integer, 0 ),   --  : r05 (Integer)
           357 => ( Parameter_Integer, 0 ),   --  : r06 (Integer)
           358 => ( Parameter_Integer, 0 ),   --  : r07 (Integer)
           359 => ( Parameter_Integer, 0 ),   --  : r08 (Integer)
           360 => ( Parameter_Integer, 0 ),   --  : r09 (Integer)
           361 => ( Parameter_Integer, 0 ),   --  : r10 (Integer)
           362 => ( Parameter_Integer, 0 ),   --  : r11 (Integer)
           363 => ( Parameter_Integer, 0 ),   --  : r12 (Integer)
           364 => ( Parameter_Integer, 0 ),   --  : r13 (Integer)
           365 => ( Parameter_Integer, 0 ),   --  : r14 (Integer)
           366 => ( Parameter_Integer, 0 ),   --  : reasden (Integer)
           367 => ( Parameter_Integer, 0 ),   --  : reasmed (Integer)
           368 => ( Parameter_Integer, 0 ),   --  : reasnhs (Integer)
           369 => ( Parameter_Integer, 0 ),   --  : reason (Integer)
           370 => ( Parameter_Integer, 0 ),   --  : recsat (Integer)
           371 => ( Parameter_Float, 0.0 ),   --  : redamt (Amount)
           372 => ( Parameter_Integer, 0 ),   --  : redany (Integer)
           373 => ( Parameter_Integer, 0 ),   --  : rednet (Integer)
           374 => ( Parameter_Float, 0.0 ),   --  : redtax (Amount)
           375 => ( Parameter_Integer, 0 ),   --  : relasat (Integer)
           376 => ( Parameter_Integer, 0 ),   --  : religenw (Integer)
           377 => ( Parameter_Integer, 0 ),   --  : religsc (Integer)
           378 => ( Parameter_Integer, 0 ),   --  : rentprof (Integer)
           379 => ( Parameter_Integer, 0 ),   --  : retire (Integer)
           380 => ( Parameter_Integer, 0 ),   --  : retire1 (Integer)
           381 => ( Parameter_Integer, 0 ),   --  : retreas (Integer)
           382 => ( Parameter_Integer, 0 ),   --  : royal1 (Integer)
           383 => ( Parameter_Integer, 0 ),   --  : royal2 (Integer)
           384 => ( Parameter_Integer, 0 ),   --  : royal3 (Integer)
           385 => ( Parameter_Integer, 0 ),   --  : royal4 (Integer)
           386 => ( Parameter_Float, 0.0 ),   --  : royyr1 (Amount)
           387 => ( Parameter_Float, 0.0 ),   --  : royyr2 (Amount)
           388 => ( Parameter_Float, 0.0 ),   --  : royyr3 (Amount)
           389 => ( Parameter_Float, 0.0 ),   --  : royyr4 (Amount)
           390 => ( Parameter_Integer, 0 ),   --  : rsa (Integer)
           391 => ( Parameter_Integer, 0 ),   --  : rsanow (Integer)
           392 => ( Parameter_Integer, 0 ),   --  : rstrct (Integer)
           393 => ( Parameter_Integer, 0 ),   --  : safe (Integer)
           394 => ( Parameter_Integer, 0 ),   --  : samesit (Integer)
           395 => ( Parameter_Integer, 0 ),   --  : schchk (Integer)
           396 => ( Parameter_Integer, 0 ),   --  : scotvec (Integer)
           397 => ( Parameter_Integer, 0 ),   --  : sctvnow (Integer)
           398 => ( Parameter_Integer, 0 ),   --  : sdemp01 (Integer)
           399 => ( Parameter_Integer, 0 ),   --  : sdemp02 (Integer)
           400 => ( Parameter_Integer, 0 ),   --  : sdemp03 (Integer)
           401 => ( Parameter_Integer, 0 ),   --  : sdemp04 (Integer)
           402 => ( Parameter_Integer, 0 ),   --  : sdemp05 (Integer)
           403 => ( Parameter_Integer, 0 ),   --  : sdemp06 (Integer)
           404 => ( Parameter_Integer, 0 ),   --  : sdemp07 (Integer)
           405 => ( Parameter_Integer, 0 ),   --  : sdemp08 (Integer)
           406 => ( Parameter_Integer, 0 ),   --  : sdemp09 (Integer)
           407 => ( Parameter_Integer, 0 ),   --  : sdemp10 (Integer)
           408 => ( Parameter_Integer, 0 ),   --  : sdemp11 (Integer)
           409 => ( Parameter_Integer, 0 ),   --  : sdemp12 (Integer)
           410 => ( Parameter_Integer, 0 ),   --  : selfdemp (Integer)
           411 => ( Parameter_Integer, 0 ),   --  : sex (Integer)
           412 => ( Parameter_Integer, 0 ),   --  : sflntyp1 (Integer)
           413 => ( Parameter_Integer, 0 ),   --  : sflntyp2 (Integer)
           414 => ( Parameter_Integer, 0 ),   --  : sftype1 (Integer)
           415 => ( Parameter_Integer, 0 ),   --  : sftype2 (Integer)
           416 => ( Parameter_Integer, 0 ),   --  : sic (Integer)
           417 => ( Parameter_Integer, 0 ),   --  : sidqn (Integer)
           418 => ( Parameter_Float, 0.0 ),   --  : slrepamt (Amount)
           419 => ( Parameter_Integer, 0 ),   --  : slrepay (Integer)
           420 => ( Parameter_Integer, 0 ),   --  : slreppd (Integer)
           421 => ( Parameter_Integer, 0 ),   --  : soc2010 (Integer)
           422 => ( Parameter_Integer, 0 ),   --  : socfund1 (Integer)
           423 => ( Parameter_Integer, 0 ),   --  : socfund2 (Integer)
           424 => ( Parameter_Integer, 0 ),   --  : socfund3 (Integer)
           425 => ( Parameter_Integer, 0 ),   --  : socfund4 (Integer)
           426 => ( Parameter_Integer, 0 ),   --  : spcreg1 (Integer)
           427 => ( Parameter_Integer, 0 ),   --  : spcreg2 (Integer)
           428 => ( Parameter_Integer, 0 ),   --  : spcreg3 (Integer)
           429 => ( Parameter_Integer, 0 ),   --  : spnumc (Integer)
           430 => ( Parameter_Integer, 0 ),   --  : spout (Integer)
           431 => ( Parameter_Integer, 0 ),   --  : spyrot (Integer)
           432 => ( Parameter_Float, 0.0 ),   --  : srentamt (Amount)
           433 => ( Parameter_Integer, 0 ),   --  : srentpd (Integer)
           434 => ( Parameter_Integer, 0 ),   --  : srispc (Integer)
           435 => ( Parameter_Integer, 0 ),   --  : srjsaesa (Integer)
           436 => ( Parameter_Integer, 0 ),   --  : stakep (Integer)
           437 => ( Parameter_Integer, 0 ),   --  : start (Integer)
           438 => ( Parameter_Integer, 0 ),   --  : tcever1 (Integer)
           439 => ( Parameter_Integer, 0 ),   --  : tcever2 (Integer)
           440 => ( Parameter_Integer, 0 ),   --  : tcrepay1 (Integer)
           441 => ( Parameter_Integer, 0 ),   --  : tcrepay2 (Integer)
           442 => ( Parameter_Integer, 0 ),   --  : tcrepay3 (Integer)
           443 => ( Parameter_Integer, 0 ),   --  : tcrepay4 (Integer)
           444 => ( Parameter_Integer, 0 ),   --  : tcrepay5 (Integer)
           445 => ( Parameter_Integer, 0 ),   --  : tcrepay6 (Integer)
           446 => ( Parameter_Integer, 0 ),   --  : tcthsyr1 (Integer)
           447 => ( Parameter_Integer, 0 ),   --  : tcthsyr2 (Integer)
           448 => ( Parameter_Integer, 0 ),   --  : tdaywrk (Integer)
           449 => ( Parameter_Integer, 0 ),   --  : tea (Integer)
           450 => ( Parameter_Integer, 0 ),   --  : tea9697 (Integer)
           451 => ( Parameter_Integer, 0 ),   --  : tempjob (Integer)
           452 => ( Parameter_Integer, 0 ),   --  : timesat (Integer)
           453 => ( Parameter_Integer, 0 ),   --  : topupl (Integer)
           454 => ( Parameter_Float, 0.0 ),   --  : totint (Amount)
           455 => ( Parameter_Integer, 0 ),   --  : train2 (Integer)
           456 => ( Parameter_Integer, 0 ),   --  : trainee (Integer)
           457 => ( Parameter_Integer, 0 ),   --  : trnallow (Integer)
           458 => ( Parameter_Float, 0.0 ),   --  : ttbprx (Amount)
           459 => ( Parameter_Integer, 0 ),   --  : tuborr (Integer)
           460 => ( Parameter_Integer, 0 ),   --  : typeed (Integer)
           461 => ( Parameter_Integer, 0 ),   --  : unpaid1 (Integer)
           462 => ( Parameter_Integer, 0 ),   --  : unpaid2 (Integer)
           463 => ( Parameter_Integer, 0 ),   --  : w1 (Integer)
           464 => ( Parameter_Integer, 0 ),   --  : w2 (Integer)
           465 => ( Parameter_Integer, 0 ),   --  : wageben1 (Integer)
           466 => ( Parameter_Integer, 0 ),   --  : wageben2 (Integer)
           467 => ( Parameter_Integer, 0 ),   --  : wageben3 (Integer)
           468 => ( Parameter_Integer, 0 ),   --  : wageben4 (Integer)
           469 => ( Parameter_Integer, 0 ),   --  : wageben5 (Integer)
           470 => ( Parameter_Integer, 0 ),   --  : wageben6 (Integer)
           471 => ( Parameter_Integer, 0 ),   --  : wageben7 (Integer)
           472 => ( Parameter_Integer, 0 ),   --  : wageben8 (Integer)
           473 => ( Parameter_Integer, 0 ),   --  : wait (Integer)
           474 => ( Parameter_Integer, 0 ),   --  : whoresp (Integer)
           475 => ( Parameter_Integer, 0 ),   --  : whosectb (Integer)
           476 => ( Parameter_Integer, 0 ),   --  : wintfuel (Integer)
           477 => ( Parameter_Integer, 0 ),   --  : working (Integer)
           478 => ( Parameter_Integer, 0 ),   --  : wpa (Integer)
           479 => ( Parameter_Integer, 0 ),   --  : wpba (Integer)
           480 => ( Parameter_Integer, 0 ),   --  : wtclum1 (Integer)
           481 => ( Parameter_Integer, 0 ),   --  : wtclum2 (Integer)
           482 => ( Parameter_Integer, 0 ),   --  : ystrtwk (Integer)
           483 => ( Parameter_Integer, 0 ),   --  : month (Integer)
           484 => ( Parameter_Integer, 0 ),   --  : able (Integer)
           485 => ( Parameter_Integer, 0 ),   --  : actacci (Integer)
           486 => ( Parameter_Integer, 0 ),   --  : age80 (Integer)
           487 => ( Parameter_Integer, 0 ),   --  : agehq80 (Integer)
           488 => ( Parameter_Integer, 0 ),   --  : basacti (Integer)
           489 => ( Parameter_Integer, 0 ),   --  : careab (Integer)
           490 => ( Parameter_Integer, 0 ),   --  : careah (Integer)
           491 => ( Parameter_Integer, 0 ),   --  : carecb (Integer)
           492 => ( Parameter_Integer, 0 ),   --  : carech (Integer)
           493 => ( Parameter_Integer, 0 ),   --  : carecl (Integer)
           494 => ( Parameter_Integer, 0 ),   --  : carefl (Integer)
           495 => ( Parameter_Integer, 0 ),   --  : carefr (Integer)
           496 => ( Parameter_Integer, 0 ),   --  : careot (Integer)
           497 => ( Parameter_Integer, 0 ),   --  : carere (Integer)
           498 => ( Parameter_Integer, 0 ),   --  : chbflg (Integer)
           499 => ( Parameter_Integer, 0 ),   --  : corignan (Integer)
           500 => ( Parameter_Integer, 0 ),   --  : curacti (Integer)
           501 => ( Parameter_Integer, 0 ),   --  : currjobm (Integer)
           502 => ( Parameter_Integer, 0 ),   --  : disacta1 (Integer)
           503 => ( Parameter_Integer, 0 ),   --  : discora1 (Integer)
           504 => ( Parameter_Integer, 0 ),   --  : dobmonth (Integer)
           505 => ( Parameter_Integer, 0 ),   --  : dobyear (Integer)
           506 => ( Parameter_Float, 0.0 ),   --  : empoccp (Amount)
           507 => ( Parameter_Integer, 0 ),   --  : empstatb (Integer)
           508 => ( Parameter_Integer, 0 ),   --  : empstatc (Integer)
           509 => ( Parameter_Integer, 0 ),   --  : empstati (Integer)
           510 => ( Parameter_Integer, 0 ),   --  : ethgr3 (Integer)
           511 => ( Parameter_Integer, 0 ),   --  : gebacti (Integer)
           512 => ( Parameter_Integer, 0 ),   --  : giltcti (Integer)
           513 => ( Parameter_Integer, 0 ),   --  : gross4 (Integer)
           514 => ( Parameter_Integer, 0 ),   --  : hdage (Integer)
           515 => ( Parameter_Integer, 0 ),   --  : hdben (Integer)
           516 => ( Parameter_Integer, 0 ),   --  : hdindinc (Integer)
           517 => ( Parameter_Float, 0.0 ),   --  : heartval (Amount)
           518 => ( Parameter_Integer, 0 ),   --  : hourab (Integer)
           519 => ( Parameter_Integer, 0 ),   --  : hourah (Integer)
           520 => ( Parameter_Float, 0.0 ),   --  : hourcare (Amount)
           521 => ( Parameter_Integer, 0 ),   --  : hourcb (Integer)
           522 => ( Parameter_Integer, 0 ),   --  : hourch (Integer)
           523 => ( Parameter_Integer, 0 ),   --  : hourcl (Integer)
           524 => ( Parameter_Integer, 0 ),   --  : hourfr (Integer)
           525 => ( Parameter_Integer, 0 ),   --  : hourot (Integer)
           526 => ( Parameter_Integer, 0 ),   --  : hourre (Integer)
           527 => ( Parameter_Integer, 0 ),   --  : hourtot (Integer)
           528 => ( Parameter_Integer, 0 ),   --  : hperson (Integer)
           529 => ( Parameter_Integer, 0 ),   --  : iagegr2 (Integer)
           530 => ( Parameter_Integer, 0 ),   --  : iagegr3 (Integer)
           531 => ( Parameter_Integer, 0 ),   --  : iagegr4 (Integer)
           532 => ( Parameter_Integer, 0 ),   --  : iagegrp (Integer)
           533 => ( Parameter_Float, 0.0 ),   --  : incseo2 (Amount)
           534 => ( Parameter_Integer, 0 ),   --  : indinc (Integer)
           535 => ( Parameter_Integer, 0 ),   --  : indisben (Integer)
           536 => ( Parameter_Float, 0.0 ),   --  : inearns (Amount)
           537 => ( Parameter_Float, 0.0 ),   --  : ininv (Amount)
           538 => ( Parameter_Integer, 0 ),   --  : inirben (Integer)
           539 => ( Parameter_Integer, 0 ),   --  : innirben (Integer)
           540 => ( Parameter_Integer, 0 ),   --  : inothben (Integer)
           541 => ( Parameter_Float, 0.0 ),   --  : inpeninc (Amount)
           542 => ( Parameter_Float, 0.0 ),   --  : inrinc (Amount)
           543 => ( Parameter_Float, 0.0 ),   --  : inrpinc (Amount)
           544 => ( Parameter_Float, 0.0 ),   --  : intvlic (Amount)
           545 => ( Parameter_Float, 0.0 ),   --  : intxcred (Amount)
           546 => ( Parameter_Integer, 0 ),   --  : isacti (Integer)
           547 => ( Parameter_Integer, 0 ),   --  : marital (Integer)
           548 => ( Parameter_Integer, 0 ),   --  : mjobsect (Integer)
           549 => ( Parameter_Integer, 0 ),   --  : ninanida (Integer)
           550 => ( Parameter_Float, 0.0 ),   --  : nincseo2 (Amount)
           551 => ( Parameter_Integer, 0 ),   --  : nindinc (Integer)
           552 => ( Parameter_Integer, 0 ),   --  : ninearns (Integer)
           553 => ( Parameter_Integer, 0 ),   --  : nininv (Integer)
           554 => ( Parameter_Integer, 0 ),   --  : ninnirbn (Integer)
           555 => ( Parameter_Integer, 0 ),   --  : ninothbn (Integer)
           556 => ( Parameter_Integer, 0 ),   --  : ninpenin (Integer)
           557 => ( Parameter_Integer, 0 ),   --  : ninrinc (Integer)
           558 => ( Parameter_Float, 0.0 ),   --  : ninsein2 (Amount)
           559 => ( Parameter_Integer, 0 ),   --  : nirel2 (Integer)
           560 => ( Parameter_Integer, 0 ),   --  : occupnum (Integer)
           561 => ( Parameter_Integer, 0 ),   --  : pepscti (Integer)
           562 => ( Parameter_Integer, 0 ),   --  : poaccti (Integer)
           563 => ( Parameter_Integer, 0 ),   --  : pocardi (Integer)
           564 => ( Parameter_Integer, 0 ),   --  : prevjobm (Integer)
           565 => ( Parameter_Integer, 0 ),   --  : relhrp (Integer)
           566 => ( Parameter_Float, 0.0 ),   --  : sapadj (Amount)
           567 => ( Parameter_Float, 0.0 ),   --  : seincam2 (Amount)
           568 => ( Parameter_Float, 0.0 ),   --  : smpadj (Amount)
           569 => ( Parameter_Float, 0.0 ),   --  : sppadj (Amount)
           570 => ( Parameter_Float, 0.0 ),   --  : sspadj (Amount)
           571 => ( Parameter_Integer, 0 ),   --  : stshcti (Integer)
           572 => ( Parameter_Integer, 0 ),   --  : taxpayer (Integer)
           573 => ( Parameter_Integer, 0 ),   --  : tesscti (Integer)
           574 => ( Parameter_Float, 0.0 ),   --  : totgrant (Amount)
           575 => ( Parameter_Float, 0.0 ),   --  : tothours (Amount)
           576 => ( Parameter_Float, 0.0 ),   --  : totoccp (Amount)
           577 => ( Parameter_Integer, 0 ),   --  : typeed2 (Integer)
           578 => ( Parameter_Integer, 0 ),   --  : untrcti (Integer)
           579 => ( Parameter_Integer, 0 ),   --  : uperson (Integer)
           580 => ( Parameter_Integer, 0 ),   --  : w45 (Integer)
           581 => ( Parameter_Float, 0.0 ),   --  : widoccp (Amount)
           582 => ( Parameter_Integer, 0 ),   --  : xbonflag (Integer)
           583 => ( Parameter_Integer, 0 ),   --  : anxious (Integer)
           584 => ( Parameter_Integer, 0 ),   --  : candgnow (Integer)
           585 => ( Parameter_Integer, 0 ),   --  : curothf (Integer)
           586 => ( Parameter_Integer, 0 ),   --  : curothp (Integer)
           587 => ( Parameter_Integer, 0 ),   --  : curothwv (Integer)
           588 => ( Parameter_Integer, 0 ),   --  : dvhiqual (Integer)
           589 => ( Parameter_Integer, 0 ),   --  : gnvqnow (Integer)
           590 => ( Parameter_Integer, 0 ),   --  : gpuc (Integer)
           591 => ( Parameter_Integer, 0 ),   --  : happywb (Integer)
           592 => ( Parameter_Integer, 0 ),   --  : hi1qual7 (Integer)
           593 => ( Parameter_Integer, 0 ),   --  : hi1qual8 (Integer)
           594 => ( Parameter_Integer, 0 ),   --  : mntarr5 (Integer)
           595 => ( Parameter_Integer, 0 ),   --  : mntnoch1 (Integer)
           596 => ( Parameter_Integer, 0 ),   --  : mntnoch2 (Integer)
           597 => ( Parameter_Integer, 0 ),   --  : mntnoch3 (Integer)
           598 => ( Parameter_Integer, 0 ),   --  : mntnoch4 (Integer)
           599 => ( Parameter_Integer, 0 ),   --  : mntnoch5 (Integer)
           600 => ( Parameter_Integer, 0 ),   --  : mntpro1 (Integer)
           601 => ( Parameter_Integer, 0 ),   --  : mntpro2 (Integer)
           602 => ( Parameter_Integer, 0 ),   --  : mntpro3 (Integer)
           603 => ( Parameter_Integer, 0 ),   --  : mnttim1 (Integer)
           604 => ( Parameter_Integer, 0 ),   --  : mnttim2 (Integer)
           605 => ( Parameter_Integer, 0 ),   --  : mnttim3 (Integer)
           606 => ( Parameter_Integer, 0 ),   --  : mntwrk1 (Integer)
           607 => ( Parameter_Integer, 0 ),   --  : mntwrk2 (Integer)
           608 => ( Parameter_Integer, 0 ),   --  : mntwrk3 (Integer)
           609 => ( Parameter_Integer, 0 ),   --  : mntwrk4 (Integer)
           610 => ( Parameter_Integer, 0 ),   --  : mntwrk5 (Integer)
           611 => ( Parameter_Integer, 0 ),   --  : ndeplnow (Integer)
           612 => ( Parameter_Integer, 0 ),   --  : oqualc1 (Integer)
           613 => ( Parameter_Integer, 0 ),   --  : oqualc2 (Integer)
           614 => ( Parameter_Integer, 0 ),   --  : oqualc3 (Integer)
           615 => ( Parameter_Integer, 0 ),   --  : sruc (Integer)
           616 => ( Parameter_Integer, 0 ),   --  : webacnow (Integer)
           617 => ( Parameter_Integer, 0 ),   --  : indeth (Integer)
           618 => ( Parameter_Integer, 0 ),   --  : euactive (Integer)
           619 => ( Parameter_Integer, 0 ),   --  : euactno (Integer)
           620 => ( Parameter_Integer, 0 ),   --  : euartact (Integer)
           621 => ( Parameter_Integer, 0 ),   --  : euaskhlp (Integer)
           622 => ( Parameter_Integer, 0 ),   --  : eucinema (Integer)
           623 => ( Parameter_Integer, 0 ),   --  : eucultur (Integer)
           624 => ( Parameter_Integer, 0 ),   --  : euinvol (Integer)
           625 => ( Parameter_Integer, 0 ),   --  : eulivpe (Integer)
           626 => ( Parameter_Integer, 0 ),   --  : eumtfam (Integer)
           627 => ( Parameter_Integer, 0 ),   --  : eumtfrnd (Integer)
           628 => ( Parameter_Integer, 0 ),   --  : eusocnet (Integer)
           629 => ( Parameter_Integer, 0 ),   --  : eusport (Integer)
           630 => ( Parameter_Integer, 0 ),   --  : eutkfam (Integer)
           631 => ( Parameter_Integer, 0 ),   --  : eutkfrnd (Integer)
           632 => ( Parameter_Integer, 0 ),   --  : eutkmat (Integer)
           633 => ( Parameter_Integer, 0 ),   --  : euvol (Integer)
           634 => ( Parameter_Integer, 0 ),   --  : natscot (Integer)
           635 => ( Parameter_Integer, 0 ),   --  : ntsctnow (Integer)
           636 => ( Parameter_Integer, 0 ),   --  : penwel1 (Integer)
           637 => ( Parameter_Integer, 0 ),   --  : penwel2 (Integer)
           638 => ( Parameter_Integer, 0 ),   --  : penwel3 (Integer)
           639 => ( Parameter_Integer, 0 ),   --  : penwel4 (Integer)
           640 => ( Parameter_Integer, 0 ),   --  : penwel5 (Integer)
           641 => ( Parameter_Integer, 0 ),   --  : penwel6 (Integer)
           642 => ( Parameter_Integer, 0 ),   --  : skiwknow (Integer)
           643 => ( Parameter_Integer, 0 ),   --  : skiwrk (Integer)
           644 => ( Parameter_Integer, 0 ),   --  : slos (Integer)
           645 => ( Parameter_Integer, 0 ),   --  : yjblev (Integer)
           646 => ( Parameter_Integer, 0 ),   --  : abs2no (Integer)
           647 => ( Parameter_Integer, 0 ),   --  : accftpt (Integer)
           648 => ( Parameter_Integer, 0 ),   --  : b2qfut1 (Integer)
           649 => ( Parameter_Integer, 0 ),   --  : b2qfut2 (Integer)
           650 => ( Parameter_Integer, 0 ),   --  : b2qfut3 (Integer)
           651 => ( Parameter_Integer, 0 ),   --  : b3qfut1 (Integer)
           652 => ( Parameter_Integer, 0 ),   --  : b3qfut2 (Integer)
           653 => ( Parameter_Integer, 0 ),   --  : b3qfut3 (Integer)
           654 => ( Parameter_Integer, 0 ),   --  : b3qfut4 (Integer)
           655 => ( Parameter_Integer, 0 ),   --  : b3qfut5 (Integer)
           656 => ( Parameter_Integer, 0 ),   --  : b3qfut6 (Integer)
           657 => ( Parameter_Integer, 0 ),   --  : ben1q1 (Integer)
           658 => ( Parameter_Integer, 0 ),   --  : ben1q2 (Integer)
           659 => ( Parameter_Integer, 0 ),   --  : ben1q3 (Integer)
           660 => ( Parameter_Integer, 0 ),   --  : ben1q4 (Integer)
           661 => ( Parameter_Integer, 0 ),   --  : ben1q5 (Integer)
           662 => ( Parameter_Integer, 0 ),   --  : ben1q6 (Integer)
           663 => ( Parameter_Integer, 0 ),   --  : ben1q7 (Integer)
           664 => ( Parameter_Integer, 0 ),   --  : ben2q1 (Integer)
           665 => ( Parameter_Integer, 0 ),   --  : ben2q2 (Integer)
           666 => ( Parameter_Integer, 0 ),   --  : ben2q3 (Integer)
           667 => ( Parameter_Integer, 0 ),   --  : ben3q1 (Integer)
           668 => ( Parameter_Integer, 0 ),   --  : ben3q2 (Integer)
           669 => ( Parameter_Integer, 0 ),   --  : ben3q3 (Integer)
           670 => ( Parameter_Integer, 0 ),   --  : ben3q4 (Integer)
           671 => ( Parameter_Integer, 0 ),   --  : ben3q5 (Integer)
           672 => ( Parameter_Integer, 0 ),   --  : ben3q6 (Integer)
           673 => ( Parameter_Integer, 0 ),   --  : ben4q1 (Integer)
           674 => ( Parameter_Integer, 0 ),   --  : ben4q2 (Integer)
           675 => ( Parameter_Integer, 0 ),   --  : ben4q3 (Integer)
           676 => ( Parameter_Integer, 0 ),   --  : ben5q1 (Integer)
           677 => ( Parameter_Integer, 0 ),   --  : ben5q2 (Integer)
           678 => ( Parameter_Integer, 0 ),   --  : ben5q3 (Integer)
           679 => ( Parameter_Integer, 0 ),   --  : ben5q4 (Integer)
           680 => ( Parameter_Integer, 0 ),   --  : ben5q5 (Integer)
           681 => ( Parameter_Integer, 0 ),   --  : ben5q6 (Integer)
           682 => ( Parameter_Integer, 0 ),   --  : ben7q1 (Integer)
           683 => ( Parameter_Integer, 0 ),   --  : ben7q2 (Integer)
           684 => ( Parameter_Integer, 0 ),   --  : ben7q3 (Integer)
           685 => ( Parameter_Integer, 0 ),   --  : ben7q4 (Integer)
           686 => ( Parameter_Integer, 0 ),   --  : ben7q5 (Integer)
           687 => ( Parameter_Integer, 0 ),   --  : ben7q6 (Integer)
           688 => ( Parameter_Integer, 0 ),   --  : ben7q7 (Integer)
           689 => ( Parameter_Integer, 0 ),   --  : ben7q8 (Integer)
           690 => ( Parameter_Integer, 0 ),   --  : ben7q9 (Integer)
           691 => ( Parameter_Integer, 0 ),   --  : btwacc (Integer)
           692 => ( Parameter_Integer, 0 ),   --  : dentist (Integer)
           693 => ( Parameter_Integer, 0 ),   --  : disdif1 (Integer)
           694 => ( Parameter_Integer, 0 ),   --  : disdif2 (Integer)
           695 => ( Parameter_Integer, 0 ),   --  : disdif3 (Integer)
           696 => ( Parameter_Integer, 0 ),   --  : disdif4 (Integer)
           697 => ( Parameter_Integer, 0 ),   --  : disdif5 (Integer)
           698 => ( Parameter_Integer, 0 ),   --  : disdif6 (Integer)
           699 => ( Parameter_Integer, 0 ),   --  : disdif7 (Integer)
           700 => ( Parameter_Integer, 0 ),   --  : disdif8 (Integer)
           701 => ( Parameter_Integer, 0 ),   --  : dptcboth (Integer)
           702 => ( Parameter_Integer, 0 ),   --  : dptclum (Integer)
           703 => ( Parameter_Integer, 0 ),   --  : ed1borr (Integer)
           704 => ( Parameter_Integer, 0 ),   --  : ed1int (Integer)
           705 => ( Parameter_Date, Clock ),   --  : ed1monyr (Ada.Calendar.Time)
           706 => ( Parameter_Integer, 0 ),   --  : ed2borr (Integer)
           707 => ( Parameter_Integer, 0 ),   --  : ed2int (Integer)
           708 => ( Parameter_Date, Clock ),   --  : ed2monyr (Ada.Calendar.Time)
           709 => ( Parameter_Integer, 0 ),   --  : edattn1 (Integer)
           710 => ( Parameter_Integer, 0 ),   --  : edattn2 (Integer)
           711 => ( Parameter_Integer, 0 ),   --  : edattn3 (Integer)
           712 => ( Parameter_Integer, 0 ),   --  : edtime (Integer)
           713 => ( Parameter_Integer, 0 ),   --  : emppay1 (Integer)
           714 => ( Parameter_Integer, 0 ),   --  : emppay2 (Integer)
           715 => ( Parameter_Integer, 0 ),   --  : emppay3 (Integer)
           716 => ( Parameter_Integer, 0 ),   --  : endyr (Integer)
           717 => ( Parameter_Integer, 0 ),   --  : epcur (Integer)
           718 => ( Parameter_Integer, 0 ),   --  : ethgrp (Integer)
           719 => ( Parameter_Integer, 0 ),   --  : exthbct2 (Integer)
           720 => ( Parameter_Integer, 0 ),   --  : exthbct3 (Integer)
           721 => ( Parameter_Integer, 0 ),   --  : eyetest (Integer)
           722 => ( Parameter_Integer, 0 ),   --  : follow (Integer)
           723 => ( Parameter_Integer, 0 ),   --  : future (Integer)
           724 => ( Parameter_Integer, 0 ),   --  : govpis (Integer)
           725 => ( Parameter_Integer, 0 ),   --  : govpjsa (Integer)
           726 => ( Parameter_Float, 0.0 ),   --  : hbothamt (Amount)
           727 => ( Parameter_Integer, 0 ),   --  : hbothbu (Integer)
           728 => ( Parameter_Integer, 0 ),   --  : hbothpd (Integer)
           729 => ( Parameter_Integer, 0 ),   --  : hbothwk (Integer)
           730 => ( Parameter_Integer, 0 ),   --  : hbotwait (Integer)
           731 => ( Parameter_Integer, 0 ),   --  : health (Integer)
           732 => ( Parameter_Integer, 0 ),   --  : hosp (Integer)
           733 => ( Parameter_Integer, 0 ),   --  : hprob (Integer)
           734 => ( Parameter_Integer, 0 ),   --  : isa3type (Integer)
           735 => ( Parameter_Integer, 0 ),   --  : ln1rpint (Integer)
           736 => ( Parameter_Integer, 0 ),   --  : ln2rpint (Integer)
           737 => ( Parameter_Integer, 0 ),   --  : look (Integer)
           738 => ( Parameter_Integer, 0 ),   --  : lookwk (Integer)
           739 => ( Parameter_Integer, 0 ),   --  : mntct (Integer)
           740 => ( Parameter_Integer, 0 ),   --  : mntfor1 (Integer)
           741 => ( Parameter_Integer, 0 ),   --  : mntfor2 (Integer)
           742 => ( Parameter_Integer, 0 ),   --  : mnttota1 (Integer)
           743 => ( Parameter_Integer, 0 ),   --  : mnttota2 (Integer)
           744 => ( Parameter_Integer, 0 ),   --  : natid1 (Integer)
           745 => ( Parameter_Integer, 0 ),   --  : natid2 (Integer)
           746 => ( Parameter_Integer, 0 ),   --  : natid3 (Integer)
           747 => ( Parameter_Integer, 0 ),   --  : natid4 (Integer)
           748 => ( Parameter_Integer, 0 ),   --  : natid5 (Integer)
           749 => ( Parameter_Integer, 0 ),   --  : natid6 (Integer)
           750 => ( Parameter_Integer, 0 ),   --  : ndeal (Integer)
           751 => ( Parameter_Integer, 0 ),   --  : newdtype (Integer)
           752 => ( Parameter_Integer, 0 ),   --  : nhs1 (Integer)
           753 => ( Parameter_Integer, 0 ),   --  : nhs2 (Integer)
           754 => ( Parameter_Integer, 0 ),   --  : nhs3 (Integer)
           755 => ( Parameter_Integer, 0 ),   --  : niethgrp (Integer)
           756 => ( Parameter_Integer, 0 ),   --  : ninatid1 (Integer)
           757 => ( Parameter_Integer, 0 ),   --  : ninatid2 (Integer)
           758 => ( Parameter_Integer, 0 ),   --  : ninatid3 (Integer)
           759 => ( Parameter_Integer, 0 ),   --  : ninatid4 (Integer)
           760 => ( Parameter_Integer, 0 ),   --  : ninatid5 (Integer)
           761 => ( Parameter_Integer, 0 ),   --  : ninatid6 (Integer)
           762 => ( Parameter_Integer, 0 ),   --  : ninatid7 (Integer)
           763 => ( Parameter_Integer, 0 ),   --  : ninatid8 (Integer)
           764 => ( Parameter_Integer, 0 ),   --  : nirel (Integer)
           765 => ( Parameter_Integer, 0 ),   --  : nitrain (Integer)
           766 => ( Parameter_Integer, 0 ),   --  : nlper (Integer)
           767 => ( Parameter_Integer, 0 ),   --  : nolook (Integer)
           768 => ( Parameter_Integer, 0 ),   --  : ntcapp (Integer)
           769 => ( Parameter_Integer, 0 ),   --  : ntcdat (Integer)
           770 => ( Parameter_Float, 0.0 ),   --  : ntcinc (Amount)
           771 => ( Parameter_Integer, 0 ),   --  : ntcorig1 (Integer)
           772 => ( Parameter_Integer, 0 ),   --  : ntcorig2 (Integer)
           773 => ( Parameter_Integer, 0 ),   --  : ntcorig3 (Integer)
           774 => ( Parameter_Integer, 0 ),   --  : ntcorig4 (Integer)
           775 => ( Parameter_Integer, 0 ),   --  : ntcorig5 (Integer)
           776 => ( Parameter_Integer, 0 ),   --  : prit (Integer)
           777 => ( Parameter_Integer, 0 ),   --  : prscrpt (Integer)
           778 => ( Parameter_Integer, 0 ),   --  : soc2000 (Integer)
           779 => ( Parameter_Integer, 0 ),   --  : specs (Integer)
           780 => ( Parameter_Integer, 0 ),   --  : startyr (Integer)
           781 => ( Parameter_Integer, 0 ),   --  : taxcred1 (Integer)
           782 => ( Parameter_Integer, 0 ),   --  : taxcred2 (Integer)
           783 => ( Parameter_Integer, 0 ),   --  : taxcred3 (Integer)
           784 => ( Parameter_Integer, 0 ),   --  : taxcred4 (Integer)
           785 => ( Parameter_Integer, 0 ),   --  : taxcred5 (Integer)
           786 => ( Parameter_Integer, 0 ),   --  : taxfut (Integer)
           787 => ( Parameter_Integer, 0 ),   --  : train (Integer)
           788 => ( Parameter_Integer, 0 ),   --  : trav (Integer)
           789 => ( Parameter_Integer, 0 ),   --  : voucher (Integer)
           790 => ( Parameter_Integer, 0 ),   --  : war1 (Integer)
           791 => ( Parameter_Integer, 0 ),   --  : war2 (Integer)
           792 => ( Parameter_Integer, 0 ),   --  : wftcboth (Integer)
           793 => ( Parameter_Integer, 0 ),   --  : wftclum (Integer)
           794 => ( Parameter_Integer, 0 ),   --  : whyfrde1 (Integer)
           795 => ( Parameter_Integer, 0 ),   --  : whyfrde2 (Integer)
           796 => ( Parameter_Integer, 0 ),   --  : whyfrde3 (Integer)
           797 => ( Parameter_Integer, 0 ),   --  : whyfrde4 (Integer)
           798 => ( Parameter_Integer, 0 ),   --  : whyfrde5 (Integer)
           799 => ( Parameter_Integer, 0 ),   --  : whyfrde6 (Integer)
           800 => ( Parameter_Integer, 0 ),   --  : whyfrey1 (Integer)
           801 => ( Parameter_Integer, 0 ),   --  : whyfrey2 (Integer)
           802 => ( Parameter_Integer, 0 ),   --  : whyfrey3 (Integer)
           803 => ( Parameter_Integer, 0 ),   --  : whyfrey4 (Integer)
           804 => ( Parameter_Integer, 0 ),   --  : whyfrey5 (Integer)
           805 => ( Parameter_Integer, 0 ),   --  : whyfrey6 (Integer)
           806 => ( Parameter_Integer, 0 ),   --  : whyfrpr1 (Integer)
           807 => ( Parameter_Integer, 0 ),   --  : whyfrpr2 (Integer)
           808 => ( Parameter_Integer, 0 ),   --  : whyfrpr3 (Integer)
           809 => ( Parameter_Integer, 0 ),   --  : whyfrpr4 (Integer)
           810 => ( Parameter_Integer, 0 ),   --  : whyfrpr5 (Integer)
           811 => ( Parameter_Integer, 0 ),   --  : whyfrpr6 (Integer)
           812 => ( Parameter_Integer, 0 ),   --  : whytrav1 (Integer)
           813 => ( Parameter_Integer, 0 ),   --  : whytrav2 (Integer)
           814 => ( Parameter_Integer, 0 ),   --  : whytrav3 (Integer)
           815 => ( Parameter_Integer, 0 ),   --  : whytrav4 (Integer)
           816 => ( Parameter_Integer, 0 ),   --  : whytrav5 (Integer)
           817 => ( Parameter_Integer, 0 ),   --  : whytrav6 (Integer)
           818 => ( Parameter_Integer, 0 ),   --  : wmkit (Integer)
           819 => ( Parameter_Integer, 0 ),   --  : wtclum3 (Integer)
           820 => ( Parameter_Integer, 0 ),   --  : addda (Integer)
           821 => ( Parameter_Float, 0.0 ),   --  : bntxcred (Amount)
           822 => ( Parameter_Integer, 0 ),   --  : fsbndcti (Integer)
           823 => ( Parameter_Float, 0.0 ),   --  : fwmlkval (Amount)
           824 => ( Parameter_Integer, 0 ),   --  : gross2 (Integer)
           825 => ( Parameter_Integer, 0 ),   --  : gross3 (Integer)
           826 => ( Parameter_Float, 0.0 ),   --  : hbsupran (Amount)
           827 => ( Parameter_Float, 0.0 ),   --  : netocpen (Amount)
           828 => ( Parameter_Integer, 0 ),   --  : nsbocti (Integer)
           829 => ( Parameter_Integer, 0 ),   --  : otbscti (Integer)
           830 => ( Parameter_Integer, 0 ),   --  : prbocti (Integer)
           831 => ( Parameter_Integer, 0 ),   --  : sayecti (Integer)
           832 => ( Parameter_Integer, 0 ),   --  : sclbcti (Integer)
           833 => ( Parameter_Integer, 0 ),   --  : sscti (Integer)
           834 => ( Parameter_Float, 0.0 ),   --  : superan (Amount)
           835 => ( Parameter_Float, 0.0 ),   --  : ttwcosts (Amount)
           836 => ( Parameter_Integer, 0 ),   --  : ben5q7 (Integer)
           837 => ( Parameter_Integer, 0 ),   --  : ben5q8 (Integer)
           838 => ( Parameter_Integer, 0 ),   --  : ben5q9 (Integer)
           839 => ( Parameter_Integer, 0 ),   --  : ddatre (Integer)
           840 => ( Parameter_Integer, 0 ),   --  : disdif9 (Integer)
           841 => ( Parameter_Float, 0.0 ),   --  : fare (Amount)
           842 => ( Parameter_Integer, 0 ),   --  : nittwmod (Integer)
           843 => ( Parameter_Integer, 0 ),   --  : oneway (Integer)
           844 => ( Parameter_Float, 0.0 ),   --  : pssamt (Amount)
           845 => ( Parameter_Integer, 0 ),   --  : pssdate (Integer)
           846 => ( Parameter_Integer, 0 ),   --  : ttwcode1 (Integer)
           847 => ( Parameter_Integer, 0 ),   --  : ttwcode2 (Integer)
           848 => ( Parameter_Integer, 0 ),   --  : ttwcode3 (Integer)
           849 => ( Parameter_Float, 0.0 ),   --  : ttwcost (Amount)
           850 => ( Parameter_Integer, 0 ),   --  : ttwfar (Integer)
           851 => ( Parameter_Float, 0.0 ),   --  : ttwfrq (Amount)
           852 => ( Parameter_Integer, 0 ),   --  : ttwmod (Integer)
           853 => ( Parameter_Integer, 0 ),   --  : ttwpay (Integer)
           854 => ( Parameter_Integer, 0 ),   --  : ttwpss (Integer)
           855 => ( Parameter_Float, 0.0 ),   --  : ttwrec (Amount)
           856 => ( Parameter_Integer, 0 ),   --  : crunaci (Integer)
           857 => ( Parameter_Integer, 0 ),   --  : enomorti (Integer)
           858 => ( Parameter_Integer, 0 ),   --  : ttwmode (Integer)
           859 => ( Parameter_Integer, 0 ),   --  : ddatrep (Integer)
           860 => ( Parameter_Integer, 0 ),   --  : disdifp (Integer)
           861 => ( Parameter_Integer, 0 ),   --  : sfrpis (Integer)
           862 => ( Parameter_Integer, 0 ),   --  : sfrpjsa (Integer)
           863 => ( Parameter_Integer, 0 ),   --  : ethgr2 (Integer)
           864 => ( Parameter_Integer, 0 ),   --  : consent (Integer)
           865 => ( Parameter_Integer, 0 ),   --  : dvpens (Integer)
           866 => ( Parameter_Integer, 0 ),   --  : lnkref1 (Integer)
           867 => ( Parameter_Integer, 0 ),   --  : lnkref2 (Integer)
           868 => ( Parameter_Integer, 0 ),   --  : lnkref21 (Integer)
           869 => ( Parameter_Integer, 0 ),   --  : lnkref22 (Integer)
           870 => ( Parameter_Integer, 0 ),   --  : lnkref23 (Integer)
           871 => ( Parameter_Integer, 0 ),   --  : lnkref24 (Integer)
           872 => ( Parameter_Integer, 0 ),   --  : lnkref25 (Integer)
           873 => ( Parameter_Integer, 0 ),   --  : lnkref3 (Integer)
           874 => ( Parameter_Integer, 0 ),   --  : lnkref4 (Integer)
           875 => ( Parameter_Integer, 0 ),   --  : lnkref5 (Integer)
           876 => ( Parameter_Integer, 0 ),   --  : pconsent (Integer)
           877 => ( Parameter_Integer, 0 ),   --  : lnkons (Integer)
           878 => ( Parameter_Integer, 0 ),   --  : lnkref6 (Integer)
           879 => ( Parameter_Integer, 0 ),   --  : lnkref7 (Integer)
           880 => ( Parameter_Integer, 0 ),   --  : lnkref8 (Integer)
           881 => ( Parameter_Integer, 0 ),   --  : lnkref9 (Integer)
           882 => ( Parameter_Integer, 0 ),   --  : b3qfut7 (Integer)
           883 => ( Parameter_Integer, 0 ),   --  : ben3q7 (Integer)
           884 => ( Parameter_Integer, 0 ),   --  : ddaprog (Integer)
           885 => ( Parameter_Integer, 0 ),   --  : hbolng (Integer)
           886 => ( Parameter_Integer, 0 ),   --  : hi2qual (Integer)
           887 => ( Parameter_Integer, 0 ),   --  : hlpgvn01 (Integer)
           888 => ( Parameter_Integer, 0 ),   --  : hlpgvn02 (Integer)
           889 => ( Parameter_Integer, 0 ),   --  : hlpgvn03 (Integer)
           890 => ( Parameter_Integer, 0 ),   --  : hlpgvn04 (Integer)
           891 => ( Parameter_Integer, 0 ),   --  : hlpgvn05 (Integer)
           892 => ( Parameter_Integer, 0 ),   --  : hlpgvn06 (Integer)
           893 => ( Parameter_Integer, 0 ),   --  : hlpgvn07 (Integer)
           894 => ( Parameter_Integer, 0 ),   --  : hlpgvn08 (Integer)
           895 => ( Parameter_Integer, 0 ),   --  : hlpgvn09 (Integer)
           896 => ( Parameter_Integer, 0 ),   --  : hlpgvn10 (Integer)
           897 => ( Parameter_Integer, 0 ),   --  : hlpgvn11 (Integer)
           898 => ( Parameter_Integer, 0 ),   --  : hlprec01 (Integer)
           899 => ( Parameter_Integer, 0 ),   --  : hlprec02 (Integer)
           900 => ( Parameter_Integer, 0 ),   --  : hlprec03 (Integer)
           901 => ( Parameter_Integer, 0 ),   --  : hlprec04 (Integer)
           902 => ( Parameter_Integer, 0 ),   --  : hlprec05 (Integer)
           903 => ( Parameter_Integer, 0 ),   --  : hlprec06 (Integer)
           904 => ( Parameter_Integer, 0 ),   --  : hlprec07 (Integer)
           905 => ( Parameter_Integer, 0 ),   --  : hlprec08 (Integer)
           906 => ( Parameter_Integer, 0 ),   --  : hlprec09 (Integer)
           907 => ( Parameter_Integer, 0 ),   --  : hlprec10 (Integer)
           908 => ( Parameter_Integer, 0 ),   --  : hlprec11 (Integer)
           909 => ( Parameter_Integer, 0 ),   --  : loangvn1 (Integer)
           910 => ( Parameter_Integer, 0 ),   --  : loangvn2 (Integer)
           911 => ( Parameter_Integer, 0 ),   --  : loangvn3 (Integer)
           912 => ( Parameter_Integer, 0 ),   --  : loanrec1 (Integer)
           913 => ( Parameter_Integer, 0 ),   --  : loanrec2 (Integer)
           914 => ( Parameter_Integer, 0 ),   --  : loanrec3 (Integer)
           915 => ( Parameter_Integer, 0 ),   --  : alg (Integer)
           916 => ( Parameter_Float, 0.0 ),   --  : algamt (Amount)
           917 => ( Parameter_Integer, 0 ),   --  : algpd (Integer)
           918 => ( Parameter_Integer, 0 ),   --  : ben4q4 (Integer)
           919 => ( Parameter_Integer, 0 ),   --  : disdifad (Integer)
           920 => ( Parameter_Integer, 0 ),   --  : gross3_x (Integer)
           921 => ( Parameter_Integer, 0 ),   --  : cbaamt (Integer)
           922 => ( Parameter_Integer, 0 ),   --  : mednum (Integer)
           923 => ( Parameter_Integer, 0 ),   --  : medprpd (Integer)
           924 => ( Parameter_Integer, 0 ),   --  : medprpy (Integer)
           925 => ( Parameter_Integer, 0 ),   --  : medpay (Integer)
           926 => ( Parameter_Integer, 0 ),   --  : medrep (Integer)
           927 => ( Parameter_Integer, 0 )   --  : medrpnm (Integer)
   ...
   function Get_Prepared_Update_Statement return gse.Prepared_Statement is 
      ...
      query : constant String := DB_Commons.Add_Schema_To_Query( UPDATE_PART, SCHEMA_NAME ) & " abs1no = $1, abspar = $2, abspay = $3, abswhy = $4, abswk = $5, x_access = $6, accjb = $7, accmsat = $8, accountq = $9, accssamt = $10, accsspd = $11, adeduc = $12, adema = $13, ademaamt = $14, ademapd = $15, age = $16, agehqual = $17, aliamt = $18, alimny = $19, alipd = $20, alius = $21, allow1 = $22, allow2 = $23, allow3 = $24, allow4 = $25, allpay1 = $26, allpay2 = $27, allpay3 = $28, allpay4 = $29, allpd1 = $30, allpd2 = $31, allpd3 = $32, allpd4 = $33, aluamt = $34, alupd = $35, anyacc = $36, anyed = $37, anymon = $38, anypen1 = $39, anypen2 = $40, anypen3 = $41, anypen4 = $42, anypen5 = $43, anypen6 = $44, anypen7 = $45, apamt = $46, apdamt = $47, apdir = $48, apdpd = $49, appd = $50, bfd = $51, bfdamt = $52, bfdpd = $53, bfdval = $54, btec = $55, btecnow = $56, c2orign = $57, calm = $58, camemt = $59, cameyr = $60, cameyr2 = $61, cbaamt2 = $62, cbchk = $63, change = $64, chkctc = $65, chkdpco1 = $66, chkdpco2 = $67, chkdpco3 = $68, chkdpn = $69, chkdsco1 = $70, chkdsco2 = $71, chkdsco3 = $72, chknop = $73, citizen = $74, citizen2 = $75, claifut1 = $76, claifut2 = $77, claifut3 = $78, claifut4 = $79, claifut5 = $80, claifut6 = $81, claifut7 = $82, claifut8 = $83, claimant = $84, cohabit = $85, combid = $86, commusat = $87, condit = $88, contuk = $89, convbl = $90, coptrust = $91, corign = $92, corigoth = $93, ctclum1 = $94, ctclum2 = $95, cupchk = $96, curqual = $97, cvht = $98, cvpay = $99, cvpd = $100, ddaprog1 = $101, ddatre1 = $102, ddatrep1 = $103, defrpen = $104, degree = $105, degrenow = $106, denrec = $107, depend = $108, depress = $109, disben1 = $110, disben2 = $111, disben3 = $112, disben4 = $113, disben5 = $114, disben6 = $115, discuss = $116, disd01 = $117, disd02 = $118, disd03 = $119, disd04 = $120, disd05 = $121, disd06 = $122, disd07 = $123, disd08 = $124, disd09 = $125, disd10 = $126, disdifp1 = $127, dla1 = $128, dla2 = $129, dls = $130, dlsamt = $131, dlspd = $132, dlsval = $133, dob = $134, down = $135, dv09pens = $136, dvil03a = $137, dvil04a = $138, dvjb12ml = $139, dvmardf = $140, ed1amt = $141, ed1pd = $142, ed1sum = $143, ed2amt = $144, ed2pd = $145, ed2sum = $146, edatt = $147, edhr = $148, edtyp = $149, eligadlt = $150, eligchld = $151, eligschm = $152, emparr = $153, empcontr = $154, emppen = $155, empschm = $156, empstat = $157, envirsat = $158, es2000 = $159, ethgrps = $160, etngrp = $161, eualiamt = $162, eualimny = $163, eualipd = $164, euetype = $165, everwrk = $166, exthbct1 = $167, followsc = $168, followup = $169, fted = $170, ftwk = $171, gpispc = $172, gpjsaesa = $173, x_grant = $174, grtamt1 = $175, grtamt2 = $176, grtdir1 = $177, grtdir2 = $178, grtnum = $179, grtsce1 = $180, grtsce2 = $181, grtval1 = $182, grtval2 = $183, gta = $184, happy = $185, health1 = $186, heathad = $187, help = $188, hholder = $189, hi1qual1 = $190, hi1qual2 = $191, hi1qual3 = $192, hi1qual4 = $193, hi1qual5 = $194, hi1qual6 = $195, hi3qual = $196, higho = $197, highonow = $198, hrpid = $199, hsvper = $200, iclaim1 = $201, iclaim2 = $202, iclaim3 = $203, iclaim4 = $204, iclaim5 = $205, iclaim6 = $206, iclaim7 = $207, iclaim8 = $208, iclaim9 = $209, incdur = $210, injlong = $211, injwk = $212, invests = $213, iout = $214, isa1type = $215, isa2type = $216, issue = $217, jobaway = $218, jobbyr = $219, jobsat = $220, kidben1 = $221, kidben2 = $222, kidben3 = $223, lareg = $224, legltrus = $225, lifesat = $226, likewk = $227, limitl = $228, lktime = $229, lktrain = $230, lkwork = $231, lnkdwp = $232, lnkref01 = $233, lnkref02 = $234, lnkref03 = $235, lnkref04 = $236, lnkref05 = $237, lnkref06 = $238, lnkref07 = $239, lnkref08 = $240, lnkref09 = $241, lnkref10 = $242, lnkref11 = $243, loan = $244, loannum = $245, lstwrk1 = $246, lstwrk2 = $247, lstyr = $248, meaning = $249, medrec = $250, memschm = $251, mntamt1 = $252, mntamt2 = $253, mntarr1 = $254, mntarr2 = $255, mntarr3 = $256, mntarr4 = $257, mntgov1 = $258, mntgov2 = $259, mntnrp = $260, mntpay = $261, mntpd1 = $262, mntpd2 = $263, mntrec = $264, mntus1 = $265, mntus2 = $266, mntusam1 = $267, mntusam2 = $268, mntuspd1 = $269, mntuspd2 = $270, moneysat = $271, ms = $272, nanid1 = $273, nanid2 = $274, nanid3 = $275, nanid4 = $276, nanid5 = $277, nanid6 = $278, nervous = $279, ni2train = $280, niamt = $281, nietngrp = $282, niexthbb = $283, ninanid1 = $284, ninanid2 = $285, ninanid3 = $286, ninanid4 = $287, ninanid5 = $288, ninanid6 = $289, ninanid7 = $290, nipd = $291, nireg = $292, nirelig = $293, nolk1 = $294, nolk2 = $295, nolk3 = $296, nowant = $297, nssec = $298, numjob = $299, numjob2 = $300, nvqlenow = $301, nvqlev = $302, oddjob = $303, oldstud = $304, otabspar = $305, otamt = $306, otapamt = $307, otappd = $308, othben1 = $309, othben2 = $310, othben3 = $311, othben4 = $312, othben5 = $313, othben6 = $314, othpass = $315, othqual1 = $316, othqual2 = $317, othqual3 = $318, othtax = $319, othtrust = $320, otinva = $321, pareamt = $322, parepd = $323, penben1 = $324, penben2 = $325, penben3 = $326, penben4 = $327, penben5 = $328, penflag = $329, penlump = $330, perspen1 = $331, perspen2 = $332, pip1 = $333, pip2 = $334, pollopin = $335, polttrus = $336, ppchk1 = $337, ppchk2 = $338, ppchk3 = $339, ppnumc = $340, ppper = $341, practice = $342, privpen = $343, proptax = $344, ptwk = $345, r01 = $346, r02 = $347, r03 = $348, r04 = $349, r05 = $350, r06 = $351, r07 = $352, r08 = $353, r09 = $354, r10 = $355, r11 = $356, r12 = $357, r13 = $358, r14 = $359, reasden = $360, reasmed = $361, reasnhs = $362, reason = $363, recsat = $364, redamt = $365, redany = $366, rednet = $367, redtax = $368, relasat = $369, religenw = $370, religsc = $371, rentprof = $372, retire = $373, retire1 = $374, retreas = $375, royal1 = $376, royal2 = $377, royal3 = $378, royal4 = $379, royyr1 = $380, royyr2 = $381, royyr3 = $382, royyr4 = $383, rsa = $384, rsanow = $385, rstrct = $386, safe = $387, samesit = $388, schchk = $389, scotvec = $390, sctvnow = $391, sdemp01 = $392, sdemp02 = $393, sdemp03 = $394, sdemp04 = $395, sdemp05 = $396, sdemp06 = $397, sdemp07 = $398, sdemp08 = $399, sdemp09 = $400, sdemp10 = $401, sdemp11 = $402, sdemp12 = $403, selfdemp = $404, sex = $405, sflntyp1 = $406, sflntyp2 = $407, sftype1 = $408, sftype2 = $409, sic = $410, sidqn = $411, slrepamt = $412, slrepay = $413, slreppd = $414, soc2010 = $415, socfund1 = $416, socfund2 = $417, socfund3 = $418, socfund4 = $419, spcreg1 = $420, spcreg2 = $421, spcreg3 = $422, spnumc = $423, spout = $424, spyrot = $425, srentamt = $426, srentpd = $427, srispc = $428, srjsaesa = $429, stakep = $430, start = $431, tcever1 = $432, tcever2 = $433, tcrepay1 = $434, tcrepay2 = $435, tcrepay3 = $436, tcrepay4 = $437, tcrepay5 = $438, tcrepay6 = $439, tcthsyr1 = $440, tcthsyr2 = $441, tdaywrk = $442, tea = $443, tea9697 = $444, tempjob = $445, timesat = $446, topupl = $447, totint = $448, train2 = $449, trainee = $450, trnallow = $451, ttbprx = $452, tuborr = $453, typeed = $454, unpaid1 = $455, unpaid2 = $456, w1 = $457, w2 = $458, wageben1 = $459, wageben2 = $460, wageben3 = $461, wageben4 = $462, wageben5 = $463, wageben6 = $464, wageben7 = $465, wageben8 = $466, wait = $467, whoresp = $468, whosectb = $469, wintfuel = $470, working = $471, wpa = $472, wpba = $473, wtclum1 = $474, wtclum2 = $475, ystrtwk = $476, month = $477, able = $478, actacci = $479, age80 = $480, agehq80 = $481, basacti = $482, careab = $483, careah = $484, carecb = $485, carech = $486, carecl = $487, carefl = $488, carefr = $489, careot = $490, carere = $491, chbflg = $492, corignan = $493, curacti = $494, currjobm = $495, disacta1 = $496, discora1 = $497, dobmonth = $498, dobyear = $499, empoccp = $500, empstatb = $501, empstatc = $502, empstati = $503, ethgr3 = $504, gebacti = $505, giltcti = $506, gross4 = $507, hdage = $508, hdben = $509, hdindinc = $510, heartval = $511, hourab = $512, hourah = $513, hourcare = $514, hourcb = $515, hourch = $516, hourcl = $517, hourfr = $518, hourot = $519, hourre = $520, hourtot = $521, hperson = $522, iagegr2 = $523, iagegr3 = $524, iagegr4 = $525, iagegrp = $526, incseo2 = $527, indinc = $528, indisben = $529, inearns = $530, ininv = $531, inirben = $532, innirben = $533, inothben = $534, inpeninc = $535, inrinc = $536, inrpinc = $537, intvlic = $538, intxcred = $539, isacti = $540, marital = $541, mjobsect = $542, ninanida = $543, nincseo2 = $544, nindinc = $545, ninearns = $546, nininv = $547, ninnirbn = $548, ninothbn = $549, ninpenin = $550, ninrinc = $551, ninsein2 = $552, nirel2 = $553, occupnum = $554, pepscti = $555, poaccti = $556, pocardi = $557, prevjobm = $558, relhrp = $559, sapadj = $560, seincam2 = $561, smpadj = $562, sppadj = $563, sspadj = $564, stshcti = $565, taxpayer = $566, tesscti = $567, totgrant = $568, tothours = $569, totoccp = $570, typeed2 = $571, untrcti = $572, uperson = $573, w45 = $574, widoccp = $575, xbonflag = $576, anxious = $577, candgnow = $578, curothf = $579, curothp = $580, curothwv = $581, dvhiqual = $582, gnvqnow = $583, gpuc = $584, happywb = $585, hi1qual7 = $586, hi1qual8 = $587, mntarr5 = $588, mntnoch1 = $589, mntnoch2 = $590, mntnoch3 = $591, mntnoch4 = $592, mntnoch5 = $593, mntpro1 = $594, mntpro2 = $595, mntpro3 = $596, mnttim1 = $597, mnttim2 = $598, mnttim3 = $599, mntwrk1 = $600, mntwrk2 = $601, mntwrk3 = $602, mntwrk4 = $603, mntwrk5 = $604, ndeplnow = $605, oqualc1 = $606, oqualc2 = $607, oqualc3 = $608, sruc = $609, webacnow = $610, indeth = $611, euactive = $612, euactno = $613, euartact = $614, euaskhlp = $615, eucinema = $616, eucultur = $617, euinvol = $618, eulivpe = $619, eumtfam = $620, eumtfrnd = $621, eusocnet = $622, eusport = $623, eutkfam = $624, eutkfrnd = $625, eutkmat = $626, euvol = $627, natscot = $628, ntsctnow = $629, penwel1 = $630, penwel2 = $631, penwel3 = $632, penwel4 = $633, penwel5 = $634, penwel6 = $635, skiwknow = $636, skiwrk = $637, slos = $638, yjblev = $639, abs2no = $640, accftpt = $641, b2qfut1 = $642, b2qfut2 = $643, b2qfut3 = $644, b3qfut1 = $645, b3qfut2 = $646, b3qfut3 = $647, b3qfut4 = $648, b3qfut5 = $649, b3qfut6 = $650, ben1q1 = $651, ben1q2 = $652, ben1q3 = $653, ben1q4 = $654, ben1q5 = $655, ben1q6 = $656, ben1q7 = $657, ben2q1 = $658, ben2q2 = $659, ben2q3 = $660, ben3q1 = $661, ben3q2 = $662, ben3q3 = $663, ben3q4 = $664, ben3q5 = $665, ben3q6 = $666, ben4q1 = $667, ben4q2 = $668, ben4q3 = $669, ben5q1 = $670, ben5q2 = $671, ben5q3 = $672, ben5q4 = $673, ben5q5 = $674, ben5q6 = $675, ben7q1 = $676, ben7q2 = $677, ben7q3 = $678, ben7q4 = $679, ben7q5 = $680, ben7q6 = $681, ben7q7 = $682, ben7q8 = $683, ben7q9 = $684, btwacc = $685, dentist = $686, disdif1 = $687, disdif2 = $688, disdif3 = $689, disdif4 = $690, disdif5 = $691, disdif6 = $692, disdif7 = $693, disdif8 = $694, dptcboth = $695, dptclum = $696, ed1borr = $697, ed1int = $698, ed1monyr = $699, ed2borr = $700, ed2int = $701, ed2monyr = $702, edattn1 = $703, edattn2 = $704, edattn3 = $705, edtime = $706, emppay1 = $707, emppay2 = $708, emppay3 = $709, endyr = $710, epcur = $711, ethgrp = $712, exthbct2 = $713, exthbct3 = $714, eyetest = $715, follow = $716, future = $717, govpis = $718, govpjsa = $719, hbothamt = $720, hbothbu = $721, hbothpd = $722, hbothwk = $723, hbotwait = $724, health = $725, hosp = $726, hprob = $727, isa3type = $728, ln1rpint = $729, ln2rpint = $730, look = $731, lookwk = $732, mntct = $733, mntfor1 = $734, mntfor2 = $735, mnttota1 = $736, mnttota2 = $737, natid1 = $738, natid2 = $739, natid3 = $740, natid4 = $741, natid5 = $742, natid6 = $743, ndeal = $744, newdtype = $745, nhs1 = $746, nhs2 = $747, nhs3 = $748, niethgrp = $749, ninatid1 = $750, ninatid2 = $751, ninatid3 = $752, ninatid4 = $753, ninatid5 = $754, ninatid6 = $755, ninatid7 = $756, ninatid8 = $757, nirel = $758, nitrain = $759, nlper = $760, nolook = $761, ntcapp = $762, ntcdat = $763, ntcinc = $764, ntcorig1 = $765, ntcorig2 = $766, ntcorig3 = $767, ntcorig4 = $768, ntcorig5 = $769, prit = $770, prscrpt = $771, soc2000 = $772, specs = $773, startyr = $774, taxcred1 = $775, taxcred2 = $776, taxcred3 = $777, taxcred4 = $778, taxcred5 = $779, taxfut = $780, train = $781, trav = $782, voucher = $783, war1 = $784, war2 = $785, wftcboth = $786, wftclum = $787, whyfrde1 = $788, whyfrde2 = $789, whyfrde3 = $790, whyfrde4 = $791, whyfrde5 = $792, whyfrde6 = $793, whyfrey1 = $794, whyfrey2 = $795, whyfrey3 = $796, whyfrey4 = $797, whyfrey5 = $798, whyfrey6 = $799, whyfrpr1 = $800, whyfrpr2 = $801, whyfrpr3 = $802, whyfrpr4 = $803, whyfrpr5 = $804, whyfrpr6 = $805, whytrav1 = $806, whytrav2 = $807, whytrav3 = $808, whytrav4 = $809, whytrav5 = $810, whytrav6 = $811, wmkit = $812, wtclum3 = $813, addda = $814, bntxcred = $815, fsbndcti = $816, fwmlkval = $817, gross2 = $818, gross3 = $819, hbsupran = $820, netocpen = $821, nsbocti = $822, otbscti = $823, prbocti = $824, sayecti = $825, sclbcti = $826, sscti = $827, superan = $828, ttwcosts = $829, ben5q7 = $830, ben5q8 = $831, ben5q9 = $832, ddatre = $833, disdif9 = $834, fare = $835, nittwmod = $836, oneway = $837, pssamt = $838, pssdate = $839, ttwcode1 = $840, ttwcode2 = $841, ttwcode3 = $842, ttwcost = $843, ttwfar = $844, ttwfrq = $845, ttwmod = $846, ttwpay = $847, ttwpss = $848, ttwrec = $849, crunaci = $850, enomorti = $851, ttwmode = $852, ddatrep = $853, disdifp = $854, sfrpis = $855, sfrpjsa = $856, ethgr2 = $857, consent = $858, dvpens = $859, lnkref1 = $860, lnkref2 = $861, lnkref21 = $862, lnkref22 = $863, lnkref23 = $864, lnkref24 = $865, lnkref25 = $866, lnkref3 = $867, lnkref4 = $868, lnkref5 = $869, pconsent = $870, lnkons = $871, lnkref6 = $872, lnkref7 = $873, lnkref8 = $874, lnkref9 = $875, b3qfut7 = $876, ben3q7 = $877, ddaprog = $878, hbolng = $879, hi2qual = $880, hlpgvn01 = $881, hlpgvn02 = $882, hlpgvn03 = $883, hlpgvn04 = $884, hlpgvn05 = $885, hlpgvn06 = $886, hlpgvn07 = $887, hlpgvn08 = $888, hlpgvn09 = $889, hlpgvn10 = $890, hlpgvn11 = $891, hlprec01 = $892, hlprec02 = $893, hlprec03 = $894, hlprec04 = $895, hlprec05 = $896, hlprec06 = $897, hlprec07 = $898, hlprec08 = $899, hlprec09 = $900, hlprec10 = $901, hlprec11 = $902, loangvn1 = $903, loangvn2 = $904, loangvn3 = $905, loanrec1 = $906, loanrec2 = $907, loanrec3 = $908, alg = $909, algamt = $910, algpd = $911, ben4q4 = $912, disdifad = $913, gross3_x = $914, cbaamt = $915, mednum = $916, medprpd = $917, medprpy = $918, medpay = $919, medrep = $920, medrpnm = $921 where user_id = $922 and edition = $923 and year = $924 and sernum = $925 and benunit = $926 and person = $927"; 
   begin 
      ps := gse.Prepare( 
        query, 
        On_Server => True ); 
   ...
   begin
      ...
      if not gse.Is_Null( cursor, 7 )then
         a_adult.abspar := gse.Integer_Value( cursor, 7 );
      end if;
      if not gse.Is_Null( cursor, 8 )then
         a_adult.abspay := gse.Integer_Value( cursor, 8 );
      end if;
      if not gse.Is_Null( cursor, 9 )then
         a_adult.abswhy := gse.Integer_Value( cursor, 9 );
      end if;
      if not gse.Is_Null( cursor, 10 )then
         a_adult.abswk := gse.Integer_Value( cursor, 10 );
      end if;
      if not gse.Is_Null( cursor, 11 )then
         a_adult.x_access := gse.Integer_Value( cursor, 11 );
      end if;
      if not gse.Is_Null( cursor, 12 )then
         a_adult.accjb := gse.Integer_Value( cursor, 12 );
      end if;
      if not gse.Is_Null( cursor, 13 )then
         a_adult.accmsat := gse.Integer_Value( cursor, 13 );
      end if;
      if not gse.Is_Null( cursor, 14 )then
         a_adult.accountq := gse.Integer_Value( cursor, 14 );
      end if;
      ...
      if not gse.Is_Null( cursor, 22 )then
         a_adult.agehqual := gse.Integer_Value( cursor, 22 );
      end if;
      if not gse.Is_Null( cursor, 23 )then
         a_adult.aliamt:= Amount'Value( gse.Value( cursor, 23 ));
      end if;
      if not gse.Is_Null( cursor, 24 )then
         a_adult.alimny := gse.Integer_Value( cursor, 24 );
      end if;
      if not gse.Is_Null( cursor, 25 )then
         a_adult.alipd := gse.Integer_Value( cursor, 25 );
      end if;
      if not gse.Is_Null( cursor, 26 )then
         a_adult.alius := gse.Integer_Value( cursor, 26 );
      end if;
      if not gse.Is_Null( cursor, 27 )then
         a_adult.allow1 := gse.Integer_Value( cursor, 27 );
      end if;
      if not gse.Is_Null( cursor, 28 )then
         a_adult.allow2 := gse.Integer_Value( cursor, 28 );
      end if;
      if not gse.Is_Null( cursor, 29 )then
         a_adult.allow3 := gse.Integer_Value( cursor, 29 );
      end if;
      if not gse.Is_Null( cursor, 30 )then
         a_adult.allow4 := gse.Integer_Value( cursor, 30 );
      end if;
      if not gse.Is_Null( cursor, 31 )then
         a_adult.allpay1:= Amount'Value( gse.Value( cursor, 31 ));
      end if;
      if not gse.Is_Null( cursor, 32 )then
         a_adult.allpay2:= Amount'Value( gse.Value( cursor, 32 ));
      end if;
      if not gse.Is_Null( cursor, 33 )then
         a_adult.allpay3:= Amount'Value( gse.Value( cursor, 33 ));
      end if;
      if not gse.Is_Null( cursor, 34 )then
         a_adult.allpay4:= Amount'Value( gse.Value( cursor, 34 ));
      end if;
      if not gse.Is_Null( cursor, 35 )then
         a_adult.allpd1 := gse.Integer_Value( cursor, 35 );
      end if;
      if not gse.Is_Null( cursor, 36 )then
         a_adult.allpd2 := gse.Integer_Value( cursor, 36 );
      end if;
      if not gse.Is_Null( cursor, 37 )then
         a_adult.allpd3 := gse.Integer_Value( cursor, 37 );
      end if;
      if not gse.Is_Null( cursor, 38 )then
         a_adult.allpd4 := gse.Integer_Value( cursor, 38 );
      end if;
      if not gse.Is_Null( cursor, 39 )then
         a_adult.aluamt:= Amount'Value( gse.Value( cursor, 39 ));
      end if;
      if not gse.Is_Null( cursor, 40 )then
         a_adult.alupd := gse.Integer_Value( cursor, 40 );
      end if;
      if not gse.Is_Null( cursor, 41 )then
         a_adult.anyacc := gse.Integer_Value( cursor, 41 );
      end if;
      if not gse.Is_Null( cursor, 42 )then
         a_adult.anyed := gse.Integer_Value( cursor, 42 );
      end if;
      if not gse.Is_Null( cursor, 43 )then
         a_adult.anymon := gse.Integer_Value( cursor, 43 );
      end if;
      if not gse.Is_Null( cursor, 44 )then
         a_adult.anypen1 := gse.Integer_Value( cursor, 44 );
      end if;
      if not gse.Is_Null( cursor, 45 )then
         a_adult.anypen2 := gse.Integer_Value( cursor, 45 );
      end if;
      if not gse.Is_Null( cursor, 46 )then
         a_adult.anypen3 := gse.Integer_Value( cursor, 46 );
      end if;
      if not gse.Is_Null( cursor, 47 )then
         a_adult.anypen4 := gse.Integer_Value( cursor, 47 );
      end if;
      if not gse.Is_Null( cursor, 48 )then
         a_adult.anypen5 := gse.Integer_Value( cursor, 48 );
      end if;
      if not gse.Is_Null( cursor, 49 )then
         a_adult.anypen6 := gse.Integer_Value( cursor, 49 );
      end if;
      if not gse.Is_Null( cursor, 50 )then
         a_adult.anypen7 := gse.Integer_Value( cursor, 50 );
      end if;
      if not gse.Is_Null( cursor, 51 )then
         a_adult.apamt:= Amount'Value( gse.Value( cursor, 51 ));
      end if;
      if not gse.Is_Null( cursor, 52 )then
         a_adult.apdamt:= Amount'Value( gse.Value( cursor, 52 ));
      end if;
      if not gse.Is_Null( cursor, 53 )then
         a_adult.apdir := gse.Integer_Value( cursor, 53 );
      end if;
      if not gse.Is_Null( cursor, 54 )then
         a_adult.apdpd := gse.Integer_Value( cursor, 54 );
      end if;
      if not gse.Is_Null( cursor, 55 )then
         a_adult.appd := gse.Integer_Value( cursor, 55 );
      end if;
      if not gse.Is_Null( cursor, 56 )then
         a_adult.bfd := gse.Integer_Value( cursor, 56 );
      end if;
      if not gse.Is_Null( cursor, 57 )then
         a_adult.bfdamt:= Amount'Value( gse.Value( cursor, 57 ));
      end if;
      if not gse.Is_Null( cursor, 58 )then
         a_adult.bfdpd := gse.Integer_Value( cursor, 58 );
      end if;
      if not gse.Is_Null( cursor, 59 )then
         a_adult.bfdval := gse.Integer_Value( cursor, 59 );
      end if;
      if not gse.Is_Null( cursor, 60 )then
         a_adult.btec := gse.Integer_Value( cursor, 60 );
      end if;
      if not gse.Is_Null( cursor, 61 )then
         a_adult.btecnow := gse.Integer_Value( cursor, 61 );
      end if;
      if not gse.Is_Null( cursor, 62 )then
         a_adult.c2orign := gse.Integer_Value( cursor, 62 );
      end if;
      if not gse.Is_Null( cursor, 63 )then
         a_adult.calm := gse.Integer_Value( cursor, 63 );
      end if;
      if not gse.Is_Null( cursor, 64 )then
         a_adult.camemt := gse.Integer_Value( cursor, 64 );
      end if;
      if not gse.Is_Null( cursor, 65 )then
         a_adult.cameyr := gse.Integer_Value( cursor, 65 );
      end if;
      if not gse.Is_Null( cursor, 66 )then
         a_adult.cameyr2 := gse.Integer_Value( cursor, 66 );
      end if;
      if not gse.Is_Null( cursor, 67 )then
         a_adult.cbaamt2 := gse.Integer_Value( cursor, 67 );
      end if;
      if not gse.Is_Null( cursor, 68 )then
         a_adult.cbchk := gse.Integer_Value( cursor, 68 );
      end if;
      if not gse.Is_Null( cursor, 69 )then
         a_adult.change := gse.Integer_Value( cursor, 69 );
      end if;
      if not gse.Is_Null( cursor, 70 )then
         a_adult.chkctc := gse.Integer_Value( cursor, 70 );
      end if;
      if not gse.Is_Null( cursor, 71 )then
         a_adult.chkdpco1 := gse.Integer_Value( cursor, 71 );
      end if;
      if not gse.Is_Null( cursor, 72 )then
         a_adult.chkdpco2 := gse.Integer_Value( cursor, 72 );
      end if;
      if not gse.Is_Null( cursor, 73 )then
         a_adult.chkdpco3 := gse.Integer_Value( cursor, 73 );
      end if;
      if not gse.Is_Null( cursor, 74 )then
         a_adult.chkdpn := gse.Integer_Value( cursor, 74 );
      end if;
      if not gse.Is_Null( cursor, 75 )then
         a_adult.chkdsco1 := gse.Integer_Value( cursor, 75 );
      end if;
      if not gse.Is_Null( cursor, 76 )then
         a_adult.chkdsco2 := gse.Integer_Value( cursor, 76 );
      end if;
      if not gse.Is_Null( cursor, 77 )then
         a_adult.chkdsco3 := gse.Integer_Value( cursor, 77 );
      end if;
      if not gse.Is_Null( cursor, 78 )then
         a_adult.chknop := gse.Integer_Value( cursor, 78 );
      end if;
      if not gse.Is_Null( cursor, 79 )then
         a_adult.citizen := gse.Integer_Value( cursor, 79 );
      end if;
      if not gse.Is_Null( cursor, 80 )then
         a_adult.citizen2 := gse.Integer_Value( cursor, 80 );
      end if;
      if not gse.Is_Null( cursor, 81 )then
         a_adult.claifut1 := gse.Integer_Value( cursor, 81 );
      end if;
      if not gse.Is_Null( cursor, 82 )then
         a_adult.claifut2 := gse.Integer_Value( cursor, 82 );
      end if;
      if not gse.Is_Null( cursor, 83 )then
         a_adult.claifut3 := gse.Integer_Value( cursor, 83 );
      end if;
      if not gse.Is_Null( cursor, 84 )then
         a_adult.claifut4 := gse.Integer_Value( cursor, 84 );
      end if;
      if not gse.Is_Null( cursor, 85 )then
         a_adult.claifut5 := gse.Integer_Value( cursor, 85 );
      end if;
      if not gse.Is_Null( cursor, 86 )then
         a_adult.claifut6 := gse.Integer_Value( cursor, 86 );
      end if;
      if not gse.Is_Null( cursor, 87 )then
         a_adult.claifut7 := gse.Integer_Value( cursor, 87 );
      end if;
      if not gse.Is_Null( cursor, 88 )then
         a_adult.claifut8 := gse.Integer_Value( cursor, 88 );
      end if;
      if not gse.Is_Null( cursor, 89 )then
         a_adult.claimant := gse.Integer_Value( cursor, 89 );
      end if;
      if not gse.Is_Null( cursor, 90 )then
         a_adult.cohabit := gse.Integer_Value( cursor, 90 );
      end if;
      if not gse.Is_Null( cursor, 91 )then
         a_adult.combid := gse.Integer_Value( cursor, 91 );
      end if;
      if not gse.Is_Null( cursor, 92 )then
         a_adult.commusat := gse.Integer_Value( cursor, 92 );
      end if;
      if not gse.Is_Null( cursor, 93 )then
         a_adult.condit := gse.Integer_Value( cursor, 93 );
      end if;
      if not gse.Is_Null( cursor, 94 )then
         a_adult.contuk := gse.Integer_Value( cursor, 94 );
      end if;
      if not gse.Is_Null( cursor, 95 )then
         a_adult.convbl := gse.Integer_Value( cursor, 95 );
      end if;
      if not gse.Is_Null( cursor, 96 )then
         a_adult.coptrust := gse.Integer_Value( cursor, 96 );
      end if;
      if not gse.Is_Null( cursor, 97 )then
         a_adult.corign := gse.Integer_Value( cursor, 97 );
      end if;
      if not gse.Is_Null( cursor, 98 )then
         a_adult.corigoth := gse.Integer_Value( cursor, 98 );
      end if;
      if not gse.Is_Null( cursor, 99 )then
         a_adult.ctclum1 := gse.Integer_Value( cursor, 99 );
      end if;
      if not gse.Is_Null( cursor, 100 )then
         a_adult.ctclum2 := gse.Integer_Value( cursor, 100 );
      end if;
      if not gse.Is_Null( cursor, 101 )then
         a_adult.cupchk := gse.Integer_Value( cursor, 101 );
      end if;
      if not gse.Is_Null( cursor, 102 )then
         a_adult.curqual := gse.Integer_Value( cursor, 102 );
      end if;
      if not gse.Is_Null( cursor, 103 )then
         a_adult.cvht := gse.Integer_Value( cursor, 103 );
      end if;
      if not gse.Is_Null( cursor, 104 )then
         a_adult.cvpay:= Amount'Value( gse.Value( cursor, 104 ));
      end if;
      if not gse.Is_Null( cursor, 105 )then
         a_adult.cvpd := gse.Integer_Value( cursor, 105 );
      end if;
      if not gse.Is_Null( cursor, 106 )then
         a_adult.ddaprog1 := gse.Integer_Value( cursor, 106 );
      end if;
      if not gse.Is_Null( cursor, 107 )then
         a_adult.ddatre1 := gse.Integer_Value( cursor, 107 );
      end if;
      if not gse.Is_Null( cursor, 108 )then
         a_adult.ddatrep1 := gse.Integer_Value( cursor, 108 );
      end if;
      if not gse.Is_Null( cursor, 109 )then
         a_adult.defrpen := gse.Integer_Value( cursor, 109 );
      end if;
      if not gse.Is_Null( cursor, 110 )then
         a_adult.degree := gse.Integer_Value( cursor, 110 );
      end if;
      if not gse.Is_Null( cursor, 111 )then
         a_adult.degrenow := gse.Integer_Value( cursor, 111 );
      end if;
      if not gse.Is_Null( cursor, 112 )then
         a_adult.denrec := gse.Integer_Value( cursor, 112 );
      end if;
      if not gse.Is_Null( cursor, 113 )then
         a_adult.depend := gse.Integer_Value( cursor, 113 );
      end if;
      if not gse.Is_Null( cursor, 114 )then
         a_adult.depress := gse.Integer_Value( cursor, 114 );
      end if;
      if not gse.Is_Null( cursor, 115 )then
         a_adult.disben1 := gse.Integer_Value( cursor, 115 );
      end if;
      if not gse.Is_Null( cursor, 116 )then
         a_adult.disben2 := gse.Integer_Value( cursor, 116 );
      end if;
      if not gse.Is_Null( cursor, 117 )then
         a_adult.disben3 := gse.Integer_Value( cursor, 117 );
      end if;
      if not gse.Is_Null( cursor, 118 )then
         a_adult.disben4 := gse.Integer_Value( cursor, 118 );
      end if;
      if not gse.Is_Null( cursor, 119 )then
         a_adult.disben5 := gse.Integer_Value( cursor, 119 );
      end if;
      if not gse.Is_Null( cursor, 120 )then
         a_adult.disben6 := gse.Integer_Value( cursor, 120 );
      end if;
      if not gse.Is_Null( cursor, 121 )then
         a_adult.discuss := gse.Integer_Value( cursor, 121 );
      end if;
      if not gse.Is_Null( cursor, 122 )then
         a_adult.disd01 := gse.Integer_Value( cursor, 122 );
      end if;
      if not gse.Is_Null( cursor, 123 )then
         a_adult.disd02 := gse.Integer_Value( cursor, 123 );
      end if;
      if not gse.Is_Null( cursor, 124 )then
         a_adult.disd03 := gse.Integer_Value( cursor, 124 );
      end if;
      if not gse.Is_Null( cursor, 125 )then
         a_adult.disd04 := gse.Integer_Value( cursor, 125 );
      end if;
      if not gse.Is_Null( cursor, 126 )then
         a_adult.disd05 := gse.Integer_Value( cursor, 126 );
      end if;
      if not gse.Is_Null( cursor, 127 )then
         a_adult.disd06 := gse.Integer_Value( cursor, 127 );
      end if;
      if not gse.Is_Null( cursor, 128 )then
         a_adult.disd07 := gse.Integer_Value( cursor, 128 );
      end if;
      if not gse.Is_Null( cursor, 129 )then
         a_adult.disd08 := gse.Integer_Value( cursor, 129 );
      end if;
      if not gse.Is_Null( cursor, 130 )then
         a_adult.disd09 := gse.Integer_Value( cursor, 130 );
      end if;
      if not gse.Is_Null( cursor, 131 )then
         a_adult.disd10 := gse.Integer_Value( cursor, 131 );
      end if;
      if not gse.Is_Null( cursor, 132 )then
         a_adult.disdifp1 := gse.Integer_Value( cursor, 132 );
      end if;
      if not gse.Is_Null( cursor, 133 )then
         a_adult.dla1 := gse.Integer_Value( cursor, 133 );
      end if;
      if not gse.Is_Null( cursor, 134 )then
         a_adult.dla2 := gse.Integer_Value( cursor, 134 );
      end if;
      if not gse.Is_Null( cursor, 135 )then
         a_adult.dls := gse.Integer_Value( cursor, 135 );
      end if;
      if not gse.Is_Null( cursor, 136 )then
         a_adult.dlsamt:= Amount'Value( gse.Value( cursor, 136 ));
      end if;
      if not gse.Is_Null( cursor, 137 )then
         a_adult.dlspd := gse.Integer_Value( cursor, 137 );
      end if;
      if not gse.Is_Null( cursor, 138 )then
         a_adult.dlsval := gse.Integer_Value( cursor, 138 );
      end if;
      if not gse.Is_Null( cursor, 139 )then
         a_adult.dob := gse.Time_Value( cursor, 139 );
      end if;
      if not gse.Is_Null( cursor, 140 )then
         a_adult.down := gse.Integer_Value( cursor, 140 );
      end if;
      if not gse.Is_Null( cursor, 141 )then
         a_adult.dv09pens := gse.Integer_Value( cursor, 141 );
      end if;
      if not gse.Is_Null( cursor, 142 )then
         a_adult.dvil03a := gse.Integer_Value( cursor, 142 );
      end if;
      if not gse.Is_Null( cursor, 143 )then
         a_adult.dvil04a := gse.Integer_Value( cursor, 143 );
      end if;
      if not gse.Is_Null( cursor, 144 )then
         a_adult.dvjb12ml := gse.Integer_Value( cursor, 144 );
      end if;
      if not gse.Is_Null( cursor, 145 )then
         a_adult.dvmardf := gse.Integer_Value( cursor, 145 );
      end if;
      if not gse.Is_Null( cursor, 146 )then
         a_adult.ed1amt:= Amount'Value( gse.Value( cursor, 146 ));
      end if;
      if not gse.Is_Null( cursor, 147 )then
         a_adult.ed1pd := gse.Integer_Value( cursor, 147 );
      end if;
      if not gse.Is_Null( cursor, 148 )then
         a_adult.ed1sum := gse.Integer_Value( cursor, 148 );
      end if;
      if not gse.Is_Null( cursor, 149 )then
         a_adult.ed2amt:= Amount'Value( gse.Value( cursor, 149 ));
      end if;
      if not gse.Is_Null( cursor, 150 )then
         a_adult.ed2pd := gse.Integer_Value( cursor, 150 );
      end if;
      if not gse.Is_Null( cursor, 151 )then
         a_adult.ed2sum := gse.Integer_Value( cursor, 151 );
      end if;
      if not gse.Is_Null( cursor, 152 )then
         a_adult.edatt := gse.Integer_Value( cursor, 152 );
      end if;
      if not gse.Is_Null( cursor, 153 )then
         a_adult.edhr := gse.Integer_Value( cursor, 153 );
      end if;
      if not gse.Is_Null( cursor, 154 )then
         a_adult.edtyp := gse.Integer_Value( cursor, 154 );
      end if;
      if not gse.Is_Null( cursor, 155 )then
         a_adult.eligadlt := gse.Integer_Value( cursor, 155 );
      end if;
      if not gse.Is_Null( cursor, 156 )then
         a_adult.eligchld := gse.Integer_Value( cursor, 156 );
      end if;
      if not gse.Is_Null( cursor, 157 )then
         a_adult.eligschm := gse.Integer_Value( cursor, 157 );
      end if;
      if not gse.Is_Null( cursor, 158 )then
         a_adult.emparr := gse.Integer_Value( cursor, 158 );
      end if;
      if not gse.Is_Null( cursor, 159 )then
         a_adult.empcontr := gse.Integer_Value( cursor, 159 );
      end if;
      if not gse.Is_Null( cursor, 160 )then
         a_adult.emppen := gse.Integer_Value( cursor, 160 );
      end if;
      if not gse.Is_Null( cursor, 161 )then
         a_adult.empschm := gse.Integer_Value( cursor, 161 );
      end if;
      if not gse.Is_Null( cursor, 162 )then
         a_adult.empstat := gse.Integer_Value( cursor, 162 );
      end if;
      if not gse.Is_Null( cursor, 163 )then
         a_adult.envirsat := gse.Integer_Value( cursor, 163 );
      end if;
      if not gse.Is_Null( cursor, 164 )then
         a_adult.es2000 := gse.Integer_Value( cursor, 164 );
      end if;
      if not gse.Is_Null( cursor, 165 )then
         a_adult.ethgrps := gse.Integer_Value( cursor, 165 );
      end if;
      if not gse.Is_Null( cursor, 166 )then
         a_adult.etngrp := gse.Integer_Value( cursor, 166 );
      end if;
      if not gse.Is_Null( cursor, 167 )then
         a_adult.eualiamt:= Amount'Value( gse.Value( cursor, 167 ));
      end if;
      if not gse.Is_Null( cursor, 168 )then
         a_adult.eualimny := gse.Integer_Value( cursor, 168 );
      end if;
      if not gse.Is_Null( cursor, 169 )then
         a_adult.eualipd := gse.Integer_Value( cursor, 169 );
      end if;
      if not gse.Is_Null( cursor, 170 )then
         a_adult.euetype := gse.Integer_Value( cursor, 170 );
      end if;
      if not gse.Is_Null( cursor, 171 )then
         a_adult.everwrk := gse.Integer_Value( cursor, 171 );
      end if;
      if not gse.Is_Null( cursor, 172 )then
         a_adult.exthbct1 := gse.Integer_Value( cursor, 172 );
      end if;
      if not gse.Is_Null( cursor, 173 )then
         a_adult.followsc := gse.Integer_Value( cursor, 173 );
      end if;
      if not gse.Is_Null( cursor, 174 )then
         a_adult.followup := gse.Integer_Value( cursor, 174 );
      end if;
      if not gse.Is_Null( cursor, 175 )then
         a_adult.fted := gse.Integer_Value( cursor, 175 );
      end if;
      if not gse.Is_Null( cursor, 176 )then
         a_adult.ftwk := gse.Integer_Value( cursor, 176 );
      end if;
      if not gse.Is_Null( cursor, 177 )then
         a_adult.gpispc := gse.Integer_Value( cursor, 177 );
      end if;
      if not gse.Is_Null( cursor, 178 )then
         a_adult.gpjsaesa := gse.Integer_Value( cursor, 178 );
      end if;
      if not gse.Is_Null( cursor, 179 )then
         a_adult.x_grant := gse.Integer_Value( cursor, 179 );
      end if;
      if not gse.Is_Null( cursor, 180 )then
         a_adult.grtamt1:= Amount'Value( gse.Value( cursor, 180 ));
      end if;
      if not gse.Is_Null( cursor, 181 )then
         a_adult.grtamt2:= Amount'Value( gse.Value( cursor, 181 ));
      end if;
      if not gse.Is_Null( cursor, 182 )then
         a_adult.grtdir1:= Amount'Value( gse.Value( cursor, 182 ));
      end if;
      if not gse.Is_Null( cursor, 183 )then
         a_adult.grtdir2:= Amount'Value( gse.Value( cursor, 183 ));
      end if;
      if not gse.Is_Null( cursor, 184 )then
         a_adult.grtnum := gse.Integer_Value( cursor, 184 );
      end if;
      if not gse.Is_Null( cursor, 185 )then
         a_adult.grtsce1 := gse.Integer_Value( cursor, 185 );
      end if;
      if not gse.Is_Null( cursor, 186 )then
         a_adult.grtsce2 := gse.Integer_Value( cursor, 186 );
      end if;
      if not gse.Is_Null( cursor, 187 )then
         a_adult.grtval1:= Amount'Value( gse.Value( cursor, 187 ));
      end if;
      if not gse.Is_Null( cursor, 188 )then
         a_adult.grtval2:= Amount'Value( gse.Value( cursor, 188 ));
      end if;
      if not gse.Is_Null( cursor, 189 )then
         a_adult.gta := gse.Integer_Value( cursor, 189 );
      end if;
      if not gse.Is_Null( cursor, 190 )then
         a_adult.happy := gse.Integer_Value( cursor, 190 );
      end if;
      if not gse.Is_Null( cursor, 191 )then
         a_adult.health1 := gse.Integer_Value( cursor, 191 );
      end if;
      if not gse.Is_Null( cursor, 192 )then
         a_adult.heathad := gse.Integer_Value( cursor, 192 );
      end if;
      if not gse.Is_Null( cursor, 193 )then
         a_adult.help := gse.Integer_Value( cursor, 193 );
      end if;
      if not gse.Is_Null( cursor, 194 )then
         a_adult.hholder := gse.Integer_Value( cursor, 194 );
      end if;
      if not gse.Is_Null( cursor, 195 )then
         a_adult.hi1qual1 := gse.Integer_Value( cursor, 195 );
      end if;
      if not gse.Is_Null( cursor, 196 )then
         a_adult.hi1qual2 := gse.Integer_Value( cursor, 196 );
      end if;
      if not gse.Is_Null( cursor, 197 )then
         a_adult.hi1qual3 := gse.Integer_Value( cursor, 197 );
      end if;
      if not gse.Is_Null( cursor, 198 )then
         a_adult.hi1qual4 := gse.Integer_Value( cursor, 198 );
      end if;
      if not gse.Is_Null( cursor, 199 )then
         a_adult.hi1qual5 := gse.Integer_Value( cursor, 199 );
      end if;
      if not gse.Is_Null( cursor, 200 )then
         a_adult.hi1qual6 := gse.Integer_Value( cursor, 200 );
      end if;
      if not gse.Is_Null( cursor, 201 )then
         a_adult.hi3qual := gse.Integer_Value( cursor, 201 );
      end if;
      if not gse.Is_Null( cursor, 202 )then
         a_adult.higho := gse.Integer_Value( cursor, 202 );
      end if;
      if not gse.Is_Null( cursor, 203 )then
         a_adult.highonow := gse.Integer_Value( cursor, 203 );
      end if;
      if not gse.Is_Null( cursor, 204 )then
         a_adult.hrpid := gse.Integer_Value( cursor, 204 );
      end if;
      if not gse.Is_Null( cursor, 205 )then
         a_adult.hsvper := gse.Integer_Value( cursor, 205 );
      end if;
      if not gse.Is_Null( cursor, 206 )then
         a_adult.iclaim1 := gse.Integer_Value( cursor, 206 );
      end if;
      if not gse.Is_Null( cursor, 207 )then
         a_adult.iclaim2 := gse.Integer_Value( cursor, 207 );
      end if;
      if not gse.Is_Null( cursor, 208 )then
         a_adult.iclaim3 := gse.Integer_Value( cursor, 208 );
      end if;
      if not gse.Is_Null( cursor, 209 )then
         a_adult.iclaim4 := gse.Integer_Value( cursor, 209 );
      end if;
      if not gse.Is_Null( cursor, 210 )then
         a_adult.iclaim5 := gse.Integer_Value( cursor, 210 );
      end if;
      if not gse.Is_Null( cursor, 211 )then
         a_adult.iclaim6 := gse.Integer_Value( cursor, 211 );
      end if;
      if not gse.Is_Null( cursor, 212 )then
         a_adult.iclaim7 := gse.Integer_Value( cursor, 212 );
      end if;
      if not gse.Is_Null( cursor, 213 )then
         a_adult.iclaim8 := gse.Integer_Value( cursor, 213 );
      end if;
      if not gse.Is_Null( cursor, 214 )then
         a_adult.iclaim9 := gse.Integer_Value( cursor, 214 );
      end if;
      if not gse.Is_Null( cursor, 215 )then
         a_adult.incdur := gse.Integer_Value( cursor, 215 );
      end if;
      if not gse.Is_Null( cursor, 216 )then
         a_adult.injlong := gse.Integer_Value( cursor, 216 );
      end if;
      if not gse.Is_Null( cursor, 217 )then
         a_adult.injwk := gse.Integer_Value( cursor, 217 );
      end if;
      if not gse.Is_Null( cursor, 218 )then
         a_adult.invests := gse.Integer_Value( cursor, 218 );
      end if;
      if not gse.Is_Null( cursor, 219 )then
         a_adult.iout := gse.Integer_Value( cursor, 219 );
      end if;
      if not gse.Is_Null( cursor, 220 )then
         a_adult.isa1type := gse.Integer_Value( cursor, 220 );
      end if;
      if not gse.Is_Null( cursor, 221 )then
         a_adult.isa2type := gse.Integer_Value( cursor, 221 );
      end if;
      if not gse.Is_Null( cursor, 222 )then
         a_adult.issue := gse.Integer_Value( cursor, 222 );
      end if;
      if not gse.Is_Null( cursor, 223 )then
         a_adult.jobaway := gse.Integer_Value( cursor, 223 );
      end if;
      if not gse.Is_Null( cursor, 224 )then
         a_adult.jobbyr := gse.Integer_Value( cursor, 224 );
      end if;
      if not gse.Is_Null( cursor, 225 )then
         a_adult.jobsat := gse.Integer_Value( cursor, 225 );
      end if;
      if not gse.Is_Null( cursor, 226 )then
         a_adult.kidben1 := gse.Integer_Value( cursor, 226 );
      end if;
      if not gse.Is_Null( cursor, 227 )then
         a_adult.kidben2 := gse.Integer_Value( cursor, 227 );
      end if;
      if not gse.Is_Null( cursor, 228 )then
         a_adult.kidben3 := gse.Integer_Value( cursor, 228 );
      end if;
      if not gse.Is_Null( cursor, 229 )then
         a_adult.lareg := gse.Integer_Value( cursor, 229 );
      end if;
      if not gse.Is_Null( cursor, 230 )then
         a_adult.legltrus := gse.Integer_Value( cursor, 230 );
      end if;
      if not gse.Is_Null( cursor, 231 )then
         a_adult.lifesat := gse.Integer_Value( cursor, 231 );
      end if;
      if not gse.Is_Null( cursor, 232 )then
         a_adult.likewk := gse.Integer_Value( cursor, 232 );
      end if;
      if not gse.Is_Null( cursor, 233 )then
         a_adult.limitl := gse.Integer_Value( cursor, 233 );
      end if;
      if not gse.Is_Null( cursor, 234 )then
         a_adult.lktime := gse.Integer_Value( cursor, 234 );
      end if;
      if not gse.Is_Null( cursor, 235 )then
         a_adult.lktrain := gse.Integer_Value( cursor, 235 );
      end if;
      if not gse.Is_Null( cursor, 236 )then
         a_adult.lkwork := gse.Integer_Value( cursor, 236 );
      end if;
      if not gse.Is_Null( cursor, 237 )then
         a_adult.lnkdwp := gse.Integer_Value( cursor, 237 );
      end if;
      if not gse.Is_Null( cursor, 238 )then
         a_adult.lnkref01 := gse.Integer_Value( cursor, 238 );
      end if;
      if not gse.Is_Null( cursor, 239 )then
         a_adult.lnkref02 := gse.Integer_Value( cursor, 239 );
      end if;
      if not gse.Is_Null( cursor, 240 )then
         a_adult.lnkref03 := gse.Integer_Value( cursor, 240 );
      end if;
      if not gse.Is_Null( cursor, 241 )then
         a_adult.lnkref04 := gse.Integer_Value( cursor, 241 );
      end if;
      if not gse.Is_Null( cursor, 242 )then
         a_adult.lnkref05 := gse.Integer_Value( cursor, 242 );
      end if;
      if not gse.Is_Null( cursor, 243 )then
         a_adult.lnkref06 := gse.Integer_Value( cursor, 243 );
      end if;
      if not gse.Is_Null( cursor, 244 )then
         a_adult.lnkref07 := gse.Integer_Value( cursor, 244 );
      end if;
      if not gse.Is_Null( cursor, 245 )then
         a_adult.lnkref08 := gse.Integer_Value( cursor, 245 );
      end if;
      if not gse.Is_Null( cursor, 246 )then
         a_adult.lnkref09 := gse.Integer_Value( cursor, 246 );
      end if;
      if not gse.Is_Null( cursor, 247 )then
         a_adult.lnkref10 := gse.Integer_Value( cursor, 247 );
      end if;
      if not gse.Is_Null( cursor, 248 )then
         a_adult.lnkref11 := gse.Integer_Value( cursor, 248 );
      end if;
      if not gse.Is_Null( cursor, 249 )then
         a_adult.loan := gse.Integer_Value( cursor, 249 );
      end if;
      if not gse.Is_Null( cursor, 250 )then
         a_adult.loannum := gse.Integer_Value( cursor, 250 );
      end if;
      if not gse.Is_Null( cursor, 251 )then
         a_adult.lstwrk1 := gse.Integer_Value( cursor, 251 );
      end if;
      if not gse.Is_Null( cursor, 252 )then
         a_adult.lstwrk2 := gse.Integer_Value( cursor, 252 );
      end if;
      if not gse.Is_Null( cursor, 253 )then
         a_adult.lstyr := gse.Integer_Value( cursor, 253 );
      end if;
      if not gse.Is_Null( cursor, 254 )then
         a_adult.meaning := gse.Integer_Value( cursor, 254 );
      end if;
      if not gse.Is_Null( cursor, 255 )then
         a_adult.medrec := gse.Integer_Value( cursor, 255 );
      end if;
      if not gse.Is_Null( cursor, 256 )then
         a_adult.memschm := gse.Integer_Value( cursor, 256 );
      end if;
      if not gse.Is_Null( cursor, 257 )then
         a_adult.mntamt1:= Amount'Value( gse.Value( cursor, 257 ));
      end if;
      if not gse.Is_Null( cursor, 258 )then
         a_adult.mntamt2:= Amount'Value( gse.Value( cursor, 258 ));
      end if;
      if not gse.Is_Null( cursor, 259 )then
         a_adult.mntarr1 := gse.Integer_Value( cursor, 259 );
      end if;
      if not gse.Is_Null( cursor, 260 )then
         a_adult.mntarr2 := gse.Integer_Value( cursor, 260 );
      end if;
      if not gse.Is_Null( cursor, 261 )then
         a_adult.mntarr3 := gse.Integer_Value( cursor, 261 );
      end if;
      if not gse.Is_Null( cursor, 262 )then
         a_adult.mntarr4 := gse.Integer_Value( cursor, 262 );
      end if;
      if not gse.Is_Null( cursor, 263 )then
         a_adult.mntgov1 := gse.Integer_Value( cursor, 263 );
      end if;
      if not gse.Is_Null( cursor, 264 )then
         a_adult.mntgov2 := gse.Integer_Value( cursor, 264 );
      end if;
      if not gse.Is_Null( cursor, 265 )then
         a_adult.mntnrp := gse.Integer_Value( cursor, 265 );
      end if;
      if not gse.Is_Null( cursor, 266 )then
         a_adult.mntpay := gse.Integer_Value( cursor, 266 );
      end if;
      if not gse.Is_Null( cursor, 267 )then
         a_adult.mntpd1 := gse.Integer_Value( cursor, 267 );
      end if;
      if not gse.Is_Null( cursor, 268 )then
         a_adult.mntpd2 := gse.Integer_Value( cursor, 268 );
      end if;
      if not gse.Is_Null( cursor, 269 )then
         a_adult.mntrec := gse.Integer_Value( cursor, 269 );
      end if;
      if not gse.Is_Null( cursor, 270 )then
         a_adult.mntus1 := gse.Integer_Value( cursor, 270 );
      end if;
      if not gse.Is_Null( cursor, 271 )then
         a_adult.mntus2 := gse.Integer_Value( cursor, 271 );
      end if;
      if not gse.Is_Null( cursor, 272 )then
         a_adult.mntusam1:= Amount'Value( gse.Value( cursor, 272 ));
      end if;
      if not gse.Is_Null( cursor, 273 )then
         a_adult.mntusam2:= Amount'Value( gse.Value( cursor, 273 ));
      end if;
      if not gse.Is_Null( cursor, 274 )then
         a_adult.mntuspd1 := gse.Integer_Value( cursor, 274 );
      end if;
      if not gse.Is_Null( cursor, 275 )then
         a_adult.mntuspd2 := gse.Integer_Value( cursor, 275 );
      end if;
      if not gse.Is_Null( cursor, 276 )then
         a_adult.moneysat := gse.Integer_Value( cursor, 276 );
      end if;
      if not gse.Is_Null( cursor, 277 )then
         a_adult.ms := gse.Integer_Value( cursor, 277 );
      end if;
      if not gse.Is_Null( cursor, 278 )then
         a_adult.nanid1 := gse.Integer_Value( cursor, 278 );
      end if;
      if not gse.Is_Null( cursor, 279 )then
         a_adult.nanid2 := gse.Integer_Value( cursor, 279 );
      end if;
      if not gse.Is_Null( cursor, 280 )then
         a_adult.nanid3 := gse.Integer_Value( cursor, 280 );
      end if;
      if not gse.Is_Null( cursor, 281 )then
         a_adult.nanid4 := gse.Integer_Value( cursor, 281 );
      end if;
      if not gse.Is_Null( cursor, 282 )then
         a_adult.nanid5 := gse.Integer_Value( cursor, 282 );
      end if;
      if not gse.Is_Null( cursor, 283 )then
         a_adult.nanid6 := gse.Integer_Value( cursor, 283 );
      end if;
      if not gse.Is_Null( cursor, 284 )then
         a_adult.nervous := gse.Integer_Value( cursor, 284 );
      end if;
      if not gse.Is_Null( cursor, 285 )then
         a_adult.ni2train := gse.Integer_Value( cursor, 285 );
      end if;
      if not gse.Is_Null( cursor, 286 )then
         a_adult.niamt:= Amount'Value( gse.Value( cursor, 286 ));
      end if;
      if not gse.Is_Null( cursor, 287 )then
         a_adult.nietngrp := gse.Integer_Value( cursor, 287 );
      end if;
      if not gse.Is_Null( cursor, 288 )then
         a_adult.niexthbb := gse.Integer_Value( cursor, 288 );
      end if;
      if not gse.Is_Null( cursor, 289 )then
         a_adult.ninanid1 := gse.Integer_Value( cursor, 289 );
      end if;
      if not gse.Is_Null( cursor, 290 )then
         a_adult.ninanid2 := gse.Integer_Value( cursor, 290 );
      end if;
      if not gse.Is_Null( cursor, 291 )then
         a_adult.ninanid3 := gse.Integer_Value( cursor, 291 );
      end if;
      if not gse.Is_Null( cursor, 292 )then
         a_adult.ninanid4 := gse.Integer_Value( cursor, 292 );
      end if;
      if not gse.Is_Null( cursor, 293 )then
         a_adult.ninanid5 := gse.Integer_Value( cursor, 293 );
      end if;
      if not gse.Is_Null( cursor, 294 )then
         a_adult.ninanid6 := gse.Integer_Value( cursor, 294 );
      end if;
      if not gse.Is_Null( cursor, 295 )then
         a_adult.ninanid7 := gse.Integer_Value( cursor, 295 );
      end if;
      if not gse.Is_Null( cursor, 296 )then
         a_adult.nipd := gse.Integer_Value( cursor, 296 );
      end if;
      if not gse.Is_Null( cursor, 297 )then
         a_adult.nireg := gse.Integer_Value( cursor, 297 );
      end if;
      if not gse.Is_Null( cursor, 298 )then
         a_adult.nirelig := gse.Integer_Value( cursor, 298 );
      end if;
      if not gse.Is_Null( cursor, 299 )then
         a_adult.nolk1 := gse.Integer_Value( cursor, 299 );
      end if;
      if not gse.Is_Null( cursor, 300 )then
         a_adult.nolk2 := gse.Integer_Value( cursor, 300 );
      end if;
      if not gse.Is_Null( cursor, 301 )then
         a_adult.nolk3 := gse.Integer_Value( cursor, 301 );
      end if;
      if not gse.Is_Null( cursor, 302 )then
         a_adult.nowant := gse.Integer_Value( cursor, 302 );
      end if;
      if not gse.Is_Null( cursor, 303 )then
         a_adult.nssec:= Amount'Value( gse.Value( cursor, 303 ));
      end if;
      if not gse.Is_Null( cursor, 304 )then
         a_adult.numjob := gse.Integer_Value( cursor, 304 );
      end if;
      if not gse.Is_Null( cursor, 305 )then
         a_adult.numjob2 := gse.Integer_Value( cursor, 305 );
      end if;
      if not gse.Is_Null( cursor, 306 )then
         a_adult.nvqlenow := gse.Integer_Value( cursor, 306 );
      end if;
      if not gse.Is_Null( cursor, 307 )then
         a_adult.nvqlev := gse.Integer_Value( cursor, 307 );
      end if;
      if not gse.Is_Null( cursor, 308 )then
         a_adult.oddjob := gse.Integer_Value( cursor, 308 );
      end if;
      if not gse.Is_Null( cursor, 309 )then
         a_adult.oldstud := gse.Integer_Value( cursor, 309 );
      end if;
      if not gse.Is_Null( cursor, 310 )then
         a_adult.otabspar := gse.Integer_Value( cursor, 310 );
      end if;
      if not gse.Is_Null( cursor, 311 )then
         a_adult.otamt:= Amount'Value( gse.Value( cursor, 311 ));
      end if;
      if not gse.Is_Null( cursor, 312 )then
         a_adult.otapamt:= Amount'Value( gse.Value( cursor, 312 ));
      end if;
      if not gse.Is_Null( cursor, 313 )then
         a_adult.otappd := gse.Integer_Value( cursor, 313 );
      end if;
      if not gse.Is_Null( cursor, 314 )then
         a_adult.othben1 := gse.Integer_Value( cursor, 314 );
      end if;
      if not gse.Is_Null( cursor, 315 )then
         a_adult.othben2 := gse.Integer_Value( cursor, 315 );
      end if;
      if not gse.Is_Null( cursor, 316 )then
         a_adult.othben3 := gse.Integer_Value( cursor, 316 );
      end if;
      if not gse.Is_Null( cursor, 317 )then
         a_adult.othben4 := gse.Integer_Value( cursor, 317 );
      end if;
      if not gse.Is_Null( cursor, 318 )then
         a_adult.othben5 := gse.Integer_Value( cursor, 318 );
      end if;
      if not gse.Is_Null( cursor, 319 )then
         a_adult.othben6 := gse.Integer_Value( cursor, 319 );
      end if;
      if not gse.Is_Null( cursor, 320 )then
         a_adult.othpass := gse.Integer_Value( cursor, 320 );
      end if;
      if not gse.Is_Null( cursor, 321 )then
         a_adult.othqual1 := gse.Integer_Value( cursor, 321 );
      end if;
      if not gse.Is_Null( cursor, 322 )then
         a_adult.othqual2 := gse.Integer_Value( cursor, 322 );
      end if;
      if not gse.Is_Null( cursor, 323 )then
         a_adult.othqual3 := gse.Integer_Value( cursor, 323 );
      end if;
      if not gse.Is_Null( cursor, 324 )then
         a_adult.othtax := gse.Integer_Value( cursor, 324 );
      end if;
      if not gse.Is_Null( cursor, 325 )then
         a_adult.othtrust := gse.Integer_Value( cursor, 325 );
      end if;
      if not gse.Is_Null( cursor, 326 )then
         a_adult.otinva := gse.Integer_Value( cursor, 326 );
      end if;
      if not gse.Is_Null( cursor, 327 )then
         a_adult.pareamt:= Amount'Value( gse.Value( cursor, 327 ));
      end if;
      if not gse.Is_Null( cursor, 328 )then
         a_adult.parepd := gse.Integer_Value( cursor, 328 );
      end if;
      if not gse.Is_Null( cursor, 329 )then
         a_adult.penben1 := gse.Integer_Value( cursor, 329 );
      end if;
      if not gse.Is_Null( cursor, 330 )then
         a_adult.penben2 := gse.Integer_Value( cursor, 330 );
      end if;
      if not gse.Is_Null( cursor, 331 )then
         a_adult.penben3 := gse.Integer_Value( cursor, 331 );
      end if;
      if not gse.Is_Null( cursor, 332 )then
         a_adult.penben4 := gse.Integer_Value( cursor, 332 );
      end if;
      if not gse.Is_Null( cursor, 333 )then
         a_adult.penben5 := gse.Integer_Value( cursor, 333 );
      end if;
      if not gse.Is_Null( cursor, 334 )then
         a_adult.penflag := gse.Integer_Value( cursor, 334 );
      end if;
      if not gse.Is_Null( cursor, 335 )then
         a_adult.penlump := gse.Integer_Value( cursor, 335 );
      end if;
      if not gse.Is_Null( cursor, 336 )then
         a_adult.perspen1 := gse.Integer_Value( cursor, 336 );
      end if;
      if not gse.Is_Null( cursor, 337 )then
         a_adult.perspen2 := gse.Integer_Value( cursor, 337 );
      end if;
      if not gse.Is_Null( cursor, 338 )then
         a_adult.pip1 := gse.Integer_Value( cursor, 338 );
      end if;
      if not gse.Is_Null( cursor, 339 )then
         a_adult.pip2 := gse.Integer_Value( cursor, 339 );
      end if;
      if not gse.Is_Null( cursor, 340 )then
         a_adult.pollopin := gse.Integer_Value( cursor, 340 );
      end if;
      if not gse.Is_Null( cursor, 341 )then
         a_adult.polttrus := gse.Integer_Value( cursor, 341 );
      end if;
      if not gse.Is_Null( cursor, 342 )then
         a_adult.ppchk1 := gse.Integer_Value( cursor, 342 );
      end if;
      if not gse.Is_Null( cursor, 343 )then
         a_adult.ppchk2 := gse.Integer_Value( cursor, 343 );
      end if;
      if not gse.Is_Null( cursor, 344 )then
         a_adult.ppchk3 := gse.Integer_Value( cursor, 344 );
      end if;
      if not gse.Is_Null( cursor, 345 )then
         a_adult.ppnumc := gse.Integer_Value( cursor, 345 );
      end if;
      if not gse.Is_Null( cursor, 346 )then
         a_adult.ppper := gse.Integer_Value( cursor, 346 );
      end if;
      if not gse.Is_Null( cursor, 347 )then
         a_adult.practice := gse.Integer_Value( cursor, 347 );
      end if;
      if not gse.Is_Null( cursor, 348 )then
         a_adult.privpen := gse.Integer_Value( cursor, 348 );
      end if;
      if not gse.Is_Null( cursor, 349 )then
         a_adult.proptax:= Amount'Value( gse.Value( cursor, 349 ));
      end if;
      if not gse.Is_Null( cursor, 350 )then
         a_adult.ptwk := gse.Integer_Value( cursor, 350 );
      end if;
      if not gse.Is_Null( cursor, 351 )then
         a_adult.r01 := gse.Integer_Value( cursor, 351 );
      end if;
      if not gse.Is_Null( cursor, 352 )then
         a_adult.r02 := gse.Integer_Value( cursor, 352 );
      end if;
      if not gse.Is_Null( cursor, 353 )then
         a_adult.r03 := gse.Integer_Value( cursor, 353 );
      end if;
      if not gse.Is_Null( cursor, 354 )then
         a_adult.r04 := gse.Integer_Value( cursor, 354 );
      end if;
      if not gse.Is_Null( cursor, 355 )then
         a_adult.r05 := gse.Integer_Value( cursor, 355 );
      end if;
      if not gse.Is_Null( cursor, 356 )then
         a_adult.r06 := gse.Integer_Value( cursor, 356 );
      end if;
      if not gse.Is_Null( cursor, 357 )then
         a_adult.r07 := gse.Integer_Value( cursor, 357 );
      end if;
      if not gse.Is_Null( cursor, 358 )then
         a_adult.r08 := gse.Integer_Value( cursor, 358 );
      end if;
      if not gse.Is_Null( cursor, 359 )then
         a_adult.r09 := gse.Integer_Value( cursor, 359 );
      end if;
      if not gse.Is_Null( cursor, 360 )then
         a_adult.r10 := gse.Integer_Value( cursor, 360 );
      end if;
      if not gse.Is_Null( cursor, 361 )then
         a_adult.r11 := gse.Integer_Value( cursor, 361 );
      end if;
      if not gse.Is_Null( cursor, 362 )then
         a_adult.r12 := gse.Integer_Value( cursor, 362 );
      end if;
      if not gse.Is_Null( cursor, 363 )then
         a_adult.r13 := gse.Integer_Value( cursor, 363 );
      end if;
      if not gse.Is_Null( cursor, 364 )then
         a_adult.r14 := gse.Integer_Value( cursor, 364 );
      end if;
      if not gse.Is_Null( cursor, 365 )then
         a_adult.reasden := gse.Integer_Value( cursor, 365 );
      end if;
      if not gse.Is_Null( cursor, 366 )then
         a_adult.reasmed := gse.Integer_Value( cursor, 366 );
      end if;
      if not gse.Is_Null( cursor, 367 )then
         a_adult.reasnhs := gse.Integer_Value( cursor, 367 );
      end if;
      if not gse.Is_Null( cursor, 368 )then
         a_adult.reason := gse.Integer_Value( cursor, 368 );
      end if;
      if not gse.Is_Null( cursor, 369 )then
         a_adult.recsat := gse.Integer_Value( cursor, 369 );
      end if;
      if not gse.Is_Null( cursor, 370 )then
         a_adult.redamt:= Amount'Value( gse.Value( cursor, 370 ));
      end if;
      if not gse.Is_Null( cursor, 371 )then
         a_adult.redany := gse.Integer_Value( cursor, 371 );
      end if;
      if not gse.Is_Null( cursor, 372 )then
         a_adult.rednet := gse.Integer_Value( cursor, 372 );
      end if;
      if not gse.Is_Null( cursor, 373 )then
         a_adult.redtax:= Amount'Value( gse.Value( cursor, 373 ));
      end if;
      if not gse.Is_Null( cursor, 374 )then
         a_adult.relasat := gse.Integer_Value( cursor, 374 );
      end if;
      if not gse.Is_Null( cursor, 375 )then
         a_adult.religenw := gse.Integer_Value( cursor, 375 );
      end if;
      if not gse.Is_Null( cursor, 376 )then
         a_adult.religsc := gse.Integer_Value( cursor, 376 );
      end if;
      if not gse.Is_Null( cursor, 377 )then
         a_adult.rentprof := gse.Integer_Value( cursor, 377 );
      end if;
      if not gse.Is_Null( cursor, 378 )then
         a_adult.retire := gse.Integer_Value( cursor, 378 );
      end if;
      if not gse.Is_Null( cursor, 379 )then
         a_adult.retire1 := gse.Integer_Value( cursor, 379 );
      end if;
      if not gse.Is_Null( cursor, 380 )then
         a_adult.retreas := gse.Integer_Value( cursor, 380 );
      end if;
      if not gse.Is_Null( cursor, 381 )then
         a_adult.royal1 := gse.Integer_Value( cursor, 381 );
      end if;
      if not gse.Is_Null( cursor, 382 )then
         a_adult.royal2 := gse.Integer_Value( cursor, 382 );
      end if;
      if not gse.Is_Null( cursor, 383 )then
         a_adult.royal3 := gse.Integer_Value( cursor, 383 );
      end if;
      if not gse.Is_Null( cursor, 384 )then
         a_adult.royal4 := gse.Integer_Value( cursor, 384 );
      end if;
      if not gse.Is_Null( cursor, 385 )then
         a_adult.royyr1:= Amount'Value( gse.Value( cursor, 385 ));
      end if;
      if not gse.Is_Null( cursor, 386 )then
         a_adult.royyr2:= Amount'Value( gse.Value( cursor, 386 ));
      end if;
      if not gse.Is_Null( cursor, 387 )then
         a_adult.royyr3:= Amount'Value( gse.Value( cursor, 387 ));
      end if;
      if not gse.Is_Null( cursor, 388 )then
         a_adult.royyr4:= Amount'Value( gse.Value( cursor, 388 ));
      end if;
      if not gse.Is_Null( cursor, 389 )then
         a_adult.rsa := gse.Integer_Value( cursor, 389 );
      end if;
      if not gse.Is_Null( cursor, 390 )then
         a_adult.rsanow := gse.Integer_Value( cursor, 390 );
      end if;
      if not gse.Is_Null( cursor, 391 )then
         a_adult.rstrct := gse.Integer_Value( cursor, 391 );
      end if;
      if not gse.Is_Null( cursor, 392 )then
         a_adult.safe := gse.Integer_Value( cursor, 392 );
      end if;
      if not gse.Is_Null( cursor, 393 )then
         a_adult.samesit := gse.Integer_Value( cursor, 393 );
      end if;
      if not gse.Is_Null( cursor, 394 )then
         a_adult.schchk := gse.Integer_Value( cursor, 394 );
      end if;
      if not gse.Is_Null( cursor, 395 )then
         a_adult.scotvec := gse.Integer_Value( cursor, 395 );
      end if;
      if not gse.Is_Null( cursor, 396 )then
         a_adult.sctvnow := gse.Integer_Value( cursor, 396 );
      end if;
      if not gse.Is_Null( cursor, 397 )then
         a_adult.sdemp01 := gse.Integer_Value( cursor, 397 );
      end if;
      if not gse.Is_Null( cursor, 398 )then
         a_adult.sdemp02 := gse.Integer_Value( cursor, 398 );
      end if;
      if not gse.Is_Null( cursor, 399 )then
         a_adult.sdemp03 := gse.Integer_Value( cursor, 399 );
      end if;
      if not gse.Is_Null( cursor, 400 )then
         a_adult.sdemp04 := gse.Integer_Value( cursor, 400 );
      end if;
      if not gse.Is_Null( cursor, 401 )then
         a_adult.sdemp05 := gse.Integer_Value( cursor, 401 );
      end if;
      if not gse.Is_Null( cursor, 402 )then
         a_adult.sdemp06 := gse.Integer_Value( cursor, 402 );
      end if;
      if not gse.Is_Null( cursor, 403 )then
         a_adult.sdemp07 := gse.Integer_Value( cursor, 403 );
      end if;
      if not gse.Is_Null( cursor, 404 )then
         a_adult.sdemp08 := gse.Integer_Value( cursor, 404 );
      end if;
      if not gse.Is_Null( cursor, 405 )then
         a_adult.sdemp09 := gse.Integer_Value( cursor, 405 );
      end if;
      if not gse.Is_Null( cursor, 406 )then
         a_adult.sdemp10 := gse.Integer_Value( cursor, 406 );
      end if;
      if not gse.Is_Null( cursor, 407 )then
         a_adult.sdemp11 := gse.Integer_Value( cursor, 407 );
      end if;
      if not gse.Is_Null( cursor, 408 )then
         a_adult.sdemp12 := gse.Integer_Value( cursor, 408 );
      end if;
      if not gse.Is_Null( cursor, 409 )then
         a_adult.selfdemp := gse.Integer_Value( cursor, 409 );
      end if;
      if not gse.Is_Null( cursor, 410 )then
         a_adult.sex := gse.Integer_Value( cursor, 410 );
      end if;
      if not gse.Is_Null( cursor, 411 )then
         a_adult.sflntyp1 := gse.Integer_Value( cursor, 411 );
      end if;
      if not gse.Is_Null( cursor, 412 )then
         a_adult.sflntyp2 := gse.Integer_Value( cursor, 412 );
      end if;
      if not gse.Is_Null( cursor, 413 )then
         a_adult.sftype1 := gse.Integer_Value( cursor, 413 );
      end if;
      if not gse.Is_Null( cursor, 414 )then
         a_adult.sftype2 := gse.Integer_Value( cursor, 414 );
      end if;
      if not gse.Is_Null( cursor, 415 )then
         a_adult.sic := gse.Integer_Value( cursor, 415 );
      end if;
      if not gse.Is_Null( cursor, 416 )then
         a_adult.sidqn := gse.Integer_Value( cursor, 416 );
      end if;
      if not gse.Is_Null( cursor, 417 )then
         a_adult.slrepamt:= Amount'Value( gse.Value( cursor, 417 ));
      end if;
      if not gse.Is_Null( cursor, 418 )then
         a_adult.slrepay := gse.Integer_Value( cursor, 418 );
      end if;
      if not gse.Is_Null( cursor, 419 )then
         a_adult.slreppd := gse.Integer_Value( cursor, 419 );
      end if;
      if not gse.Is_Null( cursor, 420 )then
         a_adult.soc2010 := gse.Integer_Value( cursor, 420 );
      end if;
      if not gse.Is_Null( cursor, 421 )then
         a_adult.socfund1 := gse.Integer_Value( cursor, 421 );
      end if;
      if not gse.Is_Null( cursor, 422 )then
         a_adult.socfund2 := gse.Integer_Value( cursor, 422 );
      end if;
      if not gse.Is_Null( cursor, 423 )then
         a_adult.socfund3 := gse.Integer_Value( cursor, 423 );
      end if;
      if not gse.Is_Null( cursor, 424 )then
         a_adult.socfund4 := gse.Integer_Value( cursor, 424 );
      end if;
      if not gse.Is_Null( cursor, 425 )then
         a_adult.spcreg1 := gse.Integer_Value( cursor, 425 );
      end if;
      if not gse.Is_Null( cursor, 426 )then
         a_adult.spcreg2 := gse.Integer_Value( cursor, 426 );
      end if;
      if not gse.Is_Null( cursor, 427 )then
         a_adult.spcreg3 := gse.Integer_Value( cursor, 427 );
      end if;
      if not gse.Is_Null( cursor, 428 )then
         a_adult.spnumc := gse.Integer_Value( cursor, 428 );
      end if;
      if not gse.Is_Null( cursor, 429 )then
         a_adult.spout := gse.Integer_Value( cursor, 429 );
      end if;
      if not gse.Is_Null( cursor, 430 )then
         a_adult.spyrot := gse.Integer_Value( cursor, 430 );
      end if;
      if not gse.Is_Null( cursor, 431 )then
         a_adult.srentamt:= Amount'Value( gse.Value( cursor, 431 ));
      end if;
      if not gse.Is_Null( cursor, 432 )then
         a_adult.srentpd := gse.Integer_Value( cursor, 432 );
      end if;
      if not gse.Is_Null( cursor, 433 )then
         a_adult.srispc := gse.Integer_Value( cursor, 433 );
      end if;
      if not gse.Is_Null( cursor, 434 )then
         a_adult.srjsaesa := gse.Integer_Value( cursor, 434 );
      end if;
      if not gse.Is_Null( cursor, 435 )then
         a_adult.stakep := gse.Integer_Value( cursor, 435 );
      end if;
      if not gse.Is_Null( cursor, 436 )then
         a_adult.start := gse.Integer_Value( cursor, 436 );
      end if;
      if not gse.Is_Null( cursor, 437 )then
         a_adult.tcever1 := gse.Integer_Value( cursor, 437 );
      end if;
      if not gse.Is_Null( cursor, 438 )then
         a_adult.tcever2 := gse.Integer_Value( cursor, 438 );
      end if;
      if not gse.Is_Null( cursor, 439 )then
         a_adult.tcrepay1 := gse.Integer_Value( cursor, 439 );
      end if;
      if not gse.Is_Null( cursor, 440 )then
         a_adult.tcrepay2 := gse.Integer_Value( cursor, 440 );
      end if;
      if not gse.Is_Null( cursor, 441 )then
         a_adult.tcrepay3 := gse.Integer_Value( cursor, 441 );
      end if;
      if not gse.Is_Null( cursor, 442 )then
         a_adult.tcrepay4 := gse.Integer_Value( cursor, 442 );
      end if;
      if not gse.Is_Null( cursor, 443 )then
         a_adult.tcrepay5 := gse.Integer_Value( cursor, 443 );
      end if;
      if not gse.Is_Null( cursor, 444 )then
         a_adult.tcrepay6 := gse.Integer_Value( cursor, 444 );
      end if;
      if not gse.Is_Null( cursor, 445 )then
         a_adult.tcthsyr1 := gse.Integer_Value( cursor, 445 );
      end if;
      if not gse.Is_Null( cursor, 446 )then
         a_adult.tcthsyr2 := gse.Integer_Value( cursor, 446 );
      end if;
      if not gse.Is_Null( cursor, 447 )then
         a_adult.tdaywrk := gse.Integer_Value( cursor, 447 );
      end if;
      if not gse.Is_Null( cursor, 448 )then
         a_adult.tea := gse.Integer_Value( cursor, 448 );
      end if;
      if not gse.Is_Null( cursor, 449 )then
         a_adult.tea9697 := gse.Integer_Value( cursor, 449 );
      end if;
      if not gse.Is_Null( cursor, 450 )then
         a_adult.tempjob := gse.Integer_Value( cursor, 450 );
      end if;
      if not gse.Is_Null( cursor, 451 )then
         a_adult.timesat := gse.Integer_Value( cursor, 451 );
      end if;
      if not gse.Is_Null( cursor, 452 )then
         a_adult.topupl := gse.Integer_Value( cursor, 452 );
      end if;
      if not gse.Is_Null( cursor, 453 )then
         a_adult.totint:= Amount'Value( gse.Value( cursor, 453 ));
      end if;
      if not gse.Is_Null( cursor, 454 )then
         a_adult.train2 := gse.Integer_Value( cursor, 454 );
      end if;
      if not gse.Is_Null( cursor, 455 )then
         a_adult.trainee := gse.Integer_Value( cursor, 455 );
      end if;
      if not gse.Is_Null( cursor, 456 )then
         a_adult.trnallow := gse.Integer_Value( cursor, 456 );
      end if;
      if not gse.Is_Null( cursor, 457 )then
         a_adult.ttbprx:= Amount'Value( gse.Value( cursor, 457 ));
      end if;
      if not gse.Is_Null( cursor, 458 )then
         a_adult.tuborr := gse.Integer_Value( cursor, 458 );
      end if;
      if not gse.Is_Null( cursor, 459 )then
         a_adult.typeed := gse.Integer_Value( cursor, 459 );
      end if;
      if not gse.Is_Null( cursor, 460 )then
         a_adult.unpaid1 := gse.Integer_Value( cursor, 460 );
      end if;
      if not gse.Is_Null( cursor, 461 )then
         a_adult.unpaid2 := gse.Integer_Value( cursor, 461 );
      end if;
      if not gse.Is_Null( cursor, 462 )then
         a_adult.w1 := gse.Integer_Value( cursor, 462 );
      end if;
      if not gse.Is_Null( cursor, 463 )then
         a_adult.w2 := gse.Integer_Value( cursor, 463 );
      end if;
      if not gse.Is_Null( cursor, 464 )then
         a_adult.wageben1 := gse.Integer_Value( cursor, 464 );
      end if;
      if not gse.Is_Null( cursor, 465 )then
         a_adult.wageben2 := gse.Integer_Value( cursor, 465 );
      end if;
      if not gse.Is_Null( cursor, 466 )then
         a_adult.wageben3 := gse.Integer_Value( cursor, 466 );
      end if;
      if not gse.Is_Null( cursor, 467 )then
         a_adult.wageben4 := gse.Integer_Value( cursor, 467 );
      end if;
      if not gse.Is_Null( cursor, 468 )then
         a_adult.wageben5 := gse.Integer_Value( cursor, 468 );
      end if;
      if not gse.Is_Null( cursor, 469 )then
         a_adult.wageben6 := gse.Integer_Value( cursor, 469 );
      end if;
      if not gse.Is_Null( cursor, 470 )then
         a_adult.wageben7 := gse.Integer_Value( cursor, 470 );
      end if;
      if not gse.Is_Null( cursor, 471 )then
         a_adult.wageben8 := gse.Integer_Value( cursor, 471 );
      end if;
      if not gse.Is_Null( cursor, 472 )then
         a_adult.wait := gse.Integer_Value( cursor, 472 );
      end if;
      if not gse.Is_Null( cursor, 473 )then
         a_adult.whoresp := gse.Integer_Value( cursor, 473 );
      end if;
      if not gse.Is_Null( cursor, 474 )then
         a_adult.whosectb := gse.Integer_Value( cursor, 474 );
      end if;
      if not gse.Is_Null( cursor, 475 )then
         a_adult.wintfuel := gse.Integer_Value( cursor, 475 );
      end if;
      if not gse.Is_Null( cursor, 476 )then
         a_adult.working := gse.Integer_Value( cursor, 476 );
      end if;
      if not gse.Is_Null( cursor, 477 )then
         a_adult.wpa := gse.Integer_Value( cursor, 477 );
      end if;
      if not gse.Is_Null( cursor, 478 )then
         a_adult.wpba := gse.Integer_Value( cursor, 478 );
      end if;
      if not gse.Is_Null( cursor, 479 )then
         a_adult.wtclum1 := gse.Integer_Value( cursor, 479 );
      end if;
      if not gse.Is_Null( cursor, 480 )then
         a_adult.wtclum2 := gse.Integer_Value( cursor, 480 );
      end if;
      if not gse.Is_Null( cursor, 481 )then
         a_adult.ystrtwk := gse.Integer_Value( cursor, 481 );
      end if;
      if not gse.Is_Null( cursor, 482 )then
         a_adult.month := gse.Integer_Value( cursor, 482 );
      end if;
      if not gse.Is_Null( cursor, 483 )then
         a_adult.able := gse.Integer_Value( cursor, 483 );
      end if;
      if not gse.Is_Null( cursor, 484 )then
         a_adult.actacci := gse.Integer_Value( cursor, 484 );
      end if;
      if not gse.Is_Null( cursor, 485 )then
         a_adult.age80 := gse.Integer_Value( cursor, 485 );
      end if;
      if not gse.Is_Null( cursor, 486 )then
         a_adult.agehq80 := gse.Integer_Value( cursor, 486 );
      end if;
      if not gse.Is_Null( cursor, 487 )then
         a_adult.basacti := gse.Integer_Value( cursor, 487 );
      end if;
      if not gse.Is_Null( cursor, 488 )then
         a_adult.careab := gse.Integer_Value( cursor, 488 );
      end if;
      if not gse.Is_Null( cursor, 489 )then
         a_adult.careah := gse.Integer_Value( cursor, 489 );
      end if;
      if not gse.Is_Null( cursor, 490 )then
         a_adult.carecb := gse.Integer_Value( cursor, 490 );
      end if;
      if not gse.Is_Null( cursor, 491 )then
         a_adult.carech := gse.Integer_Value( cursor, 491 );
      end if;
      if not gse.Is_Null( cursor, 492 )then
         a_adult.carecl := gse.Integer_Value( cursor, 492 );
      end if;
      if not gse.Is_Null( cursor, 493 )then
         a_adult.carefl := gse.Integer_Value( cursor, 493 );
      end if;
      if not gse.Is_Null( cursor, 494 )then
         a_adult.carefr := gse.Integer_Value( cursor, 494 );
      end if;
      if not gse.Is_Null( cursor, 495 )then
         a_adult.careot := gse.Integer_Value( cursor, 495 );
      end if;
      if not gse.Is_Null( cursor, 496 )then
         a_adult.carere := gse.Integer_Value( cursor, 496 );
      end if;
      if not gse.Is_Null( cursor, 497 )then
         a_adult.chbflg := gse.Integer_Value( cursor, 497 );
      end if;
      if not gse.Is_Null( cursor, 498 )then
         a_adult.corignan := gse.Integer_Value( cursor, 498 );
      end if;
      if not gse.Is_Null( cursor, 499 )then
         a_adult.curacti := gse.Integer_Value( cursor, 499 );
      end if;
      if not gse.Is_Null( cursor, 500 )then
         a_adult.currjobm := gse.Integer_Value( cursor, 500 );
      end if;
      if not gse.Is_Null( cursor, 501 )then
         a_adult.disacta1 := gse.Integer_Value( cursor, 501 );
      end if;
      if not gse.Is_Null( cursor, 502 )then
         a_adult.discora1 := gse.Integer_Value( cursor, 502 );
      end if;
      if not gse.Is_Null( cursor, 503 )then
         a_adult.dobmonth := gse.Integer_Value( cursor, 503 );
      end if;
      if not gse.Is_Null( cursor, 504 )then
         a_adult.dobyear := gse.Integer_Value( cursor, 504 );
      end if;
      if not gse.Is_Null( cursor, 505 )then
         a_adult.empoccp:= Amount'Value( gse.Value( cursor, 505 ));
      end if;
      if not gse.Is_Null( cursor, 506 )then
         a_adult.empstatb := gse.Integer_Value( cursor, 506 );
      end if;
      if not gse.Is_Null( cursor, 507 )then
         a_adult.empstatc := gse.Integer_Value( cursor, 507 );
      end if;
      if not gse.Is_Null( cursor, 508 )then
         a_adult.empstati := gse.Integer_Value( cursor, 508 );
      end if;
      if not gse.Is_Null( cursor, 509 )then
         a_adult.ethgr3 := gse.Integer_Value( cursor, 509 );
      end if;
      if not gse.Is_Null( cursor, 510 )then
         a_adult.gebacti := gse.Integer_Value( cursor, 510 );
      end if;
      if not gse.Is_Null( cursor, 511 )then
         a_adult.giltcti := gse.Integer_Value( cursor, 511 );
      end if;
      if not gse.Is_Null( cursor, 512 )then
         a_adult.gross4 := gse.Integer_Value( cursor, 512 );
      end if;
      if not gse.Is_Null( cursor, 513 )then
         a_adult.hdage := gse.Integer_Value( cursor, 513 );
      end if;
      if not gse.Is_Null( cursor, 514 )then
         a_adult.hdben := gse.Integer_Value( cursor, 514 );
      end if;
      if not gse.Is_Null( cursor, 515 )then
         a_adult.hdindinc := gse.Integer_Value( cursor, 515 );
      end if;
      if not gse.Is_Null( cursor, 516 )then
         a_adult.heartval:= Amount'Value( gse.Value( cursor, 516 ));
      end if;
      if not gse.Is_Null( cursor, 517 )then
         a_adult.hourab := gse.Integer_Value( cursor, 517 );
      end if;
      if not gse.Is_Null( cursor, 518 )then
         a_adult.hourah := gse.Integer_Value( cursor, 518 );
      end if;
      if not gse.Is_Null( cursor, 519 )then
         a_adult.hourcare:= Amount'Value( gse.Value( cursor, 519 ));
      end if;
      if not gse.Is_Null( cursor, 520 )then
         a_adult.hourcb := gse.Integer_Value( cursor, 520 );
      end if;
      if not gse.Is_Null( cursor, 521 )then
         a_adult.hourch := gse.Integer_Value( cursor, 521 );
      end if;
      if not gse.Is_Null( cursor, 522 )then
         a_adult.hourcl := gse.Integer_Value( cursor, 522 );
      end if;
      if not gse.Is_Null( cursor, 523 )then
         a_adult.hourfr := gse.Integer_Value( cursor, 523 );
      end if;
      if not gse.Is_Null( cursor, 524 )then
         a_adult.hourot := gse.Integer_Value( cursor, 524 );
      end if;
      if not gse.Is_Null( cursor, 525 )then
         a_adult.hourre := gse.Integer_Value( cursor, 525 );
      end if;
      if not gse.Is_Null( cursor, 526 )then
         a_adult.hourtot := gse.Integer_Value( cursor, 526 );
      end if;
      if not gse.Is_Null( cursor, 527 )then
         a_adult.hperson := gse.Integer_Value( cursor, 527 );
      end if;
      if not gse.Is_Null( cursor, 528 )then
         a_adult.iagegr2 := gse.Integer_Value( cursor, 528 );
      end if;
      if not gse.Is_Null( cursor, 529 )then
         a_adult.iagegr3 := gse.Integer_Value( cursor, 529 );
      end if;
      if not gse.Is_Null( cursor, 530 )then
         a_adult.iagegr4 := gse.Integer_Value( cursor, 530 );
      end if;
      if not gse.Is_Null( cursor, 531 )then
         a_adult.iagegrp := gse.Integer_Value( cursor, 531 );
      end if;
      if not gse.Is_Null( cursor, 532 )then
         a_adult.incseo2:= Amount'Value( gse.Value( cursor, 532 ));
      end if;
      if not gse.Is_Null( cursor, 533 )then
         a_adult.indinc := gse.Integer_Value( cursor, 533 );
      end if;
      if not gse.Is_Null( cursor, 534 )then
         a_adult.indisben := gse.Integer_Value( cursor, 534 );
      end if;
      if not gse.Is_Null( cursor, 535 )then
         a_adult.inearns:= Amount'Value( gse.Value( cursor, 535 ));
      end if;
      if not gse.Is_Null( cursor, 536 )then
         a_adult.ininv:= Amount'Value( gse.Value( cursor, 536 ));
      end if;
      if not gse.Is_Null( cursor, 537 )then
         a_adult.inirben := gse.Integer_Value( cursor, 537 );
      end if;
      if not gse.Is_Null( cursor, 538 )then
         a_adult.innirben := gse.Integer_Value( cursor, 538 );
      end if;
      if not gse.Is_Null( cursor, 539 )then
         a_adult.inothben := gse.Integer_Value( cursor, 539 );
      end if;
      if not gse.Is_Null( cursor, 540 )then
         a_adult.inpeninc:= Amount'Value( gse.Value( cursor, 540 ));
      end if;
      if not gse.Is_Null( cursor, 541 )then
         a_adult.inrinc:= Amount'Value( gse.Value( cursor, 541 ));
      end if;
      if not gse.Is_Null( cursor, 542 )then
         a_adult.inrpinc:= Amount'Value( gse.Value( cursor, 542 ));
      end if;
      if not gse.Is_Null( cursor, 543 )then
         a_adult.intvlic:= Amount'Value( gse.Value( cursor, 543 ));
      end if;
      if not gse.Is_Null( cursor, 544 )then
         a_adult.intxcred:= Amount'Value( gse.Value( cursor, 544 ));
      end if;
      if not gse.Is_Null( cursor, 545 )then
         a_adult.isacti := gse.Integer_Value( cursor, 545 );
      end if;
      if not gse.Is_Null( cursor, 546 )then
         a_adult.marital := gse.Integer_Value( cursor, 546 );
      end if;
      if not gse.Is_Null( cursor, 547 )then
         a_adult.mjobsect := gse.Integer_Value( cursor, 547 );
      end if;
      if not gse.Is_Null( cursor, 548 )then
         a_adult.ninanida := gse.Integer_Value( cursor, 548 );
      end if;
      if not gse.Is_Null( cursor, 549 )then
         a_adult.nincseo2:= Amount'Value( gse.Value( cursor, 549 ));
      end if;
      if not gse.Is_Null( cursor, 550 )then
         a_adult.nindinc := gse.Integer_Value( cursor, 550 );
      end if;
      if not gse.Is_Null( cursor, 551 )then
         a_adult.ninearns := gse.Integer_Value( cursor, 551 );
      end if;
      if not gse.Is_Null( cursor, 552 )then
         a_adult.nininv := gse.Integer_Value( cursor, 552 );
      end if;
      if not gse.Is_Null( cursor, 553 )then
         a_adult.ninnirbn := gse.Integer_Value( cursor, 553 );
      end if;
      if not gse.Is_Null( cursor, 554 )then
         a_adult.ninothbn := gse.Integer_Value( cursor, 554 );
      end if;
      if not gse.Is_Null( cursor, 555 )then
         a_adult.ninpenin := gse.Integer_Value( cursor, 555 );
      end if;
      if not gse.Is_Null( cursor, 556 )then
         a_adult.ninrinc := gse.Integer_Value( cursor, 556 );
      end if;
      if not gse.Is_Null( cursor, 557 )then
         a_adult.ninsein2:= Amount'Value( gse.Value( cursor, 557 ));
      end if;
      if not gse.Is_Null( cursor, 558 )then
         a_adult.nirel2 := gse.Integer_Value( cursor, 558 );
      end if;
      if not gse.Is_Null( cursor, 559 )then
         a_adult.occupnum := gse.Integer_Value( cursor, 559 );
      end if;
      if not gse.Is_Null( cursor, 560 )then
         a_adult.pepscti := gse.Integer_Value( cursor, 560 );
      end if;
      if not gse.Is_Null( cursor, 561 )then
         a_adult.poaccti := gse.Integer_Value( cursor, 561 );
      end if;
      if not gse.Is_Null( cursor, 562 )then
         a_adult.pocardi := gse.Integer_Value( cursor, 562 );
      end if;
      if not gse.Is_Null( cursor, 563 )then
         a_adult.prevjobm := gse.Integer_Value( cursor, 563 );
      end if;
      if not gse.Is_Null( cursor, 564 )then
         a_adult.relhrp := gse.Integer_Value( cursor, 564 );
      end if;
      if not gse.Is_Null( cursor, 565 )then
         a_adult.sapadj:= Amount'Value( gse.Value( cursor, 565 ));
      end if;
      if not gse.Is_Null( cursor, 566 )then
         a_adult.seincam2:= Amount'Value( gse.Value( cursor, 566 ));
      end if;
      if not gse.Is_Null( cursor, 567 )then
         a_adult.smpadj:= Amount'Value( gse.Value( cursor, 567 ));
      end if;
      if not gse.Is_Null( cursor, 568 )then
         a_adult.sppadj:= Amount'Value( gse.Value( cursor, 568 ));
      end if;
      if not gse.Is_Null( cursor, 569 )then
         a_adult.sspadj:= Amount'Value( gse.Value( cursor, 569 ));
      end if;
      if not gse.Is_Null( cursor, 570 )then
         a_adult.stshcti := gse.Integer_Value( cursor, 570 );
      end if;
      if not gse.Is_Null( cursor, 571 )then
         a_adult.taxpayer := gse.Integer_Value( cursor, 571 );
      end if;
      if not gse.Is_Null( cursor, 572 )then
         a_adult.tesscti := gse.Integer_Value( cursor, 572 );
      end if;
      if not gse.Is_Null( cursor, 573 )then
         a_adult.totgrant:= Amount'Value( gse.Value( cursor, 573 ));
      end if;
      if not gse.Is_Null( cursor, 574 )then
         a_adult.tothours:= Amount'Value( gse.Value( cursor, 574 ));
      end if;
      if not gse.Is_Null( cursor, 575 )then
         a_adult.totoccp:= Amount'Value( gse.Value( cursor, 575 ));
      end if;
      if not gse.Is_Null( cursor, 576 )then
         a_adult.typeed2 := gse.Integer_Value( cursor, 576 );
      end if;
      if not gse.Is_Null( cursor, 577 )then
         a_adult.untrcti := gse.Integer_Value( cursor, 577 );
      end if;
      if not gse.Is_Null( cursor, 578 )then
         a_adult.uperson := gse.Integer_Value( cursor, 578 );
      end if;
      if not gse.Is_Null( cursor, 579 )then
         a_adult.w45 := gse.Integer_Value( cursor, 579 );
      end if;
      if not gse.Is_Null( cursor, 580 )then
         a_adult.widoccp:= Amount'Value( gse.Value( cursor, 580 ));
      end if;
      if not gse.Is_Null( cursor, 581 )then
         a_adult.xbonflag := gse.Integer_Value( cursor, 581 );
      end if;
      if not gse.Is_Null( cursor, 582 )then
         a_adult.anxious := gse.Integer_Value( cursor, 582 );
      end if;
      if not gse.Is_Null( cursor, 583 )then
         a_adult.candgnow := gse.Integer_Value( cursor, 583 );
      end if;
      if not gse.Is_Null( cursor, 584 )then
         a_adult.curothf := gse.Integer_Value( cursor, 584 );
      end if;
      if not gse.Is_Null( cursor, 585 )then
         a_adult.curothp := gse.Integer_Value( cursor, 585 );
      end if;
      if not gse.Is_Null( cursor, 586 )then
         a_adult.curothwv := gse.Integer_Value( cursor, 586 );
      end if;
      if not gse.Is_Null( cursor, 587 )then
         a_adult.dvhiqual := gse.Integer_Value( cursor, 587 );
      end if;
      if not gse.Is_Null( cursor, 588 )then
         a_adult.gnvqnow := gse.Integer_Value( cursor, 588 );
      end if;
      if not gse.Is_Null( cursor, 589 )then
         a_adult.gpuc := gse.Integer_Value( cursor, 589 );
      end if;
      if not gse.Is_Null( cursor, 590 )then
         a_adult.happywb := gse.Integer_Value( cursor, 590 );
      end if;
      if not gse.Is_Null( cursor, 591 )then
         a_adult.hi1qual7 := gse.Integer_Value( cursor, 591 );
      end if;
      if not gse.Is_Null( cursor, 592 )then
         a_adult.hi1qual8 := gse.Integer_Value( cursor, 592 );
      end if;
      if not gse.Is_Null( cursor, 593 )then
         a_adult.mntarr5 := gse.Integer_Value( cursor, 593 );
      end if;
      if not gse.Is_Null( cursor, 594 )then
         a_adult.mntnoch1 := gse.Integer_Value( cursor, 594 );
      end if;
      if not gse.Is_Null( cursor, 595 )then
         a_adult.mntnoch2 := gse.Integer_Value( cursor, 595 );
      end if;
      if not gse.Is_Null( cursor, 596 )then
         a_adult.mntnoch3 := gse.Integer_Value( cursor, 596 );
      end if;
      if not gse.Is_Null( cursor, 597 )then
         a_adult.mntnoch4 := gse.Integer_Value( cursor, 597 );
      end if;
      if not gse.Is_Null( cursor, 598 )then
         a_adult.mntnoch5 := gse.Integer_Value( cursor, 598 );
      end if;
      if not gse.Is_Null( cursor, 599 )then
         a_adult.mntpro1 := gse.Integer_Value( cursor, 599 );
      end if;
      if not gse.Is_Null( cursor, 600 )then
         a_adult.mntpro2 := gse.Integer_Value( cursor, 600 );
      end if;
      if not gse.Is_Null( cursor, 601 )then
         a_adult.mntpro3 := gse.Integer_Value( cursor, 601 );
      end if;
      if not gse.Is_Null( cursor, 602 )then
         a_adult.mnttim1 := gse.Integer_Value( cursor, 602 );
      end if;
      if not gse.Is_Null( cursor, 603 )then
         a_adult.mnttim2 := gse.Integer_Value( cursor, 603 );
      end if;
      if not gse.Is_Null( cursor, 604 )then
         a_adult.mnttim3 := gse.Integer_Value( cursor, 604 );
      end if;
      if not gse.Is_Null( cursor, 605 )then
         a_adult.mntwrk1 := gse.Integer_Value( cursor, 605 );
      end if;
      if not gse.Is_Null( cursor, 606 )then
         a_adult.mntwrk2 := gse.Integer_Value( cursor, 606 );
      end if;
      if not gse.Is_Null( cursor, 607 )then
         a_adult.mntwrk3 := gse.Integer_Value( cursor, 607 );
      end if;
      if not gse.Is_Null( cursor, 608 )then
         a_adult.mntwrk4 := gse.Integer_Value( cursor, 608 );
      end if;
      if not gse.Is_Null( cursor, 609 )then
         a_adult.mntwrk5 := gse.Integer_Value( cursor, 609 );
      end if;
      if not gse.Is_Null( cursor, 610 )then
         a_adult.ndeplnow := gse.Integer_Value( cursor, 610 );
      end if;
      if not gse.Is_Null( cursor, 611 )then
         a_adult.oqualc1 := gse.Integer_Value( cursor, 611 );
      end if;
      if not gse.Is_Null( cursor, 612 )then
         a_adult.oqualc2 := gse.Integer_Value( cursor, 612 );
      end if;
      if not gse.Is_Null( cursor, 613 )then
         a_adult.oqualc3 := gse.Integer_Value( cursor, 613 );
      end if;
      if not gse.Is_Null( cursor, 614 )then
         a_adult.sruc := gse.Integer_Value( cursor, 614 );
      end if;
      if not gse.Is_Null( cursor, 615 )then
         a_adult.webacnow := gse.Integer_Value( cursor, 615 );
      end if;
      if not gse.Is_Null( cursor, 616 )then
         a_adult.indeth := gse.Integer_Value( cursor, 616 );
      end if;
      if not gse.Is_Null( cursor, 617 )then
         a_adult.euactive := gse.Integer_Value( cursor, 617 );
      end if;
      if not gse.Is_Null( cursor, 618 )then
         a_adult.euactno := gse.Integer_Value( cursor, 618 );
      end if;
      if not gse.Is_Null( cursor, 619 )then
         a_adult.euartact := gse.Integer_Value( cursor, 619 );
      end if;
      if not gse.Is_Null( cursor, 620 )then
         a_adult.euaskhlp := gse.Integer_Value( cursor, 620 );
      end if;
      if not gse.Is_Null( cursor, 621 )then
         a_adult.eucinema := gse.Integer_Value( cursor, 621 );
      end if;
      if not gse.Is_Null( cursor, 622 )then
         a_adult.eucultur := gse.Integer_Value( cursor, 622 );
      end if;
      if not gse.Is_Null( cursor, 623 )then
         a_adult.euinvol := gse.Integer_Value( cursor, 623 );
      end if;
      if not gse.Is_Null( cursor, 624 )then
         a_adult.eulivpe := gse.Integer_Value( cursor, 624 );
      end if;
      if not gse.Is_Null( cursor, 625 )then
         a_adult.eumtfam := gse.Integer_Value( cursor, 625 );
      end if;
      if not gse.Is_Null( cursor, 626 )then
         a_adult.eumtfrnd := gse.Integer_Value( cursor, 626 );
      end if;
      if not gse.Is_Null( cursor, 627 )then
         a_adult.eusocnet := gse.Integer_Value( cursor, 627 );
      end if;
      if not gse.Is_Null( cursor, 628 )then
         a_adult.eusport := gse.Integer_Value( cursor, 628 );
      end if;
      if not gse.Is_Null( cursor, 629 )then
         a_adult.eutkfam := gse.Integer_Value( cursor, 629 );
      end if;
      if not gse.Is_Null( cursor, 630 )then
         a_adult.eutkfrnd := gse.Integer_Value( cursor, 630 );
      end if;
      if not gse.Is_Null( cursor, 631 )then
         a_adult.eutkmat := gse.Integer_Value( cursor, 631 );
      end if;
      if not gse.Is_Null( cursor, 632 )then
         a_adult.euvol := gse.Integer_Value( cursor, 632 );
      end if;
      if not gse.Is_Null( cursor, 633 )then
         a_adult.natscot := gse.Integer_Value( cursor, 633 );
      end if;
      if not gse.Is_Null( cursor, 634 )then
         a_adult.ntsctnow := gse.Integer_Value( cursor, 634 );
      end if;
      if not gse.Is_Null( cursor, 635 )then
         a_adult.penwel1 := gse.Integer_Value( cursor, 635 );
      end if;
      if not gse.Is_Null( cursor, 636 )then
         a_adult.penwel2 := gse.Integer_Value( cursor, 636 );
      end if;
      if not gse.Is_Null( cursor, 637 )then
         a_adult.penwel3 := gse.Integer_Value( cursor, 637 );
      end if;
      if not gse.Is_Null( cursor, 638 )then
         a_adult.penwel4 := gse.Integer_Value( cursor, 638 );
      end if;
      if not gse.Is_Null( cursor, 639 )then
         a_adult.penwel5 := gse.Integer_Value( cursor, 639 );
      end if;
      if not gse.Is_Null( cursor, 640 )then
         a_adult.penwel6 := gse.Integer_Value( cursor, 640 );
      end if;
      if not gse.Is_Null( cursor, 641 )then
         a_adult.skiwknow := gse.Integer_Value( cursor, 641 );
      end if;
      if not gse.Is_Null( cursor, 642 )then
         a_adult.skiwrk := gse.Integer_Value( cursor, 642 );
      end if;
      if not gse.Is_Null( cursor, 643 )then
         a_adult.slos := gse.Integer_Value( cursor, 643 );
      end if;
      if not gse.Is_Null( cursor, 644 )then
         a_adult.yjblev := gse.Integer_Value( cursor, 644 );
      end if;
      if not gse.Is_Null( cursor, 645 )then
         a_adult.abs2no := gse.Integer_Value( cursor, 645 );
      end if;
      if not gse.Is_Null( cursor, 646 )then
         a_adult.accftpt := gse.Integer_Value( cursor, 646 );
      end if;
      if not gse.Is_Null( cursor, 647 )then
         a_adult.b2qfut1 := gse.Integer_Value( cursor, 647 );
      end if;
      if not gse.Is_Null( cursor, 648 )then
         a_adult.b2qfut2 := gse.Integer_Value( cursor, 648 );
      end if;
      if not gse.Is_Null( cursor, 649 )then
         a_adult.b2qfut3 := gse.Integer_Value( cursor, 649 );
      end if;
      if not gse.Is_Null( cursor, 650 )then
         a_adult.b3qfut1 := gse.Integer_Value( cursor, 650 );
      end if;
      if not gse.Is_Null( cursor, 651 )then
         a_adult.b3qfut2 := gse.Integer_Value( cursor, 651 );
      end if;
      if not gse.Is_Null( cursor, 652 )then
         a_adult.b3qfut3 := gse.Integer_Value( cursor, 652 );
      end if;
      if not gse.Is_Null( cursor, 653 )then
         a_adult.b3qfut4 := gse.Integer_Value( cursor, 653 );
      end if;
      if not gse.Is_Null( cursor, 654 )then
         a_adult.b3qfut5 := gse.Integer_Value( cursor, 654 );
      end if;
      if not gse.Is_Null( cursor, 655 )then
         a_adult.b3qfut6 := gse.Integer_Value( cursor, 655 );
      end if;
      if not gse.Is_Null( cursor, 656 )then
         a_adult.ben1q1 := gse.Integer_Value( cursor, 656 );
      end if;
      if not gse.Is_Null( cursor, 657 )then
         a_adult.ben1q2 := gse.Integer_Value( cursor, 657 );
      end if;
      if not gse.Is_Null( cursor, 658 )then
         a_adult.ben1q3 := gse.Integer_Value( cursor, 658 );
      end if;
      if not gse.Is_Null( cursor, 659 )then
         a_adult.ben1q4 := gse.Integer_Value( cursor, 659 );
      end if;
      if not gse.Is_Null( cursor, 660 )then
         a_adult.ben1q5 := gse.Integer_Value( cursor, 660 );
      end if;
      if not gse.Is_Null( cursor, 661 )then
         a_adult.ben1q6 := gse.Integer_Value( cursor, 661 );
      end if;
      if not gse.Is_Null( cursor, 662 )then
         a_adult.ben1q7 := gse.Integer_Value( cursor, 662 );
      end if;
      if not gse.Is_Null( cursor, 663 )then
         a_adult.ben2q1 := gse.Integer_Value( cursor, 663 );
      end if;
      if not gse.Is_Null( cursor, 664 )then
         a_adult.ben2q2 := gse.Integer_Value( cursor, 664 );
      end if;
      if not gse.Is_Null( cursor, 665 )then
         a_adult.ben2q3 := gse.Integer_Value( cursor, 665 );
      end if;
      if not gse.Is_Null( cursor, 666 )then
         a_adult.ben3q1 := gse.Integer_Value( cursor, 666 );
      end if;
      if not gse.Is_Null( cursor, 667 )then
         a_adult.ben3q2 := gse.Integer_Value( cursor, 667 );
      end if;
      if not gse.Is_Null( cursor, 668 )then
         a_adult.ben3q3 := gse.Integer_Value( cursor, 668 );
      end if;
      if not gse.Is_Null( cursor, 669 )then
         a_adult.ben3q4 := gse.Integer_Value( cursor, 669 );
      end if;
      if not gse.Is_Null( cursor, 670 )then
         a_adult.ben3q5 := gse.Integer_Value( cursor, 670 );
      end if;
      if not gse.Is_Null( cursor, 671 )then
         a_adult.ben3q6 := gse.Integer_Value( cursor, 671 );
      end if;
      if not gse.Is_Null( cursor, 672 )then
         a_adult.ben4q1 := gse.Integer_Value( cursor, 672 );
      end if;
      if not gse.Is_Null( cursor, 673 )then
         a_adult.ben4q2 := gse.Integer_Value( cursor, 673 );
      end if;
      if not gse.Is_Null( cursor, 674 )then
         a_adult.ben4q3 := gse.Integer_Value( cursor, 674 );
      end if;
      if not gse.Is_Null( cursor, 675 )then
         a_adult.ben5q1 := gse.Integer_Value( cursor, 675 );
      end if;
      if not gse.Is_Null( cursor, 676 )then
         a_adult.ben5q2 := gse.Integer_Value( cursor, 676 );
      end if;
      if not gse.Is_Null( cursor, 677 )then
         a_adult.ben5q3 := gse.Integer_Value( cursor, 677 );
      end if;
      if not gse.Is_Null( cursor, 678 )then
         a_adult.ben5q4 := gse.Integer_Value( cursor, 678 );
      end if;
      if not gse.Is_Null( cursor, 679 )then
         a_adult.ben5q5 := gse.Integer_Value( cursor, 679 );
      end if;
      if not gse.Is_Null( cursor, 680 )then
         a_adult.ben5q6 := gse.Integer_Value( cursor, 680 );
      end if;
      if not gse.Is_Null( cursor, 681 )then
         a_adult.ben7q1 := gse.Integer_Value( cursor, 681 );
      end if;
      if not gse.Is_Null( cursor, 682 )then
         a_adult.ben7q2 := gse.Integer_Value( cursor, 682 );
      end if;
      if not gse.Is_Null( cursor, 683 )then
         a_adult.ben7q3 := gse.Integer_Value( cursor, 683 );
      end if;
      if not gse.Is_Null( cursor, 684 )then
         a_adult.ben7q4 := gse.Integer_Value( cursor, 684 );
      end if;
      if not gse.Is_Null( cursor, 685 )then
         a_adult.ben7q5 := gse.Integer_Value( cursor, 685 );
      end if;
      if not gse.Is_Null( cursor, 686 )then
         a_adult.ben7q6 := gse.Integer_Value( cursor, 686 );
      end if;
      if not gse.Is_Null( cursor, 687 )then
         a_adult.ben7q7 := gse.Integer_Value( cursor, 687 );
      end if;
      if not gse.Is_Null( cursor, 688 )then
         a_adult.ben7q8 := gse.Integer_Value( cursor, 688 );
      end if;
      if not gse.Is_Null( cursor, 689 )then
         a_adult.ben7q9 := gse.Integer_Value( cursor, 689 );
      end if;
      if not gse.Is_Null( cursor, 690 )then
         a_adult.btwacc := gse.Integer_Value( cursor, 690 );
      end if;
      if not gse.Is_Null( cursor, 691 )then
         a_adult.dentist := gse.Integer_Value( cursor, 691 );
      end if;
      if not gse.Is_Null( cursor, 692 )then
         a_adult.disdif1 := gse.Integer_Value( cursor, 692 );
      end if;
      if not gse.Is_Null( cursor, 693 )then
         a_adult.disdif2 := gse.Integer_Value( cursor, 693 );
      end if;
      if not gse.Is_Null( cursor, 694 )then
         a_adult.disdif3 := gse.Integer_Value( cursor, 694 );
      end if;
      if not gse.Is_Null( cursor, 695 )then
         a_adult.disdif4 := gse.Integer_Value( cursor, 695 );
      end if;
      if not gse.Is_Null( cursor, 696 )then
         a_adult.disdif5 := gse.Integer_Value( cursor, 696 );
      end if;
      if not gse.Is_Null( cursor, 697 )then
         a_adult.disdif6 := gse.Integer_Value( cursor, 697 );
      end if;
      if not gse.Is_Null( cursor, 698 )then
         a_adult.disdif7 := gse.Integer_Value( cursor, 698 );
      end if;
      if not gse.Is_Null( cursor, 699 )then
         a_adult.disdif8 := gse.Integer_Value( cursor, 699 );
      end if;
      if not gse.Is_Null( cursor, 700 )then
         a_adult.dptcboth := gse.Integer_Value( cursor, 700 );
      end if;
      if not gse.Is_Null( cursor, 701 )then
         a_adult.dptclum := gse.Integer_Value( cursor, 701 );
      end if;
      if not gse.Is_Null( cursor, 702 )then
         a_adult.ed1borr := gse.Integer_Value( cursor, 702 );
      end if;
      if not gse.Is_Null( cursor, 703 )then
         a_adult.ed1int := gse.Integer_Value( cursor, 703 );
      end if;
      if not gse.Is_Null( cursor, 704 )then
         a_adult.ed1monyr := gse.Time_Value( cursor, 704 );
      end if;
      if not gse.Is_Null( cursor, 705 )then
         a_adult.ed2borr := gse.Integer_Value( cursor, 705 );
      end if;
      if not gse.Is_Null( cursor, 706 )then
         a_adult.ed2int := gse.Integer_Value( cursor, 706 );
      end if;
      if not gse.Is_Null( cursor, 707 )then
         a_adult.ed2monyr := gse.Time_Value( cursor, 707 );
      end if;
      if not gse.Is_Null( cursor, 708 )then
         a_adult.edattn1 := gse.Integer_Value( cursor, 708 );
      end if;
      if not gse.Is_Null( cursor, 709 )then
         a_adult.edattn2 := gse.Integer_Value( cursor, 709 );
      end if;
      if not gse.Is_Null( cursor, 710 )then
         a_adult.edattn3 := gse.Integer_Value( cursor, 710 );
      end if;
      if not gse.Is_Null( cursor, 711 )then
         a_adult.edtime := gse.Integer_Value( cursor, 711 );
      end if;
      if not gse.Is_Null( cursor, 712 )then
         a_adult.emppay1 := gse.Integer_Value( cursor, 712 );
      end if;
      if not gse.Is_Null( cursor, 713 )then
         a_adult.emppay2 := gse.Integer_Value( cursor, 713 );
      end if;
      if not gse.Is_Null( cursor, 714 )then
         a_adult.emppay3 := gse.Integer_Value( cursor, 714 );
      end if;
      if not gse.Is_Null( cursor, 715 )then
         a_adult.endyr := gse.Integer_Value( cursor, 715 );
      end if;
      if not gse.Is_Null( cursor, 716 )then
         a_adult.epcur := gse.Integer_Value( cursor, 716 );
      end if;
      if not gse.Is_Null( cursor, 717 )then
         a_adult.ethgrp := gse.Integer_Value( cursor, 717 );
      end if;
      if not gse.Is_Null( cursor, 718 )then
         a_adult.exthbct2 := gse.Integer_Value( cursor, 718 );
      end if;
      if not gse.Is_Null( cursor, 719 )then
         a_adult.exthbct3 := gse.Integer_Value( cursor, 719 );
      end if;
      if not gse.Is_Null( cursor, 720 )then
         a_adult.eyetest := gse.Integer_Value( cursor, 720 );
      end if;
      if not gse.Is_Null( cursor, 721 )then
         a_adult.follow := gse.Integer_Value( cursor, 721 );
      end if;
      if not gse.Is_Null( cursor, 722 )then
         a_adult.future := gse.Integer_Value( cursor, 722 );
      end if;
      if not gse.Is_Null( cursor, 723 )then
         a_adult.govpis := gse.Integer_Value( cursor, 723 );
      end if;
      if not gse.Is_Null( cursor, 724 )then
         a_adult.govpjsa := gse.Integer_Value( cursor, 724 );
      end if;
      if not gse.Is_Null( cursor, 725 )then
         a_adult.hbothamt:= Amount'Value( gse.Value( cursor, 725 ));
      end if;
      if not gse.Is_Null( cursor, 726 )then
         a_adult.hbothbu := gse.Integer_Value( cursor, 726 );
      end if;
      if not gse.Is_Null( cursor, 727 )then
         a_adult.hbothpd := gse.Integer_Value( cursor, 727 );
      end if;
      if not gse.Is_Null( cursor, 728 )then
         a_adult.hbothwk := gse.Integer_Value( cursor, 728 );
      end if;
      if not gse.Is_Null( cursor, 729 )then
         a_adult.hbotwait := gse.Integer_Value( cursor, 729 );
      end if;
      if not gse.Is_Null( cursor, 730 )then
         a_adult.health := gse.Integer_Value( cursor, 730 );
      end if;
      if not gse.Is_Null( cursor, 731 )then
         a_adult.hosp := gse.Integer_Value( cursor, 731 );
      end if;
      if not gse.Is_Null( cursor, 732 )then
         a_adult.hprob := gse.Integer_Value( cursor, 732 );
      end if;
      if not gse.Is_Null( cursor, 733 )then
         a_adult.isa3type := gse.Integer_Value( cursor, 733 );
      end if;
      if not gse.Is_Null( cursor, 734 )then
         a_adult.ln1rpint := gse.Integer_Value( cursor, 734 );
      end if;
      if not gse.Is_Null( cursor, 735 )then
         a_adult.ln2rpint := gse.Integer_Value( cursor, 735 );
      end if;
      if not gse.Is_Null( cursor, 736 )then
         a_adult.look := gse.Integer_Value( cursor, 736 );
      end if;
      if not gse.Is_Null( cursor, 737 )then
         a_adult.lookwk := gse.Integer_Value( cursor, 737 );
      end if;
      if not gse.Is_Null( cursor, 738 )then
         a_adult.mntct := gse.Integer_Value( cursor, 738 );
      end if;
      if not gse.Is_Null( cursor, 739 )then
         a_adult.mntfor1 := gse.Integer_Value( cursor, 739 );
      end if;
      if not gse.Is_Null( cursor, 740 )then
         a_adult.mntfor2 := gse.Integer_Value( cursor, 740 );
      end if;
      if not gse.Is_Null( cursor, 741 )then
         a_adult.mnttota1 := gse.Integer_Value( cursor, 741 );
      end if;
      if not gse.Is_Null( cursor, 742 )then
         a_adult.mnttota2 := gse.Integer_Value( cursor, 742 );
      end if;
      if not gse.Is_Null( cursor, 743 )then
         a_adult.natid1 := gse.Integer_Value( cursor, 743 );
      end if;
      if not gse.Is_Null( cursor, 744 )then
         a_adult.natid2 := gse.Integer_Value( cursor, 744 );
      end if;
      if not gse.Is_Null( cursor, 745 )then
         a_adult.natid3 := gse.Integer_Value( cursor, 745 );
      end if;
      if not gse.Is_Null( cursor, 746 )then
         a_adult.natid4 := gse.Integer_Value( cursor, 746 );
      end if;
      if not gse.Is_Null( cursor, 747 )then
         a_adult.natid5 := gse.Integer_Value( cursor, 747 );
      end if;
      if not gse.Is_Null( cursor, 748 )then
         a_adult.natid6 := gse.Integer_Value( cursor, 748 );
      end if;
      if not gse.Is_Null( cursor, 749 )then
         a_adult.ndeal := gse.Integer_Value( cursor, 749 );
      end if;
      if not gse.Is_Null( cursor, 750 )then
         a_adult.newdtype := gse.Integer_Value( cursor, 750 );
      end if;
      if not gse.Is_Null( cursor, 751 )then
         a_adult.nhs1 := gse.Integer_Value( cursor, 751 );
      end if;
      if not gse.Is_Null( cursor, 752 )then
         a_adult.nhs2 := gse.Integer_Value( cursor, 752 );
      end if;
      if not gse.Is_Null( cursor, 753 )then
         a_adult.nhs3 := gse.Integer_Value( cursor, 753 );
      end if;
      if not gse.Is_Null( cursor, 754 )then
         a_adult.niethgrp := gse.Integer_Value( cursor, 754 );
      end if;
      if not gse.Is_Null( cursor, 755 )then
         a_adult.ninatid1 := gse.Integer_Value( cursor, 755 );
      end if;
      if not gse.Is_Null( cursor, 756 )then
         a_adult.ninatid2 := gse.Integer_Value( cursor, 756 );
      end if;
      if not gse.Is_Null( cursor, 757 )then
         a_adult.ninatid3 := gse.Integer_Value( cursor, 757 );
      end if;
      if not gse.Is_Null( cursor, 758 )then
         a_adult.ninatid4 := gse.Integer_Value( cursor, 758 );
      end if;
      if not gse.Is_Null( cursor, 759 )then
         a_adult.ninatid5 := gse.Integer_Value( cursor, 759 );
      end if;
      if not gse.Is_Null( cursor, 760 )then
         a_adult.ninatid6 := gse.Integer_Value( cursor, 760 );
      end if;
      if not gse.Is_Null( cursor, 761 )then
         a_adult.ninatid7 := gse.Integer_Value( cursor, 761 );
      end if;
      if not gse.Is_Null( cursor, 762 )then
         a_adult.ninatid8 := gse.Integer_Value( cursor, 762 );
      end if;
      if not gse.Is_Null( cursor, 763 )then
         a_adult.nirel := gse.Integer_Value( cursor, 763 );
      end if;
      if not gse.Is_Null( cursor, 764 )then
         a_adult.nitrain := gse.Integer_Value( cursor, 764 );
      end if;
      if not gse.Is_Null( cursor, 765 )then
         a_adult.nlper := gse.Integer_Value( cursor, 765 );
      end if;
      if not gse.Is_Null( cursor, 766 )then
         a_adult.nolook := gse.Integer_Value( cursor, 766 );
      end if;
      if not gse.Is_Null( cursor, 767 )then
         a_adult.ntcapp := gse.Integer_Value( cursor, 767 );
      end if;
      if not gse.Is_Null( cursor, 768 )then
         a_adult.ntcdat := gse.Integer_Value( cursor, 768 );
      end if;
      if not gse.Is_Null( cursor, 769 )then
         a_adult.ntcinc:= Amount'Value( gse.Value( cursor, 769 ));
      end if;
      if not gse.Is_Null( cursor, 770 )then
         a_adult.ntcorig1 := gse.Integer_Value( cursor, 770 );
      end if;
      if not gse.Is_Null( cursor, 771 )then
         a_adult.ntcorig2 := gse.Integer_Value( cursor, 771 );
      end if;
      if not gse.Is_Null( cursor, 772 )then
         a_adult.ntcorig3 := gse.Integer_Value( cursor, 772 );
      end if;
      if not gse.Is_Null( cursor, 773 )then
         a_adult.ntcorig4 := gse.Integer_Value( cursor, 773 );
      end if;
      if not gse.Is_Null( cursor, 774 )then
         a_adult.ntcorig5 := gse.Integer_Value( cursor, 774 );
      end if;
      if not gse.Is_Null( cursor, 775 )then
         a_adult.prit := gse.Integer_Value( cursor, 775 );
      end if;
      if not gse.Is_Null( cursor, 776 )then
         a_adult.prscrpt := gse.Integer_Value( cursor, 776 );
      end if;
      if not gse.Is_Null( cursor, 777 )then
         a_adult.soc2000 := gse.Integer_Value( cursor, 777 );
      end if;
      if not gse.Is_Null( cursor, 778 )then
         a_adult.specs := gse.Integer_Value( cursor, 778 );
      end if;
      if not gse.Is_Null( cursor, 779 )then
         a_adult.startyr := gse.Integer_Value( cursor, 779 );
      end if;
      if not gse.Is_Null( cursor, 780 )then
         a_adult.taxcred1 := gse.Integer_Value( cursor, 780 );
      end if;
      if not gse.Is_Null( cursor, 781 )then
         a_adult.taxcred2 := gse.Integer_Value( cursor, 781 );
      end if;
      if not gse.Is_Null( cursor, 782 )then
         a_adult.taxcred3 := gse.Integer_Value( cursor, 782 );
      end if;
      if not gse.Is_Null( cursor, 783 )then
         a_adult.taxcred4 := gse.Integer_Value( cursor, 783 );
      end if;
      if not gse.Is_Null( cursor, 784 )then
         a_adult.taxcred5 := gse.Integer_Value( cursor, 784 );
      end if;
      if not gse.Is_Null( cursor, 785 )then
         a_adult.taxfut := gse.Integer_Value( cursor, 785 );
      end if;
      if not gse.Is_Null( cursor, 786 )then
         a_adult.train := gse.Integer_Value( cursor, 786 );
      end if;
      if not gse.Is_Null( cursor, 787 )then
         a_adult.trav := gse.Integer_Value( cursor, 787 );
      end if;
      if not gse.Is_Null( cursor, 788 )then
         a_adult.voucher := gse.Integer_Value( cursor, 788 );
      end if;
      if not gse.Is_Null( cursor, 789 )then
         a_adult.war1 := gse.Integer_Value( cursor, 789 );
      end if;
      if not gse.Is_Null( cursor, 790 )then
         a_adult.war2 := gse.Integer_Value( cursor, 790 );
      end if;
      if not gse.Is_Null( cursor, 791 )then
         a_adult.wftcboth := gse.Integer_Value( cursor, 791 );
      end if;
      if not gse.Is_Null( cursor, 792 )then
         a_adult.wftclum := gse.Integer_Value( cursor, 792 );
      end if;
      if not gse.Is_Null( cursor, 793 )then
         a_adult.whyfrde1 := gse.Integer_Value( cursor, 793 );
      end if;
      if not gse.Is_Null( cursor, 794 )then
         a_adult.whyfrde2 := gse.Integer_Value( cursor, 794 );
      end if;
      if not gse.Is_Null( cursor, 795 )then
         a_adult.whyfrde3 := gse.Integer_Value( cursor, 795 );
      end if;
      if not gse.Is_Null( cursor, 796 )then
         a_adult.whyfrde4 := gse.Integer_Value( cursor, 796 );
      end if;
      if not gse.Is_Null( cursor, 797 )then
         a_adult.whyfrde5 := gse.Integer_Value( cursor, 797 );
      end if;
      if not gse.Is_Null( cursor, 798 )then
         a_adult.whyfrde6 := gse.Integer_Value( cursor, 798 );
      end if;
      if not gse.Is_Null( cursor, 799 )then
         a_adult.whyfrey1 := gse.Integer_Value( cursor, 799 );
      end if;
      if not gse.Is_Null( cursor, 800 )then
         a_adult.whyfrey2 := gse.Integer_Value( cursor, 800 );
      end if;
      if not gse.Is_Null( cursor, 801 )then
         a_adult.whyfrey3 := gse.Integer_Value( cursor, 801 );
      end if;
      if not gse.Is_Null( cursor, 802 )then
         a_adult.whyfrey4 := gse.Integer_Value( cursor, 802 );
      end if;
      if not gse.Is_Null( cursor, 803 )then
         a_adult.whyfrey5 := gse.Integer_Value( cursor, 803 );
      end if;
      if not gse.Is_Null( cursor, 804 )then
         a_adult.whyfrey6 := gse.Integer_Value( cursor, 804 );
      end if;
      if not gse.Is_Null( cursor, 805 )then
         a_adult.whyfrpr1 := gse.Integer_Value( cursor, 805 );
      end if;
      if not gse.Is_Null( cursor, 806 )then
         a_adult.whyfrpr2 := gse.Integer_Value( cursor, 806 );
      end if;
      if not gse.Is_Null( cursor, 807 )then
         a_adult.whyfrpr3 := gse.Integer_Value( cursor, 807 );
      end if;
      if not gse.Is_Null( cursor, 808 )then
         a_adult.whyfrpr4 := gse.Integer_Value( cursor, 808 );
      end if;
      if not gse.Is_Null( cursor, 809 )then
         a_adult.whyfrpr5 := gse.Integer_Value( cursor, 809 );
      end if;
      if not gse.Is_Null( cursor, 810 )then
         a_adult.whyfrpr6 := gse.Integer_Value( cursor, 810 );
      end if;
      if not gse.Is_Null( cursor, 811 )then
         a_adult.whytrav1 := gse.Integer_Value( cursor, 811 );
      end if;
      if not gse.Is_Null( cursor, 812 )then
         a_adult.whytrav2 := gse.Integer_Value( cursor, 812 );
      end if;
      if not gse.Is_Null( cursor, 813 )then
         a_adult.whytrav3 := gse.Integer_Value( cursor, 813 );
      end if;
      if not gse.Is_Null( cursor, 814 )then
         a_adult.whytrav4 := gse.Integer_Value( cursor, 814 );
      end if;
      if not gse.Is_Null( cursor, 815 )then
         a_adult.whytrav5 := gse.Integer_Value( cursor, 815 );
      end if;
      if not gse.Is_Null( cursor, 816 )then
         a_adult.whytrav6 := gse.Integer_Value( cursor, 816 );
      end if;
      if not gse.Is_Null( cursor, 817 )then
         a_adult.wmkit := gse.Integer_Value( cursor, 817 );
      end if;
      if not gse.Is_Null( cursor, 818 )then
         a_adult.wtclum3 := gse.Integer_Value( cursor, 818 );
      end if;
      if not gse.Is_Null( cursor, 819 )then
         a_adult.addda := gse.Integer_Value( cursor, 819 );
      end if;
      if not gse.Is_Null( cursor, 820 )then
         a_adult.bntxcred:= Amount'Value( gse.Value( cursor, 820 ));
      end if;
      if not gse.Is_Null( cursor, 821 )then
         a_adult.fsbndcti := gse.Integer_Value( cursor, 821 );
      end if;
      if not gse.Is_Null( cursor, 822 )then
         a_adult.fwmlkval:= Amount'Value( gse.Value( cursor, 822 ));
      end if;
      if not gse.Is_Null( cursor, 823 )then
         a_adult.gross2 := gse.Integer_Value( cursor, 823 );
      end if;
      if not gse.Is_Null( cursor, 824 )then
         a_adult.gross3 := gse.Integer_Value( cursor, 824 );
      end if;
      if not gse.Is_Null( cursor, 825 )then
         a_adult.hbsupran:= Amount'Value( gse.Value( cursor, 825 ));
      end if;
      if not gse.Is_Null( cursor, 826 )then
         a_adult.netocpen:= Amount'Value( gse.Value( cursor, 826 ));
      end if;
      if not gse.Is_Null( cursor, 827 )then
         a_adult.nsbocti := gse.Integer_Value( cursor, 827 );
      end if;
      if not gse.Is_Null( cursor, 828 )then
         a_adult.otbscti := gse.Integer_Value( cursor, 828 );
      end if;
      if not gse.Is_Null( cursor, 829 )then
         a_adult.prbocti := gse.Integer_Value( cursor, 829 );
      end if;
      if not gse.Is_Null( cursor, 830 )then
         a_adult.sayecti := gse.Integer_Value( cursor, 830 );
      end if;
      if not gse.Is_Null( cursor, 831 )then
         a_adult.sclbcti := gse.Integer_Value( cursor, 831 );
      end if;
      if not gse.Is_Null( cursor, 832 )then
         a_adult.sscti := gse.Integer_Value( cursor, 832 );
      end if;
      if not gse.Is_Null( cursor, 833 )then
         a_adult.superan:= Amount'Value( gse.Value( cursor, 833 ));
      end if;
      if not gse.Is_Null( cursor, 834 )then
         a_adult.ttwcosts:= Amount'Value( gse.Value( cursor, 834 ));
      end if;
      if not gse.Is_Null( cursor, 835 )then
         a_adult.ben5q7 := gse.Integer_Value( cursor, 835 );
      end if;
      if not gse.Is_Null( cursor, 836 )then
         a_adult.ben5q8 := gse.Integer_Value( cursor, 836 );
      end if;
      if not gse.Is_Null( cursor, 837 )then
         a_adult.ben5q9 := gse.Integer_Value( cursor, 837 );
      end if;
      if not gse.Is_Null( cursor, 838 )then
         a_adult.ddatre := gse.Integer_Value( cursor, 838 );
      end if;
      if not gse.Is_Null( cursor, 839 )then
         a_adult.disdif9 := gse.Integer_Value( cursor, 839 );
      end if;
      if not gse.Is_Null( cursor, 840 )then
         a_adult.fare:= Amount'Value( gse.Value( cursor, 840 ));
      end if;
      if not gse.Is_Null( cursor, 841 )then
         a_adult.nittwmod := gse.Integer_Value( cursor, 841 );
      end if;
      if not gse.Is_Null( cursor, 842 )then
         a_adult.oneway := gse.Integer_Value( cursor, 842 );
      end if;
      if not gse.Is_Null( cursor, 843 )then
         a_adult.pssamt:= Amount'Value( gse.Value( cursor, 843 ));
      end if;
      if not gse.Is_Null( cursor, 844 )then
         a_adult.pssdate := gse.Integer_Value( cursor, 844 );
      end if;
      if not gse.Is_Null( cursor, 845 )then
         a_adult.ttwcode1 := gse.Integer_Value( cursor, 845 );
      end if;
      if not gse.Is_Null( cursor, 846 )then
         a_adult.ttwcode2 := gse.Integer_Value( cursor, 846 );
      end if;
      if not gse.Is_Null( cursor, 847 )then
         a_adult.ttwcode3 := gse.Integer_Value( cursor, 847 );
      end if;
      if not gse.Is_Null( cursor, 848 )then
         a_adult.ttwcost:= Amount'Value( gse.Value( cursor, 848 ));
      end if;
      if not gse.Is_Null( cursor, 849 )then
         a_adult.ttwfar := gse.Integer_Value( cursor, 849 );
      end if;
      if not gse.Is_Null( cursor, 850 )then
         a_adult.ttwfrq:= Amount'Value( gse.Value( cursor, 850 ));
      end if;
      if not gse.Is_Null( cursor, 851 )then
         a_adult.ttwmod := gse.Integer_Value( cursor, 851 );
      end if;
      if not gse.Is_Null( cursor, 852 )then
         a_adult.ttwpay := gse.Integer_Value( cursor, 852 );
      end if;
      if not gse.Is_Null( cursor, 853 )then
         a_adult.ttwpss := gse.Integer_Value( cursor, 853 );
      end if;
      if not gse.Is_Null( cursor, 854 )then
         a_adult.ttwrec:= Amount'Value( gse.Value( cursor, 854 ));
      end if;
      if not gse.Is_Null( cursor, 855 )then
         a_adult.crunaci := gse.Integer_Value( cursor, 855 );
      end if;
      if not gse.Is_Null( cursor, 856 )then
         a_adult.enomorti := gse.Integer_Value( cursor, 856 );
      end if;
      if not gse.Is_Null( cursor, 857 )then
         a_adult.ttwmode := gse.Integer_Value( cursor, 857 );
      end if;
      if not gse.Is_Null( cursor, 858 )then
         a_adult.ddatrep := gse.Integer_Value( cursor, 858 );
      end if;
      if not gse.Is_Null( cursor, 859 )then
         a_adult.disdifp := gse.Integer_Value( cursor, 859 );
      end if;
      if not gse.Is_Null( cursor, 860 )then
         a_adult.sfrpis := gse.Integer_Value( cursor, 860 );
      end if;
      if not gse.Is_Null( cursor, 861 )then
         a_adult.sfrpjsa := gse.Integer_Value( cursor, 861 );
      end if;
      if not gse.Is_Null( cursor, 862 )then
         a_adult.ethgr2 := gse.Integer_Value( cursor, 862 );
      end if;
      if not gse.Is_Null( cursor, 863 )then
         a_adult.consent := gse.Integer_Value( cursor, 863 );
      end if;
      if not gse.Is_Null( cursor, 864 )then
         a_adult.dvpens := gse.Integer_Value( cursor, 864 );
      end if;
      if not gse.Is_Null( cursor, 865 )then
         a_adult.lnkref1 := gse.Integer_Value( cursor, 865 );
      end if;
      if not gse.Is_Null( cursor, 866 )then
         a_adult.lnkref2 := gse.Integer_Value( cursor, 866 );
      end if;
      if not gse.Is_Null( cursor, 867 )then
         a_adult.lnkref21 := gse.Integer_Value( cursor, 867 );
      end if;
      if not gse.Is_Null( cursor, 868 )then
         a_adult.lnkref22 := gse.Integer_Value( cursor, 868 );
      end if;
      if not gse.Is_Null( cursor, 869 )then
         a_adult.lnkref23 := gse.Integer_Value( cursor, 869 );
      end if;
      if not gse.Is_Null( cursor, 870 )then
         a_adult.lnkref24 := gse.Integer_Value( cursor, 870 );
      end if;
      if not gse.Is_Null( cursor, 871 )then
         a_adult.lnkref25 := gse.Integer_Value( cursor, 871 );
      end if;
      if not gse.Is_Null( cursor, 872 )then
         a_adult.lnkref3 := gse.Integer_Value( cursor, 872 );
      end if;
      if not gse.Is_Null( cursor, 873 )then
         a_adult.lnkref4 := gse.Integer_Value( cursor, 873 );
      end if;
      if not gse.Is_Null( cursor, 874 )then
         a_adult.lnkref5 := gse.Integer_Value( cursor, 874 );
      end if;
      if not gse.Is_Null( cursor, 875 )then
         a_adult.pconsent := gse.Integer_Value( cursor, 875 );
      end if;
      if not gse.Is_Null( cursor, 876 )then
         a_adult.lnkons := gse.Integer_Value( cursor, 876 );
      end if;
      if not gse.Is_Null( cursor, 877 )then
         a_adult.lnkref6 := gse.Integer_Value( cursor, 877 );
      end if;
      if not gse.Is_Null( cursor, 878 )then
         a_adult.lnkref7 := gse.Integer_Value( cursor, 878 );
      end if;
      if not gse.Is_Null( cursor, 879 )then
         a_adult.lnkref8 := gse.Integer_Value( cursor, 879 );
      end if;
      if not gse.Is_Null( cursor, 880 )then
         a_adult.lnkref9 := gse.Integer_Value( cursor, 880 );
      end if;
      if not gse.Is_Null( cursor, 881 )then
         a_adult.b3qfut7 := gse.Integer_Value( cursor, 881 );
      end if;
      if not gse.Is_Null( cursor, 882 )then
         a_adult.ben3q7 := gse.Integer_Value( cursor, 882 );
      end if;
      if not gse.Is_Null( cursor, 883 )then
         a_adult.ddaprog := gse.Integer_Value( cursor, 883 );
      end if;
      if not gse.Is_Null( cursor, 884 )then
         a_adult.hbolng := gse.Integer_Value( cursor, 884 );
      end if;
      if not gse.Is_Null( cursor, 885 )then
         a_adult.hi2qual := gse.Integer_Value( cursor, 885 );
      end if;
      if not gse.Is_Null( cursor, 886 )then
         a_adult.hlpgvn01 := gse.Integer_Value( cursor, 886 );
      end if;
      if not gse.Is_Null( cursor, 887 )then
         a_adult.hlpgvn02 := gse.Integer_Value( cursor, 887 );
      end if;
      if not gse.Is_Null( cursor, 888 )then
         a_adult.hlpgvn03 := gse.Integer_Value( cursor, 888 );
      end if;
      if not gse.Is_Null( cursor, 889 )then
         a_adult.hlpgvn04 := gse.Integer_Value( cursor, 889 );
      end if;
      if not gse.Is_Null( cursor, 890 )then
         a_adult.hlpgvn05 := gse.Integer_Value( cursor, 890 );
      end if;
      if not gse.Is_Null( cursor, 891 )then
         a_adult.hlpgvn06 := gse.Integer_Value( cursor, 891 );
      end if;
      if not gse.Is_Null( cursor, 892 )then
         a_adult.hlpgvn07 := gse.Integer_Value( cursor, 892 );
      end if;
      if not gse.Is_Null( cursor, 893 )then
         a_adult.hlpgvn08 := gse.Integer_Value( cursor, 893 );
      end if;
      if not gse.Is_Null( cursor, 894 )then
         a_adult.hlpgvn09 := gse.Integer_Value( cursor, 894 );
      end if;
      if not gse.Is_Null( cursor, 895 )then
         a_adult.hlpgvn10 := gse.Integer_Value( cursor, 895 );
      end if;
      if not gse.Is_Null( cursor, 896 )then
         a_adult.hlpgvn11 := gse.Integer_Value( cursor, 896 );
      end if;
      if not gse.Is_Null( cursor, 897 )then
         a_adult.hlprec01 := gse.Integer_Value( cursor, 897 );
      end if;
      if not gse.Is_Null( cursor, 898 )then
         a_adult.hlprec02 := gse.Integer_Value( cursor, 898 );
      end if;
      if not gse.Is_Null( cursor, 899 )then
         a_adult.hlprec03 := gse.Integer_Value( cursor, 899 );
      end if;
      if not gse.Is_Null( cursor, 900 )then
         a_adult.hlprec04 := gse.Integer_Value( cursor, 900 );
      end if;
      if not gse.Is_Null( cursor, 901 )then
         a_adult.hlprec05 := gse.Integer_Value( cursor, 901 );
      end if;
      if not gse.Is_Null( cursor, 902 )then
         a_adult.hlprec06 := gse.Integer_Value( cursor, 902 );
      end if;
      if not gse.Is_Null( cursor, 903 )then
         a_adult.hlprec07 := gse.Integer_Value( cursor, 903 );
      end if;
      if not gse.Is_Null( cursor, 904 )then
         a_adult.hlprec08 := gse.Integer_Value( cursor, 904 );
      end if;
      if not gse.Is_Null( cursor, 905 )then
         a_adult.hlprec09 := gse.Integer_Value( cursor, 905 );
      end if;
      if not gse.Is_Null( cursor, 906 )then
         a_adult.hlprec10 := gse.Integer_Value( cursor, 906 );
      end if;
      if not gse.Is_Null( cursor, 907 )then
         a_adult.hlprec11 := gse.Integer_Value( cursor, 907 );
      end if;
      if not gse.Is_Null( cursor, 908 )then
         a_adult.loangvn1 := gse.Integer_Value( cursor, 908 );
      end if;
      if not gse.Is_Null( cursor, 909 )then
         a_adult.loangvn2 := gse.Integer_Value( cursor, 909 );
      end if;
      if not gse.Is_Null( cursor, 910 )then
         a_adult.loangvn3 := gse.Integer_Value( cursor, 910 );
      end if;
      if not gse.Is_Null( cursor, 911 )then
         a_adult.loanrec1 := gse.Integer_Value( cursor, 911 );
      end if;
      if not gse.Is_Null( cursor, 912 )then
         a_adult.loanrec2 := gse.Integer_Value( cursor, 912 );
      end if;
      if not gse.Is_Null( cursor, 913 )then
         a_adult.loanrec3 := gse.Integer_Value( cursor, 913 );
      end if;
      if not gse.Is_Null( cursor, 914 )then
         a_adult.alg := gse.Integer_Value( cursor, 914 );
      end if;
      if not gse.Is_Null( cursor, 915 )then
         a_adult.algamt:= Amount'Value( gse.Value( cursor, 915 ));
      end if;
      if not gse.Is_Null( cursor, 916 )then
         a_adult.algpd := gse.Integer_Value( cursor, 916 );
      end if;
      if not gse.Is_Null( cursor, 917 )then
         a_adult.ben4q4 := gse.Integer_Value( cursor, 917 );
      end if;
      if not gse.Is_Null( cursor, 918 )then
         a_adult.disdifad := gse.Integer_Value( cursor, 918 );
      end if;
      if not gse.Is_Null( cursor, 919 )then
         a_adult.gross3_x := gse.Integer_Value( cursor, 919 );
      end if;
      if not gse.Is_Null( cursor, 920 )then
         a_adult.cbaamt := gse.Integer_Value( cursor, 920 );
      end if;
      if not gse.Is_Null( cursor, 921 )then
         a_adult.mednum := gse.Integer_Value( cursor, 921 );
      end if;
      if not gse.Is_Null( cursor, 922 )then
         a_adult.medprpd := gse.Integer_Value( cursor, 922 );
      end if;
      if not gse.Is_Null( cursor, 923 )then
         a_adult.medprpy := gse.Integer_Value( cursor, 923 );
      end if;
      if not gse.Is_Null( cursor, 924 )then
         a_adult.medpay := gse.Integer_Value( cursor, 924 );
      end if;
      if not gse.Is_Null( cursor, 925 )then
         a_adult.medrep := gse.Integer_Value( cursor, 925 );
      end if;
      if not gse.Is_Null( cursor, 926 )then
         a_adult.medrpnm := gse.Integer_Value( cursor, 926 );
      end if;
      return a_adult;
   end Map_From_Cursor;
   ...
   begin
      ...
      params( 2 ) := "+"( Integer'Pos( a_adult.abspar ));
      params( 3 ) := "+"( Integer'Pos( a_adult.abspay ));
      params( 4 ) := "+"( Integer'Pos( a_adult.abswhy ));
      params( 5 ) := "+"( Integer'Pos( a_adult.abswk ));
      params( 6 ) := "+"( Integer'Pos( a_adult.x_access ));
      params( 7 ) := "+"( Integer'Pos( a_adult.accjb ));
      params( 8 ) := "+"( Integer'Pos( a_adult.accmsat ));
      params( 9 ) := "+"( Integer'Pos( a_adult.accountq ));
      ...
      params( 17 ) := "+"( Integer'Pos( a_adult.agehqual ));
      params( 18 ) := "+"( Float( a_adult.aliamt ));
      params( 19 ) := "+"( Integer'Pos( a_adult.alimny ));
      params( 20 ) := "+"( Integer'Pos( a_adult.alipd ));
      params( 21 ) := "+"( Integer'Pos( a_adult.alius ));
      params( 22 ) := "+"( Integer'Pos( a_adult.allow1 ));
      params( 23 ) := "+"( Integer'Pos( a_adult.allow2 ));
      params( 24 ) := "+"( Integer'Pos( a_adult.allow3 ));
      params( 25 ) := "+"( Integer'Pos( a_adult.allow4 ));
      params( 26 ) := "+"( Float( a_adult.allpay1 ));
      params( 27 ) := "+"( Float( a_adult.allpay2 ));
      params( 28 ) := "+"( Float( a_adult.allpay3 ));
      params( 29 ) := "+"( Float( a_adult.allpay4 ));
      params( 30 ) := "+"( Integer'Pos( a_adult.allpd1 ));
      params( 31 ) := "+"( Integer'Pos( a_adult.allpd2 ));
      params( 32 ) := "+"( Integer'Pos( a_adult.allpd3 ));
      params( 33 ) := "+"( Integer'Pos( a_adult.allpd4 ));
      params( 34 ) := "+"( Float( a_adult.aluamt ));
      params( 35 ) := "+"( Integer'Pos( a_adult.alupd ));
      params( 36 ) := "+"( Integer'Pos( a_adult.anyacc ));
      params( 37 ) := "+"( Integer'Pos( a_adult.anyed ));
      params( 38 ) := "+"( Integer'Pos( a_adult.anymon ));
      params( 39 ) := "+"( Integer'Pos( a_adult.anypen1 ));
      params( 40 ) := "+"( Integer'Pos( a_adult.anypen2 ));
      params( 41 ) := "+"( Integer'Pos( a_adult.anypen3 ));
      params( 42 ) := "+"( Integer'Pos( a_adult.anypen4 ));
      params( 43 ) := "+"( Integer'Pos( a_adult.anypen5 ));
      params( 44 ) := "+"( Integer'Pos( a_adult.anypen6 ));
      params( 45 ) := "+"( Integer'Pos( a_adult.anypen7 ));
      params( 46 ) := "+"( Float( a_adult.apamt ));
      params( 47 ) := "+"( Float( a_adult.apdamt ));
      params( 48 ) := "+"( Integer'Pos( a_adult.apdir ));
      params( 49 ) := "+"( Integer'Pos( a_adult.apdpd ));
      params( 50 ) := "+"( Integer'Pos( a_adult.appd ));
      params( 51 ) := "+"( Integer'Pos( a_adult.bfd ));
      params( 52 ) := "+"( Float( a_adult.bfdamt ));
      params( 53 ) := "+"( Integer'Pos( a_adult.bfdpd ));
      params( 54 ) := "+"( Integer'Pos( a_adult.bfdval ));
      params( 55 ) := "+"( Integer'Pos( a_adult.btec ));
      params( 56 ) := "+"( Integer'Pos( a_adult.btecnow ));
      params( 57 ) := "+"( Integer'Pos( a_adult.c2orign ));
      params( 58 ) := "+"( Integer'Pos( a_adult.calm ));
      params( 59 ) := "+"( Integer'Pos( a_adult.camemt ));
      params( 60 ) := "+"( Integer'Pos( a_adult.cameyr ));
      params( 61 ) := "+"( Integer'Pos( a_adult.cameyr2 ));
      params( 62 ) := "+"( Integer'Pos( a_adult.cbaamt2 ));
      params( 63 ) := "+"( Integer'Pos( a_adult.cbchk ));
      params( 64 ) := "+"( Integer'Pos( a_adult.change ));
      params( 65 ) := "+"( Integer'Pos( a_adult.chkctc ));
      params( 66 ) := "+"( Integer'Pos( a_adult.chkdpco1 ));
      params( 67 ) := "+"( Integer'Pos( a_adult.chkdpco2 ));
      params( 68 ) := "+"( Integer'Pos( a_adult.chkdpco3 ));
      params( 69 ) := "+"( Integer'Pos( a_adult.chkdpn ));
      params( 70 ) := "+"( Integer'Pos( a_adult.chkdsco1 ));
      params( 71 ) := "+"( Integer'Pos( a_adult.chkdsco2 ));
      params( 72 ) := "+"( Integer'Pos( a_adult.chkdsco3 ));
      params( 73 ) := "+"( Integer'Pos( a_adult.chknop ));
      params( 74 ) := "+"( Integer'Pos( a_adult.citizen ));
      params( 75 ) := "+"( Integer'Pos( a_adult.citizen2 ));
      params( 76 ) := "+"( Integer'Pos( a_adult.claifut1 ));
      params( 77 ) := "+"( Integer'Pos( a_adult.claifut2 ));
      params( 78 ) := "+"( Integer'Pos( a_adult.claifut3 ));
      params( 79 ) := "+"( Integer'Pos( a_adult.claifut4 ));
      params( 80 ) := "+"( Integer'Pos( a_adult.claifut5 ));
      params( 81 ) := "+"( Integer'Pos( a_adult.claifut6 ));
      params( 82 ) := "+"( Integer'Pos( a_adult.claifut7 ));
      params( 83 ) := "+"( Integer'Pos( a_adult.claifut8 ));
      params( 84 ) := "+"( Integer'Pos( a_adult.claimant ));
      params( 85 ) := "+"( Integer'Pos( a_adult.cohabit ));
      params( 86 ) := "+"( Integer'Pos( a_adult.combid ));
      params( 87 ) := "+"( Integer'Pos( a_adult.commusat ));
      params( 88 ) := "+"( Integer'Pos( a_adult.condit ));
      params( 89 ) := "+"( Integer'Pos( a_adult.contuk ));
      params( 90 ) := "+"( Integer'Pos( a_adult.convbl ));
      params( 91 ) := "+"( Integer'Pos( a_adult.coptrust ));
      params( 92 ) := "+"( Integer'Pos( a_adult.corign ));
      params( 93 ) := "+"( Integer'Pos( a_adult.corigoth ));
      params( 94 ) := "+"( Integer'Pos( a_adult.ctclum1 ));
      params( 95 ) := "+"( Integer'Pos( a_adult.ctclum2 ));
      params( 96 ) := "+"( Integer'Pos( a_adult.cupchk ));
      params( 97 ) := "+"( Integer'Pos( a_adult.curqual ));
      params( 98 ) := "+"( Integer'Pos( a_adult.cvht ));
      params( 99 ) := "+"( Float( a_adult.cvpay ));
      params( 100 ) := "+"( Integer'Pos( a_adult.cvpd ));
      params( 101 ) := "+"( Integer'Pos( a_adult.ddaprog1 ));
      params( 102 ) := "+"( Integer'Pos( a_adult.ddatre1 ));
      params( 103 ) := "+"( Integer'Pos( a_adult.ddatrep1 ));
      params( 104 ) := "+"( Integer'Pos( a_adult.defrpen ));
      params( 105 ) := "+"( Integer'Pos( a_adult.degree ));
      params( 106 ) := "+"( Integer'Pos( a_adult.degrenow ));
      params( 107 ) := "+"( Integer'Pos( a_adult.denrec ));
      params( 108 ) := "+"( Integer'Pos( a_adult.depend ));
      params( 109 ) := "+"( Integer'Pos( a_adult.depress ));
      params( 110 ) := "+"( Integer'Pos( a_adult.disben1 ));
      params( 111 ) := "+"( Integer'Pos( a_adult.disben2 ));
      params( 112 ) := "+"( Integer'Pos( a_adult.disben3 ));
      params( 113 ) := "+"( Integer'Pos( a_adult.disben4 ));
      params( 114 ) := "+"( Integer'Pos( a_adult.disben5 ));
      params( 115 ) := "+"( Integer'Pos( a_adult.disben6 ));
      params( 116 ) := "+"( Integer'Pos( a_adult.discuss ));
      params( 117 ) := "+"( Integer'Pos( a_adult.disd01 ));
      params( 118 ) := "+"( Integer'Pos( a_adult.disd02 ));
      params( 119 ) := "+"( Integer'Pos( a_adult.disd03 ));
      params( 120 ) := "+"( Integer'Pos( a_adult.disd04 ));
      params( 121 ) := "+"( Integer'Pos( a_adult.disd05 ));
      params( 122 ) := "+"( Integer'Pos( a_adult.disd06 ));
      params( 123 ) := "+"( Integer'Pos( a_adult.disd07 ));
      params( 124 ) := "+"( Integer'Pos( a_adult.disd08 ));
      params( 125 ) := "+"( Integer'Pos( a_adult.disd09 ));
      params( 126 ) := "+"( Integer'Pos( a_adult.disd10 ));
      params( 127 ) := "+"( Integer'Pos( a_adult.disdifp1 ));
      params( 128 ) := "+"( Integer'Pos( a_adult.dla1 ));
      params( 129 ) := "+"( Integer'Pos( a_adult.dla2 ));
      params( 130 ) := "+"( Integer'Pos( a_adult.dls ));
      params( 131 ) := "+"( Float( a_adult.dlsamt ));
      params( 132 ) := "+"( Integer'Pos( a_adult.dlspd ));
      params( 133 ) := "+"( Integer'Pos( a_adult.dlsval ));
      params( 134 ) := "+"( a_adult.dob );
      params( 135 ) := "+"( Integer'Pos( a_adult.down ));
      params( 136 ) := "+"( Integer'Pos( a_adult.dv09pens ));
      params( 137 ) := "+"( Integer'Pos( a_adult.dvil03a ));
      params( 138 ) := "+"( Integer'Pos( a_adult.dvil04a ));
      params( 139 ) := "+"( Integer'Pos( a_adult.dvjb12ml ));
      params( 140 ) := "+"( Integer'Pos( a_adult.dvmardf ));
      params( 141 ) := "+"( Float( a_adult.ed1amt ));
      params( 142 ) := "+"( Integer'Pos( a_adult.ed1pd ));
      params( 143 ) := "+"( Integer'Pos( a_adult.ed1sum ));
      params( 144 ) := "+"( Float( a_adult.ed2amt ));
      params( 145 ) := "+"( Integer'Pos( a_adult.ed2pd ));
      params( 146 ) := "+"( Integer'Pos( a_adult.ed2sum ));
      params( 147 ) := "+"( Integer'Pos( a_adult.edatt ));
      params( 148 ) := "+"( Integer'Pos( a_adult.edhr ));
      params( 149 ) := "+"( Integer'Pos( a_adult.edtyp ));
      params( 150 ) := "+"( Integer'Pos( a_adult.eligadlt ));
      params( 151 ) := "+"( Integer'Pos( a_adult.eligchld ));
      params( 152 ) := "+"( Integer'Pos( a_adult.eligschm ));
      params( 153 ) := "+"( Integer'Pos( a_adult.emparr ));
      params( 154 ) := "+"( Integer'Pos( a_adult.empcontr ));
      params( 155 ) := "+"( Integer'Pos( a_adult.emppen ));
      params( 156 ) := "+"( Integer'Pos( a_adult.empschm ));
      params( 157 ) := "+"( Integer'Pos( a_adult.empstat ));
      params( 158 ) := "+"( Integer'Pos( a_adult.envirsat ));
      params( 159 ) := "+"( Integer'Pos( a_adult.es2000 ));
      params( 160 ) := "+"( Integer'Pos( a_adult.ethgrps ));
      params( 161 ) := "+"( Integer'Pos( a_adult.etngrp ));
      params( 162 ) := "+"( Float( a_adult.eualiamt ));
      params( 163 ) := "+"( Integer'Pos( a_adult.eualimny ));
      params( 164 ) := "+"( Integer'Pos( a_adult.eualipd ));
      params( 165 ) := "+"( Integer'Pos( a_adult.euetype ));
      params( 166 ) := "+"( Integer'Pos( a_adult.everwrk ));
      params( 167 ) := "+"( Integer'Pos( a_adult.exthbct1 ));
      params( 168 ) := "+"( Integer'Pos( a_adult.followsc ));
      params( 169 ) := "+"( Integer'Pos( a_adult.followup ));
      params( 170 ) := "+"( Integer'Pos( a_adult.fted ));
      params( 171 ) := "+"( Integer'Pos( a_adult.ftwk ));
      params( 172 ) := "+"( Integer'Pos( a_adult.gpispc ));
      params( 173 ) := "+"( Integer'Pos( a_adult.gpjsaesa ));
      params( 174 ) := "+"( Integer'Pos( a_adult.x_grant ));
      params( 175 ) := "+"( Float( a_adult.grtamt1 ));
      params( 176 ) := "+"( Float( a_adult.grtamt2 ));
      params( 177 ) := "+"( Float( a_adult.grtdir1 ));
      params( 178 ) := "+"( Float( a_adult.grtdir2 ));
      params( 179 ) := "+"( Integer'Pos( a_adult.grtnum ));
      params( 180 ) := "+"( Integer'Pos( a_adult.grtsce1 ));
      params( 181 ) := "+"( Integer'Pos( a_adult.grtsce2 ));
      params( 182 ) := "+"( Float( a_adult.grtval1 ));
      params( 183 ) := "+"( Float( a_adult.grtval2 ));
      params( 184 ) := "+"( Integer'Pos( a_adult.gta ));
      params( 185 ) := "+"( Integer'Pos( a_adult.happy ));
      params( 186 ) := "+"( Integer'Pos( a_adult.health1 ));
      params( 187 ) := "+"( Integer'Pos( a_adult.heathad ));
      params( 188 ) := "+"( Integer'Pos( a_adult.help ));
      params( 189 ) := "+"( Integer'Pos( a_adult.hholder ));
      params( 190 ) := "+"( Integer'Pos( a_adult.hi1qual1 ));
      params( 191 ) := "+"( Integer'Pos( a_adult.hi1qual2 ));
      params( 192 ) := "+"( Integer'Pos( a_adult.hi1qual3 ));
      params( 193 ) := "+"( Integer'Pos( a_adult.hi1qual4 ));
      params( 194 ) := "+"( Integer'Pos( a_adult.hi1qual5 ));
      params( 195 ) := "+"( Integer'Pos( a_adult.hi1qual6 ));
      params( 196 ) := "+"( Integer'Pos( a_adult.hi3qual ));
      params( 197 ) := "+"( Integer'Pos( a_adult.higho ));
      params( 198 ) := "+"( Integer'Pos( a_adult.highonow ));
      params( 199 ) := "+"( Integer'Pos( a_adult.hrpid ));
      params( 200 ) := "+"( Integer'Pos( a_adult.hsvper ));
      params( 201 ) := "+"( Integer'Pos( a_adult.iclaim1 ));
      params( 202 ) := "+"( Integer'Pos( a_adult.iclaim2 ));
      params( 203 ) := "+"( Integer'Pos( a_adult.iclaim3 ));
      params( 204 ) := "+"( Integer'Pos( a_adult.iclaim4 ));
      params( 205 ) := "+"( Integer'Pos( a_adult.iclaim5 ));
      params( 206 ) := "+"( Integer'Pos( a_adult.iclaim6 ));
      params( 207 ) := "+"( Integer'Pos( a_adult.iclaim7 ));
      params( 208 ) := "+"( Integer'Pos( a_adult.iclaim8 ));
      params( 209 ) := "+"( Integer'Pos( a_adult.iclaim9 ));
      params( 210 ) := "+"( Integer'Pos( a_adult.incdur ));
      params( 211 ) := "+"( Integer'Pos( a_adult.injlong ));
      params( 212 ) := "+"( Integer'Pos( a_adult.injwk ));
      params( 213 ) := "+"( Integer'Pos( a_adult.invests ));
      params( 214 ) := "+"( Integer'Pos( a_adult.iout ));
      params( 215 ) := "+"( Integer'Pos( a_adult.isa1type ));
      params( 216 ) := "+"( Integer'Pos( a_adult.isa2type ));
      params( 217 ) := "+"( Integer'Pos( a_adult.issue ));
      params( 218 ) := "+"( Integer'Pos( a_adult.jobaway ));
      params( 219 ) := "+"( Integer'Pos( a_adult.jobbyr ));
      params( 220 ) := "+"( Integer'Pos( a_adult.jobsat ));
      params( 221 ) := "+"( Integer'Pos( a_adult.kidben1 ));
      params( 222 ) := "+"( Integer'Pos( a_adult.kidben2 ));
      params( 223 ) := "+"( Integer'Pos( a_adult.kidben3 ));
      params( 224 ) := "+"( Integer'Pos( a_adult.lareg ));
      params( 225 ) := "+"( Integer'Pos( a_adult.legltrus ));
      params( 226 ) := "+"( Integer'Pos( a_adult.lifesat ));
      params( 227 ) := "+"( Integer'Pos( a_adult.likewk ));
      params( 228 ) := "+"( Integer'Pos( a_adult.limitl ));
      params( 229 ) := "+"( Integer'Pos( a_adult.lktime ));
      params( 230 ) := "+"( Integer'Pos( a_adult.lktrain ));
      params( 231 ) := "+"( Integer'Pos( a_adult.lkwork ));
      params( 232 ) := "+"( Integer'Pos( a_adult.lnkdwp ));
      params( 233 ) := "+"( Integer'Pos( a_adult.lnkref01 ));
      params( 234 ) := "+"( Integer'Pos( a_adult.lnkref02 ));
      params( 235 ) := "+"( Integer'Pos( a_adult.lnkref03 ));
      params( 236 ) := "+"( Integer'Pos( a_adult.lnkref04 ));
      params( 237 ) := "+"( Integer'Pos( a_adult.lnkref05 ));
      params( 238 ) := "+"( Integer'Pos( a_adult.lnkref06 ));
      params( 239 ) := "+"( Integer'Pos( a_adult.lnkref07 ));
      params( 240 ) := "+"( Integer'Pos( a_adult.lnkref08 ));
      params( 241 ) := "+"( Integer'Pos( a_adult.lnkref09 ));
      params( 242 ) := "+"( Integer'Pos( a_adult.lnkref10 ));
      params( 243 ) := "+"( Integer'Pos( a_adult.lnkref11 ));
      params( 244 ) := "+"( Integer'Pos( a_adult.loan ));
      params( 245 ) := "+"( Integer'Pos( a_adult.loannum ));
      params( 246 ) := "+"( Integer'Pos( a_adult.lstwrk1 ));
      params( 247 ) := "+"( Integer'Pos( a_adult.lstwrk2 ));
      params( 248 ) := "+"( Integer'Pos( a_adult.lstyr ));
      params( 249 ) := "+"( Integer'Pos( a_adult.meaning ));
      params( 250 ) := "+"( Integer'Pos( a_adult.medrec ));
      params( 251 ) := "+"( Integer'Pos( a_adult.memschm ));
      params( 252 ) := "+"( Float( a_adult.mntamt1 ));
      params( 253 ) := "+"( Float( a_adult.mntamt2 ));
      params( 254 ) := "+"( Integer'Pos( a_adult.mntarr1 ));
      params( 255 ) := "+"( Integer'Pos( a_adult.mntarr2 ));
      params( 256 ) := "+"( Integer'Pos( a_adult.mntarr3 ));
      params( 257 ) := "+"( Integer'Pos( a_adult.mntarr4 ));
      params( 258 ) := "+"( Integer'Pos( a_adult.mntgov1 ));
      params( 259 ) := "+"( Integer'Pos( a_adult.mntgov2 ));
      params( 260 ) := "+"( Integer'Pos( a_adult.mntnrp ));
      params( 261 ) := "+"( Integer'Pos( a_adult.mntpay ));
      params( 262 ) := "+"( Integer'Pos( a_adult.mntpd1 ));
      params( 263 ) := "+"( Integer'Pos( a_adult.mntpd2 ));
      params( 264 ) := "+"( Integer'Pos( a_adult.mntrec ));
      params( 265 ) := "+"( Integer'Pos( a_adult.mntus1 ));
      params( 266 ) := "+"( Integer'Pos( a_adult.mntus2 ));
      params( 267 ) := "+"( Float( a_adult.mntusam1 ));
      params( 268 ) := "+"( Float( a_adult.mntusam2 ));
      params( 269 ) := "+"( Integer'Pos( a_adult.mntuspd1 ));
      params( 270 ) := "+"( Integer'Pos( a_adult.mntuspd2 ));
      params( 271 ) := "+"( Integer'Pos( a_adult.moneysat ));
      params( 272 ) := "+"( Integer'Pos( a_adult.ms ));
      params( 273 ) := "+"( Integer'Pos( a_adult.nanid1 ));
      params( 274 ) := "+"( Integer'Pos( a_adult.nanid2 ));
      params( 275 ) := "+"( Integer'Pos( a_adult.nanid3 ));
      params( 276 ) := "+"( Integer'Pos( a_adult.nanid4 ));
      params( 277 ) := "+"( Integer'Pos( a_adult.nanid5 ));
      params( 278 ) := "+"( Integer'Pos( a_adult.nanid6 ));
      params( 279 ) := "+"( Integer'Pos( a_adult.nervous ));
      params( 280 ) := "+"( Integer'Pos( a_adult.ni2train ));
      params( 281 ) := "+"( Float( a_adult.niamt ));
      params( 282 ) := "+"( Integer'Pos( a_adult.nietngrp ));
      params( 283 ) := "+"( Integer'Pos( a_adult.niexthbb ));
      params( 284 ) := "+"( Integer'Pos( a_adult.ninanid1 ));
      params( 285 ) := "+"( Integer'Pos( a_adult.ninanid2 ));
      params( 286 ) := "+"( Integer'Pos( a_adult.ninanid3 ));
      params( 287 ) := "+"( Integer'Pos( a_adult.ninanid4 ));
      params( 288 ) := "+"( Integer'Pos( a_adult.ninanid5 ));
      params( 289 ) := "+"( Integer'Pos( a_adult.ninanid6 ));
      params( 290 ) := "+"( Integer'Pos( a_adult.ninanid7 ));
      params( 291 ) := "+"( Integer'Pos( a_adult.nipd ));
      params( 292 ) := "+"( Integer'Pos( a_adult.nireg ));
      params( 293 ) := "+"( Integer'Pos( a_adult.nirelig ));
      params( 294 ) := "+"( Integer'Pos( a_adult.nolk1 ));
      params( 295 ) := "+"( Integer'Pos( a_adult.nolk2 ));
      params( 296 ) := "+"( Integer'Pos( a_adult.nolk3 ));
      params( 297 ) := "+"( Integer'Pos( a_adult.nowant ));
      params( 298 ) := "+"( Float( a_adult.nssec ));
      params( 299 ) := "+"( Integer'Pos( a_adult.numjob ));
      params( 300 ) := "+"( Integer'Pos( a_adult.numjob2 ));
      params( 301 ) := "+"( Integer'Pos( a_adult.nvqlenow ));
      params( 302 ) := "+"( Integer'Pos( a_adult.nvqlev ));
      params( 303 ) := "+"( Integer'Pos( a_adult.oddjob ));
      params( 304 ) := "+"( Integer'Pos( a_adult.oldstud ));
      params( 305 ) := "+"( Integer'Pos( a_adult.otabspar ));
      params( 306 ) := "+"( Float( a_adult.otamt ));
      params( 307 ) := "+"( Float( a_adult.otapamt ));
      params( 308 ) := "+"( Integer'Pos( a_adult.otappd ));
      params( 309 ) := "+"( Integer'Pos( a_adult.othben1 ));
      params( 310 ) := "+"( Integer'Pos( a_adult.othben2 ));
      params( 311 ) := "+"( Integer'Pos( a_adult.othben3 ));
      params( 312 ) := "+"( Integer'Pos( a_adult.othben4 ));
      params( 313 ) := "+"( Integer'Pos( a_adult.othben5 ));
      params( 314 ) := "+"( Integer'Pos( a_adult.othben6 ));
      params( 315 ) := "+"( Integer'Pos( a_adult.othpass ));
      params( 316 ) := "+"( Integer'Pos( a_adult.othqual1 ));
      params( 317 ) := "+"( Integer'Pos( a_adult.othqual2 ));
      params( 318 ) := "+"( Integer'Pos( a_adult.othqual3 ));
      params( 319 ) := "+"( Integer'Pos( a_adult.othtax ));
      params( 320 ) := "+"( Integer'Pos( a_adult.othtrust ));
      params( 321 ) := "+"( Integer'Pos( a_adult.otinva ));
      params( 322 ) := "+"( Float( a_adult.pareamt ));
      params( 323 ) := "+"( Integer'Pos( a_adult.parepd ));
      params( 324 ) := "+"( Integer'Pos( a_adult.penben1 ));
      params( 325 ) := "+"( Integer'Pos( a_adult.penben2 ));
      params( 326 ) := "+"( Integer'Pos( a_adult.penben3 ));
      params( 327 ) := "+"( Integer'Pos( a_adult.penben4 ));
      params( 328 ) := "+"( Integer'Pos( a_adult.penben5 ));
      params( 329 ) := "+"( Integer'Pos( a_adult.penflag ));
      params( 330 ) := "+"( Integer'Pos( a_adult.penlump ));
      params( 331 ) := "+"( Integer'Pos( a_adult.perspen1 ));
      params( 332 ) := "+"( Integer'Pos( a_adult.perspen2 ));
      params( 333 ) := "+"( Integer'Pos( a_adult.pip1 ));
      params( 334 ) := "+"( Integer'Pos( a_adult.pip2 ));
      params( 335 ) := "+"( Integer'Pos( a_adult.pollopin ));
      params( 336 ) := "+"( Integer'Pos( a_adult.polttrus ));
      params( 337 ) := "+"( Integer'Pos( a_adult.ppchk1 ));
      params( 338 ) := "+"( Integer'Pos( a_adult.ppchk2 ));
      params( 339 ) := "+"( Integer'Pos( a_adult.ppchk3 ));
      params( 340 ) := "+"( Integer'Pos( a_adult.ppnumc ));
      params( 341 ) := "+"( Integer'Pos( a_adult.ppper ));
      params( 342 ) := "+"( Integer'Pos( a_adult.practice ));
      params( 343 ) := "+"( Integer'Pos( a_adult.privpen ));
      params( 344 ) := "+"( Float( a_adult.proptax ));
      params( 345 ) := "+"( Integer'Pos( a_adult.ptwk ));
      params( 346 ) := "+"( Integer'Pos( a_adult.r01 ));
      params( 347 ) := "+"( Integer'Pos( a_adult.r02 ));
      params( 348 ) := "+"( Integer'Pos( a_adult.r03 ));
      params( 349 ) := "+"( Integer'Pos( a_adult.r04 ));
      params( 350 ) := "+"( Integer'Pos( a_adult.r05 ));
      params( 351 ) := "+"( Integer'Pos( a_adult.r06 ));
      params( 352 ) := "+"( Integer'Pos( a_adult.r07 ));
      params( 353 ) := "+"( Integer'Pos( a_adult.r08 ));
      params( 354 ) := "+"( Integer'Pos( a_adult.r09 ));
      params( 355 ) := "+"( Integer'Pos( a_adult.r10 ));
      params( 356 ) := "+"( Integer'Pos( a_adult.r11 ));
      params( 357 ) := "+"( Integer'Pos( a_adult.r12 ));
      params( 358 ) := "+"( Integer'Pos( a_adult.r13 ));
      params( 359 ) := "+"( Integer'Pos( a_adult.r14 ));
      params( 360 ) := "+"( Integer'Pos( a_adult.reasden ));
      params( 361 ) := "+"( Integer'Pos( a_adult.reasmed ));
      params( 362 ) := "+"( Integer'Pos( a_adult.reasnhs ));
      params( 363 ) := "+"( Integer'Pos( a_adult.reason ));
      params( 364 ) := "+"( Integer'Pos( a_adult.recsat ));
      params( 365 ) := "+"( Float( a_adult.redamt ));
      params( 366 ) := "+"( Integer'Pos( a_adult.redany ));
      params( 367 ) := "+"( Integer'Pos( a_adult.rednet ));
      params( 368 ) := "+"( Float( a_adult.redtax ));
      params( 369 ) := "+"( Integer'Pos( a_adult.relasat ));
      params( 370 ) := "+"( Integer'Pos( a_adult.religenw ));
      params( 371 ) := "+"( Integer'Pos( a_adult.religsc ));
      params( 372 ) := "+"( Integer'Pos( a_adult.rentprof ));
      params( 373 ) := "+"( Integer'Pos( a_adult.retire ));
      params( 374 ) := "+"( Integer'Pos( a_adult.retire1 ));
      params( 375 ) := "+"( Integer'Pos( a_adult.retreas ));
      params( 376 ) := "+"( Integer'Pos( a_adult.royal1 ));
      params( 377 ) := "+"( Integer'Pos( a_adult.royal2 ));
      params( 378 ) := "+"( Integer'Pos( a_adult.royal3 ));
      params( 379 ) := "+"( Integer'Pos( a_adult.royal4 ));
      params( 380 ) := "+"( Float( a_adult.royyr1 ));
      params( 381 ) := "+"( Float( a_adult.royyr2 ));
      params( 382 ) := "+"( Float( a_adult.royyr3 ));
      params( 383 ) := "+"( Float( a_adult.royyr4 ));
      params( 384 ) := "+"( Integer'Pos( a_adult.rsa ));
      params( 385 ) := "+"( Integer'Pos( a_adult.rsanow ));
      params( 386 ) := "+"( Integer'Pos( a_adult.rstrct ));
      params( 387 ) := "+"( Integer'Pos( a_adult.safe ));
      params( 388 ) := "+"( Integer'Pos( a_adult.samesit ));
      params( 389 ) := "+"( Integer'Pos( a_adult.schchk ));
      params( 390 ) := "+"( Integer'Pos( a_adult.scotvec ));
      params( 391 ) := "+"( Integer'Pos( a_adult.sctvnow ));
      params( 392 ) := "+"( Integer'Pos( a_adult.sdemp01 ));
      params( 393 ) := "+"( Integer'Pos( a_adult.sdemp02 ));
      params( 394 ) := "+"( Integer'Pos( a_adult.sdemp03 ));
      params( 395 ) := "+"( Integer'Pos( a_adult.sdemp04 ));
      params( 396 ) := "+"( Integer'Pos( a_adult.sdemp05 ));
      params( 397 ) := "+"( Integer'Pos( a_adult.sdemp06 ));
      params( 398 ) := "+"( Integer'Pos( a_adult.sdemp07 ));
      params( 399 ) := "+"( Integer'Pos( a_adult.sdemp08 ));
      params( 400 ) := "+"( Integer'Pos( a_adult.sdemp09 ));
      params( 401 ) := "+"( Integer'Pos( a_adult.sdemp10 ));
      params( 402 ) := "+"( Integer'Pos( a_adult.sdemp11 ));
      params( 403 ) := "+"( Integer'Pos( a_adult.sdemp12 ));
      params( 404 ) := "+"( Integer'Pos( a_adult.selfdemp ));
      params( 405 ) := "+"( Integer'Pos( a_adult.sex ));
      params( 406 ) := "+"( Integer'Pos( a_adult.sflntyp1 ));
      params( 407 ) := "+"( Integer'Pos( a_adult.sflntyp2 ));
      params( 408 ) := "+"( Integer'Pos( a_adult.sftype1 ));
      params( 409 ) := "+"( Integer'Pos( a_adult.sftype2 ));
      params( 410 ) := "+"( Integer'Pos( a_adult.sic ));
      params( 411 ) := "+"( Integer'Pos( a_adult.sidqn ));
      params( 412 ) := "+"( Float( a_adult.slrepamt ));
      params( 413 ) := "+"( Integer'Pos( a_adult.slrepay ));
      params( 414 ) := "+"( Integer'Pos( a_adult.slreppd ));
      params( 415 ) := "+"( Integer'Pos( a_adult.soc2010 ));
      params( 416 ) := "+"( Integer'Pos( a_adult.socfund1 ));
      params( 417 ) := "+"( Integer'Pos( a_adult.socfund2 ));
      params( 418 ) := "+"( Integer'Pos( a_adult.socfund3 ));
      params( 419 ) := "+"( Integer'Pos( a_adult.socfund4 ));
      params( 420 ) := "+"( Integer'Pos( a_adult.spcreg1 ));
      params( 421 ) := "+"( Integer'Pos( a_adult.spcreg2 ));
      params( 422 ) := "+"( Integer'Pos( a_adult.spcreg3 ));
      params( 423 ) := "+"( Integer'Pos( a_adult.spnumc ));
      params( 424 ) := "+"( Integer'Pos( a_adult.spout ));
      params( 425 ) := "+"( Integer'Pos( a_adult.spyrot ));
      params( 426 ) := "+"( Float( a_adult.srentamt ));
      params( 427 ) := "+"( Integer'Pos( a_adult.srentpd ));
      params( 428 ) := "+"( Integer'Pos( a_adult.srispc ));
      params( 429 ) := "+"( Integer'Pos( a_adult.srjsaesa ));
      params( 430 ) := "+"( Integer'Pos( a_adult.stakep ));
      params( 431 ) := "+"( Integer'Pos( a_adult.start ));
      params( 432 ) := "+"( Integer'Pos( a_adult.tcever1 ));
      params( 433 ) := "+"( Integer'Pos( a_adult.tcever2 ));
      params( 434 ) := "+"( Integer'Pos( a_adult.tcrepay1 ));
      params( 435 ) := "+"( Integer'Pos( a_adult.tcrepay2 ));
      params( 436 ) := "+"( Integer'Pos( a_adult.tcrepay3 ));
      params( 437 ) := "+"( Integer'Pos( a_adult.tcrepay4 ));
      params( 438 ) := "+"( Integer'Pos( a_adult.tcrepay5 ));
      params( 439 ) := "+"( Integer'Pos( a_adult.tcrepay6 ));
      params( 440 ) := "+"( Integer'Pos( a_adult.tcthsyr1 ));
      params( 441 ) := "+"( Integer'Pos( a_adult.tcthsyr2 ));
      params( 442 ) := "+"( Integer'Pos( a_adult.tdaywrk ));
      params( 443 ) := "+"( Integer'Pos( a_adult.tea ));
      params( 444 ) := "+"( Integer'Pos( a_adult.tea9697 ));
      params( 445 ) := "+"( Integer'Pos( a_adult.tempjob ));
      params( 446 ) := "+"( Integer'Pos( a_adult.timesat ));
      params( 447 ) := "+"( Integer'Pos( a_adult.topupl ));
      params( 448 ) := "+"( Float( a_adult.totint ));
      params( 449 ) := "+"( Integer'Pos( a_adult.train2 ));
      params( 450 ) := "+"( Integer'Pos( a_adult.trainee ));
      params( 451 ) := "+"( Integer'Pos( a_adult.trnallow ));
      params( 452 ) := "+"( Float( a_adult.ttbprx ));
      params( 453 ) := "+"( Integer'Pos( a_adult.tuborr ));
      params( 454 ) := "+"( Integer'Pos( a_adult.typeed ));
      params( 455 ) := "+"( Integer'Pos( a_adult.unpaid1 ));
      params( 456 ) := "+"( Integer'Pos( a_adult.unpaid2 ));
      params( 457 ) := "+"( Integer'Pos( a_adult.w1 ));
      params( 458 ) := "+"( Integer'Pos( a_adult.w2 ));
      params( 459 ) := "+"( Integer'Pos( a_adult.wageben1 ));
      params( 460 ) := "+"( Integer'Pos( a_adult.wageben2 ));
      params( 461 ) := "+"( Integer'Pos( a_adult.wageben3 ));
      params( 462 ) := "+"( Integer'Pos( a_adult.wageben4 ));
      params( 463 ) := "+"( Integer'Pos( a_adult.wageben5 ));
      params( 464 ) := "+"( Integer'Pos( a_adult.wageben6 ));
      params( 465 ) := "+"( Integer'Pos( a_adult.wageben7 ));
      params( 466 ) := "+"( Integer'Pos( a_adult.wageben8 ));
      params( 467 ) := "+"( Integer'Pos( a_adult.wait ));
      params( 468 ) := "+"( Integer'Pos( a_adult.whoresp ));
      params( 469 ) := "+"( Integer'Pos( a_adult.whosectb ));
      params( 470 ) := "+"( Integer'Pos( a_adult.wintfuel ));
      params( 471 ) := "+"( Integer'Pos( a_adult.working ));
      params( 472 ) := "+"( Integer'Pos( a_adult.wpa ));
      params( 473 ) := "+"( Integer'Pos( a_adult.wpba ));
      params( 474 ) := "+"( Integer'Pos( a_adult.wtclum1 ));
      params( 475 ) := "+"( Integer'Pos( a_adult.wtclum2 ));
      params( 476 ) := "+"( Integer'Pos( a_adult.ystrtwk ));
      params( 477 ) := "+"( Integer'Pos( a_adult.month ));
      params( 478 ) := "+"( Integer'Pos( a_adult.able ));
      params( 479 ) := "+"( Integer'Pos( a_adult.actacci ));
      params( 480 ) := "+"( Integer'Pos( a_adult.age80 ));
      params( 481 ) := "+"( Integer'Pos( a_adult.agehq80 ));
      params( 482 ) := "+"( Integer'Pos( a_adult.basacti ));
      params( 483 ) := "+"( Integer'Pos( a_adult.careab ));
      params( 484 ) := "+"( Integer'Pos( a_adult.careah ));
      params( 485 ) := "+"( Integer'Pos( a_adult.carecb ));
      params( 486 ) := "+"( Integer'Pos( a_adult.carech ));
      params( 487 ) := "+"( Integer'Pos( a_adult.carecl ));
      params( 488 ) := "+"( Integer'Pos( a_adult.carefl ));
      params( 489 ) := "+"( Integer'Pos( a_adult.carefr ));
      params( 490 ) := "+"( Integer'Pos( a_adult.careot ));
      params( 491 ) := "+"( Integer'Pos( a_adult.carere ));
      params( 492 ) := "+"( Integer'Pos( a_adult.chbflg ));
      params( 493 ) := "+"( Integer'Pos( a_adult.corignan ));
      params( 494 ) := "+"( Integer'Pos( a_adult.curacti ));
      params( 495 ) := "+"( Integer'Pos( a_adult.currjobm ));
      params( 496 ) := "+"( Integer'Pos( a_adult.disacta1 ));
      params( 497 ) := "+"( Integer'Pos( a_adult.discora1 ));
      params( 498 ) := "+"( Integer'Pos( a_adult.dobmonth ));
      params( 499 ) := "+"( Integer'Pos( a_adult.dobyear ));
      params( 500 ) := "+"( Float( a_adult.empoccp ));
      params( 501 ) := "+"( Integer'Pos( a_adult.empstatb ));
      params( 502 ) := "+"( Integer'Pos( a_adult.empstatc ));
      params( 503 ) := "+"( Integer'Pos( a_adult.empstati ));
      params( 504 ) := "+"( Integer'Pos( a_adult.ethgr3 ));
      params( 505 ) := "+"( Integer'Pos( a_adult.gebacti ));
      params( 506 ) := "+"( Integer'Pos( a_adult.giltcti ));
      params( 507 ) := "+"( Integer'Pos( a_adult.gross4 ));
      params( 508 ) := "+"( Integer'Pos( a_adult.hdage ));
      params( 509 ) := "+"( Integer'Pos( a_adult.hdben ));
      params( 510 ) := "+"( Integer'Pos( a_adult.hdindinc ));
      params( 511 ) := "+"( Float( a_adult.heartval ));
      params( 512 ) := "+"( Integer'Pos( a_adult.hourab ));
      params( 513 ) := "+"( Integer'Pos( a_adult.hourah ));
      params( 514 ) := "+"( Float( a_adult.hourcare ));
      params( 515 ) := "+"( Integer'Pos( a_adult.hourcb ));
      params( 516 ) := "+"( Integer'Pos( a_adult.hourch ));
      params( 517 ) := "+"( Integer'Pos( a_adult.hourcl ));
      params( 518 ) := "+"( Integer'Pos( a_adult.hourfr ));
      params( 519 ) := "+"( Integer'Pos( a_adult.hourot ));
      params( 520 ) := "+"( Integer'Pos( a_adult.hourre ));
      params( 521 ) := "+"( Integer'Pos( a_adult.hourtot ));
      params( 522 ) := "+"( Integer'Pos( a_adult.hperson ));
      params( 523 ) := "+"( Integer'Pos( a_adult.iagegr2 ));
      params( 524 ) := "+"( Integer'Pos( a_adult.iagegr3 ));
      params( 525 ) := "+"( Integer'Pos( a_adult.iagegr4 ));
      params( 526 ) := "+"( Integer'Pos( a_adult.iagegrp ));
      params( 527 ) := "+"( Float( a_adult.incseo2 ));
      params( 528 ) := "+"( Integer'Pos( a_adult.indinc ));
      params( 529 ) := "+"( Integer'Pos( a_adult.indisben ));
      params( 530 ) := "+"( Float( a_adult.inearns ));
      params( 531 ) := "+"( Float( a_adult.ininv ));
      params( 532 ) := "+"( Integer'Pos( a_adult.inirben ));
      params( 533 ) := "+"( Integer'Pos( a_adult.innirben ));
      params( 534 ) := "+"( Integer'Pos( a_adult.inothben ));
      params( 535 ) := "+"( Float( a_adult.inpeninc ));
      params( 536 ) := "+"( Float( a_adult.inrinc ));
      params( 537 ) := "+"( Float( a_adult.inrpinc ));
      params( 538 ) := "+"( Float( a_adult.intvlic ));
      params( 539 ) := "+"( Float( a_adult.intxcred ));
      params( 540 ) := "+"( Integer'Pos( a_adult.isacti ));
      params( 541 ) := "+"( Integer'Pos( a_adult.marital ));
      params( 542 ) := "+"( Integer'Pos( a_adult.mjobsect ));
      params( 543 ) := "+"( Integer'Pos( a_adult.ninanida ));
      params( 544 ) := "+"( Float( a_adult.nincseo2 ));
      params( 545 ) := "+"( Integer'Pos( a_adult.nindinc ));
      params( 546 ) := "+"( Integer'Pos( a_adult.ninearns ));
      params( 547 ) := "+"( Integer'Pos( a_adult.nininv ));
      params( 548 ) := "+"( Integer'Pos( a_adult.ninnirbn ));
      params( 549 ) := "+"( Integer'Pos( a_adult.ninothbn ));
      params( 550 ) := "+"( Integer'Pos( a_adult.ninpenin ));
      params( 551 ) := "+"( Integer'Pos( a_adult.ninrinc ));
      params( 552 ) := "+"( Float( a_adult.ninsein2 ));
      params( 553 ) := "+"( Integer'Pos( a_adult.nirel2 ));
      params( 554 ) := "+"( Integer'Pos( a_adult.occupnum ));
      params( 555 ) := "+"( Integer'Pos( a_adult.pepscti ));
      params( 556 ) := "+"( Integer'Pos( a_adult.poaccti ));
      params( 557 ) := "+"( Integer'Pos( a_adult.pocardi ));
      params( 558 ) := "+"( Integer'Pos( a_adult.prevjobm ));
      params( 559 ) := "+"( Integer'Pos( a_adult.relhrp ));
      params( 560 ) := "+"( Float( a_adult.sapadj ));
      params( 561 ) := "+"( Float( a_adult.seincam2 ));
      params( 562 ) := "+"( Float( a_adult.smpadj ));
      params( 563 ) := "+"( Float( a_adult.sppadj ));
      params( 564 ) := "+"( Float( a_adult.sspadj ));
      params( 565 ) := "+"( Integer'Pos( a_adult.stshcti ));
      params( 566 ) := "+"( Integer'Pos( a_adult.taxpayer ));
      params( 567 ) := "+"( Integer'Pos( a_adult.tesscti ));
      params( 568 ) := "+"( Float( a_adult.totgrant ));
      params( 569 ) := "+"( Float( a_adult.tothours ));
      params( 570 ) := "+"( Float( a_adult.totoccp ));
      params( 571 ) := "+"( Integer'Pos( a_adult.typeed2 ));
      params( 572 ) := "+"( Integer'Pos( a_adult.untrcti ));
      params( 573 ) := "+"( Integer'Pos( a_adult.uperson ));
      params( 574 ) := "+"( Integer'Pos( a_adult.w45 ));
      params( 575 ) := "+"( Float( a_adult.widoccp ));
      params( 576 ) := "+"( Integer'Pos( a_adult.xbonflag ));
      params( 577 ) := "+"( Integer'Pos( a_adult.anxious ));
      params( 578 ) := "+"( Integer'Pos( a_adult.candgnow ));
      params( 579 ) := "+"( Integer'Pos( a_adult.curothf ));
      params( 580 ) := "+"( Integer'Pos( a_adult.curothp ));
      params( 581 ) := "+"( Integer'Pos( a_adult.curothwv ));
      params( 582 ) := "+"( Integer'Pos( a_adult.dvhiqual ));
      params( 583 ) := "+"( Integer'Pos( a_adult.gnvqnow ));
      params( 584 ) := "+"( Integer'Pos( a_adult.gpuc ));
      params( 585 ) := "+"( Integer'Pos( a_adult.happywb ));
      params( 586 ) := "+"( Integer'Pos( a_adult.hi1qual7 ));
      params( 587 ) := "+"( Integer'Pos( a_adult.hi1qual8 ));
      params( 588 ) := "+"( Integer'Pos( a_adult.mntarr5 ));
      params( 589 ) := "+"( Integer'Pos( a_adult.mntnoch1 ));
      params( 590 ) := "+"( Integer'Pos( a_adult.mntnoch2 ));
      params( 591 ) := "+"( Integer'Pos( a_adult.mntnoch3 ));
      params( 592 ) := "+"( Integer'Pos( a_adult.mntnoch4 ));
      params( 593 ) := "+"( Integer'Pos( a_adult.mntnoch5 ));
      params( 594 ) := "+"( Integer'Pos( a_adult.mntpro1 ));
      params( 595 ) := "+"( Integer'Pos( a_adult.mntpro2 ));
      params( 596 ) := "+"( Integer'Pos( a_adult.mntpro3 ));
      params( 597 ) := "+"( Integer'Pos( a_adult.mnttim1 ));
      params( 598 ) := "+"( Integer'Pos( a_adult.mnttim2 ));
      params( 599 ) := "+"( Integer'Pos( a_adult.mnttim3 ));
      params( 600 ) := "+"( Integer'Pos( a_adult.mntwrk1 ));
      params( 601 ) := "+"( Integer'Pos( a_adult.mntwrk2 ));
      params( 602 ) := "+"( Integer'Pos( a_adult.mntwrk3 ));
      params( 603 ) := "+"( Integer'Pos( a_adult.mntwrk4 ));
      params( 604 ) := "+"( Integer'Pos( a_adult.mntwrk5 ));
      params( 605 ) := "+"( Integer'Pos( a_adult.ndeplnow ));
      params( 606 ) := "+"( Integer'Pos( a_adult.oqualc1 ));
      params( 607 ) := "+"( Integer'Pos( a_adult.oqualc2 ));
      params( 608 ) := "+"( Integer'Pos( a_adult.oqualc3 ));
      params( 609 ) := "+"( Integer'Pos( a_adult.sruc ));
      params( 610 ) := "+"( Integer'Pos( a_adult.webacnow ));
      params( 611 ) := "+"( Integer'Pos( a_adult.indeth ));
      params( 612 ) := "+"( Integer'Pos( a_adult.euactive ));
      params( 613 ) := "+"( Integer'Pos( a_adult.euactno ));
      params( 614 ) := "+"( Integer'Pos( a_adult.euartact ));
      params( 615 ) := "+"( Integer'Pos( a_adult.euaskhlp ));
      params( 616 ) := "+"( Integer'Pos( a_adult.eucinema ));
      params( 617 ) := "+"( Integer'Pos( a_adult.eucultur ));
      params( 618 ) := "+"( Integer'Pos( a_adult.euinvol ));
      params( 619 ) := "+"( Integer'Pos( a_adult.eulivpe ));
      params( 620 ) := "+"( Integer'Pos( a_adult.eumtfam ));
      params( 621 ) := "+"( Integer'Pos( a_adult.eumtfrnd ));
      params( 622 ) := "+"( Integer'Pos( a_adult.eusocnet ));
      params( 623 ) := "+"( Integer'Pos( a_adult.eusport ));
      params( 624 ) := "+"( Integer'Pos( a_adult.eutkfam ));
      params( 625 ) := "+"( Integer'Pos( a_adult.eutkfrnd ));
      params( 626 ) := "+"( Integer'Pos( a_adult.eutkmat ));
      params( 627 ) := "+"( Integer'Pos( a_adult.euvol ));
      params( 628 ) := "+"( Integer'Pos( a_adult.natscot ));
      params( 629 ) := "+"( Integer'Pos( a_adult.ntsctnow ));
      params( 630 ) := "+"( Integer'Pos( a_adult.penwel1 ));
      params( 631 ) := "+"( Integer'Pos( a_adult.penwel2 ));
      params( 632 ) := "+"( Integer'Pos( a_adult.penwel3 ));
      params( 633 ) := "+"( Integer'Pos( a_adult.penwel4 ));
      params( 634 ) := "+"( Integer'Pos( a_adult.penwel5 ));
      params( 635 ) := "+"( Integer'Pos( a_adult.penwel6 ));
      params( 636 ) := "+"( Integer'Pos( a_adult.skiwknow ));
      params( 637 ) := "+"( Integer'Pos( a_adult.skiwrk ));
      params( 638 ) := "+"( Integer'Pos( a_adult.slos ));
      params( 639 ) := "+"( Integer'Pos( a_adult.yjblev ));
      params( 640 ) := "+"( Integer'Pos( a_adult.abs2no ));
      params( 641 ) := "+"( Integer'Pos( a_adult.accftpt ));
      params( 642 ) := "+"( Integer'Pos( a_adult.b2qfut1 ));
      params( 643 ) := "+"( Integer'Pos( a_adult.b2qfut2 ));
      params( 644 ) := "+"( Integer'Pos( a_adult.b2qfut3 ));
      params( 645 ) := "+"( Integer'Pos( a_adult.b3qfut1 ));
      params( 646 ) := "+"( Integer'Pos( a_adult.b3qfut2 ));
      params( 647 ) := "+"( Integer'Pos( a_adult.b3qfut3 ));
      params( 648 ) := "+"( Integer'Pos( a_adult.b3qfut4 ));
      params( 649 ) := "+"( Integer'Pos( a_adult.b3qfut5 ));
      params( 650 ) := "+"( Integer'Pos( a_adult.b3qfut6 ));
      params( 651 ) := "+"( Integer'Pos( a_adult.ben1q1 ));
      params( 652 ) := "+"( Integer'Pos( a_adult.ben1q2 ));
      params( 653 ) := "+"( Integer'Pos( a_adult.ben1q3 ));
      params( 654 ) := "+"( Integer'Pos( a_adult.ben1q4 ));
      params( 655 ) := "+"( Integer'Pos( a_adult.ben1q5 ));
      params( 656 ) := "+"( Integer'Pos( a_adult.ben1q6 ));
      params( 657 ) := "+"( Integer'Pos( a_adult.ben1q7 ));
      params( 658 ) := "+"( Integer'Pos( a_adult.ben2q1 ));
      params( 659 ) := "+"( Integer'Pos( a_adult.ben2q2 ));
      params( 660 ) := "+"( Integer'Pos( a_adult.ben2q3 ));
      params( 661 ) := "+"( Integer'Pos( a_adult.ben3q1 ));
      params( 662 ) := "+"( Integer'Pos( a_adult.ben3q2 ));
      params( 663 ) := "+"( Integer'Pos( a_adult.ben3q3 ));
      params( 664 ) := "+"( Integer'Pos( a_adult.ben3q4 ));
      params( 665 ) := "+"( Integer'Pos( a_adult.ben3q5 ));
      params( 666 ) := "+"( Integer'Pos( a_adult.ben3q6 ));
      params( 667 ) := "+"( Integer'Pos( a_adult.ben4q1 ));
      params( 668 ) := "+"( Integer'Pos( a_adult.ben4q2 ));
      params( 669 ) := "+"( Integer'Pos( a_adult.ben4q3 ));
      params( 670 ) := "+"( Integer'Pos( a_adult.ben5q1 ));
      params( 671 ) := "+"( Integer'Pos( a_adult.ben5q2 ));
      params( 672 ) := "+"( Integer'Pos( a_adult.ben5q3 ));
      params( 673 ) := "+"( Integer'Pos( a_adult.ben5q4 ));
      params( 674 ) := "+"( Integer'Pos( a_adult.ben5q5 ));
      params( 675 ) := "+"( Integer'Pos( a_adult.ben5q6 ));
      params( 676 ) := "+"( Integer'Pos( a_adult.ben7q1 ));
      params( 677 ) := "+"( Integer'Pos( a_adult.ben7q2 ));
      params( 678 ) := "+"( Integer'Pos( a_adult.ben7q3 ));
      params( 679 ) := "+"( Integer'Pos( a_adult.ben7q4 ));
      params( 680 ) := "+"( Integer'Pos( a_adult.ben7q5 ));
      params( 681 ) := "+"( Integer'Pos( a_adult.ben7q6 ));
      params( 682 ) := "+"( Integer'Pos( a_adult.ben7q7 ));
      params( 683 ) := "+"( Integer'Pos( a_adult.ben7q8 ));
      params( 684 ) := "+"( Integer'Pos( a_adult.ben7q9 ));
      params( 685 ) := "+"( Integer'Pos( a_adult.btwacc ));
      params( 686 ) := "+"( Integer'Pos( a_adult.dentist ));
      params( 687 ) := "+"( Integer'Pos( a_adult.disdif1 ));
      params( 688 ) := "+"( Integer'Pos( a_adult.disdif2 ));
      params( 689 ) := "+"( Integer'Pos( a_adult.disdif3 ));
      params( 690 ) := "+"( Integer'Pos( a_adult.disdif4 ));
      params( 691 ) := "+"( Integer'Pos( a_adult.disdif5 ));
      params( 692 ) := "+"( Integer'Pos( a_adult.disdif6 ));
      params( 693 ) := "+"( Integer'Pos( a_adult.disdif7 ));
      params( 694 ) := "+"( Integer'Pos( a_adult.disdif8 ));
      params( 695 ) := "+"( Integer'Pos( a_adult.dptcboth ));
      params( 696 ) := "+"( Integer'Pos( a_adult.dptclum ));
      params( 697 ) := "+"( Integer'Pos( a_adult.ed1borr ));
      params( 698 ) := "+"( Integer'Pos( a_adult.ed1int ));
      params( 699 ) := "+"( a_adult.ed1monyr );
      params( 700 ) := "+"( Integer'Pos( a_adult.ed2borr ));
      params( 701 ) := "+"( Integer'Pos( a_adult.ed2int ));
      params( 702 ) := "+"( a_adult.ed2monyr );
      params( 703 ) := "+"( Integer'Pos( a_adult.edattn1 ));
      params( 704 ) := "+"( Integer'Pos( a_adult.edattn2 ));
      params( 705 ) := "+"( Integer'Pos( a_adult.edattn3 ));
      params( 706 ) := "+"( Integer'Pos( a_adult.edtime ));
      params( 707 ) := "+"( Integer'Pos( a_adult.emppay1 ));
      params( 708 ) := "+"( Integer'Pos( a_adult.emppay2 ));
      params( 709 ) := "+"( Integer'Pos( a_adult.emppay3 ));
      params( 710 ) := "+"( Integer'Pos( a_adult.endyr ));
      params( 711 ) := "+"( Integer'Pos( a_adult.epcur ));
      params( 712 ) := "+"( Integer'Pos( a_adult.ethgrp ));
      params( 713 ) := "+"( Integer'Pos( a_adult.exthbct2 ));
      params( 714 ) := "+"( Integer'Pos( a_adult.exthbct3 ));
      params( 715 ) := "+"( Integer'Pos( a_adult.eyetest ));
      params( 716 ) := "+"( Integer'Pos( a_adult.follow ));
      params( 717 ) := "+"( Integer'Pos( a_adult.future ));
      params( 718 ) := "+"( Integer'Pos( a_adult.govpis ));
      params( 719 ) := "+"( Integer'Pos( a_adult.govpjsa ));
      params( 720 ) := "+"( Float( a_adult.hbothamt ));
      params( 721 ) := "+"( Integer'Pos( a_adult.hbothbu ));
      params( 722 ) := "+"( Integer'Pos( a_adult.hbothpd ));
      params( 723 ) := "+"( Integer'Pos( a_adult.hbothwk ));
      params( 724 ) := "+"( Integer'Pos( a_adult.hbotwait ));
      params( 725 ) := "+"( Integer'Pos( a_adult.health ));
      params( 726 ) := "+"( Integer'Pos( a_adult.hosp ));
      params( 727 ) := "+"( Integer'Pos( a_adult.hprob ));
      params( 728 ) := "+"( Integer'Pos( a_adult.isa3type ));
      params( 729 ) := "+"( Integer'Pos( a_adult.ln1rpint ));
      params( 730 ) := "+"( Integer'Pos( a_adult.ln2rpint ));
      params( 731 ) := "+"( Integer'Pos( a_adult.look ));
      params( 732 ) := "+"( Integer'Pos( a_adult.lookwk ));
      params( 733 ) := "+"( Integer'Pos( a_adult.mntct ));
      params( 734 ) := "+"( Integer'Pos( a_adult.mntfor1 ));
      params( 735 ) := "+"( Integer'Pos( a_adult.mntfor2 ));
      params( 736 ) := "+"( Integer'Pos( a_adult.mnttota1 ));
      params( 737 ) := "+"( Integer'Pos( a_adult.mnttota2 ));
      params( 738 ) := "+"( Integer'Pos( a_adult.natid1 ));
      params( 739 ) := "+"( Integer'Pos( a_adult.natid2 ));
      params( 740 ) := "+"( Integer'Pos( a_adult.natid3 ));
      params( 741 ) := "+"( Integer'Pos( a_adult.natid4 ));
      params( 742 ) := "+"( Integer'Pos( a_adult.natid5 ));
      params( 743 ) := "+"( Integer'Pos( a_adult.natid6 ));
      params( 744 ) := "+"( Integer'Pos( a_adult.ndeal ));
      params( 745 ) := "+"( Integer'Pos( a_adult.newdtype ));
      params( 746 ) := "+"( Integer'Pos( a_adult.nhs1 ));
      params( 747 ) := "+"( Integer'Pos( a_adult.nhs2 ));
      params( 748 ) := "+"( Integer'Pos( a_adult.nhs3 ));
      params( 749 ) := "+"( Integer'Pos( a_adult.niethgrp ));
      params( 750 ) := "+"( Integer'Pos( a_adult.ninatid1 ));
      params( 751 ) := "+"( Integer'Pos( a_adult.ninatid2 ));
      params( 752 ) := "+"( Integer'Pos( a_adult.ninatid3 ));
      params( 753 ) := "+"( Integer'Pos( a_adult.ninatid4 ));
      params( 754 ) := "+"( Integer'Pos( a_adult.ninatid5 ));
      params( 755 ) := "+"( Integer'Pos( a_adult.ninatid6 ));
      params( 756 ) := "+"( Integer'Pos( a_adult.ninatid7 ));
      params( 757 ) := "+"( Integer'Pos( a_adult.ninatid8 ));
      params( 758 ) := "+"( Integer'Pos( a_adult.nirel ));
      params( 759 ) := "+"( Integer'Pos( a_adult.nitrain ));
      params( 760 ) := "+"( Integer'Pos( a_adult.nlper ));
      params( 761 ) := "+"( Integer'Pos( a_adult.nolook ));
      params( 762 ) := "+"( Integer'Pos( a_adult.ntcapp ));
      params( 763 ) := "+"( Integer'Pos( a_adult.ntcdat ));
      params( 764 ) := "+"( Float( a_adult.ntcinc ));
      params( 765 ) := "+"( Integer'Pos( a_adult.ntcorig1 ));
      params( 766 ) := "+"( Integer'Pos( a_adult.ntcorig2 ));
      params( 767 ) := "+"( Integer'Pos( a_adult.ntcorig3 ));
      params( 768 ) := "+"( Integer'Pos( a_adult.ntcorig4 ));
      params( 769 ) := "+"( Integer'Pos( a_adult.ntcorig5 ));
      params( 770 ) := "+"( Integer'Pos( a_adult.prit ));
      params( 771 ) := "+"( Integer'Pos( a_adult.prscrpt ));
      params( 772 ) := "+"( Integer'Pos( a_adult.soc2000 ));
      params( 773 ) := "+"( Integer'Pos( a_adult.specs ));
      params( 774 ) := "+"( Integer'Pos( a_adult.startyr ));
      params( 775 ) := "+"( Integer'Pos( a_adult.taxcred1 ));
      params( 776 ) := "+"( Integer'Pos( a_adult.taxcred2 ));
      params( 777 ) := "+"( Integer'Pos( a_adult.taxcred3 ));
      params( 778 ) := "+"( Integer'Pos( a_adult.taxcred4 ));
      params( 779 ) := "+"( Integer'Pos( a_adult.taxcred5 ));
      params( 780 ) := "+"( Integer'Pos( a_adult.taxfut ));
      params( 781 ) := "+"( Integer'Pos( a_adult.train ));
      params( 782 ) := "+"( Integer'Pos( a_adult.trav ));
      params( 783 ) := "+"( Integer'Pos( a_adult.voucher ));
      params( 784 ) := "+"( Integer'Pos( a_adult.war1 ));
      params( 785 ) := "+"( Integer'Pos( a_adult.war2 ));
      params( 786 ) := "+"( Integer'Pos( a_adult.wftcboth ));
      params( 787 ) := "+"( Integer'Pos( a_adult.wftclum ));
      params( 788 ) := "+"( Integer'Pos( a_adult.whyfrde1 ));
      params( 789 ) := "+"( Integer'Pos( a_adult.whyfrde2 ));
      params( 790 ) := "+"( Integer'Pos( a_adult.whyfrde3 ));
      params( 791 ) := "+"( Integer'Pos( a_adult.whyfrde4 ));
      params( 792 ) := "+"( Integer'Pos( a_adult.whyfrde5 ));
      params( 793 ) := "+"( Integer'Pos( a_adult.whyfrde6 ));
      params( 794 ) := "+"( Integer'Pos( a_adult.whyfrey1 ));
      params( 795 ) := "+"( Integer'Pos( a_adult.whyfrey2 ));
      params( 796 ) := "+"( Integer'Pos( a_adult.whyfrey3 ));
      params( 797 ) := "+"( Integer'Pos( a_adult.whyfrey4 ));
      params( 798 ) := "+"( Integer'Pos( a_adult.whyfrey5 ));
      params( 799 ) := "+"( Integer'Pos( a_adult.whyfrey6 ));
      params( 800 ) := "+"( Integer'Pos( a_adult.whyfrpr1 ));
      params( 801 ) := "+"( Integer'Pos( a_adult.whyfrpr2 ));
      params( 802 ) := "+"( Integer'Pos( a_adult.whyfrpr3 ));
      params( 803 ) := "+"( Integer'Pos( a_adult.whyfrpr4 ));
      params( 804 ) := "+"( Integer'Pos( a_adult.whyfrpr5 ));
      params( 805 ) := "+"( Integer'Pos( a_adult.whyfrpr6 ));
      params( 806 ) := "+"( Integer'Pos( a_adult.whytrav1 ));
      params( 807 ) := "+"( Integer'Pos( a_adult.whytrav2 ));
      params( 808 ) := "+"( Integer'Pos( a_adult.whytrav3 ));
      params( 809 ) := "+"( Integer'Pos( a_adult.whytrav4 ));
      params( 810 ) := "+"( Integer'Pos( a_adult.whytrav5 ));
      params( 811 ) := "+"( Integer'Pos( a_adult.whytrav6 ));
      params( 812 ) := "+"( Integer'Pos( a_adult.wmkit ));
      params( 813 ) := "+"( Integer'Pos( a_adult.wtclum3 ));
      params( 814 ) := "+"( Integer'Pos( a_adult.addda ));
      params( 815 ) := "+"( Float( a_adult.bntxcred ));
      params( 816 ) := "+"( Integer'Pos( a_adult.fsbndcti ));
      params( 817 ) := "+"( Float( a_adult.fwmlkval ));
      params( 818 ) := "+"( Integer'Pos( a_adult.gross2 ));
      params( 819 ) := "+"( Integer'Pos( a_adult.gross3 ));
      params( 820 ) := "+"( Float( a_adult.hbsupran ));
      params( 821 ) := "+"( Float( a_adult.netocpen ));
      params( 822 ) := "+"( Integer'Pos( a_adult.nsbocti ));
      params( 823 ) := "+"( Integer'Pos( a_adult.otbscti ));
      params( 824 ) := "+"( Integer'Pos( a_adult.prbocti ));
      params( 825 ) := "+"( Integer'Pos( a_adult.sayecti ));
      params( 826 ) := "+"( Integer'Pos( a_adult.sclbcti ));
      params( 827 ) := "+"( Integer'Pos( a_adult.sscti ));
      params( 828 ) := "+"( Float( a_adult.superan ));
      params( 829 ) := "+"( Float( a_adult.ttwcosts ));
      params( 830 ) := "+"( Integer'Pos( a_adult.ben5q7 ));
      params( 831 ) := "+"( Integer'Pos( a_adult.ben5q8 ));
      params( 832 ) := "+"( Integer'Pos( a_adult.ben5q9 ));
      params( 833 ) := "+"( Integer'Pos( a_adult.ddatre ));
      params( 834 ) := "+"( Integer'Pos( a_adult.disdif9 ));
      params( 835 ) := "+"( Float( a_adult.fare ));
      params( 836 ) := "+"( Integer'Pos( a_adult.nittwmod ));
      params( 837 ) := "+"( Integer'Pos( a_adult.oneway ));
      params( 838 ) := "+"( Float( a_adult.pssamt ));
      params( 839 ) := "+"( Integer'Pos( a_adult.pssdate ));
      params( 840 ) := "+"( Integer'Pos( a_adult.ttwcode1 ));
      params( 841 ) := "+"( Integer'Pos( a_adult.ttwcode2 ));
      params( 842 ) := "+"( Integer'Pos( a_adult.ttwcode3 ));
      params( 843 ) := "+"( Float( a_adult.ttwcost ));
      params( 844 ) := "+"( Integer'Pos( a_adult.ttwfar ));
      params( 845 ) := "+"( Float( a_adult.ttwfrq ));
      params( 846 ) := "+"( Integer'Pos( a_adult.ttwmod ));
      params( 847 ) := "+"( Integer'Pos( a_adult.ttwpay ));
      params( 848 ) := "+"( Integer'Pos( a_adult.ttwpss ));
      params( 849 ) := "+"( Float( a_adult.ttwrec ));
      params( 850 ) := "+"( Integer'Pos( a_adult.crunaci ));
      params( 851 ) := "+"( Integer'Pos( a_adult.enomorti ));
      params( 852 ) := "+"( Integer'Pos( a_adult.ttwmode ));
      params( 853 ) := "+"( Integer'Pos( a_adult.ddatrep ));
      params( 854 ) := "+"( Integer'Pos( a_adult.disdifp ));
      params( 855 ) := "+"( Integer'Pos( a_adult.sfrpis ));
      params( 856 ) := "+"( Integer'Pos( a_adult.sfrpjsa ));
      params( 857 ) := "+"( Integer'Pos( a_adult.ethgr2 ));
      params( 858 ) := "+"( Integer'Pos( a_adult.consent ));
      params( 859 ) := "+"( Integer'Pos( a_adult.dvpens ));
      params( 860 ) := "+"( Integer'Pos( a_adult.lnkref1 ));
      params( 861 ) := "+"( Integer'Pos( a_adult.lnkref2 ));
      params( 862 ) := "+"( Integer'Pos( a_adult.lnkref21 ));
      params( 863 ) := "+"( Integer'Pos( a_adult.lnkref22 ));
      params( 864 ) := "+"( Integer'Pos( a_adult.lnkref23 ));
      params( 865 ) := "+"( Integer'Pos( a_adult.lnkref24 ));
      params( 866 ) := "+"( Integer'Pos( a_adult.lnkref25 ));
      params( 867 ) := "+"( Integer'Pos( a_adult.lnkref3 ));
      params( 868 ) := "+"( Integer'Pos( a_adult.lnkref4 ));
      params( 869 ) := "+"( Integer'Pos( a_adult.lnkref5 ));
      params( 870 ) := "+"( Integer'Pos( a_adult.pconsent ));
      params( 871 ) := "+"( Integer'Pos( a_adult.lnkons ));
      params( 872 ) := "+"( Integer'Pos( a_adult.lnkref6 ));
      params( 873 ) := "+"( Integer'Pos( a_adult.lnkref7 ));
      params( 874 ) := "+"( Integer'Pos( a_adult.lnkref8 ));
      params( 875 ) := "+"( Integer'Pos( a_adult.lnkref9 ));
      params( 876 ) := "+"( Integer'Pos( a_adult.b3qfut7 ));
      params( 877 ) := "+"( Integer'Pos( a_adult.ben3q7 ));
      params( 878 ) := "+"( Integer'Pos( a_adult.ddaprog ));
      params( 879 ) := "+"( Integer'Pos( a_adult.hbolng ));
      params( 880 ) := "+"( Integer'Pos( a_adult.hi2qual ));
      params( 881 ) := "+"( Integer'Pos( a_adult.hlpgvn01 ));
      params( 882 ) := "+"( Integer'Pos( a_adult.hlpgvn02 ));
      params( 883 ) := "+"( Integer'Pos( a_adult.hlpgvn03 ));
      params( 884 ) := "+"( Integer'Pos( a_adult.hlpgvn04 ));
      params( 885 ) := "+"( Integer'Pos( a_adult.hlpgvn05 ));
      params( 886 ) := "+"( Integer'Pos( a_adult.hlpgvn06 ));
      params( 887 ) := "+"( Integer'Pos( a_adult.hlpgvn07 ));
      params( 888 ) := "+"( Integer'Pos( a_adult.hlpgvn08 ));
      params( 889 ) := "+"( Integer'Pos( a_adult.hlpgvn09 ));
      params( 890 ) := "+"( Integer'Pos( a_adult.hlpgvn10 ));
      params( 891 ) := "+"( Integer'Pos( a_adult.hlpgvn11 ));
      params( 892 ) := "+"( Integer'Pos( a_adult.hlprec01 ));
      params( 893 ) := "+"( Integer'Pos( a_adult.hlprec02 ));
      params( 894 ) := "+"( Integer'Pos( a_adult.hlprec03 ));
      params( 895 ) := "+"( Integer'Pos( a_adult.hlprec04 ));
      params( 896 ) := "+"( Integer'Pos( a_adult.hlprec05 ));
      params( 897 ) := "+"( Integer'Pos( a_adult.hlprec06 ));
      params( 898 ) := "+"( Integer'Pos( a_adult.hlprec07 ));
      params( 899 ) := "+"( Integer'Pos( a_adult.hlprec08 ));
      params( 900 ) := "+"( Integer'Pos( a_adult.hlprec09 ));
      params( 901 ) := "+"( Integer'Pos( a_adult.hlprec10 ));
      params( 902 ) := "+"( Integer'Pos( a_adult.hlprec11 ));
      params( 903 ) := "+"( Integer'Pos( a_adult.loangvn1 ));
      params( 904 ) := "+"( Integer'Pos( a_adult.loangvn2 ));
      params( 905 ) := "+"( Integer'Pos( a_adult.loangvn3 ));
      params( 906 ) := "+"( Integer'Pos( a_adult.loanrec1 ));
      params( 907 ) := "+"( Integer'Pos( a_adult.loanrec2 ));
      params( 908 ) := "+"( Integer'Pos( a_adult.loanrec3 ));
      params( 909 ) := "+"( Integer'Pos( a_adult.alg ));
      params( 910 ) := "+"( Float( a_adult.algamt ));
      params( 911 ) := "+"( Integer'Pos( a_adult.algpd ));
      params( 912 ) := "+"( Integer'Pos( a_adult.ben4q4 ));
      params( 913 ) := "+"( Integer'Pos( a_adult.disdifad ));
      params( 914 ) := "+"( Integer'Pos( a_adult.gross3_x ));
      params( 915 ) := "+"( Integer'Pos( a_adult.cbaamt ));
      params( 916 ) := "+"( Integer'Pos( a_adult.mednum ));
      params( 917 ) := "+"( Integer'Pos( a_adult.medprpd ));
      params( 918 ) := "+"( Integer'Pos( a_adult.medprpy ));
      params( 919 ) := "+"( Integer'Pos( a_adult.medpay ));
      params( 920 ) := "+"( Integer'Pos( a_adult.medrep ));
      params( 921 ) := "+"( Integer'Pos( a_adult.medrpnm ));
   ...
   begin
      ...
      params( 8 ) := "+"( Integer'Pos( a_adult.abspar ));
      params( 9 ) := "+"( Integer'Pos( a_adult.abspay ));
      params( 10 ) := "+"( Integer'Pos( a_adult.abswhy ));
      params( 11 ) := "+"( Integer'Pos( a_adult.abswk ));
      params( 12 ) := "+"( Integer'Pos( a_adult.x_access ));
      params( 13 ) := "+"( Integer'Pos( a_adult.accjb ));
      params( 14 ) := "+"( Integer'Pos( a_adult.accmsat ));
      params( 15 ) := "+"( Integer'Pos( a_adult.accountq ));
      ...
      params( 23 ) := "+"( Integer'Pos( a_adult.agehqual ));
      params( 24 ) := "+"( Float( a_adult.aliamt ));
      params( 25 ) := "+"( Integer'Pos( a_adult.alimny ));
      params( 26 ) := "+"( Integer'Pos( a_adult.alipd ));
      params( 27 ) := "+"( Integer'Pos( a_adult.alius ));
      params( 28 ) := "+"( Integer'Pos( a_adult.allow1 ));
      params( 29 ) := "+"( Integer'Pos( a_adult.allow2 ));
      params( 30 ) := "+"( Integer'Pos( a_adult.allow3 ));
      params( 31 ) := "+"( Integer'Pos( a_adult.allow4 ));
      params( 32 ) := "+"( Float( a_adult.allpay1 ));
      params( 33 ) := "+"( Float( a_adult.allpay2 ));
      params( 34 ) := "+"( Float( a_adult.allpay3 ));
      params( 35 ) := "+"( Float( a_adult.allpay4 ));
      params( 36 ) := "+"( Integer'Pos( a_adult.allpd1 ));
      params( 37 ) := "+"( Integer'Pos( a_adult.allpd2 ));
      params( 38 ) := "+"( Integer'Pos( a_adult.allpd3 ));
      params( 39 ) := "+"( Integer'Pos( a_adult.allpd4 ));
      params( 40 ) := "+"( Float( a_adult.aluamt ));
      params( 41 ) := "+"( Integer'Pos( a_adult.alupd ));
      params( 42 ) := "+"( Integer'Pos( a_adult.anyacc ));
      params( 43 ) := "+"( Integer'Pos( a_adult.anyed ));
      params( 44 ) := "+"( Integer'Pos( a_adult.anymon ));
      params( 45 ) := "+"( Integer'Pos( a_adult.anypen1 ));
      params( 46 ) := "+"( Integer'Pos( a_adult.anypen2 ));
      params( 47 ) := "+"( Integer'Pos( a_adult.anypen3 ));
      params( 48 ) := "+"( Integer'Pos( a_adult.anypen4 ));
      params( 49 ) := "+"( Integer'Pos( a_adult.anypen5 ));
      params( 50 ) := "+"( Integer'Pos( a_adult.anypen6 ));
      params( 51 ) := "+"( Integer'Pos( a_adult.anypen7 ));
      params( 52 ) := "+"( Float( a_adult.apamt ));
      params( 53 ) := "+"( Float( a_adult.apdamt ));
      params( 54 ) := "+"( Integer'Pos( a_adult.apdir ));
      params( 55 ) := "+"( Integer'Pos( a_adult.apdpd ));
      params( 56 ) := "+"( Integer'Pos( a_adult.appd ));
      params( 57 ) := "+"( Integer'Pos( a_adult.bfd ));
      params( 58 ) := "+"( Float( a_adult.bfdamt ));
      params( 59 ) := "+"( Integer'Pos( a_adult.bfdpd ));
      params( 60 ) := "+"( Integer'Pos( a_adult.bfdval ));
      params( 61 ) := "+"( Integer'Pos( a_adult.btec ));
      params( 62 ) := "+"( Integer'Pos( a_adult.btecnow ));
      params( 63 ) := "+"( Integer'Pos( a_adult.c2orign ));
      params( 64 ) := "+"( Integer'Pos( a_adult.calm ));
      params( 65 ) := "+"( Integer'Pos( a_adult.camemt ));
      params( 66 ) := "+"( Integer'Pos( a_adult.cameyr ));
      params( 67 ) := "+"( Integer'Pos( a_adult.cameyr2 ));
      params( 68 ) := "+"( Integer'Pos( a_adult.cbaamt2 ));
      params( 69 ) := "+"( Integer'Pos( a_adult.cbchk ));
      params( 70 ) := "+"( Integer'Pos( a_adult.change ));
      params( 71 ) := "+"( Integer'Pos( a_adult.chkctc ));
      params( 72 ) := "+"( Integer'Pos( a_adult.chkdpco1 ));
      params( 73 ) := "+"( Integer'Pos( a_adult.chkdpco2 ));
      params( 74 ) := "+"( Integer'Pos( a_adult.chkdpco3 ));
      params( 75 ) := "+"( Integer'Pos( a_adult.chkdpn ));
      params( 76 ) := "+"( Integer'Pos( a_adult.chkdsco1 ));
      params( 77 ) := "+"( Integer'Pos( a_adult.chkdsco2 ));
      params( 78 ) := "+"( Integer'Pos( a_adult.chkdsco3 ));
      params( 79 ) := "+"( Integer'Pos( a_adult.chknop ));
      params( 80 ) := "+"( Integer'Pos( a_adult.citizen ));
      params( 81 ) := "+"( Integer'Pos( a_adult.citizen2 ));
      params( 82 ) := "+"( Integer'Pos( a_adult.claifut1 ));
      params( 83 ) := "+"( Integer'Pos( a_adult.claifut2 ));
      params( 84 ) := "+"( Integer'Pos( a_adult.claifut3 ));
      params( 85 ) := "+"( Integer'Pos( a_adult.claifut4 ));
      params( 86 ) := "+"( Integer'Pos( a_adult.claifut5 ));
      params( 87 ) := "+"( Integer'Pos( a_adult.claifut6 ));
      params( 88 ) := "+"( Integer'Pos( a_adult.claifut7 ));
      params( 89 ) := "+"( Integer'Pos( a_adult.claifut8 ));
      params( 90 ) := "+"( Integer'Pos( a_adult.claimant ));
      params( 91 ) := "+"( Integer'Pos( a_adult.cohabit ));
      params( 92 ) := "+"( Integer'Pos( a_adult.combid ));
      params( 93 ) := "+"( Integer'Pos( a_adult.commusat ));
      params( 94 ) := "+"( Integer'Pos( a_adult.condit ));
      params( 95 ) := "+"( Integer'Pos( a_adult.contuk ));
      params( 96 ) := "+"( Integer'Pos( a_adult.convbl ));
      params( 97 ) := "+"( Integer'Pos( a_adult.coptrust ));
      params( 98 ) := "+"( Integer'Pos( a_adult.corign ));
      params( 99 ) := "+"( Integer'Pos( a_adult.corigoth ));
      params( 100 ) := "+"( Integer'Pos( a_adult.ctclum1 ));
      params( 101 ) := "+"( Integer'Pos( a_adult.ctclum2 ));
      params( 102 ) := "+"( Integer'Pos( a_adult.cupchk ));
      params( 103 ) := "+"( Integer'Pos( a_adult.curqual ));
      params( 104 ) := "+"( Integer'Pos( a_adult.cvht ));
      params( 105 ) := "+"( Float( a_adult.cvpay ));
      params( 106 ) := "+"( Integer'Pos( a_adult.cvpd ));
      params( 107 ) := "+"( Integer'Pos( a_adult.ddaprog1 ));
      params( 108 ) := "+"( Integer'Pos( a_adult.ddatre1 ));
      params( 109 ) := "+"( Integer'Pos( a_adult.ddatrep1 ));
      params( 110 ) := "+"( Integer'Pos( a_adult.defrpen ));
      params( 111 ) := "+"( Integer'Pos( a_adult.degree ));
      params( 112 ) := "+"( Integer'Pos( a_adult.degrenow ));
      params( 113 ) := "+"( Integer'Pos( a_adult.denrec ));
      params( 114 ) := "+"( Integer'Pos( a_adult.depend ));
      params( 115 ) := "+"( Integer'Pos( a_adult.depress ));
      params( 116 ) := "+"( Integer'Pos( a_adult.disben1 ));
      params( 117 ) := "+"( Integer'Pos( a_adult.disben2 ));
      params( 118 ) := "+"( Integer'Pos( a_adult.disben3 ));
      params( 119 ) := "+"( Integer'Pos( a_adult.disben4 ));
      params( 120 ) := "+"( Integer'Pos( a_adult.disben5 ));
      params( 121 ) := "+"( Integer'Pos( a_adult.disben6 ));
      params( 122 ) := "+"( Integer'Pos( a_adult.discuss ));
      params( 123 ) := "+"( Integer'Pos( a_adult.disd01 ));
      params( 124 ) := "+"( Integer'Pos( a_adult.disd02 ));
      params( 125 ) := "+"( Integer'Pos( a_adult.disd03 ));
      params( 126 ) := "+"( Integer'Pos( a_adult.disd04 ));
      params( 127 ) := "+"( Integer'Pos( a_adult.disd05 ));
      params( 128 ) := "+"( Integer'Pos( a_adult.disd06 ));
      params( 129 ) := "+"( Integer'Pos( a_adult.disd07 ));
      params( 130 ) := "+"( Integer'Pos( a_adult.disd08 ));
      params( 131 ) := "+"( Integer'Pos( a_adult.disd09 ));
      params( 132 ) := "+"( Integer'Pos( a_adult.disd10 ));
      params( 133 ) := "+"( Integer'Pos( a_adult.disdifp1 ));
      params( 134 ) := "+"( Integer'Pos( a_adult.dla1 ));
      params( 135 ) := "+"( Integer'Pos( a_adult.dla2 ));
      params( 136 ) := "+"( Integer'Pos( a_adult.dls ));
      params( 137 ) := "+"( Float( a_adult.dlsamt ));
      params( 138 ) := "+"( Integer'Pos( a_adult.dlspd ));
      params( 139 ) := "+"( Integer'Pos( a_adult.dlsval ));
      params( 140 ) := "+"( a_adult.dob );
      params( 141 ) := "+"( Integer'Pos( a_adult.down ));
      params( 142 ) := "+"( Integer'Pos( a_adult.dv09pens ));
      params( 143 ) := "+"( Integer'Pos( a_adult.dvil03a ));
      params( 144 ) := "+"( Integer'Pos( a_adult.dvil04a ));
      params( 145 ) := "+"( Integer'Pos( a_adult.dvjb12ml ));
      params( 146 ) := "+"( Integer'Pos( a_adult.dvmardf ));
      params( 147 ) := "+"( Float( a_adult.ed1amt ));
      params( 148 ) := "+"( Integer'Pos( a_adult.ed1pd ));
      params( 149 ) := "+"( Integer'Pos( a_adult.ed1sum ));
      params( 150 ) := "+"( Float( a_adult.ed2amt ));
      params( 151 ) := "+"( Integer'Pos( a_adult.ed2pd ));
      params( 152 ) := "+"( Integer'Pos( a_adult.ed2sum ));
      params( 153 ) := "+"( Integer'Pos( a_adult.edatt ));
      params( 154 ) := "+"( Integer'Pos( a_adult.edhr ));
      params( 155 ) := "+"( Integer'Pos( a_adult.edtyp ));
      params( 156 ) := "+"( Integer'Pos( a_adult.eligadlt ));
      params( 157 ) := "+"( Integer'Pos( a_adult.eligchld ));
      params( 158 ) := "+"( Integer'Pos( a_adult.eligschm ));
      params( 159 ) := "+"( Integer'Pos( a_adult.emparr ));
      params( 160 ) := "+"( Integer'Pos( a_adult.empcontr ));
      params( 161 ) := "+"( Integer'Pos( a_adult.emppen ));
      params( 162 ) := "+"( Integer'Pos( a_adult.empschm ));
      params( 163 ) := "+"( Integer'Pos( a_adult.empstat ));
      params( 164 ) := "+"( Integer'Pos( a_adult.envirsat ));
      params( 165 ) := "+"( Integer'Pos( a_adult.es2000 ));
      params( 166 ) := "+"( Integer'Pos( a_adult.ethgrps ));
      params( 167 ) := "+"( Integer'Pos( a_adult.etngrp ));
      params( 168 ) := "+"( Float( a_adult.eualiamt ));
      params( 169 ) := "+"( Integer'Pos( a_adult.eualimny ));
      params( 170 ) := "+"( Integer'Pos( a_adult.eualipd ));
      params( 171 ) := "+"( Integer'Pos( a_adult.euetype ));
      params( 172 ) := "+"( Integer'Pos( a_adult.everwrk ));
      params( 173 ) := "+"( Integer'Pos( a_adult.exthbct1 ));
      params( 174 ) := "+"( Integer'Pos( a_adult.followsc ));
      params( 175 ) := "+"( Integer'Pos( a_adult.followup ));
      params( 176 ) := "+"( Integer'Pos( a_adult.fted ));
      params( 177 ) := "+"( Integer'Pos( a_adult.ftwk ));
      params( 178 ) := "+"( Integer'Pos( a_adult.gpispc ));
      params( 179 ) := "+"( Integer'Pos( a_adult.gpjsaesa ));
      params( 180 ) := "+"( Integer'Pos( a_adult.x_grant ));
      params( 181 ) := "+"( Float( a_adult.grtamt1 ));
      params( 182 ) := "+"( Float( a_adult.grtamt2 ));
      params( 183 ) := "+"( Float( a_adult.grtdir1 ));
      params( 184 ) := "+"( Float( a_adult.grtdir2 ));
      params( 185 ) := "+"( Integer'Pos( a_adult.grtnum ));
      params( 186 ) := "+"( Integer'Pos( a_adult.grtsce1 ));
      params( 187 ) := "+"( Integer'Pos( a_adult.grtsce2 ));
      params( 188 ) := "+"( Float( a_adult.grtval1 ));
      params( 189 ) := "+"( Float( a_adult.grtval2 ));
      params( 190 ) := "+"( Integer'Pos( a_adult.gta ));
      params( 191 ) := "+"( Integer'Pos( a_adult.happy ));
      params( 192 ) := "+"( Integer'Pos( a_adult.health1 ));
      params( 193 ) := "+"( Integer'Pos( a_adult.heathad ));
      params( 194 ) := "+"( Integer'Pos( a_adult.help ));
      params( 195 ) := "+"( Integer'Pos( a_adult.hholder ));
      params( 196 ) := "+"( Integer'Pos( a_adult.hi1qual1 ));
      params( 197 ) := "+"( Integer'Pos( a_adult.hi1qual2 ));
      params( 198 ) := "+"( Integer'Pos( a_adult.hi1qual3 ));
      params( 199 ) := "+"( Integer'Pos( a_adult.hi1qual4 ));
      params( 200 ) := "+"( Integer'Pos( a_adult.hi1qual5 ));
      params( 201 ) := "+"( Integer'Pos( a_adult.hi1qual6 ));
      params( 202 ) := "+"( Integer'Pos( a_adult.hi3qual ));
      params( 203 ) := "+"( Integer'Pos( a_adult.higho ));
      params( 204 ) := "+"( Integer'Pos( a_adult.highonow ));
      params( 205 ) := "+"( Integer'Pos( a_adult.hrpid ));
      params( 206 ) := "+"( Integer'Pos( a_adult.hsvper ));
      params( 207 ) := "+"( Integer'Pos( a_adult.iclaim1 ));
      params( 208 ) := "+"( Integer'Pos( a_adult.iclaim2 ));
      params( 209 ) := "+"( Integer'Pos( a_adult.iclaim3 ));
      params( 210 ) := "+"( Integer'Pos( a_adult.iclaim4 ));
      params( 211 ) := "+"( Integer'Pos( a_adult.iclaim5 ));
      params( 212 ) := "+"( Integer'Pos( a_adult.iclaim6 ));
      params( 213 ) := "+"( Integer'Pos( a_adult.iclaim7 ));
      params( 214 ) := "+"( Integer'Pos( a_adult.iclaim8 ));
      params( 215 ) := "+"( Integer'Pos( a_adult.iclaim9 ));
      params( 216 ) := "+"( Integer'Pos( a_adult.incdur ));
      params( 217 ) := "+"( Integer'Pos( a_adult.injlong ));
      params( 218 ) := "+"( Integer'Pos( a_adult.injwk ));
      params( 219 ) := "+"( Integer'Pos( a_adult.invests ));
      params( 220 ) := "+"( Integer'Pos( a_adult.iout ));
      params( 221 ) := "+"( Integer'Pos( a_adult.isa1type ));
      params( 222 ) := "+"( Integer'Pos( a_adult.isa2type ));
      params( 223 ) := "+"( Integer'Pos( a_adult.issue ));
      params( 224 ) := "+"( Integer'Pos( a_adult.jobaway ));
      params( 225 ) := "+"( Integer'Pos( a_adult.jobbyr ));
      params( 226 ) := "+"( Integer'Pos( a_adult.jobsat ));
      params( 227 ) := "+"( Integer'Pos( a_adult.kidben1 ));
      params( 228 ) := "+"( Integer'Pos( a_adult.kidben2 ));
      params( 229 ) := "+"( Integer'Pos( a_adult.kidben3 ));
      params( 230 ) := "+"( Integer'Pos( a_adult.lareg ));
      params( 231 ) := "+"( Integer'Pos( a_adult.legltrus ));
      params( 232 ) := "+"( Integer'Pos( a_adult.lifesat ));
      params( 233 ) := "+"( Integer'Pos( a_adult.likewk ));
      params( 234 ) := "+"( Integer'Pos( a_adult.limitl ));
      params( 235 ) := "+"( Integer'Pos( a_adult.lktime ));
      params( 236 ) := "+"( Integer'Pos( a_adult.lktrain ));
      params( 237 ) := "+"( Integer'Pos( a_adult.lkwork ));
      params( 238 ) := "+"( Integer'Pos( a_adult.lnkdwp ));
      params( 239 ) := "+"( Integer'Pos( a_adult.lnkref01 ));
      params( 240 ) := "+"( Integer'Pos( a_adult.lnkref02 ));
      params( 241 ) := "+"( Integer'Pos( a_adult.lnkref03 ));
      params( 242 ) := "+"( Integer'Pos( a_adult.lnkref04 ));
      params( 243 ) := "+"( Integer'Pos( a_adult.lnkref05 ));
      params( 244 ) := "+"( Integer'Pos( a_adult.lnkref06 ));
      params( 245 ) := "+"( Integer'Pos( a_adult.lnkref07 ));
      params( 246 ) := "+"( Integer'Pos( a_adult.lnkref08 ));
      params( 247 ) := "+"( Integer'Pos( a_adult.lnkref09 ));
      params( 248 ) := "+"( Integer'Pos( a_adult.lnkref10 ));
      params( 249 ) := "+"( Integer'Pos( a_adult.lnkref11 ));
      params( 250 ) := "+"( Integer'Pos( a_adult.loan ));
      params( 251 ) := "+"( Integer'Pos( a_adult.loannum ));
      params( 252 ) := "+"( Integer'Pos( a_adult.lstwrk1 ));
      params( 253 ) := "+"( Integer'Pos( a_adult.lstwrk2 ));
      params( 254 ) := "+"( Integer'Pos( a_adult.lstyr ));
      params( 255 ) := "+"( Integer'Pos( a_adult.meaning ));
      params( 256 ) := "+"( Integer'Pos( a_adult.medrec ));
      params( 257 ) := "+"( Integer'Pos( a_adult.memschm ));
      params( 258 ) := "+"( Float( a_adult.mntamt1 ));
      params( 259 ) := "+"( Float( a_adult.mntamt2 ));
      params( 260 ) := "+"( Integer'Pos( a_adult.mntarr1 ));
      params( 261 ) := "+"( Integer'Pos( a_adult.mntarr2 ));
      params( 262 ) := "+"( Integer'Pos( a_adult.mntarr3 ));
      params( 263 ) := "+"( Integer'Pos( a_adult.mntarr4 ));
      params( 264 ) := "+"( Integer'Pos( a_adult.mntgov1 ));
      params( 265 ) := "+"( Integer'Pos( a_adult.mntgov2 ));
      params( 266 ) := "+"( Integer'Pos( a_adult.mntnrp ));
      params( 267 ) := "+"( Integer'Pos( a_adult.mntpay ));
      params( 268 ) := "+"( Integer'Pos( a_adult.mntpd1 ));
      params( 269 ) := "+"( Integer'Pos( a_adult.mntpd2 ));
      params( 270 ) := "+"( Integer'Pos( a_adult.mntrec ));
      params( 271 ) := "+"( Integer'Pos( a_adult.mntus1 ));
      params( 272 ) := "+"( Integer'Pos( a_adult.mntus2 ));
      params( 273 ) := "+"( Float( a_adult.mntusam1 ));
      params( 274 ) := "+"( Float( a_adult.mntusam2 ));
      params( 275 ) := "+"( Integer'Pos( a_adult.mntuspd1 ));
      params( 276 ) := "+"( Integer'Pos( a_adult.mntuspd2 ));
      params( 277 ) := "+"( Integer'Pos( a_adult.moneysat ));
      params( 278 ) := "+"( Integer'Pos( a_adult.ms ));
      params( 279 ) := "+"( Integer'Pos( a_adult.nanid1 ));
      params( 280 ) := "+"( Integer'Pos( a_adult.nanid2 ));
      params( 281 ) := "+"( Integer'Pos( a_adult.nanid3 ));
      params( 282 ) := "+"( Integer'Pos( a_adult.nanid4 ));
      params( 283 ) := "+"( Integer'Pos( a_adult.nanid5 ));
      params( 284 ) := "+"( Integer'Pos( a_adult.nanid6 ));
      params( 285 ) := "+"( Integer'Pos( a_adult.nervous ));
      params( 286 ) := "+"( Integer'Pos( a_adult.ni2train ));
      params( 287 ) := "+"( Float( a_adult.niamt ));
      params( 288 ) := "+"( Integer'Pos( a_adult.nietngrp ));
      params( 289 ) := "+"( Integer'Pos( a_adult.niexthbb ));
      params( 290 ) := "+"( Integer'Pos( a_adult.ninanid1 ));
      params( 291 ) := "+"( Integer'Pos( a_adult.ninanid2 ));
      params( 292 ) := "+"( Integer'Pos( a_adult.ninanid3 ));
      params( 293 ) := "+"( Integer'Pos( a_adult.ninanid4 ));
      params( 294 ) := "+"( Integer'Pos( a_adult.ninanid5 ));
      params( 295 ) := "+"( Integer'Pos( a_adult.ninanid6 ));
      params( 296 ) := "+"( Integer'Pos( a_adult.ninanid7 ));
      params( 297 ) := "+"( Integer'Pos( a_adult.nipd ));
      params( 298 ) := "+"( Integer'Pos( a_adult.nireg ));
      params( 299 ) := "+"( Integer'Pos( a_adult.nirelig ));
      params( 300 ) := "+"( Integer'Pos( a_adult.nolk1 ));
      params( 301 ) := "+"( Integer'Pos( a_adult.nolk2 ));
      params( 302 ) := "+"( Integer'Pos( a_adult.nolk3 ));
      params( 303 ) := "+"( Integer'Pos( a_adult.nowant ));
      params( 304 ) := "+"( Float( a_adult.nssec ));
      params( 305 ) := "+"( Integer'Pos( a_adult.numjob ));
      params( 306 ) := "+"( Integer'Pos( a_adult.numjob2 ));
      params( 307 ) := "+"( Integer'Pos( a_adult.nvqlenow ));
      params( 308 ) := "+"( Integer'Pos( a_adult.nvqlev ));
      params( 309 ) := "+"( Integer'Pos( a_adult.oddjob ));
      params( 310 ) := "+"( Integer'Pos( a_adult.oldstud ));
      params( 311 ) := "+"( Integer'Pos( a_adult.otabspar ));
      params( 312 ) := "+"( Float( a_adult.otamt ));
      params( 313 ) := "+"( Float( a_adult.otapamt ));
      params( 314 ) := "+"( Integer'Pos( a_adult.otappd ));
      params( 315 ) := "+"( Integer'Pos( a_adult.othben1 ));
      params( 316 ) := "+"( Integer'Pos( a_adult.othben2 ));
      params( 317 ) := "+"( Integer'Pos( a_adult.othben3 ));
      params( 318 ) := "+"( Integer'Pos( a_adult.othben4 ));
      params( 319 ) := "+"( Integer'Pos( a_adult.othben5 ));
      params( 320 ) := "+"( Integer'Pos( a_adult.othben6 ));
      params( 321 ) := "+"( Integer'Pos( a_adult.othpass ));
      params( 322 ) := "+"( Integer'Pos( a_adult.othqual1 ));
      params( 323 ) := "+"( Integer'Pos( a_adult.othqual2 ));
      params( 324 ) := "+"( Integer'Pos( a_adult.othqual3 ));
      params( 325 ) := "+"( Integer'Pos( a_adult.othtax ));
      params( 326 ) := "+"( Integer'Pos( a_adult.othtrust ));
      params( 327 ) := "+"( Integer'Pos( a_adult.otinva ));
      params( 328 ) := "+"( Float( a_adult.pareamt ));
      params( 329 ) := "+"( Integer'Pos( a_adult.parepd ));
      params( 330 ) := "+"( Integer'Pos( a_adult.penben1 ));
      params( 331 ) := "+"( Integer'Pos( a_adult.penben2 ));
      params( 332 ) := "+"( Integer'Pos( a_adult.penben3 ));
      params( 333 ) := "+"( Integer'Pos( a_adult.penben4 ));
      params( 334 ) := "+"( Integer'Pos( a_adult.penben5 ));
      params( 335 ) := "+"( Integer'Pos( a_adult.penflag ));
      params( 336 ) := "+"( Integer'Pos( a_adult.penlump ));
      params( 337 ) := "+"( Integer'Pos( a_adult.perspen1 ));
      params( 338 ) := "+"( Integer'Pos( a_adult.perspen2 ));
      params( 339 ) := "+"( Integer'Pos( a_adult.pip1 ));
      params( 340 ) := "+"( Integer'Pos( a_adult.pip2 ));
      params( 341 ) := "+"( Integer'Pos( a_adult.pollopin ));
      params( 342 ) := "+"( Integer'Pos( a_adult.polttrus ));
      params( 343 ) := "+"( Integer'Pos( a_adult.ppchk1 ));
      params( 344 ) := "+"( Integer'Pos( a_adult.ppchk2 ));
      params( 345 ) := "+"( Integer'Pos( a_adult.ppchk3 ));
      params( 346 ) := "+"( Integer'Pos( a_adult.ppnumc ));
      params( 347 ) := "+"( Integer'Pos( a_adult.ppper ));
      params( 348 ) := "+"( Integer'Pos( a_adult.practice ));
      params( 349 ) := "+"( Integer'Pos( a_adult.privpen ));
      params( 350 ) := "+"( Float( a_adult.proptax ));
      params( 351 ) := "+"( Integer'Pos( a_adult.ptwk ));
      params( 352 ) := "+"( Integer'Pos( a_adult.r01 ));
      params( 353 ) := "+"( Integer'Pos( a_adult.r02 ));
      params( 354 ) := "+"( Integer'Pos( a_adult.r03 ));
      params( 355 ) := "+"( Integer'Pos( a_adult.r04 ));
      params( 356 ) := "+"( Integer'Pos( a_adult.r05 ));
      params( 357 ) := "+"( Integer'Pos( a_adult.r06 ));
      params( 358 ) := "+"( Integer'Pos( a_adult.r07 ));
      params( 359 ) := "+"( Integer'Pos( a_adult.r08 ));
      params( 360 ) := "+"( Integer'Pos( a_adult.r09 ));
      params( 361 ) := "+"( Integer'Pos( a_adult.r10 ));
      params( 362 ) := "+"( Integer'Pos( a_adult.r11 ));
      params( 363 ) := "+"( Integer'Pos( a_adult.r12 ));
      params( 364 ) := "+"( Integer'Pos( a_adult.r13 ));
      params( 365 ) := "+"( Integer'Pos( a_adult.r14 ));
      params( 366 ) := "+"( Integer'Pos( a_adult.reasden ));
      params( 367 ) := "+"( Integer'Pos( a_adult.reasmed ));
      params( 368 ) := "+"( Integer'Pos( a_adult.reasnhs ));
      params( 369 ) := "+"( Integer'Pos( a_adult.reason ));
      params( 370 ) := "+"( Integer'Pos( a_adult.recsat ));
      params( 371 ) := "+"( Float( a_adult.redamt ));
      params( 372 ) := "+"( Integer'Pos( a_adult.redany ));
      params( 373 ) := "+"( Integer'Pos( a_adult.rednet ));
      params( 374 ) := "+"( Float( a_adult.redtax ));
      params( 375 ) := "+"( Integer'Pos( a_adult.relasat ));
      params( 376 ) := "+"( Integer'Pos( a_adult.religenw ));
      params( 377 ) := "+"( Integer'Pos( a_adult.religsc ));
      params( 378 ) := "+"( Integer'Pos( a_adult.rentprof ));
      params( 379 ) := "+"( Integer'Pos( a_adult.retire ));
      params( 380 ) := "+"( Integer'Pos( a_adult.retire1 ));
      params( 381 ) := "+"( Integer'Pos( a_adult.retreas ));
      params( 382 ) := "+"( Integer'Pos( a_adult.royal1 ));
      params( 383 ) := "+"( Integer'Pos( a_adult.royal2 ));
      params( 384 ) := "+"( Integer'Pos( a_adult.royal3 ));
      params( 385 ) := "+"( Integer'Pos( a_adult.royal4 ));
      params( 386 ) := "+"( Float( a_adult.royyr1 ));
      params( 387 ) := "+"( Float( a_adult.royyr2 ));
      params( 388 ) := "+"( Float( a_adult.royyr3 ));
      params( 389 ) := "+"( Float( a_adult.royyr4 ));
      params( 390 ) := "+"( Integer'Pos( a_adult.rsa ));
      params( 391 ) := "+"( Integer'Pos( a_adult.rsanow ));
      params( 392 ) := "+"( Integer'Pos( a_adult.rstrct ));
      params( 393 ) := "+"( Integer'Pos( a_adult.safe ));
      params( 394 ) := "+"( Integer'Pos( a_adult.samesit ));
      params( 395 ) := "+"( Integer'Pos( a_adult.schchk ));
      params( 396 ) := "+"( Integer'Pos( a_adult.scotvec ));
      params( 397 ) := "+"( Integer'Pos( a_adult.sctvnow ));
      params( 398 ) := "+"( Integer'Pos( a_adult.sdemp01 ));
      params( 399 ) := "+"( Integer'Pos( a_adult.sdemp02 ));
      params( 400 ) := "+"( Integer'Pos( a_adult.sdemp03 ));
      params( 401 ) := "+"( Integer'Pos( a_adult.sdemp04 ));
      params( 402 ) := "+"( Integer'Pos( a_adult.sdemp05 ));
      params( 403 ) := "+"( Integer'Pos( a_adult.sdemp06 ));
      params( 404 ) := "+"( Integer'Pos( a_adult.sdemp07 ));
      params( 405 ) := "+"( Integer'Pos( a_adult.sdemp08 ));
      params( 406 ) := "+"( Integer'Pos( a_adult.sdemp09 ));
      params( 407 ) := "+"( Integer'Pos( a_adult.sdemp10 ));
      params( 408 ) := "+"( Integer'Pos( a_adult.sdemp11 ));
      params( 409 ) := "+"( Integer'Pos( a_adult.sdemp12 ));
      params( 410 ) := "+"( Integer'Pos( a_adult.selfdemp ));
      params( 411 ) := "+"( Integer'Pos( a_adult.sex ));
      params( 412 ) := "+"( Integer'Pos( a_adult.sflntyp1 ));
      params( 413 ) := "+"( Integer'Pos( a_adult.sflntyp2 ));
      params( 414 ) := "+"( Integer'Pos( a_adult.sftype1 ));
      params( 415 ) := "+"( Integer'Pos( a_adult.sftype2 ));
      params( 416 ) := "+"( Integer'Pos( a_adult.sic ));
      params( 417 ) := "+"( Integer'Pos( a_adult.sidqn ));
      params( 418 ) := "+"( Float( a_adult.slrepamt ));
      params( 419 ) := "+"( Integer'Pos( a_adult.slrepay ));
      params( 420 ) := "+"( Integer'Pos( a_adult.slreppd ));
      params( 421 ) := "+"( Integer'Pos( a_adult.soc2010 ));
      params( 422 ) := "+"( Integer'Pos( a_adult.socfund1 ));
      params( 423 ) := "+"( Integer'Pos( a_adult.socfund2 ));
      params( 424 ) := "+"( Integer'Pos( a_adult.socfund3 ));
      params( 425 ) := "+"( Integer'Pos( a_adult.socfund4 ));
      params( 426 ) := "+"( Integer'Pos( a_adult.spcreg1 ));
      params( 427 ) := "+"( Integer'Pos( a_adult.spcreg2 ));
      params( 428 ) := "+"( Integer'Pos( a_adult.spcreg3 ));
      params( 429 ) := "+"( Integer'Pos( a_adult.spnumc ));
      params( 430 ) := "+"( Integer'Pos( a_adult.spout ));
      params( 431 ) := "+"( Integer'Pos( a_adult.spyrot ));
      params( 432 ) := "+"( Float( a_adult.srentamt ));
      params( 433 ) := "+"( Integer'Pos( a_adult.srentpd ));
      params( 434 ) := "+"( Integer'Pos( a_adult.srispc ));
      params( 435 ) := "+"( Integer'Pos( a_adult.srjsaesa ));
      params( 436 ) := "+"( Integer'Pos( a_adult.stakep ));
      params( 437 ) := "+"( Integer'Pos( a_adult.start ));
      params( 438 ) := "+"( Integer'Pos( a_adult.tcever1 ));
      params( 439 ) := "+"( Integer'Pos( a_adult.tcever2 ));
      params( 440 ) := "+"( Integer'Pos( a_adult.tcrepay1 ));
      params( 441 ) := "+"( Integer'Pos( a_adult.tcrepay2 ));
      params( 442 ) := "+"( Integer'Pos( a_adult.tcrepay3 ));
      params( 443 ) := "+"( Integer'Pos( a_adult.tcrepay4 ));
      params( 444 ) := "+"( Integer'Pos( a_adult.tcrepay5 ));
      params( 445 ) := "+"( Integer'Pos( a_adult.tcrepay6 ));
      params( 446 ) := "+"( Integer'Pos( a_adult.tcthsyr1 ));
      params( 447 ) := "+"( Integer'Pos( a_adult.tcthsyr2 ));
      params( 448 ) := "+"( Integer'Pos( a_adult.tdaywrk ));
      params( 449 ) := "+"( Integer'Pos( a_adult.tea ));
      params( 450 ) := "+"( Integer'Pos( a_adult.tea9697 ));
      params( 451 ) := "+"( Integer'Pos( a_adult.tempjob ));
      params( 452 ) := "+"( Integer'Pos( a_adult.timesat ));
      params( 453 ) := "+"( Integer'Pos( a_adult.topupl ));
      params( 454 ) := "+"( Float( a_adult.totint ));
      params( 455 ) := "+"( Integer'Pos( a_adult.train2 ));
      params( 456 ) := "+"( Integer'Pos( a_adult.trainee ));
      params( 457 ) := "+"( Integer'Pos( a_adult.trnallow ));
      params( 458 ) := "+"( Float( a_adult.ttbprx ));
      params( 459 ) := "+"( Integer'Pos( a_adult.tuborr ));
      params( 460 ) := "+"( Integer'Pos( a_adult.typeed ));
      params( 461 ) := "+"( Integer'Pos( a_adult.unpaid1 ));
      params( 462 ) := "+"( Integer'Pos( a_adult.unpaid2 ));
      params( 463 ) := "+"( Integer'Pos( a_adult.w1 ));
      params( 464 ) := "+"( Integer'Pos( a_adult.w2 ));
      params( 465 ) := "+"( Integer'Pos( a_adult.wageben1 ));
      params( 466 ) := "+"( Integer'Pos( a_adult.wageben2 ));
      params( 467 ) := "+"( Integer'Pos( a_adult.wageben3 ));
      params( 468 ) := "+"( Integer'Pos( a_adult.wageben4 ));
      params( 469 ) := "+"( Integer'Pos( a_adult.wageben5 ));
      params( 470 ) := "+"( Integer'Pos( a_adult.wageben6 ));
      params( 471 ) := "+"( Integer'Pos( a_adult.wageben7 ));
      params( 472 ) := "+"( Integer'Pos( a_adult.wageben8 ));
      params( 473 ) := "+"( Integer'Pos( a_adult.wait ));
      params( 474 ) := "+"( Integer'Pos( a_adult.whoresp ));
      params( 475 ) := "+"( Integer'Pos( a_adult.whosectb ));
      params( 476 ) := "+"( Integer'Pos( a_adult.wintfuel ));
      params( 477 ) := "+"( Integer'Pos( a_adult.working ));
      params( 478 ) := "+"( Integer'Pos( a_adult.wpa ));
      params( 479 ) := "+"( Integer'Pos( a_adult.wpba ));
      params( 480 ) := "+"( Integer'Pos( a_adult.wtclum1 ));
      params( 481 ) := "+"( Integer'Pos( a_adult.wtclum2 ));
      params( 482 ) := "+"( Integer'Pos( a_adult.ystrtwk ));
      params( 483 ) := "+"( Integer'Pos( a_adult.month ));
      params( 484 ) := "+"( Integer'Pos( a_adult.able ));
      params( 485 ) := "+"( Integer'Pos( a_adult.actacci ));
      params( 486 ) := "+"( Integer'Pos( a_adult.age80 ));
      params( 487 ) := "+"( Integer'Pos( a_adult.agehq80 ));
      params( 488 ) := "+"( Integer'Pos( a_adult.basacti ));
      params( 489 ) := "+"( Integer'Pos( a_adult.careab ));
      params( 490 ) := "+"( Integer'Pos( a_adult.careah ));
      params( 491 ) := "+"( Integer'Pos( a_adult.carecb ));
      params( 492 ) := "+"( Integer'Pos( a_adult.carech ));
      params( 493 ) := "+"( Integer'Pos( a_adult.carecl ));
      params( 494 ) := "+"( Integer'Pos( a_adult.carefl ));
      params( 495 ) := "+"( Integer'Pos( a_adult.carefr ));
      params( 496 ) := "+"( Integer'Pos( a_adult.careot ));
      params( 497 ) := "+"( Integer'Pos( a_adult.carere ));
      params( 498 ) := "+"( Integer'Pos( a_adult.chbflg ));
      params( 499 ) := "+"( Integer'Pos( a_adult.corignan ));
      params( 500 ) := "+"( Integer'Pos( a_adult.curacti ));
      params( 501 ) := "+"( Integer'Pos( a_adult.currjobm ));
      params( 502 ) := "+"( Integer'Pos( a_adult.disacta1 ));
      params( 503 ) := "+"( Integer'Pos( a_adult.discora1 ));
      params( 504 ) := "+"( Integer'Pos( a_adult.dobmonth ));
      params( 505 ) := "+"( Integer'Pos( a_adult.dobyear ));
      params( 506 ) := "+"( Float( a_adult.empoccp ));
      params( 507 ) := "+"( Integer'Pos( a_adult.empstatb ));
      params( 508 ) := "+"( Integer'Pos( a_adult.empstatc ));
      params( 509 ) := "+"( Integer'Pos( a_adult.empstati ));
      params( 510 ) := "+"( Integer'Pos( a_adult.ethgr3 ));
      params( 511 ) := "+"( Integer'Pos( a_adult.gebacti ));
      params( 512 ) := "+"( Integer'Pos( a_adult.giltcti ));
      params( 513 ) := "+"( Integer'Pos( a_adult.gross4 ));
      params( 514 ) := "+"( Integer'Pos( a_adult.hdage ));
      params( 515 ) := "+"( Integer'Pos( a_adult.hdben ));
      params( 516 ) := "+"( Integer'Pos( a_adult.hdindinc ));
      params( 517 ) := "+"( Float( a_adult.heartval ));
      params( 518 ) := "+"( Integer'Pos( a_adult.hourab ));
      params( 519 ) := "+"( Integer'Pos( a_adult.hourah ));
      params( 520 ) := "+"( Float( a_adult.hourcare ));
      params( 521 ) := "+"( Integer'Pos( a_adult.hourcb ));
      params( 522 ) := "+"( Integer'Pos( a_adult.hourch ));
      params( 523 ) := "+"( Integer'Pos( a_adult.hourcl ));
      params( 524 ) := "+"( Integer'Pos( a_adult.hourfr ));
      params( 525 ) := "+"( Integer'Pos( a_adult.hourot ));
      params( 526 ) := "+"( Integer'Pos( a_adult.hourre ));
      params( 527 ) := "+"( Integer'Pos( a_adult.hourtot ));
      params( 528 ) := "+"( Integer'Pos( a_adult.hperson ));
      params( 529 ) := "+"( Integer'Pos( a_adult.iagegr2 ));
      params( 530 ) := "+"( Integer'Pos( a_adult.iagegr3 ));
      params( 531 ) := "+"( Integer'Pos( a_adult.iagegr4 ));
      params( 532 ) := "+"( Integer'Pos( a_adult.iagegrp ));
      params( 533 ) := "+"( Float( a_adult.incseo2 ));
      params( 534 ) := "+"( Integer'Pos( a_adult.indinc ));
      params( 535 ) := "+"( Integer'Pos( a_adult.indisben ));
      params( 536 ) := "+"( Float( a_adult.inearns ));
      params( 537 ) := "+"( Float( a_adult.ininv ));
      params( 538 ) := "+"( Integer'Pos( a_adult.inirben ));
      params( 539 ) := "+"( Integer'Pos( a_adult.innirben ));
      params( 540 ) := "+"( Integer'Pos( a_adult.inothben ));
      params( 541 ) := "+"( Float( a_adult.inpeninc ));
      params( 542 ) := "+"( Float( a_adult.inrinc ));
      params( 543 ) := "+"( Float( a_adult.inrpinc ));
      params( 544 ) := "+"( Float( a_adult.intvlic ));
      params( 545 ) := "+"( Float( a_adult.intxcred ));
      params( 546 ) := "+"( Integer'Pos( a_adult.isacti ));
      params( 547 ) := "+"( Integer'Pos( a_adult.marital ));
      params( 548 ) := "+"( Integer'Pos( a_adult.mjobsect ));
      params( 549 ) := "+"( Integer'Pos( a_adult.ninanida ));
      params( 550 ) := "+"( Float( a_adult.nincseo2 ));
      params( 551 ) := "+"( Integer'Pos( a_adult.nindinc ));
      params( 552 ) := "+"( Integer'Pos( a_adult.ninearns ));
      params( 553 ) := "+"( Integer'Pos( a_adult.nininv ));
      params( 554 ) := "+"( Integer'Pos( a_adult.ninnirbn ));
      params( 555 ) := "+"( Integer'Pos( a_adult.ninothbn ));
      params( 556 ) := "+"( Integer'Pos( a_adult.ninpenin ));
      params( 557 ) := "+"( Integer'Pos( a_adult.ninrinc ));
      params( 558 ) := "+"( Float( a_adult.ninsein2 ));
      params( 559 ) := "+"( Integer'Pos( a_adult.nirel2 ));
      params( 560 ) := "+"( Integer'Pos( a_adult.occupnum ));
      params( 561 ) := "+"( Integer'Pos( a_adult.pepscti ));
      params( 562 ) := "+"( Integer'Pos( a_adult.poaccti ));
      params( 563 ) := "+"( Integer'Pos( a_adult.pocardi ));
      params( 564 ) := "+"( Integer'Pos( a_adult.prevjobm ));
      params( 565 ) := "+"( Integer'Pos( a_adult.relhrp ));
      params( 566 ) := "+"( Float( a_adult.sapadj ));
      params( 567 ) := "+"( Float( a_adult.seincam2 ));
      params( 568 ) := "+"( Float( a_adult.smpadj ));
      params( 569 ) := "+"( Float( a_adult.sppadj ));
      params( 570 ) := "+"( Float( a_adult.sspadj ));
      params( 571 ) := "+"( Integer'Pos( a_adult.stshcti ));
      params( 572 ) := "+"( Integer'Pos( a_adult.taxpayer ));
      params( 573 ) := "+"( Integer'Pos( a_adult.tesscti ));
      params( 574 ) := "+"( Float( a_adult.totgrant ));
      params( 575 ) := "+"( Float( a_adult.tothours ));
      params( 576 ) := "+"( Float( a_adult.totoccp ));
      params( 577 ) := "+"( Integer'Pos( a_adult.typeed2 ));
      params( 578 ) := "+"( Integer'Pos( a_adult.untrcti ));
      params( 579 ) := "+"( Integer'Pos( a_adult.uperson ));
      params( 580 ) := "+"( Integer'Pos( a_adult.w45 ));
      params( 581 ) := "+"( Float( a_adult.widoccp ));
      params( 582 ) := "+"( Integer'Pos( a_adult.xbonflag ));
      params( 583 ) := "+"( Integer'Pos( a_adult.anxious ));
      params( 584 ) := "+"( Integer'Pos( a_adult.candgnow ));
      params( 585 ) := "+"( Integer'Pos( a_adult.curothf ));
      params( 586 ) := "+"( Integer'Pos( a_adult.curothp ));
      params( 587 ) := "+"( Integer'Pos( a_adult.curothwv ));
      params( 588 ) := "+"( Integer'Pos( a_adult.dvhiqual ));
      params( 589 ) := "+"( Integer'Pos( a_adult.gnvqnow ));
      params( 590 ) := "+"( Integer'Pos( a_adult.gpuc ));
      params( 591 ) := "+"( Integer'Pos( a_adult.happywb ));
      params( 592 ) := "+"( Integer'Pos( a_adult.hi1qual7 ));
      params( 593 ) := "+"( Integer'Pos( a_adult.hi1qual8 ));
      params( 594 ) := "+"( Integer'Pos( a_adult.mntarr5 ));
      params( 595 ) := "+"( Integer'Pos( a_adult.mntnoch1 ));
      params( 596 ) := "+"( Integer'Pos( a_adult.mntnoch2 ));
      params( 597 ) := "+"( Integer'Pos( a_adult.mntnoch3 ));
      params( 598 ) := "+"( Integer'Pos( a_adult.mntnoch4 ));
      params( 599 ) := "+"( Integer'Pos( a_adult.mntnoch5 ));
      params( 600 ) := "+"( Integer'Pos( a_adult.mntpro1 ));
      params( 601 ) := "+"( Integer'Pos( a_adult.mntpro2 ));
      params( 602 ) := "+"( Integer'Pos( a_adult.mntpro3 ));
      params( 603 ) := "+"( Integer'Pos( a_adult.mnttim1 ));
      params( 604 ) := "+"( Integer'Pos( a_adult.mnttim2 ));
      params( 605 ) := "+"( Integer'Pos( a_adult.mnttim3 ));
      params( 606 ) := "+"( Integer'Pos( a_adult.mntwrk1 ));
      params( 607 ) := "+"( Integer'Pos( a_adult.mntwrk2 ));
      params( 608 ) := "+"( Integer'Pos( a_adult.mntwrk3 ));
      params( 609 ) := "+"( Integer'Pos( a_adult.mntwrk4 ));
      params( 610 ) := "+"( Integer'Pos( a_adult.mntwrk5 ));
      params( 611 ) := "+"( Integer'Pos( a_adult.ndeplnow ));
      params( 612 ) := "+"( Integer'Pos( a_adult.oqualc1 ));
      params( 613 ) := "+"( Integer'Pos( a_adult.oqualc2 ));
      params( 614 ) := "+"( Integer'Pos( a_adult.oqualc3 ));
      params( 615 ) := "+"( Integer'Pos( a_adult.sruc ));
      params( 616 ) := "+"( Integer'Pos( a_adult.webacnow ));
      params( 617 ) := "+"( Integer'Pos( a_adult.indeth ));
      params( 618 ) := "+"( Integer'Pos( a_adult.euactive ));
      params( 619 ) := "+"( Integer'Pos( a_adult.euactno ));
      params( 620 ) := "+"( Integer'Pos( a_adult.euartact ));
      params( 621 ) := "+"( Integer'Pos( a_adult.euaskhlp ));
      params( 622 ) := "+"( Integer'Pos( a_adult.eucinema ));
      params( 623 ) := "+"( Integer'Pos( a_adult.eucultur ));
      params( 624 ) := "+"( Integer'Pos( a_adult.euinvol ));
      params( 625 ) := "+"( Integer'Pos( a_adult.eulivpe ));
      params( 626 ) := "+"( Integer'Pos( a_adult.eumtfam ));
      params( 627 ) := "+"( Integer'Pos( a_adult.eumtfrnd ));
      params( 628 ) := "+"( Integer'Pos( a_adult.eusocnet ));
      params( 629 ) := "+"( Integer'Pos( a_adult.eusport ));
      params( 630 ) := "+"( Integer'Pos( a_adult.eutkfam ));
      params( 631 ) := "+"( Integer'Pos( a_adult.eutkfrnd ));
      params( 632 ) := "+"( Integer'Pos( a_adult.eutkmat ));
      params( 633 ) := "+"( Integer'Pos( a_adult.euvol ));
      params( 634 ) := "+"( Integer'Pos( a_adult.natscot ));
      params( 635 ) := "+"( Integer'Pos( a_adult.ntsctnow ));
      params( 636 ) := "+"( Integer'Pos( a_adult.penwel1 ));
      params( 637 ) := "+"( Integer'Pos( a_adult.penwel2 ));
      params( 638 ) := "+"( Integer'Pos( a_adult.penwel3 ));
      params( 639 ) := "+"( Integer'Pos( a_adult.penwel4 ));
      params( 640 ) := "+"( Integer'Pos( a_adult.penwel5 ));
      params( 641 ) := "+"( Integer'Pos( a_adult.penwel6 ));
      params( 642 ) := "+"( Integer'Pos( a_adult.skiwknow ));
      params( 643 ) := "+"( Integer'Pos( a_adult.skiwrk ));
      params( 644 ) := "+"( Integer'Pos( a_adult.slos ));
      params( 645 ) := "+"( Integer'Pos( a_adult.yjblev ));
      params( 646 ) := "+"( Integer'Pos( a_adult.abs2no ));
      params( 647 ) := "+"( Integer'Pos( a_adult.accftpt ));
      params( 648 ) := "+"( Integer'Pos( a_adult.b2qfut1 ));
      params( 649 ) := "+"( Integer'Pos( a_adult.b2qfut2 ));
      params( 650 ) := "+"( Integer'Pos( a_adult.b2qfut3 ));
      params( 651 ) := "+"( Integer'Pos( a_adult.b3qfut1 ));
      params( 652 ) := "+"( Integer'Pos( a_adult.b3qfut2 ));
      params( 653 ) := "+"( Integer'Pos( a_adult.b3qfut3 ));
      params( 654 ) := "+"( Integer'Pos( a_adult.b3qfut4 ));
      params( 655 ) := "+"( Integer'Pos( a_adult.b3qfut5 ));
      params( 656 ) := "+"( Integer'Pos( a_adult.b3qfut6 ));
      params( 657 ) := "+"( Integer'Pos( a_adult.ben1q1 ));
      params( 658 ) := "+"( Integer'Pos( a_adult.ben1q2 ));
      params( 659 ) := "+"( Integer'Pos( a_adult.ben1q3 ));
      params( 660 ) := "+"( Integer'Pos( a_adult.ben1q4 ));
      params( 661 ) := "+"( Integer'Pos( a_adult.ben1q5 ));
      params( 662 ) := "+"( Integer'Pos( a_adult.ben1q6 ));
      params( 663 ) := "+"( Integer'Pos( a_adult.ben1q7 ));
      params( 664 ) := "+"( Integer'Pos( a_adult.ben2q1 ));
      params( 665 ) := "+"( Integer'Pos( a_adult.ben2q2 ));
      params( 666 ) := "+"( Integer'Pos( a_adult.ben2q3 ));
      params( 667 ) := "+"( Integer'Pos( a_adult.ben3q1 ));
      params( 668 ) := "+"( Integer'Pos( a_adult.ben3q2 ));
      params( 669 ) := "+"( Integer'Pos( a_adult.ben3q3 ));
      params( 670 ) := "+"( Integer'Pos( a_adult.ben3q4 ));
      params( 671 ) := "+"( Integer'Pos( a_adult.ben3q5 ));
      params( 672 ) := "+"( Integer'Pos( a_adult.ben3q6 ));
      params( 673 ) := "+"( Integer'Pos( a_adult.ben4q1 ));
      params( 674 ) := "+"( Integer'Pos( a_adult.ben4q2 ));
      params( 675 ) := "+"( Integer'Pos( a_adult.ben4q3 ));
      params( 676 ) := "+"( Integer'Pos( a_adult.ben5q1 ));
      params( 677 ) := "+"( Integer'Pos( a_adult.ben5q2 ));
      params( 678 ) := "+"( Integer'Pos( a_adult.ben5q3 ));
      params( 679 ) := "+"( Integer'Pos( a_adult.ben5q4 ));
      params( 680 ) := "+"( Integer'Pos( a_adult.ben5q5 ));
      params( 681 ) := "+"( Integer'Pos( a_adult.ben5q6 ));
      params( 682 ) := "+"( Integer'Pos( a_adult.ben7q1 ));
      params( 683 ) := "+"( Integer'Pos( a_adult.ben7q2 ));
      params( 684 ) := "+"( Integer'Pos( a_adult.ben7q3 ));
      params( 685 ) := "+"( Integer'Pos( a_adult.ben7q4 ));
      params( 686 ) := "+"( Integer'Pos( a_adult.ben7q5 ));
      params( 687 ) := "+"( Integer'Pos( a_adult.ben7q6 ));
      params( 688 ) := "+"( Integer'Pos( a_adult.ben7q7 ));
      params( 689 ) := "+"( Integer'Pos( a_adult.ben7q8 ));
      params( 690 ) := "+"( Integer'Pos( a_adult.ben7q9 ));
      params( 691 ) := "+"( Integer'Pos( a_adult.btwacc ));
      params( 692 ) := "+"( Integer'Pos( a_adult.dentist ));
      params( 693 ) := "+"( Integer'Pos( a_adult.disdif1 ));
      params( 694 ) := "+"( Integer'Pos( a_adult.disdif2 ));
      params( 695 ) := "+"( Integer'Pos( a_adult.disdif3 ));
      params( 696 ) := "+"( Integer'Pos( a_adult.disdif4 ));
      params( 697 ) := "+"( Integer'Pos( a_adult.disdif5 ));
      params( 698 ) := "+"( Integer'Pos( a_adult.disdif6 ));
      params( 699 ) := "+"( Integer'Pos( a_adult.disdif7 ));
      params( 700 ) := "+"( Integer'Pos( a_adult.disdif8 ));
      params( 701 ) := "+"( Integer'Pos( a_adult.dptcboth ));
      params( 702 ) := "+"( Integer'Pos( a_adult.dptclum ));
      params( 703 ) := "+"( Integer'Pos( a_adult.ed1borr ));
      params( 704 ) := "+"( Integer'Pos( a_adult.ed1int ));
      params( 705 ) := "+"( a_adult.ed1monyr );
      params( 706 ) := "+"( Integer'Pos( a_adult.ed2borr ));
      params( 707 ) := "+"( Integer'Pos( a_adult.ed2int ));
      params( 708 ) := "+"( a_adult.ed2monyr );
      params( 709 ) := "+"( Integer'Pos( a_adult.edattn1 ));
      params( 710 ) := "+"( Integer'Pos( a_adult.edattn2 ));
      params( 711 ) := "+"( Integer'Pos( a_adult.edattn3 ));
      params( 712 ) := "+"( Integer'Pos( a_adult.edtime ));
      params( 713 ) := "+"( Integer'Pos( a_adult.emppay1 ));
      params( 714 ) := "+"( Integer'Pos( a_adult.emppay2 ));
      params( 715 ) := "+"( Integer'Pos( a_adult.emppay3 ));
      params( 716 ) := "+"( Integer'Pos( a_adult.endyr ));
      params( 717 ) := "+"( Integer'Pos( a_adult.epcur ));
      params( 718 ) := "+"( Integer'Pos( a_adult.ethgrp ));
      params( 719 ) := "+"( Integer'Pos( a_adult.exthbct2 ));
      params( 720 ) := "+"( Integer'Pos( a_adult.exthbct3 ));
      params( 721 ) := "+"( Integer'Pos( a_adult.eyetest ));
      params( 722 ) := "+"( Integer'Pos( a_adult.follow ));
      params( 723 ) := "+"( Integer'Pos( a_adult.future ));
      params( 724 ) := "+"( Integer'Pos( a_adult.govpis ));
      params( 725 ) := "+"( Integer'Pos( a_adult.govpjsa ));
      params( 726 ) := "+"( Float( a_adult.hbothamt ));
      params( 727 ) := "+"( Integer'Pos( a_adult.hbothbu ));
      params( 728 ) := "+"( Integer'Pos( a_adult.hbothpd ));
      params( 729 ) := "+"( Integer'Pos( a_adult.hbothwk ));
      params( 730 ) := "+"( Integer'Pos( a_adult.hbotwait ));
      params( 731 ) := "+"( Integer'Pos( a_adult.health ));
      params( 732 ) := "+"( Integer'Pos( a_adult.hosp ));
      params( 733 ) := "+"( Integer'Pos( a_adult.hprob ));
      params( 734 ) := "+"( Integer'Pos( a_adult.isa3type ));
      params( 735 ) := "+"( Integer'Pos( a_adult.ln1rpint ));
      params( 736 ) := "+"( Integer'Pos( a_adult.ln2rpint ));
      params( 737 ) := "+"( Integer'Pos( a_adult.look ));
      params( 738 ) := "+"( Integer'Pos( a_adult.lookwk ));
      params( 739 ) := "+"( Integer'Pos( a_adult.mntct ));
      params( 740 ) := "+"( Integer'Pos( a_adult.mntfor1 ));
      params( 741 ) := "+"( Integer'Pos( a_adult.mntfor2 ));
      params( 742 ) := "+"( Integer'Pos( a_adult.mnttota1 ));
      params( 743 ) := "+"( Integer'Pos( a_adult.mnttota2 ));
      params( 744 ) := "+"( Integer'Pos( a_adult.natid1 ));
      params( 745 ) := "+"( Integer'Pos( a_adult.natid2 ));
      params( 746 ) := "+"( Integer'Pos( a_adult.natid3 ));
      params( 747 ) := "+"( Integer'Pos( a_adult.natid4 ));
      params( 748 ) := "+"( Integer'Pos( a_adult.natid5 ));
      params( 749 ) := "+"( Integer'Pos( a_adult.natid6 ));
      params( 750 ) := "+"( Integer'Pos( a_adult.ndeal ));
      params( 751 ) := "+"( Integer'Pos( a_adult.newdtype ));
      params( 752 ) := "+"( Integer'Pos( a_adult.nhs1 ));
      params( 753 ) := "+"( Integer'Pos( a_adult.nhs2 ));
      params( 754 ) := "+"( Integer'Pos( a_adult.nhs3 ));
      params( 755 ) := "+"( Integer'Pos( a_adult.niethgrp ));
      params( 756 ) := "+"( Integer'Pos( a_adult.ninatid1 ));
      params( 757 ) := "+"( Integer'Pos( a_adult.ninatid2 ));
      params( 758 ) := "+"( Integer'Pos( a_adult.ninatid3 ));
      params( 759 ) := "+"( Integer'Pos( a_adult.ninatid4 ));
      params( 760 ) := "+"( Integer'Pos( a_adult.ninatid5 ));
      params( 761 ) := "+"( Integer'Pos( a_adult.ninatid6 ));
      params( 762 ) := "+"( Integer'Pos( a_adult.ninatid7 ));
      params( 763 ) := "+"( Integer'Pos( a_adult.ninatid8 ));
      params( 764 ) := "+"( Integer'Pos( a_adult.nirel ));
      params( 765 ) := "+"( Integer'Pos( a_adult.nitrain ));
      params( 766 ) := "+"( Integer'Pos( a_adult.nlper ));
      params( 767 ) := "+"( Integer'Pos( a_adult.nolook ));
      params( 768 ) := "+"( Integer'Pos( a_adult.ntcapp ));
      params( 769 ) := "+"( Integer'Pos( a_adult.ntcdat ));
      params( 770 ) := "+"( Float( a_adult.ntcinc ));
      params( 771 ) := "+"( Integer'Pos( a_adult.ntcorig1 ));
      params( 772 ) := "+"( Integer'Pos( a_adult.ntcorig2 ));
      params( 773 ) := "+"( Integer'Pos( a_adult.ntcorig3 ));
      params( 774 ) := "+"( Integer'Pos( a_adult.ntcorig4 ));
      params( 775 ) := "+"( Integer'Pos( a_adult.ntcorig5 ));
      params( 776 ) := "+"( Integer'Pos( a_adult.prit ));
      params( 777 ) := "+"( Integer'Pos( a_adult.prscrpt ));
      params( 778 ) := "+"( Integer'Pos( a_adult.soc2000 ));
      params( 779 ) := "+"( Integer'Pos( a_adult.specs ));
      params( 780 ) := "+"( Integer'Pos( a_adult.startyr ));
      params( 781 ) := "+"( Integer'Pos( a_adult.taxcred1 ));
      params( 782 ) := "+"( Integer'Pos( a_adult.taxcred2 ));
      params( 783 ) := "+"( Integer'Pos( a_adult.taxcred3 ));
      params( 784 ) := "+"( Integer'Pos( a_adult.taxcred4 ));
      params( 785 ) := "+"( Integer'Pos( a_adult.taxcred5 ));
      params( 786 ) := "+"( Integer'Pos( a_adult.taxfut ));
      params( 787 ) := "+"( Integer'Pos( a_adult.train ));
      params( 788 ) := "+"( Integer'Pos( a_adult.trav ));
      params( 789 ) := "+"( Integer'Pos( a_adult.voucher ));
      params( 790 ) := "+"( Integer'Pos( a_adult.war1 ));
      params( 791 ) := "+"( Integer'Pos( a_adult.war2 ));
      params( 792 ) := "+"( Integer'Pos( a_adult.wftcboth ));
      params( 793 ) := "+"( Integer'Pos( a_adult.wftclum ));
      params( 794 ) := "+"( Integer'Pos( a_adult.whyfrde1 ));
      params( 795 ) := "+"( Integer'Pos( a_adult.whyfrde2 ));
      params( 796 ) := "+"( Integer'Pos( a_adult.whyfrde3 ));
      params( 797 ) := "+"( Integer'Pos( a_adult.whyfrde4 ));
      params( 798 ) := "+"( Integer'Pos( a_adult.whyfrde5 ));
      params( 799 ) := "+"( Integer'Pos( a_adult.whyfrde6 ));
      params( 800 ) := "+"( Integer'Pos( a_adult.whyfrey1 ));
      params( 801 ) := "+"( Integer'Pos( a_adult.whyfrey2 ));
      params( 802 ) := "+"( Integer'Pos( a_adult.whyfrey3 ));
      params( 803 ) := "+"( Integer'Pos( a_adult.whyfrey4 ));
      params( 804 ) := "+"( Integer'Pos( a_adult.whyfrey5 ));
      params( 805 ) := "+"( Integer'Pos( a_adult.whyfrey6 ));
      params( 806 ) := "+"( Integer'Pos( a_adult.whyfrpr1 ));
      params( 807 ) := "+"( Integer'Pos( a_adult.whyfrpr2 ));
      params( 808 ) := "+"( Integer'Pos( a_adult.whyfrpr3 ));
      params( 809 ) := "+"( Integer'Pos( a_adult.whyfrpr4 ));
      params( 810 ) := "+"( Integer'Pos( a_adult.whyfrpr5 ));
      params( 811 ) := "+"( Integer'Pos( a_adult.whyfrpr6 ));
      params( 812 ) := "+"( Integer'Pos( a_adult.whytrav1 ));
      params( 813 ) := "+"( Integer'Pos( a_adult.whytrav2 ));
      params( 814 ) := "+"( Integer'Pos( a_adult.whytrav3 ));
      params( 815 ) := "+"( Integer'Pos( a_adult.whytrav4 ));
      params( 816 ) := "+"( Integer'Pos( a_adult.whytrav5 ));
      params( 817 ) := "+"( Integer'Pos( a_adult.whytrav6 ));
      params( 818 ) := "+"( Integer'Pos( a_adult.wmkit ));
      params( 819 ) := "+"( Integer'Pos( a_adult.wtclum3 ));
      params( 820 ) := "+"( Integer'Pos( a_adult.addda ));
      params( 821 ) := "+"( Float( a_adult.bntxcred ));
      params( 822 ) := "+"( Integer'Pos( a_adult.fsbndcti ));
      params( 823 ) := "+"( Float( a_adult.fwmlkval ));
      params( 824 ) := "+"( Integer'Pos( a_adult.gross2 ));
      params( 825 ) := "+"( Integer'Pos( a_adult.gross3 ));
      params( 826 ) := "+"( Float( a_adult.hbsupran ));
      params( 827 ) := "+"( Float( a_adult.netocpen ));
      params( 828 ) := "+"( Integer'Pos( a_adult.nsbocti ));
      params( 829 ) := "+"( Integer'Pos( a_adult.otbscti ));
      params( 830 ) := "+"( Integer'Pos( a_adult.prbocti ));
      params( 831 ) := "+"( Integer'Pos( a_adult.sayecti ));
      params( 832 ) := "+"( Integer'Pos( a_adult.sclbcti ));
      params( 833 ) := "+"( Integer'Pos( a_adult.sscti ));
      params( 834 ) := "+"( Float( a_adult.superan ));
      params( 835 ) := "+"( Float( a_adult.ttwcosts ));
      params( 836 ) := "+"( Integer'Pos( a_adult.ben5q7 ));
      params( 837 ) := "+"( Integer'Pos( a_adult.ben5q8 ));
      params( 838 ) := "+"( Integer'Pos( a_adult.ben5q9 ));
      params( 839 ) := "+"( Integer'Pos( a_adult.ddatre ));
      params( 840 ) := "+"( Integer'Pos( a_adult.disdif9 ));
      params( 841 ) := "+"( Float( a_adult.fare ));
      params( 842 ) := "+"( Integer'Pos( a_adult.nittwmod ));
      params( 843 ) := "+"( Integer'Pos( a_adult.oneway ));
      params( 844 ) := "+"( Float( a_adult.pssamt ));
      params( 845 ) := "+"( Integer'Pos( a_adult.pssdate ));
      params( 846 ) := "+"( Integer'Pos( a_adult.ttwcode1 ));
      params( 847 ) := "+"( Integer'Pos( a_adult.ttwcode2 ));
      params( 848 ) := "+"( Integer'Pos( a_adult.ttwcode3 ));
      params( 849 ) := "+"( Float( a_adult.ttwcost ));
      params( 850 ) := "+"( Integer'Pos( a_adult.ttwfar ));
      params( 851 ) := "+"( Float( a_adult.ttwfrq ));
      params( 852 ) := "+"( Integer'Pos( a_adult.ttwmod ));
      params( 853 ) := "+"( Integer'Pos( a_adult.ttwpay ));
      params( 854 ) := "+"( Integer'Pos( a_adult.ttwpss ));
      params( 855 ) := "+"( Float( a_adult.ttwrec ));
      params( 856 ) := "+"( Integer'Pos( a_adult.crunaci ));
      params( 857 ) := "+"( Integer'Pos( a_adult.enomorti ));
      params( 858 ) := "+"( Integer'Pos( a_adult.ttwmode ));
      params( 859 ) := "+"( Integer'Pos( a_adult.ddatrep ));
      params( 860 ) := "+"( Integer'Pos( a_adult.disdifp ));
      params( 861 ) := "+"( Integer'Pos( a_adult.sfrpis ));
      params( 862 ) := "+"( Integer'Pos( a_adult.sfrpjsa ));
      params( 863 ) := "+"( Integer'Pos( a_adult.ethgr2 ));
      params( 864 ) := "+"( Integer'Pos( a_adult.consent ));
      params( 865 ) := "+"( Integer'Pos( a_adult.dvpens ));
      params( 866 ) := "+"( Integer'Pos( a_adult.lnkref1 ));
      params( 867 ) := "+"( Integer'Pos( a_adult.lnkref2 ));
      params( 868 ) := "+"( Integer'Pos( a_adult.lnkref21 ));
      params( 869 ) := "+"( Integer'Pos( a_adult.lnkref22 ));
      params( 870 ) := "+"( Integer'Pos( a_adult.lnkref23 ));
      params( 871 ) := "+"( Integer'Pos( a_adult.lnkref24 ));
      params( 872 ) := "+"( Integer'Pos( a_adult.lnkref25 ));
      params( 873 ) := "+"( Integer'Pos( a_adult.lnkref3 ));
      params( 874 ) := "+"( Integer'Pos( a_adult.lnkref4 ));
      params( 875 ) := "+"( Integer'Pos( a_adult.lnkref5 ));
      params( 876 ) := "+"( Integer'Pos( a_adult.pconsent ));
      params( 877 ) := "+"( Integer'Pos( a_adult.lnkons ));
      params( 878 ) := "+"( Integer'Pos( a_adult.lnkref6 ));
      params( 879 ) := "+"( Integer'Pos( a_adult.lnkref7 ));
      params( 880 ) := "+"( Integer'Pos( a_adult.lnkref8 ));
      params( 881 ) := "+"( Integer'Pos( a_adult.lnkref9 ));
      params( 882 ) := "+"( Integer'Pos( a_adult.b3qfut7 ));
      params( 883 ) := "+"( Integer'Pos( a_adult.ben3q7 ));
      params( 884 ) := "+"( Integer'Pos( a_adult.ddaprog ));
      params( 885 ) := "+"( Integer'Pos( a_adult.hbolng ));
      params( 886 ) := "+"( Integer'Pos( a_adult.hi2qual ));
      params( 887 ) := "+"( Integer'Pos( a_adult.hlpgvn01 ));
      params( 888 ) := "+"( Integer'Pos( a_adult.hlpgvn02 ));
      params( 889 ) := "+"( Integer'Pos( a_adult.hlpgvn03 ));
      params( 890 ) := "+"( Integer'Pos( a_adult.hlpgvn04 ));
      params( 891 ) := "+"( Integer'Pos( a_adult.hlpgvn05 ));
      params( 892 ) := "+"( Integer'Pos( a_adult.hlpgvn06 ));
      params( 893 ) := "+"( Integer'Pos( a_adult.hlpgvn07 ));
      params( 894 ) := "+"( Integer'Pos( a_adult.hlpgvn08 ));
      params( 895 ) := "+"( Integer'Pos( a_adult.hlpgvn09 ));
      params( 896 ) := "+"( Integer'Pos( a_adult.hlpgvn10 ));
      params( 897 ) := "+"( Integer'Pos( a_adult.hlpgvn11 ));
      params( 898 ) := "+"( Integer'Pos( a_adult.hlprec01 ));
      params( 899 ) := "+"( Integer'Pos( a_adult.hlprec02 ));
      params( 900 ) := "+"( Integer'Pos( a_adult.hlprec03 ));
      params( 901 ) := "+"( Integer'Pos( a_adult.hlprec04 ));
      params( 902 ) := "+"( Integer'Pos( a_adult.hlprec05 ));
      params( 903 ) := "+"( Integer'Pos( a_adult.hlprec06 ));
      params( 904 ) := "+"( Integer'Pos( a_adult.hlprec07 ));
      params( 905 ) := "+"( Integer'Pos( a_adult.hlprec08 ));
      params( 906 ) := "+"( Integer'Pos( a_adult.hlprec09 ));
      params( 907 ) := "+"( Integer'Pos( a_adult.hlprec10 ));
      params( 908 ) := "+"( Integer'Pos( a_adult.hlprec11 ));
      params( 909 ) := "+"( Integer'Pos( a_adult.loangvn1 ));
      params( 910 ) := "+"( Integer'Pos( a_adult.loangvn2 ));
      params( 911 ) := "+"( Integer'Pos( a_adult.loangvn3 ));
      params( 912 ) := "+"( Integer'Pos( a_adult.loanrec1 ));
      params( 913 ) := "+"( Integer'Pos( a_adult.loanrec2 ));
      params( 914 ) := "+"( Integer'Pos( a_adult.loanrec3 ));
      params( 915 ) := "+"( Integer'Pos( a_adult.alg ));
      params( 916 ) := "+"( Float( a_adult.algamt ));
      params( 917 ) := "+"( Integer'Pos( a_adult.algpd ));
      params( 918 ) := "+"( Integer'Pos( a_adult.ben4q4 ));
      params( 919 ) := "+"( Integer'Pos( a_adult.disdifad ));
      params( 920 ) := "+"( Integer'Pos( a_adult.gross3_x ));
      params( 921 ) := "+"( Integer'Pos( a_adult.cbaamt ));
      params( 922 ) := "+"( Integer'Pos( a_adult.mednum ));
      params( 923 ) := "+"( Integer'Pos( a_adult.medprpd ));
      params( 924 ) := "+"( Integer'Pos( a_adult.medprpy ));
      params( 925 ) := "+"( Integer'Pos( a_adult.medpay ));
      params( 926 ) := "+"( Integer'Pos( a_adult.medrep ));
      params( 927 ) := "+"( Integer'Pos( a_adult.medrpnm ));
