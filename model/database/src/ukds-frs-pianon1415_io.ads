--
-- Created by ada_generator.py on 2017-10-17 22:41:54.261607
-- 
with Ukds;
with DB_Commons;
with Base_Types;
...
package Ukds.Frs.Pianon1415_IO is
   ...
   --
   -- returns true if the primary key parts of a_pianon1415 match the defaults in Ukds.Frs.Null_Pianon1415
   --
   function Is_Null( a_pianon1415 : Pianon1415 ) return Boolean;
   
   --
   -- returns the single a_pianon1415 matching the primary key fields, or the Ukds.Frs.Null_Pianon1415 record
   -- if no such record exists
   --
   function Retrieve_By_PK( user_id : Integer; edition : Integer; year : Integer; benunit : Integer; sernum : Sernum_Value; connection : Database_Connection := null ) return Ukds.Frs.Pianon1415;
   --
   ...
   --
   -- Retrieves a list of Ukds.Frs.Pianon1415 matching the criteria, or throws an exception
   --
   function Retrieve( c : d.Criteria; connection : Database_Connection := null ) return Ukds.Frs.Pianon1415_List;
   
   --
   -- Retrieves a list of Ukds.Frs.Pianon1415 retrived by the sql string, or throws an exception
   --
   function Retrieve( sqlstr : String; connection : Database_Connection := null ) return Ukds.Frs.Pianon1415_List;
   
   --
   -- Save the given record, overwriting if it exists and overwrite is true, 
   -- otherwise throws DB_Exception exception. 
   --
   procedure Save( a_pianon1415 : Ukds.Frs.Pianon1415; overwrite : Boolean := True; connection : Database_Connection := null );
   
   --
   -- Delete the given record. Throws DB_Exception exception. Sets value to Ukds.Frs.Null_Pianon1415
   --
   procedure Delete( a_pianon1415 : in out Ukds.Frs.Pianon1415; connection : Database_Connection := null );
   --
   ...
   procedure Add_pinannbu( c : in out d.Criteria; pinannbu : Integer; op : d.operation_type:= d.eq; join : d.join_type := d.join_and );
   ...
   procedure Add_pinannbu_To_Orderings( c : in out d.Criteria; direction : d.Asc_Or_Desc );
   ...
   function Map_From_Cursor( cursor : GNATCOLL.SQL.Exec.Forward_Cursor ) return Ukds.Frs.Pianon1415;
   ...
   --   11 : winpaybu                 : Parameter_Float    : Amount               :      0.0 
   --   12 : gs_newbu                 : Parameter_Integer  : Integer              :        0 
   --   13 : gs_newpp                 : Parameter_Integer  : Integer              :        0 
   --   14 : mbhcdec                  : Parameter_Integer  : Integer              :        0 
   --   15 : obhcdec                  : Parameter_Integer  : Integer              :        0 
   --   16 : mahcdec                  : Parameter_Integer  : Integer              :        0 
   --   17 : oahcdec                  : Parameter_Integer  : Integer              :        0 
   --   18 : sexsp                    : Parameter_Integer  : Integer              :        0 
   --   19 : newfamb2                 : Parameter_Integer  : Integer              :        0 
   --   20 : pidefbhc                 : Parameter_Float    : Amount               :      0.0 
   --   21 : pidefahc                 : Parameter_Float    : Amount               :      0.0 
   --   22 : pigrosbu                 : Parameter_Integer  : Integer              :        0 
   --   23 : pinincbu                 : Parameter_Integer  : Integer              :        0 
   --   24 : pigoccbu                 : Parameter_Integer  : Integer              :        0 
   --   25 : pippenbu                 : Parameter_Integer  : Integer              :        0 
   --   26 : piginvbu                 : Parameter_Integer  : Integer              :        0 
   --   27 : pigernbu                 : Parameter_Integer  : Integer              :        0 
   --   28 : pibenibu                 : Parameter_Integer  : Integer              :        0 
   --   29 : piothibu                 : Parameter_Integer  : Integer              :        0 
   --   30 : pinahcbu                 : Parameter_Integer  : Integer              :        0 
   --   31 : pinannbu                 : Parameter_Integer  : Integer              :        0 
   ...
   --   53 : sing_q1                  : Parameter_Float    : Amount               :      0.0 
   --   54 : sing_q2                  : Parameter_Float    : Amount               :      0.0 
   --   55 : sing_q3                  : Parameter_Float    : Amount               :      0.0 
   --   56 : sing_q4                  : Parameter_Float    : Amount               :      0.0 
   --   57 : sing_q5                  : Parameter_Float    : Amount               :      0.0 
   --   58 : asin_q1                  : Parameter_Float    : Amount               :      0.0 
   --   59 : asin_q2                  : Parameter_Float    : Amount               :      0.0 
   --   60 : asin_q3                  : Parameter_Float    : Amount               :      0.0 
   --   61 : asin_q4                  : Parameter_Float    : Amount               :      0.0 
   --   62 : asin_q5                  : Parameter_Float    : Amount               :      0.0 
