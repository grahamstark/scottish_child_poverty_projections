--
-- Created by ada_generator.py on 2017-09-07 21:05:09.723413
-- 
with Ukds;
...
package body Ukds.Frs.Pianon1415_IO is
   ...
   log_trace : GNATColl.Traces.Trace_Handle := GNATColl.Traces.Create( "UKDS.FRS.PIANON1415_IO" );
   ...
   SELECT_PART : constant String := "select " &
         ...
         "winpaybu, gs_newbu, gs_newpp, mbhcdec, obhcdec, mahcdec, oahcdec, sexsp, newfamb2, pidefbhc," &
         "pidefahc, pigrosbu, pinincbu, pigoccbu, pippenbu, piginvbu, pigernbu, pibenibu, piothibu, pinahcbu," &
         "pinannbu, piirbbu, pidisben, piretben, pripenbu, tvpaybu, nonben2bu, perbenbu, perbenbu2, rrpen," &
   ...
   --
   INSERT_PART : constant String := "insert into frs.pianon1415 (" &
         "user_id, edition, year, gvtregn, fambu, newfambu, sexhd, adultb, benunit, ethgrphh," &
         "winpaybu, gs_newbu, gs_newpp, mbhcdec, obhcdec, mahcdec, oahcdec, sexsp, newfamb2, pidefbhc," &
         "pidefahc, pigrosbu, pinincbu, pigoccbu, pippenbu, piginvbu, pigernbu, pibenibu, piothibu, pinahcbu," &
         "pinannbu, piirbbu, pidisben, piretben, pripenbu, tvpaybu, nonben2bu, perbenbu, perbenbu2, rrpen," &
   ...
   --
   DELETE_PART : constant String := "delete from frs.pianon1415 ";
   
   --
   -- update
   --
   UPDATE_PART : constant String := "update frs.pianon1415 set  ";
   ...
   use GNATCOLL.SQL_Impl;
      params : constant SQL_Parameters( 1 .. 67 ) := ( if update_order then (
            ...
            7 => ( Parameter_Float, 0.0 ),   --  : winpaybu (Amount)
            8 => ( Parameter_Integer, 0 ),   --  : gs_newbu (Integer)
            9 => ( Parameter_Integer, 0 ),   --  : gs_newpp (Integer)
           10 => ( Parameter_Integer, 0 ),   --  : mbhcdec (Integer)
           11 => ( Parameter_Integer, 0 ),   --  : obhcdec (Integer)
           12 => ( Parameter_Integer, 0 ),   --  : mahcdec (Integer)
           13 => ( Parameter_Integer, 0 ),   --  : oahcdec (Integer)
           14 => ( Parameter_Integer, 0 ),   --  : sexsp (Integer)
           15 => ( Parameter_Integer, 0 ),   --  : newfamb2 (Integer)
           16 => ( Parameter_Float, 0.0 ),   --  : pidefbhc (Amount)
           17 => ( Parameter_Float, 0.0 ),   --  : pidefahc (Amount)
           18 => ( Parameter_Integer, 0 ),   --  : pigrosbu (Integer)
           19 => ( Parameter_Integer, 0 ),   --  : pinincbu (Integer)
           20 => ( Parameter_Integer, 0 ),   --  : pigoccbu (Integer)
           21 => ( Parameter_Integer, 0 ),   --  : pippenbu (Integer)
           22 => ( Parameter_Integer, 0 ),   --  : piginvbu (Integer)
           23 => ( Parameter_Integer, 0 ),   --  : pigernbu (Integer)
           24 => ( Parameter_Integer, 0 ),   --  : pibenibu (Integer)
           25 => ( Parameter_Integer, 0 ),   --  : piothibu (Integer)
           26 => ( Parameter_Integer, 0 ),   --  : pinahcbu (Integer)
           27 => ( Parameter_Integer, 0 ),   --  : pinannbu (Integer)
           ...
           49 => ( Parameter_Float, 0.0 ),   --  : sing_q1 (Amount)
           50 => ( Parameter_Float, 0.0 ),   --  : sing_q2 (Amount)
           51 => ( Parameter_Float, 0.0 ),   --  : sing_q3 (Amount)
           52 => ( Parameter_Float, 0.0 ),   --  : sing_q4 (Amount)
           53 => ( Parameter_Float, 0.0 ),   --  : sing_q5 (Amount)
           54 => ( Parameter_Float, 0.0 ),   --  : asin_q1 (Amount)
           55 => ( Parameter_Float, 0.0 ),   --  : asin_q2 (Amount)
           56 => ( Parameter_Float, 0.0 ),   --  : asin_q3 (Amount)
           57 => ( Parameter_Float, 0.0 ),   --  : asin_q4 (Amount)
           58 => ( Parameter_Float, 0.0 ),   --  : asin_q5 (Amount)
           ...
           11 => ( Parameter_Float, 0.0 ),   --  : winpaybu (Amount)
           12 => ( Parameter_Integer, 0 ),   --  : gs_newbu (Integer)
           13 => ( Parameter_Integer, 0 ),   --  : gs_newpp (Integer)
           14 => ( Parameter_Integer, 0 ),   --  : mbhcdec (Integer)
           15 => ( Parameter_Integer, 0 ),   --  : obhcdec (Integer)
           16 => ( Parameter_Integer, 0 ),   --  : mahcdec (Integer)
           17 => ( Parameter_Integer, 0 ),   --  : oahcdec (Integer)
           18 => ( Parameter_Integer, 0 ),   --  : sexsp (Integer)
           19 => ( Parameter_Integer, 0 ),   --  : newfamb2 (Integer)
           20 => ( Parameter_Float, 0.0 ),   --  : pidefbhc (Amount)
           21 => ( Parameter_Float, 0.0 ),   --  : pidefahc (Amount)
           22 => ( Parameter_Integer, 0 ),   --  : pigrosbu (Integer)
           23 => ( Parameter_Integer, 0 ),   --  : pinincbu (Integer)
           24 => ( Parameter_Integer, 0 ),   --  : pigoccbu (Integer)
           25 => ( Parameter_Integer, 0 ),   --  : pippenbu (Integer)
           26 => ( Parameter_Integer, 0 ),   --  : piginvbu (Integer)
           27 => ( Parameter_Integer, 0 ),   --  : pigernbu (Integer)
           28 => ( Parameter_Integer, 0 ),   --  : pibenibu (Integer)
           29 => ( Parameter_Integer, 0 ),   --  : piothibu (Integer)
           30 => ( Parameter_Integer, 0 ),   --  : pinahcbu (Integer)
           31 => ( Parameter_Integer, 0 ),   --  : pinannbu (Integer)
           ...
           53 => ( Parameter_Float, 0.0 ),   --  : sing_q1 (Amount)
           54 => ( Parameter_Float, 0.0 ),   --  : sing_q2 (Amount)
           55 => ( Parameter_Float, 0.0 ),   --  : sing_q3 (Amount)
           56 => ( Parameter_Float, 0.0 ),   --  : sing_q4 (Amount)
           57 => ( Parameter_Float, 0.0 ),   --  : sing_q5 (Amount)
           58 => ( Parameter_Float, 0.0 ),   --  : asin_q1 (Amount)
           59 => ( Parameter_Float, 0.0 ),   --  : asin_q2 (Amount)
           60 => ( Parameter_Float, 0.0 ),   --  : asin_q3 (Amount)
           61 => ( Parameter_Float, 0.0 ),   --  : asin_q4 (Amount)
           62 => ( Parameter_Float, 0.0 ),   --  : asin_q5 (Amount)
   ...
   Next_Free_user_id_query : constant String := 
         DB_Commons.Add_Schema_To_Query( "select coalesce( max( user_id ) + 1, 1 ) from frs.pianon1415", SCHEMA_NAME );
   ...
   Next_Free_edition_query : constant String := 
         DB_Commons.Add_Schema_To_Query( "select coalesce( max( edition ) + 1, 1 ) from frs.pianon1415", SCHEMA_NAME );
   ...
   Next_Free_year_query : constant String := 
         DB_Commons.Add_Schema_To_Query( "select coalesce( max( year ) + 1, 1 ) from frs.pianon1415", SCHEMA_NAME );
   ...
   Next_Free_benunit_query : constant String := 
         DB_Commons.Add_Schema_To_Query( "select coalesce( max( benunit ) + 1, 1 ) from frs.pianon1415", SCHEMA_NAME );
   ...
   Next_Free_sernum_query : constant String := 
         DB_Commons.Add_Schema_To_Query( "select coalesce( max( sernum ) + 1, 1 ) from frs.pianon1415", SCHEMA_NAME );
   ...
   --
   -- returns true if the primary key parts of Ukds.Frs.Pianon1415 match the defaults in Ukds.Frs.Null_Pianon1415
   --
   --
   -- Does this Ukds.Frs.Pianon1415 equal the default Ukds.Frs.Null_Pianon1415 ?
   --
   function Is_Null( a_pianon1415 : Pianon1415 ) return Boolean is
   begin
      return a_pianon1415 = Ukds.Frs.Null_Pianon1415;
   end Is_Null;


   
   --
   -- returns the single Ukds.Frs.Pianon1415 matching the primary key fields, or the Ukds.Frs.Null_Pianon1415 record
   -- if no such record exists
   --
   function Retrieve_By_PK( user_id : Integer; edition : Integer; year : Integer; benunit : Integer; sernum : Sernum_Value; connection : Database_Connection := null ) return Ukds.Frs.Pianon1415 is
      l : Ukds.Frs.Pianon1415_List;
      a_pianon1415 : Ukds.Frs.Pianon1415;
      c : d.Criteria;
   begin      
      ...
      if( not Ukds.Frs.Pianon1415_List_Package.is_empty( l ) ) then
         a_pianon1415 := Ukds.Frs.Pianon1415_List_Package.First_Element( l );
      else
         a_pianon1415 := Ukds.Frs.Null_Pianon1415;
      end if;
      return a_pianon1415;
   end Retrieve_By_PK;
   ...
   EXISTS_PS : constant gse.Prepared_Statement := gse.Prepare( 
        "select 1 from frs.pianon1415 where user_id = $1 and edition = $2 and year = $3 and benunit = $4 and sernum = $5", 
        On_Server => True );
   ...
   --
   -- Retrieves a list of Pianon1415 matching the criteria, or throws an exception
   --
   function Retrieve( c : d.Criteria; connection : Database_Connection := null ) return Ukds.Frs.Pianon1415_List is
   begin      
   ...
   --
   -- Retrieves a list of Pianon1415 retrived by the sql string, or throws an exception
   --
   function Map_From_Cursor( cursor : gse.Forward_Cursor ) return Ukds.Frs.Pianon1415 is
      a_pianon1415 : Ukds.Frs.Pianon1415;
   begin
      if not gse.Is_Null( cursor, 0 )then
         a_pianon1415.user_id := gse.Integer_Value( cursor, 0 );
      end if;
      if not gse.Is_Null( cursor, 1 )then
         a_pianon1415.edition := gse.Integer_Value( cursor, 1 );
      end if;
      if not gse.Is_Null( cursor, 2 )then
         a_pianon1415.year := gse.Integer_Value( cursor, 2 );
      end if;
      if not gse.Is_Null( cursor, 3 )then
         a_pianon1415.gvtregn := gse.Integer_Value( cursor, 3 );
      end if;
      if not gse.Is_Null( cursor, 4 )then
         a_pianon1415.fambu := gse.Integer_Value( cursor, 4 );
      end if;
      if not gse.Is_Null( cursor, 5 )then
         a_pianon1415.newfambu := gse.Integer_Value( cursor, 5 );
      end if;
      if not gse.Is_Null( cursor, 6 )then
         a_pianon1415.sexhd := gse.Integer_Value( cursor, 6 );
      end if;
      if not gse.Is_Null( cursor, 7 )then
         a_pianon1415.adultb := gse.Integer_Value( cursor, 7 );
      end if;
      if not gse.Is_Null( cursor, 8 )then
         a_pianon1415.benunit := gse.Integer_Value( cursor, 8 );
      end if;
      if not gse.Is_Null( cursor, 9 )then
         a_pianon1415.ethgrphh := gse.Integer_Value( cursor, 9 );
      end if;
      if not gse.Is_Null( cursor, 10 )then
         a_pianon1415.winpaybu:= Amount'Value( gse.Value( cursor, 10 ));
      end if;
      if not gse.Is_Null( cursor, 11 )then
         a_pianon1415.gs_newbu := gse.Integer_Value( cursor, 11 );
      end if;
      if not gse.Is_Null( cursor, 12 )then
         a_pianon1415.gs_newpp := gse.Integer_Value( cursor, 12 );
      end if;
      if not gse.Is_Null( cursor, 13 )then
         a_pianon1415.mbhcdec := gse.Integer_Value( cursor, 13 );
      end if;
      if not gse.Is_Null( cursor, 14 )then
         a_pianon1415.obhcdec := gse.Integer_Value( cursor, 14 );
      end if;
      if not gse.Is_Null( cursor, 15 )then
         a_pianon1415.mahcdec := gse.Integer_Value( cursor, 15 );
      end if;
      if not gse.Is_Null( cursor, 16 )then
         a_pianon1415.oahcdec := gse.Integer_Value( cursor, 16 );
      end if;
      if not gse.Is_Null( cursor, 17 )then
         a_pianon1415.sexsp := gse.Integer_Value( cursor, 17 );
      end if;
      if not gse.Is_Null( cursor, 18 )then
         a_pianon1415.newfamb2 := gse.Integer_Value( cursor, 18 );
      end if;
      if not gse.Is_Null( cursor, 19 )then
         a_pianon1415.pidefbhc:= Amount'Value( gse.Value( cursor, 19 ));
      end if;
      if not gse.Is_Null( cursor, 20 )then
         a_pianon1415.pidefahc:= Amount'Value( gse.Value( cursor, 20 ));
      end if;
      if not gse.Is_Null( cursor, 21 )then
         a_pianon1415.pigrosbu := gse.Integer_Value( cursor, 21 );
      end if;
      if not gse.Is_Null( cursor, 22 )then
         a_pianon1415.pinincbu := gse.Integer_Value( cursor, 22 );
      end if;
      if not gse.Is_Null( cursor, 23 )then
         a_pianon1415.pigoccbu := gse.Integer_Value( cursor, 23 );
      end if;
      if not gse.Is_Null( cursor, 24 )then
         a_pianon1415.pippenbu := gse.Integer_Value( cursor, 24 );
      end if;
      if not gse.Is_Null( cursor, 25 )then
         a_pianon1415.piginvbu := gse.Integer_Value( cursor, 25 );
      end if;
      if not gse.Is_Null( cursor, 26 )then
         a_pianon1415.pigernbu := gse.Integer_Value( cursor, 26 );
      end if;
      if not gse.Is_Null( cursor, 27 )then
         a_pianon1415.pibenibu := gse.Integer_Value( cursor, 27 );
      end if;
      if not gse.Is_Null( cursor, 28 )then
         a_pianon1415.piothibu := gse.Integer_Value( cursor, 28 );
      end if;
      if not gse.Is_Null( cursor, 29 )then
         a_pianon1415.pinahcbu := gse.Integer_Value( cursor, 29 );
      end if;
      if not gse.Is_Null( cursor, 30 )then
         a_pianon1415.pinannbu := gse.Integer_Value( cursor, 30 );
      end if;
      if not gse.Is_Null( cursor, 31 )then
         a_pianon1415.piirbbu := gse.Integer_Value( cursor, 31 );
      end if;
      if not gse.Is_Null( cursor, 32 )then
         a_pianon1415.pidisben := gse.Integer_Value( cursor, 32 );
      end if;
      if not gse.Is_Null( cursor, 33 )then
         a_pianon1415.piretben := gse.Integer_Value( cursor, 33 );
      end if;
      if not gse.Is_Null( cursor, 34 )then
         a_pianon1415.pripenbu := gse.Integer_Value( cursor, 34 );
      end if;
      if not gse.Is_Null( cursor, 35 )then
         a_pianon1415.tvpaybu:= Amount'Value( gse.Value( cursor, 35 ));
      end if;
      if not gse.Is_Null( cursor, 36 )then
         a_pianon1415.nonben2bu := gse.Integer_Value( cursor, 36 );
      end if;
      if not gse.Is_Null( cursor, 37 )then
         a_pianon1415.perbenbu := gse.Integer_Value( cursor, 37 );
      end if;
      if not gse.Is_Null( cursor, 38 )then
         a_pianon1415.perbenbu2 := gse.Integer_Value( cursor, 38 );
      end if;
      if not gse.Is_Null( cursor, 39 )then
         a_pianon1415.rrpen := gse.Integer_Value( cursor, 39 );
      end if;
      if not gse.Is_Null( cursor, 40 )then
         a_pianon1415.newfambu2 := gse.Integer_Value( cursor, 40 );
      end if;
      if not gse.Is_Null( cursor, 41 )then
         a_pianon1415.dummy := gse.Integer_Value( cursor, 41 );
      end if;
      if not gse.Is_Null( cursor, 42 )then
         a_pianon1415.coup_q1:= Amount'Value( gse.Value( cursor, 42 ));
      end if;
      if not gse.Is_Null( cursor, 43 )then
         a_pianon1415.coup_q2:= Amount'Value( gse.Value( cursor, 43 ));
      end if;
      if not gse.Is_Null( cursor, 44 )then
         a_pianon1415.coup_q3:= Amount'Value( gse.Value( cursor, 44 ));
      end if;
      if not gse.Is_Null( cursor, 45 )then
         a_pianon1415.coup_q4:= Amount'Value( gse.Value( cursor, 45 ));
      end if;
      if not gse.Is_Null( cursor, 46 )then
         a_pianon1415.coup_q5:= Amount'Value( gse.Value( cursor, 46 ));
      end if;
      if not gse.Is_Null( cursor, 47 )then
         a_pianon1415.acou_q1:= Amount'Value( gse.Value( cursor, 47 ));
      end if;
      if not gse.Is_Null( cursor, 48 )then
         a_pianon1415.acou_q2:= Amount'Value( gse.Value( cursor, 48 ));
      end if;
      if not gse.Is_Null( cursor, 49 )then
         a_pianon1415.acou_q3:= Amount'Value( gse.Value( cursor, 49 ));
      end if;
      if not gse.Is_Null( cursor, 50 )then
         a_pianon1415.acou_q4:= Amount'Value( gse.Value( cursor, 50 ));
      end if;
      if not gse.Is_Null( cursor, 51 )then
         a_pianon1415.acou_q5:= Amount'Value( gse.Value( cursor, 51 ));
      end if;
      if not gse.Is_Null( cursor, 52 )then
         a_pianon1415.sing_q1:= Amount'Value( gse.Value( cursor, 52 ));
      end if;
      if not gse.Is_Null( cursor, 53 )then
         a_pianon1415.sing_q2:= Amount'Value( gse.Value( cursor, 53 ));
      end if;
      if not gse.Is_Null( cursor, 54 )then
         a_pianon1415.sing_q3:= Amount'Value( gse.Value( cursor, 54 ));
      end if;
      if not gse.Is_Null( cursor, 55 )then
         a_pianon1415.sing_q4:= Amount'Value( gse.Value( cursor, 55 ));
      end if;
      if not gse.Is_Null( cursor, 56 )then
         a_pianon1415.sing_q5:= Amount'Value( gse.Value( cursor, 56 ));
      end if;
      if not gse.Is_Null( cursor, 57 )then
         a_pianon1415.asin_q1:= Amount'Value( gse.Value( cursor, 57 ));
      end if;
      if not gse.Is_Null( cursor, 58 )then
         a_pianon1415.asin_q2:= Amount'Value( gse.Value( cursor, 58 ));
      end if;
      if not gse.Is_Null( cursor, 59 )then
         a_pianon1415.asin_q3:= Amount'Value( gse.Value( cursor, 59 ));
      end if;
      if not gse.Is_Null( cursor, 60 )then
         a_pianon1415.asin_q4:= Amount'Value( gse.Value( cursor, 60 ));
      end if;
      if not gse.Is_Null( cursor, 61 )then
         a_pianon1415.asin_q5:= Amount'Value( gse.Value( cursor, 61 ));
      end if;
      if not gse.Is_Null( cursor, 62 )then
         a_pianon1415.clust := gse.Integer_Value( cursor, 62 );
      end if;
      if not gse.Is_Null( cursor, 63 )then
         a_pianon1415.strat := gse.Integer_Value( cursor, 63 );
      end if;
      if not gse.Is_Null( cursor, 64 )then
         a_pianon1415.agehd80 := gse.Integer_Value( cursor, 64 );
      end if;
      if not gse.Is_Null( cursor, 65 )then
         a_pianon1415.agesp80 := gse.Integer_Value( cursor, 65 );
      end if;
      if not gse.Is_Null( cursor, 66 )then
         a_pianon1415.sernum := Sernum_Value'Value( gse.Value( cursor, 66 ));
      end if;
      return a_pianon1415;
   end Map_From_Cursor;

   function Retrieve( sqlstr : String; connection : Database_Connection := null ) return Ukds.Frs.Pianon1415_List is
      l : Ukds.Frs.Pianon1415_List;
      local_connection : Database_Connection;
      is_local_connection : Boolean;
   ...
   begin
      ...
      while gse.Has_Row( cursor ) loop
         declare
            a_pianon1415 : Ukds.Frs.Pianon1415 := Map_From_Cursor( cursor );
         begin
            l.append( a_pianon1415 ); 
         end;
         gse.Next( cursor );
      end loop;
      if( is_local_connection )then
   ...
   procedure Update( a_pianon1415 : Ukds.Frs.Pianon1415; connection : Database_Connection := null ) is
   ...
   begin
      ...
      params( 1 ) := "+"( Integer'Pos( a_pianon1415.gvtregn ));
      params( 2 ) := "+"( Integer'Pos( a_pianon1415.fambu ));
      params( 3 ) := "+"( Integer'Pos( a_pianon1415.newfambu ));
      params( 4 ) := "+"( Integer'Pos( a_pianon1415.sexhd ));
      params( 5 ) := "+"( Integer'Pos( a_pianon1415.adultb ));
      params( 6 ) := "+"( Integer'Pos( a_pianon1415.ethgrphh ));
      params( 7 ) := "+"( Float( a_pianon1415.winpaybu ));
      params( 8 ) := "+"( Integer'Pos( a_pianon1415.gs_newbu ));
      params( 9 ) := "+"( Integer'Pos( a_pianon1415.gs_newpp ));
      params( 10 ) := "+"( Integer'Pos( a_pianon1415.mbhcdec ));
      params( 11 ) := "+"( Integer'Pos( a_pianon1415.obhcdec ));
      params( 12 ) := "+"( Integer'Pos( a_pianon1415.mahcdec ));
      params( 13 ) := "+"( Integer'Pos( a_pianon1415.oahcdec ));
      params( 14 ) := "+"( Integer'Pos( a_pianon1415.sexsp ));
      params( 15 ) := "+"( Integer'Pos( a_pianon1415.newfamb2 ));
      params( 16 ) := "+"( Float( a_pianon1415.pidefbhc ));
      params( 17 ) := "+"( Float( a_pianon1415.pidefahc ));
      params( 18 ) := "+"( Integer'Pos( a_pianon1415.pigrosbu ));
      params( 19 ) := "+"( Integer'Pos( a_pianon1415.pinincbu ));
      params( 20 ) := "+"( Integer'Pos( a_pianon1415.pigoccbu ));
      params( 21 ) := "+"( Integer'Pos( a_pianon1415.pippenbu ));
      params( 22 ) := "+"( Integer'Pos( a_pianon1415.piginvbu ));
      params( 23 ) := "+"( Integer'Pos( a_pianon1415.pigernbu ));
      params( 24 ) := "+"( Integer'Pos( a_pianon1415.pibenibu ));
      params( 25 ) := "+"( Integer'Pos( a_pianon1415.piothibu ));
      params( 26 ) := "+"( Integer'Pos( a_pianon1415.pinahcbu ));
      params( 27 ) := "+"( Integer'Pos( a_pianon1415.pinannbu ));
      params( 28 ) := "+"( Integer'Pos( a_pianon1415.piirbbu ));
      params( 29 ) := "+"( Integer'Pos( a_pianon1415.pidisben ));
      params( 30 ) := "+"( Integer'Pos( a_pianon1415.piretben ));
      params( 31 ) := "+"( Integer'Pos( a_pianon1415.pripenbu ));
      params( 32 ) := "+"( Float( a_pianon1415.tvpaybu ));
      params( 33 ) := "+"( Integer'Pos( a_pianon1415.nonben2bu ));
      params( 34 ) := "+"( Integer'Pos( a_pianon1415.perbenbu ));
      params( 35 ) := "+"( Integer'Pos( a_pianon1415.perbenbu2 ));
      params( 36 ) := "+"( Integer'Pos( a_pianon1415.rrpen ));
      params( 37 ) := "+"( Integer'Pos( a_pianon1415.newfambu2 ));
      params( 38 ) := "+"( Integer'Pos( a_pianon1415.dummy ));
      params( 39 ) := "+"( Float( a_pianon1415.coup_q1 ));
      params( 40 ) := "+"( Float( a_pianon1415.coup_q2 ));
      params( 41 ) := "+"( Float( a_pianon1415.coup_q3 ));
      params( 42 ) := "+"( Float( a_pianon1415.coup_q4 ));
      params( 43 ) := "+"( Float( a_pianon1415.coup_q5 ));
      params( 44 ) := "+"( Float( a_pianon1415.acou_q1 ));
      params( 45 ) := "+"( Float( a_pianon1415.acou_q2 ));
      params( 46 ) := "+"( Float( a_pianon1415.acou_q3 ));
      params( 47 ) := "+"( Float( a_pianon1415.acou_q4 ));
      params( 48 ) := "+"( Float( a_pianon1415.acou_q5 ));
      params( 49 ) := "+"( Float( a_pianon1415.sing_q1 ));
      params( 50 ) := "+"( Float( a_pianon1415.sing_q2 ));
      params( 51 ) := "+"( Float( a_pianon1415.sing_q3 ));
      params( 52 ) := "+"( Float( a_pianon1415.sing_q4 ));
      params( 53 ) := "+"( Float( a_pianon1415.sing_q5 ));
      params( 54 ) := "+"( Float( a_pianon1415.asin_q1 ));
      params( 55 ) := "+"( Float( a_pianon1415.asin_q2 ));
      params( 56 ) := "+"( Float( a_pianon1415.asin_q3 ));
      params( 57 ) := "+"( Float( a_pianon1415.asin_q4 ));
      params( 58 ) := "+"( Float( a_pianon1415.asin_q5 ));
      params( 59 ) := "+"( Integer'Pos( a_pianon1415.clust ));
      params( 60 ) := "+"( Integer'Pos( a_pianon1415.strat ));
      params( 61 ) := "+"( Integer'Pos( a_pianon1415.agehd80 ));
      params( 62 ) := "+"( Integer'Pos( a_pianon1415.agesp80 ));
      params( 63 ) := "+"( Integer'Pos( a_pianon1415.user_id ));
      params( 64 ) := "+"( Integer'Pos( a_pianon1415.edition ));
      params( 65 ) := "+"( Integer'Pos( a_pianon1415.year ));
      params( 66 ) := "+"( Integer'Pos( a_pianon1415.benunit ));
      params( 67 ) := As_Bigint( a_pianon1415.sernum );
   ...
   procedure Save( a_pianon1415 : Ukds.Frs.Pianon1415; overwrite : Boolean := True; connection : Database_Connection := null ) is   
   ...
   begin
      ...
      if overwrite and Exists( a_pianon1415.user_id, a_pianon1415.edition, a_pianon1415.year, a_pianon1415.benunit, a_pianon1415.sernum ) then
         Update( a_pianon1415, local_connection );
         if( is_local_connection )then
            Connection_Pool.Return_Connection( local_connection );
         end if;
         return;
      end if;
      params( 1 ) := "+"( Integer'Pos( a_pianon1415.user_id ));
      params( 2 ) := "+"( Integer'Pos( a_pianon1415.edition ));
      params( 3 ) := "+"( Integer'Pos( a_pianon1415.year ));
      params( 4 ) := "+"( Integer'Pos( a_pianon1415.gvtregn ));
      params( 5 ) := "+"( Integer'Pos( a_pianon1415.fambu ));
      params( 6 ) := "+"( Integer'Pos( a_pianon1415.newfambu ));
      params( 7 ) := "+"( Integer'Pos( a_pianon1415.sexhd ));
      params( 8 ) := "+"( Integer'Pos( a_pianon1415.adultb ));
      params( 9 ) := "+"( Integer'Pos( a_pianon1415.benunit ));
      params( 10 ) := "+"( Integer'Pos( a_pianon1415.ethgrphh ));
      params( 11 ) := "+"( Float( a_pianon1415.winpaybu ));
      params( 12 ) := "+"( Integer'Pos( a_pianon1415.gs_newbu ));
      params( 13 ) := "+"( Integer'Pos( a_pianon1415.gs_newpp ));
      params( 14 ) := "+"( Integer'Pos( a_pianon1415.mbhcdec ));
      params( 15 ) := "+"( Integer'Pos( a_pianon1415.obhcdec ));
      params( 16 ) := "+"( Integer'Pos( a_pianon1415.mahcdec ));
      params( 17 ) := "+"( Integer'Pos( a_pianon1415.oahcdec ));
      params( 18 ) := "+"( Integer'Pos( a_pianon1415.sexsp ));
      params( 19 ) := "+"( Integer'Pos( a_pianon1415.newfamb2 ));
      params( 20 ) := "+"( Float( a_pianon1415.pidefbhc ));
      params( 21 ) := "+"( Float( a_pianon1415.pidefahc ));
      params( 22 ) := "+"( Integer'Pos( a_pianon1415.pigrosbu ));
      params( 23 ) := "+"( Integer'Pos( a_pianon1415.pinincbu ));
      params( 24 ) := "+"( Integer'Pos( a_pianon1415.pigoccbu ));
      params( 25 ) := "+"( Integer'Pos( a_pianon1415.pippenbu ));
      params( 26 ) := "+"( Integer'Pos( a_pianon1415.piginvbu ));
      params( 27 ) := "+"( Integer'Pos( a_pianon1415.pigernbu ));
      params( 28 ) := "+"( Integer'Pos( a_pianon1415.pibenibu ));
      params( 29 ) := "+"( Integer'Pos( a_pianon1415.piothibu ));
      params( 30 ) := "+"( Integer'Pos( a_pianon1415.pinahcbu ));
      params( 31 ) := "+"( Integer'Pos( a_pianon1415.pinannbu ));
      params( 32 ) := "+"( Integer'Pos( a_pianon1415.piirbbu ));
      params( 33 ) := "+"( Integer'Pos( a_pianon1415.pidisben ));
      params( 34 ) := "+"( Integer'Pos( a_pianon1415.piretben ));
      params( 35 ) := "+"( Integer'Pos( a_pianon1415.pripenbu ));
      params( 36 ) := "+"( Float( a_pianon1415.tvpaybu ));
      params( 37 ) := "+"( Integer'Pos( a_pianon1415.nonben2bu ));
      params( 38 ) := "+"( Integer'Pos( a_pianon1415.perbenbu ));
      params( 39 ) := "+"( Integer'Pos( a_pianon1415.perbenbu2 ));
      params( 40 ) := "+"( Integer'Pos( a_pianon1415.rrpen ));
      params( 41 ) := "+"( Integer'Pos( a_pianon1415.newfambu2 ));
      params( 42 ) := "+"( Integer'Pos( a_pianon1415.dummy ));
      params( 43 ) := "+"( Float( a_pianon1415.coup_q1 ));
      params( 44 ) := "+"( Float( a_pianon1415.coup_q2 ));
      params( 45 ) := "+"( Float( a_pianon1415.coup_q3 ));
      params( 46 ) := "+"( Float( a_pianon1415.coup_q4 ));
      params( 47 ) := "+"( Float( a_pianon1415.coup_q5 ));
      params( 48 ) := "+"( Float( a_pianon1415.acou_q1 ));
      params( 49 ) := "+"( Float( a_pianon1415.acou_q2 ));
      params( 50 ) := "+"( Float( a_pianon1415.acou_q3 ));
      params( 51 ) := "+"( Float( a_pianon1415.acou_q4 ));
      params( 52 ) := "+"( Float( a_pianon1415.acou_q5 ));
      params( 53 ) := "+"( Float( a_pianon1415.sing_q1 ));
      params( 54 ) := "+"( Float( a_pianon1415.sing_q2 ));
      params( 55 ) := "+"( Float( a_pianon1415.sing_q3 ));
      params( 56 ) := "+"( Float( a_pianon1415.sing_q4 ));
      params( 57 ) := "+"( Float( a_pianon1415.sing_q5 ));
      params( 58 ) := "+"( Float( a_pianon1415.asin_q1 ));
      params( 59 ) := "+"( Float( a_pianon1415.asin_q2 ));
      params( 60 ) := "+"( Float( a_pianon1415.asin_q3 ));
      params( 61 ) := "+"( Float( a_pianon1415.asin_q4 ));
      params( 62 ) := "+"( Float( a_pianon1415.asin_q5 ));
      params( 63 ) := "+"( Integer'Pos( a_pianon1415.clust ));
      params( 64 ) := "+"( Integer'Pos( a_pianon1415.strat ));
      params( 65 ) := "+"( Integer'Pos( a_pianon1415.agehd80 ));
      params( 66 ) := "+"( Integer'Pos( a_pianon1415.agesp80 ));
      params( 67 ) := As_Bigint( a_pianon1415.sernum );
   ...
   --
   -- Delete the given record. Throws DB_Exception exception. Sets value to Ukds.Frs.Null_Pianon1415
   --

   procedure Delete( a_pianon1415 : in out Ukds.Frs.Pianon1415; connection : Database_Connection := null ) is
         c : d.Criteria;
   begin  
      Add_user_id( c, a_pianon1415.user_id );
      Add_edition( c, a_pianon1415.edition );
      Add_year( c, a_pianon1415.year );
      Add_benunit( c, a_pianon1415.benunit );
      Add_sernum( c, a_pianon1415.sernum );
      Delete( c, connection );
      a_pianon1415 := Ukds.Frs.Null_Pianon1415;
   ...
   procedure Add_pinannbu( c : in out d.Criteria; pinannbu : Integer; op : d.operation_type:= d.eq; join : d.join_type := d.join_and ) is   
   elem : d.Criterion := d.Make_Criterion_Element( "pinannbu", op, join, pinannbu );
   begin
      d.add_to_criteria( c, elem );
   end Add_pinannbu;
   ...
   procedure Add_pinannbu_To_Orderings( c : in out d.Criteria; direction : d.Asc_Or_Desc ) is   
   elem : d.Order_By_Element := d.Make_Order_By_Element( "pinannbu", direction  );
   begin
      d.add_to_criteria( c, elem );
   end Add_pinannbu_To_Orderings;
