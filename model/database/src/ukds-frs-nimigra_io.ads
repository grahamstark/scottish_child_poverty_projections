--
-- Created by ada_generator.py on 2017-10-25 13:04:27.630007
-- 
with Ukds;
with DB_Commons;
with Base_Types;
...
package Ukds.Frs.Nimigra_IO is
   ...
   --
   function Is_Null( a_nimigra : Nimigra ) return Boolean;
   ...
   --
   function Retrieve( c : d.Criteria; connection : Database_Connection := null ) return Ukds.Frs.Nimigra_List;
   
   --
   -- Retrieves a list of Ukds.Frs.Nimigra retrived by the sql string, or throws an exception
   --
   function Retrieve( sqlstr : String; connection : Database_Connection := null ) return Ukds.Frs.Nimigra_List;
   
   --
   -- Save the given record, overwriting if it exists and overwrite is true, 
   -- otherwise throws DB_Exception exception. 
   --
   procedure Save( a_nimigra : Ukds.Frs.Nimigra; overwrite : Boolean := True; connection : Database_Connection := null );
   
   --
   -- Delete the given record. Throws DB_Exception exception. Sets value to Ukds.Frs.Null_Nimigra
   --
   procedure Delete( a_nimigra : in out Ukds.Frs.Nimigra; connection : Database_Connection := null );
   --
