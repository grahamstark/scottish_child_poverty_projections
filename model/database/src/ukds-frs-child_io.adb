--
-- Created by ada_generator.py on 2017-09-05 20:57:18.438997
-- 
with Ukds;
...
package body Ukds.Frs.Child_IO is
   ...
   SELECT_PART : constant String := "select " &
         "user_id, edition, year, sernum, benunit, person, age, btecnow, c2orign, cameyr," &
         "care, cdaprog1, cdatre1, cdatrep1, cdisd01, cdisd02, cdisd03, cdisd04, cdisd05, cdisd06," &
         "cdisd07, cdisd08, cdisd09, cdisd10, cdisdifp, chamtern, chamttst, chbfd, chbfdamt, chbfdpd," &
         "chbfdval, chca, chcond, chdla1, chdla2, chealth1, chearns1, chearns2, chearns3, chema," &
         "chemaamt, chemapd, chlimitl, chpdern, chpdtst, chsave, chtrnamt, chtrnpd, citizen, citizen2," &
         "cohabit, contuk, convbl, corign, corigoth, curqual, cvht, cvpay, cvpd, degrenow," &
         "denrec, depend, dob, dvmardf, eligadlt, eligchld, fted, x_grant, grtamt1, grtamt2," &
         "grtdir1, grtdir2, grtnum, grtsce1, grtsce2, grtval1, grtval2, heathch, hholder, highonow," &
         "hrsed, hsvper, issue, lareg, medrec, ms, nvqlenow, othpass, parent1, parent2," &
         "prox1619, r01, r02, r03, r04, r05, r06, r07, r08, r09," &
         "r10, r11, r12, r13, r14, reasden, reasmed, reasnhs, rsanow, sbkit," &
         "schchk, sctvnow, sex, sfvit, smkit, smlit, spcreg1, spcreg2, spcreg3, spout," &
         "srentamt, srentpd, totsave, trainee, typeed, month, careab, careah, carecb, carech," &
         "carecl, carefl, carefr, careot, carere, chearns, chincdv, chrinc, disactc1, discorc1," &
         "dobmonth, dobyear, fsbval, fsfvval, fsmlkval, fsmval, hdagech, heartval, hourab, hourah," &
         "hourcb, hourch, hourcl, hourfr, hourot, hourre, hourtot, hperson, iagegr2, iagegrp," &
         "relhrp, totgntch, tuacam, typeed2, uperson, xbonflag, candgnow, curothf, curothp, curothwv," &
         "gnvqnow, ndeplnow, oqualc1, oqualc2, oqualc3, webacnow, ntsctnow, skiwknow, adeduc, benccdis," &
         "cdisdif1, cdisdif2, cdisdif3, cdisdif4, cdisdif5, cdisdif6, cdisdif7, cdisdif8, chamt1, chamt2," &
         "chamt3, chamt4, chealth, chfar, chhr1, chhr2, chlook01, chlook02, chlook03, chlook04," &
         "chlook05, chlook06, chlook07, chlook08, chlook09, chlook10, chpay1, chpay2, chpay3, chprob," &
         "chwkern, chwktst, chyrern, chyrtst, clone, cost, dentist, endyr, eyetest, hosp," &
         "legdep, nhs1, nhs2, nhs3, prit, prscrpt, registr1, registr2, registr3, registr4," &
         "registr5, specs, startyr, trav, voucher, whytrav1, whytrav2, whytrav3, whytrav4, whytrav5," &
         "whytrav6, wmkit, chdda, fwmlkval, cddatre, cdisdif9, cddatrep, cfund, cfundh, cfundtp," &
         "fundamt1, fundamt2, fundamt3, fundamt4, fundamt5, fundamt6, givcfnd1, givcfnd2, givcfnd3, givcfnd4," &
         "givcfnd5, givcfnd6, cddaprg, disdifch, mednum, medprpd, medprpy, marital " &
         " from frs.child " ;
   ...
   use GNATCOLL.SQL_Impl;
      params : constant SQL_Parameters( 1 .. 268 ) := ( if update_order then (
            1 => ( Parameter_Integer, 0 ),   --  : age (Integer)
            2 => ( Parameter_Integer, 0 ),   --  : btecnow (Integer)
            3 => ( Parameter_Integer, 0 ),   --  : c2orign (Integer)
            4 => ( Parameter_Integer, 0 ),   --  : cameyr (Integer)
            5 => ( Parameter_Integer, 0 ),   --  : care (Integer)
            6 => ( Parameter_Integer, 0 ),   --  : cdaprog1 (Integer)
            7 => ( Parameter_Integer, 0 ),   --  : cdatre1 (Integer)
            8 => ( Parameter_Integer, 0 ),   --  : cdatrep1 (Integer)
            9 => ( Parameter_Integer, 0 ),   --  : cdisd01 (Integer)
           10 => ( Parameter_Integer, 0 ),   --  : cdisd02 (Integer)
           11 => ( Parameter_Integer, 0 ),   --  : cdisd03 (Integer)
           12 => ( Parameter_Integer, 0 ),   --  : cdisd04 (Integer)
           13 => ( Parameter_Integer, 0 ),   --  : cdisd05 (Integer)
           14 => ( Parameter_Integer, 0 ),   --  : cdisd06 (Integer)
           15 => ( Parameter_Integer, 0 ),   --  : cdisd07 (Integer)
           16 => ( Parameter_Integer, 0 ),   --  : cdisd08 (Integer)
           17 => ( Parameter_Integer, 0 ),   --  : cdisd09 (Integer)
           18 => ( Parameter_Integer, 0 ),   --  : cdisd10 (Integer)
           19 => ( Parameter_Integer, 0 ),   --  : cdisdifp (Integer)
           20 => ( Parameter_Float, 0.0 ),   --  : chamtern (Amount)
           21 => ( Parameter_Float, 0.0 ),   --  : chamttst (Amount)
           22 => ( Parameter_Integer, 0 ),   --  : chbfd (Integer)
           23 => ( Parameter_Float, 0.0 ),   --  : chbfdamt (Amount)
           24 => ( Parameter_Integer, 0 ),   --  : chbfdpd (Integer)
           25 => ( Parameter_Integer, 0 ),   --  : chbfdval (Integer)
           26 => ( Parameter_Integer, 0 ),   --  : chca (Integer)
           27 => ( Parameter_Integer, 0 ),   --  : chcond (Integer)
           28 => ( Parameter_Integer, 0 ),   --  : chdla1 (Integer)
           29 => ( Parameter_Integer, 0 ),   --  : chdla2 (Integer)
           30 => ( Parameter_Integer, 0 ),   --  : chealth1 (Integer)
           31 => ( Parameter_Integer, 0 ),   --  : chearns1 (Integer)
           32 => ( Parameter_Integer, 0 ),   --  : chearns2 (Integer)
           33 => ( Parameter_Integer, 0 ),   --  : chearns3 (Integer)
           34 => ( Parameter_Integer, 0 ),   --  : chema (Integer)
           35 => ( Parameter_Float, 0.0 ),   --  : chemaamt (Amount)
           36 => ( Parameter_Integer, 0 ),   --  : chemapd (Integer)
           37 => ( Parameter_Integer, 0 ),   --  : chlimitl (Integer)
           38 => ( Parameter_Integer, 0 ),   --  : chpdern (Integer)
           39 => ( Parameter_Integer, 0 ),   --  : chpdtst (Integer)
           40 => ( Parameter_Integer, 0 ),   --  : chsave (Integer)
           41 => ( Parameter_Float, 0.0 ),   --  : chtrnamt (Amount)
           42 => ( Parameter_Integer, 0 ),   --  : chtrnpd (Integer)
           43 => ( Parameter_Integer, 0 ),   --  : citizen (Integer)
           44 => ( Parameter_Integer, 0 ),   --  : citizen2 (Integer)
           45 => ( Parameter_Integer, 0 ),   --  : cohabit (Integer)
           46 => ( Parameter_Integer, 0 ),   --  : contuk (Integer)
           47 => ( Parameter_Integer, 0 ),   --  : convbl (Integer)
           48 => ( Parameter_Integer, 0 ),   --  : corign (Integer)
           49 => ( Parameter_Integer, 0 ),   --  : corigoth (Integer)
           50 => ( Parameter_Integer, 0 ),   --  : curqual (Integer)
           51 => ( Parameter_Integer, 0 ),   --  : cvht (Integer)
           52 => ( Parameter_Integer, 0 ),   --  : cvpay (Integer)
           53 => ( Parameter_Integer, 0 ),   --  : cvpd (Integer)
           54 => ( Parameter_Integer, 0 ),   --  : degrenow (Integer)
           55 => ( Parameter_Integer, 0 ),   --  : denrec (Integer)
           56 => ( Parameter_Integer, 0 ),   --  : depend (Integer)
           57 => ( Parameter_Date, Clock ),   --  : dob (Ada.Calendar.Time)
           58 => ( Parameter_Integer, 0 ),   --  : dvmardf (Integer)
           59 => ( Parameter_Integer, 0 ),   --  : eligadlt (Integer)
           60 => ( Parameter_Integer, 0 ),   --  : eligchld (Integer)
           61 => ( Parameter_Integer, 0 ),   --  : fted (Integer)
           62 => ( Parameter_Integer, 0 ),   --  : x_grant (Integer)
           63 => ( Parameter_Float, 0.0 ),   --  : grtamt1 (Amount)
           64 => ( Parameter_Float, 0.0 ),   --  : grtamt2 (Amount)
           65 => ( Parameter_Float, 0.0 ),   --  : grtdir1 (Amount)
           66 => ( Parameter_Float, 0.0 ),   --  : grtdir2 (Amount)
           67 => ( Parameter_Integer, 0 ),   --  : grtnum (Integer)
           68 => ( Parameter_Integer, 0 ),   --  : grtsce1 (Integer)
           69 => ( Parameter_Integer, 0 ),   --  : grtsce2 (Integer)
           70 => ( Parameter_Float, 0.0 ),   --  : grtval1 (Amount)
           71 => ( Parameter_Float, 0.0 ),   --  : grtval2 (Amount)
           72 => ( Parameter_Integer, 0 ),   --  : heathch (Integer)
           73 => ( Parameter_Integer, 0 ),   --  : hholder (Integer)
           74 => ( Parameter_Integer, 0 ),   --  : highonow (Integer)
           75 => ( Parameter_Integer, 0 ),   --  : hrsed (Integer)
           76 => ( Parameter_Integer, 0 ),   --  : hsvper (Integer)
           77 => ( Parameter_Integer, 0 ),   --  : issue (Integer)
           78 => ( Parameter_Integer, 0 ),   --  : lareg (Integer)
           79 => ( Parameter_Integer, 0 ),   --  : medrec (Integer)
           80 => ( Parameter_Integer, 0 ),   --  : ms (Integer)
           81 => ( Parameter_Integer, 0 ),   --  : nvqlenow (Integer)
           82 => ( Parameter_Integer, 0 ),   --  : othpass (Integer)
           83 => ( Parameter_Integer, 0 ),   --  : parent1 (Integer)
           84 => ( Parameter_Integer, 0 ),   --  : parent2 (Integer)
           85 => ( Parameter_Integer, 0 ),   --  : prox1619 (Integer)
           86 => ( Parameter_Integer, 0 ),   --  : r01 (Integer)
           87 => ( Parameter_Integer, 0 ),   --  : r02 (Integer)
           88 => ( Parameter_Integer, 0 ),   --  : r03 (Integer)
           89 => ( Parameter_Integer, 0 ),   --  : r04 (Integer)
           90 => ( Parameter_Integer, 0 ),   --  : r05 (Integer)
           91 => ( Parameter_Integer, 0 ),   --  : r06 (Integer)
           92 => ( Parameter_Integer, 0 ),   --  : r07 (Integer)
           93 => ( Parameter_Integer, 0 ),   --  : r08 (Integer)
           94 => ( Parameter_Integer, 0 ),   --  : r09 (Integer)
           95 => ( Parameter_Integer, 0 ),   --  : r10 (Integer)
           96 => ( Parameter_Integer, 0 ),   --  : r11 (Integer)
           97 => ( Parameter_Integer, 0 ),   --  : r12 (Integer)
           98 => ( Parameter_Integer, 0 ),   --  : r13 (Integer)
           99 => ( Parameter_Integer, 0 ),   --  : r14 (Integer)
           100 => ( Parameter_Integer, 0 ),   --  : reasden (Integer)
           101 => ( Parameter_Integer, 0 ),   --  : reasmed (Integer)
           102 => ( Parameter_Integer, 0 ),   --  : reasnhs (Integer)
           103 => ( Parameter_Integer, 0 ),   --  : rsanow (Integer)
           104 => ( Parameter_Integer, 0 ),   --  : sbkit (Integer)
           105 => ( Parameter_Integer, 0 ),   --  : schchk (Integer)
           106 => ( Parameter_Integer, 0 ),   --  : sctvnow (Integer)
           107 => ( Parameter_Integer, 0 ),   --  : sex (Integer)
           108 => ( Parameter_Integer, 0 ),   --  : sfvit (Integer)
           109 => ( Parameter_Integer, 0 ),   --  : smkit (Integer)
           110 => ( Parameter_Integer, 0 ),   --  : smlit (Integer)
           111 => ( Parameter_Integer, 0 ),   --  : spcreg1 (Integer)
           112 => ( Parameter_Integer, 0 ),   --  : spcreg2 (Integer)
           113 => ( Parameter_Integer, 0 ),   --  : spcreg3 (Integer)
           114 => ( Parameter_Integer, 0 ),   --  : spout (Integer)
           115 => ( Parameter_Integer, 0 ),   --  : srentamt (Integer)
           116 => ( Parameter_Integer, 0 ),   --  : srentpd (Integer)
           117 => ( Parameter_Integer, 0 ),   --  : totsave (Integer)
           118 => ( Parameter_Integer, 0 ),   --  : trainee (Integer)
           119 => ( Parameter_Integer, 0 ),   --  : typeed (Integer)
           120 => ( Parameter_Integer, 0 ),   --  : month (Integer)
           121 => ( Parameter_Integer, 0 ),   --  : careab (Integer)
           122 => ( Parameter_Integer, 0 ),   --  : careah (Integer)
           123 => ( Parameter_Integer, 0 ),   --  : carecb (Integer)
           124 => ( Parameter_Integer, 0 ),   --  : carech (Integer)
           125 => ( Parameter_Integer, 0 ),   --  : carecl (Integer)
           126 => ( Parameter_Integer, 0 ),   --  : carefl (Integer)
           127 => ( Parameter_Integer, 0 ),   --  : carefr (Integer)
           128 => ( Parameter_Integer, 0 ),   --  : careot (Integer)
           129 => ( Parameter_Integer, 0 ),   --  : carere (Integer)
           130 => ( Parameter_Float, 0.0 ),   --  : chearns (Amount)
           131 => ( Parameter_Float, 0.0 ),   --  : chincdv (Amount)
           132 => ( Parameter_Float, 0.0 ),   --  : chrinc (Amount)
           133 => ( Parameter_Integer, 0 ),   --  : disactc1 (Integer)
           134 => ( Parameter_Integer, 0 ),   --  : discorc1 (Integer)
           135 => ( Parameter_Integer, 0 ),   --  : dobmonth (Integer)
           136 => ( Parameter_Integer, 0 ),   --  : dobyear (Integer)
           137 => ( Parameter_Float, 0.0 ),   --  : fsbval (Amount)
           138 => ( Parameter_Float, 0.0 ),   --  : fsfvval (Amount)
           139 => ( Parameter_Float, 0.0 ),   --  : fsmlkval (Amount)
           140 => ( Parameter_Float, 0.0 ),   --  : fsmval (Amount)
           141 => ( Parameter_Integer, 0 ),   --  : hdagech (Integer)
           142 => ( Parameter_Float, 0.0 ),   --  : heartval (Amount)
           143 => ( Parameter_Integer, 0 ),   --  : hourab (Integer)
           144 => ( Parameter_Integer, 0 ),   --  : hourah (Integer)
           145 => ( Parameter_Integer, 0 ),   --  : hourcb (Integer)
           146 => ( Parameter_Integer, 0 ),   --  : hourch (Integer)
           147 => ( Parameter_Integer, 0 ),   --  : hourcl (Integer)
           148 => ( Parameter_Integer, 0 ),   --  : hourfr (Integer)
           149 => ( Parameter_Integer, 0 ),   --  : hourot (Integer)
           150 => ( Parameter_Integer, 0 ),   --  : hourre (Integer)
           151 => ( Parameter_Integer, 0 ),   --  : hourtot (Integer)
           152 => ( Parameter_Integer, 0 ),   --  : hperson (Integer)
           153 => ( Parameter_Integer, 0 ),   --  : iagegr2 (Integer)
           154 => ( Parameter_Integer, 0 ),   --  : iagegrp (Integer)
           155 => ( Parameter_Integer, 0 ),   --  : relhrp (Integer)
           156 => ( Parameter_Float, 0.0 ),   --  : totgntch (Amount)
           157 => ( Parameter_Float, 0.0 ),   --  : tuacam (Amount)
           158 => ( Parameter_Integer, 0 ),   --  : typeed2 (Integer)
           159 => ( Parameter_Integer, 0 ),   --  : uperson (Integer)
           160 => ( Parameter_Integer, 0 ),   --  : xbonflag (Integer)
           161 => ( Parameter_Integer, 0 ),   --  : candgnow (Integer)
           162 => ( Parameter_Integer, 0 ),   --  : curothf (Integer)
           163 => ( Parameter_Integer, 0 ),   --  : curothp (Integer)
           164 => ( Parameter_Integer, 0 ),   --  : curothwv (Integer)
           165 => ( Parameter_Integer, 0 ),   --  : gnvqnow (Integer)
           166 => ( Parameter_Integer, 0 ),   --  : ndeplnow (Integer)
           167 => ( Parameter_Integer, 0 ),   --  : oqualc1 (Integer)
           168 => ( Parameter_Integer, 0 ),   --  : oqualc2 (Integer)
           169 => ( Parameter_Integer, 0 ),   --  : oqualc3 (Integer)
           170 => ( Parameter_Integer, 0 ),   --  : webacnow (Integer)
           171 => ( Parameter_Integer, 0 ),   --  : ntsctnow (Integer)
           172 => ( Parameter_Integer, 0 ),   --  : skiwknow (Integer)
           173 => ( Parameter_Integer, 0 ),   --  : adeduc (Integer)
           174 => ( Parameter_Integer, 0 ),   --  : benccdis (Integer)
           175 => ( Parameter_Integer, 0 ),   --  : cdisdif1 (Integer)
           176 => ( Parameter_Integer, 0 ),   --  : cdisdif2 (Integer)
           177 => ( Parameter_Integer, 0 ),   --  : cdisdif3 (Integer)
           178 => ( Parameter_Integer, 0 ),   --  : cdisdif4 (Integer)
           179 => ( Parameter_Integer, 0 ),   --  : cdisdif5 (Integer)
           180 => ( Parameter_Integer, 0 ),   --  : cdisdif6 (Integer)
           181 => ( Parameter_Integer, 0 ),   --  : cdisdif7 (Integer)
           182 => ( Parameter_Integer, 0 ),   --  : cdisdif8 (Integer)
           183 => ( Parameter_Float, 0.0 ),   --  : chamt1 (Amount)
           184 => ( Parameter_Float, 0.0 ),   --  : chamt2 (Amount)
           185 => ( Parameter_Float, 0.0 ),   --  : chamt3 (Amount)
           186 => ( Parameter_Float, 0.0 ),   --  : chamt4 (Amount)
           187 => ( Parameter_Integer, 0 ),   --  : chealth (Integer)
           188 => ( Parameter_Integer, 0 ),   --  : chfar (Integer)
           189 => ( Parameter_Integer, 0 ),   --  : chhr1 (Integer)
           190 => ( Parameter_Integer, 0 ),   --  : chhr2 (Integer)
           191 => ( Parameter_Integer, 0 ),   --  : chlook01 (Integer)
           192 => ( Parameter_Integer, 0 ),   --  : chlook02 (Integer)
           193 => ( Parameter_Integer, 0 ),   --  : chlook03 (Integer)
           194 => ( Parameter_Integer, 0 ),   --  : chlook04 (Integer)
           195 => ( Parameter_Integer, 0 ),   --  : chlook05 (Integer)
           196 => ( Parameter_Integer, 0 ),   --  : chlook06 (Integer)
           197 => ( Parameter_Integer, 0 ),   --  : chlook07 (Integer)
           198 => ( Parameter_Integer, 0 ),   --  : chlook08 (Integer)
           199 => ( Parameter_Integer, 0 ),   --  : chlook09 (Integer)
           200 => ( Parameter_Integer, 0 ),   --  : chlook10 (Integer)
           201 => ( Parameter_Integer, 0 ),   --  : chpay1 (Integer)
           202 => ( Parameter_Integer, 0 ),   --  : chpay2 (Integer)
           203 => ( Parameter_Integer, 0 ),   --  : chpay3 (Integer)
           204 => ( Parameter_Integer, 0 ),   --  : chprob (Integer)
           205 => ( Parameter_Integer, 0 ),   --  : chwkern (Integer)
           206 => ( Parameter_Integer, 0 ),   --  : chwktst (Integer)
           207 => ( Parameter_Integer, 0 ),   --  : chyrern (Integer)
           208 => ( Parameter_Integer, 0 ),   --  : chyrtst (Integer)
           209 => ( Parameter_Integer, 0 ),   --  : clone (Integer)
           210 => ( Parameter_Integer, 0 ),   --  : cost (Integer)
           211 => ( Parameter_Integer, 0 ),   --  : dentist (Integer)
           212 => ( Parameter_Integer, 0 ),   --  : endyr (Integer)
           213 => ( Parameter_Integer, 0 ),   --  : eyetest (Integer)
           214 => ( Parameter_Integer, 0 ),   --  : hosp (Integer)
           215 => ( Parameter_Integer, 0 ),   --  : legdep (Integer)
           216 => ( Parameter_Integer, 0 ),   --  : nhs1 (Integer)
           217 => ( Parameter_Integer, 0 ),   --  : nhs2 (Integer)
           218 => ( Parameter_Integer, 0 ),   --  : nhs3 (Integer)
           219 => ( Parameter_Integer, 0 ),   --  : prit (Integer)
           220 => ( Parameter_Integer, 0 ),   --  : prscrpt (Integer)
           221 => ( Parameter_Integer, 0 ),   --  : registr1 (Integer)
           222 => ( Parameter_Integer, 0 ),   --  : registr2 (Integer)
           223 => ( Parameter_Integer, 0 ),   --  : registr3 (Integer)
           224 => ( Parameter_Integer, 0 ),   --  : registr4 (Integer)
           225 => ( Parameter_Integer, 0 ),   --  : registr5 (Integer)
           226 => ( Parameter_Integer, 0 ),   --  : specs (Integer)
           227 => ( Parameter_Integer, 0 ),   --  : startyr (Integer)
           228 => ( Parameter_Integer, 0 ),   --  : trav (Integer)
           229 => ( Parameter_Integer, 0 ),   --  : voucher (Integer)
           230 => ( Parameter_Integer, 0 ),   --  : whytrav1 (Integer)
           231 => ( Parameter_Integer, 0 ),   --  : whytrav2 (Integer)
           232 => ( Parameter_Integer, 0 ),   --  : whytrav3 (Integer)
           233 => ( Parameter_Integer, 0 ),   --  : whytrav4 (Integer)
           234 => ( Parameter_Integer, 0 ),   --  : whytrav5 (Integer)
           235 => ( Parameter_Integer, 0 ),   --  : whytrav6 (Integer)
           236 => ( Parameter_Integer, 0 ),   --  : wmkit (Integer)
           237 => ( Parameter_Integer, 0 ),   --  : chdda (Integer)
           238 => ( Parameter_Float, 0.0 ),   --  : fwmlkval (Amount)
           239 => ( Parameter_Integer, 0 ),   --  : cddatre (Integer)
           240 => ( Parameter_Integer, 0 ),   --  : cdisdif9 (Integer)
           241 => ( Parameter_Integer, 0 ),   --  : cddatrep (Integer)
           242 => ( Parameter_Integer, 0 ),   --  : cfund (Integer)
           243 => ( Parameter_Float, 0.0 ),   --  : cfundh (Amount)
           244 => ( Parameter_Integer, 0 ),   --  : cfundtp (Integer)
           245 => ( Parameter_Float, 0.0 ),   --  : fundamt1 (Amount)
           246 => ( Parameter_Float, 0.0 ),   --  : fundamt2 (Amount)
           247 => ( Parameter_Float, 0.0 ),   --  : fundamt3 (Amount)
           248 => ( Parameter_Float, 0.0 ),   --  : fundamt4 (Amount)
           249 => ( Parameter_Float, 0.0 ),   --  : fundamt5 (Amount)
           250 => ( Parameter_Float, 0.0 ),   --  : fundamt6 (Amount)
           251 => ( Parameter_Integer, 0 ),   --  : givcfnd1 (Integer)
           252 => ( Parameter_Integer, 0 ),   --  : givcfnd2 (Integer)
           253 => ( Parameter_Integer, 0 ),   --  : givcfnd3 (Integer)
           254 => ( Parameter_Integer, 0 ),   --  : givcfnd4 (Integer)
           255 => ( Parameter_Integer, 0 ),   --  : givcfnd5 (Integer)
           256 => ( Parameter_Integer, 0 ),   --  : givcfnd6 (Integer)
           257 => ( Parameter_Integer, 0 ),   --  : cddaprg (Integer)
           258 => ( Parameter_Integer, 0 ),   --  : disdifch (Integer)
           259 => ( Parameter_Integer, 0 ),   --  : mednum (Integer)
           260 => ( Parameter_Integer, 0 ),   --  : medprpd (Integer)
           261 => ( Parameter_Integer, 0 ),   --  : medprpy (Integer)
           262 => ( Parameter_Integer, 0 ),   --  : marital (Integer)
           ...
           268 => ( Parameter_Integer, 0 )   --  : person (Integer)
            ...
            7 => ( Parameter_Integer, 0 ),   --  : age (Integer)
            8 => ( Parameter_Integer, 0 ),   --  : btecnow (Integer)
            9 => ( Parameter_Integer, 0 ),   --  : c2orign (Integer)
           10 => ( Parameter_Integer, 0 ),   --  : cameyr (Integer)
           11 => ( Parameter_Integer, 0 ),   --  : care (Integer)
           12 => ( Parameter_Integer, 0 ),   --  : cdaprog1 (Integer)
           13 => ( Parameter_Integer, 0 ),   --  : cdatre1 (Integer)
           14 => ( Parameter_Integer, 0 ),   --  : cdatrep1 (Integer)
           15 => ( Parameter_Integer, 0 ),   --  : cdisd01 (Integer)
           16 => ( Parameter_Integer, 0 ),   --  : cdisd02 (Integer)
           17 => ( Parameter_Integer, 0 ),   --  : cdisd03 (Integer)
           18 => ( Parameter_Integer, 0 ),   --  : cdisd04 (Integer)
           19 => ( Parameter_Integer, 0 ),   --  : cdisd05 (Integer)
           20 => ( Parameter_Integer, 0 ),   --  : cdisd06 (Integer)
           21 => ( Parameter_Integer, 0 ),   --  : cdisd07 (Integer)
           22 => ( Parameter_Integer, 0 ),   --  : cdisd08 (Integer)
           23 => ( Parameter_Integer, 0 ),   --  : cdisd09 (Integer)
           24 => ( Parameter_Integer, 0 ),   --  : cdisd10 (Integer)
           25 => ( Parameter_Integer, 0 ),   --  : cdisdifp (Integer)
           26 => ( Parameter_Float, 0.0 ),   --  : chamtern (Amount)
           27 => ( Parameter_Float, 0.0 ),   --  : chamttst (Amount)
           28 => ( Parameter_Integer, 0 ),   --  : chbfd (Integer)
           29 => ( Parameter_Float, 0.0 ),   --  : chbfdamt (Amount)
           30 => ( Parameter_Integer, 0 ),   --  : chbfdpd (Integer)
           31 => ( Parameter_Integer, 0 ),   --  : chbfdval (Integer)
           32 => ( Parameter_Integer, 0 ),   --  : chca (Integer)
           33 => ( Parameter_Integer, 0 ),   --  : chcond (Integer)
           34 => ( Parameter_Integer, 0 ),   --  : chdla1 (Integer)
           35 => ( Parameter_Integer, 0 ),   --  : chdla2 (Integer)
           36 => ( Parameter_Integer, 0 ),   --  : chealth1 (Integer)
           37 => ( Parameter_Integer, 0 ),   --  : chearns1 (Integer)
           38 => ( Parameter_Integer, 0 ),   --  : chearns2 (Integer)
           39 => ( Parameter_Integer, 0 ),   --  : chearns3 (Integer)
           40 => ( Parameter_Integer, 0 ),   --  : chema (Integer)
           41 => ( Parameter_Float, 0.0 ),   --  : chemaamt (Amount)
           42 => ( Parameter_Integer, 0 ),   --  : chemapd (Integer)
           43 => ( Parameter_Integer, 0 ),   --  : chlimitl (Integer)
           44 => ( Parameter_Integer, 0 ),   --  : chpdern (Integer)
           45 => ( Parameter_Integer, 0 ),   --  : chpdtst (Integer)
           46 => ( Parameter_Integer, 0 ),   --  : chsave (Integer)
           47 => ( Parameter_Float, 0.0 ),   --  : chtrnamt (Amount)
           48 => ( Parameter_Integer, 0 ),   --  : chtrnpd (Integer)
           49 => ( Parameter_Integer, 0 ),   --  : citizen (Integer)
           50 => ( Parameter_Integer, 0 ),   --  : citizen2 (Integer)
           51 => ( Parameter_Integer, 0 ),   --  : cohabit (Integer)
           52 => ( Parameter_Integer, 0 ),   --  : contuk (Integer)
           53 => ( Parameter_Integer, 0 ),   --  : convbl (Integer)
           54 => ( Parameter_Integer, 0 ),   --  : corign (Integer)
           55 => ( Parameter_Integer, 0 ),   --  : corigoth (Integer)
           56 => ( Parameter_Integer, 0 ),   --  : curqual (Integer)
           57 => ( Parameter_Integer, 0 ),   --  : cvht (Integer)
           58 => ( Parameter_Integer, 0 ),   --  : cvpay (Integer)
           59 => ( Parameter_Integer, 0 ),   --  : cvpd (Integer)
           60 => ( Parameter_Integer, 0 ),   --  : degrenow (Integer)
           61 => ( Parameter_Integer, 0 ),   --  : denrec (Integer)
           62 => ( Parameter_Integer, 0 ),   --  : depend (Integer)
           63 => ( Parameter_Date, Clock ),   --  : dob (Ada.Calendar.Time)
           64 => ( Parameter_Integer, 0 ),   --  : dvmardf (Integer)
           65 => ( Parameter_Integer, 0 ),   --  : eligadlt (Integer)
           66 => ( Parameter_Integer, 0 ),   --  : eligchld (Integer)
           67 => ( Parameter_Integer, 0 ),   --  : fted (Integer)
           68 => ( Parameter_Integer, 0 ),   --  : x_grant (Integer)
           69 => ( Parameter_Float, 0.0 ),   --  : grtamt1 (Amount)
           70 => ( Parameter_Float, 0.0 ),   --  : grtamt2 (Amount)
           71 => ( Parameter_Float, 0.0 ),   --  : grtdir1 (Amount)
           72 => ( Parameter_Float, 0.0 ),   --  : grtdir2 (Amount)
           73 => ( Parameter_Integer, 0 ),   --  : grtnum (Integer)
           74 => ( Parameter_Integer, 0 ),   --  : grtsce1 (Integer)
           75 => ( Parameter_Integer, 0 ),   --  : grtsce2 (Integer)
           76 => ( Parameter_Float, 0.0 ),   --  : grtval1 (Amount)
           77 => ( Parameter_Float, 0.0 ),   --  : grtval2 (Amount)
           78 => ( Parameter_Integer, 0 ),   --  : heathch (Integer)
           79 => ( Parameter_Integer, 0 ),   --  : hholder (Integer)
           80 => ( Parameter_Integer, 0 ),   --  : highonow (Integer)
           81 => ( Parameter_Integer, 0 ),   --  : hrsed (Integer)
           82 => ( Parameter_Integer, 0 ),   --  : hsvper (Integer)
           83 => ( Parameter_Integer, 0 ),   --  : issue (Integer)
           84 => ( Parameter_Integer, 0 ),   --  : lareg (Integer)
           85 => ( Parameter_Integer, 0 ),   --  : medrec (Integer)
           86 => ( Parameter_Integer, 0 ),   --  : ms (Integer)
           87 => ( Parameter_Integer, 0 ),   --  : nvqlenow (Integer)
           88 => ( Parameter_Integer, 0 ),   --  : othpass (Integer)
           89 => ( Parameter_Integer, 0 ),   --  : parent1 (Integer)
           90 => ( Parameter_Integer, 0 ),   --  : parent2 (Integer)
           91 => ( Parameter_Integer, 0 ),   --  : prox1619 (Integer)
           92 => ( Parameter_Integer, 0 ),   --  : r01 (Integer)
           93 => ( Parameter_Integer, 0 ),   --  : r02 (Integer)
           94 => ( Parameter_Integer, 0 ),   --  : r03 (Integer)
           95 => ( Parameter_Integer, 0 ),   --  : r04 (Integer)
           96 => ( Parameter_Integer, 0 ),   --  : r05 (Integer)
           97 => ( Parameter_Integer, 0 ),   --  : r06 (Integer)
           98 => ( Parameter_Integer, 0 ),   --  : r07 (Integer)
           99 => ( Parameter_Integer, 0 ),   --  : r08 (Integer)
           100 => ( Parameter_Integer, 0 ),   --  : r09 (Integer)
           101 => ( Parameter_Integer, 0 ),   --  : r10 (Integer)
           102 => ( Parameter_Integer, 0 ),   --  : r11 (Integer)
           103 => ( Parameter_Integer, 0 ),   --  : r12 (Integer)
           104 => ( Parameter_Integer, 0 ),   --  : r13 (Integer)
           105 => ( Parameter_Integer, 0 ),   --  : r14 (Integer)
           106 => ( Parameter_Integer, 0 ),   --  : reasden (Integer)
           107 => ( Parameter_Integer, 0 ),   --  : reasmed (Integer)
           108 => ( Parameter_Integer, 0 ),   --  : reasnhs (Integer)
           109 => ( Parameter_Integer, 0 ),   --  : rsanow (Integer)
           110 => ( Parameter_Integer, 0 ),   --  : sbkit (Integer)
           111 => ( Parameter_Integer, 0 ),   --  : schchk (Integer)
           112 => ( Parameter_Integer, 0 ),   --  : sctvnow (Integer)
           113 => ( Parameter_Integer, 0 ),   --  : sex (Integer)
           114 => ( Parameter_Integer, 0 ),   --  : sfvit (Integer)
           115 => ( Parameter_Integer, 0 ),   --  : smkit (Integer)
           116 => ( Parameter_Integer, 0 ),   --  : smlit (Integer)
           117 => ( Parameter_Integer, 0 ),   --  : spcreg1 (Integer)
           118 => ( Parameter_Integer, 0 ),   --  : spcreg2 (Integer)
           119 => ( Parameter_Integer, 0 ),   --  : spcreg3 (Integer)
           120 => ( Parameter_Integer, 0 ),   --  : spout (Integer)
           121 => ( Parameter_Integer, 0 ),   --  : srentamt (Integer)
           122 => ( Parameter_Integer, 0 ),   --  : srentpd (Integer)
           123 => ( Parameter_Integer, 0 ),   --  : totsave (Integer)
           124 => ( Parameter_Integer, 0 ),   --  : trainee (Integer)
           125 => ( Parameter_Integer, 0 ),   --  : typeed (Integer)
           126 => ( Parameter_Integer, 0 ),   --  : month (Integer)
           127 => ( Parameter_Integer, 0 ),   --  : careab (Integer)
           128 => ( Parameter_Integer, 0 ),   --  : careah (Integer)
           129 => ( Parameter_Integer, 0 ),   --  : carecb (Integer)
           130 => ( Parameter_Integer, 0 ),   --  : carech (Integer)
           131 => ( Parameter_Integer, 0 ),   --  : carecl (Integer)
           132 => ( Parameter_Integer, 0 ),   --  : carefl (Integer)
           133 => ( Parameter_Integer, 0 ),   --  : carefr (Integer)
           134 => ( Parameter_Integer, 0 ),   --  : careot (Integer)
           135 => ( Parameter_Integer, 0 ),   --  : carere (Integer)
           136 => ( Parameter_Float, 0.0 ),   --  : chearns (Amount)
           137 => ( Parameter_Float, 0.0 ),   --  : chincdv (Amount)
           138 => ( Parameter_Float, 0.0 ),   --  : chrinc (Amount)
           139 => ( Parameter_Integer, 0 ),   --  : disactc1 (Integer)
           140 => ( Parameter_Integer, 0 ),   --  : discorc1 (Integer)
           141 => ( Parameter_Integer, 0 ),   --  : dobmonth (Integer)
           142 => ( Parameter_Integer, 0 ),   --  : dobyear (Integer)
           143 => ( Parameter_Float, 0.0 ),   --  : fsbval (Amount)
           144 => ( Parameter_Float, 0.0 ),   --  : fsfvval (Amount)
           145 => ( Parameter_Float, 0.0 ),   --  : fsmlkval (Amount)
           146 => ( Parameter_Float, 0.0 ),   --  : fsmval (Amount)
           147 => ( Parameter_Integer, 0 ),   --  : hdagech (Integer)
           148 => ( Parameter_Float, 0.0 ),   --  : heartval (Amount)
           149 => ( Parameter_Integer, 0 ),   --  : hourab (Integer)
           150 => ( Parameter_Integer, 0 ),   --  : hourah (Integer)
           151 => ( Parameter_Integer, 0 ),   --  : hourcb (Integer)
           152 => ( Parameter_Integer, 0 ),   --  : hourch (Integer)
           153 => ( Parameter_Integer, 0 ),   --  : hourcl (Integer)
           154 => ( Parameter_Integer, 0 ),   --  : hourfr (Integer)
           155 => ( Parameter_Integer, 0 ),   --  : hourot (Integer)
           156 => ( Parameter_Integer, 0 ),   --  : hourre (Integer)
           157 => ( Parameter_Integer, 0 ),   --  : hourtot (Integer)
           158 => ( Parameter_Integer, 0 ),   --  : hperson (Integer)
           159 => ( Parameter_Integer, 0 ),   --  : iagegr2 (Integer)
           160 => ( Parameter_Integer, 0 ),   --  : iagegrp (Integer)
           161 => ( Parameter_Integer, 0 ),   --  : relhrp (Integer)
           162 => ( Parameter_Float, 0.0 ),   --  : totgntch (Amount)
           163 => ( Parameter_Float, 0.0 ),   --  : tuacam (Amount)
           164 => ( Parameter_Integer, 0 ),   --  : typeed2 (Integer)
           165 => ( Parameter_Integer, 0 ),   --  : uperson (Integer)
           166 => ( Parameter_Integer, 0 ),   --  : xbonflag (Integer)
           167 => ( Parameter_Integer, 0 ),   --  : candgnow (Integer)
           168 => ( Parameter_Integer, 0 ),   --  : curothf (Integer)
           169 => ( Parameter_Integer, 0 ),   --  : curothp (Integer)
           170 => ( Parameter_Integer, 0 ),   --  : curothwv (Integer)
           171 => ( Parameter_Integer, 0 ),   --  : gnvqnow (Integer)
           172 => ( Parameter_Integer, 0 ),   --  : ndeplnow (Integer)
           173 => ( Parameter_Integer, 0 ),   --  : oqualc1 (Integer)
           174 => ( Parameter_Integer, 0 ),   --  : oqualc2 (Integer)
           175 => ( Parameter_Integer, 0 ),   --  : oqualc3 (Integer)
           176 => ( Parameter_Integer, 0 ),   --  : webacnow (Integer)
           177 => ( Parameter_Integer, 0 ),   --  : ntsctnow (Integer)
           178 => ( Parameter_Integer, 0 ),   --  : skiwknow (Integer)
           179 => ( Parameter_Integer, 0 ),   --  : adeduc (Integer)
           180 => ( Parameter_Integer, 0 ),   --  : benccdis (Integer)
           181 => ( Parameter_Integer, 0 ),   --  : cdisdif1 (Integer)
           182 => ( Parameter_Integer, 0 ),   --  : cdisdif2 (Integer)
           183 => ( Parameter_Integer, 0 ),   --  : cdisdif3 (Integer)
           184 => ( Parameter_Integer, 0 ),   --  : cdisdif4 (Integer)
           185 => ( Parameter_Integer, 0 ),   --  : cdisdif5 (Integer)
           186 => ( Parameter_Integer, 0 ),   --  : cdisdif6 (Integer)
           187 => ( Parameter_Integer, 0 ),   --  : cdisdif7 (Integer)
           188 => ( Parameter_Integer, 0 ),   --  : cdisdif8 (Integer)
           189 => ( Parameter_Float, 0.0 ),   --  : chamt1 (Amount)
           190 => ( Parameter_Float, 0.0 ),   --  : chamt2 (Amount)
           191 => ( Parameter_Float, 0.0 ),   --  : chamt3 (Amount)
           192 => ( Parameter_Float, 0.0 ),   --  : chamt4 (Amount)
           193 => ( Parameter_Integer, 0 ),   --  : chealth (Integer)
           194 => ( Parameter_Integer, 0 ),   --  : chfar (Integer)
           195 => ( Parameter_Integer, 0 ),   --  : chhr1 (Integer)
           196 => ( Parameter_Integer, 0 ),   --  : chhr2 (Integer)
           197 => ( Parameter_Integer, 0 ),   --  : chlook01 (Integer)
           198 => ( Parameter_Integer, 0 ),   --  : chlook02 (Integer)
           199 => ( Parameter_Integer, 0 ),   --  : chlook03 (Integer)
           200 => ( Parameter_Integer, 0 ),   --  : chlook04 (Integer)
           201 => ( Parameter_Integer, 0 ),   --  : chlook05 (Integer)
           202 => ( Parameter_Integer, 0 ),   --  : chlook06 (Integer)
           203 => ( Parameter_Integer, 0 ),   --  : chlook07 (Integer)
           204 => ( Parameter_Integer, 0 ),   --  : chlook08 (Integer)
           205 => ( Parameter_Integer, 0 ),   --  : chlook09 (Integer)
           206 => ( Parameter_Integer, 0 ),   --  : chlook10 (Integer)
           207 => ( Parameter_Integer, 0 ),   --  : chpay1 (Integer)
           208 => ( Parameter_Integer, 0 ),   --  : chpay2 (Integer)
           209 => ( Parameter_Integer, 0 ),   --  : chpay3 (Integer)
           210 => ( Parameter_Integer, 0 ),   --  : chprob (Integer)
           211 => ( Parameter_Integer, 0 ),   --  : chwkern (Integer)
           212 => ( Parameter_Integer, 0 ),   --  : chwktst (Integer)
           213 => ( Parameter_Integer, 0 ),   --  : chyrern (Integer)
           214 => ( Parameter_Integer, 0 ),   --  : chyrtst (Integer)
           215 => ( Parameter_Integer, 0 ),   --  : clone (Integer)
           216 => ( Parameter_Integer, 0 ),   --  : cost (Integer)
           217 => ( Parameter_Integer, 0 ),   --  : dentist (Integer)
           218 => ( Parameter_Integer, 0 ),   --  : endyr (Integer)
           219 => ( Parameter_Integer, 0 ),   --  : eyetest (Integer)
           220 => ( Parameter_Integer, 0 ),   --  : hosp (Integer)
           221 => ( Parameter_Integer, 0 ),   --  : legdep (Integer)
           222 => ( Parameter_Integer, 0 ),   --  : nhs1 (Integer)
           223 => ( Parameter_Integer, 0 ),   --  : nhs2 (Integer)
           224 => ( Parameter_Integer, 0 ),   --  : nhs3 (Integer)
           225 => ( Parameter_Integer, 0 ),   --  : prit (Integer)
           226 => ( Parameter_Integer, 0 ),   --  : prscrpt (Integer)
           227 => ( Parameter_Integer, 0 ),   --  : registr1 (Integer)
           228 => ( Parameter_Integer, 0 ),   --  : registr2 (Integer)
           229 => ( Parameter_Integer, 0 ),   --  : registr3 (Integer)
           230 => ( Parameter_Integer, 0 ),   --  : registr4 (Integer)
           231 => ( Parameter_Integer, 0 ),   --  : registr5 (Integer)
           232 => ( Parameter_Integer, 0 ),   --  : specs (Integer)
           233 => ( Parameter_Integer, 0 ),   --  : startyr (Integer)
           234 => ( Parameter_Integer, 0 ),   --  : trav (Integer)
           235 => ( Parameter_Integer, 0 ),   --  : voucher (Integer)
           236 => ( Parameter_Integer, 0 ),   --  : whytrav1 (Integer)
           237 => ( Parameter_Integer, 0 ),   --  : whytrav2 (Integer)
           238 => ( Parameter_Integer, 0 ),   --  : whytrav3 (Integer)
           239 => ( Parameter_Integer, 0 ),   --  : whytrav4 (Integer)
           240 => ( Parameter_Integer, 0 ),   --  : whytrav5 (Integer)
           241 => ( Parameter_Integer, 0 ),   --  : whytrav6 (Integer)
           242 => ( Parameter_Integer, 0 ),   --  : wmkit (Integer)
           243 => ( Parameter_Integer, 0 ),   --  : chdda (Integer)
           244 => ( Parameter_Float, 0.0 ),   --  : fwmlkval (Amount)
           245 => ( Parameter_Integer, 0 ),   --  : cddatre (Integer)
           246 => ( Parameter_Integer, 0 ),   --  : cdisdif9 (Integer)
           247 => ( Parameter_Integer, 0 ),   --  : cddatrep (Integer)
           248 => ( Parameter_Integer, 0 ),   --  : cfund (Integer)
           249 => ( Parameter_Float, 0.0 ),   --  : cfundh (Amount)
           250 => ( Parameter_Integer, 0 ),   --  : cfundtp (Integer)
           251 => ( Parameter_Float, 0.0 ),   --  : fundamt1 (Amount)
           252 => ( Parameter_Float, 0.0 ),   --  : fundamt2 (Amount)
           253 => ( Parameter_Float, 0.0 ),   --  : fundamt3 (Amount)
           254 => ( Parameter_Float, 0.0 ),   --  : fundamt4 (Amount)
           255 => ( Parameter_Float, 0.0 ),   --  : fundamt5 (Amount)
           256 => ( Parameter_Float, 0.0 ),   --  : fundamt6 (Amount)
           257 => ( Parameter_Integer, 0 ),   --  : givcfnd1 (Integer)
           258 => ( Parameter_Integer, 0 ),   --  : givcfnd2 (Integer)
           259 => ( Parameter_Integer, 0 ),   --  : givcfnd3 (Integer)
           260 => ( Parameter_Integer, 0 ),   --  : givcfnd4 (Integer)
           261 => ( Parameter_Integer, 0 ),   --  : givcfnd5 (Integer)
           262 => ( Parameter_Integer, 0 ),   --  : givcfnd6 (Integer)
           263 => ( Parameter_Integer, 0 ),   --  : cddaprg (Integer)
           264 => ( Parameter_Integer, 0 ),   --  : disdifch (Integer)
           265 => ( Parameter_Integer, 0 ),   --  : mednum (Integer)
           266 => ( Parameter_Integer, 0 ),   --  : medprpd (Integer)
           267 => ( Parameter_Integer, 0 ),   --  : medprpy (Integer)
           268 => ( Parameter_Integer, 0 )   --  : marital (Integer)
   ...
   function Get_Prepared_Update_Statement return gse.Prepared_Statement is 
      ...
      query : constant String := DB_Commons.Add_Schema_To_Query( UPDATE_PART, SCHEMA_NAME ) & " age = $1, btecnow = $2, c2orign = $3, cameyr = $4, care = $5, cdaprog1 = $6, cdatre1 = $7, cdatrep1 = $8, cdisd01 = $9, cdisd02 = $10, cdisd03 = $11, cdisd04 = $12, cdisd05 = $13, cdisd06 = $14, cdisd07 = $15, cdisd08 = $16, cdisd09 = $17, cdisd10 = $18, cdisdifp = $19, chamtern = $20, chamttst = $21, chbfd = $22, chbfdamt = $23, chbfdpd = $24, chbfdval = $25, chca = $26, chcond = $27, chdla1 = $28, chdla2 = $29, chealth1 = $30, chearns1 = $31, chearns2 = $32, chearns3 = $33, chema = $34, chemaamt = $35, chemapd = $36, chlimitl = $37, chpdern = $38, chpdtst = $39, chsave = $40, chtrnamt = $41, chtrnpd = $42, citizen = $43, citizen2 = $44, cohabit = $45, contuk = $46, convbl = $47, corign = $48, corigoth = $49, curqual = $50, cvht = $51, cvpay = $52, cvpd = $53, degrenow = $54, denrec = $55, depend = $56, dob = $57, dvmardf = $58, eligadlt = $59, eligchld = $60, fted = $61, x_grant = $62, grtamt1 = $63, grtamt2 = $64, grtdir1 = $65, grtdir2 = $66, grtnum = $67, grtsce1 = $68, grtsce2 = $69, grtval1 = $70, grtval2 = $71, heathch = $72, hholder = $73, highonow = $74, hrsed = $75, hsvper = $76, issue = $77, lareg = $78, medrec = $79, ms = $80, nvqlenow = $81, othpass = $82, parent1 = $83, parent2 = $84, prox1619 = $85, r01 = $86, r02 = $87, r03 = $88, r04 = $89, r05 = $90, r06 = $91, r07 = $92, r08 = $93, r09 = $94, r10 = $95, r11 = $96, r12 = $97, r13 = $98, r14 = $99, reasden = $100, reasmed = $101, reasnhs = $102, rsanow = $103, sbkit = $104, schchk = $105, sctvnow = $106, sex = $107, sfvit = $108, smkit = $109, smlit = $110, spcreg1 = $111, spcreg2 = $112, spcreg3 = $113, spout = $114, srentamt = $115, srentpd = $116, totsave = $117, trainee = $118, typeed = $119, month = $120, careab = $121, careah = $122, carecb = $123, carech = $124, carecl = $125, carefl = $126, carefr = $127, careot = $128, carere = $129, chearns = $130, chincdv = $131, chrinc = $132, disactc1 = $133, discorc1 = $134, dobmonth = $135, dobyear = $136, fsbval = $137, fsfvval = $138, fsmlkval = $139, fsmval = $140, hdagech = $141, heartval = $142, hourab = $143, hourah = $144, hourcb = $145, hourch = $146, hourcl = $147, hourfr = $148, hourot = $149, hourre = $150, hourtot = $151, hperson = $152, iagegr2 = $153, iagegrp = $154, relhrp = $155, totgntch = $156, tuacam = $157, typeed2 = $158, uperson = $159, xbonflag = $160, candgnow = $161, curothf = $162, curothp = $163, curothwv = $164, gnvqnow = $165, ndeplnow = $166, oqualc1 = $167, oqualc2 = $168, oqualc3 = $169, webacnow = $170, ntsctnow = $171, skiwknow = $172, adeduc = $173, benccdis = $174, cdisdif1 = $175, cdisdif2 = $176, cdisdif3 = $177, cdisdif4 = $178, cdisdif5 = $179, cdisdif6 = $180, cdisdif7 = $181, cdisdif8 = $182, chamt1 = $183, chamt2 = $184, chamt3 = $185, chamt4 = $186, chealth = $187, chfar = $188, chhr1 = $189, chhr2 = $190, chlook01 = $191, chlook02 = $192, chlook03 = $193, chlook04 = $194, chlook05 = $195, chlook06 = $196, chlook07 = $197, chlook08 = $198, chlook09 = $199, chlook10 = $200, chpay1 = $201, chpay2 = $202, chpay3 = $203, chprob = $204, chwkern = $205, chwktst = $206, chyrern = $207, chyrtst = $208, clone = $209, cost = $210, dentist = $211, endyr = $212, eyetest = $213, hosp = $214, legdep = $215, nhs1 = $216, nhs2 = $217, nhs3 = $218, prit = $219, prscrpt = $220, registr1 = $221, registr2 = $222, registr3 = $223, registr4 = $224, registr5 = $225, specs = $226, startyr = $227, trav = $228, voucher = $229, whytrav1 = $230, whytrav2 = $231, whytrav3 = $232, whytrav4 = $233, whytrav5 = $234, whytrav6 = $235, wmkit = $236, chdda = $237, fwmlkval = $238, cddatre = $239, cdisdif9 = $240, cddatrep = $241, cfund = $242, cfundh = $243, cfundtp = $244, fundamt1 = $245, fundamt2 = $246, fundamt3 = $247, fundamt4 = $248, fundamt5 = $249, fundamt6 = $250, givcfnd1 = $251, givcfnd2 = $252, givcfnd3 = $253, givcfnd4 = $254, givcfnd5 = $255, givcfnd6 = $256, cddaprg = $257, disdifch = $258, mednum = $259, medprpd = $260, medprpy = $261, marital = $262 where user_id = $263 and edition = $264 and year = $265 and sernum = $266 and benunit = $267 and person = $268"; 
   begin 
      ps := gse.Prepare( 
        query, 
        On_Server => True ); 
   ...
   begin
      ...
      if not gse.Is_Null( cursor, 6 )then
         a_child.age := gse.Integer_Value( cursor, 6 );
      end if;
      if not gse.Is_Null( cursor, 7 )then
         a_child.btecnow := gse.Integer_Value( cursor, 7 );
      end if;
      if not gse.Is_Null( cursor, 8 )then
         a_child.c2orign := gse.Integer_Value( cursor, 8 );
      end if;
      if not gse.Is_Null( cursor, 9 )then
         a_child.cameyr := gse.Integer_Value( cursor, 9 );
      end if;
      if not gse.Is_Null( cursor, 10 )then
         a_child.care := gse.Integer_Value( cursor, 10 );
      end if;
      if not gse.Is_Null( cursor, 11 )then
         a_child.cdaprog1 := gse.Integer_Value( cursor, 11 );
      end if;
      if not gse.Is_Null( cursor, 12 )then
         a_child.cdatre1 := gse.Integer_Value( cursor, 12 );
      end if;
      if not gse.Is_Null( cursor, 13 )then
         a_child.cdatrep1 := gse.Integer_Value( cursor, 13 );
      end if;
      if not gse.Is_Null( cursor, 14 )then
         a_child.cdisd01 := gse.Integer_Value( cursor, 14 );
      end if;
      if not gse.Is_Null( cursor, 15 )then
         a_child.cdisd02 := gse.Integer_Value( cursor, 15 );
      end if;
      if not gse.Is_Null( cursor, 16 )then
         a_child.cdisd03 := gse.Integer_Value( cursor, 16 );
      end if;
      if not gse.Is_Null( cursor, 17 )then
         a_child.cdisd04 := gse.Integer_Value( cursor, 17 );
      end if;
      if not gse.Is_Null( cursor, 18 )then
         a_child.cdisd05 := gse.Integer_Value( cursor, 18 );
      end if;
      if not gse.Is_Null( cursor, 19 )then
         a_child.cdisd06 := gse.Integer_Value( cursor, 19 );
      end if;
      if not gse.Is_Null( cursor, 20 )then
         a_child.cdisd07 := gse.Integer_Value( cursor, 20 );
      end if;
      if not gse.Is_Null( cursor, 21 )then
         a_child.cdisd08 := gse.Integer_Value( cursor, 21 );
      end if;
      if not gse.Is_Null( cursor, 22 )then
         a_child.cdisd09 := gse.Integer_Value( cursor, 22 );
      end if;
      if not gse.Is_Null( cursor, 23 )then
         a_child.cdisd10 := gse.Integer_Value( cursor, 23 );
      end if;
      if not gse.Is_Null( cursor, 24 )then
         a_child.cdisdifp := gse.Integer_Value( cursor, 24 );
      end if;
      if not gse.Is_Null( cursor, 25 )then
         a_child.chamtern:= Amount'Value( gse.Value( cursor, 25 ));
      end if;
      if not gse.Is_Null( cursor, 26 )then
         a_child.chamttst:= Amount'Value( gse.Value( cursor, 26 ));
      end if;
      if not gse.Is_Null( cursor, 27 )then
         a_child.chbfd := gse.Integer_Value( cursor, 27 );
      end if;
      if not gse.Is_Null( cursor, 28 )then
         a_child.chbfdamt:= Amount'Value( gse.Value( cursor, 28 ));
      end if;
      if not gse.Is_Null( cursor, 29 )then
         a_child.chbfdpd := gse.Integer_Value( cursor, 29 );
      end if;
      if not gse.Is_Null( cursor, 30 )then
         a_child.chbfdval := gse.Integer_Value( cursor, 30 );
      end if;
      if not gse.Is_Null( cursor, 31 )then
         a_child.chca := gse.Integer_Value( cursor, 31 );
      end if;
      if not gse.Is_Null( cursor, 32 )then
         a_child.chcond := gse.Integer_Value( cursor, 32 );
      end if;
      if not gse.Is_Null( cursor, 33 )then
         a_child.chdla1 := gse.Integer_Value( cursor, 33 );
      end if;
      if not gse.Is_Null( cursor, 34 )then
         a_child.chdla2 := gse.Integer_Value( cursor, 34 );
      end if;
      if not gse.Is_Null( cursor, 35 )then
         a_child.chealth1 := gse.Integer_Value( cursor, 35 );
      end if;
      if not gse.Is_Null( cursor, 36 )then
         a_child.chearns1 := gse.Integer_Value( cursor, 36 );
      end if;
      if not gse.Is_Null( cursor, 37 )then
         a_child.chearns2 := gse.Integer_Value( cursor, 37 );
      end if;
      if not gse.Is_Null( cursor, 38 )then
         a_child.chearns3 := gse.Integer_Value( cursor, 38 );
      end if;
      if not gse.Is_Null( cursor, 39 )then
         a_child.chema := gse.Integer_Value( cursor, 39 );
      end if;
      if not gse.Is_Null( cursor, 40 )then
         a_child.chemaamt:= Amount'Value( gse.Value( cursor, 40 ));
      end if;
      if not gse.Is_Null( cursor, 41 )then
         a_child.chemapd := gse.Integer_Value( cursor, 41 );
      end if;
      if not gse.Is_Null( cursor, 42 )then
         a_child.chlimitl := gse.Integer_Value( cursor, 42 );
      end if;
      if not gse.Is_Null( cursor, 43 )then
         a_child.chpdern := gse.Integer_Value( cursor, 43 );
      end if;
      if not gse.Is_Null( cursor, 44 )then
         a_child.chpdtst := gse.Integer_Value( cursor, 44 );
      end if;
      if not gse.Is_Null( cursor, 45 )then
         a_child.chsave := gse.Integer_Value( cursor, 45 );
      end if;
      if not gse.Is_Null( cursor, 46 )then
         a_child.chtrnamt:= Amount'Value( gse.Value( cursor, 46 ));
      end if;
      if not gse.Is_Null( cursor, 47 )then
         a_child.chtrnpd := gse.Integer_Value( cursor, 47 );
      end if;
      if not gse.Is_Null( cursor, 48 )then
         a_child.citizen := gse.Integer_Value( cursor, 48 );
      end if;
      if not gse.Is_Null( cursor, 49 )then
         a_child.citizen2 := gse.Integer_Value( cursor, 49 );
      end if;
      if not gse.Is_Null( cursor, 50 )then
         a_child.cohabit := gse.Integer_Value( cursor, 50 );
      end if;
      if not gse.Is_Null( cursor, 51 )then
         a_child.contuk := gse.Integer_Value( cursor, 51 );
      end if;
      if not gse.Is_Null( cursor, 52 )then
         a_child.convbl := gse.Integer_Value( cursor, 52 );
      end if;
      if not gse.Is_Null( cursor, 53 )then
         a_child.corign := gse.Integer_Value( cursor, 53 );
      end if;
      if not gse.Is_Null( cursor, 54 )then
         a_child.corigoth := gse.Integer_Value( cursor, 54 );
      end if;
      if not gse.Is_Null( cursor, 55 )then
         a_child.curqual := gse.Integer_Value( cursor, 55 );
      end if;
      if not gse.Is_Null( cursor, 56 )then
         a_child.cvht := gse.Integer_Value( cursor, 56 );
      end if;
      if not gse.Is_Null( cursor, 57 )then
         a_child.cvpay := gse.Integer_Value( cursor, 57 );
      end if;
      if not gse.Is_Null( cursor, 58 )then
         a_child.cvpd := gse.Integer_Value( cursor, 58 );
      end if;
      if not gse.Is_Null( cursor, 59 )then
         a_child.degrenow := gse.Integer_Value( cursor, 59 );
      end if;
      if not gse.Is_Null( cursor, 60 )then
         a_child.denrec := gse.Integer_Value( cursor, 60 );
      end if;
      if not gse.Is_Null( cursor, 61 )then
         a_child.depend := gse.Integer_Value( cursor, 61 );
      end if;
      if not gse.Is_Null( cursor, 62 )then
         a_child.dob := gse.Time_Value( cursor, 62 );
      end if;
      if not gse.Is_Null( cursor, 63 )then
         a_child.dvmardf := gse.Integer_Value( cursor, 63 );
      end if;
      if not gse.Is_Null( cursor, 64 )then
         a_child.eligadlt := gse.Integer_Value( cursor, 64 );
      end if;
      if not gse.Is_Null( cursor, 65 )then
         a_child.eligchld := gse.Integer_Value( cursor, 65 );
      end if;
      if not gse.Is_Null( cursor, 66 )then
         a_child.fted := gse.Integer_Value( cursor, 66 );
      end if;
      if not gse.Is_Null( cursor, 67 )then
         a_child.x_grant := gse.Integer_Value( cursor, 67 );
      end if;
      if not gse.Is_Null( cursor, 68 )then
         a_child.grtamt1:= Amount'Value( gse.Value( cursor, 68 ));
      end if;
      if not gse.Is_Null( cursor, 69 )then
         a_child.grtamt2:= Amount'Value( gse.Value( cursor, 69 ));
      end if;
      if not gse.Is_Null( cursor, 70 )then
         a_child.grtdir1:= Amount'Value( gse.Value( cursor, 70 ));
      end if;
      if not gse.Is_Null( cursor, 71 )then
         a_child.grtdir2:= Amount'Value( gse.Value( cursor, 71 ));
      end if;
      if not gse.Is_Null( cursor, 72 )then
         a_child.grtnum := gse.Integer_Value( cursor, 72 );
      end if;
      if not gse.Is_Null( cursor, 73 )then
         a_child.grtsce1 := gse.Integer_Value( cursor, 73 );
      end if;
      if not gse.Is_Null( cursor, 74 )then
         a_child.grtsce2 := gse.Integer_Value( cursor, 74 );
      end if;
      if not gse.Is_Null( cursor, 75 )then
         a_child.grtval1:= Amount'Value( gse.Value( cursor, 75 ));
      end if;
      if not gse.Is_Null( cursor, 76 )then
         a_child.grtval2:= Amount'Value( gse.Value( cursor, 76 ));
      end if;
      if not gse.Is_Null( cursor, 77 )then
         a_child.heathch := gse.Integer_Value( cursor, 77 );
      end if;
      if not gse.Is_Null( cursor, 78 )then
         a_child.hholder := gse.Integer_Value( cursor, 78 );
      end if;
      if not gse.Is_Null( cursor, 79 )then
         a_child.highonow := gse.Integer_Value( cursor, 79 );
      end if;
      if not gse.Is_Null( cursor, 80 )then
         a_child.hrsed := gse.Integer_Value( cursor, 80 );
      end if;
      if not gse.Is_Null( cursor, 81 )then
         a_child.hsvper := gse.Integer_Value( cursor, 81 );
      end if;
      if not gse.Is_Null( cursor, 82 )then
         a_child.issue := gse.Integer_Value( cursor, 82 );
      end if;
      if not gse.Is_Null( cursor, 83 )then
         a_child.lareg := gse.Integer_Value( cursor, 83 );
      end if;
      if not gse.Is_Null( cursor, 84 )then
         a_child.medrec := gse.Integer_Value( cursor, 84 );
      end if;
      if not gse.Is_Null( cursor, 85 )then
         a_child.ms := gse.Integer_Value( cursor, 85 );
      end if;
      if not gse.Is_Null( cursor, 86 )then
         a_child.nvqlenow := gse.Integer_Value( cursor, 86 );
      end if;
      if not gse.Is_Null( cursor, 87 )then
         a_child.othpass := gse.Integer_Value( cursor, 87 );
      end if;
      if not gse.Is_Null( cursor, 88 )then
         a_child.parent1 := gse.Integer_Value( cursor, 88 );
      end if;
      if not gse.Is_Null( cursor, 89 )then
         a_child.parent2 := gse.Integer_Value( cursor, 89 );
      end if;
      if not gse.Is_Null( cursor, 90 )then
         a_child.prox1619 := gse.Integer_Value( cursor, 90 );
      end if;
      if not gse.Is_Null( cursor, 91 )then
         a_child.r01 := gse.Integer_Value( cursor, 91 );
      end if;
      if not gse.Is_Null( cursor, 92 )then
         a_child.r02 := gse.Integer_Value( cursor, 92 );
      end if;
      if not gse.Is_Null( cursor, 93 )then
         a_child.r03 := gse.Integer_Value( cursor, 93 );
      end if;
      if not gse.Is_Null( cursor, 94 )then
         a_child.r04 := gse.Integer_Value( cursor, 94 );
      end if;
      if not gse.Is_Null( cursor, 95 )then
         a_child.r05 := gse.Integer_Value( cursor, 95 );
      end if;
      if not gse.Is_Null( cursor, 96 )then
         a_child.r06 := gse.Integer_Value( cursor, 96 );
      end if;
      if not gse.Is_Null( cursor, 97 )then
         a_child.r07 := gse.Integer_Value( cursor, 97 );
      end if;
      if not gse.Is_Null( cursor, 98 )then
         a_child.r08 := gse.Integer_Value( cursor, 98 );
      end if;
      if not gse.Is_Null( cursor, 99 )then
         a_child.r09 := gse.Integer_Value( cursor, 99 );
      end if;
      if not gse.Is_Null( cursor, 100 )then
         a_child.r10 := gse.Integer_Value( cursor, 100 );
      end if;
      if not gse.Is_Null( cursor, 101 )then
         a_child.r11 := gse.Integer_Value( cursor, 101 );
      end if;
      if not gse.Is_Null( cursor, 102 )then
         a_child.r12 := gse.Integer_Value( cursor, 102 );
      end if;
      if not gse.Is_Null( cursor, 103 )then
         a_child.r13 := gse.Integer_Value( cursor, 103 );
      end if;
      if not gse.Is_Null( cursor, 104 )then
         a_child.r14 := gse.Integer_Value( cursor, 104 );
      end if;
      if not gse.Is_Null( cursor, 105 )then
         a_child.reasden := gse.Integer_Value( cursor, 105 );
      end if;
      if not gse.Is_Null( cursor, 106 )then
         a_child.reasmed := gse.Integer_Value( cursor, 106 );
      end if;
      if not gse.Is_Null( cursor, 107 )then
         a_child.reasnhs := gse.Integer_Value( cursor, 107 );
      end if;
      if not gse.Is_Null( cursor, 108 )then
         a_child.rsanow := gse.Integer_Value( cursor, 108 );
      end if;
      if not gse.Is_Null( cursor, 109 )then
         a_child.sbkit := gse.Integer_Value( cursor, 109 );
      end if;
      if not gse.Is_Null( cursor, 110 )then
         a_child.schchk := gse.Integer_Value( cursor, 110 );
      end if;
      if not gse.Is_Null( cursor, 111 )then
         a_child.sctvnow := gse.Integer_Value( cursor, 111 );
      end if;
      if not gse.Is_Null( cursor, 112 )then
         a_child.sex := gse.Integer_Value( cursor, 112 );
      end if;
      if not gse.Is_Null( cursor, 113 )then
         a_child.sfvit := gse.Integer_Value( cursor, 113 );
      end if;
      if not gse.Is_Null( cursor, 114 )then
         a_child.smkit := gse.Integer_Value( cursor, 114 );
      end if;
      if not gse.Is_Null( cursor, 115 )then
         a_child.smlit := gse.Integer_Value( cursor, 115 );
      end if;
      if not gse.Is_Null( cursor, 116 )then
         a_child.spcreg1 := gse.Integer_Value( cursor, 116 );
      end if;
      if not gse.Is_Null( cursor, 117 )then
         a_child.spcreg2 := gse.Integer_Value( cursor, 117 );
      end if;
      if not gse.Is_Null( cursor, 118 )then
         a_child.spcreg3 := gse.Integer_Value( cursor, 118 );
      end if;
      ...
      if not gse.Is_Null( cursor, 122 )then
         a_child.totsave := gse.Integer_Value( cursor, 122 );
      end if;
      if not gse.Is_Null( cursor, 123 )then
         a_child.trainee := gse.Integer_Value( cursor, 123 );
      end if;
      if not gse.Is_Null( cursor, 124 )then
         a_child.typeed := gse.Integer_Value( cursor, 124 );
      end if;
      if not gse.Is_Null( cursor, 125 )then
         a_child.month := gse.Integer_Value( cursor, 125 );
      end if;
      if not gse.Is_Null( cursor, 126 )then
         a_child.careab := gse.Integer_Value( cursor, 126 );
      end if;
      if not gse.Is_Null( cursor, 127 )then
         a_child.careah := gse.Integer_Value( cursor, 127 );
      end if;
      if not gse.Is_Null( cursor, 128 )then
         a_child.carecb := gse.Integer_Value( cursor, 128 );
      end if;
      if not gse.Is_Null( cursor, 129 )then
         a_child.carech := gse.Integer_Value( cursor, 129 );
      end if;
      if not gse.Is_Null( cursor, 130 )then
         a_child.carecl := gse.Integer_Value( cursor, 130 );
      end if;
      if not gse.Is_Null( cursor, 131 )then
         a_child.carefl := gse.Integer_Value( cursor, 131 );
      end if;
      if not gse.Is_Null( cursor, 132 )then
         a_child.carefr := gse.Integer_Value( cursor, 132 );
      end if;
      if not gse.Is_Null( cursor, 133 )then
         a_child.careot := gse.Integer_Value( cursor, 133 );
      end if;
      if not gse.Is_Null( cursor, 134 )then
         a_child.carere := gse.Integer_Value( cursor, 134 );
      end if;
      if not gse.Is_Null( cursor, 135 )then
         a_child.chearns:= Amount'Value( gse.Value( cursor, 135 ));
      end if;
      if not gse.Is_Null( cursor, 136 )then
         a_child.chincdv:= Amount'Value( gse.Value( cursor, 136 ));
      end if;
      if not gse.Is_Null( cursor, 137 )then
         a_child.chrinc:= Amount'Value( gse.Value( cursor, 137 ));
      end if;
      if not gse.Is_Null( cursor, 138 )then
         a_child.disactc1 := gse.Integer_Value( cursor, 138 );
      end if;
      if not gse.Is_Null( cursor, 139 )then
         a_child.discorc1 := gse.Integer_Value( cursor, 139 );
      end if;
      if not gse.Is_Null( cursor, 140 )then
         a_child.dobmonth := gse.Integer_Value( cursor, 140 );
      end if;
      if not gse.Is_Null( cursor, 141 )then
         a_child.dobyear := gse.Integer_Value( cursor, 141 );
      end if;
      if not gse.Is_Null( cursor, 142 )then
         a_child.fsbval:= Amount'Value( gse.Value( cursor, 142 ));
      end if;
      if not gse.Is_Null( cursor, 143 )then
         a_child.fsfvval:= Amount'Value( gse.Value( cursor, 143 ));
      end if;
      if not gse.Is_Null( cursor, 144 )then
         a_child.fsmlkval:= Amount'Value( gse.Value( cursor, 144 ));
      end if;
      if not gse.Is_Null( cursor, 145 )then
         a_child.fsmval:= Amount'Value( gse.Value( cursor, 145 ));
      end if;
      if not gse.Is_Null( cursor, 146 )then
         a_child.hdagech := gse.Integer_Value( cursor, 146 );
      end if;
      if not gse.Is_Null( cursor, 147 )then
         a_child.heartval:= Amount'Value( gse.Value( cursor, 147 ));
      end if;
      if not gse.Is_Null( cursor, 148 )then
         a_child.hourab := gse.Integer_Value( cursor, 148 );
      end if;
      if not gse.Is_Null( cursor, 149 )then
         a_child.hourah := gse.Integer_Value( cursor, 149 );
      end if;
      if not gse.Is_Null( cursor, 150 )then
         a_child.hourcb := gse.Integer_Value( cursor, 150 );
      end if;
      if not gse.Is_Null( cursor, 151 )then
         a_child.hourch := gse.Integer_Value( cursor, 151 );
      end if;
      if not gse.Is_Null( cursor, 152 )then
         a_child.hourcl := gse.Integer_Value( cursor, 152 );
      end if;
      if not gse.Is_Null( cursor, 153 )then
         a_child.hourfr := gse.Integer_Value( cursor, 153 );
      end if;
      if not gse.Is_Null( cursor, 154 )then
         a_child.hourot := gse.Integer_Value( cursor, 154 );
      end if;
      if not gse.Is_Null( cursor, 155 )then
         a_child.hourre := gse.Integer_Value( cursor, 155 );
      end if;
      if not gse.Is_Null( cursor, 156 )then
         a_child.hourtot := gse.Integer_Value( cursor, 156 );
      end if;
      if not gse.Is_Null( cursor, 157 )then
         a_child.hperson := gse.Integer_Value( cursor, 157 );
      end if;
      if not gse.Is_Null( cursor, 158 )then
         a_child.iagegr2 := gse.Integer_Value( cursor, 158 );
      end if;
      if not gse.Is_Null( cursor, 159 )then
         a_child.iagegrp := gse.Integer_Value( cursor, 159 );
      end if;
      if not gse.Is_Null( cursor, 160 )then
         a_child.relhrp := gse.Integer_Value( cursor, 160 );
      end if;
      if not gse.Is_Null( cursor, 161 )then
         a_child.totgntch:= Amount'Value( gse.Value( cursor, 161 ));
      end if;
      if not gse.Is_Null( cursor, 162 )then
         a_child.tuacam:= Amount'Value( gse.Value( cursor, 162 ));
      end if;
      if not gse.Is_Null( cursor, 163 )then
         a_child.typeed2 := gse.Integer_Value( cursor, 163 );
      end if;
      if not gse.Is_Null( cursor, 164 )then
         a_child.uperson := gse.Integer_Value( cursor, 164 );
      end if;
      if not gse.Is_Null( cursor, 165 )then
         a_child.xbonflag := gse.Integer_Value( cursor, 165 );
      end if;
      if not gse.Is_Null( cursor, 166 )then
         a_child.candgnow := gse.Integer_Value( cursor, 166 );
      end if;
      if not gse.Is_Null( cursor, 167 )then
         a_child.curothf := gse.Integer_Value( cursor, 167 );
      end if;
      if not gse.Is_Null( cursor, 168 )then
         a_child.curothp := gse.Integer_Value( cursor, 168 );
      end if;
      if not gse.Is_Null( cursor, 169 )then
         a_child.curothwv := gse.Integer_Value( cursor, 169 );
      end if;
      if not gse.Is_Null( cursor, 170 )then
         a_child.gnvqnow := gse.Integer_Value( cursor, 170 );
      end if;
      if not gse.Is_Null( cursor, 171 )then
         a_child.ndeplnow := gse.Integer_Value( cursor, 171 );
      end if;
      if not gse.Is_Null( cursor, 172 )then
         a_child.oqualc1 := gse.Integer_Value( cursor, 172 );
      end if;
      if not gse.Is_Null( cursor, 173 )then
         a_child.oqualc2 := gse.Integer_Value( cursor, 173 );
      end if;
      if not gse.Is_Null( cursor, 174 )then
         a_child.oqualc3 := gse.Integer_Value( cursor, 174 );
      end if;
      if not gse.Is_Null( cursor, 175 )then
         a_child.webacnow := gse.Integer_Value( cursor, 175 );
      end if;
      if not gse.Is_Null( cursor, 176 )then
         a_child.ntsctnow := gse.Integer_Value( cursor, 176 );
      end if;
      if not gse.Is_Null( cursor, 177 )then
         a_child.skiwknow := gse.Integer_Value( cursor, 177 );
      end if;
      if not gse.Is_Null( cursor, 178 )then
         a_child.adeduc := gse.Integer_Value( cursor, 178 );
      end if;
      if not gse.Is_Null( cursor, 179 )then
         a_child.benccdis := gse.Integer_Value( cursor, 179 );
      end if;
      if not gse.Is_Null( cursor, 180 )then
         a_child.cdisdif1 := gse.Integer_Value( cursor, 180 );
      end if;
      if not gse.Is_Null( cursor, 181 )then
         a_child.cdisdif2 := gse.Integer_Value( cursor, 181 );
      end if;
      if not gse.Is_Null( cursor, 182 )then
         a_child.cdisdif3 := gse.Integer_Value( cursor, 182 );
      end if;
      if not gse.Is_Null( cursor, 183 )then
         a_child.cdisdif4 := gse.Integer_Value( cursor, 183 );
      end if;
      if not gse.Is_Null( cursor, 184 )then
         a_child.cdisdif5 := gse.Integer_Value( cursor, 184 );
      end if;
      if not gse.Is_Null( cursor, 185 )then
         a_child.cdisdif6 := gse.Integer_Value( cursor, 185 );
      end if;
      if not gse.Is_Null( cursor, 186 )then
         a_child.cdisdif7 := gse.Integer_Value( cursor, 186 );
      end if;
      if not gse.Is_Null( cursor, 187 )then
         a_child.cdisdif8 := gse.Integer_Value( cursor, 187 );
      end if;
      if not gse.Is_Null( cursor, 188 )then
         a_child.chamt1:= Amount'Value( gse.Value( cursor, 188 ));
      end if;
      if not gse.Is_Null( cursor, 189 )then
         a_child.chamt2:= Amount'Value( gse.Value( cursor, 189 ));
      end if;
      if not gse.Is_Null( cursor, 190 )then
         a_child.chamt3:= Amount'Value( gse.Value( cursor, 190 ));
      end if;
      if not gse.Is_Null( cursor, 191 )then
         a_child.chamt4:= Amount'Value( gse.Value( cursor, 191 ));
      end if;
      if not gse.Is_Null( cursor, 192 )then
         a_child.chealth := gse.Integer_Value( cursor, 192 );
      end if;
      if not gse.Is_Null( cursor, 193 )then
         a_child.chfar := gse.Integer_Value( cursor, 193 );
      end if;
      if not gse.Is_Null( cursor, 194 )then
         a_child.chhr1 := gse.Integer_Value( cursor, 194 );
      end if;
      if not gse.Is_Null( cursor, 195 )then
         a_child.chhr2 := gse.Integer_Value( cursor, 195 );
      end if;
      if not gse.Is_Null( cursor, 196 )then
         a_child.chlook01 := gse.Integer_Value( cursor, 196 );
      end if;
      if not gse.Is_Null( cursor, 197 )then
         a_child.chlook02 := gse.Integer_Value( cursor, 197 );
      end if;
      if not gse.Is_Null( cursor, 198 )then
         a_child.chlook03 := gse.Integer_Value( cursor, 198 );
      end if;
      if not gse.Is_Null( cursor, 199 )then
         a_child.chlook04 := gse.Integer_Value( cursor, 199 );
      end if;
      if not gse.Is_Null( cursor, 200 )then
         a_child.chlook05 := gse.Integer_Value( cursor, 200 );
      end if;
      if not gse.Is_Null( cursor, 201 )then
         a_child.chlook06 := gse.Integer_Value( cursor, 201 );
      end if;
      if not gse.Is_Null( cursor, 202 )then
         a_child.chlook07 := gse.Integer_Value( cursor, 202 );
      end if;
      if not gse.Is_Null( cursor, 203 )then
         a_child.chlook08 := gse.Integer_Value( cursor, 203 );
      end if;
      if not gse.Is_Null( cursor, 204 )then
         a_child.chlook09 := gse.Integer_Value( cursor, 204 );
      end if;
      if not gse.Is_Null( cursor, 205 )then
         a_child.chlook10 := gse.Integer_Value( cursor, 205 );
      end if;
      if not gse.Is_Null( cursor, 206 )then
         a_child.chpay1 := gse.Integer_Value( cursor, 206 );
      end if;
      if not gse.Is_Null( cursor, 207 )then
         a_child.chpay2 := gse.Integer_Value( cursor, 207 );
      end if;
      if not gse.Is_Null( cursor, 208 )then
         a_child.chpay3 := gse.Integer_Value( cursor, 208 );
      end if;
      if not gse.Is_Null( cursor, 209 )then
         a_child.chprob := gse.Integer_Value( cursor, 209 );
      end if;
      if not gse.Is_Null( cursor, 210 )then
         a_child.chwkern := gse.Integer_Value( cursor, 210 );
      end if;
      if not gse.Is_Null( cursor, 211 )then
         a_child.chwktst := gse.Integer_Value( cursor, 211 );
      end if;
      if not gse.Is_Null( cursor, 212 )then
         a_child.chyrern := gse.Integer_Value( cursor, 212 );
      end if;
      if not gse.Is_Null( cursor, 213 )then
         a_child.chyrtst := gse.Integer_Value( cursor, 213 );
      end if;
      if not gse.Is_Null( cursor, 214 )then
         a_child.clone := gse.Integer_Value( cursor, 214 );
      end if;
      if not gse.Is_Null( cursor, 215 )then
         a_child.cost := gse.Integer_Value( cursor, 215 );
      end if;
      if not gse.Is_Null( cursor, 216 )then
         a_child.dentist := gse.Integer_Value( cursor, 216 );
      end if;
      if not gse.Is_Null( cursor, 217 )then
         a_child.endyr := gse.Integer_Value( cursor, 217 );
      end if;
      if not gse.Is_Null( cursor, 218 )then
         a_child.eyetest := gse.Integer_Value( cursor, 218 );
      end if;
      if not gse.Is_Null( cursor, 219 )then
         a_child.hosp := gse.Integer_Value( cursor, 219 );
      end if;
      if not gse.Is_Null( cursor, 220 )then
         a_child.legdep := gse.Integer_Value( cursor, 220 );
      end if;
      if not gse.Is_Null( cursor, 221 )then
         a_child.nhs1 := gse.Integer_Value( cursor, 221 );
      end if;
      if not gse.Is_Null( cursor, 222 )then
         a_child.nhs2 := gse.Integer_Value( cursor, 222 );
      end if;
      if not gse.Is_Null( cursor, 223 )then
         a_child.nhs3 := gse.Integer_Value( cursor, 223 );
      end if;
      if not gse.Is_Null( cursor, 224 )then
         a_child.prit := gse.Integer_Value( cursor, 224 );
      end if;
      if not gse.Is_Null( cursor, 225 )then
         a_child.prscrpt := gse.Integer_Value( cursor, 225 );
      end if;
      if not gse.Is_Null( cursor, 226 )then
         a_child.registr1 := gse.Integer_Value( cursor, 226 );
      end if;
      if not gse.Is_Null( cursor, 227 )then
         a_child.registr2 := gse.Integer_Value( cursor, 227 );
      end if;
      if not gse.Is_Null( cursor, 228 )then
         a_child.registr3 := gse.Integer_Value( cursor, 228 );
      end if;
      if not gse.Is_Null( cursor, 229 )then
         a_child.registr4 := gse.Integer_Value( cursor, 229 );
      end if;
      if not gse.Is_Null( cursor, 230 )then
         a_child.registr5 := gse.Integer_Value( cursor, 230 );
      end if;
      if not gse.Is_Null( cursor, 231 )then
         a_child.specs := gse.Integer_Value( cursor, 231 );
      end if;
      if not gse.Is_Null( cursor, 232 )then
         a_child.startyr := gse.Integer_Value( cursor, 232 );
      end if;
      if not gse.Is_Null( cursor, 233 )then
         a_child.trav := gse.Integer_Value( cursor, 233 );
      end if;
      if not gse.Is_Null( cursor, 234 )then
         a_child.voucher := gse.Integer_Value( cursor, 234 );
      end if;
      if not gse.Is_Null( cursor, 235 )then
         a_child.whytrav1 := gse.Integer_Value( cursor, 235 );
      end if;
      if not gse.Is_Null( cursor, 236 )then
         a_child.whytrav2 := gse.Integer_Value( cursor, 236 );
      end if;
      if not gse.Is_Null( cursor, 237 )then
         a_child.whytrav3 := gse.Integer_Value( cursor, 237 );
      end if;
      if not gse.Is_Null( cursor, 238 )then
         a_child.whytrav4 := gse.Integer_Value( cursor, 238 );
      end if;
      if not gse.Is_Null( cursor, 239 )then
         a_child.whytrav5 := gse.Integer_Value( cursor, 239 );
      end if;
      if not gse.Is_Null( cursor, 240 )then
         a_child.whytrav6 := gse.Integer_Value( cursor, 240 );
      end if;
      if not gse.Is_Null( cursor, 241 )then
         a_child.wmkit := gse.Integer_Value( cursor, 241 );
      end if;
      if not gse.Is_Null( cursor, 242 )then
         a_child.chdda := gse.Integer_Value( cursor, 242 );
      end if;
      if not gse.Is_Null( cursor, 243 )then
         a_child.fwmlkval:= Amount'Value( gse.Value( cursor, 243 ));
      end if;
      if not gse.Is_Null( cursor, 244 )then
         a_child.cddatre := gse.Integer_Value( cursor, 244 );
      end if;
      if not gse.Is_Null( cursor, 245 )then
         a_child.cdisdif9 := gse.Integer_Value( cursor, 245 );
      end if;
      if not gse.Is_Null( cursor, 246 )then
         a_child.cddatrep := gse.Integer_Value( cursor, 246 );
      end if;
      if not gse.Is_Null( cursor, 247 )then
         a_child.cfund := gse.Integer_Value( cursor, 247 );
      end if;
      if not gse.Is_Null( cursor, 248 )then
         a_child.cfundh:= Amount'Value( gse.Value( cursor, 248 ));
      end if;
      if not gse.Is_Null( cursor, 249 )then
         a_child.cfundtp := gse.Integer_Value( cursor, 249 );
      end if;
      if not gse.Is_Null( cursor, 250 )then
         a_child.fundamt1:= Amount'Value( gse.Value( cursor, 250 ));
      end if;
      if not gse.Is_Null( cursor, 251 )then
         a_child.fundamt2:= Amount'Value( gse.Value( cursor, 251 ));
      end if;
      if not gse.Is_Null( cursor, 252 )then
         a_child.fundamt3:= Amount'Value( gse.Value( cursor, 252 ));
      end if;
      if not gse.Is_Null( cursor, 253 )then
         a_child.fundamt4:= Amount'Value( gse.Value( cursor, 253 ));
      end if;
      if not gse.Is_Null( cursor, 254 )then
         a_child.fundamt5:= Amount'Value( gse.Value( cursor, 254 ));
      end if;
      if not gse.Is_Null( cursor, 255 )then
         a_child.fundamt6:= Amount'Value( gse.Value( cursor, 255 ));
      end if;
      if not gse.Is_Null( cursor, 256 )then
         a_child.givcfnd1 := gse.Integer_Value( cursor, 256 );
      end if;
      if not gse.Is_Null( cursor, 257 )then
         a_child.givcfnd2 := gse.Integer_Value( cursor, 257 );
      end if;
      if not gse.Is_Null( cursor, 258 )then
         a_child.givcfnd3 := gse.Integer_Value( cursor, 258 );
      end if;
      if not gse.Is_Null( cursor, 259 )then
         a_child.givcfnd4 := gse.Integer_Value( cursor, 259 );
      end if;
      if not gse.Is_Null( cursor, 260 )then
         a_child.givcfnd5 := gse.Integer_Value( cursor, 260 );
      end if;
      if not gse.Is_Null( cursor, 261 )then
         a_child.givcfnd6 := gse.Integer_Value( cursor, 261 );
      end if;
      if not gse.Is_Null( cursor, 262 )then
         a_child.cddaprg := gse.Integer_Value( cursor, 262 );
      end if;
      if not gse.Is_Null( cursor, 263 )then
         a_child.disdifch := gse.Integer_Value( cursor, 263 );
      end if;
      if not gse.Is_Null( cursor, 264 )then
         a_child.mednum := gse.Integer_Value( cursor, 264 );
      end if;
      if not gse.Is_Null( cursor, 265 )then
         a_child.medprpd := gse.Integer_Value( cursor, 265 );
      end if;
      if not gse.Is_Null( cursor, 266 )then
         a_child.medprpy := gse.Integer_Value( cursor, 266 );
      end if;
      if not gse.Is_Null( cursor, 267 )then
         a_child.marital := gse.Integer_Value( cursor, 267 );
      end if;
      return a_child;
   end Map_From_Cursor;
   ...
   begin
      ...
      params( 1 ) := "+"( Integer'Pos( a_child.age ));
      params( 2 ) := "+"( Integer'Pos( a_child.btecnow ));
      params( 3 ) := "+"( Integer'Pos( a_child.c2orign ));
      params( 4 ) := "+"( Integer'Pos( a_child.cameyr ));
      params( 5 ) := "+"( Integer'Pos( a_child.care ));
      params( 6 ) := "+"( Integer'Pos( a_child.cdaprog1 ));
      params( 7 ) := "+"( Integer'Pos( a_child.cdatre1 ));
      params( 8 ) := "+"( Integer'Pos( a_child.cdatrep1 ));
      params( 9 ) := "+"( Integer'Pos( a_child.cdisd01 ));
      params( 10 ) := "+"( Integer'Pos( a_child.cdisd02 ));
      params( 11 ) := "+"( Integer'Pos( a_child.cdisd03 ));
      params( 12 ) := "+"( Integer'Pos( a_child.cdisd04 ));
      params( 13 ) := "+"( Integer'Pos( a_child.cdisd05 ));
      params( 14 ) := "+"( Integer'Pos( a_child.cdisd06 ));
      params( 15 ) := "+"( Integer'Pos( a_child.cdisd07 ));
      params( 16 ) := "+"( Integer'Pos( a_child.cdisd08 ));
      params( 17 ) := "+"( Integer'Pos( a_child.cdisd09 ));
      params( 18 ) := "+"( Integer'Pos( a_child.cdisd10 ));
      params( 19 ) := "+"( Integer'Pos( a_child.cdisdifp ));
      params( 20 ) := "+"( Float( a_child.chamtern ));
      params( 21 ) := "+"( Float( a_child.chamttst ));
      params( 22 ) := "+"( Integer'Pos( a_child.chbfd ));
      params( 23 ) := "+"( Float( a_child.chbfdamt ));
      params( 24 ) := "+"( Integer'Pos( a_child.chbfdpd ));
      params( 25 ) := "+"( Integer'Pos( a_child.chbfdval ));
      params( 26 ) := "+"( Integer'Pos( a_child.chca ));
      params( 27 ) := "+"( Integer'Pos( a_child.chcond ));
      params( 28 ) := "+"( Integer'Pos( a_child.chdla1 ));
      params( 29 ) := "+"( Integer'Pos( a_child.chdla2 ));
      params( 30 ) := "+"( Integer'Pos( a_child.chealth1 ));
      params( 31 ) := "+"( Integer'Pos( a_child.chearns1 ));
      params( 32 ) := "+"( Integer'Pos( a_child.chearns2 ));
      params( 33 ) := "+"( Integer'Pos( a_child.chearns3 ));
      params( 34 ) := "+"( Integer'Pos( a_child.chema ));
      params( 35 ) := "+"( Float( a_child.chemaamt ));
      params( 36 ) := "+"( Integer'Pos( a_child.chemapd ));
      params( 37 ) := "+"( Integer'Pos( a_child.chlimitl ));
      params( 38 ) := "+"( Integer'Pos( a_child.chpdern ));
      params( 39 ) := "+"( Integer'Pos( a_child.chpdtst ));
      params( 40 ) := "+"( Integer'Pos( a_child.chsave ));
      params( 41 ) := "+"( Float( a_child.chtrnamt ));
      params( 42 ) := "+"( Integer'Pos( a_child.chtrnpd ));
      params( 43 ) := "+"( Integer'Pos( a_child.citizen ));
      params( 44 ) := "+"( Integer'Pos( a_child.citizen2 ));
      params( 45 ) := "+"( Integer'Pos( a_child.cohabit ));
      params( 46 ) := "+"( Integer'Pos( a_child.contuk ));
      params( 47 ) := "+"( Integer'Pos( a_child.convbl ));
      params( 48 ) := "+"( Integer'Pos( a_child.corign ));
      params( 49 ) := "+"( Integer'Pos( a_child.corigoth ));
      params( 50 ) := "+"( Integer'Pos( a_child.curqual ));
      params( 51 ) := "+"( Integer'Pos( a_child.cvht ));
      params( 52 ) := "+"( Integer'Pos( a_child.cvpay ));
      params( 53 ) := "+"( Integer'Pos( a_child.cvpd ));
      params( 54 ) := "+"( Integer'Pos( a_child.degrenow ));
      params( 55 ) := "+"( Integer'Pos( a_child.denrec ));
      params( 56 ) := "+"( Integer'Pos( a_child.depend ));
      params( 57 ) := "+"( a_child.dob );
      params( 58 ) := "+"( Integer'Pos( a_child.dvmardf ));
      params( 59 ) := "+"( Integer'Pos( a_child.eligadlt ));
      params( 60 ) := "+"( Integer'Pos( a_child.eligchld ));
      params( 61 ) := "+"( Integer'Pos( a_child.fted ));
      params( 62 ) := "+"( Integer'Pos( a_child.x_grant ));
      params( 63 ) := "+"( Float( a_child.grtamt1 ));
      params( 64 ) := "+"( Float( a_child.grtamt2 ));
      params( 65 ) := "+"( Float( a_child.grtdir1 ));
      params( 66 ) := "+"( Float( a_child.grtdir2 ));
      params( 67 ) := "+"( Integer'Pos( a_child.grtnum ));
      params( 68 ) := "+"( Integer'Pos( a_child.grtsce1 ));
      params( 69 ) := "+"( Integer'Pos( a_child.grtsce2 ));
      params( 70 ) := "+"( Float( a_child.grtval1 ));
      params( 71 ) := "+"( Float( a_child.grtval2 ));
      params( 72 ) := "+"( Integer'Pos( a_child.heathch ));
      params( 73 ) := "+"( Integer'Pos( a_child.hholder ));
      params( 74 ) := "+"( Integer'Pos( a_child.highonow ));
      params( 75 ) := "+"( Integer'Pos( a_child.hrsed ));
      params( 76 ) := "+"( Integer'Pos( a_child.hsvper ));
      params( 77 ) := "+"( Integer'Pos( a_child.issue ));
      params( 78 ) := "+"( Integer'Pos( a_child.lareg ));
      params( 79 ) := "+"( Integer'Pos( a_child.medrec ));
      params( 80 ) := "+"( Integer'Pos( a_child.ms ));
      params( 81 ) := "+"( Integer'Pos( a_child.nvqlenow ));
      params( 82 ) := "+"( Integer'Pos( a_child.othpass ));
      params( 83 ) := "+"( Integer'Pos( a_child.parent1 ));
      params( 84 ) := "+"( Integer'Pos( a_child.parent2 ));
      params( 85 ) := "+"( Integer'Pos( a_child.prox1619 ));
      params( 86 ) := "+"( Integer'Pos( a_child.r01 ));
      params( 87 ) := "+"( Integer'Pos( a_child.r02 ));
      params( 88 ) := "+"( Integer'Pos( a_child.r03 ));
      params( 89 ) := "+"( Integer'Pos( a_child.r04 ));
      params( 90 ) := "+"( Integer'Pos( a_child.r05 ));
      params( 91 ) := "+"( Integer'Pos( a_child.r06 ));
      params( 92 ) := "+"( Integer'Pos( a_child.r07 ));
      params( 93 ) := "+"( Integer'Pos( a_child.r08 ));
      params( 94 ) := "+"( Integer'Pos( a_child.r09 ));
      params( 95 ) := "+"( Integer'Pos( a_child.r10 ));
      params( 96 ) := "+"( Integer'Pos( a_child.r11 ));
      params( 97 ) := "+"( Integer'Pos( a_child.r12 ));
      params( 98 ) := "+"( Integer'Pos( a_child.r13 ));
      params( 99 ) := "+"( Integer'Pos( a_child.r14 ));
      params( 100 ) := "+"( Integer'Pos( a_child.reasden ));
      params( 101 ) := "+"( Integer'Pos( a_child.reasmed ));
      params( 102 ) := "+"( Integer'Pos( a_child.reasnhs ));
      params( 103 ) := "+"( Integer'Pos( a_child.rsanow ));
      params( 104 ) := "+"( Integer'Pos( a_child.sbkit ));
      params( 105 ) := "+"( Integer'Pos( a_child.schchk ));
      params( 106 ) := "+"( Integer'Pos( a_child.sctvnow ));
      params( 107 ) := "+"( Integer'Pos( a_child.sex ));
      params( 108 ) := "+"( Integer'Pos( a_child.sfvit ));
      params( 109 ) := "+"( Integer'Pos( a_child.smkit ));
      params( 110 ) := "+"( Integer'Pos( a_child.smlit ));
      params( 111 ) := "+"( Integer'Pos( a_child.spcreg1 ));
      params( 112 ) := "+"( Integer'Pos( a_child.spcreg2 ));
      params( 113 ) := "+"( Integer'Pos( a_child.spcreg3 ));
      params( 114 ) := "+"( Integer'Pos( a_child.spout ));
      params( 115 ) := "+"( Integer'Pos( a_child.srentamt ));
      params( 116 ) := "+"( Integer'Pos( a_child.srentpd ));
      params( 117 ) := "+"( Integer'Pos( a_child.totsave ));
      params( 118 ) := "+"( Integer'Pos( a_child.trainee ));
      params( 119 ) := "+"( Integer'Pos( a_child.typeed ));
      params( 120 ) := "+"( Integer'Pos( a_child.month ));
      params( 121 ) := "+"( Integer'Pos( a_child.careab ));
      params( 122 ) := "+"( Integer'Pos( a_child.careah ));
      params( 123 ) := "+"( Integer'Pos( a_child.carecb ));
      params( 124 ) := "+"( Integer'Pos( a_child.carech ));
      params( 125 ) := "+"( Integer'Pos( a_child.carecl ));
      params( 126 ) := "+"( Integer'Pos( a_child.carefl ));
      params( 127 ) := "+"( Integer'Pos( a_child.carefr ));
      params( 128 ) := "+"( Integer'Pos( a_child.careot ));
      params( 129 ) := "+"( Integer'Pos( a_child.carere ));
      params( 130 ) := "+"( Float( a_child.chearns ));
      params( 131 ) := "+"( Float( a_child.chincdv ));
      params( 132 ) := "+"( Float( a_child.chrinc ));
      params( 133 ) := "+"( Integer'Pos( a_child.disactc1 ));
      params( 134 ) := "+"( Integer'Pos( a_child.discorc1 ));
      params( 135 ) := "+"( Integer'Pos( a_child.dobmonth ));
      params( 136 ) := "+"( Integer'Pos( a_child.dobyear ));
      params( 137 ) := "+"( Float( a_child.fsbval ));
      params( 138 ) := "+"( Float( a_child.fsfvval ));
      params( 139 ) := "+"( Float( a_child.fsmlkval ));
      params( 140 ) := "+"( Float( a_child.fsmval ));
      params( 141 ) := "+"( Integer'Pos( a_child.hdagech ));
      params( 142 ) := "+"( Float( a_child.heartval ));
      params( 143 ) := "+"( Integer'Pos( a_child.hourab ));
      params( 144 ) := "+"( Integer'Pos( a_child.hourah ));
      params( 145 ) := "+"( Integer'Pos( a_child.hourcb ));
      params( 146 ) := "+"( Integer'Pos( a_child.hourch ));
      params( 147 ) := "+"( Integer'Pos( a_child.hourcl ));
      params( 148 ) := "+"( Integer'Pos( a_child.hourfr ));
      params( 149 ) := "+"( Integer'Pos( a_child.hourot ));
      params( 150 ) := "+"( Integer'Pos( a_child.hourre ));
      params( 151 ) := "+"( Integer'Pos( a_child.hourtot ));
      params( 152 ) := "+"( Integer'Pos( a_child.hperson ));
      params( 153 ) := "+"( Integer'Pos( a_child.iagegr2 ));
      params( 154 ) := "+"( Integer'Pos( a_child.iagegrp ));
      params( 155 ) := "+"( Integer'Pos( a_child.relhrp ));
      params( 156 ) := "+"( Float( a_child.totgntch ));
      params( 157 ) := "+"( Float( a_child.tuacam ));
      params( 158 ) := "+"( Integer'Pos( a_child.typeed2 ));
      params( 159 ) := "+"( Integer'Pos( a_child.uperson ));
      params( 160 ) := "+"( Integer'Pos( a_child.xbonflag ));
      params( 161 ) := "+"( Integer'Pos( a_child.candgnow ));
      params( 162 ) := "+"( Integer'Pos( a_child.curothf ));
      params( 163 ) := "+"( Integer'Pos( a_child.curothp ));
      params( 164 ) := "+"( Integer'Pos( a_child.curothwv ));
      params( 165 ) := "+"( Integer'Pos( a_child.gnvqnow ));
      params( 166 ) := "+"( Integer'Pos( a_child.ndeplnow ));
      params( 167 ) := "+"( Integer'Pos( a_child.oqualc1 ));
      params( 168 ) := "+"( Integer'Pos( a_child.oqualc2 ));
      params( 169 ) := "+"( Integer'Pos( a_child.oqualc3 ));
      params( 170 ) := "+"( Integer'Pos( a_child.webacnow ));
      params( 171 ) := "+"( Integer'Pos( a_child.ntsctnow ));
      params( 172 ) := "+"( Integer'Pos( a_child.skiwknow ));
      params( 173 ) := "+"( Integer'Pos( a_child.adeduc ));
      params( 174 ) := "+"( Integer'Pos( a_child.benccdis ));
      params( 175 ) := "+"( Integer'Pos( a_child.cdisdif1 ));
      params( 176 ) := "+"( Integer'Pos( a_child.cdisdif2 ));
      params( 177 ) := "+"( Integer'Pos( a_child.cdisdif3 ));
      params( 178 ) := "+"( Integer'Pos( a_child.cdisdif4 ));
      params( 179 ) := "+"( Integer'Pos( a_child.cdisdif5 ));
      params( 180 ) := "+"( Integer'Pos( a_child.cdisdif6 ));
      params( 181 ) := "+"( Integer'Pos( a_child.cdisdif7 ));
      params( 182 ) := "+"( Integer'Pos( a_child.cdisdif8 ));
      params( 183 ) := "+"( Float( a_child.chamt1 ));
      params( 184 ) := "+"( Float( a_child.chamt2 ));
      params( 185 ) := "+"( Float( a_child.chamt3 ));
      params( 186 ) := "+"( Float( a_child.chamt4 ));
      params( 187 ) := "+"( Integer'Pos( a_child.chealth ));
      params( 188 ) := "+"( Integer'Pos( a_child.chfar ));
      params( 189 ) := "+"( Integer'Pos( a_child.chhr1 ));
      params( 190 ) := "+"( Integer'Pos( a_child.chhr2 ));
      params( 191 ) := "+"( Integer'Pos( a_child.chlook01 ));
      params( 192 ) := "+"( Integer'Pos( a_child.chlook02 ));
      params( 193 ) := "+"( Integer'Pos( a_child.chlook03 ));
      params( 194 ) := "+"( Integer'Pos( a_child.chlook04 ));
      params( 195 ) := "+"( Integer'Pos( a_child.chlook05 ));
      params( 196 ) := "+"( Integer'Pos( a_child.chlook06 ));
      params( 197 ) := "+"( Integer'Pos( a_child.chlook07 ));
      params( 198 ) := "+"( Integer'Pos( a_child.chlook08 ));
      params( 199 ) := "+"( Integer'Pos( a_child.chlook09 ));
      params( 200 ) := "+"( Integer'Pos( a_child.chlook10 ));
      params( 201 ) := "+"( Integer'Pos( a_child.chpay1 ));
      params( 202 ) := "+"( Integer'Pos( a_child.chpay2 ));
      params( 203 ) := "+"( Integer'Pos( a_child.chpay3 ));
      params( 204 ) := "+"( Integer'Pos( a_child.chprob ));
      params( 205 ) := "+"( Integer'Pos( a_child.chwkern ));
      params( 206 ) := "+"( Integer'Pos( a_child.chwktst ));
      params( 207 ) := "+"( Integer'Pos( a_child.chyrern ));
      params( 208 ) := "+"( Integer'Pos( a_child.chyrtst ));
      params( 209 ) := "+"( Integer'Pos( a_child.clone ));
      params( 210 ) := "+"( Integer'Pos( a_child.cost ));
      params( 211 ) := "+"( Integer'Pos( a_child.dentist ));
      params( 212 ) := "+"( Integer'Pos( a_child.endyr ));
      params( 213 ) := "+"( Integer'Pos( a_child.eyetest ));
      params( 214 ) := "+"( Integer'Pos( a_child.hosp ));
      params( 215 ) := "+"( Integer'Pos( a_child.legdep ));
      params( 216 ) := "+"( Integer'Pos( a_child.nhs1 ));
      params( 217 ) := "+"( Integer'Pos( a_child.nhs2 ));
      params( 218 ) := "+"( Integer'Pos( a_child.nhs3 ));
      params( 219 ) := "+"( Integer'Pos( a_child.prit ));
      params( 220 ) := "+"( Integer'Pos( a_child.prscrpt ));
      params( 221 ) := "+"( Integer'Pos( a_child.registr1 ));
      params( 222 ) := "+"( Integer'Pos( a_child.registr2 ));
      params( 223 ) := "+"( Integer'Pos( a_child.registr3 ));
      params( 224 ) := "+"( Integer'Pos( a_child.registr4 ));
      params( 225 ) := "+"( Integer'Pos( a_child.registr5 ));
      params( 226 ) := "+"( Integer'Pos( a_child.specs ));
      params( 227 ) := "+"( Integer'Pos( a_child.startyr ));
      params( 228 ) := "+"( Integer'Pos( a_child.trav ));
      params( 229 ) := "+"( Integer'Pos( a_child.voucher ));
      params( 230 ) := "+"( Integer'Pos( a_child.whytrav1 ));
      params( 231 ) := "+"( Integer'Pos( a_child.whytrav2 ));
      params( 232 ) := "+"( Integer'Pos( a_child.whytrav3 ));
      params( 233 ) := "+"( Integer'Pos( a_child.whytrav4 ));
      params( 234 ) := "+"( Integer'Pos( a_child.whytrav5 ));
      params( 235 ) := "+"( Integer'Pos( a_child.whytrav6 ));
      params( 236 ) := "+"( Integer'Pos( a_child.wmkit ));
      params( 237 ) := "+"( Integer'Pos( a_child.chdda ));
      params( 238 ) := "+"( Float( a_child.fwmlkval ));
      params( 239 ) := "+"( Integer'Pos( a_child.cddatre ));
      params( 240 ) := "+"( Integer'Pos( a_child.cdisdif9 ));
      params( 241 ) := "+"( Integer'Pos( a_child.cddatrep ));
      params( 242 ) := "+"( Integer'Pos( a_child.cfund ));
      params( 243 ) := "+"( Float( a_child.cfundh ));
      params( 244 ) := "+"( Integer'Pos( a_child.cfundtp ));
      params( 245 ) := "+"( Float( a_child.fundamt1 ));
      params( 246 ) := "+"( Float( a_child.fundamt2 ));
      params( 247 ) := "+"( Float( a_child.fundamt3 ));
      params( 248 ) := "+"( Float( a_child.fundamt4 ));
      params( 249 ) := "+"( Float( a_child.fundamt5 ));
      params( 250 ) := "+"( Float( a_child.fundamt6 ));
      params( 251 ) := "+"( Integer'Pos( a_child.givcfnd1 ));
      params( 252 ) := "+"( Integer'Pos( a_child.givcfnd2 ));
      params( 253 ) := "+"( Integer'Pos( a_child.givcfnd3 ));
      params( 254 ) := "+"( Integer'Pos( a_child.givcfnd4 ));
      params( 255 ) := "+"( Integer'Pos( a_child.givcfnd5 ));
      params( 256 ) := "+"( Integer'Pos( a_child.givcfnd6 ));
      params( 257 ) := "+"( Integer'Pos( a_child.cddaprg ));
      params( 258 ) := "+"( Integer'Pos( a_child.disdifch ));
      params( 259 ) := "+"( Integer'Pos( a_child.mednum ));
      params( 260 ) := "+"( Integer'Pos( a_child.medprpd ));
      params( 261 ) := "+"( Integer'Pos( a_child.medprpy ));
      params( 262 ) := "+"( Integer'Pos( a_child.marital ));
   ...
   begin
      ...
      params( 7 ) := "+"( Integer'Pos( a_child.age ));
      params( 8 ) := "+"( Integer'Pos( a_child.btecnow ));
      params( 9 ) := "+"( Integer'Pos( a_child.c2orign ));
      params( 10 ) := "+"( Integer'Pos( a_child.cameyr ));
      params( 11 ) := "+"( Integer'Pos( a_child.care ));
      params( 12 ) := "+"( Integer'Pos( a_child.cdaprog1 ));
      params( 13 ) := "+"( Integer'Pos( a_child.cdatre1 ));
      params( 14 ) := "+"( Integer'Pos( a_child.cdatrep1 ));
      params( 15 ) := "+"( Integer'Pos( a_child.cdisd01 ));
      params( 16 ) := "+"( Integer'Pos( a_child.cdisd02 ));
      params( 17 ) := "+"( Integer'Pos( a_child.cdisd03 ));
      params( 18 ) := "+"( Integer'Pos( a_child.cdisd04 ));
      params( 19 ) := "+"( Integer'Pos( a_child.cdisd05 ));
      params( 20 ) := "+"( Integer'Pos( a_child.cdisd06 ));
      params( 21 ) := "+"( Integer'Pos( a_child.cdisd07 ));
      params( 22 ) := "+"( Integer'Pos( a_child.cdisd08 ));
      params( 23 ) := "+"( Integer'Pos( a_child.cdisd09 ));
      params( 24 ) := "+"( Integer'Pos( a_child.cdisd10 ));
      params( 25 ) := "+"( Integer'Pos( a_child.cdisdifp ));
      params( 26 ) := "+"( Float( a_child.chamtern ));
      params( 27 ) := "+"( Float( a_child.chamttst ));
      params( 28 ) := "+"( Integer'Pos( a_child.chbfd ));
      params( 29 ) := "+"( Float( a_child.chbfdamt ));
      params( 30 ) := "+"( Integer'Pos( a_child.chbfdpd ));
      params( 31 ) := "+"( Integer'Pos( a_child.chbfdval ));
      params( 32 ) := "+"( Integer'Pos( a_child.chca ));
      params( 33 ) := "+"( Integer'Pos( a_child.chcond ));
      params( 34 ) := "+"( Integer'Pos( a_child.chdla1 ));
      params( 35 ) := "+"( Integer'Pos( a_child.chdla2 ));
      params( 36 ) := "+"( Integer'Pos( a_child.chealth1 ));
      params( 37 ) := "+"( Integer'Pos( a_child.chearns1 ));
      params( 38 ) := "+"( Integer'Pos( a_child.chearns2 ));
      params( 39 ) := "+"( Integer'Pos( a_child.chearns3 ));
      params( 40 ) := "+"( Integer'Pos( a_child.chema ));
      params( 41 ) := "+"( Float( a_child.chemaamt ));
      params( 42 ) := "+"( Integer'Pos( a_child.chemapd ));
      params( 43 ) := "+"( Integer'Pos( a_child.chlimitl ));
      params( 44 ) := "+"( Integer'Pos( a_child.chpdern ));
      params( 45 ) := "+"( Integer'Pos( a_child.chpdtst ));
      params( 46 ) := "+"( Integer'Pos( a_child.chsave ));
      params( 47 ) := "+"( Float( a_child.chtrnamt ));
      params( 48 ) := "+"( Integer'Pos( a_child.chtrnpd ));
      params( 49 ) := "+"( Integer'Pos( a_child.citizen ));
      params( 50 ) := "+"( Integer'Pos( a_child.citizen2 ));
      params( 51 ) := "+"( Integer'Pos( a_child.cohabit ));
      params( 52 ) := "+"( Integer'Pos( a_child.contuk ));
      params( 53 ) := "+"( Integer'Pos( a_child.convbl ));
      params( 54 ) := "+"( Integer'Pos( a_child.corign ));
      params( 55 ) := "+"( Integer'Pos( a_child.corigoth ));
      params( 56 ) := "+"( Integer'Pos( a_child.curqual ));
      params( 57 ) := "+"( Integer'Pos( a_child.cvht ));
      params( 58 ) := "+"( Integer'Pos( a_child.cvpay ));
      params( 59 ) := "+"( Integer'Pos( a_child.cvpd ));
      params( 60 ) := "+"( Integer'Pos( a_child.degrenow ));
      params( 61 ) := "+"( Integer'Pos( a_child.denrec ));
      params( 62 ) := "+"( Integer'Pos( a_child.depend ));
      params( 63 ) := "+"( a_child.dob );
      params( 64 ) := "+"( Integer'Pos( a_child.dvmardf ));
      params( 65 ) := "+"( Integer'Pos( a_child.eligadlt ));
      params( 66 ) := "+"( Integer'Pos( a_child.eligchld ));
      params( 67 ) := "+"( Integer'Pos( a_child.fted ));
      params( 68 ) := "+"( Integer'Pos( a_child.x_grant ));
      params( 69 ) := "+"( Float( a_child.grtamt1 ));
      params( 70 ) := "+"( Float( a_child.grtamt2 ));
      params( 71 ) := "+"( Float( a_child.grtdir1 ));
      params( 72 ) := "+"( Float( a_child.grtdir2 ));
      params( 73 ) := "+"( Integer'Pos( a_child.grtnum ));
      params( 74 ) := "+"( Integer'Pos( a_child.grtsce1 ));
      params( 75 ) := "+"( Integer'Pos( a_child.grtsce2 ));
      params( 76 ) := "+"( Float( a_child.grtval1 ));
      params( 77 ) := "+"( Float( a_child.grtval2 ));
      params( 78 ) := "+"( Integer'Pos( a_child.heathch ));
      params( 79 ) := "+"( Integer'Pos( a_child.hholder ));
      params( 80 ) := "+"( Integer'Pos( a_child.highonow ));
      params( 81 ) := "+"( Integer'Pos( a_child.hrsed ));
      params( 82 ) := "+"( Integer'Pos( a_child.hsvper ));
      params( 83 ) := "+"( Integer'Pos( a_child.issue ));
      params( 84 ) := "+"( Integer'Pos( a_child.lareg ));
      params( 85 ) := "+"( Integer'Pos( a_child.medrec ));
      params( 86 ) := "+"( Integer'Pos( a_child.ms ));
      params( 87 ) := "+"( Integer'Pos( a_child.nvqlenow ));
      params( 88 ) := "+"( Integer'Pos( a_child.othpass ));
      params( 89 ) := "+"( Integer'Pos( a_child.parent1 ));
      params( 90 ) := "+"( Integer'Pos( a_child.parent2 ));
      params( 91 ) := "+"( Integer'Pos( a_child.prox1619 ));
      params( 92 ) := "+"( Integer'Pos( a_child.r01 ));
      params( 93 ) := "+"( Integer'Pos( a_child.r02 ));
      params( 94 ) := "+"( Integer'Pos( a_child.r03 ));
      params( 95 ) := "+"( Integer'Pos( a_child.r04 ));
      params( 96 ) := "+"( Integer'Pos( a_child.r05 ));
      params( 97 ) := "+"( Integer'Pos( a_child.r06 ));
      params( 98 ) := "+"( Integer'Pos( a_child.r07 ));
      params( 99 ) := "+"( Integer'Pos( a_child.r08 ));
      params( 100 ) := "+"( Integer'Pos( a_child.r09 ));
      params( 101 ) := "+"( Integer'Pos( a_child.r10 ));
      params( 102 ) := "+"( Integer'Pos( a_child.r11 ));
      params( 103 ) := "+"( Integer'Pos( a_child.r12 ));
      params( 104 ) := "+"( Integer'Pos( a_child.r13 ));
      params( 105 ) := "+"( Integer'Pos( a_child.r14 ));
      params( 106 ) := "+"( Integer'Pos( a_child.reasden ));
      params( 107 ) := "+"( Integer'Pos( a_child.reasmed ));
      params( 108 ) := "+"( Integer'Pos( a_child.reasnhs ));
      params( 109 ) := "+"( Integer'Pos( a_child.rsanow ));
      params( 110 ) := "+"( Integer'Pos( a_child.sbkit ));
      params( 111 ) := "+"( Integer'Pos( a_child.schchk ));
      params( 112 ) := "+"( Integer'Pos( a_child.sctvnow ));
      params( 113 ) := "+"( Integer'Pos( a_child.sex ));
      params( 114 ) := "+"( Integer'Pos( a_child.sfvit ));
      params( 115 ) := "+"( Integer'Pos( a_child.smkit ));
      params( 116 ) := "+"( Integer'Pos( a_child.smlit ));
      params( 117 ) := "+"( Integer'Pos( a_child.spcreg1 ));
      params( 118 ) := "+"( Integer'Pos( a_child.spcreg2 ));
      params( 119 ) := "+"( Integer'Pos( a_child.spcreg3 ));
      params( 120 ) := "+"( Integer'Pos( a_child.spout ));
      params( 121 ) := "+"( Integer'Pos( a_child.srentamt ));
      params( 122 ) := "+"( Integer'Pos( a_child.srentpd ));
      params( 123 ) := "+"( Integer'Pos( a_child.totsave ));
      params( 124 ) := "+"( Integer'Pos( a_child.trainee ));
      params( 125 ) := "+"( Integer'Pos( a_child.typeed ));
      params( 126 ) := "+"( Integer'Pos( a_child.month ));
      params( 127 ) := "+"( Integer'Pos( a_child.careab ));
      params( 128 ) := "+"( Integer'Pos( a_child.careah ));
      params( 129 ) := "+"( Integer'Pos( a_child.carecb ));
      params( 130 ) := "+"( Integer'Pos( a_child.carech ));
      params( 131 ) := "+"( Integer'Pos( a_child.carecl ));
      params( 132 ) := "+"( Integer'Pos( a_child.carefl ));
      params( 133 ) := "+"( Integer'Pos( a_child.carefr ));
      params( 134 ) := "+"( Integer'Pos( a_child.careot ));
      params( 135 ) := "+"( Integer'Pos( a_child.carere ));
      params( 136 ) := "+"( Float( a_child.chearns ));
      params( 137 ) := "+"( Float( a_child.chincdv ));
      params( 138 ) := "+"( Float( a_child.chrinc ));
      params( 139 ) := "+"( Integer'Pos( a_child.disactc1 ));
      params( 140 ) := "+"( Integer'Pos( a_child.discorc1 ));
      params( 141 ) := "+"( Integer'Pos( a_child.dobmonth ));
      params( 142 ) := "+"( Integer'Pos( a_child.dobyear ));
      params( 143 ) := "+"( Float( a_child.fsbval ));
      params( 144 ) := "+"( Float( a_child.fsfvval ));
      params( 145 ) := "+"( Float( a_child.fsmlkval ));
      params( 146 ) := "+"( Float( a_child.fsmval ));
      params( 147 ) := "+"( Integer'Pos( a_child.hdagech ));
      params( 148 ) := "+"( Float( a_child.heartval ));
      params( 149 ) := "+"( Integer'Pos( a_child.hourab ));
      params( 150 ) := "+"( Integer'Pos( a_child.hourah ));
      params( 151 ) := "+"( Integer'Pos( a_child.hourcb ));
      params( 152 ) := "+"( Integer'Pos( a_child.hourch ));
      params( 153 ) := "+"( Integer'Pos( a_child.hourcl ));
      params( 154 ) := "+"( Integer'Pos( a_child.hourfr ));
      params( 155 ) := "+"( Integer'Pos( a_child.hourot ));
      params( 156 ) := "+"( Integer'Pos( a_child.hourre ));
      params( 157 ) := "+"( Integer'Pos( a_child.hourtot ));
      params( 158 ) := "+"( Integer'Pos( a_child.hperson ));
      params( 159 ) := "+"( Integer'Pos( a_child.iagegr2 ));
      params( 160 ) := "+"( Integer'Pos( a_child.iagegrp ));
      params( 161 ) := "+"( Integer'Pos( a_child.relhrp ));
      params( 162 ) := "+"( Float( a_child.totgntch ));
      params( 163 ) := "+"( Float( a_child.tuacam ));
      params( 164 ) := "+"( Integer'Pos( a_child.typeed2 ));
      params( 165 ) := "+"( Integer'Pos( a_child.uperson ));
      params( 166 ) := "+"( Integer'Pos( a_child.xbonflag ));
      params( 167 ) := "+"( Integer'Pos( a_child.candgnow ));
      params( 168 ) := "+"( Integer'Pos( a_child.curothf ));
      params( 169 ) := "+"( Integer'Pos( a_child.curothp ));
      params( 170 ) := "+"( Integer'Pos( a_child.curothwv ));
      params( 171 ) := "+"( Integer'Pos( a_child.gnvqnow ));
      params( 172 ) := "+"( Integer'Pos( a_child.ndeplnow ));
      params( 173 ) := "+"( Integer'Pos( a_child.oqualc1 ));
      params( 174 ) := "+"( Integer'Pos( a_child.oqualc2 ));
      params( 175 ) := "+"( Integer'Pos( a_child.oqualc3 ));
      params( 176 ) := "+"( Integer'Pos( a_child.webacnow ));
      params( 177 ) := "+"( Integer'Pos( a_child.ntsctnow ));
      params( 178 ) := "+"( Integer'Pos( a_child.skiwknow ));
      params( 179 ) := "+"( Integer'Pos( a_child.adeduc ));
      params( 180 ) := "+"( Integer'Pos( a_child.benccdis ));
      params( 181 ) := "+"( Integer'Pos( a_child.cdisdif1 ));
      params( 182 ) := "+"( Integer'Pos( a_child.cdisdif2 ));
      params( 183 ) := "+"( Integer'Pos( a_child.cdisdif3 ));
      params( 184 ) := "+"( Integer'Pos( a_child.cdisdif4 ));
      params( 185 ) := "+"( Integer'Pos( a_child.cdisdif5 ));
      params( 186 ) := "+"( Integer'Pos( a_child.cdisdif6 ));
      params( 187 ) := "+"( Integer'Pos( a_child.cdisdif7 ));
      params( 188 ) := "+"( Integer'Pos( a_child.cdisdif8 ));
      params( 189 ) := "+"( Float( a_child.chamt1 ));
      params( 190 ) := "+"( Float( a_child.chamt2 ));
      params( 191 ) := "+"( Float( a_child.chamt3 ));
      params( 192 ) := "+"( Float( a_child.chamt4 ));
      params( 193 ) := "+"( Integer'Pos( a_child.chealth ));
      params( 194 ) := "+"( Integer'Pos( a_child.chfar ));
      params( 195 ) := "+"( Integer'Pos( a_child.chhr1 ));
      params( 196 ) := "+"( Integer'Pos( a_child.chhr2 ));
      params( 197 ) := "+"( Integer'Pos( a_child.chlook01 ));
      params( 198 ) := "+"( Integer'Pos( a_child.chlook02 ));
      params( 199 ) := "+"( Integer'Pos( a_child.chlook03 ));
      params( 200 ) := "+"( Integer'Pos( a_child.chlook04 ));
      params( 201 ) := "+"( Integer'Pos( a_child.chlook05 ));
      params( 202 ) := "+"( Integer'Pos( a_child.chlook06 ));
      params( 203 ) := "+"( Integer'Pos( a_child.chlook07 ));
      params( 204 ) := "+"( Integer'Pos( a_child.chlook08 ));
      params( 205 ) := "+"( Integer'Pos( a_child.chlook09 ));
      params( 206 ) := "+"( Integer'Pos( a_child.chlook10 ));
      params( 207 ) := "+"( Integer'Pos( a_child.chpay1 ));
      params( 208 ) := "+"( Integer'Pos( a_child.chpay2 ));
      params( 209 ) := "+"( Integer'Pos( a_child.chpay3 ));
      params( 210 ) := "+"( Integer'Pos( a_child.chprob ));
      params( 211 ) := "+"( Integer'Pos( a_child.chwkern ));
      params( 212 ) := "+"( Integer'Pos( a_child.chwktst ));
      params( 213 ) := "+"( Integer'Pos( a_child.chyrern ));
      params( 214 ) := "+"( Integer'Pos( a_child.chyrtst ));
      params( 215 ) := "+"( Integer'Pos( a_child.clone ));
      params( 216 ) := "+"( Integer'Pos( a_child.cost ));
      params( 217 ) := "+"( Integer'Pos( a_child.dentist ));
      params( 218 ) := "+"( Integer'Pos( a_child.endyr ));
      params( 219 ) := "+"( Integer'Pos( a_child.eyetest ));
      params( 220 ) := "+"( Integer'Pos( a_child.hosp ));
      params( 221 ) := "+"( Integer'Pos( a_child.legdep ));
      params( 222 ) := "+"( Integer'Pos( a_child.nhs1 ));
      params( 223 ) := "+"( Integer'Pos( a_child.nhs2 ));
      params( 224 ) := "+"( Integer'Pos( a_child.nhs3 ));
      params( 225 ) := "+"( Integer'Pos( a_child.prit ));
      params( 226 ) := "+"( Integer'Pos( a_child.prscrpt ));
      params( 227 ) := "+"( Integer'Pos( a_child.registr1 ));
      params( 228 ) := "+"( Integer'Pos( a_child.registr2 ));
      params( 229 ) := "+"( Integer'Pos( a_child.registr3 ));
      params( 230 ) := "+"( Integer'Pos( a_child.registr4 ));
      params( 231 ) := "+"( Integer'Pos( a_child.registr5 ));
      params( 232 ) := "+"( Integer'Pos( a_child.specs ));
      params( 233 ) := "+"( Integer'Pos( a_child.startyr ));
      params( 234 ) := "+"( Integer'Pos( a_child.trav ));
      params( 235 ) := "+"( Integer'Pos( a_child.voucher ));
      params( 236 ) := "+"( Integer'Pos( a_child.whytrav1 ));
      params( 237 ) := "+"( Integer'Pos( a_child.whytrav2 ));
      params( 238 ) := "+"( Integer'Pos( a_child.whytrav3 ));
      params( 239 ) := "+"( Integer'Pos( a_child.whytrav4 ));
      params( 240 ) := "+"( Integer'Pos( a_child.whytrav5 ));
      params( 241 ) := "+"( Integer'Pos( a_child.whytrav6 ));
      params( 242 ) := "+"( Integer'Pos( a_child.wmkit ));
      params( 243 ) := "+"( Integer'Pos( a_child.chdda ));
      params( 244 ) := "+"( Float( a_child.fwmlkval ));
      params( 245 ) := "+"( Integer'Pos( a_child.cddatre ));
      params( 246 ) := "+"( Integer'Pos( a_child.cdisdif9 ));
      params( 247 ) := "+"( Integer'Pos( a_child.cddatrep ));
      params( 248 ) := "+"( Integer'Pos( a_child.cfund ));
      params( 249 ) := "+"( Float( a_child.cfundh ));
      params( 250 ) := "+"( Integer'Pos( a_child.cfundtp ));
      params( 251 ) := "+"( Float( a_child.fundamt1 ));
      params( 252 ) := "+"( Float( a_child.fundamt2 ));
      params( 253 ) := "+"( Float( a_child.fundamt3 ));
      params( 254 ) := "+"( Float( a_child.fundamt4 ));
      params( 255 ) := "+"( Float( a_child.fundamt5 ));
      params( 256 ) := "+"( Float( a_child.fundamt6 ));
      params( 257 ) := "+"( Integer'Pos( a_child.givcfnd1 ));
      params( 258 ) := "+"( Integer'Pos( a_child.givcfnd2 ));
      params( 259 ) := "+"( Integer'Pos( a_child.givcfnd3 ));
      params( 260 ) := "+"( Integer'Pos( a_child.givcfnd4 ));
      params( 261 ) := "+"( Integer'Pos( a_child.givcfnd5 ));
      params( 262 ) := "+"( Integer'Pos( a_child.givcfnd6 ));
      params( 263 ) := "+"( Integer'Pos( a_child.cddaprg ));
      params( 264 ) := "+"( Integer'Pos( a_child.disdifch ));
      params( 265 ) := "+"( Integer'Pos( a_child.mednum ));
      params( 266 ) := "+"( Integer'Pos( a_child.medprpd ));
      params( 267 ) := "+"( Integer'Pos( a_child.medprpy ));
      params( 268 ) := "+"( Integer'Pos( a_child.marital ));
