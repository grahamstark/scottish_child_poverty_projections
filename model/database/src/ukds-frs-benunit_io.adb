...
package body Ukds.Frs.Benunit_IO is
   ...
   SELECT_PART : constant String := "select " &
         "user_id, edition, year, sernum, benunit, adbtbl, adddec, addhol, addholr, addins," &
         "addmon, adepfur, adles, adlesnt1, adlesnt2, adlesnt3, adlesnt4, adlesnt5, adlesnt6, adlesnt7," &
         "adlesnt8, adlesoa, af1, afdep2, billnt1, billnt2, billnt3, billnt4, billnt5, billnt6," &
         "billnt7, billnt8, billnt9, cdelply, cdepact, cdepbed, cdepcel, cdepeqp, cdephol, cdeples," &
         "cdeptea, cdeptrp, cdepveg, cdpcoat, clothes, clothnt1, clothnt2, clothnt3, clothnt4, clothnt5," &
         "clothnt6, clothnt7, clothnt8, clothsoa, coatnt1, coatnt2, coatnt3, coatnt4, coatnt5, coatnt6," &
         "coatnt7, coatnt8, coatnt9, computer, compuwhy, cooknt1, cooknt2, cooknt3, cooknt4, cooknt5," &
         "cooknt6, cooknt7, cooknt8, cooknt9, cplay, crime, damp, dampnt1, dampnt2, dampnt3," &
         "dampnt4, dampnt5, dampnt6, dampnt7, dampnt8, dampnt9, dark, debt01, debt02, debt03," &
         ...
         "euteleph, eutelwhy, expnsoa, frndnt1, frndnt2, frndnt3, frndnt4, frndnt5, frndnt6, frndnt7," &
         "frndnt8, frndnt9, furnt1, furnt2, furnt3, furnt4, furnt5, furnt6, furnt7, furnt8," &
         "hairnt1, hairnt2, hairnt3, hairnt4, hairnt5, hairnt6, hairnt7, hairnt8, hairnt9, hbolng," &
         "hbothamt, hbothbu, hbothmn, hbothpd, hbothwk, hbothyr, hbotwait, heatnt1, heatnt2, heatnt3," &
         "heatnt4, heatnt5, heatnt6, heatnt7, heatnt8, heatnt9, holnt1, holnt2, holnt3, holnt4," &
         "holnt5, holnt6, holnt7, holnt8, holnt9, homent1, homent2, homent3, homent4, homent5," &
         "homent6, homent7, homent8, homent9, houshe1, houshew, intntnt1, intntnt2, intntnt3, intntnt4," &
         "intntnt5, intntnt6, intntnt7, intntnt8, intrnet, issue, kidinc, meal, mealnt1, mealnt2," &
         "mealnt3, mealnt4, mealnt5, mealnt6, mealnt7, mealnt8, mealnt9, nhhchild, noise, oabill," &
         "oacareu1, oacareu2, oacareu3, oacareu4, oacareu5, oacareu6, oacareu7, oacareu8, oacoat, oacook," &
         "oadamp, oadep2, oadp2nt1, oadp2nt2, oadp2nt3, oadp2nt4, oadp2nt5, oadp2nt6, oadp2nt7, oadp2nt8," &
         "oaexpns, oafrnd, oafur, oahair, oaheat, oahol, oahome, oahowpy1, oahowpy2, oahowpy3," &
         "oahowpy4, oahowpy5, oahowpy6, oaintern, oameal, oaout, oaphon, oapre, oataxi, oataxieu," &
         "oatelep1, oatelep2, oatelep3, oatelep4, oatelep5, oatelep6, oatelep7, oatelep8, oateleph, oawarm," &
         "outnt1, outnt2, outnt3, outnt4, outnt5, outnt6, outnt7, outnt8, outnt9, outpay," &
         "outpyamt, phonnt1, phonnt2, phonnt3, phonnt4, phonnt5, phonnt6, phonnt7, phonnt8, phonnt9," &
         "pollute, regpamt, regularp, repaybur, shoe, shoent1, shoent2, shoent3, shoent4, shoent5," &
         "shoent6, shoent7, shoent8, shoeoa, taxint1, taxint2, taxint3, taxint4, taxint5, taxint6," &
         "taxint7, taxint8, taxint9, totsav, warmnt1, warmnt2, warmnt3, warmnt4, warmnt5, warmnt6," &
         "warmnt7, warmnt8, warmnt9, washmach, washwhy, whodepq, month, adultb, boarder, bpeninc," &
         "bseinc, buagegr2, buagegr3, buagegr4, buagegrp, budisben, buearns, buethgr3, buinc, buinv," &
         "buirben, bukids, bunirben, buothben, burent, burinc, burpinc, butvlic, butxcred, depchldb," &
         "discbua1, discbuc1, diswbua1, diswbuc1, ecostabu, ecstatbu, famtypb2, famtypbs, famtypbu, fsbbu," &
         "fsfvbu, fsmbu, fsmlkbu, gross4, hbindbu, hbindbu2, heartbu, kid04, kid1115, kid1619," &
         "kid510, lodger, nbunirbn, nbuothbn, newfamb2, newfambu, subltamt, totcapb3, totsavbu, tuburent," &
         "youngch, debt13, debtar13, euchbook, euchclth, euchgame, euchmeat, euchshoe, eupbtran, eupbtrn1," &
         "eupbtrn2, eupbtrn3, eupbtrn4, eupbtrn5, euroast, eusmeal, eustudy, bueth, oaeusmea, oaholb," &
         "oaroast, ecostab2, incchnge, inchilow, actaccb, adddabu, basactb, buethgr2, buethgrp, chddabu," &
         "curactb, depdeds, disindhb, ecotypbu, famthbai, famtype, fsbndctb, fwmlkbu, gebactb, giltctb," &
         "gross2, gross3, isactb, kid1618, kidsbu0, kidsbu1, kidsbu10, kidsbu11, kidsbu12, kidsbu13," &
         "kidsbu14, kidsbu15, kidsbu16, kidsbu17, kidsbu18, kidsbu2, kidsbu3, kidsbu4, kidsbu5, kidsbu6," &
         "kidsbu7, kidsbu8, kidsbu9, lastwork, nsboctb, otbsctb, pepsctb, poacctb, prboctb, sayectb," &
         "sclbctb, ssctb, stshctb, tessctb, totcapbu, untrctb, addeples, addmel, addshoe, cdepsum," &
         "debt1, debt2, debt3, debt4, debt5, debt6, debt7, debt8, debt9, incold," &
         "crunacb, enomortb, pocardb, totcapb2, cbaamt1, cbaamt2, helpgv01, helpgv02, helpgv03, helpgv04," &
         "helpgv05, helpgv06, helpgv07, helpgv08, helpgv09, helpgv10, helpgv11, helprc01, helprc02, helprc03," &
         "helprc04, helprc05, helprc06, helprc07, helprc08, helprc09, helprc10, helprc11, loangvn1, loangvn2," &
         "loangvn3, loanrec1, loanrec2, loanrec3, gross3_x, oabilimp, oacoaimp, oacooimp, oadamimp, oaexpimp," &
         "oafrnimp, oahaiimp, oaheaimp, oaholimp, oahomimp, oameaimp, oaoutimp, oaphoimp, oataximp, oawarimp" &
         " from frs.benunit " ;
   ...
   use GNATCOLL.SQL_Impl;
      params : constant SQL_Parameters( 1 .. 510 ) := ( if update_order then (
            1 => ( Parameter_Integer, 0 ),   --  : adbtbl (Integer)
            2 => ( Parameter_Integer, 0 ),   --  : adddec (Integer)
            3 => ( Parameter_Integer, 0 ),   --  : addhol (Integer)
            4 => ( Parameter_Integer, 0 ),   --  : addholr (Integer)
            5 => ( Parameter_Integer, 0 ),   --  : addins (Integer)
            6 => ( Parameter_Integer, 0 ),   --  : addmon (Integer)
            7 => ( Parameter_Integer, 0 ),   --  : adepfur (Integer)
            8 => ( Parameter_Integer, 0 ),   --  : adles (Integer)
            9 => ( Parameter_Integer, 0 ),   --  : adlesnt1 (Integer)
           10 => ( Parameter_Integer, 0 ),   --  : adlesnt2 (Integer)
           11 => ( Parameter_Integer, 0 ),   --  : adlesnt3 (Integer)
           12 => ( Parameter_Integer, 0 ),   --  : adlesnt4 (Integer)
           13 => ( Parameter_Integer, 0 ),   --  : adlesnt5 (Integer)
           14 => ( Parameter_Integer, 0 ),   --  : adlesnt6 (Integer)
           15 => ( Parameter_Integer, 0 ),   --  : adlesnt7 (Integer)
           16 => ( Parameter_Integer, 0 ),   --  : adlesnt8 (Integer)
           17 => ( Parameter_Integer, 0 ),   --  : adlesoa (Integer)
           18 => ( Parameter_Integer, 0 ),   --  : af1 (Integer)
           19 => ( Parameter_Integer, 0 ),   --  : afdep2 (Integer)
           20 => ( Parameter_Integer, 0 ),   --  : billnt1 (Integer)
           21 => ( Parameter_Integer, 0 ),   --  : billnt2 (Integer)
           22 => ( Parameter_Integer, 0 ),   --  : billnt3 (Integer)
           23 => ( Parameter_Integer, 0 ),   --  : billnt4 (Integer)
           24 => ( Parameter_Integer, 0 ),   --  : billnt5 (Integer)
           25 => ( Parameter_Integer, 0 ),   --  : billnt6 (Integer)
           26 => ( Parameter_Integer, 0 ),   --  : billnt7 (Integer)
           27 => ( Parameter_Integer, 0 ),   --  : billnt8 (Integer)
           28 => ( Parameter_Integer, 0 ),   --  : billnt9 (Integer)
           29 => ( Parameter_Integer, 0 ),   --  : cdelply (Integer)
           30 => ( Parameter_Integer, 0 ),   --  : cdepact (Integer)
           31 => ( Parameter_Integer, 0 ),   --  : cdepbed (Integer)
           32 => ( Parameter_Integer, 0 ),   --  : cdepcel (Integer)
           33 => ( Parameter_Integer, 0 ),   --  : cdepeqp (Integer)
           34 => ( Parameter_Integer, 0 ),   --  : cdephol (Integer)
           35 => ( Parameter_Integer, 0 ),   --  : cdeples (Integer)
           36 => ( Parameter_Integer, 0 ),   --  : cdeptea (Integer)
           37 => ( Parameter_Integer, 0 ),   --  : cdeptrp (Integer)
           38 => ( Parameter_Integer, 0 ),   --  : cdepveg (Integer)
           39 => ( Parameter_Integer, 0 ),   --  : cdpcoat (Integer)
           40 => ( Parameter_Integer, 0 ),   --  : clothes (Integer)
           41 => ( Parameter_Integer, 0 ),   --  : clothnt1 (Integer)
           42 => ( Parameter_Integer, 0 ),   --  : clothnt2 (Integer)
           43 => ( Parameter_Integer, 0 ),   --  : clothnt3 (Integer)
           44 => ( Parameter_Integer, 0 ),   --  : clothnt4 (Integer)
           45 => ( Parameter_Integer, 0 ),   --  : clothnt5 (Integer)
           46 => ( Parameter_Integer, 0 ),   --  : clothnt6 (Integer)
           47 => ( Parameter_Integer, 0 ),   --  : clothnt7 (Integer)
           48 => ( Parameter_Integer, 0 ),   --  : clothnt8 (Integer)
           49 => ( Parameter_Integer, 0 ),   --  : clothsoa (Integer)
           50 => ( Parameter_Integer, 0 ),   --  : coatnt1 (Integer)
           51 => ( Parameter_Integer, 0 ),   --  : coatnt2 (Integer)
           52 => ( Parameter_Integer, 0 ),   --  : coatnt3 (Integer)
           53 => ( Parameter_Integer, 0 ),   --  : coatnt4 (Integer)
           54 => ( Parameter_Integer, 0 ),   --  : coatnt5 (Integer)
           55 => ( Parameter_Integer, 0 ),   --  : coatnt6 (Integer)
           56 => ( Parameter_Integer, 0 ),   --  : coatnt7 (Integer)
           57 => ( Parameter_Integer, 0 ),   --  : coatnt8 (Integer)
           58 => ( Parameter_Integer, 0 ),   --  : coatnt9 (Integer)
           59 => ( Parameter_Integer, 0 ),   --  : computer (Integer)
           60 => ( Parameter_Integer, 0 ),   --  : compuwhy (Integer)
           61 => ( Parameter_Integer, 0 ),   --  : cooknt1 (Integer)
           62 => ( Parameter_Integer, 0 ),   --  : cooknt2 (Integer)
           63 => ( Parameter_Integer, 0 ),   --  : cooknt3 (Integer)
           64 => ( Parameter_Integer, 0 ),   --  : cooknt4 (Integer)
           65 => ( Parameter_Integer, 0 ),   --  : cooknt5 (Integer)
           66 => ( Parameter_Integer, 0 ),   --  : cooknt6 (Integer)
           67 => ( Parameter_Integer, 0 ),   --  : cooknt7 (Integer)
           68 => ( Parameter_Integer, 0 ),   --  : cooknt8 (Integer)
           69 => ( Parameter_Integer, 0 ),   --  : cooknt9 (Integer)
           70 => ( Parameter_Integer, 0 ),   --  : cplay (Integer)
           71 => ( Parameter_Integer, 0 ),   --  : crime (Integer)
           72 => ( Parameter_Integer, 0 ),   --  : damp (Integer)
           73 => ( Parameter_Integer, 0 ),   --  : dampnt1 (Integer)
           74 => ( Parameter_Integer, 0 ),   --  : dampnt2 (Integer)
           75 => ( Parameter_Integer, 0 ),   --  : dampnt3 (Integer)
           76 => ( Parameter_Integer, 0 ),   --  : dampnt4 (Integer)
           77 => ( Parameter_Integer, 0 ),   --  : dampnt5 (Integer)
           78 => ( Parameter_Integer, 0 ),   --  : dampnt6 (Integer)
           79 => ( Parameter_Integer, 0 ),   --  : dampnt7 (Integer)
           80 => ( Parameter_Integer, 0 ),   --  : dampnt8 (Integer)
           81 => ( Parameter_Integer, 0 ),   --  : dampnt9 (Integer)
           82 => ( Parameter_Integer, 0 ),   --  : dark (Integer)
           83 => ( Parameter_Integer, 0 ),   --  : debt01 (Integer)
           84 => ( Parameter_Integer, 0 ),   --  : debt02 (Integer)
           85 => ( Parameter_Integer, 0 ),   --  : debt03 (Integer)
           86 => ( Parameter_Integer, 0 ),   --  : debt04 (Integer)
           87 => ( Parameter_Integer, 0 ),   --  : debt05 (Integer)
           88 => ( Parameter_Integer, 0 ),   --  : debt06 (Integer)
           89 => ( Parameter_Integer, 0 ),   --  : debt07 (Integer)
           90 => ( Parameter_Integer, 0 ),   --  : debt08 (Integer)
           91 => ( Parameter_Integer, 0 ),   --  : debt09 (Integer)
           92 => ( Parameter_Integer, 0 ),   --  : debt10 (Integer)
           93 => ( Parameter_Integer, 0 ),   --  : debt11 (Integer)
           94 => ( Parameter_Integer, 0 ),   --  : debt12 (Integer)
           95 => ( Parameter_Integer, 0 ),   --  : debtar01 (Integer)
           96 => ( Parameter_Integer, 0 ),   --  : debtar02 (Integer)
           97 => ( Parameter_Integer, 0 ),   --  : debtar03 (Integer)
           98 => ( Parameter_Integer, 0 ),   --  : debtar04 (Integer)
           99 => ( Parameter_Integer, 0 ),   --  : debtar05 (Integer)
           100 => ( Parameter_Integer, 0 ),   --  : debtar06 (Integer)
           101 => ( Parameter_Integer, 0 ),   --  : debtar07 (Integer)
           102 => ( Parameter_Integer, 0 ),   --  : debtar08 (Integer)
           103 => ( Parameter_Integer, 0 ),   --  : debtar09 (Integer)
           104 => ( Parameter_Integer, 0 ),   --  : debtar10 (Integer)
           105 => ( Parameter_Integer, 0 ),   --  : debtar11 (Integer)
           106 => ( Parameter_Integer, 0 ),   --  : debtar12 (Integer)
           107 => ( Parameter_Integer, 0 ),   --  : debtfre1 (Integer)
           108 => ( Parameter_Integer, 0 ),   --  : debtfre2 (Integer)
           109 => ( Parameter_Integer, 0 ),   --  : debtfre3 (Integer)
           110 => ( Parameter_Integer, 0 ),   --  : endsmeet (Integer)
           111 => ( Parameter_Integer, 0 ),   --  : eucar (Integer)
           112 => ( Parameter_Integer, 0 ),   --  : eucarwhy (Integer)
           113 => ( Parameter_Integer, 0 ),   --  : euexpns (Integer)
           114 => ( Parameter_Integer, 0 ),   --  : eumeal (Integer)
           115 => ( Parameter_Integer, 0 ),   --  : eurepay (Integer)
           116 => ( Parameter_Integer, 0 ),   --  : euteleph (Integer)
           117 => ( Parameter_Integer, 0 ),   --  : eutelwhy (Integer)
           118 => ( Parameter_Integer, 0 ),   --  : expnsoa (Integer)
           119 => ( Parameter_Integer, 0 ),   --  : frndnt1 (Integer)
           120 => ( Parameter_Integer, 0 ),   --  : frndnt2 (Integer)
           121 => ( Parameter_Integer, 0 ),   --  : frndnt3 (Integer)
           122 => ( Parameter_Integer, 0 ),   --  : frndnt4 (Integer)
           123 => ( Parameter_Integer, 0 ),   --  : frndnt5 (Integer)
           124 => ( Parameter_Integer, 0 ),   --  : frndnt6 (Integer)
           125 => ( Parameter_Integer, 0 ),   --  : frndnt7 (Integer)
           126 => ( Parameter_Integer, 0 ),   --  : frndnt8 (Integer)
           127 => ( Parameter_Integer, 0 ),   --  : frndnt9 (Integer)
           128 => ( Parameter_Integer, 0 ),   --  : furnt1 (Integer)
           129 => ( Parameter_Integer, 0 ),   --  : furnt2 (Integer)
           130 => ( Parameter_Integer, 0 ),   --  : furnt3 (Integer)
           131 => ( Parameter_Integer, 0 ),   --  : furnt4 (Integer)
           132 => ( Parameter_Integer, 0 ),   --  : furnt5 (Integer)
           133 => ( Parameter_Integer, 0 ),   --  : furnt6 (Integer)
           134 => ( Parameter_Integer, 0 ),   --  : furnt7 (Integer)
           135 => ( Parameter_Integer, 0 ),   --  : furnt8 (Integer)
           136 => ( Parameter_Integer, 0 ),   --  : hairnt1 (Integer)
           137 => ( Parameter_Integer, 0 ),   --  : hairnt2 (Integer)
           138 => ( Parameter_Integer, 0 ),   --  : hairnt3 (Integer)
           139 => ( Parameter_Integer, 0 ),   --  : hairnt4 (Integer)
           140 => ( Parameter_Integer, 0 ),   --  : hairnt5 (Integer)
           141 => ( Parameter_Integer, 0 ),   --  : hairnt6 (Integer)
           142 => ( Parameter_Integer, 0 ),   --  : hairnt7 (Integer)
           143 => ( Parameter_Integer, 0 ),   --  : hairnt8 (Integer)
           144 => ( Parameter_Integer, 0 ),   --  : hairnt9 (Integer)
           145 => ( Parameter_Integer, 0 ),   --  : hbolng (Integer)
           146 => ( Parameter_Float, 0.0 ),   --  : hbothamt (Amount)
           147 => ( Parameter_Integer, 0 ),   --  : hbothbu (Integer)
           148 => ( Parameter_Integer, 0 ),   --  : hbothmn (Integer)
           149 => ( Parameter_Integer, 0 ),   --  : hbothpd (Integer)
           150 => ( Parameter_Integer, 0 ),   --  : hbothwk (Integer)
           151 => ( Parameter_Integer, 0 ),   --  : hbothyr (Integer)
           152 => ( Parameter_Integer, 0 ),   --  : hbotwait (Integer)
           153 => ( Parameter_Integer, 0 ),   --  : heatnt1 (Integer)
           154 => ( Parameter_Integer, 0 ),   --  : heatnt2 (Integer)
           155 => ( Parameter_Integer, 0 ),   --  : heatnt3 (Integer)
           156 => ( Parameter_Integer, 0 ),   --  : heatnt4 (Integer)
           157 => ( Parameter_Integer, 0 ),   --  : heatnt5 (Integer)
           158 => ( Parameter_Integer, 0 ),   --  : heatnt6 (Integer)
           159 => ( Parameter_Integer, 0 ),   --  : heatnt7 (Integer)
           160 => ( Parameter_Integer, 0 ),   --  : heatnt8 (Integer)
           161 => ( Parameter_Integer, 0 ),   --  : heatnt9 (Integer)
           162 => ( Parameter_Integer, 0 ),   --  : holnt1 (Integer)
           163 => ( Parameter_Integer, 0 ),   --  : holnt2 (Integer)
           164 => ( Parameter_Integer, 0 ),   --  : holnt3 (Integer)
           165 => ( Parameter_Integer, 0 ),   --  : holnt4 (Integer)
           166 => ( Parameter_Integer, 0 ),   --  : holnt5 (Integer)
           167 => ( Parameter_Integer, 0 ),   --  : holnt6 (Integer)
           168 => ( Parameter_Integer, 0 ),   --  : holnt7 (Integer)
           169 => ( Parameter_Integer, 0 ),   --  : holnt8 (Integer)
           170 => ( Parameter_Integer, 0 ),   --  : holnt9 (Integer)
           171 => ( Parameter_Integer, 0 ),   --  : homent1 (Integer)
           172 => ( Parameter_Integer, 0 ),   --  : homent2 (Integer)
           173 => ( Parameter_Integer, 0 ),   --  : homent3 (Integer)
           174 => ( Parameter_Integer, 0 ),   --  : homent4 (Integer)
           175 => ( Parameter_Integer, 0 ),   --  : homent5 (Integer)
           176 => ( Parameter_Integer, 0 ),   --  : homent6 (Integer)
           177 => ( Parameter_Integer, 0 ),   --  : homent7 (Integer)
           178 => ( Parameter_Integer, 0 ),   --  : homent8 (Integer)
           179 => ( Parameter_Integer, 0 ),   --  : homent9 (Integer)
           180 => ( Parameter_Integer, 0 ),   --  : houshe1 (Integer)
           181 => ( Parameter_Integer, 0 ),   --  : houshew (Integer)
           182 => ( Parameter_Integer, 0 ),   --  : intntnt1 (Integer)
           183 => ( Parameter_Integer, 0 ),   --  : intntnt2 (Integer)
           184 => ( Parameter_Integer, 0 ),   --  : intntnt3 (Integer)
           185 => ( Parameter_Integer, 0 ),   --  : intntnt4 (Integer)
           186 => ( Parameter_Integer, 0 ),   --  : intntnt5 (Integer)
           187 => ( Parameter_Integer, 0 ),   --  : intntnt6 (Integer)
           188 => ( Parameter_Integer, 0 ),   --  : intntnt7 (Integer)
           189 => ( Parameter_Integer, 0 ),   --  : intntnt8 (Integer)
           190 => ( Parameter_Integer, 0 ),   --  : intrnet (Integer)
           191 => ( Parameter_Integer, 0 ),   --  : issue (Integer)
           192 => ( Parameter_Integer, 0 ),   --  : kidinc (Integer)
           193 => ( Parameter_Integer, 0 ),   --  : meal (Integer)
           194 => ( Parameter_Integer, 0 ),   --  : mealnt1 (Integer)
           195 => ( Parameter_Integer, 0 ),   --  : mealnt2 (Integer)
           196 => ( Parameter_Integer, 0 ),   --  : mealnt3 (Integer)
           197 => ( Parameter_Integer, 0 ),   --  : mealnt4 (Integer)
           198 => ( Parameter_Integer, 0 ),   --  : mealnt5 (Integer)
           199 => ( Parameter_Integer, 0 ),   --  : mealnt6 (Integer)
           200 => ( Parameter_Integer, 0 ),   --  : mealnt7 (Integer)
           201 => ( Parameter_Integer, 0 ),   --  : mealnt8 (Integer)
           202 => ( Parameter_Integer, 0 ),   --  : mealnt9 (Integer)
           203 => ( Parameter_Integer, 0 ),   --  : nhhchild (Integer)
           204 => ( Parameter_Integer, 0 ),   --  : noise (Integer)
           205 => ( Parameter_Integer, 0 ),   --  : oabill (Integer)
           206 => ( Parameter_Integer, 0 ),   --  : oacareu1 (Integer)
           207 => ( Parameter_Integer, 0 ),   --  : oacareu2 (Integer)
           208 => ( Parameter_Integer, 0 ),   --  : oacareu3 (Integer)
           209 => ( Parameter_Integer, 0 ),   --  : oacareu4 (Integer)
           210 => ( Parameter_Integer, 0 ),   --  : oacareu5 (Integer)
           211 => ( Parameter_Integer, 0 ),   --  : oacareu6 (Integer)
           212 => ( Parameter_Integer, 0 ),   --  : oacareu7 (Integer)
           213 => ( Parameter_Integer, 0 ),   --  : oacareu8 (Integer)
           214 => ( Parameter_Integer, 0 ),   --  : oacoat (Integer)
           215 => ( Parameter_Integer, 0 ),   --  : oacook (Integer)
           216 => ( Parameter_Integer, 0 ),   --  : oadamp (Integer)
           217 => ( Parameter_Integer, 0 ),   --  : oadep2 (Integer)
           218 => ( Parameter_Integer, 0 ),   --  : oadp2nt1 (Integer)
           219 => ( Parameter_Integer, 0 ),   --  : oadp2nt2 (Integer)
           220 => ( Parameter_Integer, 0 ),   --  : oadp2nt3 (Integer)
           221 => ( Parameter_Integer, 0 ),   --  : oadp2nt4 (Integer)
           222 => ( Parameter_Integer, 0 ),   --  : oadp2nt5 (Integer)
           223 => ( Parameter_Integer, 0 ),   --  : oadp2nt6 (Integer)
           224 => ( Parameter_Integer, 0 ),   --  : oadp2nt7 (Integer)
           225 => ( Parameter_Integer, 0 ),   --  : oadp2nt8 (Integer)
           226 => ( Parameter_Integer, 0 ),   --  : oaexpns (Integer)
           227 => ( Parameter_Integer, 0 ),   --  : oafrnd (Integer)
           228 => ( Parameter_Integer, 0 ),   --  : oafur (Integer)
           229 => ( Parameter_Integer, 0 ),   --  : oahair (Integer)
           230 => ( Parameter_Integer, 0 ),   --  : oaheat (Integer)
           231 => ( Parameter_Integer, 0 ),   --  : oahol (Integer)
           232 => ( Parameter_Integer, 0 ),   --  : oahome (Integer)
           233 => ( Parameter_Integer, 0 ),   --  : oahowpy1 (Integer)
           234 => ( Parameter_Integer, 0 ),   --  : oahowpy2 (Integer)
           235 => ( Parameter_Integer, 0 ),   --  : oahowpy3 (Integer)
           236 => ( Parameter_Integer, 0 ),   --  : oahowpy4 (Integer)
           237 => ( Parameter_Integer, 0 ),   --  : oahowpy5 (Integer)
           238 => ( Parameter_Integer, 0 ),   --  : oahowpy6 (Integer)
           239 => ( Parameter_Integer, 0 ),   --  : oaintern (Integer)
           240 => ( Parameter_Integer, 0 ),   --  : oameal (Integer)
           241 => ( Parameter_Integer, 0 ),   --  : oaout (Integer)
           242 => ( Parameter_Integer, 0 ),   --  : oaphon (Integer)
           243 => ( Parameter_Integer, 0 ),   --  : oapre (Integer)
           244 => ( Parameter_Integer, 0 ),   --  : oataxi (Integer)
           245 => ( Parameter_Integer, 0 ),   --  : oataxieu (Integer)
           246 => ( Parameter_Integer, 0 ),   --  : oatelep1 (Integer)
           247 => ( Parameter_Integer, 0 ),   --  : oatelep2 (Integer)
           248 => ( Parameter_Integer, 0 ),   --  : oatelep3 (Integer)
           249 => ( Parameter_Integer, 0 ),   --  : oatelep4 (Integer)
           250 => ( Parameter_Integer, 0 ),   --  : oatelep5 (Integer)
           251 => ( Parameter_Integer, 0 ),   --  : oatelep6 (Integer)
           252 => ( Parameter_Integer, 0 ),   --  : oatelep7 (Integer)
           253 => ( Parameter_Integer, 0 ),   --  : oatelep8 (Integer)
           254 => ( Parameter_Integer, 0 ),   --  : oateleph (Integer)
           255 => ( Parameter_Integer, 0 ),   --  : oawarm (Integer)
           256 => ( Parameter_Integer, 0 ),   --  : outnt1 (Integer)
           257 => ( Parameter_Integer, 0 ),   --  : outnt2 (Integer)
           258 => ( Parameter_Integer, 0 ),   --  : outnt3 (Integer)
           259 => ( Parameter_Integer, 0 ),   --  : outnt4 (Integer)
           260 => ( Parameter_Integer, 0 ),   --  : outnt5 (Integer)
           261 => ( Parameter_Integer, 0 ),   --  : outnt6 (Integer)
           262 => ( Parameter_Integer, 0 ),   --  : outnt7 (Integer)
           263 => ( Parameter_Integer, 0 ),   --  : outnt8 (Integer)
           264 => ( Parameter_Integer, 0 ),   --  : outnt9 (Integer)
           265 => ( Parameter_Integer, 0 ),   --  : outpay (Integer)
           266 => ( Parameter_Float, 0.0 ),   --  : outpyamt (Amount)
           267 => ( Parameter_Integer, 0 ),   --  : phonnt1 (Integer)
           268 => ( Parameter_Integer, 0 ),   --  : phonnt2 (Integer)
           269 => ( Parameter_Integer, 0 ),   --  : phonnt3 (Integer)
           270 => ( Parameter_Integer, 0 ),   --  : phonnt4 (Integer)
           271 => ( Parameter_Integer, 0 ),   --  : phonnt5 (Integer)
           272 => ( Parameter_Integer, 0 ),   --  : phonnt6 (Integer)
           273 => ( Parameter_Integer, 0 ),   --  : phonnt7 (Integer)
           274 => ( Parameter_Integer, 0 ),   --  : phonnt8 (Integer)
           275 => ( Parameter_Integer, 0 ),   --  : phonnt9 (Integer)
           276 => ( Parameter_Integer, 0 ),   --  : pollute (Integer)
           277 => ( Parameter_Float, 0.0 ),   --  : regpamt (Amount)
           278 => ( Parameter_Integer, 0 ),   --  : regularp (Integer)
           279 => ( Parameter_Integer, 0 ),   --  : repaybur (Integer)
           280 => ( Parameter_Integer, 0 ),   --  : shoe (Integer)
           281 => ( Parameter_Integer, 0 ),   --  : shoent1 (Integer)
           282 => ( Parameter_Integer, 0 ),   --  : shoent2 (Integer)
           283 => ( Parameter_Integer, 0 ),   --  : shoent3 (Integer)
           284 => ( Parameter_Integer, 0 ),   --  : shoent4 (Integer)
           285 => ( Parameter_Integer, 0 ),   --  : shoent5 (Integer)
           286 => ( Parameter_Integer, 0 ),   --  : shoent6 (Integer)
           287 => ( Parameter_Integer, 0 ),   --  : shoent7 (Integer)
           288 => ( Parameter_Integer, 0 ),   --  : shoent8 (Integer)
           289 => ( Parameter_Integer, 0 ),   --  : shoeoa (Integer)
           290 => ( Parameter_Integer, 0 ),   --  : taxint1 (Integer)
           291 => ( Parameter_Integer, 0 ),   --  : taxint2 (Integer)
           292 => ( Parameter_Integer, 0 ),   --  : taxint3 (Integer)
           293 => ( Parameter_Integer, 0 ),   --  : taxint4 (Integer)
           294 => ( Parameter_Integer, 0 ),   --  : taxint5 (Integer)
           295 => ( Parameter_Integer, 0 ),   --  : taxint6 (Integer)
           296 => ( Parameter_Integer, 0 ),   --  : taxint7 (Integer)
           297 => ( Parameter_Integer, 0 ),   --  : taxint8 (Integer)
           298 => ( Parameter_Integer, 0 ),   --  : taxint9 (Integer)
           299 => ( Parameter_Integer, 0 ),   --  : totsav (Integer)
           300 => ( Parameter_Integer, 0 ),   --  : warmnt1 (Integer)
           301 => ( Parameter_Integer, 0 ),   --  : warmnt2 (Integer)
           302 => ( Parameter_Integer, 0 ),   --  : warmnt3 (Integer)
           303 => ( Parameter_Integer, 0 ),   --  : warmnt4 (Integer)
           304 => ( Parameter_Integer, 0 ),   --  : warmnt5 (Integer)
           305 => ( Parameter_Integer, 0 ),   --  : warmnt6 (Integer)
           306 => ( Parameter_Integer, 0 ),   --  : warmnt7 (Integer)
           307 => ( Parameter_Integer, 0 ),   --  : warmnt8 (Integer)
           308 => ( Parameter_Integer, 0 ),   --  : warmnt9 (Integer)
           309 => ( Parameter_Integer, 0 ),   --  : washmach (Integer)
           310 => ( Parameter_Integer, 0 ),   --  : washwhy (Integer)
           311 => ( Parameter_Integer, 0 ),   --  : whodepq (Integer)
           312 => ( Parameter_Integer, 0 ),   --  : month (Integer)
           313 => ( Parameter_Integer, 0 ),   --  : adultb (Integer)
           314 => ( Parameter_Float, 0.0 ),   --  : boarder (Amount)
           315 => ( Parameter_Float, 0.0 ),   --  : bpeninc (Amount)
           316 => ( Parameter_Float, 0.0 ),   --  : bseinc (Amount)
           317 => ( Parameter_Integer, 0 ),   --  : buagegr2 (Integer)
           318 => ( Parameter_Integer, 0 ),   --  : buagegr3 (Integer)
           319 => ( Parameter_Integer, 0 ),   --  : buagegr4 (Integer)
           320 => ( Parameter_Integer, 0 ),   --  : buagegrp (Integer)
           321 => ( Parameter_Integer, 0 ),   --  : budisben (Integer)
           322 => ( Parameter_Float, 0.0 ),   --  : buearns (Amount)
           323 => ( Parameter_Integer, 0 ),   --  : buethgr3 (Integer)
           324 => ( Parameter_Integer, 0 ),   --  : buinc (Integer)
           325 => ( Parameter_Float, 0.0 ),   --  : buinv (Amount)
           326 => ( Parameter_Integer, 0 ),   --  : buirben (Integer)
           327 => ( Parameter_Integer, 0 ),   --  : bukids (Integer)
           328 => ( Parameter_Integer, 0 ),   --  : bunirben (Integer)
           329 => ( Parameter_Integer, 0 ),   --  : buothben (Integer)
           330 => ( Parameter_Integer, 0 ),   --  : burent (Integer)
           331 => ( Parameter_Float, 0.0 ),   --  : burinc (Amount)
           332 => ( Parameter_Float, 0.0 ),   --  : burpinc (Amount)
           333 => ( Parameter_Float, 0.0 ),   --  : butvlic (Amount)
           334 => ( Parameter_Float, 0.0 ),   --  : butxcred (Amount)
           335 => ( Parameter_Integer, 0 ),   --  : depchldb (Integer)
           336 => ( Parameter_Integer, 0 ),   --  : discbua1 (Integer)
           337 => ( Parameter_Integer, 0 ),   --  : discbuc1 (Integer)
           338 => ( Parameter_Integer, 0 ),   --  : diswbua1 (Integer)
           339 => ( Parameter_Integer, 0 ),   --  : diswbuc1 (Integer)
           340 => ( Parameter_Integer, 0 ),   --  : ecostabu (Integer)
           341 => ( Parameter_Integer, 0 ),   --  : ecstatbu (Integer)
           342 => ( Parameter_Integer, 0 ),   --  : famtypb2 (Integer)
           343 => ( Parameter_Integer, 0 ),   --  : famtypbs (Integer)
           344 => ( Parameter_Integer, 0 ),   --  : famtypbu (Integer)
           345 => ( Parameter_Float, 0.0 ),   --  : fsbbu (Amount)
           346 => ( Parameter_Float, 0.0 ),   --  : fsfvbu (Amount)
           347 => ( Parameter_Float, 0.0 ),   --  : fsmbu (Amount)
           348 => ( Parameter_Float, 0.0 ),   --  : fsmlkbu (Amount)
           349 => ( Parameter_Integer, 0 ),   --  : gross4 (Integer)
           350 => ( Parameter_Integer, 0 ),   --  : hbindbu (Integer)
           351 => ( Parameter_Integer, 0 ),   --  : hbindbu2 (Integer)
           352 => ( Parameter_Float, 0.0 ),   --  : heartbu (Amount)
           353 => ( Parameter_Integer, 0 ),   --  : kid04 (Integer)
           354 => ( Parameter_Integer, 0 ),   --  : kid1115 (Integer)
           355 => ( Parameter_Integer, 0 ),   --  : kid1619 (Integer)
           356 => ( Parameter_Integer, 0 ),   --  : kid510 (Integer)
           357 => ( Parameter_Float, 0.0 ),   --  : lodger (Amount)
           358 => ( Parameter_Integer, 0 ),   --  : nbunirbn (Integer)
           359 => ( Parameter_Integer, 0 ),   --  : nbuothbn (Integer)
           360 => ( Parameter_Integer, 0 ),   --  : newfamb2 (Integer)
           361 => ( Parameter_Integer, 0 ),   --  : newfambu (Integer)
           362 => ( Parameter_Float, 0.0 ),   --  : subltamt (Amount)
           363 => ( Parameter_Float, 0.0 ),   --  : totcapb3 (Amount)
           364 => ( Parameter_Integer, 0 ),   --  : totsavbu (Integer)
           365 => ( Parameter_Float, 0.0 ),   --  : tuburent (Amount)
           366 => ( Parameter_Integer, 0 ),   --  : youngch (Integer)
           367 => ( Parameter_Integer, 0 ),   --  : debt13 (Integer)
           368 => ( Parameter_Integer, 0 ),   --  : debtar13 (Integer)
           369 => ( Parameter_Integer, 0 ),   --  : euchbook (Integer)
           370 => ( Parameter_Integer, 0 ),   --  : euchclth (Integer)
           371 => ( Parameter_Integer, 0 ),   --  : euchgame (Integer)
           372 => ( Parameter_Integer, 0 ),   --  : euchmeat (Integer)
           373 => ( Parameter_Integer, 0 ),   --  : euchshoe (Integer)
           374 => ( Parameter_Integer, 0 ),   --  : eupbtran (Integer)
           375 => ( Parameter_Integer, 0 ),   --  : eupbtrn1 (Integer)
           376 => ( Parameter_Integer, 0 ),   --  : eupbtrn2 (Integer)
           377 => ( Parameter_Integer, 0 ),   --  : eupbtrn3 (Integer)
           378 => ( Parameter_Integer, 0 ),   --  : eupbtrn4 (Integer)
           379 => ( Parameter_Integer, 0 ),   --  : eupbtrn5 (Integer)
           380 => ( Parameter_Integer, 0 ),   --  : euroast (Integer)
           381 => ( Parameter_Integer, 0 ),   --  : eusmeal (Integer)
           382 => ( Parameter_Integer, 0 ),   --  : eustudy (Integer)
           383 => ( Parameter_Integer, 0 ),   --  : bueth (Integer)
           384 => ( Parameter_Integer, 0 ),   --  : oaeusmea (Integer)
           385 => ( Parameter_Integer, 0 ),   --  : oaholb (Integer)
           386 => ( Parameter_Integer, 0 ),   --  : oaroast (Integer)
           387 => ( Parameter_Integer, 0 ),   --  : ecostab2 (Integer)
           388 => ( Parameter_Integer, 0 ),   --  : incchnge (Integer)
           389 => ( Parameter_Integer, 0 ),   --  : inchilow (Integer)
           390 => ( Parameter_Integer, 0 ),   --  : actaccb (Integer)
           391 => ( Parameter_Integer, 0 ),   --  : adddabu (Integer)
           392 => ( Parameter_Integer, 0 ),   --  : basactb (Integer)
           393 => ( Parameter_Integer, 0 ),   --  : buethgr2 (Integer)
           394 => ( Parameter_Integer, 0 ),   --  : buethgrp (Integer)
           395 => ( Parameter_Integer, 0 ),   --  : chddabu (Integer)
           396 => ( Parameter_Integer, 0 ),   --  : curactb (Integer)
           397 => ( Parameter_Integer, 0 ),   --  : depdeds (Integer)
           398 => ( Parameter_Integer, 0 ),   --  : disindhb (Integer)
           399 => ( Parameter_Integer, 0 ),   --  : ecotypbu (Integer)
           400 => ( Parameter_Integer, 0 ),   --  : famthbai (Integer)
           401 => ( Parameter_Integer, 0 ),   --  : famtype (Integer)
           402 => ( Parameter_Integer, 0 ),   --  : fsbndctb (Integer)
           403 => ( Parameter_Float, 0.0 ),   --  : fwmlkbu (Amount)
           404 => ( Parameter_Integer, 0 ),   --  : gebactb (Integer)
           405 => ( Parameter_Integer, 0 ),   --  : giltctb (Integer)
           406 => ( Parameter_Integer, 0 ),   --  : gross2 (Integer)
           407 => ( Parameter_Integer, 0 ),   --  : gross3 (Integer)
           408 => ( Parameter_Integer, 0 ),   --  : isactb (Integer)
           409 => ( Parameter_Integer, 0 ),   --  : kid1618 (Integer)
           410 => ( Parameter_Integer, 0 ),   --  : kidsbu0 (Integer)
           411 => ( Parameter_Integer, 0 ),   --  : kidsbu1 (Integer)
           412 => ( Parameter_Integer, 0 ),   --  : kidsbu10 (Integer)
           413 => ( Parameter_Integer, 0 ),   --  : kidsbu11 (Integer)
           414 => ( Parameter_Integer, 0 ),   --  : kidsbu12 (Integer)
           415 => ( Parameter_Integer, 0 ),   --  : kidsbu13 (Integer)
           416 => ( Parameter_Integer, 0 ),   --  : kidsbu14 (Integer)
           417 => ( Parameter_Integer, 0 ),   --  : kidsbu15 (Integer)
           418 => ( Parameter_Integer, 0 ),   --  : kidsbu16 (Integer)
           419 => ( Parameter_Integer, 0 ),   --  : kidsbu17 (Integer)
           420 => ( Parameter_Integer, 0 ),   --  : kidsbu18 (Integer)
           421 => ( Parameter_Integer, 0 ),   --  : kidsbu2 (Integer)
           422 => ( Parameter_Integer, 0 ),   --  : kidsbu3 (Integer)
           423 => ( Parameter_Integer, 0 ),   --  : kidsbu4 (Integer)
           424 => ( Parameter_Integer, 0 ),   --  : kidsbu5 (Integer)
           425 => ( Parameter_Integer, 0 ),   --  : kidsbu6 (Integer)
           426 => ( Parameter_Integer, 0 ),   --  : kidsbu7 (Integer)
           427 => ( Parameter_Integer, 0 ),   --  : kidsbu8 (Integer)
           428 => ( Parameter_Integer, 0 ),   --  : kidsbu9 (Integer)
           429 => ( Parameter_Integer, 0 ),   --  : lastwork (Integer)
           430 => ( Parameter_Integer, 0 ),   --  : nsboctb (Integer)
           431 => ( Parameter_Integer, 0 ),   --  : otbsctb (Integer)
           432 => ( Parameter_Integer, 0 ),   --  : pepsctb (Integer)
           433 => ( Parameter_Integer, 0 ),   --  : poacctb (Integer)
           434 => ( Parameter_Integer, 0 ),   --  : prboctb (Integer)
           435 => ( Parameter_Integer, 0 ),   --  : sayectb (Integer)
           436 => ( Parameter_Integer, 0 ),   --  : sclbctb (Integer)
           437 => ( Parameter_Integer, 0 ),   --  : ssctb (Integer)
           438 => ( Parameter_Integer, 0 ),   --  : stshctb (Integer)
           439 => ( Parameter_Integer, 0 ),   --  : tessctb (Integer)
           440 => ( Parameter_Float, 0.0 ),   --  : totcapbu (Amount)
           441 => ( Parameter_Integer, 0 ),   --  : untrctb (Integer)
           442 => ( Parameter_Integer, 0 ),   --  : addeples (Integer)
           443 => ( Parameter_Integer, 0 ),   --  : addmel (Integer)
           444 => ( Parameter_Integer, 0 ),   --  : addshoe (Integer)
           445 => ( Parameter_Integer, 0 ),   --  : cdepsum (Integer)
           446 => ( Parameter_Integer, 0 ),   --  : debt1 (Integer)
           447 => ( Parameter_Integer, 0 ),   --  : debt2 (Integer)
           448 => ( Parameter_Integer, 0 ),   --  : debt3 (Integer)
           449 => ( Parameter_Integer, 0 ),   --  : debt4 (Integer)
           450 => ( Parameter_Integer, 0 ),   --  : debt5 (Integer)
           451 => ( Parameter_Integer, 0 ),   --  : debt6 (Integer)
           452 => ( Parameter_Integer, 0 ),   --  : debt7 (Integer)
           453 => ( Parameter_Integer, 0 ),   --  : debt8 (Integer)
           454 => ( Parameter_Integer, 0 ),   --  : debt9 (Integer)
           455 => ( Parameter_Integer, 0 ),   --  : incold (Integer)
           456 => ( Parameter_Integer, 0 ),   --  : crunacb (Integer)
           457 => ( Parameter_Integer, 0 ),   --  : enomortb (Integer)
           458 => ( Parameter_Integer, 0 ),   --  : pocardb (Integer)
           459 => ( Parameter_Float, 0.0 ),   --  : totcapb2 (Amount)
           460 => ( Parameter_Integer, 0 ),   --  : cbaamt1 (Integer)
           461 => ( Parameter_Integer, 0 ),   --  : cbaamt2 (Integer)
           462 => ( Parameter_Integer, 0 ),   --  : helpgv01 (Integer)
           463 => ( Parameter_Integer, 0 ),   --  : helpgv02 (Integer)
           464 => ( Parameter_Integer, 0 ),   --  : helpgv03 (Integer)
           465 => ( Parameter_Integer, 0 ),   --  : helpgv04 (Integer)
           466 => ( Parameter_Integer, 0 ),   --  : helpgv05 (Integer)
           467 => ( Parameter_Integer, 0 ),   --  : helpgv06 (Integer)
           468 => ( Parameter_Integer, 0 ),   --  : helpgv07 (Integer)
           469 => ( Parameter_Integer, 0 ),   --  : helpgv08 (Integer)
           470 => ( Parameter_Integer, 0 ),   --  : helpgv09 (Integer)
           471 => ( Parameter_Integer, 0 ),   --  : helpgv10 (Integer)
           472 => ( Parameter_Integer, 0 ),   --  : helpgv11 (Integer)
           473 => ( Parameter_Integer, 0 ),   --  : helprc01 (Integer)
           474 => ( Parameter_Integer, 0 ),   --  : helprc02 (Integer)
           475 => ( Parameter_Integer, 0 ),   --  : helprc03 (Integer)
           476 => ( Parameter_Integer, 0 ),   --  : helprc04 (Integer)
           477 => ( Parameter_Integer, 0 ),   --  : helprc05 (Integer)
           478 => ( Parameter_Integer, 0 ),   --  : helprc06 (Integer)
           479 => ( Parameter_Integer, 0 ),   --  : helprc07 (Integer)
           480 => ( Parameter_Integer, 0 ),   --  : helprc08 (Integer)
           481 => ( Parameter_Integer, 0 ),   --  : helprc09 (Integer)
           482 => ( Parameter_Integer, 0 ),   --  : helprc10 (Integer)
           483 => ( Parameter_Integer, 0 ),   --  : helprc11 (Integer)
           484 => ( Parameter_Integer, 0 ),   --  : loangvn1 (Integer)
           485 => ( Parameter_Integer, 0 ),   --  : loangvn2 (Integer)
           486 => ( Parameter_Integer, 0 ),   --  : loangvn3 (Integer)
           487 => ( Parameter_Integer, 0 ),   --  : loanrec1 (Integer)
           488 => ( Parameter_Integer, 0 ),   --  : loanrec2 (Integer)
           489 => ( Parameter_Integer, 0 ),   --  : loanrec3 (Integer)
           490 => ( Parameter_Integer, 0 ),   --  : gross3_x (Integer)
           491 => ( Parameter_Integer, 0 ),   --  : oabilimp (Integer)
           492 => ( Parameter_Integer, 0 ),   --  : oacoaimp (Integer)
           493 => ( Parameter_Integer, 0 ),   --  : oacooimp (Integer)
           494 => ( Parameter_Integer, 0 ),   --  : oadamimp (Integer)
           495 => ( Parameter_Integer, 0 ),   --  : oaexpimp (Integer)
           496 => ( Parameter_Integer, 0 ),   --  : oafrnimp (Integer)
           497 => ( Parameter_Integer, 0 ),   --  : oahaiimp (Integer)
           498 => ( Parameter_Integer, 0 ),   --  : oaheaimp (Integer)
           499 => ( Parameter_Integer, 0 ),   --  : oaholimp (Integer)
           500 => ( Parameter_Integer, 0 ),   --  : oahomimp (Integer)
           501 => ( Parameter_Integer, 0 ),   --  : oameaimp (Integer)
           502 => ( Parameter_Integer, 0 ),   --  : oaoutimp (Integer)
           503 => ( Parameter_Integer, 0 ),   --  : oaphoimp (Integer)
           504 => ( Parameter_Integer, 0 ),   --  : oataximp (Integer)
           505 => ( Parameter_Integer, 0 ),   --  : oawarimp (Integer)
           ...
           510 => ( Parameter_Integer, 0 )   --  : benunit (Integer)
            ...
            6 => ( Parameter_Integer, 0 ),   --  : adbtbl (Integer)
            7 => ( Parameter_Integer, 0 ),   --  : adddec (Integer)
            8 => ( Parameter_Integer, 0 ),   --  : addhol (Integer)
            9 => ( Parameter_Integer, 0 ),   --  : addholr (Integer)
           10 => ( Parameter_Integer, 0 ),   --  : addins (Integer)
           11 => ( Parameter_Integer, 0 ),   --  : addmon (Integer)
           12 => ( Parameter_Integer, 0 ),   --  : adepfur (Integer)
           13 => ( Parameter_Integer, 0 ),   --  : adles (Integer)
           14 => ( Parameter_Integer, 0 ),   --  : adlesnt1 (Integer)
           15 => ( Parameter_Integer, 0 ),   --  : adlesnt2 (Integer)
           16 => ( Parameter_Integer, 0 ),   --  : adlesnt3 (Integer)
           17 => ( Parameter_Integer, 0 ),   --  : adlesnt4 (Integer)
           18 => ( Parameter_Integer, 0 ),   --  : adlesnt5 (Integer)
           19 => ( Parameter_Integer, 0 ),   --  : adlesnt6 (Integer)
           20 => ( Parameter_Integer, 0 ),   --  : adlesnt7 (Integer)
           21 => ( Parameter_Integer, 0 ),   --  : adlesnt8 (Integer)
           22 => ( Parameter_Integer, 0 ),   --  : adlesoa (Integer)
           23 => ( Parameter_Integer, 0 ),   --  : af1 (Integer)
           24 => ( Parameter_Integer, 0 ),   --  : afdep2 (Integer)
           25 => ( Parameter_Integer, 0 ),   --  : billnt1 (Integer)
           26 => ( Parameter_Integer, 0 ),   --  : billnt2 (Integer)
           27 => ( Parameter_Integer, 0 ),   --  : billnt3 (Integer)
           28 => ( Parameter_Integer, 0 ),   --  : billnt4 (Integer)
           29 => ( Parameter_Integer, 0 ),   --  : billnt5 (Integer)
           30 => ( Parameter_Integer, 0 ),   --  : billnt6 (Integer)
           31 => ( Parameter_Integer, 0 ),   --  : billnt7 (Integer)
           32 => ( Parameter_Integer, 0 ),   --  : billnt8 (Integer)
           33 => ( Parameter_Integer, 0 ),   --  : billnt9 (Integer)
           34 => ( Parameter_Integer, 0 ),   --  : cdelply (Integer)
           35 => ( Parameter_Integer, 0 ),   --  : cdepact (Integer)
           36 => ( Parameter_Integer, 0 ),   --  : cdepbed (Integer)
           37 => ( Parameter_Integer, 0 ),   --  : cdepcel (Integer)
           38 => ( Parameter_Integer, 0 ),   --  : cdepeqp (Integer)
           39 => ( Parameter_Integer, 0 ),   --  : cdephol (Integer)
           40 => ( Parameter_Integer, 0 ),   --  : cdeples (Integer)
           41 => ( Parameter_Integer, 0 ),   --  : cdeptea (Integer)
           42 => ( Parameter_Integer, 0 ),   --  : cdeptrp (Integer)
           43 => ( Parameter_Integer, 0 ),   --  : cdepveg (Integer)
           44 => ( Parameter_Integer, 0 ),   --  : cdpcoat (Integer)
           45 => ( Parameter_Integer, 0 ),   --  : clothes (Integer)
           46 => ( Parameter_Integer, 0 ),   --  : clothnt1 (Integer)
           47 => ( Parameter_Integer, 0 ),   --  : clothnt2 (Integer)
           48 => ( Parameter_Integer, 0 ),   --  : clothnt3 (Integer)
           49 => ( Parameter_Integer, 0 ),   --  : clothnt4 (Integer)
           50 => ( Parameter_Integer, 0 ),   --  : clothnt5 (Integer)
           51 => ( Parameter_Integer, 0 ),   --  : clothnt6 (Integer)
           52 => ( Parameter_Integer, 0 ),   --  : clothnt7 (Integer)
           53 => ( Parameter_Integer, 0 ),   --  : clothnt8 (Integer)
           54 => ( Parameter_Integer, 0 ),   --  : clothsoa (Integer)
           55 => ( Parameter_Integer, 0 ),   --  : coatnt1 (Integer)
           56 => ( Parameter_Integer, 0 ),   --  : coatnt2 (Integer)
           57 => ( Parameter_Integer, 0 ),   --  : coatnt3 (Integer)
           58 => ( Parameter_Integer, 0 ),   --  : coatnt4 (Integer)
           59 => ( Parameter_Integer, 0 ),   --  : coatnt5 (Integer)
           60 => ( Parameter_Integer, 0 ),   --  : coatnt6 (Integer)
           61 => ( Parameter_Integer, 0 ),   --  : coatnt7 (Integer)
           62 => ( Parameter_Integer, 0 ),   --  : coatnt8 (Integer)
           63 => ( Parameter_Integer, 0 ),   --  : coatnt9 (Integer)
           64 => ( Parameter_Integer, 0 ),   --  : computer (Integer)
           65 => ( Parameter_Integer, 0 ),   --  : compuwhy (Integer)
           66 => ( Parameter_Integer, 0 ),   --  : cooknt1 (Integer)
           67 => ( Parameter_Integer, 0 ),   --  : cooknt2 (Integer)
           68 => ( Parameter_Integer, 0 ),   --  : cooknt3 (Integer)
           69 => ( Parameter_Integer, 0 ),   --  : cooknt4 (Integer)
           70 => ( Parameter_Integer, 0 ),   --  : cooknt5 (Integer)
           71 => ( Parameter_Integer, 0 ),   --  : cooknt6 (Integer)
           72 => ( Parameter_Integer, 0 ),   --  : cooknt7 (Integer)
           73 => ( Parameter_Integer, 0 ),   --  : cooknt8 (Integer)
           74 => ( Parameter_Integer, 0 ),   --  : cooknt9 (Integer)
           75 => ( Parameter_Integer, 0 ),   --  : cplay (Integer)
           76 => ( Parameter_Integer, 0 ),   --  : crime (Integer)
           77 => ( Parameter_Integer, 0 ),   --  : damp (Integer)
           78 => ( Parameter_Integer, 0 ),   --  : dampnt1 (Integer)
           79 => ( Parameter_Integer, 0 ),   --  : dampnt2 (Integer)
           80 => ( Parameter_Integer, 0 ),   --  : dampnt3 (Integer)
           81 => ( Parameter_Integer, 0 ),   --  : dampnt4 (Integer)
           82 => ( Parameter_Integer, 0 ),   --  : dampnt5 (Integer)
           83 => ( Parameter_Integer, 0 ),   --  : dampnt6 (Integer)
           84 => ( Parameter_Integer, 0 ),   --  : dampnt7 (Integer)
           85 => ( Parameter_Integer, 0 ),   --  : dampnt8 (Integer)
           86 => ( Parameter_Integer, 0 ),   --  : dampnt9 (Integer)
           87 => ( Parameter_Integer, 0 ),   --  : dark (Integer)
           88 => ( Parameter_Integer, 0 ),   --  : debt01 (Integer)
           89 => ( Parameter_Integer, 0 ),   --  : debt02 (Integer)
           90 => ( Parameter_Integer, 0 ),   --  : debt03 (Integer)
           91 => ( Parameter_Integer, 0 ),   --  : debt04 (Integer)
           92 => ( Parameter_Integer, 0 ),   --  : debt05 (Integer)
           93 => ( Parameter_Integer, 0 ),   --  : debt06 (Integer)
           94 => ( Parameter_Integer, 0 ),   --  : debt07 (Integer)
           95 => ( Parameter_Integer, 0 ),   --  : debt08 (Integer)
           96 => ( Parameter_Integer, 0 ),   --  : debt09 (Integer)
           97 => ( Parameter_Integer, 0 ),   --  : debt10 (Integer)
           98 => ( Parameter_Integer, 0 ),   --  : debt11 (Integer)
           99 => ( Parameter_Integer, 0 ),   --  : debt12 (Integer)
           100 => ( Parameter_Integer, 0 ),   --  : debtar01 (Integer)
           101 => ( Parameter_Integer, 0 ),   --  : debtar02 (Integer)
           102 => ( Parameter_Integer, 0 ),   --  : debtar03 (Integer)
           103 => ( Parameter_Integer, 0 ),   --  : debtar04 (Integer)
           104 => ( Parameter_Integer, 0 ),   --  : debtar05 (Integer)
           105 => ( Parameter_Integer, 0 ),   --  : debtar06 (Integer)
           106 => ( Parameter_Integer, 0 ),   --  : debtar07 (Integer)
           107 => ( Parameter_Integer, 0 ),   --  : debtar08 (Integer)
           108 => ( Parameter_Integer, 0 ),   --  : debtar09 (Integer)
           109 => ( Parameter_Integer, 0 ),   --  : debtar10 (Integer)
           110 => ( Parameter_Integer, 0 ),   --  : debtar11 (Integer)
           111 => ( Parameter_Integer, 0 ),   --  : debtar12 (Integer)
           112 => ( Parameter_Integer, 0 ),   --  : debtfre1 (Integer)
           113 => ( Parameter_Integer, 0 ),   --  : debtfre2 (Integer)
           114 => ( Parameter_Integer, 0 ),   --  : debtfre3 (Integer)
           115 => ( Parameter_Integer, 0 ),   --  : endsmeet (Integer)
           116 => ( Parameter_Integer, 0 ),   --  : eucar (Integer)
           117 => ( Parameter_Integer, 0 ),   --  : eucarwhy (Integer)
           118 => ( Parameter_Integer, 0 ),   --  : euexpns (Integer)
           119 => ( Parameter_Integer, 0 ),   --  : eumeal (Integer)
           120 => ( Parameter_Integer, 0 ),   --  : eurepay (Integer)
           121 => ( Parameter_Integer, 0 ),   --  : euteleph (Integer)
           122 => ( Parameter_Integer, 0 ),   --  : eutelwhy (Integer)
           123 => ( Parameter_Integer, 0 ),   --  : expnsoa (Integer)
           124 => ( Parameter_Integer, 0 ),   --  : frndnt1 (Integer)
           125 => ( Parameter_Integer, 0 ),   --  : frndnt2 (Integer)
           126 => ( Parameter_Integer, 0 ),   --  : frndnt3 (Integer)
           127 => ( Parameter_Integer, 0 ),   --  : frndnt4 (Integer)
           128 => ( Parameter_Integer, 0 ),   --  : frndnt5 (Integer)
           129 => ( Parameter_Integer, 0 ),   --  : frndnt6 (Integer)
           130 => ( Parameter_Integer, 0 ),   --  : frndnt7 (Integer)
           131 => ( Parameter_Integer, 0 ),   --  : frndnt8 (Integer)
           132 => ( Parameter_Integer, 0 ),   --  : frndnt9 (Integer)
           133 => ( Parameter_Integer, 0 ),   --  : furnt1 (Integer)
           134 => ( Parameter_Integer, 0 ),   --  : furnt2 (Integer)
           135 => ( Parameter_Integer, 0 ),   --  : furnt3 (Integer)
           136 => ( Parameter_Integer, 0 ),   --  : furnt4 (Integer)
           137 => ( Parameter_Integer, 0 ),   --  : furnt5 (Integer)
           138 => ( Parameter_Integer, 0 ),   --  : furnt6 (Integer)
           139 => ( Parameter_Integer, 0 ),   --  : furnt7 (Integer)
           140 => ( Parameter_Integer, 0 ),   --  : furnt8 (Integer)
           141 => ( Parameter_Integer, 0 ),   --  : hairnt1 (Integer)
           142 => ( Parameter_Integer, 0 ),   --  : hairnt2 (Integer)
           143 => ( Parameter_Integer, 0 ),   --  : hairnt3 (Integer)
           144 => ( Parameter_Integer, 0 ),   --  : hairnt4 (Integer)
           145 => ( Parameter_Integer, 0 ),   --  : hairnt5 (Integer)
           146 => ( Parameter_Integer, 0 ),   --  : hairnt6 (Integer)
           147 => ( Parameter_Integer, 0 ),   --  : hairnt7 (Integer)
           148 => ( Parameter_Integer, 0 ),   --  : hairnt8 (Integer)
           149 => ( Parameter_Integer, 0 ),   --  : hairnt9 (Integer)
           150 => ( Parameter_Integer, 0 ),   --  : hbolng (Integer)
           151 => ( Parameter_Float, 0.0 ),   --  : hbothamt (Amount)
           152 => ( Parameter_Integer, 0 ),   --  : hbothbu (Integer)
           153 => ( Parameter_Integer, 0 ),   --  : hbothmn (Integer)
           154 => ( Parameter_Integer, 0 ),   --  : hbothpd (Integer)
           155 => ( Parameter_Integer, 0 ),   --  : hbothwk (Integer)
           156 => ( Parameter_Integer, 0 ),   --  : hbothyr (Integer)
           157 => ( Parameter_Integer, 0 ),   --  : hbotwait (Integer)
           158 => ( Parameter_Integer, 0 ),   --  : heatnt1 (Integer)
           159 => ( Parameter_Integer, 0 ),   --  : heatnt2 (Integer)
           160 => ( Parameter_Integer, 0 ),   --  : heatnt3 (Integer)
           161 => ( Parameter_Integer, 0 ),   --  : heatnt4 (Integer)
           162 => ( Parameter_Integer, 0 ),   --  : heatnt5 (Integer)
           163 => ( Parameter_Integer, 0 ),   --  : heatnt6 (Integer)
           164 => ( Parameter_Integer, 0 ),   --  : heatnt7 (Integer)
           165 => ( Parameter_Integer, 0 ),   --  : heatnt8 (Integer)
           166 => ( Parameter_Integer, 0 ),   --  : heatnt9 (Integer)
           167 => ( Parameter_Integer, 0 ),   --  : holnt1 (Integer)
           168 => ( Parameter_Integer, 0 ),   --  : holnt2 (Integer)
           169 => ( Parameter_Integer, 0 ),   --  : holnt3 (Integer)
           170 => ( Parameter_Integer, 0 ),   --  : holnt4 (Integer)
           171 => ( Parameter_Integer, 0 ),   --  : holnt5 (Integer)
           172 => ( Parameter_Integer, 0 ),   --  : holnt6 (Integer)
           173 => ( Parameter_Integer, 0 ),   --  : holnt7 (Integer)
           174 => ( Parameter_Integer, 0 ),   --  : holnt8 (Integer)
           175 => ( Parameter_Integer, 0 ),   --  : holnt9 (Integer)
           176 => ( Parameter_Integer, 0 ),   --  : homent1 (Integer)
           177 => ( Parameter_Integer, 0 ),   --  : homent2 (Integer)
           178 => ( Parameter_Integer, 0 ),   --  : homent3 (Integer)
           179 => ( Parameter_Integer, 0 ),   --  : homent4 (Integer)
           180 => ( Parameter_Integer, 0 ),   --  : homent5 (Integer)
           181 => ( Parameter_Integer, 0 ),   --  : homent6 (Integer)
           182 => ( Parameter_Integer, 0 ),   --  : homent7 (Integer)
           183 => ( Parameter_Integer, 0 ),   --  : homent8 (Integer)
           184 => ( Parameter_Integer, 0 ),   --  : homent9 (Integer)
           185 => ( Parameter_Integer, 0 ),   --  : houshe1 (Integer)
           186 => ( Parameter_Integer, 0 ),   --  : houshew (Integer)
           187 => ( Parameter_Integer, 0 ),   --  : intntnt1 (Integer)
           188 => ( Parameter_Integer, 0 ),   --  : intntnt2 (Integer)
           189 => ( Parameter_Integer, 0 ),   --  : intntnt3 (Integer)
           190 => ( Parameter_Integer, 0 ),   --  : intntnt4 (Integer)
           191 => ( Parameter_Integer, 0 ),   --  : intntnt5 (Integer)
           192 => ( Parameter_Integer, 0 ),   --  : intntnt6 (Integer)
           193 => ( Parameter_Integer, 0 ),   --  : intntnt7 (Integer)
           194 => ( Parameter_Integer, 0 ),   --  : intntnt8 (Integer)
           195 => ( Parameter_Integer, 0 ),   --  : intrnet (Integer)
           196 => ( Parameter_Integer, 0 ),   --  : issue (Integer)
           197 => ( Parameter_Integer, 0 ),   --  : kidinc (Integer)
           198 => ( Parameter_Integer, 0 ),   --  : meal (Integer)
           199 => ( Parameter_Integer, 0 ),   --  : mealnt1 (Integer)
           200 => ( Parameter_Integer, 0 ),   --  : mealnt2 (Integer)
           201 => ( Parameter_Integer, 0 ),   --  : mealnt3 (Integer)
           202 => ( Parameter_Integer, 0 ),   --  : mealnt4 (Integer)
           203 => ( Parameter_Integer, 0 ),   --  : mealnt5 (Integer)
           204 => ( Parameter_Integer, 0 ),   --  : mealnt6 (Integer)
           205 => ( Parameter_Integer, 0 ),   --  : mealnt7 (Integer)
           206 => ( Parameter_Integer, 0 ),   --  : mealnt8 (Integer)
           207 => ( Parameter_Integer, 0 ),   --  : mealnt9 (Integer)
           208 => ( Parameter_Integer, 0 ),   --  : nhhchild (Integer)
           209 => ( Parameter_Integer, 0 ),   --  : noise (Integer)
           210 => ( Parameter_Integer, 0 ),   --  : oabill (Integer)
           211 => ( Parameter_Integer, 0 ),   --  : oacareu1 (Integer)
           212 => ( Parameter_Integer, 0 ),   --  : oacareu2 (Integer)
           213 => ( Parameter_Integer, 0 ),   --  : oacareu3 (Integer)
           214 => ( Parameter_Integer, 0 ),   --  : oacareu4 (Integer)
           215 => ( Parameter_Integer, 0 ),   --  : oacareu5 (Integer)
           216 => ( Parameter_Integer, 0 ),   --  : oacareu6 (Integer)
           217 => ( Parameter_Integer, 0 ),   --  : oacareu7 (Integer)
           218 => ( Parameter_Integer, 0 ),   --  : oacareu8 (Integer)
           219 => ( Parameter_Integer, 0 ),   --  : oacoat (Integer)
           220 => ( Parameter_Integer, 0 ),   --  : oacook (Integer)
           221 => ( Parameter_Integer, 0 ),   --  : oadamp (Integer)
           222 => ( Parameter_Integer, 0 ),   --  : oadep2 (Integer)
           223 => ( Parameter_Integer, 0 ),   --  : oadp2nt1 (Integer)
           224 => ( Parameter_Integer, 0 ),   --  : oadp2nt2 (Integer)
           225 => ( Parameter_Integer, 0 ),   --  : oadp2nt3 (Integer)
           226 => ( Parameter_Integer, 0 ),   --  : oadp2nt4 (Integer)
           227 => ( Parameter_Integer, 0 ),   --  : oadp2nt5 (Integer)
           228 => ( Parameter_Integer, 0 ),   --  : oadp2nt6 (Integer)
           229 => ( Parameter_Integer, 0 ),   --  : oadp2nt7 (Integer)
           230 => ( Parameter_Integer, 0 ),   --  : oadp2nt8 (Integer)
           231 => ( Parameter_Integer, 0 ),   --  : oaexpns (Integer)
           232 => ( Parameter_Integer, 0 ),   --  : oafrnd (Integer)
           233 => ( Parameter_Integer, 0 ),   --  : oafur (Integer)
           234 => ( Parameter_Integer, 0 ),   --  : oahair (Integer)
           235 => ( Parameter_Integer, 0 ),   --  : oaheat (Integer)
           236 => ( Parameter_Integer, 0 ),   --  : oahol (Integer)
           237 => ( Parameter_Integer, 0 ),   --  : oahome (Integer)
           238 => ( Parameter_Integer, 0 ),   --  : oahowpy1 (Integer)
           239 => ( Parameter_Integer, 0 ),   --  : oahowpy2 (Integer)
           240 => ( Parameter_Integer, 0 ),   --  : oahowpy3 (Integer)
           241 => ( Parameter_Integer, 0 ),   --  : oahowpy4 (Integer)
           242 => ( Parameter_Integer, 0 ),   --  : oahowpy5 (Integer)
           243 => ( Parameter_Integer, 0 ),   --  : oahowpy6 (Integer)
           244 => ( Parameter_Integer, 0 ),   --  : oaintern (Integer)
           245 => ( Parameter_Integer, 0 ),   --  : oameal (Integer)
           246 => ( Parameter_Integer, 0 ),   --  : oaout (Integer)
           247 => ( Parameter_Integer, 0 ),   --  : oaphon (Integer)
           248 => ( Parameter_Integer, 0 ),   --  : oapre (Integer)
           249 => ( Parameter_Integer, 0 ),   --  : oataxi (Integer)
           250 => ( Parameter_Integer, 0 ),   --  : oataxieu (Integer)
           251 => ( Parameter_Integer, 0 ),   --  : oatelep1 (Integer)
           252 => ( Parameter_Integer, 0 ),   --  : oatelep2 (Integer)
           253 => ( Parameter_Integer, 0 ),   --  : oatelep3 (Integer)
           254 => ( Parameter_Integer, 0 ),   --  : oatelep4 (Integer)
           255 => ( Parameter_Integer, 0 ),   --  : oatelep5 (Integer)
           256 => ( Parameter_Integer, 0 ),   --  : oatelep6 (Integer)
           257 => ( Parameter_Integer, 0 ),   --  : oatelep7 (Integer)
           258 => ( Parameter_Integer, 0 ),   --  : oatelep8 (Integer)
           259 => ( Parameter_Integer, 0 ),   --  : oateleph (Integer)
           260 => ( Parameter_Integer, 0 ),   --  : oawarm (Integer)
           261 => ( Parameter_Integer, 0 ),   --  : outnt1 (Integer)
           262 => ( Parameter_Integer, 0 ),   --  : outnt2 (Integer)
           263 => ( Parameter_Integer, 0 ),   --  : outnt3 (Integer)
           264 => ( Parameter_Integer, 0 ),   --  : outnt4 (Integer)
           265 => ( Parameter_Integer, 0 ),   --  : outnt5 (Integer)
           266 => ( Parameter_Integer, 0 ),   --  : outnt6 (Integer)
           267 => ( Parameter_Integer, 0 ),   --  : outnt7 (Integer)
           268 => ( Parameter_Integer, 0 ),   --  : outnt8 (Integer)
           269 => ( Parameter_Integer, 0 ),   --  : outnt9 (Integer)
           270 => ( Parameter_Integer, 0 ),   --  : outpay (Integer)
           271 => ( Parameter_Float, 0.0 ),   --  : outpyamt (Amount)
           272 => ( Parameter_Integer, 0 ),   --  : phonnt1 (Integer)
           273 => ( Parameter_Integer, 0 ),   --  : phonnt2 (Integer)
           274 => ( Parameter_Integer, 0 ),   --  : phonnt3 (Integer)
           275 => ( Parameter_Integer, 0 ),   --  : phonnt4 (Integer)
           276 => ( Parameter_Integer, 0 ),   --  : phonnt5 (Integer)
           277 => ( Parameter_Integer, 0 ),   --  : phonnt6 (Integer)
           278 => ( Parameter_Integer, 0 ),   --  : phonnt7 (Integer)
           279 => ( Parameter_Integer, 0 ),   --  : phonnt8 (Integer)
           280 => ( Parameter_Integer, 0 ),   --  : phonnt9 (Integer)
           281 => ( Parameter_Integer, 0 ),   --  : pollute (Integer)
           282 => ( Parameter_Float, 0.0 ),   --  : regpamt (Amount)
           283 => ( Parameter_Integer, 0 ),   --  : regularp (Integer)
           284 => ( Parameter_Integer, 0 ),   --  : repaybur (Integer)
           285 => ( Parameter_Integer, 0 ),   --  : shoe (Integer)
           286 => ( Parameter_Integer, 0 ),   --  : shoent1 (Integer)
           287 => ( Parameter_Integer, 0 ),   --  : shoent2 (Integer)
           288 => ( Parameter_Integer, 0 ),   --  : shoent3 (Integer)
           289 => ( Parameter_Integer, 0 ),   --  : shoent4 (Integer)
           290 => ( Parameter_Integer, 0 ),   --  : shoent5 (Integer)
           291 => ( Parameter_Integer, 0 ),   --  : shoent6 (Integer)
           292 => ( Parameter_Integer, 0 ),   --  : shoent7 (Integer)
           293 => ( Parameter_Integer, 0 ),   --  : shoent8 (Integer)
           294 => ( Parameter_Integer, 0 ),   --  : shoeoa (Integer)
           295 => ( Parameter_Integer, 0 ),   --  : taxint1 (Integer)
           296 => ( Parameter_Integer, 0 ),   --  : taxint2 (Integer)
           297 => ( Parameter_Integer, 0 ),   --  : taxint3 (Integer)
           298 => ( Parameter_Integer, 0 ),   --  : taxint4 (Integer)
           299 => ( Parameter_Integer, 0 ),   --  : taxint5 (Integer)
           300 => ( Parameter_Integer, 0 ),   --  : taxint6 (Integer)
           301 => ( Parameter_Integer, 0 ),   --  : taxint7 (Integer)
           302 => ( Parameter_Integer, 0 ),   --  : taxint8 (Integer)
           303 => ( Parameter_Integer, 0 ),   --  : taxint9 (Integer)
           304 => ( Parameter_Integer, 0 ),   --  : totsav (Integer)
           305 => ( Parameter_Integer, 0 ),   --  : warmnt1 (Integer)
           306 => ( Parameter_Integer, 0 ),   --  : warmnt2 (Integer)
           307 => ( Parameter_Integer, 0 ),   --  : warmnt3 (Integer)
           308 => ( Parameter_Integer, 0 ),   --  : warmnt4 (Integer)
           309 => ( Parameter_Integer, 0 ),   --  : warmnt5 (Integer)
           310 => ( Parameter_Integer, 0 ),   --  : warmnt6 (Integer)
           311 => ( Parameter_Integer, 0 ),   --  : warmnt7 (Integer)
           312 => ( Parameter_Integer, 0 ),   --  : warmnt8 (Integer)
           313 => ( Parameter_Integer, 0 ),   --  : warmnt9 (Integer)
           314 => ( Parameter_Integer, 0 ),   --  : washmach (Integer)
           315 => ( Parameter_Integer, 0 ),   --  : washwhy (Integer)
           316 => ( Parameter_Integer, 0 ),   --  : whodepq (Integer)
           317 => ( Parameter_Integer, 0 ),   --  : month (Integer)
           318 => ( Parameter_Integer, 0 ),   --  : adultb (Integer)
           319 => ( Parameter_Float, 0.0 ),   --  : boarder (Amount)
           320 => ( Parameter_Float, 0.0 ),   --  : bpeninc (Amount)
           321 => ( Parameter_Float, 0.0 ),   --  : bseinc (Amount)
           322 => ( Parameter_Integer, 0 ),   --  : buagegr2 (Integer)
           323 => ( Parameter_Integer, 0 ),   --  : buagegr3 (Integer)
           324 => ( Parameter_Integer, 0 ),   --  : buagegr4 (Integer)
           325 => ( Parameter_Integer, 0 ),   --  : buagegrp (Integer)
           326 => ( Parameter_Integer, 0 ),   --  : budisben (Integer)
           327 => ( Parameter_Float, 0.0 ),   --  : buearns (Amount)
           328 => ( Parameter_Integer, 0 ),   --  : buethgr3 (Integer)
           329 => ( Parameter_Integer, 0 ),   --  : buinc (Integer)
           330 => ( Parameter_Float, 0.0 ),   --  : buinv (Amount)
           331 => ( Parameter_Integer, 0 ),   --  : buirben (Integer)
           332 => ( Parameter_Integer, 0 ),   --  : bukids (Integer)
           333 => ( Parameter_Integer, 0 ),   --  : bunirben (Integer)
           334 => ( Parameter_Integer, 0 ),   --  : buothben (Integer)
           335 => ( Parameter_Integer, 0 ),   --  : burent (Integer)
           336 => ( Parameter_Float, 0.0 ),   --  : burinc (Amount)
           337 => ( Parameter_Float, 0.0 ),   --  : burpinc (Amount)
           338 => ( Parameter_Float, 0.0 ),   --  : butvlic (Amount)
           339 => ( Parameter_Float, 0.0 ),   --  : butxcred (Amount)
           340 => ( Parameter_Integer, 0 ),   --  : depchldb (Integer)
           341 => ( Parameter_Integer, 0 ),   --  : discbua1 (Integer)
           342 => ( Parameter_Integer, 0 ),   --  : discbuc1 (Integer)
           343 => ( Parameter_Integer, 0 ),   --  : diswbua1 (Integer)
           344 => ( Parameter_Integer, 0 ),   --  : diswbuc1 (Integer)
           345 => ( Parameter_Integer, 0 ),   --  : ecostabu (Integer)
           346 => ( Parameter_Integer, 0 ),   --  : ecstatbu (Integer)
           347 => ( Parameter_Integer, 0 ),   --  : famtypb2 (Integer)
           348 => ( Parameter_Integer, 0 ),   --  : famtypbs (Integer)
           349 => ( Parameter_Integer, 0 ),   --  : famtypbu (Integer)
           350 => ( Parameter_Float, 0.0 ),   --  : fsbbu (Amount)
           351 => ( Parameter_Float, 0.0 ),   --  : fsfvbu (Amount)
           352 => ( Parameter_Float, 0.0 ),   --  : fsmbu (Amount)
           353 => ( Parameter_Float, 0.0 ),   --  : fsmlkbu (Amount)
           354 => ( Parameter_Integer, 0 ),   --  : gross4 (Integer)
           355 => ( Parameter_Integer, 0 ),   --  : hbindbu (Integer)
           356 => ( Parameter_Integer, 0 ),   --  : hbindbu2 (Integer)
           357 => ( Parameter_Float, 0.0 ),   --  : heartbu (Amount)
           358 => ( Parameter_Integer, 0 ),   --  : kid04 (Integer)
           359 => ( Parameter_Integer, 0 ),   --  : kid1115 (Integer)
           360 => ( Parameter_Integer, 0 ),   --  : kid1619 (Integer)
           361 => ( Parameter_Integer, 0 ),   --  : kid510 (Integer)
           362 => ( Parameter_Float, 0.0 ),   --  : lodger (Amount)
           363 => ( Parameter_Integer, 0 ),   --  : nbunirbn (Integer)
           364 => ( Parameter_Integer, 0 ),   --  : nbuothbn (Integer)
           365 => ( Parameter_Integer, 0 ),   --  : newfamb2 (Integer)
           366 => ( Parameter_Integer, 0 ),   --  : newfambu (Integer)
           367 => ( Parameter_Float, 0.0 ),   --  : subltamt (Amount)
           368 => ( Parameter_Float, 0.0 ),   --  : totcapb3 (Amount)
           369 => ( Parameter_Integer, 0 ),   --  : totsavbu (Integer)
           370 => ( Parameter_Float, 0.0 ),   --  : tuburent (Amount)
           371 => ( Parameter_Integer, 0 ),   --  : youngch (Integer)
           372 => ( Parameter_Integer, 0 ),   --  : debt13 (Integer)
           373 => ( Parameter_Integer, 0 ),   --  : debtar13 (Integer)
           374 => ( Parameter_Integer, 0 ),   --  : euchbook (Integer)
           375 => ( Parameter_Integer, 0 ),   --  : euchclth (Integer)
           376 => ( Parameter_Integer, 0 ),   --  : euchgame (Integer)
           377 => ( Parameter_Integer, 0 ),   --  : euchmeat (Integer)
           378 => ( Parameter_Integer, 0 ),   --  : euchshoe (Integer)
           379 => ( Parameter_Integer, 0 ),   --  : eupbtran (Integer)
           380 => ( Parameter_Integer, 0 ),   --  : eupbtrn1 (Integer)
           381 => ( Parameter_Integer, 0 ),   --  : eupbtrn2 (Integer)
           382 => ( Parameter_Integer, 0 ),   --  : eupbtrn3 (Integer)
           383 => ( Parameter_Integer, 0 ),   --  : eupbtrn4 (Integer)
           384 => ( Parameter_Integer, 0 ),   --  : eupbtrn5 (Integer)
           385 => ( Parameter_Integer, 0 ),   --  : euroast (Integer)
           386 => ( Parameter_Integer, 0 ),   --  : eusmeal (Integer)
           387 => ( Parameter_Integer, 0 ),   --  : eustudy (Integer)
           388 => ( Parameter_Integer, 0 ),   --  : bueth (Integer)
           389 => ( Parameter_Integer, 0 ),   --  : oaeusmea (Integer)
           390 => ( Parameter_Integer, 0 ),   --  : oaholb (Integer)
           391 => ( Parameter_Integer, 0 ),   --  : oaroast (Integer)
           392 => ( Parameter_Integer, 0 ),   --  : ecostab2 (Integer)
           393 => ( Parameter_Integer, 0 ),   --  : incchnge (Integer)
           394 => ( Parameter_Integer, 0 ),   --  : inchilow (Integer)
           395 => ( Parameter_Integer, 0 ),   --  : actaccb (Integer)
           396 => ( Parameter_Integer, 0 ),   --  : adddabu (Integer)
           397 => ( Parameter_Integer, 0 ),   --  : basactb (Integer)
           398 => ( Parameter_Integer, 0 ),   --  : buethgr2 (Integer)
           399 => ( Parameter_Integer, 0 ),   --  : buethgrp (Integer)
           400 => ( Parameter_Integer, 0 ),   --  : chddabu (Integer)
           401 => ( Parameter_Integer, 0 ),   --  : curactb (Integer)
           402 => ( Parameter_Integer, 0 ),   --  : depdeds (Integer)
           403 => ( Parameter_Integer, 0 ),   --  : disindhb (Integer)
           404 => ( Parameter_Integer, 0 ),   --  : ecotypbu (Integer)
           405 => ( Parameter_Integer, 0 ),   --  : famthbai (Integer)
           406 => ( Parameter_Integer, 0 ),   --  : famtype (Integer)
           407 => ( Parameter_Integer, 0 ),   --  : fsbndctb (Integer)
           408 => ( Parameter_Float, 0.0 ),   --  : fwmlkbu (Amount)
           409 => ( Parameter_Integer, 0 ),   --  : gebactb (Integer)
           410 => ( Parameter_Integer, 0 ),   --  : giltctb (Integer)
           411 => ( Parameter_Integer, 0 ),   --  : gross2 (Integer)
           412 => ( Parameter_Integer, 0 ),   --  : gross3 (Integer)
           413 => ( Parameter_Integer, 0 ),   --  : isactb (Integer)
           414 => ( Parameter_Integer, 0 ),   --  : kid1618 (Integer)
           415 => ( Parameter_Integer, 0 ),   --  : kidsbu0 (Integer)
           416 => ( Parameter_Integer, 0 ),   --  : kidsbu1 (Integer)
           417 => ( Parameter_Integer, 0 ),   --  : kidsbu10 (Integer)
           418 => ( Parameter_Integer, 0 ),   --  : kidsbu11 (Integer)
           419 => ( Parameter_Integer, 0 ),   --  : kidsbu12 (Integer)
           420 => ( Parameter_Integer, 0 ),   --  : kidsbu13 (Integer)
           421 => ( Parameter_Integer, 0 ),   --  : kidsbu14 (Integer)
           422 => ( Parameter_Integer, 0 ),   --  : kidsbu15 (Integer)
           423 => ( Parameter_Integer, 0 ),   --  : kidsbu16 (Integer)
           424 => ( Parameter_Integer, 0 ),   --  : kidsbu17 (Integer)
           425 => ( Parameter_Integer, 0 ),   --  : kidsbu18 (Integer)
           426 => ( Parameter_Integer, 0 ),   --  : kidsbu2 (Integer)
           427 => ( Parameter_Integer, 0 ),   --  : kidsbu3 (Integer)
           428 => ( Parameter_Integer, 0 ),   --  : kidsbu4 (Integer)
           429 => ( Parameter_Integer, 0 ),   --  : kidsbu5 (Integer)
           430 => ( Parameter_Integer, 0 ),   --  : kidsbu6 (Integer)
           431 => ( Parameter_Integer, 0 ),   --  : kidsbu7 (Integer)
           432 => ( Parameter_Integer, 0 ),   --  : kidsbu8 (Integer)
           433 => ( Parameter_Integer, 0 ),   --  : kidsbu9 (Integer)
           434 => ( Parameter_Integer, 0 ),   --  : lastwork (Integer)
           435 => ( Parameter_Integer, 0 ),   --  : nsboctb (Integer)
           436 => ( Parameter_Integer, 0 ),   --  : otbsctb (Integer)
           437 => ( Parameter_Integer, 0 ),   --  : pepsctb (Integer)
           438 => ( Parameter_Integer, 0 ),   --  : poacctb (Integer)
           439 => ( Parameter_Integer, 0 ),   --  : prboctb (Integer)
           440 => ( Parameter_Integer, 0 ),   --  : sayectb (Integer)
           441 => ( Parameter_Integer, 0 ),   --  : sclbctb (Integer)
           442 => ( Parameter_Integer, 0 ),   --  : ssctb (Integer)
           443 => ( Parameter_Integer, 0 ),   --  : stshctb (Integer)
           444 => ( Parameter_Integer, 0 ),   --  : tessctb (Integer)
           445 => ( Parameter_Float, 0.0 ),   --  : totcapbu (Amount)
           446 => ( Parameter_Integer, 0 ),   --  : untrctb (Integer)
           447 => ( Parameter_Integer, 0 ),   --  : addeples (Integer)
           448 => ( Parameter_Integer, 0 ),   --  : addmel (Integer)
           449 => ( Parameter_Integer, 0 ),   --  : addshoe (Integer)
           450 => ( Parameter_Integer, 0 ),   --  : cdepsum (Integer)
           451 => ( Parameter_Integer, 0 ),   --  : debt1 (Integer)
           452 => ( Parameter_Integer, 0 ),   --  : debt2 (Integer)
           453 => ( Parameter_Integer, 0 ),   --  : debt3 (Integer)
           454 => ( Parameter_Integer, 0 ),   --  : debt4 (Integer)
           455 => ( Parameter_Integer, 0 ),   --  : debt5 (Integer)
           456 => ( Parameter_Integer, 0 ),   --  : debt6 (Integer)
           457 => ( Parameter_Integer, 0 ),   --  : debt7 (Integer)
           458 => ( Parameter_Integer, 0 ),   --  : debt8 (Integer)
           459 => ( Parameter_Integer, 0 ),   --  : debt9 (Integer)
           460 => ( Parameter_Integer, 0 ),   --  : incold (Integer)
           461 => ( Parameter_Integer, 0 ),   --  : crunacb (Integer)
           462 => ( Parameter_Integer, 0 ),   --  : enomortb (Integer)
           463 => ( Parameter_Integer, 0 ),   --  : pocardb (Integer)
           464 => ( Parameter_Float, 0.0 ),   --  : totcapb2 (Amount)
           465 => ( Parameter_Integer, 0 ),   --  : cbaamt1 (Integer)
           466 => ( Parameter_Integer, 0 ),   --  : cbaamt2 (Integer)
           467 => ( Parameter_Integer, 0 ),   --  : helpgv01 (Integer)
           468 => ( Parameter_Integer, 0 ),   --  : helpgv02 (Integer)
           469 => ( Parameter_Integer, 0 ),   --  : helpgv03 (Integer)
           470 => ( Parameter_Integer, 0 ),   --  : helpgv04 (Integer)
           471 => ( Parameter_Integer, 0 ),   --  : helpgv05 (Integer)
           472 => ( Parameter_Integer, 0 ),   --  : helpgv06 (Integer)
           473 => ( Parameter_Integer, 0 ),   --  : helpgv07 (Integer)
           474 => ( Parameter_Integer, 0 ),   --  : helpgv08 (Integer)
           475 => ( Parameter_Integer, 0 ),   --  : helpgv09 (Integer)
           476 => ( Parameter_Integer, 0 ),   --  : helpgv10 (Integer)
           477 => ( Parameter_Integer, 0 ),   --  : helpgv11 (Integer)
           478 => ( Parameter_Integer, 0 ),   --  : helprc01 (Integer)
           479 => ( Parameter_Integer, 0 ),   --  : helprc02 (Integer)
           480 => ( Parameter_Integer, 0 ),   --  : helprc03 (Integer)
           481 => ( Parameter_Integer, 0 ),   --  : helprc04 (Integer)
           482 => ( Parameter_Integer, 0 ),   --  : helprc05 (Integer)
           483 => ( Parameter_Integer, 0 ),   --  : helprc06 (Integer)
           484 => ( Parameter_Integer, 0 ),   --  : helprc07 (Integer)
           485 => ( Parameter_Integer, 0 ),   --  : helprc08 (Integer)
           486 => ( Parameter_Integer, 0 ),   --  : helprc09 (Integer)
           487 => ( Parameter_Integer, 0 ),   --  : helprc10 (Integer)
           488 => ( Parameter_Integer, 0 ),   --  : helprc11 (Integer)
           489 => ( Parameter_Integer, 0 ),   --  : loangvn1 (Integer)
           490 => ( Parameter_Integer, 0 ),   --  : loangvn2 (Integer)
           491 => ( Parameter_Integer, 0 ),   --  : loangvn3 (Integer)
           492 => ( Parameter_Integer, 0 ),   --  : loanrec1 (Integer)
           493 => ( Parameter_Integer, 0 ),   --  : loanrec2 (Integer)
           494 => ( Parameter_Integer, 0 ),   --  : loanrec3 (Integer)
           495 => ( Parameter_Integer, 0 ),   --  : gross3_x (Integer)
           496 => ( Parameter_Integer, 0 ),   --  : oabilimp (Integer)
           497 => ( Parameter_Integer, 0 ),   --  : oacoaimp (Integer)
           498 => ( Parameter_Integer, 0 ),   --  : oacooimp (Integer)
           499 => ( Parameter_Integer, 0 ),   --  : oadamimp (Integer)
           500 => ( Parameter_Integer, 0 ),   --  : oaexpimp (Integer)
           501 => ( Parameter_Integer, 0 ),   --  : oafrnimp (Integer)
           502 => ( Parameter_Integer, 0 ),   --  : oahaiimp (Integer)
           503 => ( Parameter_Integer, 0 ),   --  : oaheaimp (Integer)
           504 => ( Parameter_Integer, 0 ),   --  : oaholimp (Integer)
           505 => ( Parameter_Integer, 0 ),   --  : oahomimp (Integer)
           506 => ( Parameter_Integer, 0 ),   --  : oameaimp (Integer)
           507 => ( Parameter_Integer, 0 ),   --  : oaoutimp (Integer)
           508 => ( Parameter_Integer, 0 ),   --  : oaphoimp (Integer)
           509 => ( Parameter_Integer, 0 ),   --  : oataximp (Integer)
           510 => ( Parameter_Integer, 0 )   --  : oawarimp (Integer)
   ...
   function Get_Prepared_Update_Statement return gse.Prepared_Statement is 
      ...
      query : constant String := DB_Commons.Add_Schema_To_Query( UPDATE_PART, SCHEMA_NAME ) & " adbtbl = $1, adddec = $2, addhol = $3, addholr = $4, addins = $5, addmon = $6, adepfur = $7, adles = $8, adlesnt1 = $9, adlesnt2 = $10, adlesnt3 = $11, adlesnt4 = $12, adlesnt5 = $13, adlesnt6 = $14, adlesnt7 = $15, adlesnt8 = $16, adlesoa = $17, af1 = $18, afdep2 = $19, billnt1 = $20, billnt2 = $21, billnt3 = $22, billnt4 = $23, billnt5 = $24, billnt6 = $25, billnt7 = $26, billnt8 = $27, billnt9 = $28, cdelply = $29, cdepact = $30, cdepbed = $31, cdepcel = $32, cdepeqp = $33, cdephol = $34, cdeples = $35, cdeptea = $36, cdeptrp = $37, cdepveg = $38, cdpcoat = $39, clothes = $40, clothnt1 = $41, clothnt2 = $42, clothnt3 = $43, clothnt4 = $44, clothnt5 = $45, clothnt6 = $46, clothnt7 = $47, clothnt8 = $48, clothsoa = $49, coatnt1 = $50, coatnt2 = $51, coatnt3 = $52, coatnt4 = $53, coatnt5 = $54, coatnt6 = $55, coatnt7 = $56, coatnt8 = $57, coatnt9 = $58, computer = $59, compuwhy = $60, cooknt1 = $61, cooknt2 = $62, cooknt3 = $63, cooknt4 = $64, cooknt5 = $65, cooknt6 = $66, cooknt7 = $67, cooknt8 = $68, cooknt9 = $69, cplay = $70, crime = $71, damp = $72, dampnt1 = $73, dampnt2 = $74, dampnt3 = $75, dampnt4 = $76, dampnt5 = $77, dampnt6 = $78, dampnt7 = $79, dampnt8 = $80, dampnt9 = $81, dark = $82, debt01 = $83, debt02 = $84, debt03 = $85, debt04 = $86, debt05 = $87, debt06 = $88, debt07 = $89, debt08 = $90, debt09 = $91, debt10 = $92, debt11 = $93, debt12 = $94, debtar01 = $95, debtar02 = $96, debtar03 = $97, debtar04 = $98, debtar05 = $99, debtar06 = $100, debtar07 = $101, debtar08 = $102, debtar09 = $103, debtar10 = $104, debtar11 = $105, debtar12 = $106, debtfre1 = $107, debtfre2 = $108, debtfre3 = $109, endsmeet = $110, eucar = $111, eucarwhy = $112, euexpns = $113, eumeal = $114, eurepay = $115, euteleph = $116, eutelwhy = $117, expnsoa = $118, frndnt1 = $119, frndnt2 = $120, frndnt3 = $121, frndnt4 = $122, frndnt5 = $123, frndnt6 = $124, frndnt7 = $125, frndnt8 = $126, frndnt9 = $127, furnt1 = $128, furnt2 = $129, furnt3 = $130, furnt4 = $131, furnt5 = $132, furnt6 = $133, furnt7 = $134, furnt8 = $135, hairnt1 = $136, hairnt2 = $137, hairnt3 = $138, hairnt4 = $139, hairnt5 = $140, hairnt6 = $141, hairnt7 = $142, hairnt8 = $143, hairnt9 = $144, hbolng = $145, hbothamt = $146, hbothbu = $147, hbothmn = $148, hbothpd = $149, hbothwk = $150, hbothyr = $151, hbotwait = $152, heatnt1 = $153, heatnt2 = $154, heatnt3 = $155, heatnt4 = $156, heatnt5 = $157, heatnt6 = $158, heatnt7 = $159, heatnt8 = $160, heatnt9 = $161, holnt1 = $162, holnt2 = $163, holnt3 = $164, holnt4 = $165, holnt5 = $166, holnt6 = $167, holnt7 = $168, holnt8 = $169, holnt9 = $170, homent1 = $171, homent2 = $172, homent3 = $173, homent4 = $174, homent5 = $175, homent6 = $176, homent7 = $177, homent8 = $178, homent9 = $179, houshe1 = $180, houshew = $181, intntnt1 = $182, intntnt2 = $183, intntnt3 = $184, intntnt4 = $185, intntnt5 = $186, intntnt6 = $187, intntnt7 = $188, intntnt8 = $189, intrnet = $190, issue = $191, kidinc = $192, meal = $193, mealnt1 = $194, mealnt2 = $195, mealnt3 = $196, mealnt4 = $197, mealnt5 = $198, mealnt6 = $199, mealnt7 = $200, mealnt8 = $201, mealnt9 = $202, nhhchild = $203, noise = $204, oabill = $205, oacareu1 = $206, oacareu2 = $207, oacareu3 = $208, oacareu4 = $209, oacareu5 = $210, oacareu6 = $211, oacareu7 = $212, oacareu8 = $213, oacoat = $214, oacook = $215, oadamp = $216, oadep2 = $217, oadp2nt1 = $218, oadp2nt2 = $219, oadp2nt3 = $220, oadp2nt4 = $221, oadp2nt5 = $222, oadp2nt6 = $223, oadp2nt7 = $224, oadp2nt8 = $225, oaexpns = $226, oafrnd = $227, oafur = $228, oahair = $229, oaheat = $230, oahol = $231, oahome = $232, oahowpy1 = $233, oahowpy2 = $234, oahowpy3 = $235, oahowpy4 = $236, oahowpy5 = $237, oahowpy6 = $238, oaintern = $239, oameal = $240, oaout = $241, oaphon = $242, oapre = $243, oataxi = $244, oataxieu = $245, oatelep1 = $246, oatelep2 = $247, oatelep3 = $248, oatelep4 = $249, oatelep5 = $250, oatelep6 = $251, oatelep7 = $252, oatelep8 = $253, oateleph = $254, oawarm = $255, outnt1 = $256, outnt2 = $257, outnt3 = $258, outnt4 = $259, outnt5 = $260, outnt6 = $261, outnt7 = $262, outnt8 = $263, outnt9 = $264, outpay = $265, outpyamt = $266, phonnt1 = $267, phonnt2 = $268, phonnt3 = $269, phonnt4 = $270, phonnt5 = $271, phonnt6 = $272, phonnt7 = $273, phonnt8 = $274, phonnt9 = $275, pollute = $276, regpamt = $277, regularp = $278, repaybur = $279, shoe = $280, shoent1 = $281, shoent2 = $282, shoent3 = $283, shoent4 = $284, shoent5 = $285, shoent6 = $286, shoent7 = $287, shoent8 = $288, shoeoa = $289, taxint1 = $290, taxint2 = $291, taxint3 = $292, taxint4 = $293, taxint5 = $294, taxint6 = $295, taxint7 = $296, taxint8 = $297, taxint9 = $298, totsav = $299, warmnt1 = $300, warmnt2 = $301, warmnt3 = $302, warmnt4 = $303, warmnt5 = $304, warmnt6 = $305, warmnt7 = $306, warmnt8 = $307, warmnt9 = $308, washmach = $309, washwhy = $310, whodepq = $311, month = $312, adultb = $313, boarder = $314, bpeninc = $315, bseinc = $316, buagegr2 = $317, buagegr3 = $318, buagegr4 = $319, buagegrp = $320, budisben = $321, buearns = $322, buethgr3 = $323, buinc = $324, buinv = $325, buirben = $326, bukids = $327, bunirben = $328, buothben = $329, burent = $330, burinc = $331, burpinc = $332, butvlic = $333, butxcred = $334, depchldb = $335, discbua1 = $336, discbuc1 = $337, diswbua1 = $338, diswbuc1 = $339, ecostabu = $340, ecstatbu = $341, famtypb2 = $342, famtypbs = $343, famtypbu = $344, fsbbu = $345, fsfvbu = $346, fsmbu = $347, fsmlkbu = $348, gross4 = $349, hbindbu = $350, hbindbu2 = $351, heartbu = $352, kid04 = $353, kid1115 = $354, kid1619 = $355, kid510 = $356, lodger = $357, nbunirbn = $358, nbuothbn = $359, newfamb2 = $360, newfambu = $361, subltamt = $362, totcapb3 = $363, totsavbu = $364, tuburent = $365, youngch = $366, debt13 = $367, debtar13 = $368, euchbook = $369, euchclth = $370, euchgame = $371, euchmeat = $372, euchshoe = $373, eupbtran = $374, eupbtrn1 = $375, eupbtrn2 = $376, eupbtrn3 = $377, eupbtrn4 = $378, eupbtrn5 = $379, euroast = $380, eusmeal = $381, eustudy = $382, bueth = $383, oaeusmea = $384, oaholb = $385, oaroast = $386, ecostab2 = $387, incchnge = $388, inchilow = $389, actaccb = $390, adddabu = $391, basactb = $392, buethgr2 = $393, buethgrp = $394, chddabu = $395, curactb = $396, depdeds = $397, disindhb = $398, ecotypbu = $399, famthbai = $400, famtype = $401, fsbndctb = $402, fwmlkbu = $403, gebactb = $404, giltctb = $405, gross2 = $406, gross3 = $407, isactb = $408, kid1618 = $409, kidsbu0 = $410, kidsbu1 = $411, kidsbu10 = $412, kidsbu11 = $413, kidsbu12 = $414, kidsbu13 = $415, kidsbu14 = $416, kidsbu15 = $417, kidsbu16 = $418, kidsbu17 = $419, kidsbu18 = $420, kidsbu2 = $421, kidsbu3 = $422, kidsbu4 = $423, kidsbu5 = $424, kidsbu6 = $425, kidsbu7 = $426, kidsbu8 = $427, kidsbu9 = $428, lastwork = $429, nsboctb = $430, otbsctb = $431, pepsctb = $432, poacctb = $433, prboctb = $434, sayectb = $435, sclbctb = $436, ssctb = $437, stshctb = $438, tessctb = $439, totcapbu = $440, untrctb = $441, addeples = $442, addmel = $443, addshoe = $444, cdepsum = $445, debt1 = $446, debt2 = $447, debt3 = $448, debt4 = $449, debt5 = $450, debt6 = $451, debt7 = $452, debt8 = $453, debt9 = $454, incold = $455, crunacb = $456, enomortb = $457, pocardb = $458, totcapb2 = $459, cbaamt1 = $460, cbaamt2 = $461, helpgv01 = $462, helpgv02 = $463, helpgv03 = $464, helpgv04 = $465, helpgv05 = $466, helpgv06 = $467, helpgv07 = $468, helpgv08 = $469, helpgv09 = $470, helpgv10 = $471, helpgv11 = $472, helprc01 = $473, helprc02 = $474, helprc03 = $475, helprc04 = $476, helprc05 = $477, helprc06 = $478, helprc07 = $479, helprc08 = $480, helprc09 = $481, helprc10 = $482, helprc11 = $483, loangvn1 = $484, loangvn2 = $485, loangvn3 = $486, loanrec1 = $487, loanrec2 = $488, loanrec3 = $489, gross3_x = $490, oabilimp = $491, oacoaimp = $492, oacooimp = $493, oadamimp = $494, oaexpimp = $495, oafrnimp = $496, oahaiimp = $497, oaheaimp = $498, oaholimp = $499, oahomimp = $500, oameaimp = $501, oaoutimp = $502, oaphoimp = $503, oataximp = $504, oawarimp = $505 where user_id = $506 and edition = $507 and year = $508 and sernum = $509 and benunit = $510"; 
   begin 
      ps := gse.Prepare( 
        query, 
        On_Server => True ); 
   ...
   begin
      ...
      if not gse.Is_Null( cursor, 5 )then
         a_benunit.adbtbl := gse.Integer_Value( cursor, 5 );
      end if;
      if not gse.Is_Null( cursor, 6 )then
         a_benunit.adddec := gse.Integer_Value( cursor, 6 );
      end if;
      if not gse.Is_Null( cursor, 7 )then
         a_benunit.addhol := gse.Integer_Value( cursor, 7 );
      end if;
      if not gse.Is_Null( cursor, 8 )then
         a_benunit.addholr := gse.Integer_Value( cursor, 8 );
      end if;
      if not gse.Is_Null( cursor, 9 )then
         a_benunit.addins := gse.Integer_Value( cursor, 9 );
      end if;
      if not gse.Is_Null( cursor, 10 )then
         a_benunit.addmon := gse.Integer_Value( cursor, 10 );
      end if;
      if not gse.Is_Null( cursor, 11 )then
         a_benunit.adepfur := gse.Integer_Value( cursor, 11 );
      end if;
      if not gse.Is_Null( cursor, 12 )then
         a_benunit.adles := gse.Integer_Value( cursor, 12 );
      end if;
      if not gse.Is_Null( cursor, 13 )then
         a_benunit.adlesnt1 := gse.Integer_Value( cursor, 13 );
      end if;
      if not gse.Is_Null( cursor, 14 )then
         a_benunit.adlesnt2 := gse.Integer_Value( cursor, 14 );
      end if;
      if not gse.Is_Null( cursor, 15 )then
         a_benunit.adlesnt3 := gse.Integer_Value( cursor, 15 );
      end if;
      if not gse.Is_Null( cursor, 16 )then
         a_benunit.adlesnt4 := gse.Integer_Value( cursor, 16 );
      end if;
      if not gse.Is_Null( cursor, 17 )then
         a_benunit.adlesnt5 := gse.Integer_Value( cursor, 17 );
      end if;
      if not gse.Is_Null( cursor, 18 )then
         a_benunit.adlesnt6 := gse.Integer_Value( cursor, 18 );
      end if;
      if not gse.Is_Null( cursor, 19 )then
         a_benunit.adlesnt7 := gse.Integer_Value( cursor, 19 );
      end if;
      if not gse.Is_Null( cursor, 20 )then
         a_benunit.adlesnt8 := gse.Integer_Value( cursor, 20 );
      end if;
      if not gse.Is_Null( cursor, 21 )then
         a_benunit.adlesoa := gse.Integer_Value( cursor, 21 );
      end if;
      if not gse.Is_Null( cursor, 22 )then
         a_benunit.af1 := gse.Integer_Value( cursor, 22 );
      end if;
      if not gse.Is_Null( cursor, 23 )then
         a_benunit.afdep2 := gse.Integer_Value( cursor, 23 );
      end if;
      if not gse.Is_Null( cursor, 24 )then
         a_benunit.billnt1 := gse.Integer_Value( cursor, 24 );
      end if;
      if not gse.Is_Null( cursor, 25 )then
         a_benunit.billnt2 := gse.Integer_Value( cursor, 25 );
      end if;
      if not gse.Is_Null( cursor, 26 )then
         a_benunit.billnt3 := gse.Integer_Value( cursor, 26 );
      end if;
      if not gse.Is_Null( cursor, 27 )then
         a_benunit.billnt4 := gse.Integer_Value( cursor, 27 );
      end if;
      if not gse.Is_Null( cursor, 28 )then
         a_benunit.billnt5 := gse.Integer_Value( cursor, 28 );
      end if;
      if not gse.Is_Null( cursor, 29 )then
         a_benunit.billnt6 := gse.Integer_Value( cursor, 29 );
      end if;
      if not gse.Is_Null( cursor, 30 )then
         a_benunit.billnt7 := gse.Integer_Value( cursor, 30 );
      end if;
      if not gse.Is_Null( cursor, 31 )then
         a_benunit.billnt8 := gse.Integer_Value( cursor, 31 );
      end if;
      if not gse.Is_Null( cursor, 32 )then
         a_benunit.billnt9 := gse.Integer_Value( cursor, 32 );
      end if;
      if not gse.Is_Null( cursor, 33 )then
         a_benunit.cdelply := gse.Integer_Value( cursor, 33 );
      end if;
      if not gse.Is_Null( cursor, 34 )then
         a_benunit.cdepact := gse.Integer_Value( cursor, 34 );
      end if;
      if not gse.Is_Null( cursor, 35 )then
         a_benunit.cdepbed := gse.Integer_Value( cursor, 35 );
      end if;
      if not gse.Is_Null( cursor, 36 )then
         a_benunit.cdepcel := gse.Integer_Value( cursor, 36 );
      end if;
      if not gse.Is_Null( cursor, 37 )then
         a_benunit.cdepeqp := gse.Integer_Value( cursor, 37 );
      end if;
      if not gse.Is_Null( cursor, 38 )then
         a_benunit.cdephol := gse.Integer_Value( cursor, 38 );
      end if;
      if not gse.Is_Null( cursor, 39 )then
         a_benunit.cdeples := gse.Integer_Value( cursor, 39 );
      end if;
      if not gse.Is_Null( cursor, 40 )then
         a_benunit.cdeptea := gse.Integer_Value( cursor, 40 );
      end if;
      if not gse.Is_Null( cursor, 41 )then
         a_benunit.cdeptrp := gse.Integer_Value( cursor, 41 );
      end if;
      if not gse.Is_Null( cursor, 42 )then
         a_benunit.cdepveg := gse.Integer_Value( cursor, 42 );
      end if;
      if not gse.Is_Null( cursor, 43 )then
         a_benunit.cdpcoat := gse.Integer_Value( cursor, 43 );
      end if;
      if not gse.Is_Null( cursor, 44 )then
         a_benunit.clothes := gse.Integer_Value( cursor, 44 );
      end if;
      if not gse.Is_Null( cursor, 45 )then
         a_benunit.clothnt1 := gse.Integer_Value( cursor, 45 );
      end if;
      if not gse.Is_Null( cursor, 46 )then
         a_benunit.clothnt2 := gse.Integer_Value( cursor, 46 );
      end if;
      if not gse.Is_Null( cursor, 47 )then
         a_benunit.clothnt3 := gse.Integer_Value( cursor, 47 );
      end if;
      if not gse.Is_Null( cursor, 48 )then
         a_benunit.clothnt4 := gse.Integer_Value( cursor, 48 );
      end if;
      if not gse.Is_Null( cursor, 49 )then
         a_benunit.clothnt5 := gse.Integer_Value( cursor, 49 );
      end if;
      if not gse.Is_Null( cursor, 50 )then
         a_benunit.clothnt6 := gse.Integer_Value( cursor, 50 );
      end if;
      if not gse.Is_Null( cursor, 51 )then
         a_benunit.clothnt7 := gse.Integer_Value( cursor, 51 );
      end if;
      if not gse.Is_Null( cursor, 52 )then
         a_benunit.clothnt8 := gse.Integer_Value( cursor, 52 );
      end if;
      if not gse.Is_Null( cursor, 53 )then
         a_benunit.clothsoa := gse.Integer_Value( cursor, 53 );
      end if;
      if not gse.Is_Null( cursor, 54 )then
         a_benunit.coatnt1 := gse.Integer_Value( cursor, 54 );
      end if;
      if not gse.Is_Null( cursor, 55 )then
         a_benunit.coatnt2 := gse.Integer_Value( cursor, 55 );
      end if;
      if not gse.Is_Null( cursor, 56 )then
         a_benunit.coatnt3 := gse.Integer_Value( cursor, 56 );
      end if;
      if not gse.Is_Null( cursor, 57 )then
         a_benunit.coatnt4 := gse.Integer_Value( cursor, 57 );
      end if;
      if not gse.Is_Null( cursor, 58 )then
         a_benunit.coatnt5 := gse.Integer_Value( cursor, 58 );
      end if;
      if not gse.Is_Null( cursor, 59 )then
         a_benunit.coatnt6 := gse.Integer_Value( cursor, 59 );
      end if;
      if not gse.Is_Null( cursor, 60 )then
         a_benunit.coatnt7 := gse.Integer_Value( cursor, 60 );
      end if;
      if not gse.Is_Null( cursor, 61 )then
         a_benunit.coatnt8 := gse.Integer_Value( cursor, 61 );
      end if;
      if not gse.Is_Null( cursor, 62 )then
         a_benunit.coatnt9 := gse.Integer_Value( cursor, 62 );
      end if;
      if not gse.Is_Null( cursor, 63 )then
         a_benunit.computer := gse.Integer_Value( cursor, 63 );
      end if;
      if not gse.Is_Null( cursor, 64 )then
         a_benunit.compuwhy := gse.Integer_Value( cursor, 64 );
      end if;
      if not gse.Is_Null( cursor, 65 )then
         a_benunit.cooknt1 := gse.Integer_Value( cursor, 65 );
      end if;
      if not gse.Is_Null( cursor, 66 )then
         a_benunit.cooknt2 := gse.Integer_Value( cursor, 66 );
      end if;
      if not gse.Is_Null( cursor, 67 )then
         a_benunit.cooknt3 := gse.Integer_Value( cursor, 67 );
      end if;
      if not gse.Is_Null( cursor, 68 )then
         a_benunit.cooknt4 := gse.Integer_Value( cursor, 68 );
      end if;
      if not gse.Is_Null( cursor, 69 )then
         a_benunit.cooknt5 := gse.Integer_Value( cursor, 69 );
      end if;
      if not gse.Is_Null( cursor, 70 )then
         a_benunit.cooknt6 := gse.Integer_Value( cursor, 70 );
      end if;
      if not gse.Is_Null( cursor, 71 )then
         a_benunit.cooknt7 := gse.Integer_Value( cursor, 71 );
      end if;
      if not gse.Is_Null( cursor, 72 )then
         a_benunit.cooknt8 := gse.Integer_Value( cursor, 72 );
      end if;
      if not gse.Is_Null( cursor, 73 )then
         a_benunit.cooknt9 := gse.Integer_Value( cursor, 73 );
      end if;
      if not gse.Is_Null( cursor, 74 )then
         a_benunit.cplay := gse.Integer_Value( cursor, 74 );
      end if;
      if not gse.Is_Null( cursor, 75 )then
         a_benunit.crime := gse.Integer_Value( cursor, 75 );
      end if;
      if not gse.Is_Null( cursor, 76 )then
         a_benunit.damp := gse.Integer_Value( cursor, 76 );
      end if;
      if not gse.Is_Null( cursor, 77 )then
         a_benunit.dampnt1 := gse.Integer_Value( cursor, 77 );
      end if;
      if not gse.Is_Null( cursor, 78 )then
         a_benunit.dampnt2 := gse.Integer_Value( cursor, 78 );
      end if;
      if not gse.Is_Null( cursor, 79 )then
         a_benunit.dampnt3 := gse.Integer_Value( cursor, 79 );
      end if;
      if not gse.Is_Null( cursor, 80 )then
         a_benunit.dampnt4 := gse.Integer_Value( cursor, 80 );
      end if;
      if not gse.Is_Null( cursor, 81 )then
         a_benunit.dampnt5 := gse.Integer_Value( cursor, 81 );
      end if;
      if not gse.Is_Null( cursor, 82 )then
         a_benunit.dampnt6 := gse.Integer_Value( cursor, 82 );
      end if;
      if not gse.Is_Null( cursor, 83 )then
         a_benunit.dampnt7 := gse.Integer_Value( cursor, 83 );
      end if;
      if not gse.Is_Null( cursor, 84 )then
         a_benunit.dampnt8 := gse.Integer_Value( cursor, 84 );
      end if;
      if not gse.Is_Null( cursor, 85 )then
         a_benunit.dampnt9 := gse.Integer_Value( cursor, 85 );
      end if;
      if not gse.Is_Null( cursor, 86 )then
         a_benunit.dark := gse.Integer_Value( cursor, 86 );
      end if;
      if not gse.Is_Null( cursor, 87 )then
         a_benunit.debt01 := gse.Integer_Value( cursor, 87 );
      end if;
      if not gse.Is_Null( cursor, 88 )then
         a_benunit.debt02 := gse.Integer_Value( cursor, 88 );
      end if;
      if not gse.Is_Null( cursor, 89 )then
         a_benunit.debt03 := gse.Integer_Value( cursor, 89 );
      end if;
      if not gse.Is_Null( cursor, 90 )then
         a_benunit.debt04 := gse.Integer_Value( cursor, 90 );
      end if;
      if not gse.Is_Null( cursor, 91 )then
         a_benunit.debt05 := gse.Integer_Value( cursor, 91 );
      end if;
      if not gse.Is_Null( cursor, 92 )then
         a_benunit.debt06 := gse.Integer_Value( cursor, 92 );
      end if;
      if not gse.Is_Null( cursor, 93 )then
         a_benunit.debt07 := gse.Integer_Value( cursor, 93 );
      end if;
      if not gse.Is_Null( cursor, 94 )then
         a_benunit.debt08 := gse.Integer_Value( cursor, 94 );
      end if;
      if not gse.Is_Null( cursor, 95 )then
         a_benunit.debt09 := gse.Integer_Value( cursor, 95 );
      end if;
      if not gse.Is_Null( cursor, 96 )then
         a_benunit.debt10 := gse.Integer_Value( cursor, 96 );
      end if;
      if not gse.Is_Null( cursor, 97 )then
         a_benunit.debt11 := gse.Integer_Value( cursor, 97 );
      end if;
      if not gse.Is_Null( cursor, 98 )then
         a_benunit.debt12 := gse.Integer_Value( cursor, 98 );
      end if;
      if not gse.Is_Null( cursor, 99 )then
         a_benunit.debtar01 := gse.Integer_Value( cursor, 99 );
      end if;
      if not gse.Is_Null( cursor, 100 )then
         a_benunit.debtar02 := gse.Integer_Value( cursor, 100 );
      end if;
      if not gse.Is_Null( cursor, 101 )then
         a_benunit.debtar03 := gse.Integer_Value( cursor, 101 );
      end if;
      if not gse.Is_Null( cursor, 102 )then
         a_benunit.debtar04 := gse.Integer_Value( cursor, 102 );
      end if;
      if not gse.Is_Null( cursor, 103 )then
         a_benunit.debtar05 := gse.Integer_Value( cursor, 103 );
      end if;
      if not gse.Is_Null( cursor, 104 )then
         a_benunit.debtar06 := gse.Integer_Value( cursor, 104 );
      end if;
      if not gse.Is_Null( cursor, 105 )then
         a_benunit.debtar07 := gse.Integer_Value( cursor, 105 );
      end if;
      if not gse.Is_Null( cursor, 106 )then
         a_benunit.debtar08 := gse.Integer_Value( cursor, 106 );
      end if;
      if not gse.Is_Null( cursor, 107 )then
         a_benunit.debtar09 := gse.Integer_Value( cursor, 107 );
      end if;
      if not gse.Is_Null( cursor, 108 )then
         a_benunit.debtar10 := gse.Integer_Value( cursor, 108 );
      end if;
      if not gse.Is_Null( cursor, 109 )then
         a_benunit.debtar11 := gse.Integer_Value( cursor, 109 );
      end if;
      if not gse.Is_Null( cursor, 110 )then
         a_benunit.debtar12 := gse.Integer_Value( cursor, 110 );
      end if;
      if not gse.Is_Null( cursor, 111 )then
         a_benunit.debtfre1 := gse.Integer_Value( cursor, 111 );
      end if;
      if not gse.Is_Null( cursor, 112 )then
         a_benunit.debtfre2 := gse.Integer_Value( cursor, 112 );
      end if;
      if not gse.Is_Null( cursor, 113 )then
         a_benunit.debtfre3 := gse.Integer_Value( cursor, 113 );
      end if;
      if not gse.Is_Null( cursor, 114 )then
         a_benunit.endsmeet := gse.Integer_Value( cursor, 114 );
      end if;
      if not gse.Is_Null( cursor, 115 )then
         a_benunit.eucar := gse.Integer_Value( cursor, 115 );
      end if;
      if not gse.Is_Null( cursor, 116 )then
         a_benunit.eucarwhy := gse.Integer_Value( cursor, 116 );
      end if;
      if not gse.Is_Null( cursor, 117 )then
         a_benunit.euexpns := gse.Integer_Value( cursor, 117 );
      end if;
      if not gse.Is_Null( cursor, 118 )then
         a_benunit.eumeal := gse.Integer_Value( cursor, 118 );
      end if;
      if not gse.Is_Null( cursor, 119 )then
         a_benunit.eurepay := gse.Integer_Value( cursor, 119 );
      end if;
      if not gse.Is_Null( cursor, 120 )then
         a_benunit.euteleph := gse.Integer_Value( cursor, 120 );
      end if;
      if not gse.Is_Null( cursor, 121 )then
         a_benunit.eutelwhy := gse.Integer_Value( cursor, 121 );
      end if;
      if not gse.Is_Null( cursor, 122 )then
         a_benunit.expnsoa := gse.Integer_Value( cursor, 122 );
      end if;
      if not gse.Is_Null( cursor, 123 )then
         a_benunit.frndnt1 := gse.Integer_Value( cursor, 123 );
      end if;
      if not gse.Is_Null( cursor, 124 )then
         a_benunit.frndnt2 := gse.Integer_Value( cursor, 124 );
      end if;
      if not gse.Is_Null( cursor, 125 )then
         a_benunit.frndnt3 := gse.Integer_Value( cursor, 125 );
      end if;
      if not gse.Is_Null( cursor, 126 )then
         a_benunit.frndnt4 := gse.Integer_Value( cursor, 126 );
      end if;
      if not gse.Is_Null( cursor, 127 )then
         a_benunit.frndnt5 := gse.Integer_Value( cursor, 127 );
      end if;
      if not gse.Is_Null( cursor, 128 )then
         a_benunit.frndnt6 := gse.Integer_Value( cursor, 128 );
      end if;
      if not gse.Is_Null( cursor, 129 )then
         a_benunit.frndnt7 := gse.Integer_Value( cursor, 129 );
      end if;
      if not gse.Is_Null( cursor, 130 )then
         a_benunit.frndnt8 := gse.Integer_Value( cursor, 130 );
      end if;
      if not gse.Is_Null( cursor, 131 )then
         a_benunit.frndnt9 := gse.Integer_Value( cursor, 131 );
      end if;
      if not gse.Is_Null( cursor, 132 )then
         a_benunit.furnt1 := gse.Integer_Value( cursor, 132 );
      end if;
      if not gse.Is_Null( cursor, 133 )then
         a_benunit.furnt2 := gse.Integer_Value( cursor, 133 );
      end if;
      if not gse.Is_Null( cursor, 134 )then
         a_benunit.furnt3 := gse.Integer_Value( cursor, 134 );
      end if;
      if not gse.Is_Null( cursor, 135 )then
         a_benunit.furnt4 := gse.Integer_Value( cursor, 135 );
      end if;
      if not gse.Is_Null( cursor, 136 )then
         a_benunit.furnt5 := gse.Integer_Value( cursor, 136 );
      end if;
      if not gse.Is_Null( cursor, 137 )then
         a_benunit.furnt6 := gse.Integer_Value( cursor, 137 );
      end if;
      if not gse.Is_Null( cursor, 138 )then
         a_benunit.furnt7 := gse.Integer_Value( cursor, 138 );
      end if;
      if not gse.Is_Null( cursor, 139 )then
         a_benunit.furnt8 := gse.Integer_Value( cursor, 139 );
      end if;
      if not gse.Is_Null( cursor, 140 )then
         a_benunit.hairnt1 := gse.Integer_Value( cursor, 140 );
      end if;
      if not gse.Is_Null( cursor, 141 )then
         a_benunit.hairnt2 := gse.Integer_Value( cursor, 141 );
      end if;
      if not gse.Is_Null( cursor, 142 )then
         a_benunit.hairnt3 := gse.Integer_Value( cursor, 142 );
      end if;
      if not gse.Is_Null( cursor, 143 )then
         a_benunit.hairnt4 := gse.Integer_Value( cursor, 143 );
      end if;
      if not gse.Is_Null( cursor, 144 )then
         a_benunit.hairnt5 := gse.Integer_Value( cursor, 144 );
      end if;
      if not gse.Is_Null( cursor, 145 )then
         a_benunit.hairnt6 := gse.Integer_Value( cursor, 145 );
      end if;
      if not gse.Is_Null( cursor, 146 )then
         a_benunit.hairnt7 := gse.Integer_Value( cursor, 146 );
      end if;
      if not gse.Is_Null( cursor, 147 )then
         a_benunit.hairnt8 := gse.Integer_Value( cursor, 147 );
      end if;
      if not gse.Is_Null( cursor, 148 )then
         a_benunit.hairnt9 := gse.Integer_Value( cursor, 148 );
      end if;
      if not gse.Is_Null( cursor, 149 )then
         a_benunit.hbolng := gse.Integer_Value( cursor, 149 );
      end if;
      if not gse.Is_Null( cursor, 150 )then
         a_benunit.hbothamt:= Amount'Value( gse.Value( cursor, 150 ));
      end if;
      if not gse.Is_Null( cursor, 151 )then
         a_benunit.hbothbu := gse.Integer_Value( cursor, 151 );
      end if;
      if not gse.Is_Null( cursor, 152 )then
         a_benunit.hbothmn := gse.Integer_Value( cursor, 152 );
      end if;
      if not gse.Is_Null( cursor, 153 )then
         a_benunit.hbothpd := gse.Integer_Value( cursor, 153 );
      end if;
      if not gse.Is_Null( cursor, 154 )then
         a_benunit.hbothwk := gse.Integer_Value( cursor, 154 );
      end if;
      if not gse.Is_Null( cursor, 155 )then
         a_benunit.hbothyr := gse.Integer_Value( cursor, 155 );
      end if;
      if not gse.Is_Null( cursor, 156 )then
         a_benunit.hbotwait := gse.Integer_Value( cursor, 156 );
      end if;
      if not gse.Is_Null( cursor, 157 )then
         a_benunit.heatnt1 := gse.Integer_Value( cursor, 157 );
      end if;
      if not gse.Is_Null( cursor, 158 )then
         a_benunit.heatnt2 := gse.Integer_Value( cursor, 158 );
      end if;
      if not gse.Is_Null( cursor, 159 )then
         a_benunit.heatnt3 := gse.Integer_Value( cursor, 159 );
      end if;
      if not gse.Is_Null( cursor, 160 )then
         a_benunit.heatnt4 := gse.Integer_Value( cursor, 160 );
      end if;
      if not gse.Is_Null( cursor, 161 )then
         a_benunit.heatnt5 := gse.Integer_Value( cursor, 161 );
      end if;
      if not gse.Is_Null( cursor, 162 )then
         a_benunit.heatnt6 := gse.Integer_Value( cursor, 162 );
      end if;
      if not gse.Is_Null( cursor, 163 )then
         a_benunit.heatnt7 := gse.Integer_Value( cursor, 163 );
      end if;
      if not gse.Is_Null( cursor, 164 )then
         a_benunit.heatnt8 := gse.Integer_Value( cursor, 164 );
      end if;
      if not gse.Is_Null( cursor, 165 )then
         a_benunit.heatnt9 := gse.Integer_Value( cursor, 165 );
      end if;
      if not gse.Is_Null( cursor, 166 )then
         a_benunit.holnt1 := gse.Integer_Value( cursor, 166 );
      end if;
      if not gse.Is_Null( cursor, 167 )then
         a_benunit.holnt2 := gse.Integer_Value( cursor, 167 );
      end if;
      if not gse.Is_Null( cursor, 168 )then
         a_benunit.holnt3 := gse.Integer_Value( cursor, 168 );
      end if;
      if not gse.Is_Null( cursor, 169 )then
         a_benunit.holnt4 := gse.Integer_Value( cursor, 169 );
      end if;
      if not gse.Is_Null( cursor, 170 )then
         a_benunit.holnt5 := gse.Integer_Value( cursor, 170 );
      end if;
      if not gse.Is_Null( cursor, 171 )then
         a_benunit.holnt6 := gse.Integer_Value( cursor, 171 );
      end if;
      if not gse.Is_Null( cursor, 172 )then
         a_benunit.holnt7 := gse.Integer_Value( cursor, 172 );
      end if;
      if not gse.Is_Null( cursor, 173 )then
         a_benunit.holnt8 := gse.Integer_Value( cursor, 173 );
      end if;
      if not gse.Is_Null( cursor, 174 )then
         a_benunit.holnt9 := gse.Integer_Value( cursor, 174 );
      end if;
      if not gse.Is_Null( cursor, 175 )then
         a_benunit.homent1 := gse.Integer_Value( cursor, 175 );
      end if;
      if not gse.Is_Null( cursor, 176 )then
         a_benunit.homent2 := gse.Integer_Value( cursor, 176 );
      end if;
      if not gse.Is_Null( cursor, 177 )then
         a_benunit.homent3 := gse.Integer_Value( cursor, 177 );
      end if;
      if not gse.Is_Null( cursor, 178 )then
         a_benunit.homent4 := gse.Integer_Value( cursor, 178 );
      end if;
      if not gse.Is_Null( cursor, 179 )then
         a_benunit.homent5 := gse.Integer_Value( cursor, 179 );
      end if;
      if not gse.Is_Null( cursor, 180 )then
         a_benunit.homent6 := gse.Integer_Value( cursor, 180 );
      end if;
      if not gse.Is_Null( cursor, 181 )then
         a_benunit.homent7 := gse.Integer_Value( cursor, 181 );
      end if;
      if not gse.Is_Null( cursor, 182 )then
         a_benunit.homent8 := gse.Integer_Value( cursor, 182 );
      end if;
      if not gse.Is_Null( cursor, 183 )then
         a_benunit.homent9 := gse.Integer_Value( cursor, 183 );
      end if;
      if not gse.Is_Null( cursor, 184 )then
         a_benunit.houshe1 := gse.Integer_Value( cursor, 184 );
      end if;
      if not gse.Is_Null( cursor, 185 )then
         a_benunit.houshew := gse.Integer_Value( cursor, 185 );
      end if;
      if not gse.Is_Null( cursor, 186 )then
         a_benunit.intntnt1 := gse.Integer_Value( cursor, 186 );
      end if;
      if not gse.Is_Null( cursor, 187 )then
         a_benunit.intntnt2 := gse.Integer_Value( cursor, 187 );
      end if;
      if not gse.Is_Null( cursor, 188 )then
         a_benunit.intntnt3 := gse.Integer_Value( cursor, 188 );
      end if;
      if not gse.Is_Null( cursor, 189 )then
         a_benunit.intntnt4 := gse.Integer_Value( cursor, 189 );
      end if;
      if not gse.Is_Null( cursor, 190 )then
         a_benunit.intntnt5 := gse.Integer_Value( cursor, 190 );
      end if;
      if not gse.Is_Null( cursor, 191 )then
         a_benunit.intntnt6 := gse.Integer_Value( cursor, 191 );
      end if;
      if not gse.Is_Null( cursor, 192 )then
         a_benunit.intntnt7 := gse.Integer_Value( cursor, 192 );
      end if;
      if not gse.Is_Null( cursor, 193 )then
         a_benunit.intntnt8 := gse.Integer_Value( cursor, 193 );
      end if;
      if not gse.Is_Null( cursor, 194 )then
         a_benunit.intrnet := gse.Integer_Value( cursor, 194 );
      end if;
      if not gse.Is_Null( cursor, 195 )then
         a_benunit.issue := gse.Integer_Value( cursor, 195 );
      end if;
      if not gse.Is_Null( cursor, 196 )then
         a_benunit.kidinc := gse.Integer_Value( cursor, 196 );
      end if;
      if not gse.Is_Null( cursor, 197 )then
         a_benunit.meal := gse.Integer_Value( cursor, 197 );
      end if;
      if not gse.Is_Null( cursor, 198 )then
         a_benunit.mealnt1 := gse.Integer_Value( cursor, 198 );
      end if;
      if not gse.Is_Null( cursor, 199 )then
         a_benunit.mealnt2 := gse.Integer_Value( cursor, 199 );
      end if;
      if not gse.Is_Null( cursor, 200 )then
         a_benunit.mealnt3 := gse.Integer_Value( cursor, 200 );
      end if;
      if not gse.Is_Null( cursor, 201 )then
         a_benunit.mealnt4 := gse.Integer_Value( cursor, 201 );
      end if;
      if not gse.Is_Null( cursor, 202 )then
         a_benunit.mealnt5 := gse.Integer_Value( cursor, 202 );
      end if;
      if not gse.Is_Null( cursor, 203 )then
         a_benunit.mealnt6 := gse.Integer_Value( cursor, 203 );
      end if;
      if not gse.Is_Null( cursor, 204 )then
         a_benunit.mealnt7 := gse.Integer_Value( cursor, 204 );
      end if;
      if not gse.Is_Null( cursor, 205 )then
         a_benunit.mealnt8 := gse.Integer_Value( cursor, 205 );
      end if;
      if not gse.Is_Null( cursor, 206 )then
         a_benunit.mealnt9 := gse.Integer_Value( cursor, 206 );
      end if;
      if not gse.Is_Null( cursor, 207 )then
         a_benunit.nhhchild := gse.Integer_Value( cursor, 207 );
      end if;
      if not gse.Is_Null( cursor, 208 )then
         a_benunit.noise := gse.Integer_Value( cursor, 208 );
      end if;
      if not gse.Is_Null( cursor, 209 )then
         a_benunit.oabill := gse.Integer_Value( cursor, 209 );
      end if;
      if not gse.Is_Null( cursor, 210 )then
         a_benunit.oacareu1 := gse.Integer_Value( cursor, 210 );
      end if;
      if not gse.Is_Null( cursor, 211 )then
         a_benunit.oacareu2 := gse.Integer_Value( cursor, 211 );
      end if;
      if not gse.Is_Null( cursor, 212 )then
         a_benunit.oacareu3 := gse.Integer_Value( cursor, 212 );
      end if;
      if not gse.Is_Null( cursor, 213 )then
         a_benunit.oacareu4 := gse.Integer_Value( cursor, 213 );
      end if;
      if not gse.Is_Null( cursor, 214 )then
         a_benunit.oacareu5 := gse.Integer_Value( cursor, 214 );
      end if;
      if not gse.Is_Null( cursor, 215 )then
         a_benunit.oacareu6 := gse.Integer_Value( cursor, 215 );
      end if;
      if not gse.Is_Null( cursor, 216 )then
         a_benunit.oacareu7 := gse.Integer_Value( cursor, 216 );
      end if;
      if not gse.Is_Null( cursor, 217 )then
         a_benunit.oacareu8 := gse.Integer_Value( cursor, 217 );
      end if;
      if not gse.Is_Null( cursor, 218 )then
         a_benunit.oacoat := gse.Integer_Value( cursor, 218 );
      end if;
      if not gse.Is_Null( cursor, 219 )then
         a_benunit.oacook := gse.Integer_Value( cursor, 219 );
      end if;
      if not gse.Is_Null( cursor, 220 )then
         a_benunit.oadamp := gse.Integer_Value( cursor, 220 );
      end if;
      if not gse.Is_Null( cursor, 221 )then
         a_benunit.oadep2 := gse.Integer_Value( cursor, 221 );
      end if;
      if not gse.Is_Null( cursor, 222 )then
         a_benunit.oadp2nt1 := gse.Integer_Value( cursor, 222 );
      end if;
      if not gse.Is_Null( cursor, 223 )then
         a_benunit.oadp2nt2 := gse.Integer_Value( cursor, 223 );
      end if;
      if not gse.Is_Null( cursor, 224 )then
         a_benunit.oadp2nt3 := gse.Integer_Value( cursor, 224 );
      end if;
      if not gse.Is_Null( cursor, 225 )then
         a_benunit.oadp2nt4 := gse.Integer_Value( cursor, 225 );
      end if;
      if not gse.Is_Null( cursor, 226 )then
         a_benunit.oadp2nt5 := gse.Integer_Value( cursor, 226 );
      end if;
      if not gse.Is_Null( cursor, 227 )then
         a_benunit.oadp2nt6 := gse.Integer_Value( cursor, 227 );
      end if;
      if not gse.Is_Null( cursor, 228 )then
         a_benunit.oadp2nt7 := gse.Integer_Value( cursor, 228 );
      end if;
      if not gse.Is_Null( cursor, 229 )then
         a_benunit.oadp2nt8 := gse.Integer_Value( cursor, 229 );
      end if;
      if not gse.Is_Null( cursor, 230 )then
         a_benunit.oaexpns := gse.Integer_Value( cursor, 230 );
      end if;
      if not gse.Is_Null( cursor, 231 )then
         a_benunit.oafrnd := gse.Integer_Value( cursor, 231 );
      end if;
      if not gse.Is_Null( cursor, 232 )then
         a_benunit.oafur := gse.Integer_Value( cursor, 232 );
      end if;
      if not gse.Is_Null( cursor, 233 )then
         a_benunit.oahair := gse.Integer_Value( cursor, 233 );
      end if;
      if not gse.Is_Null( cursor, 234 )then
         a_benunit.oaheat := gse.Integer_Value( cursor, 234 );
      end if;
      if not gse.Is_Null( cursor, 235 )then
         a_benunit.oahol := gse.Integer_Value( cursor, 235 );
      end if;
      if not gse.Is_Null( cursor, 236 )then
         a_benunit.oahome := gse.Integer_Value( cursor, 236 );
      end if;
      if not gse.Is_Null( cursor, 237 )then
         a_benunit.oahowpy1 := gse.Integer_Value( cursor, 237 );
      end if;
      if not gse.Is_Null( cursor, 238 )then
         a_benunit.oahowpy2 := gse.Integer_Value( cursor, 238 );
      end if;
      if not gse.Is_Null( cursor, 239 )then
         a_benunit.oahowpy3 := gse.Integer_Value( cursor, 239 );
      end if;
      if not gse.Is_Null( cursor, 240 )then
         a_benunit.oahowpy4 := gse.Integer_Value( cursor, 240 );
      end if;
      if not gse.Is_Null( cursor, 241 )then
         a_benunit.oahowpy5 := gse.Integer_Value( cursor, 241 );
      end if;
      if not gse.Is_Null( cursor, 242 )then
         a_benunit.oahowpy6 := gse.Integer_Value( cursor, 242 );
      end if;
      if not gse.Is_Null( cursor, 243 )then
         a_benunit.oaintern := gse.Integer_Value( cursor, 243 );
      end if;
      if not gse.Is_Null( cursor, 244 )then
         a_benunit.oameal := gse.Integer_Value( cursor, 244 );
      end if;
      if not gse.Is_Null( cursor, 245 )then
         a_benunit.oaout := gse.Integer_Value( cursor, 245 );
      end if;
      if not gse.Is_Null( cursor, 246 )then
         a_benunit.oaphon := gse.Integer_Value( cursor, 246 );
      end if;
      if not gse.Is_Null( cursor, 247 )then
         a_benunit.oapre := gse.Integer_Value( cursor, 247 );
      end if;
      if not gse.Is_Null( cursor, 248 )then
         a_benunit.oataxi := gse.Integer_Value( cursor, 248 );
      end if;
      if not gse.Is_Null( cursor, 249 )then
         a_benunit.oataxieu := gse.Integer_Value( cursor, 249 );
      end if;
      if not gse.Is_Null( cursor, 250 )then
         a_benunit.oatelep1 := gse.Integer_Value( cursor, 250 );
      end if;
      if not gse.Is_Null( cursor, 251 )then
         a_benunit.oatelep2 := gse.Integer_Value( cursor, 251 );
      end if;
      if not gse.Is_Null( cursor, 252 )then
         a_benunit.oatelep3 := gse.Integer_Value( cursor, 252 );
      end if;
      if not gse.Is_Null( cursor, 253 )then
         a_benunit.oatelep4 := gse.Integer_Value( cursor, 253 );
      end if;
      if not gse.Is_Null( cursor, 254 )then
         a_benunit.oatelep5 := gse.Integer_Value( cursor, 254 );
      end if;
      if not gse.Is_Null( cursor, 255 )then
         a_benunit.oatelep6 := gse.Integer_Value( cursor, 255 );
      end if;
      if not gse.Is_Null( cursor, 256 )then
         a_benunit.oatelep7 := gse.Integer_Value( cursor, 256 );
      end if;
      if not gse.Is_Null( cursor, 257 )then
         a_benunit.oatelep8 := gse.Integer_Value( cursor, 257 );
      end if;
      if not gse.Is_Null( cursor, 258 )then
         a_benunit.oateleph := gse.Integer_Value( cursor, 258 );
      end if;
      if not gse.Is_Null( cursor, 259 )then
         a_benunit.oawarm := gse.Integer_Value( cursor, 259 );
      end if;
      if not gse.Is_Null( cursor, 260 )then
         a_benunit.outnt1 := gse.Integer_Value( cursor, 260 );
      end if;
      if not gse.Is_Null( cursor, 261 )then
         a_benunit.outnt2 := gse.Integer_Value( cursor, 261 );
      end if;
      if not gse.Is_Null( cursor, 262 )then
         a_benunit.outnt3 := gse.Integer_Value( cursor, 262 );
      end if;
      if not gse.Is_Null( cursor, 263 )then
         a_benunit.outnt4 := gse.Integer_Value( cursor, 263 );
      end if;
      if not gse.Is_Null( cursor, 264 )then
         a_benunit.outnt5 := gse.Integer_Value( cursor, 264 );
      end if;
      if not gse.Is_Null( cursor, 265 )then
         a_benunit.outnt6 := gse.Integer_Value( cursor, 265 );
      end if;
      if not gse.Is_Null( cursor, 266 )then
         a_benunit.outnt7 := gse.Integer_Value( cursor, 266 );
      end if;
      if not gse.Is_Null( cursor, 267 )then
         a_benunit.outnt8 := gse.Integer_Value( cursor, 267 );
      end if;
      if not gse.Is_Null( cursor, 268 )then
         a_benunit.outnt9 := gse.Integer_Value( cursor, 268 );
      end if;
      if not gse.Is_Null( cursor, 269 )then
         a_benunit.outpay := gse.Integer_Value( cursor, 269 );
      end if;
      if not gse.Is_Null( cursor, 270 )then
         a_benunit.outpyamt:= Amount'Value( gse.Value( cursor, 270 ));
      end if;
      if not gse.Is_Null( cursor, 271 )then
         a_benunit.phonnt1 := gse.Integer_Value( cursor, 271 );
      end if;
      if not gse.Is_Null( cursor, 272 )then
         a_benunit.phonnt2 := gse.Integer_Value( cursor, 272 );
      end if;
      if not gse.Is_Null( cursor, 273 )then
         a_benunit.phonnt3 := gse.Integer_Value( cursor, 273 );
      end if;
      if not gse.Is_Null( cursor, 274 )then
         a_benunit.phonnt4 := gse.Integer_Value( cursor, 274 );
      end if;
      if not gse.Is_Null( cursor, 275 )then
         a_benunit.phonnt5 := gse.Integer_Value( cursor, 275 );
      end if;
      if not gse.Is_Null( cursor, 276 )then
         a_benunit.phonnt6 := gse.Integer_Value( cursor, 276 );
      end if;
      if not gse.Is_Null( cursor, 277 )then
         a_benunit.phonnt7 := gse.Integer_Value( cursor, 277 );
      end if;
      if not gse.Is_Null( cursor, 278 )then
         a_benunit.phonnt8 := gse.Integer_Value( cursor, 278 );
      end if;
      if not gse.Is_Null( cursor, 279 )then
         a_benunit.phonnt9 := gse.Integer_Value( cursor, 279 );
      end if;
      if not gse.Is_Null( cursor, 280 )then
         a_benunit.pollute := gse.Integer_Value( cursor, 280 );
      end if;
      if not gse.Is_Null( cursor, 281 )then
         a_benunit.regpamt:= Amount'Value( gse.Value( cursor, 281 ));
      end if;
      if not gse.Is_Null( cursor, 282 )then
         a_benunit.regularp := gse.Integer_Value( cursor, 282 );
      end if;
      if not gse.Is_Null( cursor, 283 )then
         a_benunit.repaybur := gse.Integer_Value( cursor, 283 );
      end if;
      if not gse.Is_Null( cursor, 284 )then
         a_benunit.shoe := gse.Integer_Value( cursor, 284 );
      end if;
      if not gse.Is_Null( cursor, 285 )then
         a_benunit.shoent1 := gse.Integer_Value( cursor, 285 );
      end if;
      if not gse.Is_Null( cursor, 286 )then
         a_benunit.shoent2 := gse.Integer_Value( cursor, 286 );
      end if;
      if not gse.Is_Null( cursor, 287 )then
         a_benunit.shoent3 := gse.Integer_Value( cursor, 287 );
      end if;
      if not gse.Is_Null( cursor, 288 )then
         a_benunit.shoent4 := gse.Integer_Value( cursor, 288 );
      end if;
      if not gse.Is_Null( cursor, 289 )then
         a_benunit.shoent5 := gse.Integer_Value( cursor, 289 );
      end if;
      if not gse.Is_Null( cursor, 290 )then
         a_benunit.shoent6 := gse.Integer_Value( cursor, 290 );
      end if;
      if not gse.Is_Null( cursor, 291 )then
         a_benunit.shoent7 := gse.Integer_Value( cursor, 291 );
      end if;
      if not gse.Is_Null( cursor, 292 )then
         a_benunit.shoent8 := gse.Integer_Value( cursor, 292 );
      end if;
      if not gse.Is_Null( cursor, 293 )then
         a_benunit.shoeoa := gse.Integer_Value( cursor, 293 );
      end if;
      if not gse.Is_Null( cursor, 294 )then
         a_benunit.taxint1 := gse.Integer_Value( cursor, 294 );
      end if;
      if not gse.Is_Null( cursor, 295 )then
         a_benunit.taxint2 := gse.Integer_Value( cursor, 295 );
      end if;
      if not gse.Is_Null( cursor, 296 )then
         a_benunit.taxint3 := gse.Integer_Value( cursor, 296 );
      end if;
      if not gse.Is_Null( cursor, 297 )then
         a_benunit.taxint4 := gse.Integer_Value( cursor, 297 );
      end if;
      if not gse.Is_Null( cursor, 298 )then
         a_benunit.taxint5 := gse.Integer_Value( cursor, 298 );
      end if;
      if not gse.Is_Null( cursor, 299 )then
         a_benunit.taxint6 := gse.Integer_Value( cursor, 299 );
      end if;
      if not gse.Is_Null( cursor, 300 )then
         a_benunit.taxint7 := gse.Integer_Value( cursor, 300 );
      end if;
      if not gse.Is_Null( cursor, 301 )then
         a_benunit.taxint8 := gse.Integer_Value( cursor, 301 );
      end if;
      if not gse.Is_Null( cursor, 302 )then
         a_benunit.taxint9 := gse.Integer_Value( cursor, 302 );
      end if;
      if not gse.Is_Null( cursor, 303 )then
         a_benunit.totsav := gse.Integer_Value( cursor, 303 );
      end if;
      if not gse.Is_Null( cursor, 304 )then
         a_benunit.warmnt1 := gse.Integer_Value( cursor, 304 );
      end if;
      if not gse.Is_Null( cursor, 305 )then
         a_benunit.warmnt2 := gse.Integer_Value( cursor, 305 );
      end if;
      if not gse.Is_Null( cursor, 306 )then
         a_benunit.warmnt3 := gse.Integer_Value( cursor, 306 );
      end if;
      if not gse.Is_Null( cursor, 307 )then
         a_benunit.warmnt4 := gse.Integer_Value( cursor, 307 );
      end if;
      if not gse.Is_Null( cursor, 308 )then
         a_benunit.warmnt5 := gse.Integer_Value( cursor, 308 );
      end if;
      if not gse.Is_Null( cursor, 309 )then
         a_benunit.warmnt6 := gse.Integer_Value( cursor, 309 );
      end if;
      if not gse.Is_Null( cursor, 310 )then
         a_benunit.warmnt7 := gse.Integer_Value( cursor, 310 );
      end if;
      if not gse.Is_Null( cursor, 311 )then
         a_benunit.warmnt8 := gse.Integer_Value( cursor, 311 );
      end if;
      if not gse.Is_Null( cursor, 312 )then
         a_benunit.warmnt9 := gse.Integer_Value( cursor, 312 );
      end if;
      if not gse.Is_Null( cursor, 313 )then
         a_benunit.washmach := gse.Integer_Value( cursor, 313 );
      end if;
      if not gse.Is_Null( cursor, 314 )then
         a_benunit.washwhy := gse.Integer_Value( cursor, 314 );
      end if;
      if not gse.Is_Null( cursor, 315 )then
         a_benunit.whodepq := gse.Integer_Value( cursor, 315 );
      end if;
      if not gse.Is_Null( cursor, 316 )then
         a_benunit.month := gse.Integer_Value( cursor, 316 );
      end if;
      if not gse.Is_Null( cursor, 317 )then
         a_benunit.adultb := gse.Integer_Value( cursor, 317 );
      end if;
      if not gse.Is_Null( cursor, 318 )then
         a_benunit.boarder:= Amount'Value( gse.Value( cursor, 318 ));
      end if;
      if not gse.Is_Null( cursor, 319 )then
         a_benunit.bpeninc:= Amount'Value( gse.Value( cursor, 319 ));
      end if;
      if not gse.Is_Null( cursor, 320 )then
         a_benunit.bseinc:= Amount'Value( gse.Value( cursor, 320 ));
      end if;
      if not gse.Is_Null( cursor, 321 )then
         a_benunit.buagegr2 := gse.Integer_Value( cursor, 321 );
      end if;
      if not gse.Is_Null( cursor, 322 )then
         a_benunit.buagegr3 := gse.Integer_Value( cursor, 322 );
      end if;
      if not gse.Is_Null( cursor, 323 )then
         a_benunit.buagegr4 := gse.Integer_Value( cursor, 323 );
      end if;
      if not gse.Is_Null( cursor, 324 )then
         a_benunit.buagegrp := gse.Integer_Value( cursor, 324 );
      end if;
      if not gse.Is_Null( cursor, 325 )then
         a_benunit.budisben := gse.Integer_Value( cursor, 325 );
      end if;
      if not gse.Is_Null( cursor, 326 )then
         a_benunit.buearns:= Amount'Value( gse.Value( cursor, 326 ));
      end if;
      if not gse.Is_Null( cursor, 327 )then
         a_benunit.buethgr3 := gse.Integer_Value( cursor, 327 );
      end if;
      if not gse.Is_Null( cursor, 328 )then
         a_benunit.buinc := gse.Integer_Value( cursor, 328 );
      end if;
      if not gse.Is_Null( cursor, 329 )then
         a_benunit.buinv:= Amount'Value( gse.Value( cursor, 329 ));
      end if;
      if not gse.Is_Null( cursor, 330 )then
         a_benunit.buirben := gse.Integer_Value( cursor, 330 );
      end if;
      if not gse.Is_Null( cursor, 331 )then
         a_benunit.bukids := gse.Integer_Value( cursor, 331 );
      end if;
      if not gse.Is_Null( cursor, 332 )then
         a_benunit.bunirben := gse.Integer_Value( cursor, 332 );
      end if;
      if not gse.Is_Null( cursor, 333 )then
         a_benunit.buothben := gse.Integer_Value( cursor, 333 );
      end if;
      if not gse.Is_Null( cursor, 334 )then
         a_benunit.burent := gse.Integer_Value( cursor, 334 );
      end if;
      if not gse.Is_Null( cursor, 335 )then
         a_benunit.burinc:= Amount'Value( gse.Value( cursor, 335 ));
      end if;
      if not gse.Is_Null( cursor, 336 )then
         a_benunit.burpinc:= Amount'Value( gse.Value( cursor, 336 ));
      end if;
      if not gse.Is_Null( cursor, 337 )then
         a_benunit.butvlic:= Amount'Value( gse.Value( cursor, 337 ));
      end if;
      if not gse.Is_Null( cursor, 338 )then
         a_benunit.butxcred:= Amount'Value( gse.Value( cursor, 338 ));
      end if;
      if not gse.Is_Null( cursor, 339 )then
         a_benunit.depchldb := gse.Integer_Value( cursor, 339 );
      end if;
      if not gse.Is_Null( cursor, 340 )then
         a_benunit.discbua1 := gse.Integer_Value( cursor, 340 );
      end if;
      if not gse.Is_Null( cursor, 341 )then
         a_benunit.discbuc1 := gse.Integer_Value( cursor, 341 );
      end if;
      if not gse.Is_Null( cursor, 342 )then
         a_benunit.diswbua1 := gse.Integer_Value( cursor, 342 );
      end if;
      if not gse.Is_Null( cursor, 343 )then
         a_benunit.diswbuc1 := gse.Integer_Value( cursor, 343 );
      end if;
      if not gse.Is_Null( cursor, 344 )then
         a_benunit.ecostabu := gse.Integer_Value( cursor, 344 );
      end if;
      if not gse.Is_Null( cursor, 345 )then
         a_benunit.ecstatbu := gse.Integer_Value( cursor, 345 );
      end if;
      if not gse.Is_Null( cursor, 346 )then
         a_benunit.famtypb2 := gse.Integer_Value( cursor, 346 );
      end if;
      if not gse.Is_Null( cursor, 347 )then
         a_benunit.famtypbs := gse.Integer_Value( cursor, 347 );
      end if;
      if not gse.Is_Null( cursor, 348 )then
         a_benunit.famtypbu := gse.Integer_Value( cursor, 348 );
      end if;
      if not gse.Is_Null( cursor, 349 )then
         a_benunit.fsbbu:= Amount'Value( gse.Value( cursor, 349 ));
      end if;
      if not gse.Is_Null( cursor, 350 )then
         a_benunit.fsfvbu:= Amount'Value( gse.Value( cursor, 350 ));
      end if;
      if not gse.Is_Null( cursor, 351 )then
         a_benunit.fsmbu:= Amount'Value( gse.Value( cursor, 351 ));
      end if;
      if not gse.Is_Null( cursor, 352 )then
         a_benunit.fsmlkbu:= Amount'Value( gse.Value( cursor, 352 ));
      end if;
      if not gse.Is_Null( cursor, 353 )then
         a_benunit.gross4 := gse.Integer_Value( cursor, 353 );
      end if;
      if not gse.Is_Null( cursor, 354 )then
         a_benunit.hbindbu := gse.Integer_Value( cursor, 354 );
      end if;
      if not gse.Is_Null( cursor, 355 )then
         a_benunit.hbindbu2 := gse.Integer_Value( cursor, 355 );
      end if;
      if not gse.Is_Null( cursor, 356 )then
         a_benunit.heartbu:= Amount'Value( gse.Value( cursor, 356 ));
      end if;
      if not gse.Is_Null( cursor, 357 )then
         a_benunit.kid04 := gse.Integer_Value( cursor, 357 );
      end if;
      if not gse.Is_Null( cursor, 358 )then
         a_benunit.kid1115 := gse.Integer_Value( cursor, 358 );
      end if;
      if not gse.Is_Null( cursor, 359 )then
         a_benunit.kid1619 := gse.Integer_Value( cursor, 359 );
      end if;
      if not gse.Is_Null( cursor, 360 )then
         a_benunit.kid510 := gse.Integer_Value( cursor, 360 );
      end if;
      if not gse.Is_Null( cursor, 361 )then
         a_benunit.lodger:= Amount'Value( gse.Value( cursor, 361 ));
      end if;
      if not gse.Is_Null( cursor, 362 )then
         a_benunit.nbunirbn := gse.Integer_Value( cursor, 362 );
      end if;
      if not gse.Is_Null( cursor, 363 )then
         a_benunit.nbuothbn := gse.Integer_Value( cursor, 363 );
      end if;
      if not gse.Is_Null( cursor, 364 )then
         a_benunit.newfamb2 := gse.Integer_Value( cursor, 364 );
      end if;
      if not gse.Is_Null( cursor, 365 )then
         a_benunit.newfambu := gse.Integer_Value( cursor, 365 );
      end if;
      if not gse.Is_Null( cursor, 366 )then
         a_benunit.subltamt:= Amount'Value( gse.Value( cursor, 366 ));
      end if;
      if not gse.Is_Null( cursor, 367 )then
         a_benunit.totcapb3:= Amount'Value( gse.Value( cursor, 367 ));
      end if;
      if not gse.Is_Null( cursor, 368 )then
         a_benunit.totsavbu := gse.Integer_Value( cursor, 368 );
      end if;
      if not gse.Is_Null( cursor, 369 )then
         a_benunit.tuburent:= Amount'Value( gse.Value( cursor, 369 ));
      end if;
      if not gse.Is_Null( cursor, 370 )then
         a_benunit.youngch := gse.Integer_Value( cursor, 370 );
      end if;
      if not gse.Is_Null( cursor, 371 )then
         a_benunit.debt13 := gse.Integer_Value( cursor, 371 );
      end if;
      if not gse.Is_Null( cursor, 372 )then
         a_benunit.debtar13 := gse.Integer_Value( cursor, 372 );
      end if;
      if not gse.Is_Null( cursor, 373 )then
         a_benunit.euchbook := gse.Integer_Value( cursor, 373 );
      end if;
      if not gse.Is_Null( cursor, 374 )then
         a_benunit.euchclth := gse.Integer_Value( cursor, 374 );
      end if;
      if not gse.Is_Null( cursor, 375 )then
         a_benunit.euchgame := gse.Integer_Value( cursor, 375 );
      end if;
      if not gse.Is_Null( cursor, 376 )then
         a_benunit.euchmeat := gse.Integer_Value( cursor, 376 );
      end if;
      if not gse.Is_Null( cursor, 377 )then
         a_benunit.euchshoe := gse.Integer_Value( cursor, 377 );
      end if;
      if not gse.Is_Null( cursor, 378 )then
         a_benunit.eupbtran := gse.Integer_Value( cursor, 378 );
      end if;
      if not gse.Is_Null( cursor, 379 )then
         a_benunit.eupbtrn1 := gse.Integer_Value( cursor, 379 );
      end if;
      if not gse.Is_Null( cursor, 380 )then
         a_benunit.eupbtrn2 := gse.Integer_Value( cursor, 380 );
      end if;
      if not gse.Is_Null( cursor, 381 )then
         a_benunit.eupbtrn3 := gse.Integer_Value( cursor, 381 );
      end if;
      if not gse.Is_Null( cursor, 382 )then
         a_benunit.eupbtrn4 := gse.Integer_Value( cursor, 382 );
      end if;
      if not gse.Is_Null( cursor, 383 )then
         a_benunit.eupbtrn5 := gse.Integer_Value( cursor, 383 );
      end if;
      if not gse.Is_Null( cursor, 384 )then
         a_benunit.euroast := gse.Integer_Value( cursor, 384 );
      end if;
      if not gse.Is_Null( cursor, 385 )then
         a_benunit.eusmeal := gse.Integer_Value( cursor, 385 );
      end if;
      if not gse.Is_Null( cursor, 386 )then
         a_benunit.eustudy := gse.Integer_Value( cursor, 386 );
      end if;
      if not gse.Is_Null( cursor, 387 )then
         a_benunit.bueth := gse.Integer_Value( cursor, 387 );
      end if;
      if not gse.Is_Null( cursor, 388 )then
         a_benunit.oaeusmea := gse.Integer_Value( cursor, 388 );
      end if;
      if not gse.Is_Null( cursor, 389 )then
         a_benunit.oaholb := gse.Integer_Value( cursor, 389 );
      end if;
      if not gse.Is_Null( cursor, 390 )then
         a_benunit.oaroast := gse.Integer_Value( cursor, 390 );
      end if;
      if not gse.Is_Null( cursor, 391 )then
         a_benunit.ecostab2 := gse.Integer_Value( cursor, 391 );
      end if;
      if not gse.Is_Null( cursor, 392 )then
         a_benunit.incchnge := gse.Integer_Value( cursor, 392 );
      end if;
      if not gse.Is_Null( cursor, 393 )then
         a_benunit.inchilow := gse.Integer_Value( cursor, 393 );
      end if;
      if not gse.Is_Null( cursor, 394 )then
         a_benunit.actaccb := gse.Integer_Value( cursor, 394 );
      end if;
      if not gse.Is_Null( cursor, 395 )then
         a_benunit.adddabu := gse.Integer_Value( cursor, 395 );
      end if;
      if not gse.Is_Null( cursor, 396 )then
         a_benunit.basactb := gse.Integer_Value( cursor, 396 );
      end if;
      if not gse.Is_Null( cursor, 397 )then
         a_benunit.buethgr2 := gse.Integer_Value( cursor, 397 );
      end if;
      if not gse.Is_Null( cursor, 398 )then
         a_benunit.buethgrp := gse.Integer_Value( cursor, 398 );
      end if;
      if not gse.Is_Null( cursor, 399 )then
         a_benunit.chddabu := gse.Integer_Value( cursor, 399 );
      end if;
      if not gse.Is_Null( cursor, 400 )then
         a_benunit.curactb := gse.Integer_Value( cursor, 400 );
      end if;
      if not gse.Is_Null( cursor, 401 )then
         a_benunit.depdeds := gse.Integer_Value( cursor, 401 );
      end if;
      if not gse.Is_Null( cursor, 402 )then
         a_benunit.disindhb := gse.Integer_Value( cursor, 402 );
      end if;
      if not gse.Is_Null( cursor, 403 )then
         a_benunit.ecotypbu := gse.Integer_Value( cursor, 403 );
      end if;
      if not gse.Is_Null( cursor, 404 )then
         a_benunit.famthbai := gse.Integer_Value( cursor, 404 );
      end if;
      if not gse.Is_Null( cursor, 405 )then
         a_benunit.famtype := gse.Integer_Value( cursor, 405 );
      end if;
      if not gse.Is_Null( cursor, 406 )then
         a_benunit.fsbndctb := gse.Integer_Value( cursor, 406 );
      end if;
      if not gse.Is_Null( cursor, 407 )then
         a_benunit.fwmlkbu:= Amount'Value( gse.Value( cursor, 407 ));
      end if;
      if not gse.Is_Null( cursor, 408 )then
         a_benunit.gebactb := gse.Integer_Value( cursor, 408 );
      end if;
      if not gse.Is_Null( cursor, 409 )then
         a_benunit.giltctb := gse.Integer_Value( cursor, 409 );
      end if;
      if not gse.Is_Null( cursor, 410 )then
         a_benunit.gross2 := gse.Integer_Value( cursor, 410 );
      end if;
      if not gse.Is_Null( cursor, 411 )then
         a_benunit.gross3 := gse.Integer_Value( cursor, 411 );
      end if;
      if not gse.Is_Null( cursor, 412 )then
         a_benunit.isactb := gse.Integer_Value( cursor, 412 );
      end if;
      if not gse.Is_Null( cursor, 413 )then
         a_benunit.kid1618 := gse.Integer_Value( cursor, 413 );
      end if;
      if not gse.Is_Null( cursor, 414 )then
         a_benunit.kidsbu0 := gse.Integer_Value( cursor, 414 );
      end if;
      if not gse.Is_Null( cursor, 415 )then
         a_benunit.kidsbu1 := gse.Integer_Value( cursor, 415 );
      end if;
      if not gse.Is_Null( cursor, 416 )then
         a_benunit.kidsbu10 := gse.Integer_Value( cursor, 416 );
      end if;
      if not gse.Is_Null( cursor, 417 )then
         a_benunit.kidsbu11 := gse.Integer_Value( cursor, 417 );
      end if;
      if not gse.Is_Null( cursor, 418 )then
         a_benunit.kidsbu12 := gse.Integer_Value( cursor, 418 );
      end if;
      if not gse.Is_Null( cursor, 419 )then
         a_benunit.kidsbu13 := gse.Integer_Value( cursor, 419 );
      end if;
      if not gse.Is_Null( cursor, 420 )then
         a_benunit.kidsbu14 := gse.Integer_Value( cursor, 420 );
      end if;
      if not gse.Is_Null( cursor, 421 )then
         a_benunit.kidsbu15 := gse.Integer_Value( cursor, 421 );
      end if;
      if not gse.Is_Null( cursor, 422 )then
         a_benunit.kidsbu16 := gse.Integer_Value( cursor, 422 );
      end if;
      if not gse.Is_Null( cursor, 423 )then
         a_benunit.kidsbu17 := gse.Integer_Value( cursor, 423 );
      end if;
      if not gse.Is_Null( cursor, 424 )then
         a_benunit.kidsbu18 := gse.Integer_Value( cursor, 424 );
      end if;
      if not gse.Is_Null( cursor, 425 )then
         a_benunit.kidsbu2 := gse.Integer_Value( cursor, 425 );
      end if;
      if not gse.Is_Null( cursor, 426 )then
         a_benunit.kidsbu3 := gse.Integer_Value( cursor, 426 );
      end if;
      if not gse.Is_Null( cursor, 427 )then
         a_benunit.kidsbu4 := gse.Integer_Value( cursor, 427 );
      end if;
      if not gse.Is_Null( cursor, 428 )then
         a_benunit.kidsbu5 := gse.Integer_Value( cursor, 428 );
      end if;
      if not gse.Is_Null( cursor, 429 )then
         a_benunit.kidsbu6 := gse.Integer_Value( cursor, 429 );
      end if;
      if not gse.Is_Null( cursor, 430 )then
         a_benunit.kidsbu7 := gse.Integer_Value( cursor, 430 );
      end if;
      if not gse.Is_Null( cursor, 431 )then
         a_benunit.kidsbu8 := gse.Integer_Value( cursor, 431 );
      end if;
      if not gse.Is_Null( cursor, 432 )then
         a_benunit.kidsbu9 := gse.Integer_Value( cursor, 432 );
      end if;
      if not gse.Is_Null( cursor, 433 )then
         a_benunit.lastwork := gse.Integer_Value( cursor, 433 );
      end if;
      if not gse.Is_Null( cursor, 434 )then
         a_benunit.nsboctb := gse.Integer_Value( cursor, 434 );
      end if;
      if not gse.Is_Null( cursor, 435 )then
         a_benunit.otbsctb := gse.Integer_Value( cursor, 435 );
      end if;
      if not gse.Is_Null( cursor, 436 )then
         a_benunit.pepsctb := gse.Integer_Value( cursor, 436 );
      end if;
      if not gse.Is_Null( cursor, 437 )then
         a_benunit.poacctb := gse.Integer_Value( cursor, 437 );
      end if;
      if not gse.Is_Null( cursor, 438 )then
         a_benunit.prboctb := gse.Integer_Value( cursor, 438 );
      end if;
      if not gse.Is_Null( cursor, 439 )then
         a_benunit.sayectb := gse.Integer_Value( cursor, 439 );
      end if;
      if not gse.Is_Null( cursor, 440 )then
         a_benunit.sclbctb := gse.Integer_Value( cursor, 440 );
      end if;
      if not gse.Is_Null( cursor, 441 )then
         a_benunit.ssctb := gse.Integer_Value( cursor, 441 );
      end if;
      if not gse.Is_Null( cursor, 442 )then
         a_benunit.stshctb := gse.Integer_Value( cursor, 442 );
      end if;
      if not gse.Is_Null( cursor, 443 )then
         a_benunit.tessctb := gse.Integer_Value( cursor, 443 );
      end if;
      if not gse.Is_Null( cursor, 444 )then
         a_benunit.totcapbu:= Amount'Value( gse.Value( cursor, 444 ));
      end if;
      if not gse.Is_Null( cursor, 445 )then
         a_benunit.untrctb := gse.Integer_Value( cursor, 445 );
      end if;
      if not gse.Is_Null( cursor, 446 )then
         a_benunit.addeples := gse.Integer_Value( cursor, 446 );
      end if;
      if not gse.Is_Null( cursor, 447 )then
         a_benunit.addmel := gse.Integer_Value( cursor, 447 );
      end if;
      if not gse.Is_Null( cursor, 448 )then
         a_benunit.addshoe := gse.Integer_Value( cursor, 448 );
      end if;
      if not gse.Is_Null( cursor, 449 )then
         a_benunit.cdepsum := gse.Integer_Value( cursor, 449 );
      end if;
      if not gse.Is_Null( cursor, 450 )then
         a_benunit.debt1 := gse.Integer_Value( cursor, 450 );
      end if;
      if not gse.Is_Null( cursor, 451 )then
         a_benunit.debt2 := gse.Integer_Value( cursor, 451 );
      end if;
      if not gse.Is_Null( cursor, 452 )then
         a_benunit.debt3 := gse.Integer_Value( cursor, 452 );
      end if;
      if not gse.Is_Null( cursor, 453 )then
         a_benunit.debt4 := gse.Integer_Value( cursor, 453 );
      end if;
      if not gse.Is_Null( cursor, 454 )then
         a_benunit.debt5 := gse.Integer_Value( cursor, 454 );
      end if;
      if not gse.Is_Null( cursor, 455 )then
         a_benunit.debt6 := gse.Integer_Value( cursor, 455 );
      end if;
      if not gse.Is_Null( cursor, 456 )then
         a_benunit.debt7 := gse.Integer_Value( cursor, 456 );
      end if;
      if not gse.Is_Null( cursor, 457 )then
         a_benunit.debt8 := gse.Integer_Value( cursor, 457 );
      end if;
      if not gse.Is_Null( cursor, 458 )then
         a_benunit.debt9 := gse.Integer_Value( cursor, 458 );
      end if;
      if not gse.Is_Null( cursor, 459 )then
         a_benunit.incold := gse.Integer_Value( cursor, 459 );
      end if;
      if not gse.Is_Null( cursor, 460 )then
         a_benunit.crunacb := gse.Integer_Value( cursor, 460 );
      end if;
      if not gse.Is_Null( cursor, 461 )then
         a_benunit.enomortb := gse.Integer_Value( cursor, 461 );
      end if;
      if not gse.Is_Null( cursor, 462 )then
         a_benunit.pocardb := gse.Integer_Value( cursor, 462 );
      end if;
      if not gse.Is_Null( cursor, 463 )then
         a_benunit.totcapb2:= Amount'Value( gse.Value( cursor, 463 ));
      end if;
      if not gse.Is_Null( cursor, 464 )then
         a_benunit.cbaamt1 := gse.Integer_Value( cursor, 464 );
      end if;
      if not gse.Is_Null( cursor, 465 )then
         a_benunit.cbaamt2 := gse.Integer_Value( cursor, 465 );
      end if;
      if not gse.Is_Null( cursor, 466 )then
         a_benunit.helpgv01 := gse.Integer_Value( cursor, 466 );
      end if;
      if not gse.Is_Null( cursor, 467 )then
         a_benunit.helpgv02 := gse.Integer_Value( cursor, 467 );
      end if;
      if not gse.Is_Null( cursor, 468 )then
         a_benunit.helpgv03 := gse.Integer_Value( cursor, 468 );
      end if;
      if not gse.Is_Null( cursor, 469 )then
         a_benunit.helpgv04 := gse.Integer_Value( cursor, 469 );
      end if;
      if not gse.Is_Null( cursor, 470 )then
         a_benunit.helpgv05 := gse.Integer_Value( cursor, 470 );
      end if;
      if not gse.Is_Null( cursor, 471 )then
         a_benunit.helpgv06 := gse.Integer_Value( cursor, 471 );
      end if;
      if not gse.Is_Null( cursor, 472 )then
         a_benunit.helpgv07 := gse.Integer_Value( cursor, 472 );
      end if;
      if not gse.Is_Null( cursor, 473 )then
         a_benunit.helpgv08 := gse.Integer_Value( cursor, 473 );
      end if;
      if not gse.Is_Null( cursor, 474 )then
         a_benunit.helpgv09 := gse.Integer_Value( cursor, 474 );
      end if;
      if not gse.Is_Null( cursor, 475 )then
         a_benunit.helpgv10 := gse.Integer_Value( cursor, 475 );
      end if;
      if not gse.Is_Null( cursor, 476 )then
         a_benunit.helpgv11 := gse.Integer_Value( cursor, 476 );
      end if;
      if not gse.Is_Null( cursor, 477 )then
         a_benunit.helprc01 := gse.Integer_Value( cursor, 477 );
      end if;
      if not gse.Is_Null( cursor, 478 )then
         a_benunit.helprc02 := gse.Integer_Value( cursor, 478 );
      end if;
      if not gse.Is_Null( cursor, 479 )then
         a_benunit.helprc03 := gse.Integer_Value( cursor, 479 );
      end if;
      if not gse.Is_Null( cursor, 480 )then
         a_benunit.helprc04 := gse.Integer_Value( cursor, 480 );
      end if;
      if not gse.Is_Null( cursor, 481 )then
         a_benunit.helprc05 := gse.Integer_Value( cursor, 481 );
      end if;
      if not gse.Is_Null( cursor, 482 )then
         a_benunit.helprc06 := gse.Integer_Value( cursor, 482 );
      end if;
      if not gse.Is_Null( cursor, 483 )then
         a_benunit.helprc07 := gse.Integer_Value( cursor, 483 );
      end if;
      if not gse.Is_Null( cursor, 484 )then
         a_benunit.helprc08 := gse.Integer_Value( cursor, 484 );
      end if;
      if not gse.Is_Null( cursor, 485 )then
         a_benunit.helprc09 := gse.Integer_Value( cursor, 485 );
      end if;
      if not gse.Is_Null( cursor, 486 )then
         a_benunit.helprc10 := gse.Integer_Value( cursor, 486 );
      end if;
      if not gse.Is_Null( cursor, 487 )then
         a_benunit.helprc11 := gse.Integer_Value( cursor, 487 );
      end if;
      if not gse.Is_Null( cursor, 488 )then
         a_benunit.loangvn1 := gse.Integer_Value( cursor, 488 );
      end if;
      if not gse.Is_Null( cursor, 489 )then
         a_benunit.loangvn2 := gse.Integer_Value( cursor, 489 );
      end if;
      if not gse.Is_Null( cursor, 490 )then
         a_benunit.loangvn3 := gse.Integer_Value( cursor, 490 );
      end if;
      if not gse.Is_Null( cursor, 491 )then
         a_benunit.loanrec1 := gse.Integer_Value( cursor, 491 );
      end if;
      if not gse.Is_Null( cursor, 492 )then
         a_benunit.loanrec2 := gse.Integer_Value( cursor, 492 );
      end if;
      if not gse.Is_Null( cursor, 493 )then
         a_benunit.loanrec3 := gse.Integer_Value( cursor, 493 );
      end if;
      if not gse.Is_Null( cursor, 494 )then
         a_benunit.gross3_x := gse.Integer_Value( cursor, 494 );
      end if;
      if not gse.Is_Null( cursor, 495 )then
         a_benunit.oabilimp := gse.Integer_Value( cursor, 495 );
      end if;
      if not gse.Is_Null( cursor, 496 )then
         a_benunit.oacoaimp := gse.Integer_Value( cursor, 496 );
      end if;
      if not gse.Is_Null( cursor, 497 )then
         a_benunit.oacooimp := gse.Integer_Value( cursor, 497 );
      end if;
      if not gse.Is_Null( cursor, 498 )then
         a_benunit.oadamimp := gse.Integer_Value( cursor, 498 );
      end if;
      if not gse.Is_Null( cursor, 499 )then
         a_benunit.oaexpimp := gse.Integer_Value( cursor, 499 );
      end if;
      if not gse.Is_Null( cursor, 500 )then
         a_benunit.oafrnimp := gse.Integer_Value( cursor, 500 );
      end if;
      if not gse.Is_Null( cursor, 501 )then
         a_benunit.oahaiimp := gse.Integer_Value( cursor, 501 );
      end if;
      if not gse.Is_Null( cursor, 502 )then
         a_benunit.oaheaimp := gse.Integer_Value( cursor, 502 );
      end if;
      if not gse.Is_Null( cursor, 503 )then
         a_benunit.oaholimp := gse.Integer_Value( cursor, 503 );
      end if;
      if not gse.Is_Null( cursor, 504 )then
         a_benunit.oahomimp := gse.Integer_Value( cursor, 504 );
      end if;
      if not gse.Is_Null( cursor, 505 )then
         a_benunit.oameaimp := gse.Integer_Value( cursor, 505 );
      end if;
      if not gse.Is_Null( cursor, 506 )then
         a_benunit.oaoutimp := gse.Integer_Value( cursor, 506 );
      end if;
      if not gse.Is_Null( cursor, 507 )then
         a_benunit.oaphoimp := gse.Integer_Value( cursor, 507 );
      end if;
      if not gse.Is_Null( cursor, 508 )then
         a_benunit.oataximp := gse.Integer_Value( cursor, 508 );
      end if;
      if not gse.Is_Null( cursor, 509 )then
         a_benunit.oawarimp := gse.Integer_Value( cursor, 509 );
      end if;
      return a_benunit;
   end Map_From_Cursor;
   ...
   begin
      ...
      params( 1 ) := "+"( Integer'Pos( a_benunit.adbtbl ));
      params( 2 ) := "+"( Integer'Pos( a_benunit.adddec ));
      params( 47 ) := "+"( Integer'Pos( a_benunit.clothnt7 ));
      params( 48 ) := "+"( Integer'Pos( a_benunit.clothnt8 ));
      params( 49 ) := "+"( Integer'Pos( a_benunit.clothsoa ));
      params( 50 ) := "+"( Integer'Pos( a_benunit.coatnt1 ));
      params( 51 ) := "+"( Integer'Pos( a_benunit.coatnt2 ));
      params( 52 ) := "+"( Integer'Pos( a_benunit.coatnt3 ));
      params( 53 ) := "+"( Integer'Pos( a_benunit.coatnt4 ));
      params( 54 ) := "+"( Integer'Pos( a_benunit.coatnt5 ));
      params( 55 ) := "+"( Integer'Pos( a_benunit.coatnt6 ));
      params( 56 ) := "+"( Integer'Pos( a_benunit.coatnt7 ));
      params( 57 ) := "+"( Integer'Pos( a_benunit.coatnt8 ));
      params( 58 ) := "+"( Integer'Pos( a_benunit.coatnt9 ));
      params( 59 ) := "+"( Integer'Pos( a_benunit.computer ));
      params( 60 ) := "+"( Integer'Pos( a_benunit.compuwhy ));
      params( 61 ) := "+"( Integer'Pos( a_benunit.cooknt1 ));
      params( 62 ) := "+"( Integer'Pos( a_benunit.cooknt2 ));
      params( 63 ) := "+"( Integer'Pos( a_benunit.cooknt3 ));
      params( 64 ) := "+"( Integer'Pos( a_benunit.cooknt4 ));
      params( 65 ) := "+"( Integer'Pos( a_benunit.cooknt5 ));
      params( 66 ) := "+"( Integer'Pos( a_benunit.cooknt6 ));
      params( 67 ) := "+"( Integer'Pos( a_benunit.cooknt7 ));
      params( 68 ) := "+"( Integer'Pos( a_benunit.cooknt8 ));
      params( 69 ) := "+"( Integer'Pos( a_benunit.cooknt9 ));
      params( 70 ) := "+"( Integer'Pos( a_benunit.cplay ));
      params( 71 ) := "+"( Integer'Pos( a_benunit.crime ));
      params( 72 ) := "+"( Integer'Pos( a_benunit.damp ));
      params( 73 ) := "+"( Integer'Pos( a_benunit.dampnt1 ));
      params( 74 ) := "+"( Integer'Pos( a_benunit.dampnt2 ));
      params( 75 ) := "+"( Integer'Pos( a_benunit.dampnt3 ));
      params( 76 ) := "+"( Integer'Pos( a_benunit.dampnt4 ));
      params( 77 ) := "+"( Integer'Pos( a_benunit.dampnt5 ));
      params( 78 ) := "+"( Integer'Pos( a_benunit.dampnt6 ));
      params( 79 ) := "+"( Integer'Pos( a_benunit.dampnt7 ));
      params( 80 ) := "+"( Integer'Pos( a_benunit.dampnt8 ));
      params( 81 ) := "+"( Integer'Pos( a_benunit.dampnt9 ));
      params( 82 ) := "+"( Integer'Pos( a_benunit.dark ));
      params( 83 ) := "+"( Integer'Pos( a_benunit.debt01 ));
      params( 84 ) := "+"( Integer'Pos( a_benunit.debt02 ));
      params( 85 ) := "+"( Integer'Pos( a_benunit.debt03 ));
      params( 86 ) := "+"( Integer'Pos( a_benunit.debt04 ));
      params( 87 ) := "+"( Integer'Pos( a_benunit.debt05 ));
      params( 88 ) := "+"( Integer'Pos( a_benunit.debt06 ));
      params( 89 ) := "+"( Integer'Pos( a_benunit.debt07 ));
      params( 72 ) := "+"( Integer'Pos( a_benunit.cooknt7 ));
      params( 73 ) := "+"( Integer'Pos( a_benunit.cooknt8 ));
      params( 74 ) := "+"( Integer'Pos( a_benunit.cooknt9 ));
      params( 75 ) := "+"( Integer'Pos( a_benunit.cplay ));
      params( 76 ) := "+"( Integer'Pos( a_benunit.crime ));
      params( 77 ) := "+"( Integer'Pos( a_benunit.damp ));
      params( 78 ) := "+"( Integer'Pos( a_benunit.dampnt1 ));
      params( 79 ) := "+"( Integer'Pos( a_benunit.dampnt2 ));
      params( 80 ) := "+"( Integer'Pos( a_benunit.dampnt3 ));
      params( 81 ) := "+"( Integer'Pos( a_benunit.dampnt4 ));
      params( 82 ) := "+"( Integer'Pos( a_benunit.dampnt5 ));
      params( 83 ) := "+"( Integer'Pos( a_benunit.dampnt6 ));
      params( 84 ) := "+"( Integer'Pos( a_benunit.dampnt7 ));
      params( 85 ) := "+"( Integer'Pos( a_benunit.dampnt8 ));
      params( 86 ) := "+"( Integer'Pos( a_benunit.dampnt9 ));
      params( 87 ) := "+"( Integer'Pos( a_benunit.dark ));
      params( 88 ) := "+"( Integer'Pos( a_benunit.debt01 ));
      params( 89 ) := "+"( Integer'Pos( a_benunit.debt02 ));
      params( 90 ) := "+"( Integer'Pos( a_benunit.debt03 ));
      params( 91 ) := "+"( Integer'Pos( a_benunit.debt04 ));
      params( 92 ) := "+"( Integer'Pos( a_benunit.debt05 ));
      params( 93 ) := "+"( Integer'Pos( a_benunit.debt06 ));
      params( 94 ) := "+"( Integer'Pos( a_benunit.debt07 ));
      params( 95 ) := "+"( Integer'Pos( a_benunit.debt08 ));
      params( 96 ) := "+"( Integer'Pos( a_benunit.debt09 ));
      params( 97 ) := "+"( Integer'Pos( a_benunit.debt10 ));
      params( 98 ) := "+"( Integer'Pos( a_benunit.debt11 ));
      params( 99 ) := "+"( Integer'Pos( a_benunit.debt12 ));
      params( 100 ) := "+"( Integer'Pos( a_benunit.debtar01 ));
      params( 101 ) := "+"( Integer'Pos( a_benunit.debtar02 ));
      params( 102 ) := "+"( Integer'Pos( a_benunit.debtar03 ));
      params( 103 ) := "+"( Integer'Pos( a_benunit.debtar04 ));
      params( 104 ) := "+"( Integer'Pos( a_benunit.debtar05 ));
      params( 105 ) := "+"( Integer'Pos( a_benunit.debtar06 ));
      params( 106 ) := "+"( Integer'Pos( a_benunit.debtar07 ));
      params( 107 ) := "+"( Integer'Pos( a_benunit.debtar08 ));
      params( 108 ) := "+"( Integer'Pos( a_benunit.debtar09 ));
      params( 109 ) := "+"( Integer'Pos( a_benunit.debtar10 ));
      params( 110 ) := "+"( Integer'Pos( a_benunit.debtar11 ));
      params( 111 ) := "+"( Integer'Pos( a_benunit.debtar12 ));
      params( 112 ) := "+"( Integer'Pos( a_benunit.debtfre1 ));
      params( 113 ) := "+"( Integer'Pos( a_benunit.debtfre2 ));
      params( 114 ) := "+"( Integer'Pos( a_benunit.debtfre3 ));
      params( 115 ) := "+"( Integer'Pos( a_benunit.endsmeet ));
      params( 246 ) := "+"( Integer'Pos( a_benunit.oaout ));
      params( 247 ) := "+"( Integer'Pos( a_benunit.oaphon ));
      params( 248 ) := "+"( Integer'Pos( a_benunit.oapre ));
      params( 249 ) := "+"( Integer'Pos( a_benunit.oataxi ));
      params( 250 ) := "+"( Integer'Pos( a_benunit.oataxieu ));
      params( 251 ) := "+"( Integer'Pos( a_benunit.oatelep1 ));
      params( 252 ) := "+"( Integer'Pos( a_benunit.oatelep2 ));
      params( 253 ) := "+"( Integer'Pos( a_benunit.oatelep3 ));
      params( 254 ) := "+"( Integer'Pos( a_benunit.oatelep4 ));
      params( 255 ) := "+"( Integer'Pos( a_benunit.oatelep5 ));
      params( 256 ) := "+"( Integer'Pos( a_benunit.oatelep6 ));
      params( 257 ) := "+"( Integer'Pos( a_benunit.oatelep7 ));
      params( 258 ) := "+"( Integer'Pos( a_benunit.oatelep8 ));
      params( 259 ) := "+"( Integer'Pos( a_benunit.oateleph ));
      params( 260 ) := "+"( Integer'Pos( a_benunit.oawarm ));
      params( 261 ) := "+"( Integer'Pos( a_benunit.outnt1 ));
      params( 262 ) := "+"( Integer'Pos( a_benunit.outnt2 ));
      params( 263 ) := "+"( Integer'Pos( a_benunit.outnt3 ));
      params( 264 ) := "+"( Integer'Pos( a_benunit.outnt4 ));
      params( 265 ) := "+"( Integer'Pos( a_benunit.outnt5 ));
      params( 266 ) := "+"( Integer'Pos( a_benunit.outnt6 ));
      params( 267 ) := "+"( Integer'Pos( a_benunit.outnt7 ));
      params( 268 ) := "+"( Integer'Pos( a_benunit.outnt8 ));
      params( 269 ) := "+"( Integer'Pos( a_benunit.outnt9 ));
      params( 270 ) := "+"( Integer'Pos( a_benunit.outpay ));
      params( 271 ) := "+"( Float( a_benunit.outpyamt ));
      params( 272 ) := "+"( Integer'Pos( a_benunit.phonnt1 ));
      params( 273 ) := "+"( Integer'Pos( a_benunit.phonnt2 ));
      params( 274 ) := "+"( Integer'Pos( a_benunit.phonnt3 ));
      params( 275 ) := "+"( Integer'Pos( a_benunit.phonnt4 ));
      params( 276 ) := "+"( Integer'Pos( a_benunit.phonnt5 ));
      params( 277 ) := "+"( Integer'Pos( a_benunit.phonnt6 ));
      params( 278 ) := "+"( Integer'Pos( a_benunit.phonnt7 ));
      params( 279 ) := "+"( Integer'Pos( a_benunit.phonnt8 ));
      params( 280 ) := "+"( Integer'Pos( a_benunit.phonnt9 ));
      params( 281 ) := "+"( Integer'Pos( a_benunit.pollute ));
      params( 282 ) := "+"( Float( a_benunit.regpamt ));
      params( 283 ) := "+"( Integer'Pos( a_benunit.regularp ));
      params( 284 ) := "+"( Integer'Pos( a_benunit.repaybur ));
      params( 285 ) := "+"( Integer'Pos( a_benunit.shoe ));
      params( 286 ) := "+"( Integer'Pos( a_benunit.shoent1 ));
      params( 287 ) := "+"( Integer'Pos( a_benunit.shoent2 ));
      params( 288 ) := "+"( Integer'Pos( a_benunit.shoent3 ));
      params( 289 ) := "+"( Integer'Pos( a_benunit.shoent4 ));
