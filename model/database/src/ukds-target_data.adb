--
-- Created by ada_generator.py on 2017-10-19 12:07:28.081187
-- 
...
package body Ukds.target_data is
   ...
   begin
      return  "Target_Dataset: " &
         ...
         "one_adult_hh_wales = " & rec.one_adult_hh_wales'Img &
         "two_adult_hhs_wales = " & rec.two_adult_hhs_wales'Img &
         "other_hh_wales = " & rec.other_hh_wales'Img &
         "one_adult_hh_nireland = " & rec.one_adult_hh_nireland'Img &
         "two_adult_hhs_nireland = " & rec.two_adult_hhs_nireland'Img &
         "other_hh_nireland = " & rec.other_hh_nireland'Img &
         "one_adult_hh_england = " & rec.one_adult_hh_england'Img &
         "two_adult_hhs_england = " & rec.two_adult_hhs_england'Img &
         "other_hh_england = " & rec.other_hh_england'Img &
         "one_adult_hh_scotland = " & rec.one_adult_hh_scotland'Img &
         "two_adult_hhs_scotland = " & rec.two_adult_hhs_scotland'Img &
         "other_hh_scotland = " & rec.other_hh_scotland'Img;
   end to_String;
