--
-- Created by ada_generator.py on 2017-09-20 22:07:21.165676
-- 
...
package body Ukds.target_data is
   ...
   begin
      return  "Run: " &
         ...
         "households_source = " & To_String( rec.households_source ) &
         "households_edition = " & rec.households_edition'Img &
         "population_source = " & To_String( rec.population_source ) &
