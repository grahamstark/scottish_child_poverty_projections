--
-- Created by ada_generator.py on 2017-10-18 13:47:19.847882
-- 
with Ukds;
...
package body Ukds.Target_Data.Target_Dataset_IO is
   ...
   use GNATCOLL.SQL_Impl;
      params : constant SQL_Parameters( 1 .. 308 ) := ( if update_order then (
           ...
           17 => ( Parameter_Float, 0.0 ),   --  : eng_hhld_a_couple_and_one_or_more_other_adults_no_dependent_children (Amount)
           ...
           21 => ( Parameter_Float, 0.0 ),   --  : eng_hhld_a_couple_and_one_or_more_other_adults_no_dependent_children (Amount)
   ...
   begin
      ...
      if not gse.Is_Null( cursor, 20 )then
         a_target_dataset.eng_hhld_a_couple_and_one_or_more_other_adults_no_dependent_children:= Amount'Value( gse.Value( cursor, 20 ));
      end if;
   ...
   begin
      ...
      params( 17 ) := "+"( Float( a_target_dataset.eng_hhld_a_couple_and_one_or_more_other_adults_no_dependent_children ));
   ...
   begin
      ...
      params( 21 ) := "+"( Float( a_target_dataset.eng_hhld_a_couple_and_one_or_more_other_adults_no_dependent_children ));
   ...
   procedure Add_eng_hhld_a_couple_and_one_or_more_other_adults_no_dependent_children( c : in out d.Criteria; eng_hhld_a_couple_and_one_or_more_other_adults_no_dependent_children : Amount; op : d.operation_type:= d.eq; join : d.join_type := d.join_and ) is   
   elem : d.Criterion := d.Make_Criterion_Element( "eng_hhld_a_couple_and_one_or_more_other_adults_no_dependent_children", op, join, Long_Float( eng_hhld_a_couple_and_one_or_more_other_adults_no_dependent_children ) );
   begin
      d.add_to_criteria( c, elem );
   end Add_eng_hhld_a_couple_and_one_or_more_other_adults_no_dependent_children;
   ...
   procedure Add_eng_hhld_a_couple_and_one_or_more_other_adults_no_dependent_children_To_Orderings( c : in out d.Criteria; direction : d.Asc_Or_Desc ) is   
   elem : d.Order_By_Element := d.Make_Order_By_Element( "eng_hhld_a_couple_and_one_or_more_other_adults_no_dependent_children", direction  );
   begin
      d.add_to_criteria( c, elem );
   end Add_eng_hhld_a_couple_and_one_or_more_other_adults_no_dependent_children_To_Orderings;
